...
class CfnSuiteDefinition(
    ...
    Example::
        ...
        cfn_suite_definition = iotcoredeviceadvisor.CfnSuiteDefinition(self, "MyCfnSuiteDefinition",
            suite_definition_configuration=iotcoredeviceadvisor.CfnSuiteDefinition.SuiteDefinitionConfigurationProperty(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        suite_definition_configuration: typing.Union[typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _aws_cdk_core_f4b25747.IResolvable],
    ...
    def suite_definition_configuration(
        self,
    ) -> typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable]:
        ...
        *Type:* String
        ...
        '''
        return typing.cast(typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable], jsii.get(self, "suiteDefinitionConfiguration"))

    @suite_definition_configuration.setter
    def suite_definition_configuration(
        self,
        value: typing.Union["CfnSuiteDefinition.SuiteDefinitionConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable],
    ) -> None:
        if __debug__:
...
class CfnSuiteDefinitionProps:
    ...
    def suite_definition_configuration(
        ...
        *Type:* String
        ...
        return typing.cast(typing.Union[CfnSuiteDefinition.SuiteDefinitionConfigurationProperty, _aws_cdk_core_f4b25747.IResolvable], result)
