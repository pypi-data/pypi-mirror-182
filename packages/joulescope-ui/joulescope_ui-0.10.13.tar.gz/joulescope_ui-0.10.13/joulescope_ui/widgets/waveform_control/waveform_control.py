...
class WaveformControlWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent, cmdp, state_preference):
        ...
        self._add_zoom_icon('zoom_in', self._on_x_axis_zoom_in, TOOLTIP_X_AXIS_ZOOM_IN)
        self._add_zoom_icon('zoom_out', self._on_x_axis_zoom_out, TOOLTIP_X_AXIS_ZOOM_OUT)
        self._add_zoom_icon('zoom_all', self._on_x_axis_zoom_all, TOOLTIP_X_AXIS_ZOOM_ALL)
    ...
    def _add_zoom_icon(self, resource_name, callback, tooltip):
        button = QtWidgets.QPushButton(self)
        button.setProperty('waveform_zoom_icon', True)
