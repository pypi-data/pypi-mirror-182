    ...
    def clean_old_installation(self):
        ...
        if os.path.isdir(os.path.join(self._source_dir, 'src')):
            ...
            try:
                shutil.rmtree(
                    os.path.join(
                        self._folder_package, 'pycover', 'dist',
                    ),
                ),
            except OSError:
                pass
    ...
    def run_installation(self):
        ...
        if os.path.isdir(os.path.join(self._source_dir, 'src')):
            ...
            shutil.copytree(
                ...
                os.path.join(self._ext_dir, 'pycover', 'node_modules'),
            )
            shutil.copytree(
                os.path.join(self._tmp_dir, 'dist'),
                os.path.join(self._ext_dir, 'pycover', 'dist'),
            )
...
setup(
    ...
    ext_modules=[NodeJsExtension('pycover')],
