...
import bit_lts
from bit_lts.network.fees import get_fee, get_fee_cached, set_fee_cache_time


def test_set_fee_cache_time():
    original = bit_lts.network.fees.DEFAULT_CACHE_TIME
    set_fee_cache_time(30)
    updated = bit_lts.network.fees.DEFAULT_CACHE_TIME
