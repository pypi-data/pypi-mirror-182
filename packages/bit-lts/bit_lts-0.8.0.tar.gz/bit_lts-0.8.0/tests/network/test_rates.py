...
import bit_lts
from bit_lts.network.rates import (
    RatesAPI,
    btc_to_satoshi,
    currency_to_satoshi,
...
from bit_lts.utils import Decimal


def test_set_rate_cache_time():
    original = bit_lts.network.rates.DEFAULT_CACHE_TIME
    set_rate_cache_time(30)
    updated = bit_lts.network.rates.DEFAULT_CACHE_TIME
