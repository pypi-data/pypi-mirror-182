...
class BaseTBCProvider(object):
    ...
    def __init__(self) -> None:
        assert (
            callable(self.description) is False
        ), "`description` must be property, not callable"
        assert (
            callable(self.client_ip) is False
        ), "`client_ip` must be property, not callable"
        assert callable(self.cert) is False, "`cert` must be property, not callable"
        assert (
    ...
    def description(self) -> str:
        ...
        """
        raise NotImplementedError("Provider needs implement `description` function")
    ...
    def client_ip(self) -> str:
        ...
        :return:
        """
        raise NotImplementedError("Provider needs implement `client_ip` function")
    ...
    def cert(self) -> Tuple[str, str]:
        ...
        """
        raise NotImplementedError("Provider needs implement `cert` function")
