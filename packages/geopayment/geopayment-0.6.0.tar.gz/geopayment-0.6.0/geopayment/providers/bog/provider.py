...
class BaseIPayProvider(object):
    ...
    def client_id(self) -> str:
        ...
        :return: client id
        """
        raise NotImplementedError("Provider needs implement `client_id` function")
    ...
    def secret_key(self) -> str:
        ...
        """
        raise NotImplementedError("Provider needs implement `secret_key` function")
    ...
    def service_url(self) -> str:
        ...
        """
        raise NotImplementedError("Provider needs implement `service_url` function")
    ...
    def redirect_url(self) -> str:
        ...
        """
        raise NotImplementedError("Provider needs implement `redirect_url` function")
...
class IPayProvider(BaseIPayProvider):
    ...
    def checkout(self, **kwargs: Optional[Any]) -> Dict[str, str]:
        ...
        if "links" in result and self.order_status:
            link = list(filter(lambda x: x["rel"] == "approve", result["links"]))
            if link:
