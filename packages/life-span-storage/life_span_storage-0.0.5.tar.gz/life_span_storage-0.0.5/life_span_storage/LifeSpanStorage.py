...
- limit (number; optional)"""
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, data=Component.UNDEFINED, limit=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'data', 'limit']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'data', 'limit']
