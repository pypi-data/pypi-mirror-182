...
class CfnDataRepositoryAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param batch_import_meta_data_on_create: A boolean flag indicating whether an import data repository task to import metadata should run after the data repository association is created. The task runs if this flag is set to ``true`` . .. epigraph:: ``BatchImportMetaDataOnCreate`` is not supported for data repositories linked to an Amazon File Cache resource.
        ...
        :param s3: The configuration for an Amazon S3 data repository linked to an Amazon FSx for Lustre file system with a data repository association.
    ...
    class S3Property:
        def __init__(
            ...
            *,
            ...
            '''
            :param auto_export_policy: ``CfnDataRepositoryAssociation.S3Property.AutoExportPolicy``.
            :param auto_import_policy: ``CfnDataRepositoryAssociation.S3Property.AutoImportPolicy``.
...
class CfnFileSystem(
    ...
    class OpenZFSConfigurationProperty:
        ...
        def deployment_type(self) -> builtins.str:
            ...
            For more information, see: `Deployment type availability <https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/available-aws-regions.html>`_ and `File system performance <https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/zfs-fs-performance.html>`_ in the *Amazon FSx for OpenZFS User Guide* .
