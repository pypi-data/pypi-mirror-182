...
modeNameToSymDict  = {
    ...
    'VSURGE':  (+1, "VELOCITY", 1 , "m/s/m" , 1) ,
    'VSWAY':   (-1, "VELOCITY", 2 , "m/s/m", 1) ,
    'VHEAVE':  (+1, "VELOCITY", 3 , "m/s/m", 1) ,
    'VROLL':   (-1, "VELOCITY", 4 , "deg/s/m", 0) ,
    'VPITCH':  (+1, "VELOCITY", 5 , "deg/s/m", 0 ) ,
    'VYAW':    (-1, "VELOCITY", 6 , "deg/s/m", 0) ,
    'ASURGE':  (+1, "ACCELERATION", 1 , "m/s²/m" , 1) ,
    'ASWAY':   (-1, "ACCELERATION", 2 , "m/s²/m", 1) ,
    'AHEAVE':  (+1, "ACCELERATION", 3 , "m/s²/m", 1) ,
    'AROLL':   (-1, "ACCELERATION", 4 , "deg/s²/m", 0) ,
    'APITCH':  (+1, "ACCELERATION", 5 , "deg/s²/m", 0 ) ,
    'AYAW':    (-1, "ACCELERATION", 6 , "deg/s²/m", 0) ,    
