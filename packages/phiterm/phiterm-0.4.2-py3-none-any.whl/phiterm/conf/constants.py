...
PHI_SIGNIN_URL_WITHOUT_PARAMS: str = "http://localhost:3000/login" if PHI_API_MODE == "dev" else "https://phidata.com/login"
BACKEND_API_URL: str = "http://localhost:8000" if PHI_API_MODE == "dev" else "https://api.phidata.com"
