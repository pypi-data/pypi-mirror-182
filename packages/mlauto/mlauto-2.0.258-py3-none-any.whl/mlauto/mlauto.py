...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if ('_init_' in frame.f_code.co_name and ('torch' in frame.f_code.co_filename or 'sklearn' in frame.f_code.co_filename or ('tensorflow' in frame.f_code.co_filename and 'framework' in frame.f_code.co_filename))):
