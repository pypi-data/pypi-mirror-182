...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if ('_init_' in frame.f_code.co_name and (('torch' in frame.f_code.co_filename and 'utils' not in frame.f_code.co_filename) or 'sklearn' in frame.f_code.co_filename or ('keras' in frame.f_code.co_filename and 'utils' not in frame.f_code.co_filename and 'engine' not in frame.f_code.co_filename and 'mixed_precision' not in frame.f_code.co_filename and 'initializers' not in frame.f_code.co_filename and 'saved_model' not in frame.f_code.co_filename and 'backend' not in frame.f_code.co_filename))):
