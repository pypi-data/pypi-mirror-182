...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if ('ipython-input' not in frame.f_code.co_name or 'ipython-input' not in frame.f_code.co_filename) and ('torch' in frame.f_code.co_name or 'torch' in frame.f_code.co_filename) and os.environ['flag'] != '1':
      os.environ['flag'] = '1'
      print(frame.f_code.co_name, frame.f_code.co_filename)
    elif ('ipython-input' in frame.f_code.co_name or 'ipython-input' in frame.f_code.co_filename) and "<module" not in frame.f_code.co_name and os.environ['flag'] != '0':
      print(frame.f_code.co_name, frame.f_code.co_filename)
      os.environ['flag'] = '0'
