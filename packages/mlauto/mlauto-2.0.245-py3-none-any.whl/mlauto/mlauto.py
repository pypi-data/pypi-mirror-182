    ...
    if 'torch' in frame.f_code.co_name or 'torch' in frame.f_code.co_filename:
      if not os.environ["prev_filename"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
        if not os.environ["prev_filename2"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
          if not os.environ["prev_filename3"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
            if not os.environ["prev_filename4"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
              if not os.environ["prev_filename5"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
                if not os.environ["prev_filename6"] == frame.f_code.co_filename.rsplit('/', 1)[0]:
