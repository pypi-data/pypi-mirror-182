...
class HyperV:
    ...
    class snapshot:
        ...
        def create(self, snapshot_name='Clear_OS', vms=[]):
        ...
        # Список снапшотов фиртуалных машин 
        def get_all(self, vms=[]):
