...
from elixir_server.traittypes import InstanceFromClasses
from elixir_server.utils import ensure_async
...
class SessionManager(LoggingConfigurable):
    ...
    kernel_manager = Instance("elixir_server.services.kernels.kernelmanager.MappingKernelManager")
