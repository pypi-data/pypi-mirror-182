...
from elixir_server import _tz as tz
from elixir_server.base.handlers import AuthenticatedFileHandler
...
try:
    ...
    # windows + py2
    from elixir_server.utils import samefile_simple as samefile
