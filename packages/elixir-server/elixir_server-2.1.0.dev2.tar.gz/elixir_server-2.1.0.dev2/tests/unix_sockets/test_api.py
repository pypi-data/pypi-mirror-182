...
import elixir_server.serverapp
from elixir_server.utils import async_fetch, url_path_join, urlencode_unix_socket
...
async def test_list_running_servers(jp_unix_socket_file, http_server):
    ...
    servers = list(elixir_server.serverapp.list_running_servers())
