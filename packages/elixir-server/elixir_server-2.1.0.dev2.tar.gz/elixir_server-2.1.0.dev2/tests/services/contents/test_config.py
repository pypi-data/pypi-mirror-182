...
from elixir_server.services.contents.checkpoints import AsyncCheckpoints
from elixir_server.services.contents.filecheckpoints import (
    AsyncGenericFileCheckpoints,
    GenericFileCheckpoints,
)
from elixir_server.services.contents.manager import AsyncContentsManager
...
async def test_async_contents_manager(jp_configurable_serverapp):
    ...
    argv = [
        "--ServerApp.contents_manager_class=elixir_server.services.contents.manager.AsyncContentsManager"
    ]
