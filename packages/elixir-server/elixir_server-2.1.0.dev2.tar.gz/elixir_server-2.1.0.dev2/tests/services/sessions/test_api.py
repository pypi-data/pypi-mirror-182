...
from elixir_server.services.kernels.kernelmanager import AsyncMappingKernelManager
from elixir_server.utils import url_path_join
...
configs: list = [
    {
        "ServerApp": {
            "kernel_manager_class": "elixir_server.services.kernels.kernelmanager.MappingKernelManager"
        }
    },
    {
        "ServerApp": {
            "kernel_manager_class": "elixir_server.services.kernels.kernelmanager.AsyncMappingKernelManager"
        }
    },
    {
        "ServerApp": {
