...
from elixir_server.auth.security import passwd_check
from elixir_server.serverapp import JupyterPasswordApp, ServerApp, list_running_servers


def test_help_output():
    """jupyter server --help-all works"""
    check_help_all_output("elixir_server")
