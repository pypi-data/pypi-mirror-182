...
from elixir_server.config_manager import BaseJSONConfigManager
from elixir_server.extension.serverextension import (
    _get_config_dir,
...
def test_help_output():
    check_help_all_output("elixir_server.extension.serverextension")
    check_help_all_output("elixir_server.extension.serverextension", ["enable"])
    check_help_all_output("elixir_server.extension.serverextension", ["disable"])
    check_help_all_output("elixir_server.extension.serverextension", ["install"])
    check_help_all_output("elixir_server.extension.serverextension", ["uninstall"])
