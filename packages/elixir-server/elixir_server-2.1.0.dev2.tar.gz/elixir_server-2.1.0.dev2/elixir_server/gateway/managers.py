...
class GatewayMappingKernelManager(AsyncMappingKernelManager):
    ...
    def _default_kernel_manager_class(self):
        return "elixir_server.gateway.managers.GatewayKernelManager"
...
class GatewaySessionManager(SessionManager):
    kernel_manager = Instance("elixir_server.gateway.managers.GatewayMappingKernelManager")
...
class GatewayKernelManager(AsyncKernelManager):
    ...
    client_class = DottedObjectName("elixir_server.gateway.managers.GatewayKernelClient")
    client_factory = Type(klass="elixir_server.gateway.managers.GatewayKernelClient")
