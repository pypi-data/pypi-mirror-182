...
from elixir_server.transutils import _i18n
...
if TYPE_CHECKING:
    ...
    from elixir_server.serverapp import ServerApp
...
class IdentityProvider(LoggingConfigurable):
    ...
    login_handler_class = Type(
        default_value="elixir_server.auth.login.LoginFormHandler",
    ...
    logout_handler_class = Type(
        default_value="elixir_server.auth.logout.LogoutHandler",
        klass=web.RequestHandler,
        config=True,
    ...
    def get_user(self, handler: JupyterHandler) -> User | None | Awaitable[User | None]:
        ...
        Must return a :class:`.elixir_server.auth.User`,
...
class PasswordIdentityProvider(IdentityProvider):
    ...
    hashed_password = Unicode(
        ...
        help=_i18n(
            ...
            To generate, type in a python/IPython shell:
                ...
                from elixir_server.auth import passwd; passwd()
    ...
    def validate_security(
        ...
        if self.password_required and (not self.hashed_password):
            ...
            self.log.critical(_i18n("\t$ python -m elixir_server.auth password"))
            sys.exit(1)
