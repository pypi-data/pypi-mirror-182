...
class GRPCCollector (FormCollector):
    ...
    def collect_incoming_data (self, data):
        print ('COLLECT INCOMMING DATA', len (data))
        self.buffer += data
    ...
    def found_terminator (self):
        ...
        print ('FOUND TERMINATOR', len (buf))
...
class GRPCAsyncStreamCollector (GRPCStreamCollector):
    def __init__ (self, handler, request, *args):
        super ().__init__ (handler, request, *args)
    ...
    def handle_message (self, msg):
        f = self.input_type [0]()
        f.ParseFromString (msg)
        print ('QUEUEEEEEEEEEEEEEEEEEEEEEEEE', f)
