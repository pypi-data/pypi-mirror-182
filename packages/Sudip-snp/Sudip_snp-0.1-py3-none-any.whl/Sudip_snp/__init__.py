def snp_dw(location):
    ...
    time.sleep(3)
    print(
        "Please Kindly Install Webdriver Manager Using pip install webdriver-manager ,make sure to \n put this command in your ide terminal so that they are installed in the proper place")
    time.sleep(5)
    print("\n\n",
