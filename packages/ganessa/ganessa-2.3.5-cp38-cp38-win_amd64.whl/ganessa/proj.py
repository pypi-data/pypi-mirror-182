...
# METHODS
#   * dict methods: keys(), values(), __getitem__, __setitem__
...
# REMARK
#   Initial dict values are available as FrenchProjMapping().mapping.
...
# RESULT
#   str name_or_epsg: EPSG or symbolic name, depending on the value of as_epsg:
