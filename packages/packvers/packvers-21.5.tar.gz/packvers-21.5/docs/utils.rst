...
.. function:: canonicalize_version(version)
    ...
    :class:`~packvers.version.Version` instance), and returns the
    ...
    .. doctest::
        ...
        >>> from packvers.utils import canonicalize_version
...
.. function:: parse_wheel_filename(filename)
    ...
    instance of :class:`~packvers.version.Version`. The build number
    ...
    .. doctest::
        ...
        >>> from packvers.utils import parse_wheel_filename
...
.. function:: parse_sdist_filename(filename)
    ...
    represented by an instance of :class:`~packvers.version.Version`.

    :param str filename: The name of the sdist file.

    .. doctest::

        >>> from packvers.utils import parse_sdist_filename
        >>> from packvers.version import Version
