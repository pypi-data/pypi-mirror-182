...
class itkImageToImageFilterIVF53IVF53(itk.itkBoneCommonPython.itkImageSourceIVF53):
...
def replace_feature_map_nan_inf_image_filter(*args: itkt.ImageLike, **kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for ReplaceFeatureMapNanInfImageFilter"""
    import itk
...
def replace_feature_map_nan_inf_image_filter_init_docstring():
    ...
    filter_class = itk.BoneMorphometry.ReplaceFeatureMapNanInfImageFilter
    replace_feature_map_nan_inf_image_filter.process_object = filter_class
