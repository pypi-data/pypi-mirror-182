...
with open("zerogram/__init__.py", encoding="utf-8") as f:
...
setup(
    ...
    url="https://github.com/ؤ",
    download_url="https://github.com/DEV-Degram/zerogram/releases/latest",
    author="Abdo Asil",
    ...
    project_urls={
        "Tracker": "https://github.com/DEV-Degram/zerogram/issues",
        "Community": "https://t.me/FA9SH",
        "Source": "https://github.com/DEV-Degram/zerogram",
        "Documentation": "https://zerogram.com",
    },
    python_requires="~=3.7",
    package_data={
        "zerogram": ["py.typed"],
