...
import zerogram
from zerogram.filters import Filter
from zerogram.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~zerogram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~zerogram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~zerogram.types.Message`):
    ...
    async def check(self, client: "zerogram.Client", messages: List[Message]):
