...
from zerogram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "zerogram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~zerogram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~zerogram.handlers.MessageHandler` the *update* argument will be a :obj:`~zerogram.types.Message`; in a :obj:`~zerogram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~zerogram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~zerogram.filters.command` or :meth:`~zerogram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~zerogram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~zerogram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~zerogram.types.Message`.
    ...
    async def func(flt, client: zerogram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~zerogram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~zerogram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~zerogram.types.InlineQuery`: The filter will match ``query``.
