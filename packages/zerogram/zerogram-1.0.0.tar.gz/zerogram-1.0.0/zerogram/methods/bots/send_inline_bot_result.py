...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~zerogram.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~zerogram.types.Message`: On success, the sent inline result message is returned.
