...
import zerogram
from zerogram import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~zerogram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~zerogram.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~zerogram.types.BotCommand`: On success, the list of bot commands is returned.
