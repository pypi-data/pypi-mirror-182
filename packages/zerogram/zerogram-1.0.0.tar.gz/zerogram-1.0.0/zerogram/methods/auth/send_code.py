...
from zerogram.errors import PhoneMigrate, NetworkMigrate
from zerogram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~zerogram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
