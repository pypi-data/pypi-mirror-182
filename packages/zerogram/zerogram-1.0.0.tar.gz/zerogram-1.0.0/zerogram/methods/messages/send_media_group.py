...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~zerogram.types.InputMediaPhoto`, :obj:`~zerogram.types.InputMediaVideo`, :obj:`~zerogram.types.InputMediaAudio` and :obj:`~zerogram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~zerogram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from zerogram.types import InputMediaPhoto, InputMediaVideo
