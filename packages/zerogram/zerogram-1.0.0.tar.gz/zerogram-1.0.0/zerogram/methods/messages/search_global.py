...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~zerogram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~zerogram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~zerogram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "zerogram". Get the first 50 results
                async for message in app.search_global("zerogram", limit=50):
                    print(message.text)
