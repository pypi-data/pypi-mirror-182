...
from zerogram.errors import AuthBytesInvalid
from zerogram.session import Session
from zerogram.session.auth import Auth


async def get_session(client: "zerogram.Client", dc_id: int):
