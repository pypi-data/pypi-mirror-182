...
import zerogram
from zerogram import StopTransmission, enums
from zerogram import raw
from zerogram import types
from zerogram import utils
from zerogram.errors import FilePartMissing
from zerogram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~zerogram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~zerogram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~zerogram.Client.stop_transmission`, None is returned.
