...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~zerogram.types.Chat` | :obj:`~zerogram.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("zerogram")
                print(chat)
        """
