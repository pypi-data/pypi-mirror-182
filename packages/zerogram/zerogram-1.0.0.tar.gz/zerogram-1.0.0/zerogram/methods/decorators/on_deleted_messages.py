...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~zerogram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.DeletedMessagesHandler(func, self),
