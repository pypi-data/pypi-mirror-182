...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~zerogram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.ChatMemberUpdatedHandler(func, self),
