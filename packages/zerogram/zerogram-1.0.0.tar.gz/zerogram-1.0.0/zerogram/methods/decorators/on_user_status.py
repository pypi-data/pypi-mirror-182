...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~zerogram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.UserStatusHandler(func, self),
