...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~zerogram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.ChatJoinRequestHandler(func, self),
