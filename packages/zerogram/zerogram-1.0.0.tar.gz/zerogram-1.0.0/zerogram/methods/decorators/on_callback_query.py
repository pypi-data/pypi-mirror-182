...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~zerogram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.CallbackQueryHandler(func, self),
