...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~zerogram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.InlineQueryHandler(func, self),
