...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~zerogram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.MessageHandler(func, self),
