...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~zerogram.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~zerogram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zerogram.Client):
                self.add_handler(zerogram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zerogram.handlers.ChosenInlineResultHandler(func, self),
