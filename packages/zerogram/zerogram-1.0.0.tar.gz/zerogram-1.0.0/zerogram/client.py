...
import zerogram
from zerogram import __version__, __license__
from zerogram import enums
from zerogram import raw
from zerogram import utils
from zerogram.crypto import aes
from zerogram.errors import CDNFileHashMismatch
from zerogram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest
)
from zerogram.handlers.handler import Handler
from zerogram.methods import Methods
from zerogram.session import Auth, Session
from zerogram.storage import FileStorage, MemoryStorage
from zerogram.types import User, TermsOfService
from zerogram.utils import ainput
...
class Client(Methods):
    """zerogram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~zerogram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            Define a custom working directory. The working directory is the location in your filesystem where zerogram
    ...
    APP_VERSION = f"zerogram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to zerogram (version {__version__})")
        print(f"zerogram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~zerogram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.zerogram.org/start/auth")
    ...
    async def get_file(
        ...
        try:
            ...
            if not isinstance(e, zerogram.StopTransmission):
                log.error(e, exc_info=True)
