...
from zerogram.crypto import aes, rsa, prime
from zerogram.errors import SecurityCheckMismatch
from zerogram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "zerogram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
