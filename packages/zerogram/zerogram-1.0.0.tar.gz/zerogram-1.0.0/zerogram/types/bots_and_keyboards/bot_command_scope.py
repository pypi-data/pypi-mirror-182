...
class BotCommandScope(Object):
    ...
    - :obj:`~zerogram.types.BotCommandScopeDefault`
    - :obj:`~zerogram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~zerogram.types.BotCommandScopeAllGroupChats`
    - :obj:`~zerogram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~zerogram.types.BotCommandScopeChat`
    - :obj:`~zerogram.types.BotCommandScopeChatAdministrators`
    - :obj:`~zerogram.types.BotCommandScopeChatMember`
