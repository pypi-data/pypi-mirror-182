...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~zerogram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~zerogram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~zerogram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~zerogram.types.CallbackGame`, *optional*):
