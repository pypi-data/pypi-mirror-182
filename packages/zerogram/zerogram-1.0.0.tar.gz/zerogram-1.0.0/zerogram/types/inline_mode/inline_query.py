...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~zerogram.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <zerogram.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~zerogram.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~zerogram.types.InlineQueryResult`):
