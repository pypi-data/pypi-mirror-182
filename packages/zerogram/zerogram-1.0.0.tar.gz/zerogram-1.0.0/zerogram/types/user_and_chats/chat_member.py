...
import zerogram
from zerogram import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~zerogram.enums.ChatMemberStatus`):
            The member's status in the chat.

        user (:obj:`~zerogram.types.User`, *optional*):
        ...
        invited_by (:obj:`~zerogram.types.User`, *optional*):
        ...
        promoted_by (:obj:`~zerogram.types.User`, *optional*):
            Administrators only. Information about the user who promoted this member as administrator.

        restricted_by (:obj:`~zerogram.types.User`, *optional*):
