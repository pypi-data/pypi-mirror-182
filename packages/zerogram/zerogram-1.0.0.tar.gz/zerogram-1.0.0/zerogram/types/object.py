...
class Object:
    def __init__(self, client: "zerogram.Client" = None):
        self._client = client

    def bind(self, client: "zerogram.Client"):
        """Bind a Client instance to this and to all nested zerogram objects.

        Parameters:
            client (:obj:`~zerogram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing zerogram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/zerogramchat/167281
