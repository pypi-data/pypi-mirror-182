...
class Plot:
    ...
    def __new__(self, all_para_combination, result_df, settings, intraday, summary, freq):
        ...
        output_folder = all_para_combination[0]['output_folder']
        ...
        def display_output(sort_method,para_checklist,filter_dropdown_div,filter_input_div,fig_line,\
                ...
                if chart3_button_clicks > self.chart3_button_clicks:
                    ...
                    if (chart3_start_str and chart3_end_str):
                        ...
                        if (detla.days > 60) or (detla.days < 1):
                            ...
                            chart3_chart = components.generate_chart_3(para_combination, chart3_start, chart3_end, freq)
            ...
            if sort_method:
                ...
                fig_line = components.generate_chart_1(graph_df, all_para_combination, intraday, summary)
        ...
        def update_matrix(clickData,performance_matrix):
            ...
            if clickData:
                if self.chart_type == 1:
                    ...
                    # for key in para_key_list:
                    #     para_values.append(self.graph_df.iloc[self.line_selected][key])
                    # save_path = plotguy.generate_filepath(filename, output_folder, start_date, end_date, para_dict,
                    #                               para_values)
