...
class Backend:
    ...
    # TODO: implement self.selector_id.
    # def __repr__(self):
...
def get_backend(client: StrangeworksGQLClient, backend_slug: str) -> Backend:
    """
...
get_backends_request = Operation(
    query="""
        query backends ($product_slugs: [String!], $backend_type_slugs: [String!], $backend_statuses: [BackendStatus!], $backend_tags: [String!]) {
