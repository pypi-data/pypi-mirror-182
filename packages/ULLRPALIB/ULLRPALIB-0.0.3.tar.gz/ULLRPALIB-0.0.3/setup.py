...
# twine upload --repository testpypi dist/ULLRPALIB-0.0.2.tar.gz dist/ULLRPALIB-0.0.2-py3-none-any.whl
# twine upload dist/ULLRPALIB-0.0.2.tar.gz dist/ULLRPALIB-0.0.2-py3-none-any.whl
...
AUTHOR = 'ULL-RPA' #Modificar con vuestros datos
AUTHOR_EMAIL = 'gerencia.sce.ticger@ull.edu.es' #Modificar con vuestros datos
