...
logging.getLogger("orangtua").setLevel(logging.ERROR)
logging.getLogger("orangtua.client").setLevel(logging.ERROR)
logging.getLogger("orangtua.session.auth").setLevel(logging.ERROR)
logging.getLogger("orangtua.session.session").setLevel(logging.ERROR)
