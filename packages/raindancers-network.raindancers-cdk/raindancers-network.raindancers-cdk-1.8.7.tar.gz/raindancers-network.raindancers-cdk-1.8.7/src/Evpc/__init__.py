...
class AddCoreRoutesProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument policy_table", value=policy_table, expected_type=type_hints["policy_table"])
    ...
    @builtins.property
    def policy_table(self) -> builtins.str:
        '''
        :stability: experimental
        '''
        result = self._values.get("policy_table")
        assert result is not None, "Required property 'policy_table' is missing"
        return typing.cast(builtins.str, result)
