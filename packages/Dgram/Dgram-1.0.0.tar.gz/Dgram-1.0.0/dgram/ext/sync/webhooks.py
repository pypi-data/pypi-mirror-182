"""
This file is used by dgram.run_webhooks() function.
...
class SyncWebhookListener:
    def __init__(self, bot, 
        ...
        for synchronous version of dgram.
        Not supposed to be used manually by user.
        Use dgram.run_webhooks() instead.

        :param bot: dgram instance.
        :type bot: dgram.dgram
