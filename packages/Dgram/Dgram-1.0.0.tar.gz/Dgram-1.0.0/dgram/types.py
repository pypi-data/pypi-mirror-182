...
from dgram import util

DISABLE_KEYLEN_ERROR = False

logger = logging.getLogger('dgram')
...
class Update(JsonDeserializable):
    ...
    :type poll_answer: :class:`dgram.types.PollAnswer`
    ...
    :type my_chat_member: :class:`dgram.types.ChatMemberUpdated`
    ...
    :type chat_member: :class:`dgram.types.ChatMemberUpdated`
    ...
    :type chat_join_request: :class:`dgram.types.ChatJoinRequest`

    :return: Instance of the class
    :rtype: :class:`dgram.types.Update`
...
class ChatJoinRequest(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatJoinRequest`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class WebhookInfo(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.WebhookInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Chat(JsonDeserializable):
    ...
    :type photo: :class:`dgram.types.ChatPhoto`
    ...
    :param location: Optional. For supergroups, the location to which the supergroup is connected. Returned only in 
        getChat.
    :type location: :class:`dgram.types.ChatLocation`

    :return: Instance of the class
    :rtype: :class:`dgram.types.Chat`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MessageID(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MessageId`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class WebAppData(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.WebAppData`
    """
...
class Message(JsonDeserializable):
    ...
    :type sender_chat: :class:`dgram.types.Chat`
    ...
    :type reply_to_message: :class:`dgram.types.Message`

    :param via_bot: Optional. Bot through which the message was sent
    :type via_bot: :class:`dgram.types.User`
    ...
    :param entities: Optional. For text messages, special entities like usernames, URLs, bot commands, etc. that 
        appear in the text
    :type entities: :obj:`list` of :class:`dgram.types.MessageEntity`

    :param animation: Optional. Message is an animation, information about the animation. For backward 
        compatibility, when this field is set, the document field will also be set
    :type animation: :class:`dgram.types.Animation`

    :param audio: Optional. Message is an audio file, information about the file
    :type audio: :class:`dgram.types.Audio`

    :param document: Optional. Message is a general file, information about the file
    :type document: :class:`dgram.types.Document`

    :param photo: Optional. Message is a photo, available sizes of the photo
    :type photo: :obj:`list` of :class:`dgram.types.PhotoSize`

    :param sticker: Optional. Message is a sticker, information about the sticker
    :type sticker: :class:`dgram.types.Sticker`

    :param video: Optional. Message is a video, information about the video
    :type video: :class:`dgram.types.Video`

    :param video_note: Optional. Message is a video note, information about the video message
    :type video_note: :class:`dgram.types.VideoNote`

    :param voice: Optional. Message is a voice message, information about the file
    :type voice: :class:`dgram.types.Voice`
    ...
    :type caption_entities: :obj:`list` of :class:`dgram.types.MessageEntity`

    :param contact: Optional. Message is a shared contact, information about the contact
    :type contact: :class:`dgram.types.Contact`

    :param dice: Optional. Message is a dice with random value
    :type dice: :class:`dgram.types.Dice`

    :param game: Optional. Message is a game, information about the game. More about games »
    :type game: :class:`dgram.types.Game`
    ...
    :type venue: :class:`dgram.types.Venue`

    :param location: Optional. Message is a shared location, information about the location
    :type location: :class:`dgram.types.Location`
    ...
    :type new_chat_photo: :obj:`list` of :class:`dgram.types.PhotoSize`
    ...
    :param message_auto_delete_timer_changed: Optional. Service message: auto-delete timer settings changed in 
        the chat
    :type message_auto_delete_timer_changed: :class:`dgram.types.MessageAutoDeleteTimerChanged`
    ...
    :type invoice: :class:`dgram.types.Invoice`
    ...
    :type successful_payment: :class:`dgram.types.SuccessfulPayment`
    ...
    :type reply_markup: :class:`dgram.types.InlineKeyboardMarkup`

    :return: Instance of the class
    :rtype: :class:`dgram.types.Message`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MessageEntity(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    :type user: :class:`dgram.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MessageEntity`
    """
    @staticmethod
...
class PhotoSize(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.PhotoSize`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Audio(JsonDeserializable):
    ...
    :type thumb: :class:`dgram.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`dgram.types.Audio`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Document(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Document`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoNote(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.VideoNote`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Contact(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Contact`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Location(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Location`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class UserProfilePhotos(JsonDeserializable):
    ...
    :type photos: :obj:`list` of :obj:`list` of :class:`dgram.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`dgram.types.UserProfilePhotos`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ForceReply(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ForceReply`
    """
...
class ReplyKeyboardRemove(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ReplyKeyboardRemove`
    """
...
class WebAppInfo(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.WebAppInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ReplyKeyboardMarkup(JsonSerializable):
    ...
    :param keyboard: :obj:`list` of button rows, each represented by an :obj:`list` of 
        :class:`dgram.types.KeyboardButton` objects
    :type keyboard: :obj:`list` of :obj:`list` of :class:`dgram.types.KeyboardButton`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ReplyKeyboardMarkup`
    """
    max_row_keys = 12
    ...
    def add(self, *args, row_width=None):
        ...
        :type args: :obj:`str` or :class:`dgram.types.KeyboardButton`
...
class KeyboardButtonPollType(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.KeyboardButtonPollType`
    """
...
class KeyboardButton(Dictionaryable, JsonSerializable):
    ...
    :type request_poll: :class:`dgram.types.KeyboardButtonPollType`
    ...
    :type web_app: :class:`dgram.types.WebAppInfo`

    :return: Instance of the class
    :rtype: :class:`dgram.types.KeyboardButton`
    """
...
class InlineKeyboardMarkup(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    .. note::
        It is recommended to use :meth:`dgram.util.quick_markup` instead.

    .. code-block:: python3
        :caption: Example of a custom keyboard with buttons.

        from dgram.util import quick_markup
    ...
    :param inline_keyboard: :obj:`list` of button rows, each represented by an :obj:`list` of 
        :class:`dgram.types.InlineKeyboardButton` objects
    :type inline_keyboard: :obj:`list` of :obj:`list` of :class:`dgram.types.InlineKeyboardButton`

    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineKeyboardMarkup`
    """
    max_row_keys = 8
    ...
    def add(self, *args, row_width=None):
        ...
        :type args: :obj:`list` of :class:`dgram.types.InlineKeyboardButton`
...
class InlineKeyboardButton(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    :type login_url: :class:`dgram.types.LoginUrl`
    ...
    :type callback_game: :class:`dgram.types.CallbackGame`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineKeyboardButton`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class LoginUrl(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.LoginUrl`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class CallbackQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.CallbackQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ChatPhoto(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatPhoto`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ChatMember(JsonDeserializable):
    ...
    * :class:`dgram.types.ChatMemberOwner`
    * :class:`dgram.types.ChatMemberAdministrator`
    * :class:`dgram.types.ChatMemberMember`
    * :class:`dgram.types.ChatMemberRestricted`
    * :class:`dgram.types.ChatMemberLeft`
    * :class:`dgram.types.ChatMemberBanned`
...
class ChatMemberOwner(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberOwner`
    """
    pass
...
class ChatMemberAdministrator(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberAdministrator`
    """
    pass
...
class ChatMemberMember(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberMember`
    """
    pass
...
class ChatMemberRestricted(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberRestricted`
    """
    pass
...
class ChatMemberLeft(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberLeft`
    """
    pass
...
class ChatMemberBanned(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatMemberBanned`
    """
    pass
...
class ChatPermissions(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatPermissions`
    """
    @classmethod
    def de_json(cls, json_string):
...
class BotCommand(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommand`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class BotCommandScope(ABC, JsonSerializable):
    ...
    * :class:`BotCommandScopeDefault`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScope`
    """
...
class BotCommandScopeDefault(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeDefault`
    """
    def __init__(self):
        """
...
class BotCommandScopeAllPrivateChats(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeAllPrivateChats`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all private chats.
...
class BotCommandScopeAllGroupChats(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeAllGroupChats`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all group and supergroup chats.
...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeAllChatAdministrators`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all group and supergroup chat administrators.
...
class BotCommandScopeChat(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeChat`
    """
...
class BotCommandScopeChatAdministrators(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeChatAdministrators`
    """
    def __init__(self, chat_id=None):
...
class BotCommandScopeChatMember(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.BotCommandScopeChatMember`
    """
...
class InlineQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class InputTextMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputTextMessageContent`
    """
...
class InputLocationMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputLocationMessageContent`
    """
...
class InputVenueMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputVenueMessageContent`
    """
...
class InputContactMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputContactMessageContent`
    """
...
class InputInvoiceMessageContent(Dictionaryable):
    ...
    :type prices: :obj:`list` of :class:`dgram.types.LabeledPrice`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputInvoiceMessageContent`
    """
...
class ChosenInlineResult(JsonDeserializable):
    ...
    :type from: :class:`dgram.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChosenInlineResult`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class SentWebAppMessage(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.SentWebAppMessage`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class InlineQueryResultArticle(InlineQueryResultBase):
    ...
    :type input_message_content: :class:`dgram.types.InputMessageContent`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultArticle`
    """
...
class InlineQueryResultPhoto(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultPhoto`
    """
...
class InlineQueryResultGif(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultGif`
    """
...
class InlineQueryResultMpeg4Gif(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultMpeg4Gif`
    """
...
class InlineQueryResultVideo(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultVideo`
    """
...
class InlineQueryResultAudio(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultAudio`
    """
...
class InlineQueryResultVoice(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultVoice`
    """
...
class InlineQueryResultDocument(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultDocument`
    """
...
class InlineQueryResultLocation(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultLocation`
    """
...
class InlineQueryResultVenue(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultVenue`
    """
...
class InlineQueryResultContact(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultContact`
    """
...
class InlineQueryResultGame(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultGame`
    """
...
class InlineQueryResultCachedPhoto(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedPhoto`
    """
...
class InlineQueryResultCachedGif(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedGif`
    """
...
class InlineQueryResultCachedMpeg4Gif(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedMpeg4Gif`
    """
...
class InlineQueryResultCachedSticker(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedSticker`
    """
...
class InlineQueryResultCachedDocument(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedDocument`
    """
...
class InlineQueryResultCachedVideo(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedVideo`
    """
...
class InlineQueryResultCachedVoice(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedVoice`
    """
...
class InlineQueryResultCachedAudio(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InlineQueryResultCachedAudio`
    """
...
class Animation(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Animation`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class GameHighScore(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.GameHighScore`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class LabeledPrice(JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.LabeledPrice`
    """
...
class Invoice(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Invoice`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingAddress(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ShippingAddress`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class OrderInfo(JsonDeserializable):
    ...
    :type shipping_address: :class:`dgram.types.ShippingAddress`

    :return: Instance of the class
    :rtype: :class:`dgram.types.OrderInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingOption(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ShippingOption`
    """
...
class SuccessfulPayment(JsonDeserializable):
    ...
    :type order_info: :class:`dgram.types.OrderInfo`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.SuccessfulPayment`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ShippingQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class PreCheckoutQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.PreCheckoutQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class StickerSet(JsonDeserializable):
    ...
    :type stickers: :obj:`list` of :class:`dgram.types.Sticker`

    :param thumb: Optional. Sticker set thumbnail in the .WEBP, .TGS, or .WEBM format
    :type thumb: :class:`dgram.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`dgram.types.StickerSet`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class Sticker(JsonDeserializable):
    ...
    :type premium_animation: :class:`dgram.types.File`

    :param mask_position: Optional. For mask stickers, the position where the mask should be placed
    :type mask_position: :class:`dgram.types.MaskPosition`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.Sticker`
    """
...
class MaskPosition(Dictionaryable, JsonDeserializable, JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MaskPosition`
    """
...
class InputMediaPhoto(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputMediaPhoto`
    """
...
class InputMediaVideo(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputMediaVideo`
    """
...
class InputMediaAnimation(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputMediaAnimation`
    """
    def __init__(self, media, thumb=None, caption=None, parse_mode=None, caption_entities=None,
...
class InputMediaAudio(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputMediaAudio`
    """
    def __init__(self, media, thumb=None, caption=None, parse_mode=None, caption_entities=None,
...
class InputMediaDocument(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.InputMediaDocument`
    """
    def __init__(self, media, thumb=None, caption=None, parse_mode=None, caption_entities=None,
...
class PollOption(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.PollOption`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class Poll(JsonDeserializable):
    ...
    :type options: :obj:`list` of :class:`dgram.types.PollOption`
    ...
    :param explanation_entities: Optional. Special entities like usernames, URLs, bot commands, etc. that appear in 
        the explanation
    :type explanation_entities: :obj:`list` of :class:`dgram.types.MessageEntity`
    ...
    def add(self, option):
        ...
        :type option: :class:`dgram.types.PollOption` or :obj:`str`
        """
...
class PollAnswer(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.PollAnswer`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ChatLocation(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatLocation`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return json_string
...
class ChatInviteLink(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :type creator: :class:`dgram.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatInviteLink`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ProximityAlertTriggered(JsonDeserializable):
    ...
    :type traveler: :class:`dgram.types.User`

    :param watcher: User that set the alert
    :type watcher: :class:`dgram.types.User`

    :param distance: The distance between the users
    :type distance: :obj:`int`

    :return: Instance of the class
    :rtype: :class:`dgram.types.ProximityAlertTriggered`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatScheduled(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.VideoChatScheduled`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatEnded(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.VideoChatEnded`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatParticipantsInvited(JsonDeserializable):
    ...
    :type users: :obj:`list` of :class:`dgram.types.User`

    :return: Instance of the class
    :rtype: :class:`dgram.types.VideoChatParticipantsInvited`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MessageAutoDeleteTimerChanged(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MessageAutoDeleteTimerChanged`
    """   
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MenuButtonCommands(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MenuButtonCommands`
    """
...
class MenuButtonWebApp(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MenuButtonWebApp`
    """
...
class MenuButtonDefault(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.MenuButtonDefault`
    """
    def __init__(self, type):
        self.type: str = type
...
class ChatAdministratorRights(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ChatAdministratorRights`
    """
...
class InputFile:
    ...
    .. code-block:: python3
        ...
        from dgram.types import InputFile
...
class ForumTopicCreated(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ForumTopicCreated`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ForumTopic(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`dgram.types.ForumTopic`
    """
