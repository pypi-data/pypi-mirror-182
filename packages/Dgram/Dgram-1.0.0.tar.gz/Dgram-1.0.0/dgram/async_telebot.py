...
# storages
from dgram.asyncio_storage import StateMemoryStorage, StatePickleStorage, StateStorageBase
from dgram.asyncio_handler_backends import BaseMiddleware, CancelUpdate, SkipHandler, State, ContinueHandling

from inspect import signature

from dgram import util, types, asyncio_helper
import asyncio
...
class Asyncdgram:
    ...
    .. code-block:: python3
        :caption: Using asynchronous implementation of dgram.

        from dgram.async_dgram import Asyncdgram
        bot = Asyncdgram('token') # get token from @BotFather
    ...
    :type state_storage: :class:`dgram.asyncio_storage.StateMemoryStorage`, optional
    ...
    async def process_new_updates(self, updates: List[types.Update]):
        ...
        :type updates: :obj:`list` of :obj:`dgram.types.Update`
    ...
    def add_custom_filter(self, custom_filter: Union[asyncio_filters.SimpleCustomFilter, asyncio_filters.AdvancedCustomFilter]):
        ...
        :type custom_filter: :class:`dgram.asyncio_filters.SimpleCustomFilter` or :class:`dgram.asyncio_filters.AdvancedCustomFilter`
    ...
    def setup_middleware(self, middleware: BaseMiddleware):
        ...
        .. note::
            ...
            Take a look at the :class:`dgram.asyncio_handler_backends.BaseMiddleware` section for more.

        :param middleware: Middleware-class.
        :type middleware: :class:`dgram.asyncio_handler_backends.BaseMiddleware`
    ...
    def enable_saving_states(self, filename="./.state-save/states.pkl"):
        ...
        .. note::
            It is recommended to pass a :class:`~dgram.asyncio_storage.StatePickleStorage` instance as state_storage
            to dgram class.
    ...
    async def run_webhooks(self,
        ...
        # for webhooks
        try:
            from dgram.ext.aio import AsyncWebhookListener
