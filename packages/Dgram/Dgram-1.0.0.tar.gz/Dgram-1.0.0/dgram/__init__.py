...
import dgram.util
import dgram.types
import dgram.formatting

# storage
from dgram.storage import StatePickleStorage, StateMemoryStorage, StateStorageBase
...
from dgram import apihelper, util, types
from dgram.handler_backends import (
    HandlerBackend, MemoryHandlerBackend, FileHandlerBackend, BaseMiddleware,
    CancelUpdate, SkipHandler, State, ContinueHandling
)
from dgram.custom_filters import SimpleCustomFilter, AdvancedCustomFilter
...
class dgram:
    ...
    .. code-block:: python3
        :caption: Creating instance of dgram

        from dgram import dgram
        bot = dgram('token') # get token from @BotFather
        # now you can register other handlers/update listeners, 
        # and use bot methods.

    See more examples in examples/ directory:
    https://github.com/eternnoir/dgram/tree/master/examples
    ...
    :type next_step_backend: :class:`dgram.handler_backends.HandlerBackend`, optional

    :param reply_backend: Reply step handler class, defaults to None
    :type reply_backend: :class:`dgram.handler_backends.HandlerBackend`, optional

    :param exception_handler: Exception handler to handle errors, defaults to None
    :type exception_handler: :class:`dgram.ExceptionHandler`, optional
    ...
    :type state_storage: :class:`dgram.storage.StateStorageBase`, optional
    ...
    def enable_saving_states(self, filename: Optional[str]="./.state-save/states.pkl"):
        ...
        .. note::
            It is recommended to pass a :class:`~dgram.storage.StatePickleStorage` instance as state_storage
            to dgram class.
    ...
    def run_webhooks(self,
        ...
        # webhooks module
        try:
            from dgram.ext.sync import SyncWebhookListener
    ...
    def get_updates(self, offset: Optional[int]=None, limit: Optional[int]=None, 
        ...
        :rtype: :obj:`list` of :class:`dgram.types.Update`
        """
    ...
    def process_new_updates(self, updates: List[types.Update]):
        ...
        :param updates: List of :class:`dgram.types.Update` objects.
        :type updates: :obj:`list` of :class:`dgram.types.Update`
    ...
    def _setup_change_detector(self, path_to_watch: str):
        try:
            ...
            from dgram.ext.reloader import EventHandler
        except ImportError:
            raise ImportError(
    ...
    def get_user_profile_photos(self, user_id: int, offset: Optional[int]=None, 
        ...
        Returns a :class:`dgram.types.UserProfilePhotos` object.
    ...
    def get_chat_administrators(self, chat_id: Union[int, str]) -> List[types.ChatMember]:
        ...
        :rtype: :obj:`list` of :class:`dgram.types.ChatMember`
        """
    ...
    def get_chat_member(self, chat_id: Union[int, str], user_id: int) -> types.ChatMember:
        ...
        :rtype: :class:`dgram.types.ChatMember`
        """
    ...
    def send_message(
        ...
        :type entities: Array of :class:`dgram.types.MessageEntity`
        ...
        :type reply_markup: :class:`dgram.types.InlineKeyboardMarkup` or :class:`dgram.types.ReplyKeyboardMarkup` or :class:`dgram.types.ReplyKeyboardRemove`
            or :class:`dgram.types.ForceReply`
    ...
    def copy_message(
        ...
        :type caption_entities: Array of :class:`dgram.types.MessageEntity`
    ...
    def send_photo(
        ...
        :type photo: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_audio(
        ...
        :type audio: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_voice(
        ...
        :type voice: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_document(
        ...
        :type document: :obj:`str` or :class:`dgram.types.InputFile`
        ...
        :type thumb: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_sticker(
        ...
        :type sticker: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_video(
        ...
        :type video: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_animation(
        ...
        :type animation: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def send_video_note(
        ...
        :type data: :obj:`str` or :class:`dgram.types.InputFile`
    ...
    def edit_message_live_location(
        ...
        :rtype: :class:`dgram.types.Message` or bool
        """
        return types.Message.de_json(
    ...
    def get_my_commands(self, scope: Optional[types.BotCommandScope]=None, 
        ...
        :type scope: :class:`dgram.types.BotCommandScope`
        ...
        :rtype: :obj:`list` of :class:`dgram.types.BotCommand`
        """
    ...
    def set_chat_menu_button(self, chat_id: Union[int, str]=None, 
        ...
        :type menu_button: :class:`dgram.types.MenuButton`
    ...
    def get_chat_menu_button(self, chat_id: Union[int, str]=None) -> types.MenuButton:
        ...
        :rtype: :class:`dgram.types.MenuButton`
        """
    ...
    def set_my_default_administrator_rights(self, rights: types.ChatAdministratorRights=None, 
        ...
        :type rights: :class:`dgram.types.ChatAdministratorRights`
    ...
    def set_my_commands(self, commands: List[types.BotCommand],
        ...
        :type commands: :obj:`list` of :class:`dgram.types.BotCommand`
    ...
    def edit_message_text(
        ...
        :type entities: List of :obj:`dgram.types.MessageEntity`
    ...
    def edit_message_media(
        ...
        :param reply_markup: A JSON-serialized object for an inline keyboard.
        :type reply_markup: :obj:`dgram.types.InlineKeyboardMarkup` or :obj:`ReplyKeyboardMarkup` or :obj:`ReplyKeyboardRemove` or :obj:`ForceReply`
    ...
    def reply_to(self, message: types.Message, text: str, **kwargs) -> types.Message:
        ...
        :param message: Instance of :class:`dgram.types.Message`
        :type message: :obj:`types.Message`

        :param text: Text of the message.
        :type text: :obj:`str`

        :param kwargs: Additional keyword arguments which are passed to :meth:`dgram.dgram.send_message`
    ...
    def get_custom_emoji_stickers(self, custom_emoji_ids: List[str]) -> List[types.Sticker]:
        ...
        :rtype: :obj:`list` of :class:`dgram.types.Sticker`
        """
    ...
    def get_forum_topic_icon_stickers(self) -> List[types.Sticker]:
        ...
        :rtype: List[:class:`dgram.types.StickerSet`]
        """
    ...
    def answer_web_app_query(self, web_app_query_id: str, result: types.InlineQueryResultBase) -> types.SentWebAppMessage:
        ...
        :type result: :class:`dgram.types.InlineQueryResultBase`
    ...
    def register_for_reply(self, message: types.Message, callback: Callable, *args, **kwargs) -> None:
        ...
        :type callback: :obj:`Callable[[dgram.types.Message], None]`
    ...
    def setup_middleware(self, middleware: BaseMiddleware):
        ...
        :param middleware: Subclass of :class:`dgram.handler_backends.BaseMiddleware`
        :type middleware: :class:`dgram.handler_backends.BaseMiddleware`
        :return: None
        """
    ...
    def set_state(self, user_id: int, state: Union[int, str, State], chat_id: Optional[int]=None) -> None:
        ...
        :param state: new state. can be string, integer, or :class:`dgram.types.State`
        :type state: :obj:`int` or :obj:`str` or :class:`dgram.types.State`
    ...
    def get_state(self, user_id: int, chat_id: Optional[int]=None) -> Optional[Union[int, str, State]]:
        ...
        :rtype: :obj:`int` or :obj:`str` or :class:`dgram.types.State`
        """
        if chat_id is None:
            chat_id = user_id
    ...
    def add_middleware_handler(self, handler, update_types=None):
        ...
        if not apihelper.ENABLE_MIDDLEWARE:
            raise RuntimeError("Middleware is not enabled. Use apihelper.ENABLE_MIDDLEWARE before initialising dgram.")
    ...
    def message_handler(
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.Message` object.
    ...
    def register_message_handler(self, callback: Callable, content_types: Optional[List[str]]=None, commands: Optional[List[str]]=None,
        ...
        :param pass_bot: True if you need to pass dgram instance to handler(useful for separating handlers into different files)
    ...
    def inline_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.InlineQuery` object.
    ...
    def chosen_inline_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.ChosenInlineResult` object.
    ...
    def callback_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.CallbackQuery` object.
    ...
    def shipping_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.ShippingQuery` object.
    ...
    def pre_checkout_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.PreCheckoutQuery` object.
    ...
    def poll_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.Poll` object.
    ...
    def poll_answer_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.PollAnswer` object.
    ...
    def my_chat_member_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.ChatMemberUpdated` object.
    ...
    def chat_join_request_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`dgram.types.ChatJoinRequest` object.
