...
def _sample_records(size, sample_rate, inputs, outputs, feedbacks, join_keys, timestamps):
    ...
    return inputs, outputs, feedbacks, join_keys, timestamps
...
class Gantry:
    ...
    def log_file(
        ...
        feedback_id: Optional[List[str]] = None,
        feedback_keys: Optional[List[str]] = None,
    ) -> None:
        """
        Ingest a file containing records into Gantry.
        ...
        Args:
            ...
            feedback_id (optional, list[str]): by default, feedback_id values will be fetched
    ...
    def log_records(  # noqa: C901
        ...
        Returns:
            A tuple of (batch_id, list[join_keys]): The batch_id will be None if records are not
        ...
        inputs, outputs, feedbacks, join_keys, timestamps = _sample_records(
            size, sample_rate, inputs, outputs, feedbacks, join_keys, timestamps
        )
    ...
    def _log_prediction_and_feedback_events(
        ...
        This method can assume inputs/outputs/feedbacks/timestamps have same size
        """
        size = len(inputs)
    ...
    def _log_feedback_event(
        ...
        ev = _build_feedback_event(
            context, application, join_key, feedback, feedback_version, timestamp
        )
        self.log_store.log(application, ev)
        return join_key
