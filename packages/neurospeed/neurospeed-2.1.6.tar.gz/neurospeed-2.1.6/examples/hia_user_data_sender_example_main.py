...
def run_user_test_flow(config_path):
    ...
    if hia_client.is_connected():
        ...
        hia_client.set_packet_labels({"packet_lbl_title1": "packet_lbl_value1", "packet_lbl_title2": "packet_lbl_value2"})
        time.sleep(0.2)
        hia_client.set_onetime_labels({"onetime_lbl_title1": "onetime_lbl_value1", "onetime_lbl_title2": "onetime_lbl_value2"})
