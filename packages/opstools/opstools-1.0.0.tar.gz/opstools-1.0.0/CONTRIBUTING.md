...
Welcome to `opstools` contributor's guide.
...
If you experience bugs or general issues with `opstools`, please have a look
...
You can help improve `opstools` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opstools` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opstools`'s files. While this mechanism can
...
```
conda create -n opstools python=3 six virtualenv pytest pytest-cov
conda activate opstools
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opstools.git
   cd opstools
   ```
...
5. Install [pre-commit]:
   ...
   `opstools` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opstools
[issue tracker]: https://github.com/<USERNAME>/opstools/issues
