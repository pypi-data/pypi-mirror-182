...
class RegraFiscal(entity.Entity, db.Model):
    ...
    def __init__(self, id, domain_org_id, cstcofins_id, csticms_id,
                 ...
                 icms_sob_pis_cofins, icms_sob_frete, 
        ...
        self.aliq_especifica_icms_st = aliq_especifica_icms_st
        self.aliq_reducao_base_icms = aliq_reducao_base_icms
        self.aliq_reducao_base_st = aliq_reducao_base_st
    ...
    def is_stable(self):
        ...
        if (self.icms_sob_ipi is True and 
            ...
            raise exception.BadRequest('Se icms_sob_ipi é verdadeiro então' + 
