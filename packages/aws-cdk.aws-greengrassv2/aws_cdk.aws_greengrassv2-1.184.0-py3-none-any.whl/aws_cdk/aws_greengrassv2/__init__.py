...
class CfnDeployment(
    ...
    For more information, see the `Create deployments <https://docs.aws.amazon.com/greengrass/v2/latest/developerguide/create-deployments.html>`_ in the *AWS IoT Greengrass V2 Developer Guide* .
    .. epigraph::
            ...
            iot_job_configuration=greengrassv2.CfnDeployment.DeploymentIoTJobConfigurationProperty(
                ...
                job_executions_rollout_config=greengrassv2.CfnDeployment.IoTJobExecutionsRolloutConfigProperty(
                    exponential_rate=greengrassv2.CfnDeployment.IoTJobExponentialRolloutRateProperty(
                        ...
                        rate_increase_criteria=greengrassv2.CfnDeployment.IoTJobRateIncreaseCriteriaProperty(
    ...
    class DeploymentComponentUpdatePolicyProperty:
        ...
        def action(self) -> typing.Optional[builtins.str]:
            ...
            - ``NOTIFY_COMPONENTS`` – The deployment notifies each component before it stops and updates that component. Components can use the `SubscribeToComponentUpdates <https://docs.aws.amazon.com/greengrass/v2/developerguide/interprocess-communication.html#ipc-operation-subscribetocomponentupdates>`_ IPC operation to receive these notifications. Then, components can respond with the `DeferComponentUpdate <https://docs.aws.amazon.com/greengrass/v2/developerguide/interprocess-communication.html#ipc-operation-defercomponentupdate>`_ IPC operation. For more information, see the `Create deployments <https://docs.aws.amazon.com/greengrass/v2/latest/developerguide/create-deployments.html>`_ in the *AWS IoT Greengrass V2 Developer Guide* .
    ...
    class IoTJobExponentialRolloutRateProperty:
        def __init__(
            ...
            *,
            ...
            rate_increase_criteria: typing.Union[_aws_cdk_core_f4b25747.IResolvable, typing.Union["CfnDeployment.IoTJobRateIncreaseCriteriaProperty", typing.Dict[builtins.str, typing.Any]]],
        ) -> None:
        ...
        def rate_increase_criteria(
            self,
        ) -> typing.Union[_aws_cdk_core_f4b25747.IResolvable, "CfnDeployment.IoTJobRateIncreaseCriteriaProperty"]:
            ...
            return typing.cast(typing.Union[_aws_cdk_core_f4b25747.IResolvable, "CfnDeployment.IoTJobRateIncreaseCriteriaProperty"], result)
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-greengrassv2.CfnDeployment.IoTJobRateIncreaseCriteriaProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class IoTJobRateIncreaseCriteriaProperty:
        def __init__(
            self,
            *,
            ...
            :param number_of_notified_things: The number of devices to receive the job notification before the rollout rate increases.
            :param number_of_succeeded_things: The number of devices to successfully run the configuration job before the rollout rate increases.
            ...
            Example::
                ...
                io_tJob_rate_increase_criteria_property = greengrassv2.CfnDeployment.IoTJobRateIncreaseCriteriaProperty(
                    number_of_notified_things=123,
                    number_of_succeeded_things=123
                )
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__154cd08db9422ae3ccadf1ee65a4c85b045d83273d1873e1834082a0d7377044)
        ...
        def number_of_notified_things(self) -> typing.Optional[jsii.Number]:
            ...
            :link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-iotjobrateincreasecriteria.html#cfn-greengrassv2-deployment-iotjobrateincreasecriteria-numberofnotifiedthings
            '''
        ...
        def number_of_succeeded_things(self) -> typing.Optional[jsii.Number]:
            ...
            :link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-greengrassv2-deployment-iotjobrateincreasecriteria.html#cfn-greengrassv2-deployment-iotjobrateincreasecriteria-numberofsucceededthings
            '''
        ...
        def __repr__(self) -> str:
            return "IoTJobRateIncreaseCriteriaProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
...
def _typecheckingstub__154cd08db9422ae3ccadf1ee65a4c85b045d83273d1873e1834082a0d7377044(
    *,
    number_of_notified_things: typing.Optional[jsii.Number] = None,
    number_of_succeeded_things: typing.Optional[jsii.Number] = None,
) -> None:
