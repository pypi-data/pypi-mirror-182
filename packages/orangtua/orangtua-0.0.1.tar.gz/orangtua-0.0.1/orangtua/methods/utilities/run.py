...
import orangtua
from orangtua.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~fipper.Client.start`, :meth:`~fipper.idle` and :meth:`~fipper.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`fipper.compose`.
