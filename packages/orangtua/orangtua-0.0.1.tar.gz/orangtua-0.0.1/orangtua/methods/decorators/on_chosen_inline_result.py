...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~fipper.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, orangtua.Client):
                self.add_handler(orangtua.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        orangtua.handlers.ChosenInlineResultHandler(func, self),
