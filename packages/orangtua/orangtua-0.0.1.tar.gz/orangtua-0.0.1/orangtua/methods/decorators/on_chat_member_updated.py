...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~fipper.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, orangtua.Client):
                self.add_handler(orangtua.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        orangtua.handlers.ChatMemberUpdatedHandler(func, self),
