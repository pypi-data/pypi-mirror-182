...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~fipper.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, orangtua.Client):
                self.add_handler(orangtua.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        orangtua.handlers.ChatJoinRequestHandler(func, self),
