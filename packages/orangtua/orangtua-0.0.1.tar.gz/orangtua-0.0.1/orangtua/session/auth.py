...
from orangtua.crypto import aes, rsa, prime
from orangtua.errors import SecurityCheckMismatch
from orangtua.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "orangtua.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
