...
import orangtua
from orangtua import __version__, __license__
from orangtua import enums
from orangtua import raw
from orangtua import utils
from orangtua.crypto import aes
from orangtua.errors import CDNFileHashMismatch
from orangtua.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from orangtua.handlers.handler import Handler
from orangtua.methods import Methods
from orangtua.session import Auth, Session
from orangtua.storage import FileStorage, MemoryStorage
from orangtua.types import User, TermsOfService
from orangtua.utils import ainput
...
class Client(Methods):
    ...
    APP_VERSION = f"Orang Tua {__version__}"
