...
import orangtua
from orangtua import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~fipper.enums.ChatMemberStatus`):
        ...
        invited_by (:obj:`~fipper.types.User`, *optional*):
