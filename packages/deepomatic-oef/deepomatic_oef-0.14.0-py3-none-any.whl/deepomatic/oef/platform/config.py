...
from .helpers.form import Form, MainForm
...
FORM.append(
    ...
    .append(
        ...
        Form(
            ...
            display_ifs=[DisplayCondition('trainer.optimizer.optimizer', ['momentum_optimizer'])]
        ).append(
            InputControl(
        ...
        Form(
            padding_left=SUBSECTION_LEFT_OFFSET,
            display_ifs=[DisplayCondition('trainer.optimizer.optimizer', ['rms_prop_optimizer'])]
        ).append(
            InputControl(
...
FORM.append(
    ListControl(
        ...
        .append(
            ...
            .append(Text("You may want to disable other data augmentations to avoid interfering. This algorithm applies the best policy from https://arxiv.org/abs/1805.09501. It is a mix of random image translations, color histogram equilizations, \"graying\" patches of the image, sharpness adjustments, image shearing, image rotating and color balance adjustments."))
        ),
