...
- extraAttributes (list; optional):
    contains attribute names to add to the UI; use with backend
    aggregation when certain fields are omitted.

- hiddenAttributes (list; default ["Test"]):
...
- valueFilter (dict; optional):
    ...
    _type = 'PivotTable'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, data=Component.UNDEFINED, hiddenAttributes=Component.UNDEFINED, extraAttributes=Component.UNDEFINED, hiddenFromAggregators=Component.UNDEFINED, hiddenFromDragDrop=Component.UNDEFINED, menuLimit=Component.UNDEFINED, unusedOrientationCutoff=Component.UNDEFINED, cols=Component.UNDEFINED, colOrder=Component.UNDEFINED, rows=Component.UNDEFINED, rowOrder=Component.UNDEFINED, aggregatorName=Component.UNDEFINED, vals=Component.UNDEFINED, valueFilter=Component.UNDEFINED, rendererName=Component.UNDEFINED, listedAggregators=Component.UNDEFINED, listedAggregationValues=Component.UNDEFINED, listedRenderers=Component.UNDEFINED, showUI=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'aggregatorName', 'colOrder', 'cols', 'data', 'extraAttributes', 'hiddenAttributes', 'hiddenFromAggregators', 'hiddenFromDragDrop', 'listedAggregationValues', 'listedAggregators', 'listedRenderers', 'menuLimit', 'rendererName', 'rowOrder', 'rows', 'showUI', 'unusedOrientationCutoff', 'vals', 'valueFilter']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'aggregatorName', 'colOrder', 'cols', 'data', 'extraAttributes', 'hiddenAttributes', 'hiddenFromAggregators', 'hiddenFromDragDrop', 'listedAggregationValues', 'listedAggregators', 'listedRenderers', 'menuLimit', 'rendererName', 'rowOrder', 'rows', 'showUI', 'unusedOrientationCutoff', 'vals', 'valueFilter']
