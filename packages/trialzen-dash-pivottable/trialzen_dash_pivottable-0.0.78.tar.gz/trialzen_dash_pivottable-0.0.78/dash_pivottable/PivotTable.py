...
- plotlyOptions (dict; default {width: 100, height: 100}):
    to change the size of the graph e.g {with:100, height:300}.
...
- valueFilter (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, data=Component.UNDEFINED, hiddenAttributes=Component.UNDEFINED, extraAttributes=Component.UNDEFINED, hiddenFromAggregators=Component.UNDEFINED, hiddenFromDragDrop=Component.UNDEFINED, menuLimit=Component.UNDEFINED, unusedOrientationCutoff=Component.UNDEFINED, cols=Component.UNDEFINED, colOrder=Component.UNDEFINED, rows=Component.UNDEFINED, rowOrder=Component.UNDEFINED, aggregatorName=Component.UNDEFINED, vals=Component.UNDEFINED, valueFilter=Component.UNDEFINED, rendererName=Component.UNDEFINED, listedAggregators=Component.UNDEFINED, listedAggregationValues=Component.UNDEFINED, listedRenderers=Component.UNDEFINED, showUI=Component.UNDEFINED, plotlyOptions=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'aggregatorName', 'colOrder', 'cols', 'data', 'extraAttributes', 'hiddenAttributes', 'hiddenFromAggregators', 'hiddenFromDragDrop', 'listedAggregationValues', 'listedAggregators', 'listedRenderers', 'menuLimit', 'plotlyOptions', 'rendererName', 'rowOrder', 'rows', 'showUI', 'unusedOrientationCutoff', 'vals', 'valueFilter']
        self._type = 'PivotTable'
        self._namespace = 'dash_pivottable'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'aggregatorName', 'colOrder', 'cols', 'data', 'extraAttributes', 'hiddenAttributes', 'hiddenFromAggregators', 'hiddenFromDragDrop', 'listedAggregationValues', 'listedAggregators', 'listedRenderers', 'menuLimit', 'plotlyOptions', 'rendererName', 'rowOrder', 'rows', 'showUI', 'unusedOrientationCutoff', 'vals', 'valueFilter']
