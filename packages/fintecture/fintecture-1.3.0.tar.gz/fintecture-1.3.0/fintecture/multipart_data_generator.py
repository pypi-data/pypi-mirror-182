...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(fintecture.api_requestor._api_encode(params))

        for key, value in fintecture.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = fintecture.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, fintecture.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, fintecture.six.text_type):
