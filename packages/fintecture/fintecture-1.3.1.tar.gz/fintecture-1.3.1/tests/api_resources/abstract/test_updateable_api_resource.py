...
class TestUpdateableAPIResource(object):
    class MyUpdateable(fintecture.api_resources.abstract.UpdateableAPIResource):
    ...
    def test_retrieve_and_update_with_fintecture_version(self, request_mock, obj):
        request_mock.stub_request(
            "get", "/v1/myupdateables/foo", {"id": "foo", "bobble": "scrobble"}
        )

        res = self.MyUpdateable.retrieve("foo", fintecture_version="2017-08-15")
