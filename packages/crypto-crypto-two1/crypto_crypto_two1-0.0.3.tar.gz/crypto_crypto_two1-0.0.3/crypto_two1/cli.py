...
import crypto_two1.blockchain.exceptions as blockchain_exceptions
...
from crypto_two1.commands.util import config as two1_config
from crypto_two1.commands.util import uxstring
from crypto_two1.commands.util import decorators
from crypto_two1.commands.util import exceptions
from crypto_two1.commands.util import wallet as wallet_utils
from crypto_two1.commands.util import account as account_utils
from crypto_two1.commands.buy import buy
from crypto_two1.commands.doctor import doctor
from crypto_two1.commands.mine import mine
from crypto_two1.commands.log import log
from crypto_two1.commands.inbox import inbox
from crypto_two1.commands.login import login
from crypto_two1.commands.help import help
from crypto_two1.commands.status import status
from crypto_two1.commands.update import update
from crypto_two1.commands.uninstall import uninstall
from crypto_two1.commands.flush import flush
from crypto_two1.commands.send import send
from crypto_two1.commands.search import search
from crypto_two1.commands.rate import rate
from crypto_two1.commands.publish import publish
from crypto_two1.commands.profile import profile
from crypto_two1.commands.join import join
from crypto_two1.commands.market import market
from crypto_two1.commands.sell import sell
from crypto_two1.commands.earn import earn
from crypto_two1.commands.faucet import faucet
from crypto_two1.commands.wallet import wallet
from crypto_two1.commands.channels import channels
...
def parse_config(
        config_file=crypto_two1.TWO1_CONFIG_FILE,
        config_dict=None,
    ...
    if need_wallet_and_account:
        ...
        client = rest_client.TwentyOneRestClient(crypto_two1.TWO1_HOST, machine_auth, config.username)
...
@click.option('--config-file',
              ...
              default=crypto_two1.TWO1_CONFIG_FILE,
              metavar='PATH',
              help='Path to config (default: %s)' % crypto_two1.TWO1_CONFIG_FILE)
...
@click.version_option(crypto_two1.TWO1_VERSION, message=crypto_two1.TWO1_VERSION_MESSAGE)
@click.pass_context
...
"""
    ...
    if uuid:
        crypto_two1.TWO1_DEVICE_ID = uuid
