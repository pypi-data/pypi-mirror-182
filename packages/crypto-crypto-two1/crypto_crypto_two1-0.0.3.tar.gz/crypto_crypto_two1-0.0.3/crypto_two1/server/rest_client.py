...
class TwentyOneRestClient(object):
    def __init__(self, server_url=None, machine_auth=None, username=None,
        ...
        self.server_url = server_url if server_url is not None else crypto_two1.TWO1_HOST
        self.version = version
        if username:
            self.username = username.lower()
        self._session = None
        self._device_id = crypto_two1.TWO1_DEVICE_ID or "FREE_CLIENT"
    ...
    def _request(self, sign_username=None, method="GET", path="", two1_auth=None, **kwargs):
        ...
        headers["User-Agent"] = "21/{}".format(crypto_two1.TWO1_VERSION)
...
if __name__ == "__main__":
    ...
    from crypto_two1.commands.util import config

    conf = config.Config()
    host = crypto_two1.TWO1_HOST
    for n in range(2):
