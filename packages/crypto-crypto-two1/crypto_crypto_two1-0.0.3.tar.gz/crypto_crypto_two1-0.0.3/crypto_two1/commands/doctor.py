...
from crypto_two1.commands import market
...
class Doctor(object):
    ...
    def check_general_two1_version(self):
        ...
        actual_version = crypto_two1.TWO1_VERSION
    ...
    def check_dependency_two1_lib(self):
        ...
        two1_location = crypto_two1.__file__
    ...
    def check_dependency_two1_dotenv(self):
        ...
        dotenv_path = crypto_two1.TWO1_USER_FOLDER
        if not os.path.exists(dotenv_path):
            return Check.Result.FAIL, check_str, "{} does not exist".format(dotenv_path)

        config_file_path = crypto_two1.TWO1_CONFIG_FILE
    ...
    def check_server_21_api(self):
        ...
        if self.make_http_connection(crypto_two1.TWO1_HOST):
            result = Check.Result.PASS

        return result, check_str, crypto_two1.TWO1_HOST
    ...
    def check_server_21_pool(self):
        ...
        check_str = "21 Pool"
        result = Check.Result.FAIL
        if self.make_http_connection(crypto_two1.TWO1_POOL_URL):
            result = Check.Result.PASS

        return result, check_str, crypto_two1.TWO1_POOL_URL
    ...
    def check_server_21_logging(self):
        ...
        result = Check.Result.FAIL
        if self.make_http_connection(crypto_two1.TWO1_LOGGER_SERVER):
            result = Check.Result.PASS

        return result, check_str, crypto_two1.TWO1_LOGGER_SERVER
    ...
    def check_server_21_provider(self):
        ...
        return self._check_server(
            ...
            urljoin(crypto_two1.TWO1_PROVIDER_HOST, 'blockchain/bitcoin/blocks/latest')
        )
    ...
    def check_server_21_pypi(self):
        ...
        if self.make_http_connection(crypto_two1.TWO1_PYPI_HOST):
            result = Check.Result.PASS
        else:
            result = Check.Result.FAIL

        return result, check_str, crypto_two1.TWO1_PYPI_HOST
