...
import creator_pb2 as creator__pb2
...
class TeradataReaderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDataFromTD = channel.unary_stream(
                ...
                request_serializer=creator__pb2.TableName.SerializeToString,
                response_deserializer=creator__pb2.Resultset.FromString,
                )
...
class TeradataReader(object):
    ...
    def GetDataFromTD(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/TeradataReader/GetDataFromTD',
            creator__pb2.TableName.SerializeToString,
            creator__pb2.Resultset.FromString,
