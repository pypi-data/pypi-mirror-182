...
class Action(object):
    ...
    @staticmethod
    def CreateHideField(sdfdoc, list_length, field):
...
class Appearance(object):
    ...
    RedactionOverlay = property(_PDFNetPython.Appearance_RedactionOverlay_get, _PDFNetPython.Appearance_RedactionOverlay_set)
    PositiveOverlayColor = property(_PDFNetPython.Appearance_PositiveOverlayColor_get, _PDFNetPython.Appearance_PositiveOverlayColor_set)
    NegativeOverlayColor = property(_PDFNetPython.Appearance_NegativeOverlayColor_get, _PDFNetPython.Appearance_NegativeOverlayColor_set)
    Border = property(_PDFNetPython.Appearance_Border_get, _PDFNetPython.Appearance_Border_set)
    UseOverlayText = property(_PDFNetPython.Appearance_UseOverlayText_get, _PDFNetPython.Appearance_UseOverlayText_set)
    TextFont = property(_PDFNetPython.Appearance_TextFont_get, _PDFNetPython.Appearance_TextFont_set)
    MinFontSize = property(_PDFNetPython.Appearance_MinFontSize_get, _PDFNetPython.Appearance_MinFontSize_set)
    MaxFontSize = property(_PDFNetPython.Appearance_MaxFontSize_get, _PDFNetPython.Appearance_MaxFontSize_set)
    TextColor = property(_PDFNetPython.Appearance_TextColor_get, _PDFNetPython.Appearance_TextColor_set)
    HorizTextAlignment = property(_PDFNetPython.Appearance_HorizTextAlignment_get, _PDFNetPython.Appearance_HorizTextAlignment_set)
    VertTextAlignment = property(_PDFNetPython.Appearance_VertTextAlignment_get, _PDFNetPython.Appearance_VertTextAlignment_set)
    ShowRedactedContentRegions = property(_PDFNetPython.Appearance_ShowRedactedContentRegions_get, _PDFNetPython.Appearance_ShowRedactedContentRegions_set)
    RedactedContentColor = property(_PDFNetPython.Appearance_RedactedContentColor_get, _PDFNetPython.Appearance_RedactedContentColor_set)
