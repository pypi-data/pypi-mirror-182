...
def after_run(self, adapter, results):
    ...
    alvin_platform_id = os.environ.get("ALVIN_PLATFORM_ID")
    alvin_dbt_platform_id = os.environ.get("ALVIN_DBT_PLATFORM_ID")

    log_verbose(f"alvin_platform_id: {alvin_platform_id}")
    ...
    log_verbose("start send dbt metadata summary")
    backend_adapter.send_data(summary, "api/v1/metadata-summary")
    log_verbose("end send dbt metadata summary")
