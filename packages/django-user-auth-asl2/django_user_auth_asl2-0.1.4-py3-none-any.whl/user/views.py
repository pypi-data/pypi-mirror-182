...
class PermissionViewSet(viewsets.ModelViewSet):
    queryset=Permission.objects.filter().exclude(codename__in=["add_logentry","change_logentry","delete_logentry","view_logentry","add_permission","change_permission","delete_permission","view_permission","add_contenttype","change_contenttype","delete_contenttype","view_contenttype","add_session","change_session","delete_session","view_session"])
...
class UserRoleApi(APIView):
    ...
    def get(self,request):
        ...
        if group:
            ...
            return Response({'permissions':"You do not belong to any group"})
