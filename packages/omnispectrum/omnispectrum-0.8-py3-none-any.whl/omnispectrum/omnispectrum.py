...
class OmniSpectrum():
    ...
    def any_angle_spectrum(self):
        if (not os.path.exists(os.path.dirname(self.path) + os.path.basename(self.path).split('.')[-2] + '_a.jpg')):
...
#             self.pool.close()
#             self.pool.join()
            self.graph(self.theta, self.r, self.sa, os.path.dirname(self.path) + os.path.basename(self.path).split('.')[-2] + '_a.jpg')
            self.graph(self.theta, self.r, self.sv, os.path.dirname(self.path) + os.path.basename(self.path).split('.')[-2] + '_v.jpg')
            self.graph(self.theta, self.r, self.su, os.path.dirname(self.path) + os.path.basename(self.path).split('.')[-2] + '_u.jpg')
