...
`;!function(e,t,r,i){var n=l();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var s=t((function(e){n.initializeInstanceElements(e,a.elements)}),r),a=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(f(o.descriptor)||f(n.descriptor)){if(p(o)||p(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(p(o)){if(p(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}d(o,n)}else t.push(o)}return t}(s.d.map(c)),e);n.initializeClassElements(s.F,a.elements),n.runClassFinishers(s.F,a.finishers)}([(0,s.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"field",key:a.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading"> ${y(g(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"field",static:!0,key:"styles",value:()=>[n.W,o.iv`
    ...
    `,"rtl"===document.dir?o.iv`
      ...
      >
        ...
        <ha-statistic-picker
          .hass=${this.hass}
          .includeUnitClass=${this._params.allowedGasUnitClass||g}
          .includeDeviceClass=${v}
          .value=${this._source.stat_energy_from}
          .label=${`${this.hass.localize("ui.panel.config.energy.gas.dialog.gas_usage")} (${void 0===this._params.allowedGasUnitClass?this.hass.localize("ui.panel.config.energy.gas.dialog.m3_or_kWh"):e})`}
        ...
        ${"statistic"===this._costs?i.dy`<ha-statistic-picker
              ...
              .label=${this.hass.localize("ui.panel.config.energy.gas.dialog.cost_stat_input")}
        ...
        ${"entity"===this._costs?i.dy`<ha-entity-picker
              ...
              .label=${this.hass.localize("ui.panel.config.energy.gas.dialog.cost_entity_input",{unit:this._pickedDisplayUnit||e})}
        ...
        ${"number"===this._costs?i.dy`<ha-textfield
              .label=${this.hass.localize("ui.panel.config.energy.gas.dialog.cost_number_input",{unit:this._pickedDisplayUnit||e})}
              class="price-options"
              step=".01"
              type="number"
              .value=${this._source.number_energy_price}
              @change=${this._numberPriceChanged}
              .suffix=${`${this.hass.config.currency}/${this._pickedDisplayUnit||e}`}
            >
            </ha-textfield>`:""}
    ...
    `}},{kind:"method",key:"_handleCostChanged",value:function(e){const t=e.currentTarget;this._costs=t.value}},{kind:"method",key:"_numberPriceChanged",value:function(e){this._source={...this._source,number_energy_price:Number(e.target.value),entity_energy_price:null,stat_cost:null}}},{kind:"method",key:"_priceStatChanged",value:function(e){this._source={...this._source,entity_energy_price:null,number_energy_price:null,stat_cost:e.detail.value}}},{kind:"method",key:"_priceEntityChanged",value:function(e){this._source={...this._source,entity_energy_price:e.detail.value,number_energy_price:null,stat_cost:null}}},{kind:"method",key:"_statisticChanged",value:async function(e){if(e.detail.value){const t=await(0,l.Py)(this.hass,[e.detail.value]);this._pickedDisplayUnit=(0,l.dO)(this.hass,e.detail.value,t[0])}else this._pickedDisplayUnit=void 0;(0,l.Hs)(e.detail.value)&&"statistic"!==this._costs&&(this._costs="no-costs"),this._source={...this._source,stat_energy_from:e.detail.value}}},{kind:"method",key:"_save",value:async function(){try{"no-costs"===this._costs&&(this._source.entity_energy_price=null,this._source.number_energy_price=null,this._source.stat_cost=null),await this._params.saveCallback(this._source),this.closeDialog()}catch(e){this._error=e.message}}},{kind:"get",static:!0,key:"styles",value:function(){return[a.Qx,a.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=c7e9c6b3.js.map