      ...
      <hui-generic-entity-row .hass=${this.hass} .config=${this._config}>
        ${"slider"===e.attributes.mode||"auto"===e.attributes.mode&&(Number(e.attributes.max)-Number(e.attributes.min))/Number(e.attributes.step)<=256?r.dy`
              <div class="flex">
                ...
                ></ha-slider>
                <span class="state">
                  ${(0,o.D)(this.hass.localize,e,this.hass.locale,this.hass.entities,e.state)}
                </span>
              </div>
            `:r.dy`
