...
_POSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='position', full_name='seerep.Pose.position', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='orientation', full_name='seerep.Pose.orientation', index=1,
...
Pose = _reflection.GeneratedProtocolMessageType('Pose', (_message.Message,), {
  'DESCRIPTOR' : _POSE,
  '__module__' : 'pose_pb2'
  # @@protoc_insertion_point(class_scope:seerep.Pose)
  })
