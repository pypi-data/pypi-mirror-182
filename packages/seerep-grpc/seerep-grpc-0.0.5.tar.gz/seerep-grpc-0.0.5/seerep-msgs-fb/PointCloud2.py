...
def AddLabelsGeneral(builder, labelsGeneral): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(labelsGeneral), 0)
def PointCloud2AddLabelsGeneral(builder, labelsGeneral):
...
def PointCloud2StartLabelsGeneralVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartLabelsGeneralVector(builder, numElems)
def AddLabelsBb(builder, labelsBb): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(labelsBb), 0)
def PointCloud2AddLabelsBb(builder, labelsBb):
...
def PointCloud2StartLabelsBbVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
