...
_QUATERNION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='seerep.Quaternion.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='seerep.Quaternion.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='z', full_name='seerep.Quaternion.z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='w', full_name='seerep.Quaternion.w', index=3,
...
Quaternion = _reflection.GeneratedProtocolMessageType('Quaternion', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:seerep.Quaternion)
  })
