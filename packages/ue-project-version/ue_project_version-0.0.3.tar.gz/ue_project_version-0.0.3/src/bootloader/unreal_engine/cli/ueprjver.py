...
def parse_arguments() -> argparse.Namespace:
    ...
    @return: An instance `Namespace` corresponding to the populated
        namespace.
    """
    parser = argparse.ArgumentParser(description="Unreal Engine")
    ...
    parser.add_argument(
        ...
        required=False,
        type=int,
        help=f"specify the build number of the Unreal Engine project")
    ...
    parser.add_argument(
        ...
        help=f"specify the path to the Unreal Engine project")
...
def run():
    ...
    version = project_version.find_project_version_ini_file(arguments.path, require_semantic_versioning=True)
