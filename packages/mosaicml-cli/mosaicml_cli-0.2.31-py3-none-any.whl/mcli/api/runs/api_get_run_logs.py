...
def _get_logs(query: DocumentNode, variables: Dict[str, Any]) -> Generator[Future[str], None, None]:

    connection = MAPIConnection.get_current_connection()
    decoder = MessageDecoder()

    for message in connection.subscribe(query, variables, decoder.parse_message):
        yield message
