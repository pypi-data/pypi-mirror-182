...
import aws_cdk.aws_imagebuilder as _aws_cdk_aws_imagebuilder_f73225a0
...
class AmiPipelineLib(
    ...
    def get_lookup_criteria(
    ...
    ) -> _aws_cdk_aws_ec2_67de8e8d.LookupMachineImageProps:
        '''
        :param parent_image: -
        '''
        if __debug__:
        ...
        return typing.cast(_aws_cdk_aws_ec2_67de8e8d.LookupMachineImageProps, jsii.invoke(self, "getLookupCriteria", [parent_image]))
    ...
    def codepipeline(
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_codepipeline_0063e444.Pipeline], jsii.get(self, "codepipeline"))

    @codepipeline.setter
    def codepipeline(
        self,
        value: typing.Optional[_aws_cdk_aws_codepipeline_0063e444.Pipeline],
    ) -> None:
        if __debug__:
    ...
    def distribution_config(
        self,
    ) -> typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnDistributionConfiguration]:
        return typing.cast(typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnDistributionConfiguration], jsii.get(self, "distributionConfig"))

    @distribution_config.setter
    def distribution_config(
        self,
        value: typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnDistributionConfiguration],
    ) -> None:
        if __debug__:
    ...
    def ebs_encryption_key(self) -> typing.Optional[_aws_cdk_aws_kms_e491a92b.Key]:
        return typing.cast(typing.Optional[_aws_cdk_aws_kms_e491a92b.Key], jsii.get(self, "ebsEncryptionKey"))

    @ebs_encryption_key.setter
    def ebs_encryption_key(
        self,
        value: typing.Optional[_aws_cdk_aws_kms_e491a92b.Key],
    ) -> None:
        if __debug__:
    ...
    def image_pipeline(
        self,
    ) -> typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImagePipeline]:
        return typing.cast(typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImagePipeline], jsii.get(self, "imagePipeline"))

    @image_pipeline.setter
    def image_pipeline(
        self,
        value: typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImagePipeline],
    ) -> None:
        if __debug__:
    ...
    def infrastructure(
        self,
    ) -> typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnInfrastructureConfiguration]:
        return typing.cast(typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnInfrastructureConfiguration], jsii.get(self, "infrastructure"))

    @infrastructure.setter
    def infrastructure(
        self,
        value: typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnInfrastructureConfiguration],
    ) -> None:
        if __debug__:
    ...
    def recipe(
        self,
    ) -> typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImageRecipe]:
        return typing.cast(typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImageRecipe], jsii.get(self, "recipe"))

    @recipe.setter
    def recipe(
        self,
        value: typing.Optional[_aws_cdk_aws_imagebuilder_f73225a0.CfnImageRecipe],
    ) -> None:
        if __debug__:
    ...
    def topic(self) -> typing.Optional[_aws_cdk_aws_sns_889c7272.Topic]:
        return typing.cast(typing.Optional[_aws_cdk_aws_sns_889c7272.Topic], jsii.get(self, "topic"))

    @topic.setter
    def topic(self, value: typing.Optional[_aws_cdk_aws_sns_889c7272.Topic]) -> None:
        if __debug__:
...
class ComponentBuilder(
    ...
    def component_dependencies_map(
        self,
    ) -> typing.Mapping[builtins.str, typing.Union[ArnComponentRef, _aws_cdk_aws_imagebuilder_f73225a0.CfnComponent]]:
        return typing.cast(typing.Mapping[builtins.str, typing.Union[ArnComponentRef, _aws_cdk_aws_imagebuilder_f73225a0.CfnComponent]], jsii.get(self, "componentDependenciesMap"))

    @component_dependencies_map.setter
    def component_dependencies_map(
        self,
        value: typing.Mapping[builtins.str, typing.Union[ArnComponentRef, _aws_cdk_aws_imagebuilder_f73225a0.CfnComponent]],
    ) -> None:
        if __debug__:
    ...
    def scope(self) -> _aws_cdk_core_f4b25747.Construct:
        return typing.cast(_aws_cdk_core_f4b25747.Construct, jsii.get(self, "scope"))

    @scope.setter
    def scope(self, value: _aws_cdk_core_f4b25747.Construct) -> None:
        if __debug__:
...
class PipelineBuilder(
    ...
    def create(
        self,
        stack: _aws_cdk_core_f4b25747.Construct,
...
class SlackNotification(
    ...
    def __init__(
        ...
        scope: _aws_cdk_core_f4b25747.Construct,
        id: builtins.str,
        sns_topic: _aws_cdk_aws_sns_889c7272.Topic,
    ...
    def sns_topic(self) -> _aws_cdk_aws_sns_889c7272.Topic:
        return typing.cast(_aws_cdk_aws_sns_889c7272.Topic, jsii.get(self, "snsTopic"))

    @sns_topic.setter
    def sns_topic(self, value: _aws_cdk_aws_sns_889c7272.Topic) -> None:
        if __debug__:
...
class SourceAction(
    ...
    def __init__(
        self,
        source_output: _aws_cdk_aws_codepipeline_0063e444.Artifact,
        action: _aws_cdk_aws_codepipeline_0063e444.IAction,
    ) -> None:
        '''
        :param source_output: -
        :param action: -
    ...
    def action(self) -> _aws_cdk_aws_codepipeline_0063e444.IAction:
        return typing.cast(_aws_cdk_aws_codepipeline_0063e444.IAction, jsii.get(self, "action"))

    @action.setter
    def action(self, value: _aws_cdk_aws_codepipeline_0063e444.IAction) -> None:
        if __debug__:
    ...
    def source_output(self) -> _aws_cdk_aws_codepipeline_0063e444.Artifact:
        return typing.cast(_aws_cdk_aws_codepipeline_0063e444.Artifact, jsii.get(self, "sourceOutput"))

    @source_output.setter
    def source_output(self, value: _aws_cdk_aws_codepipeline_0063e444.Artifact) -> None:
        if __debug__:
...
def _typecheckingstub__ef6a5e9ff807f841d088aa7ccf1e4f5f54c10990db12e26b01999c38ec938a5f(
    value: typing.Optional[_aws_cdk_aws_sns_889c7272.Topic],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__2f80b66683126ccb70d2ab359cb55b8a02a48aa1cc6ec413fdaa396a1488dd9b(
    value: _aws_cdk_core_f4b25747.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a1e27c3bdb20c1ca9b9008409ec6cd3a5a84576a9ddaa0a252283f53a625b884(
    value: _aws_cdk_aws_sns_889c7272.Topic,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__7d47187b1fe6c66929cc1178a6bf954406890327a9124c160d5283b72c09adfb(
    value: _aws_cdk_aws_codepipeline_0063e444.IAction,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6cb70a11bf8ae16853c9a53eae36b10c34822b59fa6599bf54ad143108b18065(
    value: _aws_cdk_aws_codepipeline_0063e444.Artifact,
) -> None:
    """Type checking stubs"""
    pass
