...
class Instagram:
    ...
    def Login(self):
        ...
        useragent=f'Instagram 264.0.0.22.106 Android (28/9; 240dpi; 720x1280; google; G{a2}A; G{a2}A; intel; en_US; 430370707)'
        self.Blockversion='ee6c2aaa4a5904196d52bef8682d54042308790b11f7278ab2699af3ee80f9a1'
        headers = {
        ...
        data = {
            'signed_body': 'SIGNATURE.{"jazoest":"22616","country_codes":"[{\\"country_code\\":\\"1\\",\\"source\\":[\\"default\\"]},{\\"country_code\\":\\"91\\",\\"source\\":[\\"sim\\"]}]","phone_id":"'+str(IgFamilyDeviceId)+'","enc_password":"#PWD_INSTAGRAM:0:'+str(round(time.time()))+':'+str(self.passw)+'","username":"'+str(self.user)+'","adid":"'+str(uuid.uuid4())+'","guid":"'+str(IgDeviceId)+'","device_id":"'+str(AndroidID)+'","google_tokens":"[]","login_attempt_count":"0"}',
        }
