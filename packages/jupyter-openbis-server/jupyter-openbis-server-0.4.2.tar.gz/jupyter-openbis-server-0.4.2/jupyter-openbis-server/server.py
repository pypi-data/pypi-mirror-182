...
def load_jupyter_server_extension(nb_server_app):
    ...
    connections = _load_configuration(
        paths=nb_server_app.config_file_paths, filename="openbis-connections.yaml"
    )
    ...
    # OpenBIS connections
    web_app.add_handlers(
        host_pattern, [(url_path_join(base_url, "/openbis/conns"), OpenBISConnections)]
    )
    ...
    web_app.add_handlers(
        ...
        [
            (
                url_path_join(base_url, "/openbis/conn/(?P<connection_name>.*)"),
                OpenBISConnectionHandler,
            )
        ],
    )
    ...
    # OpenBIS connections
    web_app.add_handlers(
        host_pattern, [(url_path_join(base_url, "/requirements"), Requirements)]
    )
