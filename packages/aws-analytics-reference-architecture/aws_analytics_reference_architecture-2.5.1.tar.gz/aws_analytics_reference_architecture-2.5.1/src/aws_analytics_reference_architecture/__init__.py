...
class CdkDeployer(
    ...
    '''(experimental) A custom CDK Stack that can be synthetized as a CloudFormation Stack to deploy a CDK application hosted on GitHub.
    ...
    def __init__(
        ...
        *,
        ...
        cdk_parameters: typing.Optional[typing.Mapping[builtins.str, typing.Union[aws_cdk.CfnParameterProps, typing.Dict[str, typing.Any]]]] = None,
        cdk_stack: typing.Optional[builtins.str] = None,
        deploy_build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec] = None,
        destroy_build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec] = None,
        ...
        :param scope: the Scope of the CDK Construct.
        :param deployment_type: (experimental) The deployment type WORKSHOP_STUDIO: the CDK application is deployed through a workshop studio deployment process CLICK_TO_DEPLOY: the CDK application is deployed through a click on a github README button.
        :param cdk_app_location: (experimental) The location of the CDK application in the Github repository. It is used to ``cd`` into the folder before deploying the CDK application Default: - The root of the repository
        :param cdk_parameters: (experimental) The CFN parameters to pass to the CDK application. Default: - No parameter is used
        :param cdk_stack: (experimental) The CDK stack name to deploy. Default: - The default stack is deployed
        :param deploy_build_spec: (experimental) Deploy CodeBuild buildspec file name at the root of the cdk app folder.
        :param destroy_build_spec: (experimental) Destroy Codebuild buildspec file name at the root of the cdk app folder.
        :param git_branch: (experimental) The branch to use on the Github repository. Default: - The main branch of the repository
        :param github_repository: (experimental) The github repository containing the CDK application.
...
class CdkDeployerProps(aws_cdk.StackProps):
    def __init__(
        self,
        *,
        analytics_reporting: typing.Optional[builtins.bool] = None,
        ...
        '''(experimental) The properties for the CdkDeployer construct.
    ...
    def deployment_type(self) -> "DeploymentType":
        '''(experimental) The deployment type WORKSHOP_STUDIO: the CDK application is deployed through a workshop studio deployment process CLICK_TO_DEPLOY: the CDK application is deployed through a click on a github README button.
    ...
    def cdk_app_location(self) -> typing.Optional[builtins.str]:
        '''(experimental) The location of the CDK application in the Github repository.
    ...
    def cdk_parameters(
        self,
    ) -> typing.Optional[typing.Mapping[builtins.str, aws_cdk.CfnParameterProps]]:
        '''(experimental) The CFN parameters to pass to the CDK application.
        ...
        return typing.cast(typing.Optional[typing.Mapping[builtins.str, aws_cdk.CfnParameterProps]], result)

    @builtins.property
    def cdk_stack(self) -> typing.Optional[builtins.str]:
        '''(experimental) The CDK stack name to deploy.
    ...
    @builtins.property
    def deploy_build_spec(self) -> typing.Optional[aws_cdk.aws_codebuild.BuildSpec]:
        '''(experimental) Deploy CodeBuild buildspec file name at the root of the cdk app folder.
    ...
    @builtins.property
    def destroy_build_spec(self) -> typing.Optional[aws_cdk.aws_codebuild.BuildSpec]:
        '''(experimental) Destroy Codebuild buildspec file name at the root of the cdk app folder.
    ...
    def git_branch(self) -> typing.Optional[builtins.str]:
        '''(experimental) The branch to use on the Github repository.
    ...
    def github_repository(self) -> typing.Optional[builtins.str]:
        '''(experimental) The github repository containing the CDK application.
