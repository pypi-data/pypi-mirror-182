...
{'': ['*'],
 'openbb_terminal': ['custom_reports/lunar_crash/*',
                     ...
                     'miscellaneous/portfolio_examples/allocation/*',
                     'miscellaneous/portfolio_examples/holdings/*',
                     'miscellaneous/portfolio_examples/optimization/*',
                     'miscellaneous/routines/*',
                     'miscellaneous/scripts/*',
                     'miscellaneous/scripts/alternative/*',
                     'miscellaneous/scripts/cryptocurrency/*',
                     'miscellaneous/scripts/dashboards/*',
                     'miscellaneous/scripts/econometrics/*',
                     'miscellaneous/scripts/economy/*',
                     'miscellaneous/scripts/etf/*',
                     'miscellaneous/scripts/forecast/*',
                     'miscellaneous/scripts/forex/*',
                     'miscellaneous/scripts/mutual_funds/*',
                     'miscellaneous/scripts/portfolio/*',
                     'miscellaneous/scripts/reports/*',
                     'miscellaneous/scripts/stocks/*',
 ...
 'openbb_terminal.stocks.screener': ['presets/*']}
...
['FundamentalAnalysis>=0.2.6,<0.3.0',
 ...
 'thepassiveinvestor>=1.0.10,<2.0.0',
...
{'all': ['Riskfolio-Lib>=3.1.1,<4.0.0',
 ...
 'jupyterlab': ['jupyterlab-code-formatter>=1.4.10,<2.0.0',
                ...
                'jedi-language-server>=0.35.1,<0.36.0'],
