...
class OperationTarget(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, target_key, target_type, crop_type, mass, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, target_key, target_type, crop_type, mass, *args, **kwargs):  
        """OperationTarget - a model defined in OpenAPI
