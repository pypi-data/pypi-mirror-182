...
class OperationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Operation type. ., must be one of ["HARVEST", "STORAGE", "DRYING", "MOVEMENT", "TRANSFER", "CONSUMPTION", "SELLING", "BUYING", ]  

        Keyword Args:
            value (str): Operation type. ., must be one of ["HARVEST", "STORAGE", "DRYING", "MOVEMENT", "TRANSFER", "CONSUMPTION", "SELLING", "BUYING", ]  
