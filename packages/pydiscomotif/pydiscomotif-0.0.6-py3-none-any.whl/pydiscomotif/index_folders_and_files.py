...
def get_index_folders_and_files(index_folder_path: Path) -> Tuple[List[Path], List[Path]]:
    ...
    folders = [ 
        index_folder_path / 'C_alpha_distance',
        index_folder_path / 'sidechain_CMR_distance',
        index_folder_path / 'vector_angle',
        index_folder_path / 'residue_data_folder' # This is where residue data, extracted from parsing PDB files, is temporarily saved as a pickled and compressed file.
    ]
    files = [
