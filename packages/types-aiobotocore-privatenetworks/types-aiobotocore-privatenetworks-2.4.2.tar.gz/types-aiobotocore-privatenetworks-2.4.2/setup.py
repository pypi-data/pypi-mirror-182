...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.Private5G 2.4.2 service generated with mypy-boto3-builder"
        " 7.12.2"
    ),
    classifiers=[
    ...
    keywords="aiobotocore privatenetworks type-annotations boto3-stubs mypy typeshed autocomplete",
