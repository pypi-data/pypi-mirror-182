...
@jsii.implements(aws_cdk.aws_appsync_alpha.ISchema)
class CodeFirstSchema(
    ...
    def bind(
        self,
        api: aws_cdk.aws_appsync_alpha.IGraphqlApi,
    ) -> aws_cdk.aws_appsync_alpha.ISchemaConfig:
        '''Called when the GraphQL Api is initialized to allow this object to bind to the stack.

        :param api: The binding GraphQL Api.
        '''
        if __debug__:
            def stub(api: aws_cdk.aws_appsync_alpha.IGraphqlApi) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument api", value=api, expected_type=type_hints["api"])
        _options = aws_cdk.aws_appsync_alpha.SchemaBindOptions()

        return typing.cast(aws_cdk.aws_appsync_alpha.ISchemaConfig, jsii.invoke(self, "bind", [api, _options]))
...
class Directive(metaclass=jsii.JSIIMeta, jsii_type="awscdk-appsync-utils.Directive"):
    ...
    def mode(self) -> typing.Optional[aws_cdk.aws_appsync_alpha.AuthorizationType]:
        '''The authorization type of this directive.

        :default: - not an authorization directive
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_appsync_alpha.AuthorizationType], jsii.get(self, "mode"))
    ...
    def _modes(
        self,
    ) -> typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.AuthorizationType]]:
        '''the authorization modes for this intermediate type.'''
        return typing.cast(typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.AuthorizationType]], jsii.get(self, "modes"))

    @_modes.setter
    def _modes(
        self,
        value: typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.AuthorizationType]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.AuthorizationType]],
...
class IField(typing_extensions.Protocol):
    ...
    def directives_to_string(
        self,
        modes: typing.Optional[typing.Sequence[aws_cdk.aws_appsync_alpha.AuthorizationType]] = None,
    ) -> builtins.str:
...
class IIntermediateType(typing_extensions.Protocol):
    ...
    def resolvers(
        self,
    ) -> typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.Resolver]]:
    ...
    def resolvers(
        self,
        value: typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.Resolver]],
    ) -> None:
        ...
...
class _IIntermediateTypeProxy:
    ...
    def resolvers(
        ...
        '''The resolvers linked to this data source.'''
        return typing.cast(typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.Resolver]], jsii.get(self, "resolvers"))
...
class ObjectType(
    ...
    def _generate_resolver(
        ...
        field_name: builtins.str,
        *,
        data_source: typing.Optional[aws_cdk.aws_appsync_alpha.BaseDataSource] = None,
        pipeline_config: typing.Optional[typing.Sequence[aws_cdk.aws_appsync_alpha.IAppsyncFunction]] = None,
        request_mapping_template: typing.Optional[aws_cdk.aws_appsync_alpha.MappingTemplate] = None,
        response_mapping_template: typing.Optional[aws_cdk.aws_appsync_alpha.MappingTemplate] = None,
        return_type: "GraphqlType",
        args: typing.Optional[typing.Mapping[builtins.str, "GraphqlType"]] = None,
        directives: typing.Optional[typing.Sequence[Directive]] = None,
    ) -> aws_cdk.aws_appsync_alpha.Resolver:
        ...
        return typing.cast(aws_cdk.aws_appsync_alpha.Resolver, jsii.invoke(self, "generateResolver", [api, field_name, options]))
...
class ResolvableFieldOptions(FieldOptions):
    ...
    @builtins.property
    def data_source(self) -> typing.Optional[aws_cdk.aws_appsync_alpha.BaseDataSource]:
        '''The data source creating linked to this resolvable field.

        :default: - no data source
        '''
        result = self._values.get("data_source")
        return typing.cast(typing.Optional[aws_cdk.aws_appsync_alpha.BaseDataSource], result)

    @builtins.property
    def pipeline_config(
        self,
    ) -> typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.IAppsyncFunction]]:
        ...
        return typing.cast(typing.Optional[typing.List[aws_cdk.aws_appsync_alpha.IAppsyncFunction]], result)

    @builtins.property
    def request_mapping_template(
        self,
    ) -> typing.Optional[aws_cdk.aws_appsync_alpha.MappingTemplate]:
        '''The request mapping template for this resolver.

        :default: - No mapping template
        '''
        result = self._values.get("request_mapping_template")
        return typing.cast(typing.Optional[aws_cdk.aws_appsync_alpha.MappingTemplate], result)
...
class GraphqlType(
    ...
    def directives_to_string(
        self,
        _modes: typing.Optional[typing.Sequence[aws_cdk.aws_appsync_alpha.AuthorizationType]] = None,
    ) -> builtins.str:
        '''Generate the directives for this field.
