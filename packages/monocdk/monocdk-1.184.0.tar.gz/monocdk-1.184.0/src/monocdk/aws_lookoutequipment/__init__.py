...
class CfnInferenceScheduler(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        data_input_configuration: typing.Union[typing.Union["CfnInferenceScheduler.DataInputConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_a771d0ef],
        data_output_configuration: typing.Union[typing.Union["CfnInferenceScheduler.DataOutputConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_a771d0ef],
    ...
    def data_input_configuration(
        self,
    ) -> typing.Union["CfnInferenceScheduler.DataInputConfigurationProperty", _IResolvable_a771d0ef]:
        ...
        '''
        return typing.cast(typing.Union["CfnInferenceScheduler.DataInputConfigurationProperty", _IResolvable_a771d0ef], jsii.get(self, "dataInputConfiguration"))

    @data_input_configuration.setter
    def data_input_configuration(
        self,
        value: typing.Union["CfnInferenceScheduler.DataInputConfigurationProperty", _IResolvable_a771d0ef],
    ) -> None:
        if __debug__:
    ...
    def data_output_configuration(
        self,
    ) -> typing.Union["CfnInferenceScheduler.DataOutputConfigurationProperty", _IResolvable_a771d0ef]:
        ...
        '''
        return typing.cast(typing.Union["CfnInferenceScheduler.DataOutputConfigurationProperty", _IResolvable_a771d0ef], jsii.get(self, "dataOutputConfiguration"))

    @data_output_configuration.setter
    def data_output_configuration(
        self,
        value: typing.Union["CfnInferenceScheduler.DataOutputConfigurationProperty", _IResolvable_a771d0ef],
    ) -> None:
        if __debug__:
...
class CfnInferenceSchedulerProps:
    ...
    def data_input_configuration(
        ...
        return typing.cast(typing.Union[CfnInferenceScheduler.DataInputConfigurationProperty, _IResolvable_a771d0ef], result)
    ...
    def data_output_configuration(
        ...
        return typing.cast(typing.Union[CfnInferenceScheduler.DataOutputConfigurationProperty, _IResolvable_a771d0ef], result)
