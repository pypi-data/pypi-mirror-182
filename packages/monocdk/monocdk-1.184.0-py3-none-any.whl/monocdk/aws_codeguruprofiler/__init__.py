...
class CfnProfilingGroup(
    ...
    def __init__(
        ...
        *,
        ...
        agent_permissions: typing.Optional[typing.Union[typing.Union["CfnProfilingGroup.AgentPermissionsProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ...
    def agent_permissions(
        self,
    ) -> typing.Optional[typing.Union["CfnProfilingGroup.AgentPermissionsProperty", _IResolvable_a771d0ef]]:
        ...
        *Principals* : A list of string ARNs for the roles and users you want to grant access to the profiling group. Wildcards are not supported in the ARNs. You are allowed to provide up to 50 ARNs. An empty list is not permitted. This is a required key.
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnProfilingGroup.AgentPermissionsProperty", _IResolvable_a771d0ef]], jsii.get(self, "agentPermissions"))

    @agent_permissions.setter
    def agent_permissions(
        self,
        value: typing.Optional[typing.Union["CfnProfilingGroup.AgentPermissionsProperty", _IResolvable_a771d0ef]],
    ) -> None:
        if __debug__:
...
class CfnProfilingGroupProps:
    ...
    def agent_permissions(
        ...
        *Principals* : A list of string ARNs for the roles and users you want to grant access to the profiling group. Wildcards are not supported in the ARNs. You are allowed to provide up to 50 ARNs. An empty list is not permitted. This is a required key.
        ...
        return typing.cast(typing.Optional[typing.Union[CfnProfilingGroup.AgentPermissionsProperty, _IResolvable_a771d0ef]], result)
