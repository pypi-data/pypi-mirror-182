...
{'': ['*'],
 'cli': ['resources/*'],
 'dsdl': ['dsdl_library/class/*', 'dsdl_library/task/*'],
 'dsdl.test': ['dsdl_test/datasets/classification/Caltech-256/*',
               'dsdl_test/datasets/classification/Caltech-256/annotations/json/*',
               'dsdl_test/datasets/classification/Food-101/*',
               'dsdl_test/datasets/classification/Food-101/annotations/json/*',
               'dsdl_test/datasets/classification/MNIST/*',
               'dsdl_test/datasets/classification/MNIST/annotations/json/*',
               'dsdl_test/datasets/classification/Oxford_102_Flower/*',
               'dsdl_test/datasets/classification/Oxford_102_Flower/annotations/json/*',
               'dsdl_test/datasets/classification/STL-10/*',
               'dsdl_test/datasets/classification/STL-10/annotations/json/*',
               'dsdl_test/datasets/classification/UCF101/*',
               'dsdl_test/datasets/classification/UCF101/annotations/json/*',
               'dsdl_test/datasets/detection/BDD100KImages/*',
               'dsdl_test/datasets/detection/BDD100KImages/annotations/json/*',
               'dsdl_test/datasets/detection/CityPersons/*',
               'dsdl_test/datasets/detection/CityPersons/annotations/json/*',
               'dsdl_test/datasets/detection/FGVC_Aircraft/*',
               'dsdl_test/datasets/detection/FGVC_Aircraft/annotations/json/*',
               'dsdl_test/datasets/detection/KITTI_Object/*',
               'dsdl_test/datasets/detection/KITTI_Object/annotations/json/*',
               'dsdl_test/datasets/detection/xBD/*',
               'dsdl_test/datasets/detection/xBD/annotations/json/*'],
 'dsdlsdk': ['common/*']}
...
setup_kwargs = {
    ...
    'url': 'https://github.com/opendatalab/dsdl-sdk/tree/dev',
    'packages': packages,
