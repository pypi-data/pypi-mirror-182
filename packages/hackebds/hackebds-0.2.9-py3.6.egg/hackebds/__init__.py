...
def get_version():
    return Fore.GREEN+"Version: 0.2.8"+Fore.RESET
...
def num_get_file_cmd(number, CMD_PATH,CMD, filename):
	fun = hackebds_cmd_dic.get(number)
	return fun(CMD, CMD_PATH ,filename)
...
def main():
	...
	parser.add_argument('-arch', required=False, type=str, help='Target arch architecturet', choices=('mips','mipsel','mips64','mipsel64','armelv5','armelv7','armebv5','armebv7','aarch64','x86','x64','android','powerpc','powerpcle','powerpc64','powerpc64le','sparc','sparc64'))
	...
	parser.add_argument('-cmd_path', required=False, type=str,default=None, help='Commands Path')
	...
	if (args.res == "cmd_file" and args.arch != None and args.encode == False ):
		if(args.cmd != None):
			try:
				num_get_file_cmd(arch_get_number(args.arch), args.cmd_path, args.cmd,args.filename)
				return 
			except Exception as e:
				print(e)
				pass
