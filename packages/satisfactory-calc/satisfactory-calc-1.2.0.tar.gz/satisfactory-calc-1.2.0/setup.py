...
package_name = "satisfactory-calc"
...
setuptools.setup(
    ...
    description="The satisfactory production line can be easily calculated.",   # パッケージの簡単な説明
    ...
    keywords=f"{package_name} satisfactory calc game nicoyou",                  # PyPIでの検索用キーワードをスペース区切りで指定
    classifiers=[
