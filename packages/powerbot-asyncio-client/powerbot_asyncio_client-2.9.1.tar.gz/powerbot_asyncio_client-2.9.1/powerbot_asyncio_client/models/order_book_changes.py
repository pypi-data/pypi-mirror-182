...
class OrderBookChanges(object):
    ...
    def __init__(self, message_class=None, emitted_at=None, contract_id=None, contract_type=None, delivery_area=None, active_since=None, revision=None, sequence_number=None, best_price_changed=None, delta=None, delivery_start=None, delivery_end=None, orders=None, local_vars_configuration=None):  # noqa: E501
