...
class TradesApi(object):
    ...
    def get_internal_trades_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_internal_trades`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_trades_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_trades`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
