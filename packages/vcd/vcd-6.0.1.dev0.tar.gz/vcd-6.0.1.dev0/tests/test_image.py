...
class TestBasic(unittest.TestCase):
    def test_polygon2D(self):
        ...
        poly1 = types.poly2d(
            "poly1",
            (5, 5, 10, 5, 11, 6, 11, 8, 9, 10, 5, 10, 3, 8, 3, 6, 4, 5),
    ...
    def test_create_image_png(self):
        ...
        payload_b64_bytes = base64.b64encode(
            payload
        )  # starts with b' (NOT SERIALIZABLE!)
    ...
    def test_contours(self):
        ...
        for class_name, color in classes_colors.items():
            ...
            for idx, contour in enumerate(contours):
                ...
                vcd.add_object_data(
                    ...
                    types.poly2d(
                        "contour"
                        + str(idx),  # WARNING: In VCD 4.3.0, names MUST be unique
                        points,
                        types.Poly2DType.MODE_POLY2D_SRF6DCC,
                        closed=True,
        ...
        for class_name, contours in contours_dict.items():
            ...
            cv.drawContours(
                img_out, contours, -1, color, hierarchy=hierarchy_array, thickness=-1
            )
