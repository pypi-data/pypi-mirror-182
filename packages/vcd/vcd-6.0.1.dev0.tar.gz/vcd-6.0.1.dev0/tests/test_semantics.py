...
class TestBasic(unittest.TestCase):
    ...
    def test_semantics(self):
        ...
        officeUID = vcd.add_context(
            "Office", "#Office", frame_value=None, uid=None, ont_uid=ont_uid_0
        )

        for frameNum in range(0, 30):
            if frameNum == 3:
                startTalkingUID = vcd.add_event(
                    "StartTalking",
                    "#StartTalking",
                    frameNum,
                    uid=None,
                ...
                talkingUID = vcd.add_action(
                    "Talking", "#Talking", frameNum, uid=None, ont_uid=ont_uid_0
                )
                noisyUID = vcd.add_context("Noisy", "", frameNum)  # No ontology

                relation1UID = vcd.add_relation_subject_object(
                    "",
                    "#Starts",
                    core.ElementType.event,
                    startTalkingUID,
                    core.ElementType.action,
                    talkingUID,
                    relation_uid=None,
                    ont_uid=ont_uid_0,
                    frame_value=None,
                ...
                relation2UID = vcd.add_relation_subject_object(
                    "",
                    "#Causes",
                    core.ElementType.action,
                    talkingUID,
                    core.ElementType.context,
                    noisyUID,
                    relation_uid=None,
                    ont_uid=ont_uid_0,
                    frame_value=None,
                ...
                self.assertEqual(
                    len(vcd.get_relation(relation2UID)["rdf_subjects"]),
                    1,
                    "Should be 1",
                )
                self.assertEqual(
                    vcd.get_relation(relation2UID)["rdf_subjects"][0]["uid"],
                    talkingUID,
                    "Should be equal",
                )
    ...
    def test_actions(self):
        ...
        # 3.- Add some objects
        uid_pedestrian1 = vcd_a.add_object(
            name="", semantic_type="Pedestrian", frame_value=None, ont_uid="0"
        )  # therefore its uri is "http://vcd.vicomtech.org/ontology/automotive/#Pedestrian"
        uid_car1 = vcd_a.add_object(
            name="", semantic_type="Car", frame_value=None, ont_uid="0"
        )
        uid_pedestrian1 = vcd_b.add_object(
            name="", semantic_type="Pedestrian", frame_value=None, ont_uid="0"
        )
        uid_car1 = vcd_b.add_object(
            name="", semantic_type="Car", frame_value=None, ont_uid="0"
        )
        uid_pedestrian1 = vcd_c.add_object(
            name="", semantic_type="Pedestrian", frame_value=None, ont_uid="0"
        )
        uid_car1 = vcd_c.add_object(
            name="", semantic_type="Car", frame_value=None, ont_uid="0"
        )
        ...
        vcd_a.add_object_data(
            uid=uid_pedestrian1, object_data=types.text(name="action", val="Walking")
        )
        vcd_a.add_object_data(
            uid=uid_car1, object_data=types.text(name="action", val="Parked")
        )
        ...
        uid_action1 = vcd_b.add_action(
            name="", semantic_type="Walking", frame_value=None, ont_uid="0"
        )
        uid_rel1 = vcd_b.add_relation(
            name="", semantic_type="performsAction", ont_uid="0"
        )
        vcd_b.add_rdf(
            relation_uid=uid_rel1,
            rdf_type=core.RDF.subject,
            element_uid=uid_pedestrian1,
            element_type=core.ElementType.object,
        )
        vcd_b.add_rdf(
            relation_uid=uid_rel1,
            rdf_type=core.RDF.object,
            element_uid=uid_action1,
            element_type=core.ElementType.action,
        )

        uid_action2 = vcd_b.add_action(
            name="", semantic_type="Parked", frame_value=None, ont_uid="0"
        )
        uid_rel2 = vcd_b.add_relation(
            name="", semantic_type="performsAction", ont_uid="0"
        )
        vcd_b.add_rdf(
            relation_uid=uid_rel2,
            rdf_type=core.RDF.subject,
            element_uid=uid_car1,
            element_type=core.ElementType.object,
        )
        vcd_b.add_rdf(
            relation_uid=uid_rel2,
            rdf_type=core.RDF.object,
            element_uid=uid_action2,
            element_type=core.ElementType.action,
        )
        ...
        # Con: sames as a
        uid_action1 = vcd_c.add_action(
            name="", semantic_type="Walking", frame_value=None, ont_uid="0"
        )
        uid_action2 = vcd_c.add_action(
            name="", semantic_type="Parked", frame_value=None, ont_uid="0"
        )
        vcd_c.add_action_data(
            uid=uid_action1,
            action_data=types.num(name="subject", val=int(uid_pedestrian1)),
        )
        vcd_c.add_action_data(
            uid=uid_action2, action_data=types.num(name="subject", val=int(uid_car1))
        )
        ...
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_actions_a.json"),
            )
        )
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_actions_b.json"),
            )
        )
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_actions_c.json"),
            )
        )
    ...
    def test_relations(self):
        ...
        self.assertEqual(
            vcd.data["openlabel"]["relations"]["0"]["frame_intervals"][0][
                "frame_start"
            ],
            0,
        )
        self.assertEqual(
            vcd.data["openlabel"]["relations"]["0"]["frame_intervals"][0]["frame_end"],
            10,
        )
        ...
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_relations_1.json"),
            )
        )
        ...
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_relations_2.json"),
            )
        )
        ...
        uid4 = vcd.add_relation_object_object(
            name="", semantic_type="isNear", object_uid_1=uid1, object_uid_2=uid2
        )
        ...
        self.assertTrue(
            check_openlabel(
                ...
                Path(__file__).parent.resolve()
                / "etc"
                / str(openlabel_version_name + "_test_relations_3.json"),
            )
        )
    ...
    def test_scene_KITTI_Tracking_3(self):
        ...
        vcd_file_name = str(
            ...
            / str(
                openlabel_version_name
                + "_kitti_tracking_"
                + str(sequence_number).zfill(4)
                + ".json"
            )
        )
        vcd = core.OpenLABEL()
        vcd.load_from_file(vcd_file_name)
        ...
        vcd.add_metadata_properties(
            {
                "cnl_text": "In a city, being sunny, the ego-vehicle drives in the left lane of a single-way two-lanes road, Two other cars drive in the right lane. When the cars pass the ego-vehicle, then the ego-vehicle changes to the right lane, and then the ego-vehicle drives in the right lane."
            }
        )
        ...
        vcd.add_element_data(
            element_type=core.ElementType.object,
            uid=uid_lane_left,
            element_data=types.text(name="Position", val="Left"),
        )
        vcd.add_element_data(
            element_type=core.ElementType.object,
            uid=uid_lane_right,
            element_data=types.text(name="Position", val="Right"),
        )
        vcd.add_element_data(
            element_type=core.ElementType.object,
            uid=uid_road,
            element_data=types.text(name="Direction", val="Single-way"),
        )
        vcd.add_element_data(
            element_type=core.ElementType.object,
            uid=uid_road,
            element_data=types.num(name="NumberOfLanes", val=2),
        )
        ...
        uid_action_drive_straight_1 = vcd.add_action(
            name="DriveStraight1", semantic_type="DriveStraight", frame_value=[(0, 31)]
        )  # Approx. at frame 31, the ego vehicle starts changing lane
        vcd.add_relation_object_action(
            name="",
        ...
        uid_action_drive_straight_2 = vcd.add_action(
            ...
            frame_value=vcd.get_element_frame_intervals(
                element_type=core.ElementType.object, uid=uid_car_a
            ).get(),
        )
        vcd.add_relation_object_action(
            name="",
        ...
        uid_action_drive_straight_3 = vcd.add_action(
            ...
            semantic_type="DriveStraight",
            frame_value=vcd.get_element_frame_intervals(
                element_type=core.ElementType.object, uid=uid_car_b
            ).get(),
        )
        vcd.add_relation_object_action(
            name="",
        ...
        uid_action_lane_change = vcd.add_action(
            name="LaneChange1", semantic_type="LaneChange", frame_value=[(33, 75)]
        )
        vcd.add_relation_object_action(
            name="",
            semantic_type="isSubjectOfAction",
        ...
        uid_event_pass = vcd.add_event(
            name="Pass1", semantic_type="Pass", frame_value=32
        )
        vcd.add_relation_subject_object(
            name="",
