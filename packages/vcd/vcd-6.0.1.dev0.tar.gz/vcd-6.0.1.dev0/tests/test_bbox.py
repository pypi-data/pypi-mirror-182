...
class TestBasic(unittest.TestCase):
    def test_bbox_simple(self):
        ...
        zebracross1 = openlabel.add_object(
            name="zebracross1", semantic_type="ZebraCross"
        )
        ...
        openlabel.add_object_data(
            uid=car1,
            object_data=types.bbox(
                name="shape", val=[410 + 52 / 2, 280 + 47 / 2, 52, 47]
            ),
        )
        openlabel.add_object_data(
            uid=bus1,
            object_data=types.bbox(
                name="shape", val=[468 + 56 / 2, 266 + 47 / 2, 56, 47]
            ),
        )
        openlabel.add_object_data(
            uid=car2,
            object_data=types.bbox(
                name="shape", val=[105 + 96 / 2, 280 + 34 / 2, 96, 34]
            ),
        )
        openlabel.add_object_data(
            uid=car3,
            object_data=types.bbox(
                name="shape", val=[198 + 63 / 2, 280 + 42 / 2, 63, 42]
            ),
        )
        openlabel.add_object_data(
            uid=semaphore1,
            object_data=types.bbox(
                name="shape", val=[167 + 38 / 2, 80 + 80 / 2, 38, 81]
            ),
        )
        openlabel.add_object_data(
            uid=semaphore2,
            object_data=types.bbox(
                name="shape", val=[885 + 32 / 2, 145 + 63 / 2, 32, 63]
            ),
        )
        openlabel.add_object_data(
            uid=zebracross1,
            object_data=types.bbox(
                name="shape", val=[291 + 524 / 2, 358 + 55 / 2, 524, 55]
            ),
        )
