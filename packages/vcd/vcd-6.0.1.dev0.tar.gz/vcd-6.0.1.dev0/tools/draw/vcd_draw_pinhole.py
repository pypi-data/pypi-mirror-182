...
def read_camera_pinhole():
    ...
    vcd.add_coordinate_system(
        name="camera_pinhole", cs_type=types.CoordinateSystemType.sensor_cs
    )
    vcd.add_stream(
        stream_name="camera_pinhole",
        uri="",
        description="USB camera with radial distortion",
    ...
    vcd.add_stream_properties(
        ...
        intrinsics=types.IntrinsicsPinhole(
            ...
            camera_matrix_3x4=utils.fromCameraMatrix3x3toCameraMatrix3x4(camera_matrix)
            .flatten()
            .tolist(),
