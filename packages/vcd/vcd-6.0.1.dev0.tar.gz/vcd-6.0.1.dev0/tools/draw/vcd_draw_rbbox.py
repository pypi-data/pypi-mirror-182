...
vcd.add_object_data(
    uid=uid1, object_data=types.rbbox(name="shape1", val=[250, 100, 40, 100, 0.0])
)
vcd.add_object_data(
    uid=uid1, object_data=types.rbbox(name="shape2", val=[250, 100, 40, 100, 0.5])
)
vcd.add_object_data(
    uid=uid1, object_data=types.rbbox(name="shape3", val=[250, 100, 40, 100, 1.56])
)
...
box1 = np.int0(
    cv.boxPoints(
        ((rbbox1[0], rbbox1[1]), (rbbox1[2], rbbox1[3]), rbbox1[4] * 180.0 / np.pi)
    )
)
rbbox2 = vcd.get_element_data(core.ElementType.object, uid1, "shape2")["val"]
box2 = np.int0(
    cv.boxPoints(
        ((rbbox2[0], rbbox2[1]), (rbbox2[2], rbbox2[3]), rbbox2[4] * 180.0 / np.pi)
    )
)
rbbox3 = vcd.get_element_data(core.ElementType.object, uid1, "shape3")["val"]
box3 = np.int0(
    cv.boxPoints(
        ((rbbox3[0], rbbox3[1]), (rbbox3[2], rbbox3[3]), rbbox3[4] * 180.0 / np.pi)
    )
)
