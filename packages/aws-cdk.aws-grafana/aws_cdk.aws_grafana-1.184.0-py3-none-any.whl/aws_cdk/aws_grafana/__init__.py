...
class CfnWorkspace(
    ...
    Don't use ``CreateWorkspace`` to modify an existing workspace. Instead, use `UpdateWorkspace <https://docs.aws.amazon.com/grafana/latest/APIReference/API_UpdateWorkspace.html>`_ .
    ...
    def __init__(
        ...
        *,
        ...
        saml_configuration: typing.Optional[typing.Union[typing.Union["CfnWorkspace.SamlConfigurationProperty", typing.Dict[builtins.str, typing.Any]], _aws_cdk_core_f4b25747.IResolvable]] = None,
        ...
        :param data_sources: Specifies the AWS data sources that have been configured to have IAM roles and permissions created to allow Amazon Managed Grafana to read data from these sources.
        ...
        :param permission_type: If this is ``Service Managed`` , Amazon Managed Grafana automatically creates the IAM roles and provisions the permissions that the workspace needs to use AWS data sources and notification channels. If this is ``CUSTOMER_MANAGED`` , you manage those roles and permissions yourself. If you are creating this workspace in a member account of an organization and that account is not a delegated administrator account, and you want the workspace to access data sources in other AWS accounts in the organization, you must choose ``CUSTOMER_MANAGED`` . For more information, see `Amazon Managed Grafana permissions and policies for AWS data sources and notification channels <https://docs.aws.amazon.com/grafana/latest/userguide/AMG-manage-permissions.html>`_
    ...
    def permission_type(self) -> typing.Optional[builtins.str]:
        ...
        For more information, see `Amazon Managed Grafana permissions and policies for AWS data sources and notification channels <https://docs.aws.amazon.com/grafana/latest/userguide/AMG-manage-permissions.html>`_
    ...
    def saml_configuration(
        self,
    ) -> typing.Optional[typing.Union["CfnWorkspace.SamlConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnWorkspace.SamlConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable]], jsii.get(self, "samlConfiguration"))

    @saml_configuration.setter
    def saml_configuration(
        self,
        value: typing.Optional[typing.Union["CfnWorkspace.SamlConfigurationProperty", _aws_cdk_core_f4b25747.IResolvable]],
    ) -> None:
        if __debug__:
...
class CfnWorkspaceProps:
    ...
    def saml_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnWorkspace.SamlConfigurationProperty, _aws_cdk_core_f4b25747.IResolvable]], result)
