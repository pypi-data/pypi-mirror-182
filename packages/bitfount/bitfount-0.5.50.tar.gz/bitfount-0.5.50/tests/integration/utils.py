...
def load_pod_config(config_path: Path, data_path: Path) -> PodConfig:
    ...
    if config.data_config.ignore_cols:
        updated_ignore_cols = {}
        for table_name in config.data_config.ignore_cols:
            updated_ignore_cols[
                f"{table_name}{suffix}"
            ] = config.data_config.ignore_cols[table_name]
        config.data_config.ignore_cols = updated_ignore_cols
