...
class RsCMX_Signaling:
	"""606 total commands, 12 Subgroups, 0 group commands"""
	_driver_options = "SupportedInstrModels = CMX/CMW, SupportedIdnPatterns = CMX/CMW, SimulationIdnString = 'Rohde&Schwarz,CMX,100001,4.0.120.0013'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '4.0.120.0013'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '4.0.120.0013'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCMX_Signaling version failed. Current version: '4.0.120.0013', minimum required version: '{min_version}'")
	...
	@property
	def signaling(self):
		"""signaling commands group. 11 Sub-classes, 0 commands."""
