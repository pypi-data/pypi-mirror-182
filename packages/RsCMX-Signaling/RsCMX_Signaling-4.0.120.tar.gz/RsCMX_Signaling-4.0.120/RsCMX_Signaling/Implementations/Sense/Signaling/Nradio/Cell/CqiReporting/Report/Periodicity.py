...
class PeriodicityCls:
	...
	def get(self, cell_name: str) -> enums.PeriodicityReport:
		"""SCPI: SENSe:SIGNaling:NRADio:CELL:CQIReporting:REPort:PERiodicity \n
		Snippet: value: enums.PeriodicityReport = driver.sense.signaling.nradio.cell.cqiReporting.report.periodicity.get(cell_name = '1') \n
		Queries the periodicity of CSI reports,
		configured indirectly via [CONFigure:]SIGNaling:NRADio:CELL:CQIReporting:PERiodicity. \n
		...
		return Conversions.str_to_scalar_enum(response, enums.PeriodicityReport)
