...
class ResourceCls:
	...
	def set(self, structure: SetStruct) -> None:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:RESource \n
		Snippet with structure: \n
		structure = driver.configure.signaling.nradio.cell.srs.resource.resource.SetStruct() \n
		...
		driver.configure.signaling.nradio.cell.srs.resource.resource.set(structure) \n
		No command help available \n
			:param structure: for set value, see the help for SetStruct structure arguments.
		"""
		self._core.io.write_struct(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:RESource', structure)
	...
	def get(self, cell_name: str, resource_no: int) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:RESource \n
		Snippet: value: GetStruct = driver.configure.signaling.nradio.cell.srs.resource.resource.get(cell_name = '1', resource_no = 1) \n
		No command help available \n
		...
		return self._core.io.query_struct(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:RESource? {param}'.rstrip(), self.__class__.GetStruct())
