...
class TcombCls:
	...
	def set(self, cell_name: str, resource_no: int, ktc: enums.Ktc = None, offset: int = None, cyclic_shift: int = None) -> None:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:TCOMb \n
		Snippet: driver.configure.signaling.nradio.cell.srs.resource.tcomb.set(cell_name = '1', resource_no = 1, ktc = enums.Ktc.N2, offset = 1, cyclic_shift = 1) \n
		...
		self._core.io.write(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:TCOMb {param}'.rstrip())
	...
	def get(self, cell_name: str, resource_no: int) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:TCOMb \n
		Snippet: value: GetStruct = driver.configure.signaling.nradio.cell.srs.resource.tcomb.get(cell_name = '1', resource_no = 1) \n
		No command help available \n
			:param cell_name: No help available
			:param resource_no: No help available
		...
		return self._core.io.query_struct(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:TCOMb? {param}'.rstrip(), self.__class__.GetStruct())
