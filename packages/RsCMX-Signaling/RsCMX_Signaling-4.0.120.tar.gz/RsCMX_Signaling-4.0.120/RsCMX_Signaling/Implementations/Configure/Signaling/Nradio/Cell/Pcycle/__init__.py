...
class PcycleCls:
	"""Pcycle commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def popFrame(self):
		"""popFrame commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_popFrame'):
			from .PopFrame import PopFrameCls
			self._popFrame = PopFrameCls(self._core, self._cmd_group)
		return self._popFrame
