...
class UplinkCls:
	"""Uplink commands group definition. 6 total commands, 6 Subgroups, 0 group commands"""
	...
	@property
	def txRx(self):
		"""txRx commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_txRx'):
			from .TxRx import TxRxCls
			self._txRx = TxRxCls(self._core, self._cmd_group)
		return self._txRx
