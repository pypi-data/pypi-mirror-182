...
class CellCls:
	"""Cell commands group definition. 205 total commands, 21 Subgroups, 0 group commands"""
	...
	@property
	def mconfig(self):
		"""mconfig commands group. 6 Sub-classes, 0 commands."""
	...
	def cqiReporting(self):
		"""cqiReporting commands group. 4 Sub-classes, 0 commands."""
	...
	@property
	def cdrx(self):
		"""cdrx commands group. 9 Sub-classes, 0 commands."""
	...
	@property
	def pcycle(self):
		"""pcycle commands group. 3 Sub-classes, 0 commands."""
	...
	@property
	def srs(self):
		"""srs commands group. 9 Sub-classes, 0 commands."""
