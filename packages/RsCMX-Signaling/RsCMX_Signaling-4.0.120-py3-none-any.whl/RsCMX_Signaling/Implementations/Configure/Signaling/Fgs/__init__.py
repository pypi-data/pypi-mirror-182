...
class FgsCls:
	"""Fgs commands group definition. 18 total commands, 5 Subgroups, 1 group commands"""
	...
	@property
	def nbehavior(self):
		"""nbehavior commands group. 0 Sub-classes, 2 commands."""
	...
	@property
	def nas(self):
		"""nas commands group. 2 Sub-classes, 0 commands."""
	...
	def get_tmode(self) -> bool:
		...
		Selects whether an 'ACTIVATE TEST MODE' message is sent to the UE during registration in a 5G tracking area, or not.
