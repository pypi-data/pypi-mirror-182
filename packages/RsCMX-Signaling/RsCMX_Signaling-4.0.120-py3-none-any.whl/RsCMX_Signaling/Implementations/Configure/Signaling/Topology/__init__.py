...
class TopologyCls:
	"""Topology commands group definition. 12 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def plmn(self):
		"""plmn commands group. 3 Sub-classes, 0 commands."""
	...
	@property
	def eps(self):
		"""eps commands group. 3 Sub-classes, 0 commands."""
	...
	@property
	def fgs(self):
		"""fgs commands group. 4 Sub-classes, 0 commands."""
