...
class FhoppingCls:
	...
	def set(self, cell_name: str, resource_no: int, csrs: int, bsrs: int = None, bhop: int = None) -> None:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:FHOPping \n
		Snippet: driver.configure.signaling.nradio.cell.srs.resource.fhopping.set(cell_name = '1', resource_no = 1, csrs = 1, bsrs = 1, bhop = 1) \n
		...
		self._core.io.write(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:FHOPping {param}'.rstrip())
	...
	def get(self, cell_name: str, resource_no: int) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:SRS:RESource:FHOPping \n
		Snippet: value: GetStruct = driver.configure.signaling.nradio.cell.srs.resource.fhopping.get(cell_name = '1', resource_no = 1) \n
		No command help available \n
			:param cell_name: No help available
			:param resource_no: No help available
		...
		return self._core.io.query_struct(f'CONFigure:SIGNaling:NRADio:CELL:SRS:RESource:FHOPping? {param}'.rstrip(), self.__class__.GetStruct())
