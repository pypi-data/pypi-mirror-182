...
class img_control():
    ...
    # Draw CenterLine
    def draw_CenterLine(self, img, draw=False):
        if draw:
    ...
    # Texting
    def insert_Text(self, img, msg, draw=False, ):
        if draw:
    ...
    # get Canny
    def get_Canny(self, img, kernel_size, threshold1, threshold2):
        # 00. Make a Copy
        img_copy = img.copy()
    ...
    def get_Threshold(self, img_edge, kernel_size, iter_d, iter_e):
        img_edge2 = img_edge
        kernel2 = kernel_size
        kernel2 = (kernel2 * 2) + 1
    ...
    # Contour
    def get_Contour(self, img_org, img_th, minArea, ariga=False):
        img_thresh = img_th
    ...
    # Get Masked Image
    def get_masked_image(self, img_src, contours, mask_flag=False):
