...
from nornir_maze.configuration_management.cli.show_tasks import write_commands_to_file
...
def pyats_create_testbed(nr_obj: Nornir, pyats_testbed_file: str) -> None:
    """
...
def pyats_update_golden_cleanup(
    nr_obj: Nornir, config_status: bool, task_text: str, pyats: dict, verbose: bool = False
) -> Union[str, None]:
    """
