            ...
            try:
                ...
                values = [
                        (
                            ...
                            get_link_table(catalog_name, 'silver', output_db_table)
                        )
                    ]
                ...
                set_comment_table(catalog_name, f'silver.{output_db_table}'  , tbl_properties.get('cortex.description'))
            ...
            try:
                ...
                values = [
                        (
                            ...
                            get_link_table(catalog_name, 'gold', output_db_table)
                        )
                    ]
                df_governance = spark.createDataFrame(values, columns)
                df_governance.write.option("header", "true")\
                    ...
                    .mode('append')\
                    .saveAsTable("cortex.data_governance_quality.tables")
                set_comment_table(catalog_name, f'gold.{output_db_table}'  , tbl_properties.get('cortex.description'))
