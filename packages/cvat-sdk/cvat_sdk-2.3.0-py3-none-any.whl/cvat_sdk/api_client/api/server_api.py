...
from cvat_sdk.api_client.model.advanced_authentication import AdvancedAuthentication
...
class ServerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_advanced_auth_endpoint = _Endpoint(
            settings={
                'response_schema': (AdvancedAuthentication,),
                'auth': [
                    'basicAuth',
                    'csrfAuth',
                    'sessionAuth',
                ...
                'endpoint_path': '/api/server/advanced-auth',
                'operation_id': 'retrieve_advanced_auth',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_advanced_auth(
        ...
        *,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[AdvancedAuthentication], urllib3.HTTPResponse]:
        """Method provides a list with advanced integrated authentication methods (e.g. social accounts)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.retrieve_advanced_auth(_async_call=True)
        >>> result = thread.get()
        ...
        Returns:
            (AdvancedAuthentication, HTTPResponse)
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['_async_call'] = _async_call
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.retrieve_advanced_auth_endpoint.call_with_http_info(**kwargs)
