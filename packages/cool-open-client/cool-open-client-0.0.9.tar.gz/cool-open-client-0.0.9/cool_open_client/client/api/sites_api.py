...
class SitesApi(object):
    ...
    def sites_get(self, x_access_token, **kwargs):  # noqa: E501
        """get my sites  # noqa: E501

        get my sites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_get(x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.sites_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
        else:
            (data) = self.sites_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
            return data

    def sites_get_with_http_info(self, x_access_token, **kwargs):  # noqa: E501
        """get my sites  # noqa: E501

        get my sites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_get_with_http_info(x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_access_token' not in params or
            ...
            raise ValueError("Missing the required parameter `x_access_token` when calling `sites_get`")  # noqa: E501
