...
class UnitsApi(object):
    ...
    def units_get(self, x_access_token, **kwargs):  # noqa: E501
        """get my units  # noqa: E501

        get my units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.units_get(x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.units_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
        else:
            (data) = self.units_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
            return data

    def units_get_with_http_info(self, x_access_token, **kwargs):  # noqa: E501
        """get my units  # noqa: E501

        get my units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.units_get_with_http_info(x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_access_token' not in params or
            ...
            raise ValueError("Missing the required parameter `x_access_token` when calling `units_get`")  # noqa: E501
