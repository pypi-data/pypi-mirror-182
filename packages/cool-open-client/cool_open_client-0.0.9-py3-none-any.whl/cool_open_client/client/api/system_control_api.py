...
class SystemControlApi(object):
    ...
    def systems_system_id_controls_modes_put(self, body, x_access_token, system_id, **kwargs):  # noqa: E501
        """set system active operation mode for all units  # noqa: E501

        set system active operation mode for all units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_system_id_controls_modes_put(body, x_access_token, system_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.systems_system_id_controls_modes_put_with_http_info(body, x_access_token, system_id, **kwargs)  # noqa: E501
        else:
            (data) = self.systems_system_id_controls_modes_put_with_http_info(body, x_access_token, system_id, **kwargs)  # noqa: E501
            return data

    def systems_system_id_controls_modes_put_with_http_info(self, body, x_access_token, system_id, **kwargs):  # noqa: E501
        """set system active operation mode for all units  # noqa: E501

        set system active operation mode for all units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_system_id_controls_modes_put_with_http_info(body, x_access_token, system_id, async_req=True)
        >>> result = thread.get()
    ...
    def systems_system_id_controls_switches_put(self, body, x_access_token, system_id, **kwargs):  # noqa: E501
        """set system active operation status for all units  # noqa: E501

        set system active operation status for all units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_system_id_controls_switches_put(body, x_access_token, system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.systems_system_id_controls_switches_put_with_http_info(body, x_access_token, system_id, **kwargs)  # noqa: E501
        else:
            (data) = self.systems_system_id_controls_switches_put_with_http_info(body, x_access_token, system_id, **kwargs)  # noqa: E501
            return data

    def systems_system_id_controls_switches_put_with_http_info(self, body, x_access_token, system_id, **kwargs):  # noqa: E501
        """set system active operation status for all units  # noqa: E501

        set system active operation status for all units  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_system_id_controls_switches_put_with_http_info(body, x_access_token, system_id, async_req=True)
        >>> result = thread.get()
