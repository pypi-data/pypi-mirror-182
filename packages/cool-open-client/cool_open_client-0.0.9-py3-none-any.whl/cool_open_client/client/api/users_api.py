...
class UsersApi(object):
    ...
    def users_get(self, x_access_token, **kwargs):  # noqa: E501
        """get my users  # noqa: E501

        get my users  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_get(x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.users_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
        else:
            (data) = self.users_get_with_http_info(x_access_token, **kwargs)  # noqa: E501
            return data

    def users_get_with_http_info(self, x_access_token, **kwargs):  # noqa: E501
        """get my users  # noqa: E501

        get my users  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_get_with_http_info(x_access_token, async_req=True)
        >>> result = thread.get()
