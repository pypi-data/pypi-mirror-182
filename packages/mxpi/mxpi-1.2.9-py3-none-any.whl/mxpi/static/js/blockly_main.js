...
function c_list(){
  ...
  $("#c-table").tabulator("setData",[
    ...
    {id:17, name:"MediaPipe-4",  col:"使用MediaPipe进行人体姿态检测",cheese:ce('14')},
    {id:18, name:"目标识别",  col:"进行模型推理、目标识别",cheese:ce('15')},
    {id:19, name:"图像分类",  col:"进行模型推理、图像分类",cheese:ce('16')},
    {id:20, name:"行空板-1",  col:"行空板打开摄像头",cheese:ce('19')},
    {id:21, name:"行空板-2",  col:"行空板进行色块识别",cheese:ce('20')},
    {id:22, name:"行空板-3",  col:"行空板进行目标检测",cheese:ce('21')},
    {id:23, name:"行空板-4",  col:"行空板GET网络天气进行显示",cheese:ce('22')},
    {id:24, name:"行空板-5",  col:"行空板PyQt交互案例",cheese:ce('23')},
    {id:25, name:"行空板-6",  col:"行空板PyQt试试绘制加速度值，需要安装pyqtgraph",cheese:ce('24')},
  ]);
}
var model_lists
function model_list(){
