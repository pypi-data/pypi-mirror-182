...
class RsCMPX_Gprf:
	"""766 total commands, 17 Subgroups, 0 group commands"""
	_driver_options = "SupportedInstrModels = CMX500/CMP/CMW/PVT, SupportedIdnPatterns = CMX/CMP/CMW/PVT, SimulationIdnString = 'Rohde&Schwarz,CMX,100001,4.0.140.0029'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '4.0.140.0029'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '4.0.140.0029'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCMPX_Gprf version failed. Current version: '4.0.140.0029', minimum required version: '{min_version}'")
	...
	@property
	def route(self):
		"""route commands group. 12 Sub-classes, 0 commands."""
	...
	@property
	def trigger(self):
		"""trigger commands group. 12 Sub-classes, 0 commands."""
	...
	@property
	def catalog(self):
		"""catalog commands group. 14 Sub-classes, 0 commands."""
