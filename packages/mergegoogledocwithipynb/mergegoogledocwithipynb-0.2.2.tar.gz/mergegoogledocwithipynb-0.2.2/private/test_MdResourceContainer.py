...
from MergeGoogleDocWithIpynb.Types import BlockType, ResourceType
...
class test_MdResourceContainer(unittest.TestCase):
    ...
    def test_addOnce(self):
        self.mdResourceContainer.add(self.resourceCollector1.exportToMarkdownResource())
    ...
    def test_addTwice(self):
        ...
        self.mdResourceContainer.add(resourceCollector2.exportToMarkdownResource())
