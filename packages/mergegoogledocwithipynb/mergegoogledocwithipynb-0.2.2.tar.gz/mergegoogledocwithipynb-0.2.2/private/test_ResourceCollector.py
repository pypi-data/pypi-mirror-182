...
class test_ResourceCollector(unittest.TestCase):
    ...
    def test_collectFromLocalFile(self):
        ...
        self.assertEqual(expect, resourceCollector.exportToMarkdownResource().replace("\n", ""))
    ...
    def test_failToExport(self):
        resourceCollector = ResourceCollector(ResourceType.MARKDOWN)
        self.assertEqual("", resourceCollector.exportToMarkdownResource())
        ...
        self.assertRaises(ResourceExportException, resourceCollector.exportToMarkdownResource)
