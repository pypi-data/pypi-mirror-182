...
import numpy as np
from lxb_pylib.io.exceptions import BadConversionError, DataExistsError


class Postgres(BaseSQLConnection):
    """
    Handles data transfer from a PostgreSQL database.
    """
    ...
    @classmethod
    def with_config(cls, **kwargs) -> "Postgres":
        """
        Initializes Postgres loader from configuration loader
        """
        return cls(**kwargs)
