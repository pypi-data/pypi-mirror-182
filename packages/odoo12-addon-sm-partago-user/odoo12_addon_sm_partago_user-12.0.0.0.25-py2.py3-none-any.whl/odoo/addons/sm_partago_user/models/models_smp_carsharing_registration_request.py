...
class carsharing_registration_request(models.Model):
  ...
  # accounting_role = fields.Selection([
  #   ('prepayment_membership', 'Prepayment membership')],
  #   ('postpayment_membership','Postpayment membership'),
  #   ('promo_membership','Promo membership'),
  #   ('maintenance_membership','Maintenance membership'),
  #   ('company_membership','Company membership'),
  #   string=_("Accounting role"), default="Prepayment membership")
  ...
  registration_api_endpoint_overwrite = fields.Char(string="Registration API endpoint overwrite")
  ...
  def compute_request(self,task_creation=False):
    ...
    if self.group_index:
      ...
      app_db_utils.update_system_group_from_app_group(self,company.sm_user_person_group)
      app_db_utils.update_system_group_from_app_group(self,company.sm_user_person_group_prepayment)
  ...
  def _compute_registration_group(self):
    ...
    if self.group_index:
      ...
      if self.ba_behaviour == 'no_ba':
        computed_group_index = company.sm_user_person_group
      else:
        computed_group_index = company.sm_user_person_group_prepayment
  ...
  def _compute_send_app_registration_email(self):
    return self.related_member_id.compute_send_app_registration_email(self.registration_api_endpoint_overwrite)
