...
class sm_company(models.Model):
  ...
  elprat_ok_mail_template_id = fields.Many2one('mail.template',
    string=_("El Prat request successful email template"))
  elprat_notok_mail_template_id = fields.Many2one('mail.template',
    string=_("El P rat request NOT successful email template"))