...
from .py2pb import ToProto, ToPyobj, ToPyobjSpec

# =======================================================================================
# = QuoteApi
# =======================================================================================
# QuoteSubscribe
_pyb.RegisterConvertor(protobuf=MsgProto.Quote_QuoteRegisterMsg).Register(QuoteSubscribe)
...
# =======================================================================================
# QuoteRegisterAck
_pyb.RegisterConvertor(protobuf=MsgProto.Quote_RegisterAck).SetPyHandles(
