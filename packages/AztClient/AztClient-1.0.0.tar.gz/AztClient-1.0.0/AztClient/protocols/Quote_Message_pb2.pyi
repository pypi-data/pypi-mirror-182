...
class QuoteRegisterMsg(_MsgProtoBase_Quote_Message_pb2):
...
class RegisterAck(_MsgProtoBase_Quote_Message_pb2):
...
class EQuoteMsgID:
    ...
    KQuoteMsgID_RegisterAck = 11
    KQuoteMsgID_UnRegisterAck = 12
