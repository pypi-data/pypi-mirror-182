...
#   np.argmax - the metric and classifiability are positively correlated
#   np.argmin - the metric and classifiability are negatively correlated
metric_polarity_dict={
    'classification.ACC': np.argmax,
    ...
    'test.Median.CHI2':np.argmax,
    'test.Median.CHI2.max':np.argmax,
