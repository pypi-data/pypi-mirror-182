...
from mastapy.cycloidal import _1423
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self) -> '_1828.TwoDChartDefinition':
    ...
    @property
    def estimated_modifications_from_spline_fit(self) -> '_1828.TwoDChartDefinition':
    ...
    @property
    def modifications_specification(self) -> '_1423.CycloidalDiscModificationsSpecification':
