...
from mastapy.utility.cad_export import _1797
...
class CustomReportCadDrawing(_1737.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1797.StockDrawings':
        ...
        return constructor.new_from_mastapy_type(_1797.StockDrawings)(value) if value is not None else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1797.StockDrawings'):
