...
from mastapy.utility.report import _1732, _1733
...
T = TypeVar('T', bound='_1733.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1732.CustomReportItemContainerCollectionBase, Generic[T]):
    """CustomReportItemContainerCollection
