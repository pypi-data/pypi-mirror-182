...
from mastapy.utility.report import _1736, _1739
...
TItem = TypeVar('TItem', bound='_1739.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1736.CustomReportMultiPropertyItemBase, Generic[TItem]):
    """CustomReportMultiPropertyItem
