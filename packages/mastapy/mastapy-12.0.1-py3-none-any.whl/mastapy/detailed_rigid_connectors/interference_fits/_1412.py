...
from mastapy.bearings.tolerances import _1884, _1869, _1875
...
class InterferenceFitHalfDesign(_1354.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1884.SupportTolerance':
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1869.InnerSupportTolerance':
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1875.OuterSupportTolerance':
