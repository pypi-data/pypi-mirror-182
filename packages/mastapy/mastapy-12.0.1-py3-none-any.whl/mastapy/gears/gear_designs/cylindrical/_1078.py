...
from mastapy.utility.units_and_measurements.measurements import _1633, _1654
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    @property
    def chordal_span(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1633.LengthShort](temp) if temp is not None else None

    @property
    def normal_thickness(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def normal_thickness_at_specified_diameter(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def over_balls(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def over_two_pins_free_pin_method(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def over_two_pins_transverse_method(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def profile_shift(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def profile_shift_coefficient(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1654.Number]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1654.Number](temp) if temp is not None else None

    @property
    def transverse_thickness(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def transverse_thickness_at_specified_diameter(self) -> '_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]':
    ...
    @property
    def tooth_thickness(self) -> 'List[_1028.CylindricalGearToothThicknessSpecification[_1633.LengthShort]]':
