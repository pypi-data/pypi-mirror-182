...
from mastapy.utility.property import _1800
...
class DesignConstraintsCollection(_1793.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1800.DeletableCollectionMember[_937.DesignConstraint]]':
