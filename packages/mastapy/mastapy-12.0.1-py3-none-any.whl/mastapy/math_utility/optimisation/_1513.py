...
from mastapy.math_utility.optimisation import _1515, _1511, _1512
...
class ParetoOptimisationStrategy(_1793.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    @property
    def charts(self) -> 'List[_1515.ParetoOptimisationStrategyChartInformation]':
    ...
    @property
    def inputs(self) -> 'List[_1511.ParetoOptimisationInput]':
    ...
    @property
    def outputs(self) -> 'List[_1512.ParetoOptimisationOutput]':
