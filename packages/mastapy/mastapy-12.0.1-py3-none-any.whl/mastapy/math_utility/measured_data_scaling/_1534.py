...
from mastapy.math_utility import _1469, _1454
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.math_utility.measured_data_scaling import _1535
from mastapy.utility.units_and_measurements.measurements import (
    _1578, _1583, _1587, _1602,
    _1608, _1660, _1659, _1665,
    _1581, _1698, _1691, _1636
)
...
class DataScalingOptions(_0.APIBase):
    ...
    @property
    def weighting(self) -> '_1454.AcousticWeighting':
        ...
        return constructor.new_from_mastapy_type(_1454.AcousticWeighting)(value) if value is not None else None

    @weighting.setter
    def weighting(self, value: '_1454.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Weighting = value

    @property
    def acceleration_reference_values(self) -> '_1535.DataScalingReferenceValues[_1578.Acceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1578.Acceleration](temp) if temp is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_1535.DataScalingReferenceValues[_1583.AngularAcceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1583.AngularAcceleration](temp) if temp is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_1535.DataScalingReferenceValues[_1587.AngularVelocity]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1587.AngularVelocity](temp) if temp is not None else None

    @property
    def energy_reference_values(self) -> '_1535.DataScalingReferenceValues[_1602.Energy]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1602.Energy](temp) if temp is not None else None

    @property
    def force_reference_values(self) -> '_1535.DataScalingReferenceValues[_1608.Force]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1608.Force](temp) if temp is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_1535.DataScalingReferenceValues[_1660.PowerSmallPerArea]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1660.PowerSmallPerArea](temp) if temp is not None else None

    @property
    def power_small_reference_values(self) -> '_1535.DataScalingReferenceValues[_1659.PowerSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1659.PowerSmall](temp) if temp is not None else None

    @property
    def pressure_reference_values(self) -> '_1535.DataScalingReferenceValues[_1665.Pressure]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1665.Pressure](temp) if temp is not None else None

    @property
    def small_angle_reference_values(self) -> '_1535.DataScalingReferenceValues[_1581.AngleSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1581.AngleSmall](temp) if temp is not None else None

    @property
    def small_velocity_reference_values(self) -> '_1535.DataScalingReferenceValues[_1698.VelocitySmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1698.VelocitySmall](temp) if temp is not None else None

    @property
    def torque_reference_values(self) -> '_1535.DataScalingReferenceValues[_1691.Torque]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1691.Torque](temp) if temp is not None else None

    @property
    def very_short_length_reference_values(self) -> '_1535.DataScalingReferenceValues[_1636.LengthVeryShort]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1636.LengthVeryShort](temp) if temp is not None else None
