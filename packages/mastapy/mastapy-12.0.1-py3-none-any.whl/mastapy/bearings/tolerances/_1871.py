...
from mastapy.bearings.tolerances import _1866, _1863
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.bearings import _1850
...
class InterferenceTolerance(_1863.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1866.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1866.BearingToleranceDefinitionOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefinitionOption = value

    @property
    def mounting_point_surface_finish(self) -> '_1850.MountingPointSurfaceFinishes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1850.MountingPointSurfaceFinishes)(value) if value is not None else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1850.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
