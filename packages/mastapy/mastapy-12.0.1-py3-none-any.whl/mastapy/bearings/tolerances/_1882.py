...
from mastapy.bearings.tolerances import _1883, _1878, _1870
...
class SupportDetail(_1870.InterferenceDetail):
    """SupportDetail
    ...
    @property
    def material_source(self) -> '_1883.SupportMaterialSource':
        ...
        return constructor.new_from_mastapy_type(_1883.SupportMaterialSource)(value) if value is not None else None
    ...
    @property
    def radial_specification_method(self) -> '_1878.RadialSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1878.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1878.RadialSpecificationMethod'):
