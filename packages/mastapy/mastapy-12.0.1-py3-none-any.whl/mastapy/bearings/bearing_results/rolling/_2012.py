...
from mastapy.bearings.bearing_results.rolling import _2011, _1960
...
class LoadedThrustBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2011.LoadedThrustBallBearingResults':
