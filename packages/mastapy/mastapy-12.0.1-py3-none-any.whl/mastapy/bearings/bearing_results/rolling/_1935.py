...
from mastapy.math_utility.measured_data import _1532, _1533
...
class ISO14179Settings(_1793.NamedDatabaseItem):
    """ISO14179Settings
    ...
    @property
    def isotr141792001f1_specification_method(self) -> '_2022.PowerRatingF1EstimationMethod':
        ...
        return constructor.new_from_mastapy_type(_2022.PowerRatingF1EstimationMethod)(value) if value is not None else None

    @isotr141792001f1_specification_method.setter
    def isotr141792001f1_specification_method(self, value: '_2022.PowerRatingF1EstimationMethod'):
    ...
    @property
    def power_rating_f0_scaling_factor_one_dimensional_lookup_table(self) -> '_1532.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_one_dimensional_lookup_table(self) -> '_1532.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_scaling_factor_one_dimensional_lookup_table(self) -> '_1532.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_two_dimensional_lookup_table(self) -> '_1533.TwodimensionalFunctionLookupTable':
