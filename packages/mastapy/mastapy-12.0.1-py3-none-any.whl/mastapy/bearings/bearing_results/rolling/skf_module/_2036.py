...
from mastapy.bearings.bearing_results.rolling.skf_module import _2047, _2053
...
class BearingRatingLife(_2053.SKFCalculationResult):
    """BearingRatingLife
    ...
    @property
    def life_model(self) -> '_2047.LifeModel':
