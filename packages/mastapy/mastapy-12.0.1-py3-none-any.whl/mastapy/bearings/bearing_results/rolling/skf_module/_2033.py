...
from mastapy.bearings.bearing_results.rolling.skf_module import _2034, _2053
...
class AdjustedSpeed(_2053.SKFCalculationResult):
    """AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_2034.AdjustmentFactors':
