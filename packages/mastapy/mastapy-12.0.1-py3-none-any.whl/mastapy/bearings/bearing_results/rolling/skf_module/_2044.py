...
class GreaseLifeAndRelubricationInterval(_2053.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease_quantity(self) -> '_2045.GreaseQuantity':
    ...
    @property
    def initial_fill(self) -> '_2046.InitialFill':
