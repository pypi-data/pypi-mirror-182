...
from mastapy.bearings.bearing_results.rolling.skf_module import _2050, _2053
...
class DynamicAxialLoadCarryingCapacity(_2053.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_2050.PermissibleAxialLoad':
