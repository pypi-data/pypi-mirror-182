...
from mastapy.bearings.bearing_results.rolling import _1978, _1967
...
class LoadedNeedleRollerBearingRow(_1967.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1978.LoadedNeedleRollerBearingResults':
