...
from mastapy.bearings.bearing_results.rolling import _1974, _1973, _1960
...
class LoadedFourPointContactBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1974.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1973.LoadedFourPointContactBallBearingRaceResults]':
