...
from mastapy.bearings.bearing_results.rolling import _1997, _1987
...
class LoadedSphericalRollerRadialBearingRow(_1987.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1997.LoadedSphericalRollerRadialBearingResults':
