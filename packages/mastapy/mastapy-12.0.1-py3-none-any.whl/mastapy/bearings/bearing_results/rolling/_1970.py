...
from mastapy.bearings.bearing_results.rolling import _1969, _1960
...
class LoadedDeepGrooveBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1969.LoadedDeepGrooveBallBearingResults':
