...
from mastapy.bearings.bearing_results.rolling import _2014, _1987
...
class LoadedToroidalRollerBearingRow(_1987.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2014.LoadedToroidalRollerBearingResults':
