...
from mastapy.bearings.bearing_results.rolling import _1946, _1987
...
class LoadedAsymmetricSphericalRollerBearingRow(_1987.LoadedRollerBearingRow):
    """LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1946.LoadedAsymmetricSphericalRollerBearingResults':
