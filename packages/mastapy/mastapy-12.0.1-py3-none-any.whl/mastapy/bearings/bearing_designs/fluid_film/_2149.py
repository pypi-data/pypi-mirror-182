...
class PlainOilFedJournalBearing(_2147.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self) -> '_1849.JournalOilFeedType':
        ...
        return constructor.new_from_mastapy_type(_1849.JournalOilFeedType)(value) if value is not None else None

    @feed_type.setter
    def feed_type(self, value: '_1849.JournalOilFeedType'):
    ...
    @property
    def axial_groove_oil_feed(self) -> '_2138.AxialGrooveJournalBearing':
    ...
    @property
    def axial_hole_oil_feed(self) -> '_2139.AxialHoleJournalBearing':
    ...
    @property
    def circumferential_groove_oil_feed(self) -> '_2140.CircumferentialFeedJournalBearing':
