...
class PlainGreaseFilledJournalBearing(_2147.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_2146.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new_from_mastapy_type(_2146.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_2146.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_2148.PlainJournalHousing':
        ...
        if _2148.PlainJournalHousing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_2141.CylindricalHousingJournalBearing':
        ...
        if _2141.CylindricalHousingJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_2142.MachineryEncasedJournalBearing':
        ...
        if _2142.MachineryEncasedJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_2144.PedestalJournalBearing':
        ...
        if _2144.PedestalJournalBearing.TYPE not in temp.__class__.__mro__:
