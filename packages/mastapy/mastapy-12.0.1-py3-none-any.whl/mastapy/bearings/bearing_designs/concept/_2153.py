...
from mastapy.bearings.bearing_designs.concept import _2152, _2154
...
class ConceptAxialClearanceBearing(_2154.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2152.BearingNodePosition':
        ...
        return constructor.new_from_mastapy_type(_2152.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2152.BearingNodePosition'):
