...
from mastapy.bearings import _1844
...
class LinearBearing(_2086.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1844.BearingStiffnessMatrixOption':
        ...
        return constructor.new_from_mastapy_type(_1844.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1844.BearingStiffnessMatrixOption'):
