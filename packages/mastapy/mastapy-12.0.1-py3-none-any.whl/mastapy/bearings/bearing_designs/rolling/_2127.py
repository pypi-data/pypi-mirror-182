...
from mastapy.bearings.bearing_designs.rolling import _2120, _2117
...
class TaperRollerBearing(_2117.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1838.BearingMeasurementType':
        ...
        return constructor.new_from_mastapy_type(_1838.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1838.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_2120.RollerRibDetail':
