...
from mastapy.bearings.bearing_designs.rolling import _2119, _2120, _2118
...
class NonBarrelRollerBearing(_2118.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_2119.RollerEndShape':
        ...
        return constructor.new_from_mastapy_type(_2119.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_2119.RollerEndShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RollerEndShape = value

    @property
    def ribs(self) -> 'List[_2120.RollerRibDetail]':
