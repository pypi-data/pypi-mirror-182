...
from mastapy.bearings.roller_bearing_profiles import _1890, _1900
...
class RollerBearing(_2121.RollingBearing):
    """RollerBearing
    ...
    @property
    def inner_race_profile_set(self) -> '_1890.ProfileSet':
    ...
    @property
    def outer_race_profile_set(self) -> '_1890.ProfileSet':
    ...
    @property
    def roller_profile_set(self) -> '_1890.ProfileSet':
    ...
    @property
    def inner_race_and_roller_profiles(self) -> 'List[_1900.RollerRaceProfilePoint]':
    ...
    @property
    def inner_race_and_roller_profiles_for_first_row(self) -> 'List[_1900.RollerRaceProfilePoint]':
    ...
    @property
    def inner_race_and_roller_profiles_for_second_row(self) -> 'List[_1900.RollerRaceProfilePoint]':
    ...
    @property
    def outer_race_and_roller_profiles(self) -> 'List[_1900.RollerRaceProfilePoint]':
    ...
    @property
    def outer_race_and_roller_profiles_for_first_row(self) -> 'List[_1900.RollerRaceProfilePoint]':
    ...
    @property
    def outer_race_and_roller_profiles_for_second_row(self) -> 'List[_1900.RollerRaceProfilePoint]':
