...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2101.BearingProtectionLevel':
        ...
        return constructor.new_from_mastapy_type(_2101.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_2101.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2101.BearingProtectionLevel'):
