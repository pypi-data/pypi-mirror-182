...
from mastapy.bearings.bearing_designs.rolling import _2109, _2115
...
class FourPointContactBallBearing(_2115.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_2109.FourPointContactAngleDefinition':
        ...
        return constructor.new_from_mastapy_type(_2109.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_2109.FourPointContactAngleDefinition'):
