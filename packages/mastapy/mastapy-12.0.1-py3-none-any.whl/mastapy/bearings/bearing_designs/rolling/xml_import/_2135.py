...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2133, _2132
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2133.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2132.AbstractXmlVariableAssignment]':
