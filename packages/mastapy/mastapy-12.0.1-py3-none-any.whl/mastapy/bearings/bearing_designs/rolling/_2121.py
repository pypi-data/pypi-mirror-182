...
from mastapy.bearings import (
    _1854, _1832, _1833, _1834,
    _1831, _1857
)
from mastapy.bearings.bearing_designs.rolling import (
    _2103, _2107, _2108, _2114,
    _2124, _2102, _2131, _2111,
    _2099, _2123
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials import _239
from mastapy.utility import _1548
from mastapy.bearings.bearing_designs import _2087
...
class RollingBearing(_2087.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2103.CageBridgeShape':
        ...
        return constructor.new_from_mastapy_type(_2103.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2103.CageBridgeShape'):
    ...
    @property
    def cage_material(self) -> '_1834.BearingCageMaterial':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1834.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1834.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def catalogue(self) -> '_1831.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1831.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2124.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2124.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2102.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2102.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def geometric_constants(self) -> '_2111.GeometricConstants':
    ...
    @property
    def history(self) -> '_1548.FileHistory':
    ...
    @property
    def protection(self) -> '_2099.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2123.SKFSealFrictionalMomentConstants':
