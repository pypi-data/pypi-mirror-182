...
class RollingBearingDatabase(_1795.SQLDatabase['_1856.RollingBearingKey', '_2121.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2121.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1858.RollingBearingType', designation: Optional['str'] = 'None') -> '_2121.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2121.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1858.RollingBearingType', designation: Optional['str'] = 'None') -> '_1856.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1856.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2121.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1831.BearingCatalog', type_: '_1858.RollingBearingType', bore_range: '_1453.Range', outer_diameter_range: '_1453.Range', width_range: '_1453.Range', dynamic_capacity_range: '_1453.Range', number_of_rows: 'int', material_type: '_1847.HybridSteelAll') -> 'List[_2121.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1831.BearingCatalog', type_: '_1858.RollingBearingType') -> 'List[_2121.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1831.BearingCatalog') -> '_2121.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1831.BearingCatalog') -> 'List[_2121.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
