...
from mastapy.bearings.roller_bearing_profiles import (
    _1898, _1892, _1893, _1894,
    _1895, _1896, _1897, _1899
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1853.RollerBearingProfileTypes':
        ...
        return constructor.new_from_mastapy_type(_1853.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1853.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1898.RollerBearingProfile':
        ...
        if _1898.RollerBearingProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1892.RollerBearingConicalProfile':
        ...
        if _1892.RollerBearingConicalProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1893.RollerBearingCrownedProfile':
        ...
        if _1893.RollerBearingCrownedProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1894.RollerBearingDinLundbergProfile':
        ...
        if _1894.RollerBearingDinLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1895.RollerBearingFlatProfile':
        ...
        if _1895.RollerBearingFlatProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1896.RollerBearingJohnsGoharProfile':
        ...
        if _1896.RollerBearingJohnsGoharProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1897.RollerBearingLundbergProfile':
        ...
        if _1897.RollerBearingLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1899.RollerBearingUserSpecifiedProfile':
        ...
        if _1899.RollerBearingUserSpecifiedProfile.TYPE not in temp.__class__.__mro__:
