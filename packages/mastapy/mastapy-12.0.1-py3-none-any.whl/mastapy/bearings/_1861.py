...
from mastapy.bearings.bearing_results.rolling.skf_module import _2052
...
class SKFSettings(_1560.PerMachineSettings):
    """SKFSettings
    ...
    @property
    def skf_authentication(self) -> '_2052.SKFAuthentication':
