...
from mastapy.system_model.fe import _2310, _2317
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2310.AlignmentMethodForRaceBearing':
        ...
        return constructor.new_from_mastapy_type(_2310.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2310.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2317.BearingRaceNodeLink]':
