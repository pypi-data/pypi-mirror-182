...
from mastapy.system_model.fe import _2337, _2338
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self) -> '_2337.FESubstructureNode':
    ...
    @property
    def connected_component_local_coordinate_system(self) -> '_1463.CoordinateSystem3D':
    ...
    @property
    def mode_shapes_at_condensation_node(self) -> 'List[_2338.FESubstructureNodeModeShape]':
