...
from mastapy.math_utility import _1456, _1455
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1456.Axis':
        ...
        return constructor.new_from_mastapy_type(_1456.Axis)(value) if value is not None else None

    @component_direction_normal_to_surface.setter
    def component_direction_normal_to_surface(self, value: '_1456.Axis'):
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1455.AlignmentAxis':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1455.AlignmentAxis)(value) if value is not None else None

    @fe_axis_approximately_in_perpendicular_direction.setter
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1455.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FEAxisApproximatelyInPerpendicularDirection = value

    @property
    def first_component_alignment_axis(self) -> '_1456.Axis':
    ...
    def first_component_alignment_axis(self, value: '_1456.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FirstComponentAlignmentAxis = value

    @property
    def first_fe_alignment_axis(self) -> '_1455.AlignmentAxis':
    ...
    def first_fe_alignment_axis(self, value: '_1455.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
