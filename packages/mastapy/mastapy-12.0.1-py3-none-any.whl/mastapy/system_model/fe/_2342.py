...
class FESubstructureWithSelection(_2313.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2335.FESubstructure':
    ...
    @property
    def element_face_groups(self) -> 'List[_2328.ElementFaceGroupWithSelection]':
    ...
    @property
    def node_groups(self) -> 'List[_2353.NodeGroupWithSelection]':
