...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5698, _5618
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5787
...
class FEPartHarmonicAnalysis(_5618.AbstractShaftOrHousingHarmonicAnalysis):
    """FEPartHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2406.FEPart':
    ...
    @property
    def component_load_case(self) -> '_6814.FEPartLoadCase':
    ...
    @property
    def coupled_modal_analysis(self) -> '_4574.FEPartModalAnalysis':
    ...
    @property
    def export(self) -> '_5698.HarmonicAnalysisFEExportOptions':
    ...
    @property
    def results(self) -> '_5787.FEPartHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2704.FEPartSystemDeflection':
