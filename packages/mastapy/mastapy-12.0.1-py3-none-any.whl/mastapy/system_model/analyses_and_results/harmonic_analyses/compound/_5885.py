...
class MeasurementComponentCompoundHarmonicAnalysis(_5931.VirtualComponentCompoundHarmonicAnalysis):
    """MeasurementComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5716.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5716.MeasurementComponentHarmonicAnalysis]':
