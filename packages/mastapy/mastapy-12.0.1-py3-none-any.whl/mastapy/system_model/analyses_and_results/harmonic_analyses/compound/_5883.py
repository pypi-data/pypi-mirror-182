...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5881, _5882, _5877
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis(_5877.KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5714.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5881.KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5882.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5714.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
