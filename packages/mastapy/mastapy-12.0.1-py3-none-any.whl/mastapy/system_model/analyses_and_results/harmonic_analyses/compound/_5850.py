...
class CVTCompoundHarmonicAnalysis(_5819.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5658.CVTHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5658.CVTHarmonicAnalysis]':
