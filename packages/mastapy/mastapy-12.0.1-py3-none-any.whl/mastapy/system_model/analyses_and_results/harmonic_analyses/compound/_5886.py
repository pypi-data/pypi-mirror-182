...
class MountableComponentCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """MountableComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5717.MountableComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5717.MountableComponentHarmonicAnalysis]':
