...
class GuideDxfModelCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """GuideDxfModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5695.GuideDxfModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5695.GuideDxfModelHarmonicAnalysis]':
