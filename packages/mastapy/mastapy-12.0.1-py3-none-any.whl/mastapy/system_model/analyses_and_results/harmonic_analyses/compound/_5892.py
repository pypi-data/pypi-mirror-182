...
class PlanetaryConnectionCompoundHarmonicAnalysis(_5906.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """PlanetaryConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5724.PlanetaryConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5724.PlanetaryConnectionHarmonicAnalysis]':
