...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5856, _5857, _5869
...
class CylindricalGearSetCompoundHarmonicAnalysis(_5869.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5666.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_harmonic_analysis(self) -> 'List[_5856.CylindricalGearCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_harmonic_analysis(self) -> 'List[_5857.CylindricalGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5666.CylindricalGearSetHarmonicAnalysis]':
