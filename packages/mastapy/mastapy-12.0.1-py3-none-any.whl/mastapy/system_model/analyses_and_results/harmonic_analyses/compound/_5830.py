...
class ClutchCompoundHarmonicAnalysis(_5846.CouplingCompoundHarmonicAnalysis):
    """ClutchCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5639.ClutchHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5639.ClutchHarmonicAnalysis]':
