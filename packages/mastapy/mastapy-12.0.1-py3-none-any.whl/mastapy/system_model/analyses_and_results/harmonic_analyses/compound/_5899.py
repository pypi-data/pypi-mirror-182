...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5874.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5732.RingPinsToDiscConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5732.RingPinsToDiscConnectionHarmonicAnalysis]':
