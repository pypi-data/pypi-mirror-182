...
class ZerolBevelGearCompoundHarmonicAnalysis(_5825.BevelGearCompoundHarmonicAnalysis):
    """ZerolBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5771.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5771.ZerolBevelGearHarmonicAnalysis]':
