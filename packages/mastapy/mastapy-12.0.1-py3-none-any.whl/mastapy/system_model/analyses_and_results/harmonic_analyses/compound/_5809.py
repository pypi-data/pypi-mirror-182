...
class AbstractAssemblyCompoundHarmonicAnalysis(_5888.PartCompoundHarmonicAnalysis):
    """AbstractAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5615.AbstractAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5615.AbstractAssemblyHarmonicAnalysis]':
