...
class FEPartCompoundHarmonicAnalysis(_5811.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """FEPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5685.FEPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5685.FEPartHarmonicAnalysis]':
