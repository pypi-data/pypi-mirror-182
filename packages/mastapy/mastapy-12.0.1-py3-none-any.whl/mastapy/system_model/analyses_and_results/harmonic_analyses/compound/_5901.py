...
class RollingRingCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """RollingRingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5735.RollingRingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5735.RollingRingHarmonicAnalysis]':
