...
class RingPinsCompoundHarmonicAnalysis(_5886.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5731.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5731.RingPinsHarmonicAnalysis]':
