...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5917, _5918, _5827
...
class StraightBevelGearSetCompoundHarmonicAnalysis(_5827.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5754.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5917.StraightBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5918.StraightBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5754.StraightBevelGearSetHarmonicAnalysis]':
