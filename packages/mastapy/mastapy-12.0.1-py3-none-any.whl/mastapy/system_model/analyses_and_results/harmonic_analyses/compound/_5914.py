...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5825.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5749.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5749.StraightBevelDiffGearHarmonicAnalysis]':
