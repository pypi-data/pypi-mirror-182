...
class AbstractShaftCompoundHarmonicAnalysis(_5811.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """AbstractShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5617.AbstractShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5617.AbstractShaftHarmonicAnalysis]':
