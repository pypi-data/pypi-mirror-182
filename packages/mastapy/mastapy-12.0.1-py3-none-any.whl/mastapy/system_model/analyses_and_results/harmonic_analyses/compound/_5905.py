...
class ShaftHubConnectionCompoundHarmonicAnalysis(_5845.ConnectorCompoundHarmonicAnalysis):
    """ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5738.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5738.ShaftHubConnectionHarmonicAnalysis]':
