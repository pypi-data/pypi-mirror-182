...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5844.ConnectionCompoundHarmonicAnalysis):
    """InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5705.InterMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5705.InterMountableComponentConnectionHarmonicAnalysis]':
