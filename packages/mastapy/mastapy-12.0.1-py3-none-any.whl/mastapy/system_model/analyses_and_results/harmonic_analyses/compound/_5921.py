...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5914.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5756.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5756.StraightBevelSunGearHarmonicAnalysis]':
