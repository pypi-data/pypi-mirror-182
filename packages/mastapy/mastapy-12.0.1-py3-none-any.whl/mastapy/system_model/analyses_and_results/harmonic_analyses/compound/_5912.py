...
class SpringDamperConnectionCompoundHarmonicAnalysis(_5847.CouplingConnectionCompoundHarmonicAnalysis):
    """SpringDamperConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5746.SpringDamperConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5746.SpringDamperConnectionHarmonicAnalysis]':
