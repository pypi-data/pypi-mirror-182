...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5820.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5631.BevelDifferentialSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5631.BevelDifferentialSunGearHarmonicAnalysis]':
