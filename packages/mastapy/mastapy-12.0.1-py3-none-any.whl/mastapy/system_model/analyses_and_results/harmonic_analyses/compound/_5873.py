...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5871, _5872, _5815
...
class HypoidGearSetCompoundHarmonicAnalysis(_5815.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """HypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5704.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5871.HypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5872.HypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5704.HypoidGearSetHarmonicAnalysis]':
