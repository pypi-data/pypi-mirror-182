...
class TorqueConverterTurbineCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterTurbineCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5764.TorqueConverterTurbineHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5764.TorqueConverterTurbineHarmonicAnalysis]':
