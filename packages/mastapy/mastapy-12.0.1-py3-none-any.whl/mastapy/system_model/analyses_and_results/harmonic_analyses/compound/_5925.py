...
class SynchroniserSleeveCompoundHarmonicAnalysis(_5924.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserSleeveCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5760.SynchroniserSleeveHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5760.SynchroniserSleeveHarmonicAnalysis]':
