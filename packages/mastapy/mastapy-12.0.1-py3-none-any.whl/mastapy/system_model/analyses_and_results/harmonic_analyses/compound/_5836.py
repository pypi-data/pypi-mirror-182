...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5847.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5643.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5643.ConceptCouplingConnectionHarmonicAnalysis]':
