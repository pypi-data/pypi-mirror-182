...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5826.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5744.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5744.SpiralBevelGearMeshHarmonicAnalysis]':
