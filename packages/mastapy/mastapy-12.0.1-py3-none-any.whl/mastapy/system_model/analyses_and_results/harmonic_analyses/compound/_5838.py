...
class ConceptGearCompoundHarmonicAnalysis(_5867.GearCompoundHarmonicAnalysis):
    """ConceptGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5646.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5646.ConceptGearHarmonicAnalysis]':
