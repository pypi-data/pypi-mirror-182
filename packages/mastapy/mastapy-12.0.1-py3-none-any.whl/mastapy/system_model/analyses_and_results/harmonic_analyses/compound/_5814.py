...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(_5842.ConicalGearMeshCompoundHarmonicAnalysis):
    """AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5621.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5621.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
