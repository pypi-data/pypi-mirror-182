...
class ClutchHalfCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5638.ClutchHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5638.ClutchHalfHarmonicAnalysis]':
