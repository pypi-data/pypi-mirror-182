...
class ClutchConnectionCompoundHarmonicAnalysis(_5847.CouplingConnectionCompoundHarmonicAnalysis):
    """ClutchConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5637.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5637.ClutchConnectionHarmonicAnalysis]':
