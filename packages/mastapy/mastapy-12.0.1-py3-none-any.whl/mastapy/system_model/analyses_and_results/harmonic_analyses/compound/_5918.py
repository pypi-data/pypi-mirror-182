...
class StraightBevelGearMeshCompoundHarmonicAnalysis(_5826.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5753.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5753.StraightBevelGearMeshHarmonicAnalysis]':
