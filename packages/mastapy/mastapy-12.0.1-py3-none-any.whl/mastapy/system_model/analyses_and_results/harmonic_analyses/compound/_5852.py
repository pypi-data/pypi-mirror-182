...
class CycloidalAssemblyCompoundHarmonicAnalysis(_5907.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """CycloidalAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5660.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5660.CycloidalAssemblyHarmonicAnalysis]':
