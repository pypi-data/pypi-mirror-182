...
class BoltCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5636.BoltHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5636.BoltHarmonicAnalysis]':
