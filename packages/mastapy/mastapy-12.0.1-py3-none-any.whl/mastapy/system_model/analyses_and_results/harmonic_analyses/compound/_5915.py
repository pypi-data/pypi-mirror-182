...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysis(_5826.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelDiffGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5750.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5750.StraightBevelDiffGearMeshHarmonicAnalysis]':
