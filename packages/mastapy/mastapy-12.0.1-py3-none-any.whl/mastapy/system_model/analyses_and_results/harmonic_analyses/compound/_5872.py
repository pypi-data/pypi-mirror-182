...
class HypoidGearMeshCompoundHarmonicAnalysis(_5814.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis):
    """HypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5703.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5703.HypoidGearMeshHarmonicAnalysis]':
