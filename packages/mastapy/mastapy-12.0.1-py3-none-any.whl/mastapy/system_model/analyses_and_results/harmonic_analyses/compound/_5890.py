...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_5847.CouplingConnectionCompoundHarmonicAnalysis):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5720.PartToPartShearCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5720.PartToPartShearCouplingConnectionHarmonicAnalysis]':
