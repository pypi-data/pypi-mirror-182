...
class BevelDifferentialGearMeshCompoundHarmonicAnalysis(_5826.BevelGearMeshCompoundHarmonicAnalysis):
    """BevelDifferentialGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5628.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5628.BevelDifferentialGearMeshHarmonicAnalysis]':
