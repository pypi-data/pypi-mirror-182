...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5878, _5879, _5877
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(_5877.KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5711.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5878.KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5879.KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5711.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
