...
class ConicalGearCompoundHarmonicAnalysis(_5867.GearCompoundHarmonicAnalysis):
    """ConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5649.ConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5649.ConicalGearHarmonicAnalysis]':
