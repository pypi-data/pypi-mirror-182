...
class ConnectionCompoundHarmonicAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5652.ConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5652.ConnectionHarmonicAnalysis]':
