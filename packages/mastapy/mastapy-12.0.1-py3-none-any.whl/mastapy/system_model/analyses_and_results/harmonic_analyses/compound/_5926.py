...
class TorqueConverterCompoundHarmonicAnalysis(_5846.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5762.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5762.TorqueConverterHarmonicAnalysis]':
