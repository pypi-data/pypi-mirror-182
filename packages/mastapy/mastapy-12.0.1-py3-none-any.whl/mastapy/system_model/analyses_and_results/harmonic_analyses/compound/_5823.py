...
class BevelDifferentialPlanetGearCompoundHarmonicAnalysis(_5820.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5630.BevelDifferentialPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5630.BevelDifferentialPlanetGearHarmonicAnalysis]':
