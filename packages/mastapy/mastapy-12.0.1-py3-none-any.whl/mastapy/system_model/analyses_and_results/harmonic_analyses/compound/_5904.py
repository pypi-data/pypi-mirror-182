...
class ShaftCompoundHarmonicAnalysis(_5810.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5737.ShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5737.ShaftHarmonicAnalysis]':
