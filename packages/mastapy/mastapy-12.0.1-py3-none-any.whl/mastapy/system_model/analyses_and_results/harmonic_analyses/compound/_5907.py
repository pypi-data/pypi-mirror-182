...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5809.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5741.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5741.SpecialisedAssemblyHarmonicAnalysis]':
