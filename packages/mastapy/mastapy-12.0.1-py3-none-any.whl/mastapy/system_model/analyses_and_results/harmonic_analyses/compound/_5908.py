...
class SpiralBevelGearCompoundHarmonicAnalysis(_5825.BevelGearCompoundHarmonicAnalysis):
    """SpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5743.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5743.SpiralBevelGearHarmonicAnalysis]':
