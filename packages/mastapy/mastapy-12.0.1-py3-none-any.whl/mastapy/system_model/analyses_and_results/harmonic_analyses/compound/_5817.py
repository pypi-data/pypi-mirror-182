...
class BearingCompoundHarmonicAnalysis(_5845.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5624.BearingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5624.BearingHarmonicAnalysis]':
