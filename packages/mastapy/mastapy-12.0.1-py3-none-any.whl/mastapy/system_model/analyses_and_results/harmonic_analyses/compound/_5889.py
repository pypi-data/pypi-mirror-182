...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_5846.CouplingCompoundHarmonicAnalysis):
    """PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5722.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5722.PartToPartShearCouplingHarmonicAnalysis]':
