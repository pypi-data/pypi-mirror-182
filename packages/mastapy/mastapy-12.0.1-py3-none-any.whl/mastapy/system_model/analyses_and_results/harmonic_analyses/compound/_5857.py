...
class CylindricalGearMeshCompoundHarmonicAnalysis(_5868.GearMeshCompoundHarmonicAnalysis):
    """CylindricalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5665.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5665.CylindricalGearMeshHarmonicAnalysis]':
