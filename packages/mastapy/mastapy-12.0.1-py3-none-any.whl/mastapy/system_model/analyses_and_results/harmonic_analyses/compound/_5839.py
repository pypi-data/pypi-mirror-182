...
class ConceptGearMeshCompoundHarmonicAnalysis(_5868.GearMeshCompoundHarmonicAnalysis):
    """ConceptGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5647.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5647.ConceptGearMeshHarmonicAnalysis]':
