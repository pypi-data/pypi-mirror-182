...
class BoltedJointCompoundHarmonicAnalysis(_5907.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BoltedJointCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5635.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5635.BoltedJointHarmonicAnalysis]':
