...
class CycloidalDiscCompoundHarmonicAnalysis(_5810.AbstractShaftCompoundHarmonicAnalysis):
    """CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5662.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5662.CycloidalDiscHarmonicAnalysis]':
