...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5838, _5839, _5869
...
class ConceptGearSetCompoundHarmonicAnalysis(_5869.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5648.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis(self) -> 'List[_5838.ConceptGearCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis(self) -> 'List[_5839.ConceptGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5648.ConceptGearSetHarmonicAnalysis]':
