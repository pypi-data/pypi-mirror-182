...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5627, _5628, _5634
...
class BevelDifferentialGearSetHarmonicAnalysis(_5634.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5627.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_harmonic_analysis(self) -> 'List[_5627.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5628.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis(self) -> 'List[_5628.BevelDifferentialGearMeshHarmonicAnalysis]':
