...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5646, _5647, _5693
...
class ConceptGearSetHarmonicAnalysis(_5693.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5646.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def concept_gears_harmonic_analysis(self) -> 'List[_5646.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5647.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_harmonic_analysis(self) -> 'List[_5647.ConceptGearMeshHarmonicAnalysis]':
