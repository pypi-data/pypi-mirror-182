...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5664, _5665, _5693
...
class CylindricalGearSetHarmonicAnalysis(_5693.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5664.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5664.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5665.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5665.CylindricalGearMeshHarmonicAnalysis]':
