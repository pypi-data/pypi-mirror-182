...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5778, _5776
...
class ExcitationSourceSelection(_5776.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5778.HarmonicSelection]':
