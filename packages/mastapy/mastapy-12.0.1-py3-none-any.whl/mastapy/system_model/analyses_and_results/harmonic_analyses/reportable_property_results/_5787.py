...
class FEPartHarmonicAnalysisResultsPropertyAccessor(_5795.HarmonicAnalysisResultsPropertyAccessor):
    """FEPartHarmonicAnalysisResultsPropertyAccessor
    ...
    @property
    def combined_orders(self) -> '_5797.ResultsForMultipleOrdersForFESurface':
    ...
    @property
    def excitations(self) -> 'List[_5788.FEPartSingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5802.ResultsForOrderIncludingSurfaces]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5802.ResultsForOrderIncludingSurfaces]':
