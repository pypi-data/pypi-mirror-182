...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5800, _5784
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5784.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5800.ResultsForOrderIncludingGroups]':
