...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5794, _5801
...
class ResultsForOrderIncludingSurfaces(_5801.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5794.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
