...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5798, _5807, _5800
...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self) -> '_5798.ResultsForMultipleOrdersForGroups':
    ...
    @property
    def excitations(self) -> 'List[_5807.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5800.ResultsForOrderIncludingGroups]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5800.ResultsForOrderIncludingGroups]':
