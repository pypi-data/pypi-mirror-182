...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5805, _5785
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5805.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
    ...
    @property
    def result_at_reference_speed(self) -> '_5785.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
    ...
    @property
    def data_points(self) -> 'List[_5785.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
