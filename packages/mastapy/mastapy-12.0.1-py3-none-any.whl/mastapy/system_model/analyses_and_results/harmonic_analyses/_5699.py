...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5730, _5687, _5742
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5777
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def response_cache_level(self) -> '_5730.ResponseCacheLevel':
        ...
        return constructor.new_from_mastapy_type(_5730.ResponseCacheLevel)(value) if value is not None else None

    @response_cache_level.setter
    def response_cache_level(self, value: '_5730.ResponseCacheLevel'):
    ...
    @property
    def excitation_selection(self) -> '_5777.ExcitationSourceSelectionGroup':
    ...
    @property
    def modal_analysis_options(self) -> '_4598.ModalAnalysisOptions':
