...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5771, _5772, _5634
...
class ZerolBevelGearSetHarmonicAnalysis(_5634.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5771.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis(self) -> 'List[_5771.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5772.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis(self) -> 'List[_5772.ZerolBevelGearMeshHarmonicAnalysis]':
