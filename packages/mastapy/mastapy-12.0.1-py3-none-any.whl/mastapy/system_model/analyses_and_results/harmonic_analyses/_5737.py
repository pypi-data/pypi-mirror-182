...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5701, _5617
...
class ShaftHarmonicAnalysis(_5617.AbstractShaftHarmonicAnalysis):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4619.ShaftModalAnalysis':
    ...
    @property
    def export(self) -> '_5701.HarmonicAnalysisShaftExportOptions':
    ...
    @property
    def system_deflection_results(self) -> '_2751.ShaftSystemDeflection':
