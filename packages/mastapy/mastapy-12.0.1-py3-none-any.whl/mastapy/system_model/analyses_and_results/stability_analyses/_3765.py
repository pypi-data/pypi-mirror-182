...
from mastapy.system_model.analyses_and_results.stability_analyses import _3766, _3764, _3770
...
class FaceGearSetStabilityAnalysis(_3770.GearSetStabilityAnalysis):
    """FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3766.FaceGearStabilityAnalysis]':
    ...
    @property
    def face_meshes_stability_analysis(self) -> 'List[_3764.FaceGearMeshStabilityAnalysis]':
