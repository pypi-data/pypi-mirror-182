...
from mastapy.system_model.analyses_and_results.stability_analyses import _3841, _3839, _3727
...
class ZerolBevelGearSetStabilityAnalysis(_3727.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3841.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3839.ZerolBevelGearMeshStabilityAnalysis]':
