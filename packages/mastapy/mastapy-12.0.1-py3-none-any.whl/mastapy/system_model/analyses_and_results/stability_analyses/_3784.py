...
from mastapy.system_model.analyses_and_results.stability_analyses import _3785, _3783, _3778
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3778.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3785.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3783.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
