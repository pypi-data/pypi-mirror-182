...
from mastapy.system_model.analyses_and_results.stability_analyses import _3838, _3836, _3770
...
class WormGearSetStabilityAnalysis(_3770.GearSetStabilityAnalysis):
    """WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3838.WormGearStabilityAnalysis]':
    ...
    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3836.WormGearMeshStabilityAnalysis]':
