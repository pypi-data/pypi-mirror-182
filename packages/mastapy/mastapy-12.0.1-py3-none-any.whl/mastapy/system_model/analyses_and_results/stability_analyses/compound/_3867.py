...
class ComponentCompoundStabilityAnalysis(_3921.PartCompoundStabilityAnalysis):
    """ComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3735.ComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3735.ComponentStabilityAnalysis]':
