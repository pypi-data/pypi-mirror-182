...
class BearingCompoundStabilityAnalysis(_3878.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3718.BearingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3718.BearingStabilityAnalysis]':
