...
class WormGearCompoundStabilityAnalysis(_3900.GearCompoundStabilityAnalysis):
    """WormGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3838.WormGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3838.WormGearStabilityAnalysis]':
