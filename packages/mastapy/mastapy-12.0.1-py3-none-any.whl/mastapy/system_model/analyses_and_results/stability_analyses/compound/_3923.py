...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3880.CouplingConnectionCompoundStabilityAnalysis):
    """PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3791.PartToPartShearCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3791.PartToPartShearCouplingConnectionStabilityAnalysis]':
