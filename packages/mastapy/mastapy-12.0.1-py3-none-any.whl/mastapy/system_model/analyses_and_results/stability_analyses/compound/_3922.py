...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3879.CouplingCompoundStabilityAnalysis):
    """PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3793.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3793.PartToPartShearCouplingStabilityAnalysis]':
