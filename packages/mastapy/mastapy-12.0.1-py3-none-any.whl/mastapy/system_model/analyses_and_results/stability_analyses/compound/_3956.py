...
class SynchroniserHalfCompoundStabilityAnalysis(_3957.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3826.SynchroniserHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3826.SynchroniserHalfStabilityAnalysis]':
