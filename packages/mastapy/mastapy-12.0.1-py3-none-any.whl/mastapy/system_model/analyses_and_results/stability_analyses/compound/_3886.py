...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3866.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3755.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3755.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
