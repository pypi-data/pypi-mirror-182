...
class GuideDxfModelCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3772.GuideDxfModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3772.GuideDxfModelStabilityAnalysis]':
