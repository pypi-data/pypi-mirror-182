...
class OilSealCompoundStabilityAnalysis(_3878.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3789.OilSealStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3789.OilSealStabilityAnalysis]':
