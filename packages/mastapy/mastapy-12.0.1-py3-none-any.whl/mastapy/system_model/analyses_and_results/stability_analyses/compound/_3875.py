...
class ConicalGearMeshCompoundStabilityAnalysis(_3901.GearMeshCompoundStabilityAnalysis):
    """ConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3742.ConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3742.ConicalGearMeshStabilityAnalysis]':
