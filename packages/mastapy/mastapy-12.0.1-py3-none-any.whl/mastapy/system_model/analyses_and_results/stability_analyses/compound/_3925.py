...
class PlanetaryConnectionCompoundStabilityAnalysis(_3939.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """PlanetaryConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3794.PlanetaryConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3794.PlanetaryConnectionStabilityAnalysis]':
