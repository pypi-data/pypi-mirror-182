...
class PartToPartShearCouplingHalfCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """PartToPartShearCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3792.PartToPartShearCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3792.PartToPartShearCouplingHalfStabilityAnalysis]':
