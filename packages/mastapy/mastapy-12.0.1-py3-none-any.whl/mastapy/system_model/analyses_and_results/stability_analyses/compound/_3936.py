...
class RootAssemblyCompoundStabilityAnalysis(_3849.AssemblyCompoundStabilityAnalysis):
    """RootAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3805.RootAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3805.RootAssemblyStabilityAnalysis]':
