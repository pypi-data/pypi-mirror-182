...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3877.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3776.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3776.InterMountableComponentConnectionStabilityAnalysis]':
