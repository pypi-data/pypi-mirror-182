...
class ClutchConnectionCompoundStabilityAnalysis(_3880.CouplingConnectionCompoundStabilityAnalysis):
    """ClutchConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3731.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3731.ClutchConnectionStabilityAnalysis]':
