...
class CoaxialConnectionCompoundStabilityAnalysis(_3939.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3734.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3734.CoaxialConnectionStabilityAnalysis]':
