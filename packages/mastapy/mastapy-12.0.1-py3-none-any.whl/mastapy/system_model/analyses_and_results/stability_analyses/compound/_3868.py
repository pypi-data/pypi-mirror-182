...
class ConceptCouplingCompoundStabilityAnalysis(_3879.CouplingCompoundStabilityAnalysis):
    """ConceptCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3738.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3738.ConceptCouplingStabilityAnalysis]':
