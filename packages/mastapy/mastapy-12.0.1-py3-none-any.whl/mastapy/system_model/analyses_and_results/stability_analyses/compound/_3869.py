...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3880.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3736.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3736.ConceptCouplingConnectionStabilityAnalysis]':
