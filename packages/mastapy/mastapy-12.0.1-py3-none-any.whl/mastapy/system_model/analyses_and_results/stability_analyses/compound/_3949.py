...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3947, _3948, _3860
...
class StraightBevelDiffGearSetCompoundStabilityAnalysis(_3860.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelDiffGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3819.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_stability_analysis(self) -> 'List[_3947.StraightBevelDiffGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_stability_analysis(self) -> 'List[_3948.StraightBevelDiffGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3819.StraightBevelDiffGearSetStabilityAnalysis]':
