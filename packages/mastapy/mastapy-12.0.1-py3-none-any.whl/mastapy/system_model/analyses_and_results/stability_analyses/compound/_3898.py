...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3844
...
class FEPartCompoundStabilityAnalysis(_3844.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """FEPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3767.FEPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3767.FEPartStabilityAnalysis]':
