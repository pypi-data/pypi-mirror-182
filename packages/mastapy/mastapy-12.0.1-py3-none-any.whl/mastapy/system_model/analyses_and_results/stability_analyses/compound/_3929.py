...
class PowerLoadCompoundStabilityAnalysis(_3964.VirtualComponentCompoundStabilityAnalysis):
    """PowerLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3798.PowerLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3798.PowerLoadStabilityAnalysis]':
