...
class MeasurementComponentCompoundStabilityAnalysis(_3964.VirtualComponentCompoundStabilityAnalysis):
    """MeasurementComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3787.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3787.MeasurementComponentStabilityAnalysis]':
