...
class ConceptGearMeshCompoundStabilityAnalysis(_3901.GearMeshCompoundStabilityAnalysis):
    """ConceptGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3739.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3739.ConceptGearMeshStabilityAnalysis]':
