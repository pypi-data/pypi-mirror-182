...
class CylindricalGearCompoundStabilityAnalysis(_3900.GearCompoundStabilityAnalysis):
    """CylindricalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3760.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3760.CylindricalGearStabilityAnalysis]':
