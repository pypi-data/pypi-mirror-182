...
class PlanetaryGearSetCompoundStabilityAnalysis(_3891.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3795.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3795.PlanetaryGearSetStabilityAnalysis]':
