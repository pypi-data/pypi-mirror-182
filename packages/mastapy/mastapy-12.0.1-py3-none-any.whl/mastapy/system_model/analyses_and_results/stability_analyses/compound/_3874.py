...
class ConicalGearCompoundStabilityAnalysis(_3900.GearCompoundStabilityAnalysis):
    """ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3744.ConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3744.ConicalGearStabilityAnalysis]':
