...
class WormGearMeshCompoundStabilityAnalysis(_3901.GearMeshCompoundStabilityAnalysis):
    """WormGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3836.WormGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3836.WormGearMeshStabilityAnalysis]':
