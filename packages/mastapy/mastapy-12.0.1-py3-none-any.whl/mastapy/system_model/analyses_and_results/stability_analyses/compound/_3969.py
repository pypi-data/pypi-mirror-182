...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3859.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3839.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3839.ZerolBevelGearMeshStabilityAnalysis]':
