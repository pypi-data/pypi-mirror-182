...
class PulleyCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3799.PulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3799.PulleyStabilityAnalysis]':
