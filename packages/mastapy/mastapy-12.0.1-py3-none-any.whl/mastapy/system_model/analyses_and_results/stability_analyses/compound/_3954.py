...
class StraightBevelSunGearCompoundStabilityAnalysis(_3947.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3825.StraightBevelSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3825.StraightBevelSunGearStabilityAnalysis]':
