...
class RollingRingAssemblyCompoundStabilityAnalysis(_3940.SpecialisedAssemblyCompoundStabilityAnalysis):
    """RollingRingAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3802.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3802.RollingRingAssemblyStabilityAnalysis]':
