...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis(_3908.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3785.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3785.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
