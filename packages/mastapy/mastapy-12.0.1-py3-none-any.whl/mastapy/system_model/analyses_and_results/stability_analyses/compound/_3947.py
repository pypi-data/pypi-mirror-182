...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3858.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3820.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3820.StraightBevelDiffGearStabilityAnalysis]':
