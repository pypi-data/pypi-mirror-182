...
class SynchroniserSleeveCompoundStabilityAnalysis(_3957.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserSleeveCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3828.SynchroniserSleeveStabilityAnalysis]':
