...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3968, _3969, _3860
...
class ZerolBevelGearSetCompoundStabilityAnalysis(_3860.BevelGearSetCompoundStabilityAnalysis):
    """ZerolBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3840.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_stability_analysis(self) -> 'List[_3968.ZerolBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_stability_analysis(self) -> 'List[_3969.ZerolBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3840.ZerolBevelGearSetStabilityAnalysis]':
