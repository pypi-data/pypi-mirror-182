...
class CylindricalPlanetGearCompoundStabilityAnalysis(_3889.CylindricalGearCompoundStabilityAnalysis):
    """CylindricalPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3761.CylindricalPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3761.CylindricalPlanetGearStabilityAnalysis]':
