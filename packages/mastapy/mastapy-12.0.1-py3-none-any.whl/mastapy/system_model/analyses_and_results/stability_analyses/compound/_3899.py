...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3940.SpecialisedAssemblyCompoundStabilityAnalysis):
    """FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3768.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3768.FlexiblePinAssemblyStabilityAnalysis]':
