...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3895, _3896, _3902
...
class FaceGearSetCompoundStabilityAnalysis(_3902.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3765.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3895.FaceGearCompoundStabilityAnalysis]':
    ...
    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3896.FaceGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3765.FaceGearSetStabilityAnalysis]':
