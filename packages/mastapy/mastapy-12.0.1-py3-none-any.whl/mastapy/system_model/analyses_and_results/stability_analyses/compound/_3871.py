...
class ConceptGearCompoundStabilityAnalysis(_3900.GearCompoundStabilityAnalysis):
    """ConceptGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3741.ConceptGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3741.ConceptGearStabilityAnalysis]':
