...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3843
...
class ShaftCompoundStabilityAnalysis(_3843.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3807.ShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3807.ShaftStabilityAnalysis]':
