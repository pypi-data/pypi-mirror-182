...
class RingPinsToDiscConnectionCompoundStabilityAnalysis(_3907.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RingPinsToDiscConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3801.RingPinsToDiscConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3801.RingPinsToDiscConnectionStabilityAnalysis]':
