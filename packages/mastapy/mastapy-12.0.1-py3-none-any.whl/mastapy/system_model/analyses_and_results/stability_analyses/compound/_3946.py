...
class SpringDamperHalfCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """SpringDamperHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3814.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3814.SpringDamperHalfStabilityAnalysis]':
