...
class FaceGearMeshCompoundStabilityAnalysis(_3901.GearMeshCompoundStabilityAnalysis):
    """FaceGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3764.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3764.FaceGearMeshStabilityAnalysis]':
