...
class AbstractShaftCompoundStabilityAnalysis(_3844.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3712.AbstractShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3712.AbstractShaftStabilityAnalysis]':
