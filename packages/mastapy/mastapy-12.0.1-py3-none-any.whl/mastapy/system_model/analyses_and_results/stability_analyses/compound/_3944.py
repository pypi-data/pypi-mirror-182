...
class SpringDamperCompoundStabilityAnalysis(_3879.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3815.SpringDamperStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3815.SpringDamperStabilityAnalysis]':
