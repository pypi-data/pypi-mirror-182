...
class SynchroniserPartCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """SynchroniserPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.SynchroniserPartStabilityAnalysis]':
