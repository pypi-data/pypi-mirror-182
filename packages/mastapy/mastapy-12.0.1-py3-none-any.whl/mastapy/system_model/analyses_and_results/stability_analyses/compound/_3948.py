...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3859
...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3859.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3818.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3818.StraightBevelDiffGearMeshStabilityAnalysis]':
