...
class ClutchCompoundStabilityAnalysis(_3879.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3733.ClutchStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3733.ClutchStabilityAnalysis]':
