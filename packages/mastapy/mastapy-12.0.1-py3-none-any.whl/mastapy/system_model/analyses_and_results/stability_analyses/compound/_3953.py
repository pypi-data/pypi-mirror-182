...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3947.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3824.StraightBevelPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3824.StraightBevelPlanetGearStabilityAnalysis]':
