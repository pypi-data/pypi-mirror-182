...
class MassDiscCompoundStabilityAnalysis(_3964.VirtualComponentCompoundStabilityAnalysis):
    """MassDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3786.MassDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3786.MassDiscStabilityAnalysis]':
