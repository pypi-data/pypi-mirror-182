...
class ConnectorCompoundStabilityAnalysis(_3919.MountableComponentCompoundStabilityAnalysis):
    """ConnectorCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3746.ConnectorStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3746.ConnectorStabilityAnalysis]':
