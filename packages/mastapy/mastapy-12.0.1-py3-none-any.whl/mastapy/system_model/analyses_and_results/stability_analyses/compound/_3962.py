...
class TorqueConverterTurbineCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterTurbineCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3833.TorqueConverterTurbineStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3833.TorqueConverterTurbineStabilityAnalysis]':
