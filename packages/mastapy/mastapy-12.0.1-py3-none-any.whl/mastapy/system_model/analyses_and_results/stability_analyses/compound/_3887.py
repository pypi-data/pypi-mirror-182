...
class CycloidalDiscCompoundStabilityAnalysis(_3843.AbstractShaftCompoundStabilityAnalysis):
    """CycloidalDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3757.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3757.CycloidalDiscStabilityAnalysis]':
