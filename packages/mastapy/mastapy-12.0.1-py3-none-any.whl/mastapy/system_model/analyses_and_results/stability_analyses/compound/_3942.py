...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3859.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3810.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3810.SpiralBevelGearMeshStabilityAnalysis]':
