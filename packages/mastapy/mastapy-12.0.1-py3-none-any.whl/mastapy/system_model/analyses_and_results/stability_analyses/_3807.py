...
from mastapy.system_model.analyses_and_results.stability_analyses import _3750, _3712
...
class ShaftStabilityAnalysis(_3712.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3750.CriticalSpeed]':
