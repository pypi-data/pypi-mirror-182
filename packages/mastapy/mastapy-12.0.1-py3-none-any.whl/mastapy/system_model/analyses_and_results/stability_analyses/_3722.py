...
from mastapy.system_model.analyses_and_results.stability_analyses import _3723, _3721, _3727
...
class BevelDifferentialGearSetStabilityAnalysis(_3727.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3723.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3721.BevelDifferentialGearMeshStabilityAnalysis]':
