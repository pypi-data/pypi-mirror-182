...
from mastapy.system_model.analyses_and_results.stability_analyses import _3782, _3780, _3778
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3778.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3782.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3780.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
