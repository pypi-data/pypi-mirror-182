...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4316, _4315, _4314
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_4314.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_4316.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_4315.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
