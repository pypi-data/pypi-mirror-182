...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4363, _4362, _4257
...
class StraightBevelDiffGearSetParametricStudyTool(_4257.BevelGearSetParametricStudyTool):
    """StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4363.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4362.StraightBevelDiffGearMeshParametricStudyTool]':
