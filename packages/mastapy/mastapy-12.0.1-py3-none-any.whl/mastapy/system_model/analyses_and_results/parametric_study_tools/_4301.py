...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4300, _4299, _4306
...
class FaceGearSetParametricStudyTool(_4306.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4300.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4299.FaceGearMeshParametricStudyTool]':
