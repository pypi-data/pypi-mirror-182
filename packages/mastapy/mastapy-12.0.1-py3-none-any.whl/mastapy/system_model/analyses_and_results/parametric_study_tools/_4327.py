...
from mastapy.math_utility.optimisation import _1519, _1517
...
class ParametricStudyDOEResultVariable(_1517.ParetoOptimisationVariableBase):
    """ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1519.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new_from_mastapy_type(_1519.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @target.setter
    def target(self, value: '_1519.PropertyTargetForDominantCandidateSearch'):
