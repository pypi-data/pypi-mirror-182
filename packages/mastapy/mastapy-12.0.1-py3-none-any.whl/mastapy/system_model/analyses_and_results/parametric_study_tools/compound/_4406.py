...
class BoltedJointCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """BoltedJointCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4258.BoltedJointParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4258.BoltedJointParametricStudyTool]':
