...
class MountableComponentCompoundParametricStudyTool(_4411.ComponentCompoundParametricStudyTool):
    """MountableComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4324.MountableComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4324.MountableComponentParametricStudyTool]':
