...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4397.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4253.BevelDifferentialPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4253.BevelDifferentialPlanetGearParametricStudyTool]':
