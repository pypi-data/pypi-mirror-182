...
class SpiralBevelGearMeshCompoundParametricStudyTool(_4403.BevelGearMeshCompoundParametricStudyTool):
    """SpiralBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4356.SpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4356.SpiralBevelGearMeshParametricStudyTool]':
