...
class BevelGearMeshCompoundParametricStudyTool(_4391.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """BevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4255.BevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4255.BevelGearMeshParametricStudyTool]':
