...
class TorqueConverterPumpCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4376.TorqueConverterPumpParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4376.TorqueConverterPumpParametricStudyTool]':
