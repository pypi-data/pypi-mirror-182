...
class MassDiscCompoundParametricStudyTool(_4508.VirtualComponentCompoundParametricStudyTool):
    """MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4321.MassDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4321.MassDiscParametricStudyTool]':
