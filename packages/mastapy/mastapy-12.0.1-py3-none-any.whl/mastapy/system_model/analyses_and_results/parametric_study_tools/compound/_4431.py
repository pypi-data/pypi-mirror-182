...
class CycloidalDiscCompoundParametricStudyTool(_4387.AbstractShaftCompoundParametricStudyTool):
    """CycloidalDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4284.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4284.CycloidalDiscParametricStudyTool]':
