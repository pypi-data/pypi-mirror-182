...
class CVTPulleyCompoundParametricStudyTool(_4474.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4281.CVTPulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4281.CVTPulleyParametricStudyTool]':
