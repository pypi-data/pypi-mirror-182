...
class ConceptCouplingConnectionCompoundParametricStudyTool(_4424.CouplingConnectionCompoundParametricStudyTool):
    """ConceptCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4265.ConceptCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4265.ConceptCouplingConnectionParametricStudyTool]':
