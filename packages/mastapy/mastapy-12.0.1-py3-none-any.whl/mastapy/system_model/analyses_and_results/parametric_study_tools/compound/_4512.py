...
class ZerolBevelGearCompoundParametricStudyTool(_4402.BevelGearCompoundParametricStudyTool):
    """ZerolBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4384.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4384.ZerolBevelGearParametricStudyTool]':
