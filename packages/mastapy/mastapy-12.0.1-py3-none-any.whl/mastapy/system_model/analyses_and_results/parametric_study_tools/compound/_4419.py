...
class ConicalGearMeshCompoundParametricStudyTool(_4445.GearMeshCompoundParametricStudyTool):
    """ConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4271.ConicalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4271.ConicalGearMeshParametricStudyTool]':
