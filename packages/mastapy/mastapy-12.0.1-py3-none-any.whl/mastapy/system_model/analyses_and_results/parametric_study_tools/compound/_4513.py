...
class ZerolBevelGearMeshCompoundParametricStudyTool(_4403.BevelGearMeshCompoundParametricStudyTool):
    """ZerolBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4383.ZerolBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4383.ZerolBevelGearMeshParametricStudyTool]':
