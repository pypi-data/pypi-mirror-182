...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4411.ComponentCompoundParametricStudyTool):
    """AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4240.AbstractShaftOrHousingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4240.AbstractShaftOrHousingParametricStudyTool]':
