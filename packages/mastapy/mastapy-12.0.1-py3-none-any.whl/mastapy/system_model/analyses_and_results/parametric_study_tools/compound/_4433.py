...
class CylindricalGearCompoundParametricStudyTool(_4444.GearCompoundParametricStudyTool):
    """CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4287.CylindricalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4287.CylindricalGearParametricStudyTool]':
