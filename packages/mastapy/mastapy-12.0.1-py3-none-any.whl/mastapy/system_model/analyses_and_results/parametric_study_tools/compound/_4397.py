...
class BevelDifferentialGearCompoundParametricStudyTool(_4402.BevelGearCompoundParametricStudyTool):
    """BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4251.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4251.BevelDifferentialGearParametricStudyTool]':
