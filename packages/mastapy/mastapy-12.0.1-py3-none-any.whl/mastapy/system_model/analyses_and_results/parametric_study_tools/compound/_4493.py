...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4491, _4492, _4404
...
class StraightBevelDiffGearSetCompoundParametricStudyTool(_4404.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelDiffGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4364.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gears_compound_parametric_study_tool(self) -> 'List[_4491.StraightBevelDiffGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_parametric_study_tool(self) -> 'List[_4492.StraightBevelDiffGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4364.StraightBevelDiffGearSetParametricStudyTool]':
