...
class BoltCompoundParametricStudyTool(_4411.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4259.BoltParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4259.BoltParametricStudyTool]':
