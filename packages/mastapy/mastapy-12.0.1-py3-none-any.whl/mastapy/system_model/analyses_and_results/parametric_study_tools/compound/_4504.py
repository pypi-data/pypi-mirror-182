...
class TorqueConverterConnectionCompoundParametricStudyTool(_4424.CouplingConnectionCompoundParametricStudyTool):
    """TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4374.TorqueConverterConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4374.TorqueConverterConnectionParametricStudyTool]':
