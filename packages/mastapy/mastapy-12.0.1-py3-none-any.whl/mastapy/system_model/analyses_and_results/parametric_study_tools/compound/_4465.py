...
class PartCompoundParametricStudyTool(_7471.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4336.PartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4336.PartParametricStudyTool]':
