...
class HypoidGearMeshCompoundParametricStudyTool(_4391.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """HypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4308.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4308.HypoidGearMeshParametricStudyTool]':
