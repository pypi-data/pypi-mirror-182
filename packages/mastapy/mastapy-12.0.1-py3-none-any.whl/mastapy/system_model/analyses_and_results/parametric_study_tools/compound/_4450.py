...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4448, _4449, _4392
...
class HypoidGearSetCompoundParametricStudyTool(_4392.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """HypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4310.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4448.HypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4449.HypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4310.HypoidGearSetParametricStudyTool]':
