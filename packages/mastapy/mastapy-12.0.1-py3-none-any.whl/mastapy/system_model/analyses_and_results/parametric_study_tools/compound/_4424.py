...
class CouplingConnectionCompoundParametricStudyTool(_4451.InterMountableComponentConnectionCompoundParametricStudyTool):
    """CouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4276.CouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4276.CouplingConnectionParametricStudyTool]':
