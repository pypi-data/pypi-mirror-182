...
class CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool(_4389.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4285.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4285.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
