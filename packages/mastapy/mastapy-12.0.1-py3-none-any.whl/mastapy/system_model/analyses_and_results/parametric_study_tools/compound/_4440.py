...
class FaceGearMeshCompoundParametricStudyTool(_4445.GearMeshCompoundParametricStudyTool):
    """FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4299.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4299.FaceGearMeshParametricStudyTool]':
