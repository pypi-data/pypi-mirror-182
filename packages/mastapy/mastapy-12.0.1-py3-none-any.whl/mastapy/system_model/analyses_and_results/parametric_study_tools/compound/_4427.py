...
class CVTCompoundParametricStudyTool(_4396.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4280.CVTParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4280.CVTParametricStudyTool]':
