...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4388
...
class FEPartCompoundParametricStudyTool(_4388.AbstractShaftOrHousingCompoundParametricStudyTool):
    """FEPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4302.FEPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4302.FEPartParametricStudyTool]':
