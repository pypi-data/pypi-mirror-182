...
class PowerLoadCompoundParametricStudyTool(_4508.VirtualComponentCompoundParametricStudyTool):
    """PowerLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4344.PowerLoadParametricStudyTool]':
    ...
    @property
    def load_cases(self) -> 'List[_6866.PowerLoadLoadCase]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4344.PowerLoadParametricStudyTool]':
