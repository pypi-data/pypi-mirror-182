...
class PartToPartShearCouplingConnectionCompoundParametricStudyTool(_4424.CouplingConnectionCompoundParametricStudyTool):
    """PartToPartShearCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4337.PartToPartShearCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4337.PartToPartShearCouplingConnectionParametricStudyTool]':
