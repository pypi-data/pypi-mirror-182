...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4509, _4510, _4446
...
class WormGearSetCompoundParametricStudyTool(_4446.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4382.WormGearSetParametricStudyTool]':
    ...
    @property
    def worm_gears_compound_parametric_study_tool(self) -> 'List[_4509.WormGearCompoundParametricStudyTool]':
    ...
    @property
    def worm_meshes_compound_parametric_study_tool(self) -> 'List[_4510.WormGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4382.WormGearSetParametricStudyTool]':
