...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4512, _4513, _4404
...
class ZerolBevelGearSetCompoundParametricStudyTool(_4404.BevelGearSetCompoundParametricStudyTool):
    """ZerolBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4385.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4512.ZerolBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4513.ZerolBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4385.ZerolBevelGearSetParametricStudyTool]':
