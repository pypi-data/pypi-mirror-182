...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4397.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4254.BevelDifferentialSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4254.BevelDifferentialSunGearParametricStudyTool]':
