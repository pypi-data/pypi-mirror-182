...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4403
...
class BevelDifferentialGearMeshCompoundParametricStudyTool(_4403.BevelGearMeshCompoundParametricStudyTool):
    """BevelDifferentialGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4250.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4250.BevelDifferentialGearMeshParametricStudyTool]':
