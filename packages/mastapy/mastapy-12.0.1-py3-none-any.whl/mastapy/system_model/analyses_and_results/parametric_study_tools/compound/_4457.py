...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4455, _4456, _4454
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(_4454.KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4317.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4455.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4456.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4317.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
