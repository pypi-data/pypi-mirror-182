...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4439, _4440, _4446
...
class FaceGearSetCompoundParametricStudyTool(_4446.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4301.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4439.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4440.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4301.FaceGearSetParametricStudyTool]':
