...
class PlanetaryGearSetCompoundParametricStudyTool(_4435.CylindricalGearSetCompoundParametricStudyTool):
    """PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4341.PlanetaryGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4341.PlanetaryGearSetParametricStudyTool]':
