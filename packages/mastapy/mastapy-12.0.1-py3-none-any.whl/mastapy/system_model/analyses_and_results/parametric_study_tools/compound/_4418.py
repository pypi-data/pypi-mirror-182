...
class ConicalGearCompoundParametricStudyTool(_4444.GearCompoundParametricStudyTool):
    """ConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4272.ConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4272.ConicalGearParametricStudyTool]':
