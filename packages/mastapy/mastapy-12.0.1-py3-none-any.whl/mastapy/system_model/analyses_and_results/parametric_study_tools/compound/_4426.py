...
class CVTBeltConnectionCompoundParametricStudyTool(_4395.BeltConnectionCompoundParametricStudyTool):
    """CVTBeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4279.CVTBeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4279.CVTBeltConnectionParametricStudyTool]':
