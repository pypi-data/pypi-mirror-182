...
class KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool(_4420.ConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4314.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4314.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
