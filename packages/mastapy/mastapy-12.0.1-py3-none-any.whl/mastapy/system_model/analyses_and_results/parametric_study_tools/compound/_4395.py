...
class BeltConnectionCompoundParametricStudyTool(_4451.InterMountableComponentConnectionCompoundParametricStudyTool):
    """BeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4248.BeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4248.BeltConnectionParametricStudyTool]':
