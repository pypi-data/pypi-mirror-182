...
class PulleyCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4345.PulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4345.PulleyParametricStudyTool]':
