...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4338.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4338.PartToPartShearCouplingHalfParametricStudyTool]':
