...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4403.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4362.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4362.StraightBevelDiffGearMeshParametricStudyTool]':
