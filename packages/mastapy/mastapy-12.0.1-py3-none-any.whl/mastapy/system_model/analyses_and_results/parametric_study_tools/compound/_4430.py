...
class CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool(_4410.CoaxialConnectionCompoundParametricStudyTool):
    """CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4283.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4283.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
