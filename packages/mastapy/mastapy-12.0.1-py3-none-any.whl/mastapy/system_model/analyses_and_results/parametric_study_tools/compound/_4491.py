...
class StraightBevelDiffGearCompoundParametricStudyTool(_4402.BevelGearCompoundParametricStudyTool):
    """StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4363.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4363.StraightBevelDiffGearParametricStudyTool]':
