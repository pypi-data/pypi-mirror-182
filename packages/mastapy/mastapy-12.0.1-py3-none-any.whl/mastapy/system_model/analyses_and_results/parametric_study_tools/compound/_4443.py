...
class FlexiblePinAssemblyCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """FlexiblePinAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4303.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4303.FlexiblePinAssemblyParametricStudyTool]':
