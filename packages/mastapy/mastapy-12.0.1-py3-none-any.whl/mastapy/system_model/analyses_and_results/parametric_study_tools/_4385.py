...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4384, _4383, _4257
...
class ZerolBevelGearSetParametricStudyTool(_4257.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4384.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4383.ZerolBevelGearMeshParametricStudyTool]':
