...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4293, _4247, _4249, _4252,
    _4258, _4259, _4280, _4262,
    _4267, _4270, _4282, _4284,
    _4288, _4302, _4301, _4303,
    _4310, _4317, _4320, _4321,
    _4322, _4325, _4339, _4342,
    _4343, _4344, _4346, _4348,
    _4352, _4353, _4358, _4361,
    _4364, _4367, _4371, _4375,
    _4378, _4382, _4385, _4239
)
...
class AssemblyParametricStudyTool(_4239.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4293.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4247.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4249.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4252.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4258.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4259.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4280.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4262.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4267.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4270.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4282.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4284.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4288.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4302.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4301.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4303.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4310.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4317.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4320.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4321.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4322.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4325.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4339.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4342.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4343.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4344.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4346.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4348.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4352.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4353.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4358.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4361.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4364.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4367.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4371.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4375.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4378.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4382.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4385.ZerolBevelGearSetParametricStudyTool]':
