...
class CylindricalGearParametricStudyTool(_4305.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2692.CylindricalGearSystemDeflection]':
