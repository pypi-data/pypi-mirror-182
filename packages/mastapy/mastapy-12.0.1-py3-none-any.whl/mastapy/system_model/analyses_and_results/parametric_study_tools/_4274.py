...
class ConnectionParametricStudyTool(_7463.ConnectionAnalysisCase):
    """ConnectionParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1813.DataLoggerWithCharts':
    ...
    @property
    def parametric_study_tool(self) -> '_4331.ParametricStudyTool':
