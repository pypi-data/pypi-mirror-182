...
class FlexiblePinAnalysisStopStartAnalysis(_6198.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self) -> '_2751.ShaftSystemDeflection':
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2751.ShaftSystemDeflection':
