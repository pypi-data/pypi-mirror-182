...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6197
...
class WindTurbineCertificationReport(_6197.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2427.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2747.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2893.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2747.RootAssemblySystemDeflection':
