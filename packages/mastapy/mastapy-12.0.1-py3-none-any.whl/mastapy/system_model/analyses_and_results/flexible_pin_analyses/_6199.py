...
from mastapy.system_model.analyses_and_results.system_deflections import _2705, _2645
...
class FlexiblePinAnalysisConceptLevel(_6198.FlexiblePinAnalysis):
    """FlexiblePinAnalysisConceptLevel
    ...
    @property
    def flexible_pin_extreme_load_case(self) -> '_2705.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def flexible_pin_nominal_load_case(self) -> '_2705.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def planet_bearings_in_nominal_load(self) -> 'List[_2645.BearingSystemDeflection]':
