...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6008, _6009, _6007
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation(_6007.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysisOfSingleExcitation):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6008.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6009.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
