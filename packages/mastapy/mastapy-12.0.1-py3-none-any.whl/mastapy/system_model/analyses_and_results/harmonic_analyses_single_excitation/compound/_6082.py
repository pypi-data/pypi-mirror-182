...
class BevelDifferentialPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6079.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5952.BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5952.BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation]':
