...
class BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6133.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5947.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5947.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
