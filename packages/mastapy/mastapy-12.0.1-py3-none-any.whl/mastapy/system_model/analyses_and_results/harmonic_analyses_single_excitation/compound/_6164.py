...
class ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6104.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6035.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6035.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
