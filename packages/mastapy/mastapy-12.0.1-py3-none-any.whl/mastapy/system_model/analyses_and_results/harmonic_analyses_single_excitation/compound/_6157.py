...
class RingPinsCompoundHarmonicAnalysisOfSingleExcitation(_6145.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """RingPinsCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6028.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6028.RingPinsHarmonicAnalysisOfSingleExcitation]':
