...
class BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation(_6084.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5949.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5949.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
