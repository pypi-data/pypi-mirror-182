...
class CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6077.BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5978.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5978.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
