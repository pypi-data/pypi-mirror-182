...
class RootAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6075.AssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """RootAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6033.RootAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6033.RootAssemblyHarmonicAnalysisOfSingleExcitation]':
