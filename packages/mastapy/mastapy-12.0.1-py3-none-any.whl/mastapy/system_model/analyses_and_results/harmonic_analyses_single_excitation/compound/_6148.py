...
class PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(_6105.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6021.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6021.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
