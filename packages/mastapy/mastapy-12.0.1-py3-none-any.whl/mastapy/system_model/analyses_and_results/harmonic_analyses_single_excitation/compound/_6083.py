...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_6079.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5953.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5953.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
