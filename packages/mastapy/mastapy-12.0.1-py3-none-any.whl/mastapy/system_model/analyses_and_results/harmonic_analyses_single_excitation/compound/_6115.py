...
class CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation(_6126.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5985.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5985.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
