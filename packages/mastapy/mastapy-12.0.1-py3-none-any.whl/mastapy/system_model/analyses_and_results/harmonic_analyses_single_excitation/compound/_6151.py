...
class PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6165.ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6022.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6022.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
