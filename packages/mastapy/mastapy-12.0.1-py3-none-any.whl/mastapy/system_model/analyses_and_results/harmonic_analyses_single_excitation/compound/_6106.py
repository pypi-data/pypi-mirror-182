...
class CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6133.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5975.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5975.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
