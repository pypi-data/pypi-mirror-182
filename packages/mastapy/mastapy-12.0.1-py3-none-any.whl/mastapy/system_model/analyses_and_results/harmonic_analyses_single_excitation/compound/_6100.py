...
class ConicalGearCompoundHarmonicAnalysisOfSingleExcitation(_6126.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """ConicalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5970.ConicalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5970.ConicalGearHarmonicAnalysisOfSingleExcitation]':
