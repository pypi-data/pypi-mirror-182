...
class MassDiscCompoundHarmonicAnalysisOfSingleExcitation(_6190.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MassDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6014.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6014.MassDiscHarmonicAnalysisOfSingleExcitation]':
