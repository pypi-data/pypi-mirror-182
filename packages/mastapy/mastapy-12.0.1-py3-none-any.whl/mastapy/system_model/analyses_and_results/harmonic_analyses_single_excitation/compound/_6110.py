...
class CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation(_6156.PulleyCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5980.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5980.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
