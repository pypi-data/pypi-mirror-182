...
class WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6127.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6063.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6063.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
