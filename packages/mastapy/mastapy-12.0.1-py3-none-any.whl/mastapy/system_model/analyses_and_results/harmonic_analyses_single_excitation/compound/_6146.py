...
class OilSealCompoundHarmonicAnalysisOfSingleExcitation(_6104.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """OilSealCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6017.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6017.OilSealHarmonicAnalysisOfSingleExcitation]':
