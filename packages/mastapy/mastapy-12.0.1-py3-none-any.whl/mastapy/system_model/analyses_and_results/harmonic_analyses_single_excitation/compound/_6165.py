...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6071.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6036.ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6036.ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation]':
