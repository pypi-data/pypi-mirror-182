...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6074.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
