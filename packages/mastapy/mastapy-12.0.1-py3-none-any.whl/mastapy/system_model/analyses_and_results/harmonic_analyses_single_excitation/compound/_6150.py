...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_6107.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6020.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6020.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
