...
class ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6128.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5972.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5972.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
