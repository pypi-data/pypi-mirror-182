...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6191, _6192, _6128
...
class WormGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6128.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6064.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6191.WormGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6192.WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6064.WormGearSetHarmonicAnalysisOfSingleExcitation]':
