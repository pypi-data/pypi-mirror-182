...
class StraightBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_6084.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6047.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6047.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
