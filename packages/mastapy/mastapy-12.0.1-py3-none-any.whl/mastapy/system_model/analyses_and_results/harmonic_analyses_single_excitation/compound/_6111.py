...
class CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6166.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5981.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5981.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]':
