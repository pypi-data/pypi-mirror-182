...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6102.ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5944.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5944.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
