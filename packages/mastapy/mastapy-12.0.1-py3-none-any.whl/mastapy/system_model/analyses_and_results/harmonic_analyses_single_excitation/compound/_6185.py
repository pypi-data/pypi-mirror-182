...
class TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation(_6105.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6057.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6057.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
