...
class ConceptGearCompoundHarmonicAnalysisOfSingleExcitation(_6126.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5967.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5967.ConceptGearHarmonicAnalysisOfSingleExcitation]':
