...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6097, _6098, _6128
...
class ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6128.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5969.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6097.ConceptGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6098.ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5969.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
