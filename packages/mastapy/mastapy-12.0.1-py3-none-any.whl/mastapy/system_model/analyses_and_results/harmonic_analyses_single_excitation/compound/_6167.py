...
class SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_6084.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6038.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6038.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
