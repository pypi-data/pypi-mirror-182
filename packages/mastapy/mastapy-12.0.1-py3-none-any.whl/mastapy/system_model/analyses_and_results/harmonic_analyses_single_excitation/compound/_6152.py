...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6117.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6023.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6023.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
