...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6062, _6063, _5998
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_5998.GearSetHarmonicAnalysisOfSingleExcitation):
    """WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6062.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6063.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
