...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6001, _6002, _5944
...
class HypoidGearSetHarmonicAnalysisOfSingleExcitation(_5944.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation):
    """HypoidGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def hypoid_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6001.HypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6002.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
