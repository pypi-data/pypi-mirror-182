...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6065, _6066, _5956
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6065.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6066.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
