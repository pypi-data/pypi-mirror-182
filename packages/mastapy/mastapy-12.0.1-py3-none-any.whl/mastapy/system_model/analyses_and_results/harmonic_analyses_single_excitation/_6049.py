...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6047, _6048, _5956
...
class StraightBevelGearSetHarmonicAnalysisOfSingleExcitation(_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6047.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6048.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
