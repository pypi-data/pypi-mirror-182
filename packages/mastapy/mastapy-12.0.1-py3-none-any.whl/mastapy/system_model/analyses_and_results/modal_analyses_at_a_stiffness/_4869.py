...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4868, _4867, _4866
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness(_4866.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4868.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4867.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
