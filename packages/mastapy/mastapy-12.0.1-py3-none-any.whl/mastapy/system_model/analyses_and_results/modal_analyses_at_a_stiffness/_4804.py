...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import (
    _4805, _4807, _4810, _4816,
    _4817, _4838, _4820, _4825,
    _4828, _4840, _4842, _4846,
    _4854, _4853, _4855, _4862,
    _4869, _4872, _4873, _4874,
    _4876, _4880, _4883, _4884,
    _4885, _4887, _4889, _4893,
    _4894, _4899, _4902, _4905,
    _4908, _4912, _4916, _4919,
    _4923, _4926, _4797
)
...
class AssemblyModalAnalysisAtAStiffness(_4797.AbstractAssemblyModalAnalysisAtAStiffness):
    """AssemblyModalAnalysisAtAStiffness
    ...
    @property
    def bearings(self) -> 'List[_4805.BearingModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4807.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4810.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4816.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4817.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4838.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4820.ClutchModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4825.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4828.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4840.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4842.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4846.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4854.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4853.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4855.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4862.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4869.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4872.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_4873.MassDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_4874.MeasurementComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_4876.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4880.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4883.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_4884.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_4885.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_4887.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4889.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4893.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_4894.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4899.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4902.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4905.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4908.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_4912.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_4916.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4919.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4923.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4926.ZerolBevelGearSetModalAnalysisAtAStiffness]':
