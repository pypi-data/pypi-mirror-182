...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4809, _4808, _4815
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4815.BevelGearSetModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4809.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4808.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
