...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4907, _4906, _4815
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4815.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4907.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4906.StraightBevelGearMeshModalAnalysisAtAStiffness]':
