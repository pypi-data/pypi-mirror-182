...
class ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness(_4965.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4823.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4823.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
