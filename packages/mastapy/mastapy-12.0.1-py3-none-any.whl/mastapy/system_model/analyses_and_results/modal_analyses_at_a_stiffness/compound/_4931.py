...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4959.ConicalGearCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4802.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4802.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
