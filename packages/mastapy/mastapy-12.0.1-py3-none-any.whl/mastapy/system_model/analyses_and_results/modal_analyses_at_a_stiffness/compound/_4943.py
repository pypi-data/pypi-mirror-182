...
class BevelGearCompoundModalAnalysisAtAStiffness(_4931.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """BevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4814.BevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4814.BevelGearModalAnalysisAtAStiffness]':
