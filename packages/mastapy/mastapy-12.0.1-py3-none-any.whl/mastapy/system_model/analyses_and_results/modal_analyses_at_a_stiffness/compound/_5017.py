...
class RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(_4992.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4888.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4888.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
