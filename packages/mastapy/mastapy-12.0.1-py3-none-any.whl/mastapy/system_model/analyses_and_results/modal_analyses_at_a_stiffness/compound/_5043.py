...
class SynchroniserSleeveCompoundModalAnalysisAtAStiffness(_5042.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    """SynchroniserSleeveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4914.SynchroniserSleeveModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4914.SynchroniserSleeveModalAnalysisAtAStiffness]':
