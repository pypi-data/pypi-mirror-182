...
class RootAssemblyCompoundModalAnalysisAtAStiffness(_4934.AssemblyCompoundModalAnalysisAtAStiffness):
    """RootAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4892.RootAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4892.RootAssemblyModalAnalysisAtAStiffness]':
