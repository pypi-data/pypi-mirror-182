...
class SpringDamperCompoundModalAnalysisAtAStiffness(_4964.CouplingCompoundModalAnalysisAtAStiffness):
    """SpringDamperCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4902.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4902.SpringDamperModalAnalysisAtAStiffness]':
