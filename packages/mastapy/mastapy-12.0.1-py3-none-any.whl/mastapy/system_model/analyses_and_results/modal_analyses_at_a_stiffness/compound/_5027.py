...
class SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(_4944.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4897.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4897.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
