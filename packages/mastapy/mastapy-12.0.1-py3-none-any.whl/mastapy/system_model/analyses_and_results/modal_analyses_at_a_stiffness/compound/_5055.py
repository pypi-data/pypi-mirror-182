...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5053, _5054, _4945
...
class ZerolBevelGearSetCompoundModalAnalysisAtAStiffness(_4945.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4926.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5053.ZerolBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5054.ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4926.ZerolBevelGearSetModalAnalysisAtAStiffness]':
