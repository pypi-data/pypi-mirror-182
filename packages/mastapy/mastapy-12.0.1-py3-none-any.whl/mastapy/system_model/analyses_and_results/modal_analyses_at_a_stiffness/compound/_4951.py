...
class CoaxialConnectionCompoundModalAnalysisAtAStiffness(_5024.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CoaxialConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4821.CoaxialConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4821.CoaxialConnectionModalAnalysisAtAStiffness]':
