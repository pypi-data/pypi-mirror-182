...
class TorqueConverterPumpCompoundModalAnalysisAtAStiffness(_4966.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterPumpCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4917.TorqueConverterPumpModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4917.TorqueConverterPumpModalAnalysisAtAStiffness]':
