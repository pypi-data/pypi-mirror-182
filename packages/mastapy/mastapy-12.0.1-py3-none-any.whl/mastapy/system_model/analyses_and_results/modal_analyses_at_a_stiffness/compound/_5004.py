...
class MountableComponentCompoundModalAnalysisAtAStiffness(_4952.ComponentCompoundModalAnalysisAtAStiffness):
    """MountableComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4875.MountableComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4875.MountableComponentModalAnalysisAtAStiffness]':
