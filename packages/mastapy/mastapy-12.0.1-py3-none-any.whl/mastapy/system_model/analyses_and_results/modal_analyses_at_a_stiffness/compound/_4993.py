...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4959
...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness(_4959.ConicalGearCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4865.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4865.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
