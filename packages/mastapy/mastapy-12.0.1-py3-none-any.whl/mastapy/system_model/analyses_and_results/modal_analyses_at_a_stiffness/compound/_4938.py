...
class BevelDifferentialGearCompoundModalAnalysisAtAStiffness(_4943.BevelGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4809.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4809.BevelDifferentialGearModalAnalysisAtAStiffness]':
