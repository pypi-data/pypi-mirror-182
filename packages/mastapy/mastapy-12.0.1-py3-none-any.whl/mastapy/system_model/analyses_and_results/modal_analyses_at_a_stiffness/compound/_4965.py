...
class CouplingConnectionCompoundModalAnalysisAtAStiffness(_4992.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4834.CouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4834.CouplingConnectionModalAnalysisAtAStiffness]':
