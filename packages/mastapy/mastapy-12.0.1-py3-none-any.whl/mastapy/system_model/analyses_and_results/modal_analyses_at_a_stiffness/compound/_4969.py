...
class CVTPulleyCompoundModalAnalysisAtAStiffness(_5015.PulleyCompoundModalAnalysisAtAStiffness):
    """CVTPulleyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4839.CVTPulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4839.CVTPulleyModalAnalysisAtAStiffness]':
