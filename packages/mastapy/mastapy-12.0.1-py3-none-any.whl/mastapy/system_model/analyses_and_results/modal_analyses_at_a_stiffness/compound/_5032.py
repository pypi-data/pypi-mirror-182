...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4943.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4904.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4904.StraightBevelDiffGearModalAnalysisAtAStiffness]':
