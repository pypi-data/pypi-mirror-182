...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness(_4961.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4803.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4803.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
