...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4936.BeltConnectionCompoundModalAnalysisAtAStiffness):
    """CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4837.CVTBeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4837.CVTBeltConnectionModalAnalysisAtAStiffness]':
