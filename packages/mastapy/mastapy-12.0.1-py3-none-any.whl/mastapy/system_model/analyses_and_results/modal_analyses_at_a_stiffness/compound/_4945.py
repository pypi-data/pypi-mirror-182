...
class BevelGearSetCompoundModalAnalysisAtAStiffness(_4933.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """BevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4815.BevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4815.BevelGearSetModalAnalysisAtAStiffness]':
