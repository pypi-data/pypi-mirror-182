...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5026, _5027, _4945
...
class SpiralBevelGearSetCompoundModalAnalysisAtAStiffness(_4945.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4899.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5026.SpiralBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5027.SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4899.SpiralBevelGearSetModalAnalysisAtAStiffness]':
