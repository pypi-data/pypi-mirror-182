...
class ClutchConnectionCompoundModalAnalysisAtAStiffness(_4965.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ClutchConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4818.ClutchConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4818.ClutchConnectionModalAnalysisAtAStiffness]':
