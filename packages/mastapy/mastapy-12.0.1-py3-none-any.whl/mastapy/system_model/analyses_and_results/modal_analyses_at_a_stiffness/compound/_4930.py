...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4962.ConnectionCompoundModalAnalysisAtAStiffness):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4800.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4800.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
