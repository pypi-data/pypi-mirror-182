...
class WormGearMeshCompoundModalAnalysisAtAStiffness(_4986.GearMeshCompoundModalAnalysisAtAStiffness):
    """WormGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4921.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4921.WormGearMeshModalAnalysisAtAStiffness]':
