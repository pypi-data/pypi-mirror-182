...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4965.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4900.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4900.SpringDamperConnectionModalAnalysisAtAStiffness]':
