...
class ClutchCompoundModalAnalysisAtAStiffness(_4964.CouplingCompoundModalAnalysisAtAStiffness):
    """ClutchCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4820.ClutchModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4820.ClutchModalAnalysisAtAStiffness]':
