...
class ConnectorCompoundModalAnalysisAtAStiffness(_5004.MountableComponentCompoundModalAnalysisAtAStiffness):
    """ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4833.ConnectorModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4833.ConnectorModalAnalysisAtAStiffness]':
