...
class ConicalGearCompoundModalAnalysisAtAStiffness(_4985.GearCompoundModalAnalysisAtAStiffness):
    """ConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4830.ConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4830.ConicalGearModalAnalysisAtAStiffness]':
