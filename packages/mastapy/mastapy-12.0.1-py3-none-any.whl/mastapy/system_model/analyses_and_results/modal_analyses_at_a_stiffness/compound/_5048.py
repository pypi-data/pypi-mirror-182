...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(_5049.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """UnbalancedMassCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4919.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4919.UnbalancedMassModalAnalysisAtAStiffness]':
