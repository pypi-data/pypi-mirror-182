...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness(_4951.CoaxialConnectionCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4841.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4841.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
