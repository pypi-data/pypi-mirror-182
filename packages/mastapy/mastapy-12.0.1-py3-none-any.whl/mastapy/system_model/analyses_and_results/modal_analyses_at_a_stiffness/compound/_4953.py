...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4964.CouplingCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4825.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4825.ConceptCouplingModalAnalysisAtAStiffness]':
