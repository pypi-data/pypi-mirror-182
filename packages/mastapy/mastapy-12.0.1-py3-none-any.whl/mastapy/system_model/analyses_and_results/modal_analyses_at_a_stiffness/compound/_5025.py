...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4927
...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4927.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4896.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4896.SpecialisedAssemblyModalAnalysisAtAStiffness]':
