...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4956, _4957, _4987
...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(_4987.GearSetCompoundModalAnalysisAtAStiffness):
    """ConceptGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4828.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4956.ConceptGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4957.ConceptGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4828.ConceptGearSetModalAnalysisAtAStiffness]':
