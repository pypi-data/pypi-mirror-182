...
class FaceGearMeshCompoundModalAnalysisAtAStiffness(_4986.GearMeshCompoundModalAnalysisAtAStiffness):
    """FaceGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4851.FaceGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4851.FaceGearMeshModalAnalysisAtAStiffness]':
