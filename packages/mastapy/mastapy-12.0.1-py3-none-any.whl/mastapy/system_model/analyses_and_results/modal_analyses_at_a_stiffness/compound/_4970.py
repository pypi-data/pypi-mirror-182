...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(_5025.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CycloidalAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4840.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4840.CycloidalAssemblyModalAnalysisAtAStiffness]':
