...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5032, _5033, _4945
...
class StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness(_4945.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4905.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5032.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5033.StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4905.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
