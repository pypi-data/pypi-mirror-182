...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_4986.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4844.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4844.CylindricalGearMeshModalAnalysisAtAStiffness]':
