...
class BeltConnectionCompoundModalAnalysisAtAStiffness(_4992.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """BeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4806.BeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4806.BeltConnectionModalAnalysisAtAStiffness]':
