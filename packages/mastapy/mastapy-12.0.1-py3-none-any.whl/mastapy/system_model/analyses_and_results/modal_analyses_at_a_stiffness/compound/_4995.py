...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness(_4961.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4866.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4866.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
