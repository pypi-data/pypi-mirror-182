...
class HypoidGearMeshCompoundModalAnalysisAtAStiffness(_4932.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """HypoidGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4860.HypoidGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4860.HypoidGearMeshModalAnalysisAtAStiffness]':
