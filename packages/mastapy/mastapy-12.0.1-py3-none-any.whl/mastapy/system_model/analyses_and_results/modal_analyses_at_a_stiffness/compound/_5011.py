...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4976.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4882.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4882.PlanetaryGearSetModalAnalysisAtAStiffness]':
