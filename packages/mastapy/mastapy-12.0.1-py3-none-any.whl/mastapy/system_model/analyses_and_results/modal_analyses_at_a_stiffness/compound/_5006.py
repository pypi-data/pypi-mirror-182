...
class PartCompoundModalAnalysisAtAStiffness(_7471.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4877.PartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4877.PartModalAnalysisAtAStiffness]':
