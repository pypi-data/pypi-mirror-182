...
class CouplingHalfCompoundModalAnalysisAtAStiffness(_5004.MountableComponentCompoundModalAnalysisAtAStiffness):
    """CouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4835.CouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4835.CouplingHalfModalAnalysisAtAStiffness]':
