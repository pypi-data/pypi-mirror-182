...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtAStiffness(_4965.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4878.PartToPartShearCouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4878.PartToPartShearCouplingConnectionModalAnalysisAtAStiffness]':
