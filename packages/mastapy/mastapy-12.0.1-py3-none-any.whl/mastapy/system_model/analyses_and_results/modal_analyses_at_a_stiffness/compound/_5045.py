...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4965.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4915.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4915.TorqueConverterConnectionModalAnalysisAtAStiffness]':
