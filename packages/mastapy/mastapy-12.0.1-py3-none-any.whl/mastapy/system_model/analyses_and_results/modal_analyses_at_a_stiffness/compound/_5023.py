...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4963.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4893.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4893.ShaftHubConnectionModalAnalysisAtAStiffness]':
