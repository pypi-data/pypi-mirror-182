...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4952.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4850.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4850.ExternalCADModelModalAnalysisAtAStiffness]':
