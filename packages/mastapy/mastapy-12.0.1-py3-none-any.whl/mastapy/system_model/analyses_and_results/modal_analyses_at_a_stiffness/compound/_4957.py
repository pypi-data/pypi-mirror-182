...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_4986.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConceptGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4826.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4826.ConceptGearMeshModalAnalysisAtAStiffness]':
