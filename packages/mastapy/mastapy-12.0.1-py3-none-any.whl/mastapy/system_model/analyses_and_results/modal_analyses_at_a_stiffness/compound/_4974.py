...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4985.GearCompoundModalAnalysisAtAStiffness):
    """CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4845.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4845.CylindricalGearModalAnalysisAtAStiffness]':
