...
class PowerLoadCompoundModalAnalysisAtAStiffness(_5049.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4885.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4885.PowerLoadModalAnalysisAtAStiffness]':
