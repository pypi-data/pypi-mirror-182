...
class SynchroniserCompoundModalAnalysisAtAStiffness(_5025.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """SynchroniserCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4912.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4912.SynchroniserModalAnalysisAtAStiffness]':
