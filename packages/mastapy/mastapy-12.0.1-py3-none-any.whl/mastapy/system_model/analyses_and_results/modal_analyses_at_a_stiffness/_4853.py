...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4852, _4851, _4858
...
class FaceGearSetModalAnalysisAtAStiffness(_4858.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4852.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4851.FaceGearMeshModalAnalysisAtAStiffness]':
