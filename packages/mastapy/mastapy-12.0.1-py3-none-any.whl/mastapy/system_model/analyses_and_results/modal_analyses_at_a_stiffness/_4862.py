...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4861, _4860, _4803
...
class HypoidGearSetModalAnalysisAtAStiffness(_4803.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    """HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4861.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4860.HypoidGearMeshModalAnalysisAtAStiffness]':
