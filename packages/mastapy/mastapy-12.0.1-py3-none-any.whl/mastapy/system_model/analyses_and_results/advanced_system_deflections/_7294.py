...
class RollingRingConnectionAdvancedSystemDeflection(_7265.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2745.RollingRingConnectionSystemDeflection]':
