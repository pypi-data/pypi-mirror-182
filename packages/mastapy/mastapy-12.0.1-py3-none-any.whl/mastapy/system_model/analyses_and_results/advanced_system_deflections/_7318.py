...
class TorqueConverterAdvancedSystemDeflection(_7236.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2777.TorqueConverterSystemDeflection]':
