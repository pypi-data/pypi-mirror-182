...
class HypoidGearAdvancedSystemDeflection(_7202.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2712.HypoidGearSystemDeflection]':
