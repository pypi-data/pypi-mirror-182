...
class SpiralBevelGearMeshAdvancedSystemDeflection(_7215.BevelGearMeshAdvancedSystemDeflection):
    """SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2754.SpiralBevelGearMeshSystemDeflection]':
