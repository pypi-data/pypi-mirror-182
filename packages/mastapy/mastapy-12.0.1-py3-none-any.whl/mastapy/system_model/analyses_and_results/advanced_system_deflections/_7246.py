...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7247, _7249, _7258
...
class CylindricalGearAdvancedSystemDeflection(_7258.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7247.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7249.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7249.CylindricalMeshedGearAdvancedSystemDeflection]':
