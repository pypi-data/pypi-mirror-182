...
class TorqueConverterTurbineAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2778.TorqueConverterTurbineSystemDeflection]':
