...
class ConceptCouplingConnectionAdvancedSystemDeflection(_7237.CouplingConnectionAdvancedSystemDeflection):
    """ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2664.ConceptCouplingConnectionSystemDeflection]':
