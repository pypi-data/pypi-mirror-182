...
class RingPinsAdvancedSystemDeflection(_7278.MountableComponentAdvancedSystemDeflection):
    """RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2741.RingPinsSystemDeflection]':
