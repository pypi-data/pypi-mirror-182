...
class BoltAdvancedSystemDeflection(_7223.ComponentAdvancedSystemDeflection):
    """BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2657.BoltSystemDeflection]':
