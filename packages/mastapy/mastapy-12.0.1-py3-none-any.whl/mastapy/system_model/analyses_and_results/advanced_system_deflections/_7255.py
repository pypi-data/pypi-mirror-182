...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7253, _7254, _7260
...
class FaceGearSetAdvancedSystemDeflection(_7260.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2702.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7253.FaceGearAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7254.FaceGearMeshAdvancedSystemDeflection]':
