...
class SynchroniserHalfAdvancedSystemDeflection(_7316.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2768.SynchroniserHalfSystemDeflection]':
