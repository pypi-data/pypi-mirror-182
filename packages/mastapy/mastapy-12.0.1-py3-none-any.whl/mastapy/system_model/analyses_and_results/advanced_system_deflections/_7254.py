...
class FaceGearMeshAdvancedSystemDeflection(_7259.GearMeshAdvancedSystemDeflection):
    """FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2701.FaceGearMeshSystemDeflection]':
