...
class RollingRingAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2746.RollingRingSystemDeflection]':
