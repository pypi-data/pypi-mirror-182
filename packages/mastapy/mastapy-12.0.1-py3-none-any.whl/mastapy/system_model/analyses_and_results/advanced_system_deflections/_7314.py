...
class SynchroniserAdvancedSystemDeflection(_7299.SpecialisedAssemblyAdvancedSystemDeflection):
    """SynchroniserAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2771.SynchroniserSystemDeflection]':
