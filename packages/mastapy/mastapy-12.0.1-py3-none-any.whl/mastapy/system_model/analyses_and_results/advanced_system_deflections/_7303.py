...
class SpringDamperAdvancedSystemDeflection(_7236.CouplingAdvancedSystemDeflection):
    """SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2759.SpringDamperSystemDeflection]':
