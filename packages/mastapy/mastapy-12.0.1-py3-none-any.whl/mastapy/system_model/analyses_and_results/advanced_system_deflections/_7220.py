...
class ClutchConnectionAdvancedSystemDeflection(_7237.CouplingConnectionAdvancedSystemDeflection):
    """ClutchConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2658.ClutchConnectionSystemDeflection]':
