...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7269, _7270, _7268
...
class KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection(_7268.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_advanced_system_deflection(self) -> 'List[_7269.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_advanced_system_deflection(self) -> 'List[_7270.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
