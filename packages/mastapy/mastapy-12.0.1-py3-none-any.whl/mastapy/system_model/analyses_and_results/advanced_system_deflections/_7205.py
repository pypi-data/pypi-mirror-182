...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import (
    _7206, _7208, _7211, _7218,
    _7217, _7239, _7219, _7224,
    _7229, _7242, _7243, _7248,
    _7256, _7255, _7257, _7264,
    _7271, _7274, _7276, _7277,
    _7279, _7281, _7286, _7287,
    _7288, _7290, _7293, _7297,
    _7296, _7302, _7303, _7308,
    _7311, _7314, _7318, _7323,
    _7327, _7330, _7195
)
...
class AssemblyAdvancedSystemDeflection(_7195.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2644.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7206.BearingAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7208.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7211.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7218.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7217.BoltAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7239.CVTAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7219.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7224.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7229.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7242.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7243.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7248.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7256.FEPartAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7255.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7257.FlexiblePinAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7264.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7271.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7274.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7276.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7277.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7279.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7281.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7286.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7287.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7288.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7290.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7293.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7297.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7296.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7302.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7303.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7308.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7311.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7314.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7318.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7323.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7327.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7330.ZerolBevelGearSetAdvancedSystemDeflection]':
