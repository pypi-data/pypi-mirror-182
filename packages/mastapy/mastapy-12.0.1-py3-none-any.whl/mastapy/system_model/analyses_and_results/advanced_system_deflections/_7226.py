...
class ConceptCouplingHalfAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2665.ConceptCouplingHalfSystemDeflection]':
