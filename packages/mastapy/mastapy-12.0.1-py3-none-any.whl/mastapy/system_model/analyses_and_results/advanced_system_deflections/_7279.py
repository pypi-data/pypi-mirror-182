...
class OilSealAdvancedSystemDeflection(_7234.ConnectorAdvancedSystemDeflection):
    """OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2731.OilSealSystemDeflection]':
