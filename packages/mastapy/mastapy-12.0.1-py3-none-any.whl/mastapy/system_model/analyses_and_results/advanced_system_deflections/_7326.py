...
class WormGearMeshAdvancedSystemDeflection(_7259.GearMeshAdvancedSystemDeflection):
    """WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2783.WormGearMeshSystemDeflection]':
