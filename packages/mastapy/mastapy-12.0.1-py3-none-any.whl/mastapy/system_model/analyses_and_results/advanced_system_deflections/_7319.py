...
class TorqueConverterConnectionAdvancedSystemDeflection(_7237.CouplingConnectionAdvancedSystemDeflection):
    """TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2775.TorqueConverterConnectionSystemDeflection]':
