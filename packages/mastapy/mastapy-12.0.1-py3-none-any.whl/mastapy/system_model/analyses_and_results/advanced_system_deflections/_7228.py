...
class ConceptGearMeshAdvancedSystemDeflection(_7259.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2667.ConceptGearMeshSystemDeflection]':
