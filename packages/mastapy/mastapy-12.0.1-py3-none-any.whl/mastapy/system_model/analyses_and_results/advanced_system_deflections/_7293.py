...
class RollingRingAssemblyAdvancedSystemDeflection(_7299.SpecialisedAssemblyAdvancedSystemDeflection):
    """RollingRingAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2744.RollingRingAssemblySystemDeflection]':
