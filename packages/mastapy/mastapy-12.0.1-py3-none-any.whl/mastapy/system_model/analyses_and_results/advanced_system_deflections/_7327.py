...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7325, _7326, _7260
...
class WormGearSetAdvancedSystemDeflection(_7260.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2784.WormGearSetSystemDeflection]':
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_7325.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_7326.WormGearMeshAdvancedSystemDeflection]':
