...
class PartToPartShearCouplingAdvancedSystemDeflection(_7236.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2735.PartToPartShearCouplingSystemDeflection]':
