...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7384, _7385, _7391
...
class FaceGearSetCompoundAdvancedSystemDeflection(_7391.GearSetCompoundAdvancedSystemDeflection):
    """FaceGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7255.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def face_gears_compound_advanced_system_deflection(self) -> 'List[_7384.FaceGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_compound_advanced_system_deflection(self) -> 'List[_7385.FaceGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7255.FaceGearSetAdvancedSystemDeflection]':
