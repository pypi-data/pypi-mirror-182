...
class ZerolBevelGearMeshCompoundAdvancedSystemDeflection(_7348.BevelGearMeshCompoundAdvancedSystemDeflection):
    """ZerolBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7329.ZerolBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7329.ZerolBevelGearMeshAdvancedSystemDeflection]':
