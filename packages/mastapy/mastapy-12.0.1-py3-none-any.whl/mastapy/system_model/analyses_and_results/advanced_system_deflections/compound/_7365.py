...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7391.GearSetCompoundAdvancedSystemDeflection):
    """ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7232.ConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7232.ConicalGearSetAdvancedSystemDeflection]':
