...
class HypoidGearMeshCompoundAdvancedSystemDeflection(_7336.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """HypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7263.HypoidGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7263.HypoidGearMeshAdvancedSystemDeflection]':
