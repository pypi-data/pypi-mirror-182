...
class FaceGearCompoundAdvancedSystemDeflection(_7389.GearCompoundAdvancedSystemDeflection):
    """FaceGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7253.FaceGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7253.FaceGearAdvancedSystemDeflection]':
