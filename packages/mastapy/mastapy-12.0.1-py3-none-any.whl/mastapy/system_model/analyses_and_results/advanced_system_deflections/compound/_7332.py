...
class AbstractShaftCompoundAdvancedSystemDeflection(_7333.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    """AbstractShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7196.AbstractShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7196.AbstractShaftAdvancedSystemDeflection]':
