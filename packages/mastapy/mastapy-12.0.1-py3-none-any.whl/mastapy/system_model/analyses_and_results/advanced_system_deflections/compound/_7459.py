...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7457, _7458, _7349
...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(_7349.BevelGearSetCompoundAdvancedSystemDeflection):
    """ZerolBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7330.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7457.ZerolBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7458.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7330.ZerolBevelGearSetAdvancedSystemDeflection]':
