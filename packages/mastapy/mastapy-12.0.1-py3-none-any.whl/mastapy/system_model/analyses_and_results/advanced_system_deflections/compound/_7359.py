...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7226.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7226.ConceptCouplingHalfAdvancedSystemDeflection]':
