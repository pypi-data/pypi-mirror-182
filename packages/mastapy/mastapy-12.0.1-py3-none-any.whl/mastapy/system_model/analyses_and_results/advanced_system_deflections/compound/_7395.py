...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7393, _7394, _7337
...
class HypoidGearSetCompoundAdvancedSystemDeflection(_7337.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection):
    """HypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7264.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_7393.HypoidGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_7394.HypoidGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7264.HypoidGearSetAdvancedSystemDeflection]':
