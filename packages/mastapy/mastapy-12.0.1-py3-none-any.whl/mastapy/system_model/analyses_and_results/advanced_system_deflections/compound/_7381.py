...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7378.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7250.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7250.CylindricalPlanetGearAdvancedSystemDeflection]':
