...
class RollingRingConnectionCompoundAdvancedSystemDeflection(_7396.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RollingRingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7294.RollingRingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7294.RollingRingConnectionAdvancedSystemDeflection]':
