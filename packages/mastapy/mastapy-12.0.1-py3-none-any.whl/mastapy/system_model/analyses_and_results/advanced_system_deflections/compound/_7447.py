...
class SynchroniserSleeveCompoundAdvancedSystemDeflection(_7446.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserSleeveCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7317.SynchroniserSleeveAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7317.SynchroniserSleeveAdvancedSystemDeflection]':
