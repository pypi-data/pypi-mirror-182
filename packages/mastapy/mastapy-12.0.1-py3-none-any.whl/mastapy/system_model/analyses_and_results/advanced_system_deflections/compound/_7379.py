...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(_7390.GearMeshCompoundAdvancedSystemDeflection):
    """CylindricalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7247.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7247.CylindricalGearMeshAdvancedSystemDeflection]':
