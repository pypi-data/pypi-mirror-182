...
class VirtualComponentCompoundAdvancedSystemDeflection(_7408.MountableComponentCompoundAdvancedSystemDeflection):
    """VirtualComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7324.VirtualComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7324.VirtualComponentAdvancedSystemDeflection]':
