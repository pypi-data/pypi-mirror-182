...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7342, _7343, _7349
...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(_7349.BevelGearSetCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7211.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_system_deflection(self) -> 'List[_7342.BevelDifferentialGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_system_deflection(self) -> 'List[_7343.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7211.BevelDifferentialGearSetAdvancedSystemDeflection]':
