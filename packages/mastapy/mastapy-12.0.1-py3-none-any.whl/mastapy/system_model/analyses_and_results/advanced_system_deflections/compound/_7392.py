...
class GuideDxfModelCompoundAdvancedSystemDeflection(_7356.ComponentCompoundAdvancedSystemDeflection):
    """GuideDxfModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7261.GuideDxfModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7261.GuideDxfModelAdvancedSystemDeflection]':
