...
class PowerLoadCompoundAdvancedSystemDeflection(_7453.VirtualComponentCompoundAdvancedSystemDeflection):
    """PowerLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7288.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7288.PowerLoadAdvancedSystemDeflection]':
