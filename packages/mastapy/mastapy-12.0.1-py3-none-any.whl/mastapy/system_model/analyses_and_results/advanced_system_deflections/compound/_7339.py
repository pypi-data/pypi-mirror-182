...
class BearingCompoundAdvancedSystemDeflection(_7367.ConnectorCompoundAdvancedSystemDeflection):
    """BearingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7206.BearingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7206.BearingAdvancedSystemDeflection]':
