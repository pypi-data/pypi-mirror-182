...
class WormGearCompoundAdvancedSystemDeflection(_7389.GearCompoundAdvancedSystemDeflection):
    """WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7325.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7325.WormGearAdvancedSystemDeflection]':
