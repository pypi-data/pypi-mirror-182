...
class PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7283.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7283.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
