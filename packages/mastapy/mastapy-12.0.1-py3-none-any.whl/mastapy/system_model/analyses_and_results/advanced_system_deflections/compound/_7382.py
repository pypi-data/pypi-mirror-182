...
class DatumCompoundAdvancedSystemDeflection(_7356.ComponentCompoundAdvancedSystemDeflection):
    """DatumCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7251.DatumAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7251.DatumAdvancedSystemDeflection]':
