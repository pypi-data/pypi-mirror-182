...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7439, _7440, _7349
...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(_7349.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7311.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7439.StraightBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7440.StraightBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7311.StraightBevelGearSetAdvancedSystemDeflection]':
