...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7436, _7437, _7349
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_7349.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7308.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_7436.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_7437.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7308.StraightBevelDiffGearSetAdvancedSystemDeflection]':
