...
class PartToPartShearCouplingCompoundAdvancedSystemDeflection(_7368.CouplingCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7281.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7281.PartToPartShearCouplingAdvancedSystemDeflection]':
