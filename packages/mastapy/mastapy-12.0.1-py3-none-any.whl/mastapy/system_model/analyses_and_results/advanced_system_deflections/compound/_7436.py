...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7347.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7306.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7306.StraightBevelDiffGearAdvancedSystemDeflection]':
