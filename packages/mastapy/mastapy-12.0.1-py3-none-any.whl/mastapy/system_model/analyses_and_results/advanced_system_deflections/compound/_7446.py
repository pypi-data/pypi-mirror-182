...
class SynchroniserPartCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """SynchroniserPartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7316.SynchroniserPartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7316.SynchroniserPartAdvancedSystemDeflection]':
