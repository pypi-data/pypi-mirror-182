...
class SpringDamperConnectionCompoundAdvancedSystemDeflection(_7369.CouplingConnectionCompoundAdvancedSystemDeflection):
    """SpringDamperConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7304.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7304.SpringDamperConnectionAdvancedSystemDeflection]':
