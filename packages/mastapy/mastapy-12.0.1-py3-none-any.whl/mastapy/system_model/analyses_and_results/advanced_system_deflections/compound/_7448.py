...
class TorqueConverterCompoundAdvancedSystemDeflection(_7368.CouplingCompoundAdvancedSystemDeflection):
    """TorqueConverterCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7318.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7318.TorqueConverterAdvancedSystemDeflection]':
