...
class CVTPulleyCompoundAdvancedSystemDeflection(_7419.PulleyCompoundAdvancedSystemDeflection):
    """CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7241.CVTPulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7241.CVTPulleyAdvancedSystemDeflection]':
