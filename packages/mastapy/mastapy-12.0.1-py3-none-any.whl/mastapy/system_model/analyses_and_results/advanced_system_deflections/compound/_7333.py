...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7356.ComponentCompoundAdvancedSystemDeflection):
    """AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7197.AbstractShaftOrHousingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7197.AbstractShaftOrHousingAdvancedSystemDeflection]':
