...
class StraightBevelSunGearCompoundAdvancedSystemDeflection(_7436.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7313.StraightBevelSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7313.StraightBevelSunGearAdvancedSystemDeflection]':
