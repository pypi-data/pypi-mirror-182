...
class ExternalCADModelCompoundAdvancedSystemDeflection(_7356.ComponentCompoundAdvancedSystemDeflection):
    """ExternalCADModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7252.ExternalCADModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7252.ExternalCADModelAdvancedSystemDeflection]':
