...
class ConceptCouplingConnectionCompoundAdvancedSystemDeflection(_7369.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ConceptCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7225.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7225.ConceptCouplingConnectionAdvancedSystemDeflection]':
