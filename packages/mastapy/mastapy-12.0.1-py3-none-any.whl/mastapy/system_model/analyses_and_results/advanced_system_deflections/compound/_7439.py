...
class StraightBevelGearCompoundAdvancedSystemDeflection(_7347.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7309.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7309.StraightBevelGearAdvancedSystemDeflection]':
