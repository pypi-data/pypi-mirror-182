...
class PlanetaryConnectionCompoundAdvancedSystemDeflection(_7428.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """PlanetaryConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7284.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7284.PlanetaryConnectionAdvancedSystemDeflection]':
