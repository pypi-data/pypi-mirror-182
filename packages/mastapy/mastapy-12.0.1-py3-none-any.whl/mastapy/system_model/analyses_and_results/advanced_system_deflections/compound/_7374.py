...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(_7429.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """CycloidalAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7242.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7242.CycloidalAssemblyAdvancedSystemDeflection]':
