...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7347.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7328.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7328.ZerolBevelGearAdvancedSystemDeflection]':
