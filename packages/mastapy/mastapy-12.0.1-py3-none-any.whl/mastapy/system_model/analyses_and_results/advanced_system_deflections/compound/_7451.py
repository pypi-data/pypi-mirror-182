...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7321.TorqueConverterTurbineAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7321.TorqueConverterTurbineAdvancedSystemDeflection]':
