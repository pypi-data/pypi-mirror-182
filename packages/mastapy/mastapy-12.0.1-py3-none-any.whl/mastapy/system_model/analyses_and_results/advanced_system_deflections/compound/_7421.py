...
class RingPinsToDiscConnectionCompoundAdvancedSystemDeflection(_7396.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RingPinsToDiscConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7291.RingPinsToDiscConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7291.RingPinsToDiscConnectionAdvancedSystemDeflection]':
