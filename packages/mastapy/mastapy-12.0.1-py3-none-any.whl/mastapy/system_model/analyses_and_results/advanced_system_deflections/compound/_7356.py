...
class ComponentCompoundAdvancedSystemDeflection(_7410.PartCompoundAdvancedSystemDeflection):
    """ComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7223.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7223.ComponentAdvancedSystemDeflection]':
