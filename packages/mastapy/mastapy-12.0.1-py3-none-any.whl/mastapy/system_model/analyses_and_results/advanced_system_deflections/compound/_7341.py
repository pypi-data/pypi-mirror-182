...
class BeltDriveCompoundAdvancedSystemDeflection(_7429.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BeltDriveCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7208.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7208.BeltDriveAdvancedSystemDeflection]':
