...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7378, _7379, _7391
...
class CylindricalGearSetCompoundAdvancedSystemDeflection(_7391.GearSetCompoundAdvancedSystemDeflection):
    """CylindricalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7248.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gears_compound_advanced_system_deflection(self) -> 'List[_7378.CylindricalGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_advanced_system_deflection(self) -> 'List[_7379.CylindricalGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7248.CylindricalGearSetAdvancedSystemDeflection]':
