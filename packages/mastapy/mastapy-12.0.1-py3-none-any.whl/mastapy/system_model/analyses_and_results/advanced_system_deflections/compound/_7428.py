...
class ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7334.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7298.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7298.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
