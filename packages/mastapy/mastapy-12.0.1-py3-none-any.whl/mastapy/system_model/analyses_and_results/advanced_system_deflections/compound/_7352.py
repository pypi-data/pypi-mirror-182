...
class ClutchCompoundAdvancedSystemDeflection(_7368.CouplingCompoundAdvancedSystemDeflection):
    """ClutchCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7219.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7219.ClutchAdvancedSystemDeflection]':
