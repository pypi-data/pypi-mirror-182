...
class ConnectionCompoundAdvancedSystemDeflection(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7233.ConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7233.ConnectionAdvancedSystemDeflection]':
