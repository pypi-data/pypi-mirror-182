...
class BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection(_7342.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7212.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7212.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
