...
class SpringDamperCompoundAdvancedSystemDeflection(_7368.CouplingCompoundAdvancedSystemDeflection):
    """SpringDamperCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7303.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7303.SpringDamperAdvancedSystemDeflection]':
