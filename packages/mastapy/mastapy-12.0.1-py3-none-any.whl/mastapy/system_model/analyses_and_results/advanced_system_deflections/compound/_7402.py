...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7400, _7401, _7399
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection(_7399.KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7271.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_7400.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_7401.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7271.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
