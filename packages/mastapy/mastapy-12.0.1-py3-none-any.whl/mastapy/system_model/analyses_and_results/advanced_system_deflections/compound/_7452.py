...
class UnbalancedMassCompoundAdvancedSystemDeflection(_7453.VirtualComponentCompoundAdvancedSystemDeflection):
    """UnbalancedMassCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7323.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7323.UnbalancedMassAdvancedSystemDeflection]':
