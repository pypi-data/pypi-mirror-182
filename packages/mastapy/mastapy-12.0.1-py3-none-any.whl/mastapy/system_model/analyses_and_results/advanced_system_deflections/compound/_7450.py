...
class TorqueConverterPumpCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterPumpCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7320.TorqueConverterPumpAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7320.TorqueConverterPumpAdvancedSystemDeflection]':
