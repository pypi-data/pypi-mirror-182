...
class WormGearMeshCompoundAdvancedSystemDeflection(_7390.GearMeshCompoundAdvancedSystemDeflection):
    """WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7326.WormGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7326.WormGearMeshAdvancedSystemDeflection]':
