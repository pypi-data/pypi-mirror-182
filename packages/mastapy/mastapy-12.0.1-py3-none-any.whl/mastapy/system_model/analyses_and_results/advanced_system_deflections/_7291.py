...
class RingPinsToDiscConnectionAdvancedSystemDeflection(_7265.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RingPinsToDiscConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2742.RingPinsToDiscConnectionSystemDeflection]':
