...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_7198.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2684.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
