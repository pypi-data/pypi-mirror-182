...
class ShaftAdvancedSystemDeflection(_7196.AbstractShaftAdvancedSystemDeflection):
    """ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2751.ShaftSystemDeflection]':
