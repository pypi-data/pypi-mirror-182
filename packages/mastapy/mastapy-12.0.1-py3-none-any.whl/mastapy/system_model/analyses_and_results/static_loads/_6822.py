...
class GearSetLoadCase(_6879.SpecialisedAssemblyLoadCase):
    """GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5376.GearMeshStiffnessModel':
        ...
        return constructor.new_from_mastapy_type(_5376.GearMeshStiffnessModel)(value) if value is not None else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5376.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6938.AdvancedTimeSteppingAnalysisForModulationOptions':
    ...
    @property
    def assembly_design(self) -> '_2484.GearSet':
    ...
    @property
    def gears(self) -> 'List[_6817.GearLoadCase]':
    ...
    @property
    def gears_without_clones(self) -> 'List[_6817.GearLoadCase]':
    ...
    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6819.GearMeshLoadCase]':
