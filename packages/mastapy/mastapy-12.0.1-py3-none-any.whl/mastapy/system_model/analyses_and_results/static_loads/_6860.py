...
class PlanetaryGearSetLoadCase(_6792.CylindricalGearSetLoadCase):
    """PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1555.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1555.LoadCaseOverrideOption'):
