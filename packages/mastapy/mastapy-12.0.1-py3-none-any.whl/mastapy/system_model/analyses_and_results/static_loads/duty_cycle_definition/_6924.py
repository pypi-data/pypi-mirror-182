...
from mastapy.math_utility import _1456
...
class PointLoadInputOptions(_1810.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1456.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6915.AdditionalForcesObtainedFrom':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6915.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6915.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
