...
from mastapy.system_model.analyses_and_results.static_loads import _6811, _6812, _6822
...
class FaceGearSetLoadCase(_6822.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6811.FaceGearLoadCase]':
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6811.FaceGearLoadCase]':
    ...
    @property
    def face_meshes_load_case(self) -> 'List[_6812.FaceGearMeshLoadCase]':
