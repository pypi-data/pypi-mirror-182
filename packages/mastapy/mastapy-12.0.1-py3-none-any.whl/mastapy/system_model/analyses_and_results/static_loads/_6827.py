...
from mastapy.system_model.analyses_and_results.static_loads import _6837, _6825, _6806
...
class HarmonicLoadDataFluxImport(_6825.HarmonicLoadDataCSVImport['_6806.ElectricMachineHarmonicLoadFluxImportOptions']):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6837.InnerDiameterReference':
        ...
        return constructor.new_from_mastapy_type(_6837.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6837.InnerDiameterReference'):
