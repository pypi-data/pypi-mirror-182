...
from mastapy.system_model.analyses_and_results.static_loads import _6886, _6887, _6757
...
class StraightBevelDiffGearSetLoadCase(_6757.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6886.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6886.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6887.StraightBevelDiffGearMeshLoadCase]':
