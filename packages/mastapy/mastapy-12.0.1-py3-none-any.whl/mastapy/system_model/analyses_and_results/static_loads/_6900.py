...
class TorqueConverterLoadCase(_6780.CouplingLoadCase):
    """TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1498.Vector2DListAccessor':
    ...
    def lock_up_clutch_pressure_time_profile(self, value: '_1498.Vector2DListAccessor'):
