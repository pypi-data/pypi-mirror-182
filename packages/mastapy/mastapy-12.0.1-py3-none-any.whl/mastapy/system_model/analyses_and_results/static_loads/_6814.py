...
from mastapy.system_model.fe import _2312, _2335
...
class FEPartLoadCase(_6736.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2312.AngleSource':
        ...
        return constructor.new_from_mastapy_type(_2312.AngleSource)(value) if value is not None else None
