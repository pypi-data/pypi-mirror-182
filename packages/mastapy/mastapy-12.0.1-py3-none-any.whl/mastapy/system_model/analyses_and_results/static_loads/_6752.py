...
from mastapy.system_model.analyses_and_results.static_loads import _6750, _6751, _6757
...
class BevelDifferentialGearSetLoadCase(_6757.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6750.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6750.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6751.BevelDifferentialGearMeshLoadCase]':
