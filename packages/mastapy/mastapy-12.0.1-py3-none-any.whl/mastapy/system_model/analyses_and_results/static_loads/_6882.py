...
from mastapy.system_model.analyses_and_results.static_loads import _6880, _6881, _6757
...
class SpiralBevelGearSetLoadCase(_6757.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6880.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6880.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6881.SpiralBevelGearMeshLoadCase]':
