...
class RootAssemblyLoadCase(_6746.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1541.PIDControlSettings':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6792.CylindricalGearSetLoadCase]':
