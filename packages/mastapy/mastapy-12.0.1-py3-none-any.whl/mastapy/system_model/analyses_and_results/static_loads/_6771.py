...
from mastapy.system_model.analyses_and_results.static_loads import _6772, _6817
...
class ConicalGearLoadCase(_6817.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6772.ConicalGearManufactureError':
