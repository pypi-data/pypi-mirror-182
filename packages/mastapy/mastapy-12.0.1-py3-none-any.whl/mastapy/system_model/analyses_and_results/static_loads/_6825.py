...
from mastapy.system_model.analyses_and_results.static_loads import _6795, _6829, _6807
...
T = TypeVar('T', bound='_6807.ElectricMachineHarmonicLoadImportOptionsBase')


class HarmonicLoadDataCSVImport(_6829.HarmonicLoadDataImportFromMotorPackages['T'], Generic[T]):
    """HarmonicLoadDataCSVImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6795.DataFromMotorPackagePerSpeed]':
