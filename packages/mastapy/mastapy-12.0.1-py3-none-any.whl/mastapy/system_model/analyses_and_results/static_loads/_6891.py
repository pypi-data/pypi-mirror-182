...
from mastapy.system_model.analyses_and_results.static_loads import _6889, _6890, _6757
...
class StraightBevelGearSetLoadCase(_6757.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6889.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6889.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6890.StraightBevelGearMeshLoadCase]':
