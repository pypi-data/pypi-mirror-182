...
from mastapy.system_model.analyses_and_results.static_loads import _6798, _6807
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6798.ElectricMachineHarmonicLoadData, Generic[T]):
    """ElectricMachineHarmonicLoadDataFromMotorPackages
