...
from mastapy.system_model.analyses_and_results.static_loads import _6783, _6749
...
class CVTLoadCase(_6749.BeltDriveLoadCase):
    """CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6783.CVTPulleyLoadCase]':
