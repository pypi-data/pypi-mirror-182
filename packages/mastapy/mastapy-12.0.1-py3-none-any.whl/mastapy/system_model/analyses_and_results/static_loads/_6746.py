...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6747, _6749, _6752, _6758,
    _6759, _6782, _6760, _6762,
    _6767, _6770, _6784, _6786,
    _6792, _6814, _6813, _6815,
    _6819, _6834, _6844, _6847,
    _6848, _6849, _6853, _6858,
    _6862, _6865, _6866, _6870,
    _6871, _6872, _6876, _6877,
    _6736, _6882, _6885, _6888,
    _6891, _6895, _6900, _6907,
    _6911, _6914, _6734
)
...
class AssemblyLoadCase(_6734.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6747.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6749.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6752.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6758.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6759.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6782.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6760.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6762.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6767.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6770.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6784.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6786.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6792.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6814.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6813.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6815.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6819.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6834.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6844.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6847.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6848.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6849.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6853.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6858.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6862.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6865.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6870.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6871.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6872.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6876.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6877.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6736.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6882.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6885.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6888.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6891.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6895.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6900.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6907.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6911.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6914.ZerolBevelGearSetLoadCase]':
