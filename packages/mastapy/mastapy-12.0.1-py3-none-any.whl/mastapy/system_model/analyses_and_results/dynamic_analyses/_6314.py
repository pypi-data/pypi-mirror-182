...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6312, _6313, _6224
...
class StraightBevelDiffGearSetDynamicAnalysis(_6224.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6312.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6313.StraightBevelDiffGearMeshDynamicAnalysis]':
