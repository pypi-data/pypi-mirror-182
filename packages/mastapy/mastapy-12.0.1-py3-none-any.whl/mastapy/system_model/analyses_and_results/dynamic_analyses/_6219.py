...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6217, _6218, _6224
...
class BevelDifferentialGearSetDynamicAnalysis(_6224.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6217.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6218.BevelDifferentialGearMeshDynamicAnalysis]':
