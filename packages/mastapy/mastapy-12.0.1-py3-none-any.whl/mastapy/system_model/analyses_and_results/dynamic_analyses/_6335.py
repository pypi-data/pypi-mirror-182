...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6333, _6334, _6224
...
class ZerolBevelGearSetDynamicAnalysis(_6224.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6333.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6334.ZerolBevelGearMeshDynamicAnalysis]':
