...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6235, _6236, _6267
...
class ConceptGearSetDynamicAnalysis(_6267.GearSetDynamicAnalysis):
    """ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_6235.ConceptGearDynamicAnalysis]':
    ...
    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_6236.ConceptGearMeshDynamicAnalysis]':
