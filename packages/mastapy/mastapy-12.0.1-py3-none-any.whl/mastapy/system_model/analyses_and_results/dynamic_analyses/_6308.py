...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6306, _6307, _6224
...
class SpiralBevelGearSetDynamicAnalysis(_6224.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6306.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6307.SpiralBevelGearMeshDynamicAnalysis]':
