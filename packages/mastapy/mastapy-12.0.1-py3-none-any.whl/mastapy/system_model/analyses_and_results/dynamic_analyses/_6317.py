...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6315, _6316, _6224
...
class StraightBevelGearSetDynamicAnalysis(_6224.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_6315.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_6316.StraightBevelGearMeshDynamicAnalysis]':
