...
class BoltCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6225.BoltDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6225.BoltDynamicAnalysis]':
