...
class VirtualComponentCompoundDynamicAnalysis(_6413.MountableComponentCompoundDynamicAnalysis):
    """VirtualComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6329.VirtualComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6329.VirtualComponentDynamicAnalysis]':
