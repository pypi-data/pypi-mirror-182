...
class ComponentCompoundDynamicAnalysis(_6415.PartCompoundDynamicAnalysis):
    """ComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6231.ComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6231.ComponentDynamicAnalysis]':
