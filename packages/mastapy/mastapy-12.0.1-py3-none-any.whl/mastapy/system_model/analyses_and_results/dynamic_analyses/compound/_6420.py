...
class PlanetaryGearSetCompoundDynamicAnalysis(_6385.CylindricalGearSetCompoundDynamicAnalysis):
    """PlanetaryGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6291.PlanetaryGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6291.PlanetaryGearSetDynamicAnalysis]':
