...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6462, _6463, _6354
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_6354.BevelGearSetCompoundDynamicAnalysis):
    """ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6335.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6462.ZerolBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6463.ZerolBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6335.ZerolBevelGearSetDynamicAnalysis]':
