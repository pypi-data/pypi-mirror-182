...
class CVTPulleyCompoundDynamicAnalysis(_6424.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6248.CVTPulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6248.CVTPulleyDynamicAnalysis]':
