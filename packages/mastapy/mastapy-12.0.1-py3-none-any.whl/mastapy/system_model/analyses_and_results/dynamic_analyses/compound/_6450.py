...
class SynchroniserHalfCompoundDynamicAnalysis(_6451.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6321.SynchroniserHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6321.SynchroniserHalfDynamicAnalysis]':
