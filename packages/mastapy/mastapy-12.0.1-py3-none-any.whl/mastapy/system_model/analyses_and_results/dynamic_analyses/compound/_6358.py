...
class ClutchConnectionCompoundDynamicAnalysis(_6374.CouplingConnectionCompoundDynamicAnalysis):
    """ClutchConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6227.ClutchConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6227.ClutchConnectionDynamicAnalysis]':
