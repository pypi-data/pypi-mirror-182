...
class HypoidGearCompoundDynamicAnalysis(_6340.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6269.HypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6269.HypoidGearDynamicAnalysis]':
