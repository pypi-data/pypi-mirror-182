...
class StraightBevelSunGearCompoundDynamicAnalysis(_6441.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6319.StraightBevelSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6319.StraightBevelSunGearDynamicAnalysis]':
