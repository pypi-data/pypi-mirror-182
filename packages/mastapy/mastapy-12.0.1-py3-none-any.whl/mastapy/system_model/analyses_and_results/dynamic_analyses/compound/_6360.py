...
class CoaxialConnectionCompoundDynamicAnalysis(_6433.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CoaxialConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6230.CoaxialConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6230.CoaxialConnectionDynamicAnalysis]':
