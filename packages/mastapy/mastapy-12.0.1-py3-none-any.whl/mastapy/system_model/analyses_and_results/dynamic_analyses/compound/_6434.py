...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6336
...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6336.AbstractAssemblyCompoundDynamicAnalysis):
    """SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6305.SpecialisedAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6305.SpecialisedAssemblyDynamicAnalysis]':
