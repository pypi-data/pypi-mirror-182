...
class MeasurementComponentCompoundDynamicAnalysis(_6458.VirtualComponentCompoundDynamicAnalysis):
    """MeasurementComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6283.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6283.MeasurementComponentDynamicAnalysis]':
