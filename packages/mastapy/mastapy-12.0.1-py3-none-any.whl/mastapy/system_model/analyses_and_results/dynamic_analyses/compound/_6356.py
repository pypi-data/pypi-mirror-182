...
class BoltedJointCompoundDynamicAnalysis(_6434.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BoltedJointCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6226.BoltedJointDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6226.BoltedJointDynamicAnalysis]':
