...
class WormGearCompoundDynamicAnalysis(_6394.GearCompoundDynamicAnalysis):
    """WormGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6330.WormGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6330.WormGearDynamicAnalysis]':
