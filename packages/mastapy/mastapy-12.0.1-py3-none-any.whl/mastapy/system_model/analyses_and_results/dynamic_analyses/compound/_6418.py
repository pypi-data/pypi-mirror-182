...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6289.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6289.PartToPartShearCouplingHalfDynamicAnalysis]':
