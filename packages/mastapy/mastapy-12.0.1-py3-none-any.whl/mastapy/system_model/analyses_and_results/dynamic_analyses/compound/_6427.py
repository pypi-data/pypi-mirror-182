...
class RollingRingAssemblyCompoundDynamicAnalysis(_6434.SpecialisedAssemblyCompoundDynamicAnalysis):
    """RollingRingAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6298.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6298.RollingRingAssemblyDynamicAnalysis]':
