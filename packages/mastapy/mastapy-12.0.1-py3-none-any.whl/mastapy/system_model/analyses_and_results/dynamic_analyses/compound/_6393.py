...
class FlexiblePinAssemblyCompoundDynamicAnalysis(_6434.SpecialisedAssemblyCompoundDynamicAnalysis):
    """FlexiblePinAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6264.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6264.FlexiblePinAssemblyDynamicAnalysis]':
