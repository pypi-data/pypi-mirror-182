...
class PlanetaryConnectionCompoundDynamicAnalysis(_6433.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6290.PlanetaryConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6290.PlanetaryConnectionDynamicAnalysis]':
