...
class MountableComponentCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """MountableComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6284.MountableComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6284.MountableComponentDynamicAnalysis]':
