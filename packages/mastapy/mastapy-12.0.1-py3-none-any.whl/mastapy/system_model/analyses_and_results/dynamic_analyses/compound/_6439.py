...
class SpringDamperConnectionCompoundDynamicAnalysis(_6374.CouplingConnectionCompoundDynamicAnalysis):
    """SpringDamperConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6309.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6309.SpringDamperConnectionDynamicAnalysis]':
