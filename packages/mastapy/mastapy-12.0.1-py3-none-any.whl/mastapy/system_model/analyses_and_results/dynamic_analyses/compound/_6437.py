...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6435, _6436, _6354
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_6354.BevelGearSetCompoundDynamicAnalysis):
    """SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6308.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6435.SpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6436.SpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6308.SpiralBevelGearSetDynamicAnalysis]':
