...
class PowerLoadCompoundDynamicAnalysis(_6458.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6294.PowerLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6294.PowerLoadDynamicAnalysis]':
