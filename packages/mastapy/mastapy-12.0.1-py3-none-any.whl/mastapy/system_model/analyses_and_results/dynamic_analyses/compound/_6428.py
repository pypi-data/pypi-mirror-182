...
class RollingRingCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """RollingRingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6300.RollingRingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6300.RollingRingDynamicAnalysis]':
