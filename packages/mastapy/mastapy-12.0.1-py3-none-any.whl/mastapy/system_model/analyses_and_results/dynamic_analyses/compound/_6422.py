...
class PointLoadCompoundDynamicAnalysis(_6458.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6293.PointLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6293.PointLoadDynamicAnalysis]':
