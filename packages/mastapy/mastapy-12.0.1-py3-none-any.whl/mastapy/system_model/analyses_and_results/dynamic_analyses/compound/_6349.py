...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6347, _6348, _6354
...
class BevelDifferentialGearSetCompoundDynamicAnalysis(_6354.BevelGearSetCompoundDynamicAnalysis):
    """BevelDifferentialGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6219.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_dynamic_analysis(self) -> 'List[_6347.BevelDifferentialGearCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_dynamic_analysis(self) -> 'List[_6348.BevelDifferentialGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6219.BevelDifferentialGearSetDynamicAnalysis]':
