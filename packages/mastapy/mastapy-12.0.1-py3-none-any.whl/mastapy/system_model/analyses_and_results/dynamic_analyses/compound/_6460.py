...
class WormGearMeshCompoundDynamicAnalysis(_6395.GearMeshCompoundDynamicAnalysis):
    """WormGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6331.WormGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6331.WormGearMeshDynamicAnalysis]':
