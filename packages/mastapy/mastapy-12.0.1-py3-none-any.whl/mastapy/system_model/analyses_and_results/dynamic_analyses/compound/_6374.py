...
class CouplingConnectionCompoundDynamicAnalysis(_6401.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """CouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6243.CouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6243.CouplingConnectionDynamicAnalysis]':
