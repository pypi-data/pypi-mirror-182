...
class ConnectorCompoundDynamicAnalysis(_6413.MountableComponentCompoundDynamicAnalysis):
    """ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6242.ConnectorDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6242.ConnectorDynamicAnalysis]':
