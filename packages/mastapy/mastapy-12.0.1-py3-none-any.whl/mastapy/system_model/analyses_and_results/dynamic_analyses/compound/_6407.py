...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6405, _6406, _6404
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis(_6404.KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6278.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6405.KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6406.KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6278.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
