...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6389, _6390, _6396
...
class FaceGearSetCompoundDynamicAnalysis(_6396.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6262.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6389.FaceGearCompoundDynamicAnalysis]':
    ...
    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6390.FaceGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6262.FaceGearSetDynamicAnalysis]':
