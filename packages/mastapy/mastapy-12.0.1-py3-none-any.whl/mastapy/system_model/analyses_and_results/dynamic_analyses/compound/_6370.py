...
class ConicalGearSetCompoundDynamicAnalysis(_6396.GearSetCompoundDynamicAnalysis):
    """ConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6240.ConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6240.ConicalGearSetDynamicAnalysis]':
