...
class ZerolBevelGearCompoundDynamicAnalysis(_6352.BevelGearCompoundDynamicAnalysis):
    """ZerolBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6333.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6333.ZerolBevelGearDynamicAnalysis]':
