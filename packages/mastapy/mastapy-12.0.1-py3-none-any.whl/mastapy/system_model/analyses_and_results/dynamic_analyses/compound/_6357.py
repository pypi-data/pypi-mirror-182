...
class ClutchCompoundDynamicAnalysis(_6373.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6228.ClutchDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6228.ClutchDynamicAnalysis]':
