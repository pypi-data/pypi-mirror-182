...
class GuideDxfModelCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6268.GuideDxfModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6268.GuideDxfModelDynamicAnalysis]':
