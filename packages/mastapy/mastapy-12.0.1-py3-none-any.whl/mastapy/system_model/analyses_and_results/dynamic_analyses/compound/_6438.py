...
class SpringDamperCompoundDynamicAnalysis(_6373.CouplingCompoundDynamicAnalysis):
    """SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6310.SpringDamperDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6310.SpringDamperDynamicAnalysis]':
