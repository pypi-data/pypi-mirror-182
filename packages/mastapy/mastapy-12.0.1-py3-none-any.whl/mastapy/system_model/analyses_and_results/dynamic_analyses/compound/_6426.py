...
class RingPinsToDiscConnectionCompoundDynamicAnalysis(_6401.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RingPinsToDiscConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6297.RingPinsToDiscConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6297.RingPinsToDiscConnectionDynamicAnalysis]':
