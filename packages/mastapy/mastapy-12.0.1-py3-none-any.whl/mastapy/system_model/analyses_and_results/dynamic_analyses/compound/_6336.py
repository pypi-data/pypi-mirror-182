...
class AbstractAssemblyCompoundDynamicAnalysis(_6415.PartCompoundDynamicAnalysis):
    """AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6206.AbstractAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6206.AbstractAssemblyDynamicAnalysis]':
