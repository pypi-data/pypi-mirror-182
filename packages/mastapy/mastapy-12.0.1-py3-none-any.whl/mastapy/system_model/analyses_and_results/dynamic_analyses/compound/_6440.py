...
class SpringDamperHalfCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """SpringDamperHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6311.SpringDamperHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6311.SpringDamperHalfDynamicAnalysis]':
