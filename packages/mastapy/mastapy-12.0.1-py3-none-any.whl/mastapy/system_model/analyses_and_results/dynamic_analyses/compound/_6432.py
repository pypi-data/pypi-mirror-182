...
class ShaftHubConnectionCompoundDynamicAnalysis(_6372.ConnectorCompoundDynamicAnalysis):
    """ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6303.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6303.ShaftHubConnectionDynamicAnalysis]':
