...
class KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis(_6402.KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6276.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6276.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
