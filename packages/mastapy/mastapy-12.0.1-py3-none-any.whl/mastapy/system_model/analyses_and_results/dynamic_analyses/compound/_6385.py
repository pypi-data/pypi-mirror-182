...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6383, _6384, _6396
...
class CylindricalGearSetCompoundDynamicAnalysis(_6396.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6255.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_dynamic_analysis(self) -> 'List[_6383.CylindricalGearCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_dynamic_analysis(self) -> 'List[_6384.CylindricalGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6255.CylindricalGearSetDynamicAnalysis]':
