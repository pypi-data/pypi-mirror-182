...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6373.CouplingCompoundDynamicAnalysis):
    """PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6288.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6288.PartToPartShearCouplingDynamicAnalysis]':
