...
class AGMAGleasonConicalGearMeshCompoundDynamicAnalysis(_6369.ConicalGearMeshCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6211.AGMAGleasonConicalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6211.AGMAGleasonConicalGearMeshDynamicAnalysis]':
