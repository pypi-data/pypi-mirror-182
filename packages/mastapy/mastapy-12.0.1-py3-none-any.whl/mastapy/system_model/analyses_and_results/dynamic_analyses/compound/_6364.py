...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6234.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6234.ConceptCouplingHalfDynamicAnalysis]':
