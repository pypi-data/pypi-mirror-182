...
class MassDiscCompoundDynamicAnalysis(_6458.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6282.MassDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6282.MassDiscDynamicAnalysis]':
