...
class BevelDifferentialPlanetGearCompoundDynamicAnalysis(_6347.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6220.BevelDifferentialPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6220.BevelDifferentialPlanetGearDynamicAnalysis]':
