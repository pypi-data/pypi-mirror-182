...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6459, _6460, _6396
...
class WormGearSetCompoundDynamicAnalysis(_6396.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6332.WormGearSetDynamicAnalysis]':
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_6459.WormGearCompoundDynamicAnalysis]':
    ...
    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_6460.WormGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6332.WormGearSetDynamicAnalysis]':
