...
class KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis(_6370.ConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6275.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6275.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
