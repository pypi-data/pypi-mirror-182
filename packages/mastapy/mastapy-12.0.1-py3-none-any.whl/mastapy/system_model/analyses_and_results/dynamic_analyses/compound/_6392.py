...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6338
...
class FEPartCompoundDynamicAnalysis(_6338.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6263.FEPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6263.FEPartDynamicAnalysis]':
