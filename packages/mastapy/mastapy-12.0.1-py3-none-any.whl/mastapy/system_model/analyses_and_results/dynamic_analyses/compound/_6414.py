...
class OilSealCompoundDynamicAnalysis(_6372.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6285.OilSealDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6285.OilSealDynamicAnalysis]':
