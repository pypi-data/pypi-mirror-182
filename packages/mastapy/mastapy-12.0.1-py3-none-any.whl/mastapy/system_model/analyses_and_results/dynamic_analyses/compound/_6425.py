...
class RingPinsCompoundDynamicAnalysis(_6413.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6296.RingPinsDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6296.RingPinsDynamicAnalysis]':
