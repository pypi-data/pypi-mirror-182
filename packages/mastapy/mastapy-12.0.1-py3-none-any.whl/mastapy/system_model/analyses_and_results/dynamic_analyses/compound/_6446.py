...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6444, _6445, _6354
...
class StraightBevelGearSetCompoundDynamicAnalysis(_6354.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6317.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6444.StraightBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6445.StraightBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6317.StraightBevelGearSetDynamicAnalysis]':
