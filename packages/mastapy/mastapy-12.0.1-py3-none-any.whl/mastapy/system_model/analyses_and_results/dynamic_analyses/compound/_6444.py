...
class StraightBevelGearCompoundDynamicAnalysis(_6352.BevelGearCompoundDynamicAnalysis):
    """StraightBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6315.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6315.StraightBevelGearDynamicAnalysis]':
