...
class RootAssemblyCompoundDynamicAnalysis(_6343.AssemblyCompoundDynamicAnalysis):
    """RootAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6301.RootAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6301.RootAssemblyDynamicAnalysis]':
