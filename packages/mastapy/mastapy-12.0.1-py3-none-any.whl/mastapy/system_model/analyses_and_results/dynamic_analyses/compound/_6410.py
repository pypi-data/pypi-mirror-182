...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6408, _6409, _6404
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis(_6404.KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6281.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6408.KlingelnbergCycloPalloidSpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6409.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6281.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
