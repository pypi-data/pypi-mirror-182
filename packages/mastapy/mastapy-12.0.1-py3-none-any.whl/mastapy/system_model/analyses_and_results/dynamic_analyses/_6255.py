...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6253, _6254, _6267
...
class CylindricalGearSetDynamicAnalysis(_6267.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6253.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6254.CylindricalGearMeshDynamicAnalysis]':
