...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6276, _6277, _6275
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_6275.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_6276.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_6277.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
