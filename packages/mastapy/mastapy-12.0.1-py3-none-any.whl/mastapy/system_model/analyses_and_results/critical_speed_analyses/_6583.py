...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6581, _6582, _6489
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6489.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6581.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6582.StraightBevelGearMeshCriticalSpeedAnalysis]':
