...
class StraightBevelGearMeshCompoundCriticalSpeedAnalysis(_6619.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6582.StraightBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6582.StraightBevelGearMeshCriticalSpeedAnalysis]':
