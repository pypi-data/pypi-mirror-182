...
class WormGearCompoundCriticalSpeedAnalysis(_6660.GearCompoundCriticalSpeedAnalysis):
    """WormGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6596.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6596.WormGearCriticalSpeedAnalysis]':
