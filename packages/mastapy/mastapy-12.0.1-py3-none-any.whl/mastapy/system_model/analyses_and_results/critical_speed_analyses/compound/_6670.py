...
class KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis(_6636.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6541.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6541.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
