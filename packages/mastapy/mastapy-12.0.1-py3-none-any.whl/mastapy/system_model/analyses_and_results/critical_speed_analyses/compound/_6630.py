...
class ConceptCouplingHalfCompoundCriticalSpeedAnalysis(_6641.CouplingHalfCompoundCriticalSpeedAnalysis):
    """ConceptCouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6499.ConceptCouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6499.ConceptCouplingHalfCriticalSpeedAnalysis]':
