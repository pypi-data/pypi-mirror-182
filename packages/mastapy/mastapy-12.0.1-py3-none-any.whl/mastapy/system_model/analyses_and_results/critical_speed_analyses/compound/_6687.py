...
class PlanetCarrierCompoundCriticalSpeedAnalysis(_6679.MountableComponentCompoundCriticalSpeedAnalysis):
    """PlanetCarrierCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6558.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6558.PlanetCarrierCriticalSpeedAnalysis]':
