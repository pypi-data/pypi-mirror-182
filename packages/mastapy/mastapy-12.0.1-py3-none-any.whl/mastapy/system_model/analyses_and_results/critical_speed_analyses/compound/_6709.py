...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6707, _6708, _6620
...
class StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis(_6620.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6580.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_critical_speed_analysis(self) -> 'List[_6707.StraightBevelDiffGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_critical_speed_analysis(self) -> 'List[_6708.StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6580.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
