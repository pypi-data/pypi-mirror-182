...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6626.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6517.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6517.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
