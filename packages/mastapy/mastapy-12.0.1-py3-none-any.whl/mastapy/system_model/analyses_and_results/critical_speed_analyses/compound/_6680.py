...
class OilSealCompoundCriticalSpeedAnalysis(_6638.ConnectorCompoundCriticalSpeedAnalysis):
    """OilSealCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6551.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6551.OilSealCriticalSpeedAnalysis]':
