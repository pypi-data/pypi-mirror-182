...
class AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis(_6634.ConicalGearCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6475.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6475.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
