...
class ConceptCouplingConnectionCompoundCriticalSpeedAnalysis(_6640.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ConceptCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6497.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6497.ConceptCouplingConnectionCriticalSpeedAnalysis]':
