...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6637
...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6637.ConnectionCompoundCriticalSpeedAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6474.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6474.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
