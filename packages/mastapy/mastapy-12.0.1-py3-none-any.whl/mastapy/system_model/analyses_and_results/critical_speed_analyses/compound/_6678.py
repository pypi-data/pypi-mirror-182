...
class MeasurementComponentCompoundCriticalSpeedAnalysis(_6724.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MeasurementComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6549.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6549.MeasurementComponentCriticalSpeedAnalysis]':
