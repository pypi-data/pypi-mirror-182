...
class RollingRingAssemblyCompoundCriticalSpeedAnalysis(_6700.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """RollingRingAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6564.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6564.RollingRingAssemblyCriticalSpeedAnalysis]':
