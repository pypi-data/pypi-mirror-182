...
class ConnectionCompoundCriticalSpeedAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6506.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6506.ConnectionCriticalSpeedAnalysis]':
