...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6603
...
class ShaftCompoundCriticalSpeedAnalysis(_6603.AbstractShaftCompoundCriticalSpeedAnalysis):
    """ShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6568.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6568.ShaftCriticalSpeedAnalysis]':
