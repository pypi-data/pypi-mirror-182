...
class SpringDamperCompoundCriticalSpeedAnalysis(_6639.CouplingCompoundCriticalSpeedAnalysis):
    """SpringDamperCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6576.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6576.SpringDamperCriticalSpeedAnalysis]':
