...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6637.ConnectionCompoundCriticalSpeedAnalysis):
    """InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6538.InterMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6538.InterMountableComponentConnectionCriticalSpeedAnalysis]':
