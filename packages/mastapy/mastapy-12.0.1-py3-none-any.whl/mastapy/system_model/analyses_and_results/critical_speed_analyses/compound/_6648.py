...
class CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(_6605.AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6519.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6519.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
