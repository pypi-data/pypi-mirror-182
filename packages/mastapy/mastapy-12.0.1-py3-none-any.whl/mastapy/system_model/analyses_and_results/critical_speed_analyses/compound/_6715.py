...
class SynchroniserCompoundCriticalSpeedAnalysis(_6700.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """SynchroniserCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6586.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6586.SynchroniserCriticalSpeedAnalysis]':
