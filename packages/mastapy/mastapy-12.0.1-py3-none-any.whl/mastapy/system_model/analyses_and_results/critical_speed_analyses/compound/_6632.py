...
class ConceptGearMeshCompoundCriticalSpeedAnalysis(_6661.GearMeshCompoundCriticalSpeedAnalysis):
    """ConceptGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6501.ConceptGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6501.ConceptGearMeshCriticalSpeedAnalysis]':
