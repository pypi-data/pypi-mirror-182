...
class CylindricalGearMeshCompoundCriticalSpeedAnalysis(_6661.GearMeshCompoundCriticalSpeedAnalysis):
    """CylindricalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6521.CylindricalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6521.CylindricalGearMeshCriticalSpeedAnalysis]':
