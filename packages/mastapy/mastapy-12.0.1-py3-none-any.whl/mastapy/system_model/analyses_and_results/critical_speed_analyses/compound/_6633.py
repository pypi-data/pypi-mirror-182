...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6631, _6632, _6662
...
class ConceptGearSetCompoundCriticalSpeedAnalysis(_6662.GearSetCompoundCriticalSpeedAnalysis):
    """ConceptGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6502.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gears_compound_critical_speed_analysis(self) -> 'List[_6631.ConceptGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_compound_critical_speed_analysis(self) -> 'List[_6632.ConceptGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6502.ConceptGearSetCriticalSpeedAnalysis]':
