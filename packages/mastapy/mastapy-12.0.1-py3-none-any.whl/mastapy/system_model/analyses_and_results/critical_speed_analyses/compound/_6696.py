...
class RootAssemblyCompoundCriticalSpeedAnalysis(_6609.AssemblyCompoundCriticalSpeedAnalysis):
    """RootAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6567.RootAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6567.RootAssemblyCriticalSpeedAnalysis]':
