...
class SynchroniserSleeveCompoundCriticalSpeedAnalysis(_6717.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserSleeveCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6589.SynchroniserSleeveCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6589.SynchroniserSleeveCriticalSpeedAnalysis]':
