...
class CycloidalAssemblyCompoundCriticalSpeedAnalysis(_6700.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """CycloidalAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6516.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6516.CycloidalAssemblyCriticalSpeedAnalysis]':
