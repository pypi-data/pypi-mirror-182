...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6717.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6587.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6587.SynchroniserHalfCriticalSpeedAnalysis]':
