...
class WormGearMeshCompoundCriticalSpeedAnalysis(_6661.GearMeshCompoundCriticalSpeedAnalysis):
    """WormGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6597.WormGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6597.WormGearMeshCriticalSpeedAnalysis]':
