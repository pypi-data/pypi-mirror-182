...
class ConnectorCompoundCriticalSpeedAnalysis(_6679.MountableComponentCompoundCriticalSpeedAnalysis):
    """ConnectorCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6507.ConnectorCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6507.ConnectorCriticalSpeedAnalysis]':
