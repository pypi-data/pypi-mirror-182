...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6603.AbstractShaftCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6518.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6518.CycloidalDiscCriticalSpeedAnalysis]':
