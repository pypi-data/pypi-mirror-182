...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6707.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6584.StraightBevelPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6584.StraightBevelPlanetGearCriticalSpeedAnalysis]':
