...
class CylindricalPlanetGearCompoundCriticalSpeedAnalysis(_6649.CylindricalGearCompoundCriticalSpeedAnalysis):
    """CylindricalPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6523.CylindricalPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6523.CylindricalPlanetGearCriticalSpeedAnalysis]':
