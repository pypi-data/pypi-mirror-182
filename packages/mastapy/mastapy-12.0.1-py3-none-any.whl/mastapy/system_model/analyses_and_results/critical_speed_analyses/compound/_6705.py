...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(_6640.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """SpringDamperConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6575.SpringDamperConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6575.SpringDamperConnectionCriticalSpeedAnalysis]':
