...
class KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis(_6668.KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6542.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6542.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
