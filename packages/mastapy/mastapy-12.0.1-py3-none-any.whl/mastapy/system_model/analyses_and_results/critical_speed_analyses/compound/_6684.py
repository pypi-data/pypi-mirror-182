...
class PartToPartShearCouplingHalfCompoundCriticalSpeedAnalysis(_6641.CouplingHalfCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6555.PartToPartShearCouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6555.PartToPartShearCouplingHalfCriticalSpeedAnalysis]':
