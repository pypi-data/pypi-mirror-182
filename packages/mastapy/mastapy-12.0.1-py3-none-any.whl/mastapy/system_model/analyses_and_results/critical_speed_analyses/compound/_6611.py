...
class BeltConnectionCompoundCriticalSpeedAnalysis(_6667.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """BeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6480.BeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6480.BeltConnectionCriticalSpeedAnalysis]':
