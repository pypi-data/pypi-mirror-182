...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6679.MountableComponentCompoundCriticalSpeedAnalysis):
    """CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6510.CouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6510.CouplingHalfCriticalSpeedAnalysis]':
