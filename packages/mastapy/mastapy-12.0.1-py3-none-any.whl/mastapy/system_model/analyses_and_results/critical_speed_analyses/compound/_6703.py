...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6701, _6702, _6620
...
class SpiralBevelGearSetCompoundCriticalSpeedAnalysis(_6620.BevelGearSetCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6574.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6701.SpiralBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6702.SpiralBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6574.SpiralBevelGearSetCriticalSpeedAnalysis]':
