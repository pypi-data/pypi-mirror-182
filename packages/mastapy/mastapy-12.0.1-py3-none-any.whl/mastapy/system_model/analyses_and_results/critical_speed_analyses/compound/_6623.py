...
class ClutchCompoundCriticalSpeedAnalysis(_6639.CouplingCompoundCriticalSpeedAnalysis):
    """ClutchCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6493.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6493.ClutchCriticalSpeedAnalysis]':
