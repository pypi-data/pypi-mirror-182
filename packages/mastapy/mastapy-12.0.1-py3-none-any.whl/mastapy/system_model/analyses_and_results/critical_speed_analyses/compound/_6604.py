...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6627.ComponentCompoundCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6473.AbstractShaftOrHousingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6473.AbstractShaftOrHousingCriticalSpeedAnalysis]':
