...
class PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis(_6640.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6553.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6553.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
