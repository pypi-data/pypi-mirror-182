...
class StraightBevelGearCompoundCriticalSpeedAnalysis(_6618.BevelGearCompoundCriticalSpeedAnalysis):
    """StraightBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6581.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6581.StraightBevelGearCriticalSpeedAnalysis]':
