...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6649, _6650, _6662
...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(_6662.GearSetCompoundCriticalSpeedAnalysis):
    """CylindricalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6522.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_critical_speed_analysis(self) -> 'List[_6649.CylindricalGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_critical_speed_analysis(self) -> 'List[_6650.CylindricalGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6522.CylindricalGearSetCriticalSpeedAnalysis]':
