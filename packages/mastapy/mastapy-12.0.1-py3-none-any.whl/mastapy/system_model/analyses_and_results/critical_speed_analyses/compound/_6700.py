...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6602
...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6602.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6571.SpecialisedAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6571.SpecialisedAssemblyCriticalSpeedAnalysis]':
