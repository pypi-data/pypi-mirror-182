...
class ClutchConnectionCompoundCriticalSpeedAnalysis(_6640.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ClutchConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6492.ClutchConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6492.ClutchConnectionCriticalSpeedAnalysis]':
