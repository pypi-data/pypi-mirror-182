...
class PlanetaryConnectionCompoundCriticalSpeedAnalysis(_6699.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """PlanetaryConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6556.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6556.PlanetaryConnectionCriticalSpeedAnalysis]':
