...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6578, _6579, _6489
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6489.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6578.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6579.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
