...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6599, _6600, _6489
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6489.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6599.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6600.ZerolBevelGearMeshCriticalSpeedAnalysis]':
