...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6526, _6527, _6533
...
class FaceGearSetCriticalSpeedAnalysis(_6533.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6526.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6527.FaceGearMeshCriticalSpeedAnalysis]':
