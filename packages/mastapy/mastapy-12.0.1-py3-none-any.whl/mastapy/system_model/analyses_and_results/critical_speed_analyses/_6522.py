...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6520, _6521, _6533
...
class CylindricalGearSetCriticalSpeedAnalysis(_6533.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6520.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6521.CylindricalGearMeshCriticalSpeedAnalysis]':
