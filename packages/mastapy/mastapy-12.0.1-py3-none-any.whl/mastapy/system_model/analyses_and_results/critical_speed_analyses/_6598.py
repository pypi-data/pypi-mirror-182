...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6596, _6597, _6533
...
class WormGearSetCriticalSpeedAnalysis(_6533.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6596.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6597.WormGearMeshCriticalSpeedAnalysis]':
