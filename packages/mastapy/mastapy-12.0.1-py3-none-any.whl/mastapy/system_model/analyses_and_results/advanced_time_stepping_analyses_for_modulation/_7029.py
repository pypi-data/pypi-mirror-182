...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_7035.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6872.RollingRingAssemblyLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2744.RollingRingAssemblySystemDeflection':
