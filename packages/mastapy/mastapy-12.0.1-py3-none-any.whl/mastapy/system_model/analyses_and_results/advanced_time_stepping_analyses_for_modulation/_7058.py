...
class UnbalancedMassAdvancedTimeSteppingAnalysisForModulation(_7059.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6907.UnbalancedMassLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2781.UnbalancedMassSystemDeflection':
