...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_7004.KlingelnbergCycloPalloidConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """KlingelnbergCycloPalloidHypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6843.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2718.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
