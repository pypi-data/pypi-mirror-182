...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6972.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6853.OilSealLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2731.OilSealSystemDeflection':
