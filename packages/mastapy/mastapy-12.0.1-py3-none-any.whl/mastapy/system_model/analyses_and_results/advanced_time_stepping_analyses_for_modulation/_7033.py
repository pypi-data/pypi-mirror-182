...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6972.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2748.ShaftHubConnectionSystemDeflection':
