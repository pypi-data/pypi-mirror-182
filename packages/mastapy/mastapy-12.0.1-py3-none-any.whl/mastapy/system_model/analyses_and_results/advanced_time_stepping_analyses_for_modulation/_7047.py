...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7045, _7046, _6954
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6954.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2764.StraightBevelGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7045.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7046.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
