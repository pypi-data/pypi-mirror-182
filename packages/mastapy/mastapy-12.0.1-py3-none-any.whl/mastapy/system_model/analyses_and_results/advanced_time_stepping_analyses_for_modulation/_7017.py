...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2735.PartToPartShearCouplingSystemDeflection':
