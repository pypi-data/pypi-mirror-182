...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
    _6944, _6946, _6949, _6956,
    _6955, _6976, _6957, _6962,
    _6967, _6979, _6980, _6985,
    _6992, _6991, _6993, _7001,
    _7008, _7011, _7012, _7013,
    _7015, _7017, _7022, _7023,
    _7024, _7026, _7029, _7033,
    _7032, _7038, _7039, _7044,
    _7047, _7050, _7054, _7058,
    _7062, _7065, _6932
)
...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(_6932.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """AssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bearings(self) -> 'List[_6944.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def belt_drives(self) -> 'List[_6946.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6949.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6956.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolts(self) -> 'List[_6955.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cv_ts(self) -> 'List[_6976.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def clutches(self) -> 'List[_6957.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6962.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6967.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6979.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6980.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6985.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def fe_parts(self) -> 'List[_6992.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6991.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6993.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7001.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7008.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7011.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def mass_discs(self) -> 'List[_7012.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def measurement_components(self) -> 'List[_7013.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def oil_seals(self) -> 'List[_7015.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7017.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7022.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def point_loads(self) -> 'List[_7023.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def power_loads(self) -> 'List[_7024.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def ring_pins(self) -> 'List[_7026.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7029.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7033.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shafts(self) -> 'List[_7032.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7038.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7039.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7044.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7047.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def synchronisers(self) -> 'List[_7050.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def torque_converters(self) -> 'List[_7054.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7058.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7062.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7065.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
