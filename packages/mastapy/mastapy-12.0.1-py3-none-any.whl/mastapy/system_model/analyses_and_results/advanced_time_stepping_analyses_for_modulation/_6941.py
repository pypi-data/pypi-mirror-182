...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6970.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2642.AGMAGleasonConicalGearSetSystemDeflection':
