...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6947.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2652.BevelDifferentialSunGearSystemDeflection':
