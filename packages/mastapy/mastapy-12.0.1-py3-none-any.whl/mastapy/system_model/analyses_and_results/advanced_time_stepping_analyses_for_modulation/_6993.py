...
class FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation(_7035.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2705.FlexiblePinAssemblySystemDeflection':
