...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6945.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2679.CVTBeltConnectionSystemDeflection':
