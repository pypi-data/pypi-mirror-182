...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6983.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    """CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2479.CylindricalPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2697.CylindricalPlanetGearSystemDeflection':
