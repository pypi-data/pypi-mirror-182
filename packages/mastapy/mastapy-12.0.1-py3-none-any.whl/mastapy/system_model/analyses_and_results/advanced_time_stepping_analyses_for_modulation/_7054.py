...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2777.TorqueConverterSystemDeflection':
