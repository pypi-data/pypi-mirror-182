...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6902.TorqueConverterTurbineLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2778.TorqueConverterTurbineSystemDeflection':
