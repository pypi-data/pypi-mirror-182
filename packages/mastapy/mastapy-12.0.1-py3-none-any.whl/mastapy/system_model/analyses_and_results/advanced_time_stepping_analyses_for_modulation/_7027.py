...
class RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation(_7002.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2742.RingPinsToDiscConnectionSystemDeflection':
