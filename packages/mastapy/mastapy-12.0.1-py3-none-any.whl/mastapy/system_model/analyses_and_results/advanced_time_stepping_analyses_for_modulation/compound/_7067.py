...
class AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_7068.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6933.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6933.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
