...
from mastapy.system_model.connections_and_sockets.couplings import _2297
...
class ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2297.ConceptCouplingConnection':
    ...
    @property
    def connection_design(self) -> '_2297.ConceptCouplingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6963.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6963.ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
