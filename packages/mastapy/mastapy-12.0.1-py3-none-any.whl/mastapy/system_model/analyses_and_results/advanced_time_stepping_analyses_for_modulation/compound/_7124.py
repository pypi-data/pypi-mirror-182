...
class GearCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6994.GearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6994.GearAdvancedTimeSteppingAnalysisForModulation]':
