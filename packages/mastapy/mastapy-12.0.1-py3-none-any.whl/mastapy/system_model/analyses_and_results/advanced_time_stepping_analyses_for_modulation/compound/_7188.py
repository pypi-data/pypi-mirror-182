...
class VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7059.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7059.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
