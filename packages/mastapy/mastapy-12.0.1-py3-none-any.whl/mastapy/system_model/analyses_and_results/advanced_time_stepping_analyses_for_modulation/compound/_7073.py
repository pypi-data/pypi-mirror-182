...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import (
    _7074, _7076, _7079, _7086,
    _7085, _7107, _7087, _7092,
    _7097, _7109, _7111, _7115,
    _7122, _7121, _7123, _7130,
    _7137, _7140, _7141, _7142,
    _7144, _7146, _7151, _7152,
    _7153, _7155, _7157, _7162,
    _7161, _7167, _7168, _7173,
    _7176, _7179, _7183, _7187,
    _7191, _7194, _7066
)
...
class AssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7066.AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6942.AssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bearings(self) -> 'List[_7074.BearingCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def belt_drives(self) -> 'List[_7076.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7079.BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7086.BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolts(self) -> 'List[_7085.BoltCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cv_ts(self) -> 'List[_7107.CVTCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def clutches(self) -> 'List[_7087.ClutchCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7092.ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7097.ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7109.CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7111.CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7115.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def fe_parts(self) -> 'List[_7122.FEPartCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7121.FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7123.FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7130.HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7137.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7140.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def mass_discs(self) -> 'List[_7141.MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def measurement_components(self) -> 'List[_7142.MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def oil_seals(self) -> 'List[_7144.OilSealCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7146.PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7151.PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def point_loads(self) -> 'List[_7152.PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def power_loads(self) -> 'List[_7153.PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def ring_pins(self) -> 'List[_7155.RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7157.RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7162.ShaftHubConnectionCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shafts(self) -> 'List[_7161.ShaftCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7167.SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7168.SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7173.StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7176.StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def synchronisers(self) -> 'List[_7179.SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def torque_converters(self) -> 'List[_7183.TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7187.UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7191.WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7194.ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6942.AssemblyAdvancedTimeSteppingAnalysisForModulation]':
