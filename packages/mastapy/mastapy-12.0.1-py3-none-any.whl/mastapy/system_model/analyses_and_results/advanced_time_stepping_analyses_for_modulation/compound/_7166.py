...
class SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2276.SpiralBevelGearMesh':
    ...
    @property
    def connection_design(self) -> '_2276.SpiralBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7037.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7037.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
