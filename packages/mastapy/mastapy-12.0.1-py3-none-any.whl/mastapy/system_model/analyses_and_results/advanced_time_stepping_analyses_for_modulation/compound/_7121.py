...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7119, _7120, _7126
...
class FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7126.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2481.FaceGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6991.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7119.FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7120.FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6991.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
