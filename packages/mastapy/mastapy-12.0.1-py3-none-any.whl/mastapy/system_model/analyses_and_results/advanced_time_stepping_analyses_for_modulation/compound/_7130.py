...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7128, _7129, _7072
...
class HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7072.AGMAGleasonConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2487.HypoidGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7001.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7128.HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7129.HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7001.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
