...
class RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2549.RollingRingAssembly':
    ...
    @property
    def assembly_design(self) -> '_2549.RollingRingAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7029.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7029.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
