...
class TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2562.TorqueConverterTurbine':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7057.TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7057.TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation]':
