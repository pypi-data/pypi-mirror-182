...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7068
...
class FEPartCompoundAdvancedTimeSteppingAnalysisForModulation(_7068.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FEPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6992.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6992.FEPartAdvancedTimeSteppingAnalysisForModulation]':
