...
class PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7188.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7024.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7024.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
