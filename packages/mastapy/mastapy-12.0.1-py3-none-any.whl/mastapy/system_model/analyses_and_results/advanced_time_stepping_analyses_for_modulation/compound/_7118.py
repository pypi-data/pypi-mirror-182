...
class ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6988.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6988.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
