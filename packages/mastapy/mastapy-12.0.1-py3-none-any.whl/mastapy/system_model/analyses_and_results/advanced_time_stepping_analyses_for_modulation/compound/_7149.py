...
class PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2240.PlanetaryConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7020.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7020.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
