...
class CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2520.CycloidalAssembly':
    ...
    @property
    def assembly_design(self) -> '_2520.CycloidalAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6979.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6979.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
