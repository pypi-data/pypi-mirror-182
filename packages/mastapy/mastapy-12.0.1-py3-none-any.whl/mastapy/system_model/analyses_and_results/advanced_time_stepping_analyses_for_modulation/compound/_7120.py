...
class FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7125.GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2264.FaceGearMesh':
    ...
    @property
    def connection_design(self) -> '_2264.FaceGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6990.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6990.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
