...
class MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7188.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2415.MassDisc':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7012.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7012.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
