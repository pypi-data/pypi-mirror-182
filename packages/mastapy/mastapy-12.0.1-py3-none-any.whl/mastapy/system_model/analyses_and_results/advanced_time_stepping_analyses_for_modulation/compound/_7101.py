...
from mastapy.system_model.analyses_and_results.analysis_cases import _7464
...
class ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6971.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6971.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
