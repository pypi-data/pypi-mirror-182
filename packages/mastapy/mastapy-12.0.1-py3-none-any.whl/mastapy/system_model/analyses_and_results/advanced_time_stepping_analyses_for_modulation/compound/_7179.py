...
class SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2554.Synchroniser':
    ...
    @property
    def assembly_design(self) -> '_2554.Synchroniser':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7050.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7050.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
