...
class SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7052.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7052.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
