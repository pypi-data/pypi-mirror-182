...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7192, _7193, _7084
...
class ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7084.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2506.ZerolBevelGearSet':
    ...
    @property
    def assembly_design(self) -> '_2506.ZerolBevelGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7065.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7192.ZerolBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7193.ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7065.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
