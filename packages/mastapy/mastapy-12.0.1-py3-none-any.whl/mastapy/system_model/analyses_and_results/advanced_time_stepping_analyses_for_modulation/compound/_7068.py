...
class AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6934.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6934.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
