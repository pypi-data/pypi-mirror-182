...
class BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2254.BevelDifferentialGearMesh':
    ...
    @property
    def connection_design(self) -> '_2254.BevelDifferentialGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6948.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6948.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
