...
class PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7019.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7019.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
