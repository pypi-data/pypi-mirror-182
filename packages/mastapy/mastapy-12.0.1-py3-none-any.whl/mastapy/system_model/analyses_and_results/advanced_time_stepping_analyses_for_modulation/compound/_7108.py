...
class CVTPulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_7154.PulleyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTPulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6978.CVTPulleyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6978.CVTPulleyAdvancedTimeSteppingAnalysisForModulation]':
