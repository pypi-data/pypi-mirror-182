...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7039.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7039.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
