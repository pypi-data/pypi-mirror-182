...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7471.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7016.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7016.PartAdvancedTimeSteppingAnalysisForModulation]':
