...
class GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7131.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6995.GearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6995.GearMeshAdvancedTimeSteppingAnalysisForModulation]':
