...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6972.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6972.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
