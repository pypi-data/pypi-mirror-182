...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7131.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2221.BeltConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6945.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6945.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
