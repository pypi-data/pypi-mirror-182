...
class ConceptGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7125.GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2258.ConceptGearMesh':
    ...
    @property
    def connection_design(self) -> '_2258.ConceptGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6966.ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6966.ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation]':
