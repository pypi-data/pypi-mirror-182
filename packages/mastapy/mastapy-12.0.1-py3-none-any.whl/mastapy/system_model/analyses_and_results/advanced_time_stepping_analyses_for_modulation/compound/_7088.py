...
class ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2295.ClutchConnection':
    ...
    @property
    def connection_design(self) -> '_2295.ClutchConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6958.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6958.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
