...
class StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7082.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7045.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7045.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
