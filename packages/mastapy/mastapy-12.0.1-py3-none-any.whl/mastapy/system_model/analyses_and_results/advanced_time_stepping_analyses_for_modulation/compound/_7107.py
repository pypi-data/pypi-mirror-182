...
class CVTCompoundAdvancedTimeSteppingAnalysisForModulation(_7076.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6976.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6976.CVTAdvancedTimeSteppingAnalysisForModulation]':
