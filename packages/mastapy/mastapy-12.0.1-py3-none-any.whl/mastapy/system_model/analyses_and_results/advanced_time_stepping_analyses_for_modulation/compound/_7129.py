...
class HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7071.AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2268.HypoidGearMesh':
    ...
    @property
    def connection_design(self) -> '_2268.HypoidGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7000.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7000.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
