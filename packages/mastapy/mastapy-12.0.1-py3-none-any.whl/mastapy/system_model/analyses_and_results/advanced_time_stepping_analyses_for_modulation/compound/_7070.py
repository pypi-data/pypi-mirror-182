...
class AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7098.ConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6939.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6939.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
