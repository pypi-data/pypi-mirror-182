...
class SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7041.SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7041.SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation]':
