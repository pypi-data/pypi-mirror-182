...
class TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7055.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7055.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
