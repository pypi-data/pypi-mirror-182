...
class BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2396.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6956.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6956.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
