...
class FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2407.FlexiblePinAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6993.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6993.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
