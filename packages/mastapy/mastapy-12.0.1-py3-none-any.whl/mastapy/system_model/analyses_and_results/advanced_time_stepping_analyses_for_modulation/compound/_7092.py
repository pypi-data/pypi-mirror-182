...
class ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2533.ConceptCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6962.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6962.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
