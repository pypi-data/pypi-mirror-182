...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7083
...
class StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2278.StraightBevelDiffGearMesh':
    ...
    @property
    def connection_design(self) -> '_2278.StraightBevelDiffGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7043.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7043.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
