...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7131.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2245.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_2245.RollingRingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7030.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7030.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
