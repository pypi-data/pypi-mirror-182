...
class BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation(_7164.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2528.BeltDrive':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6946.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6946.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
