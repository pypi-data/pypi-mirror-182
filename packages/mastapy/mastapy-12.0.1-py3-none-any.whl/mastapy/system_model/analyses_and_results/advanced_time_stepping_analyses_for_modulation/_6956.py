...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_7035.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2656.BoltedJointSystemDeflection':
