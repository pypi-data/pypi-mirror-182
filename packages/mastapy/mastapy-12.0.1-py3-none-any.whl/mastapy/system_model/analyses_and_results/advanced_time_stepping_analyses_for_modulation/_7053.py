...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_7052.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2770.SynchroniserSleeveSystemDeflection':
