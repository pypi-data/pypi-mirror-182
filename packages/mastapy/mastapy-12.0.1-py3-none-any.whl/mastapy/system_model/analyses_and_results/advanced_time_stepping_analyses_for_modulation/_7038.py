...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7036, _7037, _6954
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6954.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2755.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7036.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7037.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
