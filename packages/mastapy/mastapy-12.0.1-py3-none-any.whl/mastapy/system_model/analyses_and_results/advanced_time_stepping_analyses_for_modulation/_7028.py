...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6874.RollingRingLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2746.RollingRingSystemDeflection':
