...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6952.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6912.ZerolBevelGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2788.ZerolBevelGearSystemDeflection':
