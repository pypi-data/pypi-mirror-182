...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6740, _6732, _6822, _6743,
    _6752, _6757, _6770, _6775,
    _6792, _6813, _6834, _6841,
    _6844, _6847, _6860, _6882,
    _6888, _6891, _6911, _6914
)
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    @property
    def advanced_time_stepping_analysis_method(self) -> '_6740.AdvancedTimeSteppingAnalysisForModulationType':
        ...
        return constructor.new_from_mastapy_type(_6740.AdvancedTimeSteppingAnalysisForModulationType)(value) if value is not None else None

    @advanced_time_stepping_analysis_method.setter
    def advanced_time_stepping_analysis_method(self, value: '_6740.AdvancedTimeSteppingAnalysisForModulationType'):
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation(self) -> '_6822.GearSetLoadCase':
        ...
        if _6822.GearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_agma_gleason_conical_gear_set_load_case(self) -> '_6743.AGMAGleasonConicalGearSetLoadCase':
        ...
        if _6743.AGMAGleasonConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_differential_gear_set_load_case(self) -> '_6752.BevelDifferentialGearSetLoadCase':
        ...
        if _6752.BevelDifferentialGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_gear_set_load_case(self) -> '_6757.BevelGearSetLoadCase':
        ...
        if _6757.BevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_concept_gear_set_load_case(self) -> '_6770.ConceptGearSetLoadCase':
        ...
        if _6770.ConceptGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_conical_gear_set_load_case(self) -> '_6775.ConicalGearSetLoadCase':
        ...
        if _6775.ConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_cylindrical_gear_set_load_case(self) -> '_6792.CylindricalGearSetLoadCase':
        ...
        if _6792.CylindricalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_face_gear_set_load_case(self) -> '_6813.FaceGearSetLoadCase':
        ...
        if _6813.FaceGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_hypoid_gear_set_load_case(self) -> '_6834.HypoidGearSetLoadCase':
        ...
        if _6834.HypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_conical_gear_set_load_case(self) -> '_6841.KlingelnbergCycloPalloidConicalGearSetLoadCase':
        ...
        if _6841.KlingelnbergCycloPalloidConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_load_case(self) -> '_6844.KlingelnbergCycloPalloidHypoidGearSetLoadCase':
        ...
        if _6844.KlingelnbergCycloPalloidHypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_load_case(self) -> '_6847.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase':
        ...
        if _6847.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_planetary_gear_set_load_case(self) -> '_6860.PlanetaryGearSetLoadCase':
        ...
        if _6860.PlanetaryGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_spiral_bevel_gear_set_load_case(self) -> '_6882.SpiralBevelGearSetLoadCase':
        ...
        if _6882.SpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_diff_gear_set_load_case(self) -> '_6888.StraightBevelDiffGearSetLoadCase':
        ...
        if _6888.StraightBevelDiffGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_gear_set_load_case(self) -> '_6891.StraightBevelGearSetLoadCase':
        ...
        if _6891.StraightBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_worm_gear_set_load_case(self) -> '_6911.WormGearSetLoadCase':
        ...
        if _6911.WormGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_zerol_bevel_gear_set_load_case(self) -> '_6914.ZerolBevelGearSetLoadCase':
        ...
        if _6914.ZerolBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def time_options(self) -> '_2636.TimeOptions':
