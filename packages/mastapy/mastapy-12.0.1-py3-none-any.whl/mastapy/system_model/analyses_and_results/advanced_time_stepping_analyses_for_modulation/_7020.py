...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_7034.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2736.PlanetaryConnectionSystemDeflection':
