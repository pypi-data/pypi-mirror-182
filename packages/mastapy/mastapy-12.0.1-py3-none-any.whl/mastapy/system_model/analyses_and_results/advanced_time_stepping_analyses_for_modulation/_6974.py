...
class CouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_7002.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2676.CouplingConnectionSystemDeflection':
