...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2659.ClutchHalfSystemDeflection':
