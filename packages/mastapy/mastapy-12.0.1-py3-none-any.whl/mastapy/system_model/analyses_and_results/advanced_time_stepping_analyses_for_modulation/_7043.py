...
class StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation(_6953.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6887.StraightBevelDiffGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2760.StraightBevelDiffGearMeshSystemDeflection':
