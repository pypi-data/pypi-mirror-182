...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2575, _6942
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6942.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2575.AdvancedTimeSteppingAnalysisForModulation':
    ...
    @property
    def results(self) -> '_5806.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2747.RootAssemblySystemDeflection':
