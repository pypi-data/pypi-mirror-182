...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6953.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2786.ZerolBevelGearMeshSystemDeflection':
