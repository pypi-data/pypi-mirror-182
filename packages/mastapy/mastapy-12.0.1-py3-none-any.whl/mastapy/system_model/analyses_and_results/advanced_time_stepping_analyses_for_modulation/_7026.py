...
class RingPinsAdvancedTimeSteppingAnalysisForModulation(_7014.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2741.RingPinsSystemDeflection':
