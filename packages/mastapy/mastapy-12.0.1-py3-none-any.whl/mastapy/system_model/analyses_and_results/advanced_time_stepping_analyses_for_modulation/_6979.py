...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(_7035.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2682.CycloidalAssemblySystemDeflection':
