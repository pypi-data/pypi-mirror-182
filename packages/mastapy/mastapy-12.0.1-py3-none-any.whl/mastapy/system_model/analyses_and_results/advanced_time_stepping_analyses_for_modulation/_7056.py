...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2776.TorqueConverterPumpSystemDeflection':
