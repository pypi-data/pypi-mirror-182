...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6940.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6833.HypoidGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2710.HypoidGearMeshSystemDeflection':
