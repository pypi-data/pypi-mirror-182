...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6995.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2783.WormGearMeshSystemDeflection':
