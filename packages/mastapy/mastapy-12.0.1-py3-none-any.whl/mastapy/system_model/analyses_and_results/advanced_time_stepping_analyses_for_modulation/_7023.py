...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_7059.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6865.PointLoadLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2738.PointLoadSystemDeflection':
