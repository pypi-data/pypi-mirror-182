...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_7059.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6848.MassDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2726.MassDiscSystemDeflection':
