...
class ConceptGearAdvancedTimeSteppingAnalysisForModulation(_6994.GearAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6768.ConceptGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2669.ConceptGearSystemDeflection':
