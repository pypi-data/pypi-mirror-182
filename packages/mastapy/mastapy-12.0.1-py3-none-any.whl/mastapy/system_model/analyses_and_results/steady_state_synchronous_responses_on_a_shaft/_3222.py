...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3223, _3221, _3251
...
class ConceptGearSetSteadyStateSynchronousResponseOnAShaft(_3251.GearSetSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def concept_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3223.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3221.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
