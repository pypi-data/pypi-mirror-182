...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3300, _3298, _3209
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponseOnAShaft(_3209.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3300.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3298.StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft]':
