...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3303, _3301, _3209
...
class StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3209.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3303.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3301.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
