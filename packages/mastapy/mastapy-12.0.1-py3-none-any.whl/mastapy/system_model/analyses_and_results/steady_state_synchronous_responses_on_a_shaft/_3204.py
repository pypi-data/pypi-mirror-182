...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3205, _3203, _3209
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(_3209.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3205.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3203.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
