...
class SpringDamperHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3361.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3295.SpringDamperHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3295.SpringDamperHalfSteadyStateSynchronousResponseOnAShaft]':
