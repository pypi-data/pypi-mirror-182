...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseOnAShaft(_3361.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3311.TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3311.TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft]':
