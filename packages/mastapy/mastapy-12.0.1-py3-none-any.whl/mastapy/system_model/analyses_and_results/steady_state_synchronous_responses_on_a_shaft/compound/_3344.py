...
class ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3360.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3213.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3213.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
