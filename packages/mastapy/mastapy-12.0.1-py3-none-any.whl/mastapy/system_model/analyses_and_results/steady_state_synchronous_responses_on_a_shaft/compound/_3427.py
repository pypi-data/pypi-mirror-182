...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft(_3338.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3300.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3300.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
