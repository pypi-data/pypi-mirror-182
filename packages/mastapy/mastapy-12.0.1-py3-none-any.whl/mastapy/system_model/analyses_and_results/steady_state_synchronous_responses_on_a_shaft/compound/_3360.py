...
class CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3387.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3229.CouplingConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3229.CouplingConnectionSteadyStateSynchronousResponseOnAShaft]':
