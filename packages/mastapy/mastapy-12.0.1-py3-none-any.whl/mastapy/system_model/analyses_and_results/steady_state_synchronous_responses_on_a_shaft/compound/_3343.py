...
class ClutchCompoundSteadyStateSynchronousResponseOnAShaft(_3359.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """ClutchCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3215.ClutchSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3215.ClutchSteadyStateSynchronousResponseOnAShaft]':
