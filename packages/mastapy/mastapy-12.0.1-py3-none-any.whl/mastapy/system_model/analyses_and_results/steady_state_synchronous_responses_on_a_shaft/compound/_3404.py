...
class PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3361.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3273.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3273.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
