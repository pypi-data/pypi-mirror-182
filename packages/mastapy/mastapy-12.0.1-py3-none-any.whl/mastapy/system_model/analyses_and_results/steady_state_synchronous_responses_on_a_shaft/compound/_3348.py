...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3359.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3220.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3220.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
