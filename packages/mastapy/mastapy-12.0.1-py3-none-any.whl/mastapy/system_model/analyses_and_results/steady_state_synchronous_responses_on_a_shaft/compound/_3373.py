...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_3347.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3243.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3243.DatumSteadyStateSynchronousResponseOnAShaft]':
