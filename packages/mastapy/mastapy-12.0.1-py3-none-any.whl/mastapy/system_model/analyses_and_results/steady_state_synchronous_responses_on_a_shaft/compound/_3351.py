...
class ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(_3380.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3223.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3223.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
