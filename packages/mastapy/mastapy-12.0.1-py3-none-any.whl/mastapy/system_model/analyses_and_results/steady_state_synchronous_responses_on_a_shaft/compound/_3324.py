...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft(_3347.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3193.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3193.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
