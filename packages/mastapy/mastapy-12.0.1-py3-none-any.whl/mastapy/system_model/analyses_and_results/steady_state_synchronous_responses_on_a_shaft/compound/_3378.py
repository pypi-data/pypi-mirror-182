...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3324
...
class FEPartCompoundSteadyStateSynchronousResponseOnAShaft(_3324.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    """FEPartCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3248.FEPartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3248.FEPartSteadyStateSynchronousResponseOnAShaft]':
