...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3338
...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3338.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2505.ZerolBevelGear':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3321.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3321.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
