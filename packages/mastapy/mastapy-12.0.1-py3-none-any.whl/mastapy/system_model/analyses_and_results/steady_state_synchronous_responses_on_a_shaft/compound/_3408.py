...
class PointLoadCompoundSteadyStateSynchronousResponseOnAShaft(_3444.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """PointLoadCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3278.PointLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3278.PointLoadSteadyStateSynchronousResponseOnAShaft]':
