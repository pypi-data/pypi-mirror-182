...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3387.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3284.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3284.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft]':
