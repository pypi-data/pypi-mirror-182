...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3323
...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3323.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3288.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3288.ShaftSteadyStateSynchronousResponseOnAShaft]':
