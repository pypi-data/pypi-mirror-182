...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3360.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3294.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3294.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
