...
class ComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3401.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """ComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3217.ComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3217.ComponentSteadyStateSynchronousResponseOnAShaft]':
