...
class GearCompoundSteadyStateSynchronousResponseOnAShaft(_3399.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3252.GearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3252.GearSteadyStateSynchronousResponseOnAShaft]':
