...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3360.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3310.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3310.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
