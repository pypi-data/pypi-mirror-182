...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import (
    _3330, _3332, _3335, _3342,
    _3341, _3363, _3343, _3348,
    _3353, _3365, _3367, _3371,
    _3378, _3377, _3379, _3386,
    _3393, _3396, _3397, _3398,
    _3400, _3402, _3407, _3408,
    _3409, _3411, _3413, _3418,
    _3417, _3423, _3424, _3429,
    _3432, _3435, _3439, _3443,
    _3447, _3450, _3322
)
...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3322.AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """AssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3199.AssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bearings(self) -> 'List[_3330.BearingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def belt_drives(self) -> 'List[_3332.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3335.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3342.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolts(self) -> 'List[_3341.BoltCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cv_ts(self) -> 'List[_3363.CVTCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def clutches(self) -> 'List[_3343.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3348.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3353.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3365.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3367.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3371.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def fe_parts(self) -> 'List[_3378.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3377.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3379.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3386.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3393.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3396.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def mass_discs(self) -> 'List[_3397.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def measurement_components(self) -> 'List[_3398.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def oil_seals(self) -> 'List[_3400.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3402.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3407.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def point_loads(self) -> 'List[_3408.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def power_loads(self) -> 'List[_3409.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def ring_pins(self) -> 'List[_3411.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3413.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3418.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shafts(self) -> 'List[_3417.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3423.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3424.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3429.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3432.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def synchronisers(self) -> 'List[_3435.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def torque_converters(self) -> 'List[_3439.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3443.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3447.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3450.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3199.AssemblySteadyStateSynchronousResponseOnAShaft]':
