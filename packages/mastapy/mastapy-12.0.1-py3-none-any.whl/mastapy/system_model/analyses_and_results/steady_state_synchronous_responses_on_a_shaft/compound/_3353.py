...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3351, _3352, _3382
...
class ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3382.GearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3222.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3351.ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3352.ConceptGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3222.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]':
