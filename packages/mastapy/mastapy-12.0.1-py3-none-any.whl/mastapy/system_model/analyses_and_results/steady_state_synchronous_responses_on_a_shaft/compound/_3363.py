...
class CVTCompoundSteadyStateSynchronousResponseOnAShaft(_3332.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3234.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3234.CVTSteadyStateSynchronousResponseOnAShaft]':
