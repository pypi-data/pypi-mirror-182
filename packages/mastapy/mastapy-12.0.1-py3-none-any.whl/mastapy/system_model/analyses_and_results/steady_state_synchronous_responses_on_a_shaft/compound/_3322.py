...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3401.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3192.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3192.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
