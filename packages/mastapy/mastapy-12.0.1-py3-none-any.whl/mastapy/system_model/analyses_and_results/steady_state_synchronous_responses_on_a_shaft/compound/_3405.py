...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3419.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3275.PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3275.PlanetaryConnectionSteadyStateSynchronousResponseOnAShaft]':
