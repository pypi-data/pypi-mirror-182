...
class AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3357.ConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3195.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3195.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft]':
