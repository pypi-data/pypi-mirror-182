...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3247, _3245, _3251
...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_3251.GearSetSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3247.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3245.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
