...
from mastapy.system_model.analyses_and_results.power_flows import _4105, _4104, _4038
...
class WormGearSetPowerFlow(_4038.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4105.WormGearPowerFlow]':
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4105.WormGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4104.WormGearMeshPowerFlow]':
    ...
    @property
    def worm_meshes_power_flow(self) -> 'List[_4104.WormGearMeshPowerFlow]':
