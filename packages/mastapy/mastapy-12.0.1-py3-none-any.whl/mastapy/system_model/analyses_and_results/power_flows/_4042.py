...
from mastapy.system_model.analyses_and_results.power_flows import _4041, _4040, _3983
...
class HypoidGearSetPowerFlow(_3983.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4041.HypoidGearPowerFlow]':
    ...
    @property
    def hypoid_gears_power_flow(self) -> 'List[_4041.HypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4040.HypoidGearMeshPowerFlow]':
    ...
    @property
    def hypoid_meshes_power_flow(self) -> 'List[_4040.HypoidGearMeshPowerFlow]':
