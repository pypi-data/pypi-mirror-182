...
class SynchroniserCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4095.SynchroniserPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4095.SynchroniserPowerFlow]':
