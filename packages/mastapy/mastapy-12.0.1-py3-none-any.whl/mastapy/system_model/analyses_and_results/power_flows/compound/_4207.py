...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_4113.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    """ShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4077.ShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4077.ShaftToMountableComponentConnectionPowerFlow]':
