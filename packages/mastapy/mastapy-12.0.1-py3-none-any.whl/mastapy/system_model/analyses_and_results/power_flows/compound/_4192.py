...
class PartToPartShearCouplingHalfCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """PartToPartShearCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4059.PartToPartShearCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4059.PartToPartShearCouplingHalfPowerFlow]':
