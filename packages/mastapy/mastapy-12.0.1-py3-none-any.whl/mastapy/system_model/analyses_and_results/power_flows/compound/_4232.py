...
class VirtualComponentCompoundPowerFlow(_4187.MountableComponentCompoundPowerFlow):
    """VirtualComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4103.VirtualComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4103.VirtualComponentPowerFlow]':
