...
class RollingRingAssemblyCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4071.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4071.RollingRingAssemblyPowerFlow]':
