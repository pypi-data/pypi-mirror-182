...
class DatumCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4029.DatumPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4029.DatumPowerFlow]':
