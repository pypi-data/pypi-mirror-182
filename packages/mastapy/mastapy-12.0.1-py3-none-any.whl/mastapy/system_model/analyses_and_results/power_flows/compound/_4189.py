...
class PartCompoundPowerFlow(_7471.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4057.PartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4057.PartPowerFlow]':
