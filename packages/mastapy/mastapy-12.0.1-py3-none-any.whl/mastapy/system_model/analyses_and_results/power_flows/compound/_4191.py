...
class PartToPartShearCouplingConnectionCompoundPowerFlow(_4148.CouplingConnectionCompoundPowerFlow):
    """PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4058.PartToPartShearCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4058.PartToPartShearCouplingConnectionPowerFlow]':
