...
class GuideDxfModelCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4039.GuideDxfModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4039.GuideDxfModelPowerFlow]':
