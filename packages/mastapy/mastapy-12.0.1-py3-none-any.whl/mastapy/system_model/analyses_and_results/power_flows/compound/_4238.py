...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4236, _4237, _4128
...
class ZerolBevelGearSetCompoundPowerFlow(_4128.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4109.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4236.ZerolBevelGearCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4237.ZerolBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4109.ZerolBevelGearSetPowerFlow]':
