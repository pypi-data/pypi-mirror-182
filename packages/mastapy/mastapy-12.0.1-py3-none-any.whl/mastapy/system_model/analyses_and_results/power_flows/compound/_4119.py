...
class BeltConnectionCompoundPowerFlow(_4175.InterMountableComponentConnectionCompoundPowerFlow):
    """BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3986.BeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3986.BeltConnectionPowerFlow]':
