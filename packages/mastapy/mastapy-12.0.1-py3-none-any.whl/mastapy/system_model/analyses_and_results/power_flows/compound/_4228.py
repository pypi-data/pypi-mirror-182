...
class TorqueConverterConnectionCompoundPowerFlow(_4148.CouplingConnectionCompoundPowerFlow):
    """TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4098.TorqueConverterConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4098.TorqueConverterConnectionPowerFlow]':
