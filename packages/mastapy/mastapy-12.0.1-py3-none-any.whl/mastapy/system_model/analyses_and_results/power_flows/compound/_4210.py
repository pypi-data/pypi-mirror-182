...
class SpiralBevelGearMeshCompoundPowerFlow(_4127.BevelGearMeshCompoundPowerFlow):
    """SpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4079.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4079.SpiralBevelGearMeshPowerFlow]':
