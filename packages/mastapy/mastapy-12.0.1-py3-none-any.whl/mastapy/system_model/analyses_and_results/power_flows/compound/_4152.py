...
class CVTPulleyCompoundPowerFlow(_4198.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4019.CVTPulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4019.CVTPulleyPowerFlow]':
