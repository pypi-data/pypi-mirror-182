...
class SpiralBevelGearCompoundPowerFlow(_4126.BevelGearCompoundPowerFlow):
    """SpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4080.SpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4080.SpiralBevelGearPowerFlow]':
