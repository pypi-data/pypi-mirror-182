...
class GearCompoundPowerFlow(_4187.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4037.GearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4037.GearPowerFlow]':
