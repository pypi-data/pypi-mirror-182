...
class RootAssemblyCompoundPowerFlow(_4117.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5597.AbstractStaticLoadCaseGroup':
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5595.AbstractDesignStateLoadCaseGroup':
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5600.DesignState':
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5601.DutyCycle':
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5604.SubGroupInSingleDesignState':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4074.RootAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4074.RootAssemblyPowerFlow]':
