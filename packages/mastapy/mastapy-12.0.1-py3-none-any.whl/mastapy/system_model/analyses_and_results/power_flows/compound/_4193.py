...
class PlanetaryConnectionCompoundPowerFlow(_4207.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4061.PlanetaryConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4061.PlanetaryConnectionPowerFlow]':
