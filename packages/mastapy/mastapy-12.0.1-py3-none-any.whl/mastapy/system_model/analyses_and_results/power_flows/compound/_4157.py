...
class CylindricalGearCompoundPowerFlow(_4168.GearCompoundPowerFlow):
    """CylindricalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.CylindricalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.CylindricalGearPowerFlow]':
