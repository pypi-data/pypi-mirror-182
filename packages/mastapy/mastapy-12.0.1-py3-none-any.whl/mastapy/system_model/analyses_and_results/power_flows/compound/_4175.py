...
class InterMountableComponentConnectionCompoundPowerFlow(_4145.ConnectionCompoundPowerFlow):
    """InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4043.InterMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4043.InterMountableComponentConnectionPowerFlow]':
