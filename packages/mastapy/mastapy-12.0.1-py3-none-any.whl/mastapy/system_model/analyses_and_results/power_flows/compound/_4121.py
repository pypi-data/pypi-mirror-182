...
class BevelDifferentialGearCompoundPowerFlow(_4126.BevelGearCompoundPowerFlow):
    """BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3989.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3989.BevelDifferentialGearPowerFlow]':
