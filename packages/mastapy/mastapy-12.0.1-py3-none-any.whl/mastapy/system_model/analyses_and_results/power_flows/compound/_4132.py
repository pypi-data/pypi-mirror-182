...
class ClutchConnectionCompoundPowerFlow(_4148.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3998.ClutchConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3998.ClutchConnectionPowerFlow]':
