...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4126
...
class ZerolBevelGearCompoundPowerFlow(_4126.BevelGearCompoundPowerFlow):
    """ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4108.ZerolBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4108.ZerolBevelGearPowerFlow]':
