...
class RollingRingCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4073.RollingRingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4073.RollingRingPowerFlow]':
