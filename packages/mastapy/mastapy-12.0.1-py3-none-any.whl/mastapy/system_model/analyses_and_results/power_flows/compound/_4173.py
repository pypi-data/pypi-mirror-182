...
class HypoidGearMeshCompoundPowerFlow(_4115.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """HypoidGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4040.HypoidGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4040.HypoidGearMeshPowerFlow]':
