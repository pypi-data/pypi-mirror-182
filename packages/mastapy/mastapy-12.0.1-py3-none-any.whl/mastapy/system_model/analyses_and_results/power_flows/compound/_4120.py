...
class BeltDriveCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3987.BeltDrivePowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3987.BeltDrivePowerFlow]':
