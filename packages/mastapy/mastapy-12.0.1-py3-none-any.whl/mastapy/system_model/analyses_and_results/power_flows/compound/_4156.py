...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_4113.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    """CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4022.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4022.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
