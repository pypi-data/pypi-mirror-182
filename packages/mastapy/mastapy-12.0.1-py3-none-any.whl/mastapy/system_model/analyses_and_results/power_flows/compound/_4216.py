...
class StraightBevelDiffGearMeshCompoundPowerFlow(_4127.BevelGearMeshCompoundPowerFlow):
    """StraightBevelDiffGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4085.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4085.StraightBevelDiffGearMeshPowerFlow]':
