...
class KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow(_4176.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4048.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4048.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
