...
class CoaxialConnectionCompoundPowerFlow(_4207.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """CoaxialConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4001.CoaxialConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4001.CoaxialConnectionPowerFlow]':
