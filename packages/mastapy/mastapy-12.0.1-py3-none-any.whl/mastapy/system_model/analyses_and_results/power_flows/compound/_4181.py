...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4179, _4180, _4178
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow(_4178.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4049.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_power_flow(self) -> 'List[_4179.KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_power_flow(self) -> 'List[_4180.KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4049.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
