...
class BevelGearCompoundPowerFlow(_4114.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3994.BevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3994.BevelGearPowerFlow]':
