...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4110
...
class SpecialisedAssemblyCompoundPowerFlow(_4110.AbstractAssemblyCompoundPowerFlow):
    """SpecialisedAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4078.SpecialisedAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4078.SpecialisedAssemblyPowerFlow]':
