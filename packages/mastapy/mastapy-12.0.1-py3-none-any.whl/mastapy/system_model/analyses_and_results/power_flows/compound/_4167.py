...
class FlexiblePinAssemblyCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4035.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4035.FlexiblePinAssemblyPowerFlow]':
