...
class WormGearCompoundPowerFlow(_4168.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4105.WormGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4105.WormGearPowerFlow]':
