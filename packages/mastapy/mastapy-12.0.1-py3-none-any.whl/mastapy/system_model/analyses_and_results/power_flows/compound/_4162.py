...
class ExternalCADModelCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4030.ExternalCADModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4030.ExternalCADModelPowerFlow]':
