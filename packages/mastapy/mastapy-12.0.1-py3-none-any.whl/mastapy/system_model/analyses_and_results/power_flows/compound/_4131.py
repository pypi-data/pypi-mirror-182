...
class ClutchCompoundPowerFlow(_4147.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4000.ClutchPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4000.ClutchPowerFlow]':
