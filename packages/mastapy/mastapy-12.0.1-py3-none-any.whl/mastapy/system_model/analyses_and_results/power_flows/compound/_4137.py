...
class ConceptCouplingConnectionCompoundPowerFlow(_4148.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4003.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4003.ConceptCouplingConnectionPowerFlow]':
