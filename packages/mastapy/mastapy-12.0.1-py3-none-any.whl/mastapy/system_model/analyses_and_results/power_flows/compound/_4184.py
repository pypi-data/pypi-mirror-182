...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4182, _4183, _4178
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow(_4178.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4052.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_power_flow(self) -> 'List[_4182.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4183.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4052.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
