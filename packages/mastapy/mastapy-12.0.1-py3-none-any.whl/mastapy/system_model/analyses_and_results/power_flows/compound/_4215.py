...
class StraightBevelDiffGearCompoundPowerFlow(_4126.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4086.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4086.StraightBevelDiffGearPowerFlow]':
