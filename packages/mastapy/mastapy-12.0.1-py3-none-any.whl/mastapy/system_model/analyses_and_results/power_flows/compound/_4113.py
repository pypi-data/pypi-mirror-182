...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4145.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3980.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3980.AbstractShaftToMountableComponentConnectionPowerFlow]':
