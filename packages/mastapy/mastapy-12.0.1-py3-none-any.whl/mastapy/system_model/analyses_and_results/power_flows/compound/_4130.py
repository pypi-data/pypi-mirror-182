...
class BoltedJointCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3996.BoltedJointPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3996.BoltedJointPowerFlow]':
