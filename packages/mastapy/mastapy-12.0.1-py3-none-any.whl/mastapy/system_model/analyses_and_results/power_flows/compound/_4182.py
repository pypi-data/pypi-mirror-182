...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow(_4176.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
