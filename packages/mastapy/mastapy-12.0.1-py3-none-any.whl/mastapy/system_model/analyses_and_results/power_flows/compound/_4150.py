...
class CVTBeltConnectionCompoundPowerFlow(_4119.BeltConnectionCompoundPowerFlow):
    """CVTBeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4017.CVTBeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4017.CVTBeltConnectionPowerFlow]':
