...
class ConicalGearCompoundPowerFlow(_4168.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4010.ConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4010.ConicalGearPowerFlow]':
