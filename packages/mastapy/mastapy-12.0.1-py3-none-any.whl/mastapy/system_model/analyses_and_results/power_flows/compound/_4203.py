...
class RollingRingConnectionCompoundPowerFlow(_4175.InterMountableComponentConnectionCompoundPowerFlow):
    """RollingRingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4072.RollingRingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4072.RollingRingConnectionPowerFlow]':
