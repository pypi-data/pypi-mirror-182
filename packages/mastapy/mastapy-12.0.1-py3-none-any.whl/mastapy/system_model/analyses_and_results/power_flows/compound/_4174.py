...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4172, _4173, _4116
...
class HypoidGearSetCompoundPowerFlow(_4116.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4042.HypoidGearSetPowerFlow]':
    ...
    @property
    def hypoid_gears_compound_power_flow(self) -> 'List[_4172.HypoidGearCompoundPowerFlow]':
    ...
    @property
    def hypoid_meshes_compound_power_flow(self) -> 'List[_4173.HypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4042.HypoidGearSetPowerFlow]':
