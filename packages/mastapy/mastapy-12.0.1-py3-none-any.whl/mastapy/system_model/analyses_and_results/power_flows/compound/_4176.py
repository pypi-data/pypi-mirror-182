...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_4142.ConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4045.KlingelnbergCycloPalloidConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4045.KlingelnbergCycloPalloidConicalGearPowerFlow]':
