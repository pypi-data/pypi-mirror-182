...
class SpringDamperHalfCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4083.SpringDamperHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4083.SpringDamperHalfPowerFlow]':
