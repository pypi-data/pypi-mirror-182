...
class SynchroniserHalfCompoundPowerFlow(_4225.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4093.SynchroniserHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4093.SynchroniserHalfPowerFlow]':
