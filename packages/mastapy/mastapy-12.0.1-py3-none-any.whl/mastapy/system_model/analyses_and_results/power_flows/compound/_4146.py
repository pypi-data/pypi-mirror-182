...
class ConnectorCompoundPowerFlow(_4187.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4013.ConnectorPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4013.ConnectorPowerFlow]':
