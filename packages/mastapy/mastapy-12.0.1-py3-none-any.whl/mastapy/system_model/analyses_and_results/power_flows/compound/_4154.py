...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4134.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4021.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4021.CycloidalDiscCentralBearingConnectionPowerFlow]':
