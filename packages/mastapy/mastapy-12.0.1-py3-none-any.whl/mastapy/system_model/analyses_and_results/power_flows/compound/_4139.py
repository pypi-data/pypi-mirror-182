...
class ConceptGearCompoundPowerFlow(_4168.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4007.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4007.ConceptGearPowerFlow]':
