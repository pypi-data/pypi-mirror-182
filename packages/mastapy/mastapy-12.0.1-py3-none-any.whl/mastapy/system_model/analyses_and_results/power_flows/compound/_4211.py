...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4209, _4210, _4128
...
class SpiralBevelGearSetCompoundPowerFlow(_4128.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4081.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_4209.SpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4210.SpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4081.SpiralBevelGearSetPowerFlow]':
