...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4121, _4122, _4128
...
class BevelDifferentialGearSetCompoundPowerFlow(_4128.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3990.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bevel_differential_gears_compound_power_flow(self) -> 'List[_4121.BevelDifferentialGearCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_compound_power_flow(self) -> 'List[_4122.BevelDifferentialGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3990.BevelDifferentialGearSetPowerFlow]':
