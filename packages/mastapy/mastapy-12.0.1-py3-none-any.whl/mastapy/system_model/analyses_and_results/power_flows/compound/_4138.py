...
class ConceptCouplingHalfCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4004.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4004.ConceptCouplingHalfPowerFlow]':
