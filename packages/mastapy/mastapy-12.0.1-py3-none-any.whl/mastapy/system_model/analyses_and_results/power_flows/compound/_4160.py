...
class CylindricalPlanetGearCompoundPowerFlow(_4157.CylindricalGearCompoundPowerFlow):
    """CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4028.CylindricalPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4028.CylindricalPlanetGearPowerFlow]':
