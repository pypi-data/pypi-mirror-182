...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3985, _3987, _3990, _3996,
    _3997, _4018, _4000, _4005,
    _4008, _4020, _4023, _4027,
    _4034, _4033, _4035, _4042,
    _4049, _4052, _4038, _4053,
    _4054, _4056, _4060, _4063,
    _4064, _4067, _4069, _4071,
    _4075, _4076, _4081, _4084,
    _4087, _4090, _4095, _4099,
    _4102, _4106, _4109, _3977
)
...
class AssemblyPowerFlow(_3977.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_3985.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3987.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3990.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3996.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_3997.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4018.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4000.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4005.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4008.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4020.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4023.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4027.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4034.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4033.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4035.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4042.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4049.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4052.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4038.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4053.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4054.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4056.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4060.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4063.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4064.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4067.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4069.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4071.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4075.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4076.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4081.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4084.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4087.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4090.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4095.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4099.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4102.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4106.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4109.ZerolBevelGearSetPowerFlow]':
