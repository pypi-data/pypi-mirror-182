...
from mastapy.system_model.analyses_and_results.power_flows import _4080, _4079, _3995
...
class SpiralBevelGearSetPowerFlow(_3995.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4080.SpiralBevelGearPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_4080.SpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4079.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_4079.SpiralBevelGearMeshPowerFlow]':
