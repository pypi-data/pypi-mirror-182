...
from mastapy.system_model.analyses_and_results.power_flows import _4037, _4036, _4078
...
class GearSetPowerFlow(_4078.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4037.GearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4036.GearMeshPowerFlow]':
