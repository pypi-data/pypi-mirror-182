...
from mastapy.system_model.analyses_and_results.power_flows import _4108, _4107, _3995
...
class ZerolBevelGearSetPowerFlow(_3995.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4108.ZerolBevelGearPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4108.ZerolBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4107.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4107.ZerolBevelGearMeshPowerFlow]':
