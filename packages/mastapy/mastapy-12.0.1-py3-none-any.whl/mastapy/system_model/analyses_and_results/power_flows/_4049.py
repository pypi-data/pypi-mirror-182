...
from mastapy.system_model.analyses_and_results.power_flows import _4048, _4047, _4046
...
class KlingelnbergCycloPalloidHypoidGearSetPowerFlow(_4046.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4048.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_power_flow(self) -> 'List[_4048.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4047.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_power_flow(self) -> 'List[_4047.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
