...
from mastapy.system_model.analyses_and_results.power_flows import _4089, _4088, _3995
...
class StraightBevelGearSetPowerFlow(_3995.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4089.StraightBevelGearPowerFlow]':
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4089.StraightBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4088.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4088.StraightBevelGearMeshPowerFlow]':
