...
from mastapy.system_model.analyses_and_results.power_flows import _3989, _3988, _3995
...
class BevelDifferentialGearSetPowerFlow(_3995.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3989.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3989.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3988.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3988.BevelDifferentialGearMeshPowerFlow]':
