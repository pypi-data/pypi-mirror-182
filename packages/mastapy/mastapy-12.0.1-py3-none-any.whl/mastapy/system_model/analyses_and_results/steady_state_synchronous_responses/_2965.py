...
class ConnectionSteadyStateSynchronousResponse(_7466.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3036.SteadyStateSynchronousResponse':
