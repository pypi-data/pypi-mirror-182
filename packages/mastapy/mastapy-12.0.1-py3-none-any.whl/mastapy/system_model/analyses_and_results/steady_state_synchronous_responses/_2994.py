...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2995, _2993, _2935
...
class HypoidGearSetSteadyStateSynchronousResponse(_2935.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    """HypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2995.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2993.HypoidGearMeshSteadyStateSynchronousResponse]':
