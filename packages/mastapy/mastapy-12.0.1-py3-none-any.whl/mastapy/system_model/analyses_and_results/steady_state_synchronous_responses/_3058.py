...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3059, _3057, _2990
...
class WormGearSetSteadyStateSynchronousResponse(_2990.GearSetSteadyStateSynchronousResponse):
    """WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3059.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3057.WormGearMeshSteadyStateSynchronousResponse]':
