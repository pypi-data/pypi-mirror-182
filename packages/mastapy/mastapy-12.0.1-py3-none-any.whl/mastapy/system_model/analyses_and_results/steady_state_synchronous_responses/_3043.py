...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3044, _3042, _2947
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2947.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3044.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3042.StraightBevelGearMeshSteadyStateSynchronousResponse]':
