...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3041, _3039, _2947
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponse(_2947.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response(self) -> 'List[_3041.StraightBevelDiffGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response(self) -> 'List[_3039.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
