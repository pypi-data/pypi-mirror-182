...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3074, _3075, _3081
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3081.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2942.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3074.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3075.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2942.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
