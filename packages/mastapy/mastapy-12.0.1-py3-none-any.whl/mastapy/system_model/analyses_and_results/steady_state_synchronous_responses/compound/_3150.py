...
class PowerLoadCompoundSteadyStateSynchronousResponse(_3185.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """PowerLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3018.PowerLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3018.PowerLoadSteadyStateSynchronousResponse]':
