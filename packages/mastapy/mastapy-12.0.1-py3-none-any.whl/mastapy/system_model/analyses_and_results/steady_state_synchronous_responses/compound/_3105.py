...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3151.PulleyCompoundSteadyStateSynchronousResponse):
    """CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2971.CVTPulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2971.CVTPulleySteadyStateSynchronousResponse]':
