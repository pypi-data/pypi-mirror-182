...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3101.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3033.SpringDamperConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3033.SpringDamperConnectionSteadyStateSynchronousResponse]':
