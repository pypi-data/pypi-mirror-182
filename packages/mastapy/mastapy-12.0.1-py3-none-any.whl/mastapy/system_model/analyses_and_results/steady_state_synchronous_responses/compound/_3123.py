...
class GearSetCompoundSteadyStateSynchronousResponse(_3161.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """GearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2990.GearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2990.GearSetSteadyStateSynchronousResponse]':
