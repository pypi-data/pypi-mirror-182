...
class PointLoadCompoundSteadyStateSynchronousResponse(_3185.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """PointLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3017.PointLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3017.PointLoadSteadyStateSynchronousResponse]':
