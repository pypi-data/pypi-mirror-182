...
class MeasurementComponentCompoundSteadyStateSynchronousResponse(_3185.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MeasurementComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3007.MeasurementComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3007.MeasurementComponentSteadyStateSynchronousResponse]':
