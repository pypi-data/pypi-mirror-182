...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponse(_3160.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3014.PlanetaryConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3014.PlanetaryConnectionSteadyStateSynchronousResponse]':
