...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(_3074.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2944.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2944.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
