...
class CycloidalDiscCompoundSteadyStateSynchronousResponse(_3064.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2976.CycloidalDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2976.CycloidalDiscSteadyStateSynchronousResponse]':
