...
class HypoidGearCompoundSteadyStateSynchronousResponse(_3067.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """HypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2995.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2995.HypoidGearSteadyStateSynchronousResponse]':
