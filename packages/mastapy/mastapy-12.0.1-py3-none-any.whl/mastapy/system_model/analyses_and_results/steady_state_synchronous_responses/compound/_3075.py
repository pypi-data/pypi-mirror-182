...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(_3080.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2941.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2941.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
