...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3064
...
class ShaftCompoundSteadyStateSynchronousResponse(_3064.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """ShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3027.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3027.ShaftSteadyStateSynchronousResponse]':
