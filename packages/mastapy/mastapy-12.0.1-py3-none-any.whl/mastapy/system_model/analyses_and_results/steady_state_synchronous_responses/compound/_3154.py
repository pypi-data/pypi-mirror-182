...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponse(_3161.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3022.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3022.RollingRingAssemblySteadyStateSynchronousResponse]':
