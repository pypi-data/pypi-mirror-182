...
class FaceGearCompoundSteadyStateSynchronousResponse(_3121.GearCompoundSteadyStateSynchronousResponse):
    """FaceGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2986.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2986.FaceGearSteadyStateSynchronousResponse]':
