...
class CoaxialConnectionCompoundSteadyStateSynchronousResponse(_3160.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2954.CoaxialConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2954.CoaxialConnectionSteadyStateSynchronousResponse]':
