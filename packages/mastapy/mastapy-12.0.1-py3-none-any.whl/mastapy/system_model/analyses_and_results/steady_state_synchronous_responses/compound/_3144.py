...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(_3101.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3011.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3011.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
