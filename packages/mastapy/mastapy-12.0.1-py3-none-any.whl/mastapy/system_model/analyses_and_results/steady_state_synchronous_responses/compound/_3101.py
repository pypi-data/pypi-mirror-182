...
class CouplingConnectionCompoundSteadyStateSynchronousResponse(_3128.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2967.CouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2967.CouplingConnectionSteadyStateSynchronousResponse]':
