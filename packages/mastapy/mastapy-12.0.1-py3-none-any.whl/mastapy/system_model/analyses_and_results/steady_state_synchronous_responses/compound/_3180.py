...
class TorqueConverterCompoundSteadyStateSynchronousResponse(_3100.CouplingCompoundSteadyStateSynchronousResponse):
    """TorqueConverterCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3053.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3053.TorqueConverterSteadyStateSynchronousResponse]':
