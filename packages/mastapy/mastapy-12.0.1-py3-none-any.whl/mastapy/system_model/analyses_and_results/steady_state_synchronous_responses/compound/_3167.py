...
class SpringDamperHalfCompoundSteadyStateSynchronousResponse(_3102.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """SpringDamperHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3034.SpringDamperHalfSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3034.SpringDamperHalfSteadyStateSynchronousResponse]':
