...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3132, _3133, _3131
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse(_3131.KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3001.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_3132.KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3133.KlingelnbergCycloPalloidHypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3001.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse]':
