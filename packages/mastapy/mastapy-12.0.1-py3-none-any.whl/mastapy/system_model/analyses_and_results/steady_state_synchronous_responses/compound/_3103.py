...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponse(_3072.BeltConnectionCompoundSteadyStateSynchronousResponse):
    """CVTBeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2970.CVTBeltConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2970.CVTBeltConnectionSteadyStateSynchronousResponse]':
