...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
    _3071, _3073, _3076, _3083,
    _3082, _3104, _3084, _3089,
    _3094, _3106, _3108, _3112,
    _3119, _3118, _3120, _3127,
    _3134, _3137, _3138, _3139,
    _3141, _3143, _3148, _3149,
    _3150, _3152, _3154, _3159,
    _3158, _3164, _3165, _3170,
    _3173, _3176, _3180, _3184,
    _3188, _3191, _3063
)
...
class AssemblyCompoundSteadyStateSynchronousResponse(_3063.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """AssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2937.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def bearings(self) -> 'List[_3071.BearingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_3073.BeltDriveCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3076.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3083.BoltedJointCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_3082.BoltCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_3104.CVTCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_3084.ClutchCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3089.ConceptCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3094.ConceptGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3106.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3108.CycloidalDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3112.CylindricalGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_3119.FEPartCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3118.FaceGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3120.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3127.HypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3134.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3137.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_3138.MassDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_3139.MeasurementComponentCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_3141.OilSealCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3143.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3148.PlanetCarrierCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3149.PointLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3150.PowerLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3152.RingPinsCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3154.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3159.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3158.ShaftCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3164.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3165.SpringDamperCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3170.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3173.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3176.SynchroniserCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3180.TorqueConverterCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3184.UnbalancedMassCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3188.WormGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3191.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2937.AssemblySteadyStateSynchronousResponse]':
