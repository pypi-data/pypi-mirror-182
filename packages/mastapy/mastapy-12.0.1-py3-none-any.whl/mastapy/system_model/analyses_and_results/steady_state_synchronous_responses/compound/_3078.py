...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse(_3074.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2945.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2945.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
