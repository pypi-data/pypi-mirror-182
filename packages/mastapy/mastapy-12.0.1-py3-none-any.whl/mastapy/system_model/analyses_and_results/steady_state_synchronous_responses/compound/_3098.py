...
class ConnectionCompoundSteadyStateSynchronousResponse(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2965.ConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2965.ConnectionSteadyStateSynchronousResponse]':
