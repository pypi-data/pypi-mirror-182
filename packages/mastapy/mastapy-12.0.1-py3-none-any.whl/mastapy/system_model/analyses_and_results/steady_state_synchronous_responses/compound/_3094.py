...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3092, _3093, _3123
...
class ConceptGearSetCompoundSteadyStateSynchronousResponse(_3123.GearSetCompoundSteadyStateSynchronousResponse):
    """ConceptGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2960.ConceptGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response(self) -> 'List[_3092.ConceptGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3093.ConceptGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2960.ConceptGearSetSteadyStateSynchronousResponse]':
