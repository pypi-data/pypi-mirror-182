...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_3079.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3044.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3044.StraightBevelGearSteadyStateSynchronousResponse]':
