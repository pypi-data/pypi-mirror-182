...
class BoltCompoundSteadyStateSynchronousResponse(_3088.ComponentCompoundSteadyStateSynchronousResponse):
    """BoltCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2950.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2950.BoltSteadyStateSynchronousResponse]':
