...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3110, _3111, _3123
...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(_3123.GearSetCompoundSteadyStateSynchronousResponse):
    """CylindricalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2978.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gears_compound_steady_state_synchronous_response(self) -> 'List[_3110.CylindricalGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3111.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2978.CylindricalGearSetSteadyStateSynchronousResponse]':
