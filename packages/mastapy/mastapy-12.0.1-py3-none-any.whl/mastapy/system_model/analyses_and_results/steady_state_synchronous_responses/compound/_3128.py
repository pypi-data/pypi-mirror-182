...
class InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3098.ConnectionCompoundSteadyStateSynchronousResponse):
    """InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2996.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2996.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
