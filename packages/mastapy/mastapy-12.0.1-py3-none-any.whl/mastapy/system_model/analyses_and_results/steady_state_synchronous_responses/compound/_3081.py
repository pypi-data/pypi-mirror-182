...
class BevelGearSetCompoundSteadyStateSynchronousResponse(_3069.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """BevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2947.BevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2947.BevelGearSetSteadyStateSynchronousResponse]':
