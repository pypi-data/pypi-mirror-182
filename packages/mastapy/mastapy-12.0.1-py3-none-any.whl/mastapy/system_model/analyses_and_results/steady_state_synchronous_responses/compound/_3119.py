...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3065
...
class FEPartCompoundSteadyStateSynchronousResponse(_3065.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    """FEPartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2987.FEPartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2987.FEPartSteadyStateSynchronousResponse]':
