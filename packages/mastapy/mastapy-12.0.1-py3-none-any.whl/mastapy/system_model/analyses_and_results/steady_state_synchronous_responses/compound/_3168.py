...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponse(_3079.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3041.StraightBevelDiffGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3041.StraightBevelDiffGearSteadyStateSynchronousResponse]':
