...
class MountableComponentCompoundSteadyStateSynchronousResponse(_3088.ComponentCompoundSteadyStateSynchronousResponse):
    """MountableComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3008.MountableComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3008.MountableComponentSteadyStateSynchronousResponse]':
