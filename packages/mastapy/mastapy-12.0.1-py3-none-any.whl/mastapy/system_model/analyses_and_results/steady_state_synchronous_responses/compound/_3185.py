...
class VirtualComponentCompoundSteadyStateSynchronousResponse(_3140.MountableComponentCompoundSteadyStateSynchronousResponse):
    """VirtualComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3056.VirtualComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3056.VirtualComponentSteadyStateSynchronousResponse]':
