...
class RootAssemblyCompoundSteadyStateSynchronousResponse(_3070.AssemblyCompoundSteadyStateSynchronousResponse):
    """RootAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3025.RootAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3025.RootAssemblySteadyStateSynchronousResponse]':
