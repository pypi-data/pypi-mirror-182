...
class SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse(_3080.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3030.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3030.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
