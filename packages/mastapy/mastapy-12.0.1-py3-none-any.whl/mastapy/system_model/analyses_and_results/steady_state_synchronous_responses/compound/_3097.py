...
class ConicalGearSetCompoundSteadyStateSynchronousResponse(_3123.GearSetCompoundSteadyStateSynchronousResponse):
    """ConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2963.ConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2963.ConicalGearSetSteadyStateSynchronousResponse]':
