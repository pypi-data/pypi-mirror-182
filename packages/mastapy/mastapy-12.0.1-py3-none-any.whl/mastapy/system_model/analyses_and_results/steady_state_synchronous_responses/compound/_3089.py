...
class ConceptCouplingCompoundSteadyStateSynchronousResponse(_3100.CouplingCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2958.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2958.ConceptCouplingSteadyStateSynchronousResponse]':
