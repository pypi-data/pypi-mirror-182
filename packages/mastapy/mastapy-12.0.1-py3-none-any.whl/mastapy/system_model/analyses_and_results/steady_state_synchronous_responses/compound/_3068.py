...
class AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse(_3096.ConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2934.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2934.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
