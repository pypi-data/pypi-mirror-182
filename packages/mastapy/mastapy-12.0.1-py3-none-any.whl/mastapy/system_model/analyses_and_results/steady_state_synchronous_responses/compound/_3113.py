...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponse(_3110.CylindricalGearCompoundSteadyStateSynchronousResponse):
    """CylindricalPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2980.CylindricalPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2980.CylindricalPlanetGearSteadyStateSynchronousResponse]':
