...
class UnbalancedMassCompoundSteadyStateSynchronousResponse(_3185.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """UnbalancedMassCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3055.UnbalancedMassSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3055.UnbalancedMassSteadyStateSynchronousResponse]':
