...
class FaceGearMeshCompoundSteadyStateSynchronousResponse(_3122.GearMeshCompoundSteadyStateSynchronousResponse):
    """FaceGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2984.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2984.FaceGearMeshSteadyStateSynchronousResponse]':
