...
class BoltedJointCompoundSteadyStateSynchronousResponse(_3161.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BoltedJointCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2949.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2949.BoltedJointSteadyStateSynchronousResponse]':
