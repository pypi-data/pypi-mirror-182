...
class PartCompoundSteadyStateSynchronousResponse(_7471.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3010.PartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3010.PartSteadyStateSynchronousResponse]':
