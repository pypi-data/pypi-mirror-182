...
class AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3098.ConnectionCompoundSteadyStateSynchronousResponse):
    """AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2933.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2933.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
