...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponse(_3099.ConnectorCompoundSteadyStateSynchronousResponse):
    """ShaftHubConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3026.ShaftHubConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3026.ShaftHubConnectionSteadyStateSynchronousResponse]':
