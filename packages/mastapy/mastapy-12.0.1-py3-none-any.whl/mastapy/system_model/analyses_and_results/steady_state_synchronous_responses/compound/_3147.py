...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponse(_3112.CylindricalGearSetCompoundSteadyStateSynchronousResponse):
    """PlanetaryGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3015.PlanetaryGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3015.PlanetaryGearSetSteadyStateSynchronousResponse]':
