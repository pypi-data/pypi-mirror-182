...
class ConicalGearMeshCompoundSteadyStateSynchronousResponse(_3122.GearMeshCompoundSteadyStateSynchronousResponse):
    """ConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2962.ConicalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2962.ConicalGearMeshSteadyStateSynchronousResponse]':
