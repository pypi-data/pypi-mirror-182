...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3063
...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(_3063.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """SpecialisedAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3029.SpecialisedAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3029.SpecialisedAssemblySteadyStateSynchronousResponse]':
