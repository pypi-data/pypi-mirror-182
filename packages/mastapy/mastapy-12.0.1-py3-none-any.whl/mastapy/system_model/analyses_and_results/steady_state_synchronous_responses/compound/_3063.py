...
class AbstractAssemblyCompoundSteadyStateSynchronousResponse(_3142.PartCompoundSteadyStateSynchronousResponse):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2930.AbstractAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2930.AbstractAssemblySteadyStateSynchronousResponse]':
