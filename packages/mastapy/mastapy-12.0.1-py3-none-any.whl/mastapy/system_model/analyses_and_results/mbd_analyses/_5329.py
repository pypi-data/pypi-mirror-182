...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5328, _5327, _5334
...
class BevelDifferentialGearSetMultibodyDynamicsAnalysis(_5334.BevelGearSetMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5328.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_multibody_dynamics_analysis(self) -> 'List[_5328.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_multibody_dynamics_analysis(self) -> 'List[_5327.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
