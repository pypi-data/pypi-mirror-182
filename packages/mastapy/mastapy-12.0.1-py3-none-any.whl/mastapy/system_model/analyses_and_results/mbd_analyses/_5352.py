...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2591
from mastapy.math_utility.convergence import _1540, _1539
...
class ConnectionMultibodyDynamicsAnalysis(_7467.ConnectionTimeSeriesLoadAnalysisCase):
    """ConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis(self) -> '_2591.MultibodyDynamicsAnalysis':
    ...
    @property
    def data_logger(self) -> '_1540.DataLogger':
        ...
        if _1540.DataLogger.TYPE not in temp.__class__.__mro__:
