...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5428, _5427, _5334
...
class SpiralBevelGearSetMultibodyDynamicsAnalysis(_5334.BevelGearSetMultibodyDynamicsAnalysis):
    """SpiralBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5428.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5428.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5427.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
