...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5462, _5464
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5353.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5462.DynamicForceVector3DResult':
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5464.DynamicTorqueVector3DResult':
