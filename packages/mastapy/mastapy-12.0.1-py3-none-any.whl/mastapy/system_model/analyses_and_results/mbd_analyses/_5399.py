...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5465
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5321.AnalysisTypes':
        ...
        return constructor.new_from_mastapy_type(_5321.AnalysisTypes)(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5321.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5383.InertiaAdjustedLoadCasePeriodMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5383.InertiaAdjustedLoadCasePeriodMethod)(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5383.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5384.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5384.InertiaAdjustedLoadCaseResultsToCreate)(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5384.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_interface_options(self) -> '_5465.DynamicExternalInterfaceOptions':
    ...
    @property
    def frequency_response_options(self) -> '_4576.FrequencyResponseAnalysisOptions':
    ...
    @property
    def run_up_analysis_options(self) -> '_5400.MBDRunUpAnalysisOptions':
