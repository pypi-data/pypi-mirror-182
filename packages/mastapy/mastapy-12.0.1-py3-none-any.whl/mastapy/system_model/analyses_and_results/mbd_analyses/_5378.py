...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5377, _5375, _5426
...
class GearSetMultibodyDynamicsAnalysis(_5426.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5377.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5375.GearMeshMultibodyDynamicsAnalysis]':
