...
class RingPinsCompoundMultibodyDynamicsAnalysis(_5543.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """RingPinsCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5414.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5414.RingPinsMultibodyDynamicsAnalysis]':
