...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5501.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5387.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5387.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
