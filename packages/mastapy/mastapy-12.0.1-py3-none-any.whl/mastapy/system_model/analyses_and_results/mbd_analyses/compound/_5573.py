...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5571, _5572, _5484
...
class StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis(_5484.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5435.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5571.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5572.StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5435.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
