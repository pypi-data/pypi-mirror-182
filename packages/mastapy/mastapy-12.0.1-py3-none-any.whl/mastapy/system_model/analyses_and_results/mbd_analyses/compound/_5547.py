...
class PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5504.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5405.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5405.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
