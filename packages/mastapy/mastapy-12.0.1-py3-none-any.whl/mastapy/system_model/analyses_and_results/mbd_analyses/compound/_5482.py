...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5470.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5333.BevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5333.BevelGearMultibodyDynamicsAnalysis]':
