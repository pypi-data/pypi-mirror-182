...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import (
    _5474, _5476, _5479, _5486,
    _5485, _5507, _5487, _5492,
    _5497, _5509, _5511, _5515,
    _5522, _5521, _5523, _5530,
    _5537, _5540, _5541, _5542,
    _5544, _5546, _5551, _5552,
    _5553, _5555, _5557, _5562,
...
class AssemblyCompoundMultibodyDynamicsAnalysis(_5466.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """AssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5322.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5474.BearingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5476.BeltDriveCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5479.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5486.BoltedJointCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5485.BoltCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5507.CVTCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5487.ClutchCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5492.ConceptCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5497.ConceptGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5509.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5511.CycloidalDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5515.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5522.FEPartCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5521.FaceGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5523.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5530.HypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5537.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5540.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5541.MassDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5542.MeasurementComponentCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5544.OilSealCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5546.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5551.PlanetCarrierCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5552.PointLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5553.PowerLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5555.RingPinsCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5557.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5562.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5561.ShaftCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5567.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5568.SpringDamperCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5573.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5576.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5579.SynchroniserCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5583.TorqueConverterCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5587.UnbalancedMassCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5591.WormGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5594.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5322.AssemblyMultibodyDynamicsAnalysis]':
