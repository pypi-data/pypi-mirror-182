...
class StraightBevelSunGearCompoundMultibodyDynamicsAnalysis(_5571.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5440.StraightBevelSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5440.StraightBevelSunGearMultibodyDynamicsAnalysis]':
