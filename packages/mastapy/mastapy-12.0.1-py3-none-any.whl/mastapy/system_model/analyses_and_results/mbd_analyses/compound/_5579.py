...
class SynchroniserCompoundMultibodyDynamicsAnalysis(_5564.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """SynchroniserCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5442.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5442.SynchroniserMultibodyDynamicsAnalysis]':
