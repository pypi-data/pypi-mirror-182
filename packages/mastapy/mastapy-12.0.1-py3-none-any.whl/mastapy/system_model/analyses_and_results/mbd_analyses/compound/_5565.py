...
class SpiralBevelGearCompoundMultibodyDynamicsAnalysis(_5482.BevelGearCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5428.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5428.SpiralBevelGearMultibodyDynamicsAnalysis]':
