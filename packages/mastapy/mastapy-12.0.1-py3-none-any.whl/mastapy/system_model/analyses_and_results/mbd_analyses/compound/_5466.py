...
class AbstractAssemblyCompoundMultibodyDynamicsAnalysis(_5545.PartCompoundMultibodyDynamicsAnalysis):
    """AbstractAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5314.AbstractAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5314.AbstractAssemblyMultibodyDynamicsAnalysis]':
