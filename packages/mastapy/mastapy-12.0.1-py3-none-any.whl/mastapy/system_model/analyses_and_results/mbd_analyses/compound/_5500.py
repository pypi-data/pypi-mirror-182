...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5526.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5351.ConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5351.ConicalGearSetMultibodyDynamicsAnalysis]':
