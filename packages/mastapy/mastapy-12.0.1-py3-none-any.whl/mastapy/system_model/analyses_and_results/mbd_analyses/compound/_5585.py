...
class TorqueConverterPumpCompoundMultibodyDynamicsAnalysis(_5505.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterPumpCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5448.TorqueConverterPumpMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5448.TorqueConverterPumpMultibodyDynamicsAnalysis]':
