...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5490.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5361.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5361.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
