...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5592, _5593, _5484
...
class ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis(_5484.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5459.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5592.ZerolBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5593.ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5459.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
