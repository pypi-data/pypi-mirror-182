...
class VirtualComponentCompoundMultibodyDynamicsAnalysis(_5543.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """VirtualComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5452.VirtualComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5452.VirtualComponentMultibodyDynamicsAnalysis]':
