...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5468
...
class FEPartCompoundMultibodyDynamicsAnalysis(_5468.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """FEPartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5373.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5373.FEPartMultibodyDynamicsAnalysis]':
