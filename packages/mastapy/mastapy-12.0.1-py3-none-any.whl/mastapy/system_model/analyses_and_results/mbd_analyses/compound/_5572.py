...
class StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis(_5483.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5433.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5433.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
