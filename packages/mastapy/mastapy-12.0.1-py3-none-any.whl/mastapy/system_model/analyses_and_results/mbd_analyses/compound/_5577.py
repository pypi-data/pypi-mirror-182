...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5571.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5439.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5439.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
