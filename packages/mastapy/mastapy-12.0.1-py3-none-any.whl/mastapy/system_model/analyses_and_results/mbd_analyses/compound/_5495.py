...
class ConceptGearCompoundMultibodyDynamicsAnalysis(_5524.GearCompoundMultibodyDynamicsAnalysis):
    """ConceptGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5347.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5347.ConceptGearMultibodyDynamicsAnalysis]':
