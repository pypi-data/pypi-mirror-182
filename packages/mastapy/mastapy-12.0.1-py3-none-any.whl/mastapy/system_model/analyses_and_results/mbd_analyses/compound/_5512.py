...
class CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis(_5469.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5363.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5363.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
