...
class OilSealCompoundMultibodyDynamicsAnalysis(_5502.ConnectorCompoundMultibodyDynamicsAnalysis):
    """OilSealCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5403.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5403.OilSealMultibodyDynamicsAnalysis]':
