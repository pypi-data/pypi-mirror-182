...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5466
...
class SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis(_5466.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5426.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5426.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
