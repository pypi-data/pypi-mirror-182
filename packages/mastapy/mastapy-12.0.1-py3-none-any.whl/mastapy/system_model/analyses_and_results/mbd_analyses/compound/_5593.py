...
class ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5483.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5457.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5457.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
