...
class SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5483.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5427.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5427.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
