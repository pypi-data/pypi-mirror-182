...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5482.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5437.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5437.StraightBevelGearMultibodyDynamicsAnalysis]':
