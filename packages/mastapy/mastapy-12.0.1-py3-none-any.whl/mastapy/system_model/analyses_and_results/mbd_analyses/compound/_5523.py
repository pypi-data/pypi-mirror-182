...
class FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis(_5564.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5374.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5374.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
