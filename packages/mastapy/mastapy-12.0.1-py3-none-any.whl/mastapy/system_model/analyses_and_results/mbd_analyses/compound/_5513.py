...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5524.GearCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5365.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5365.CylindricalGearMultibodyDynamicsAnalysis]':
