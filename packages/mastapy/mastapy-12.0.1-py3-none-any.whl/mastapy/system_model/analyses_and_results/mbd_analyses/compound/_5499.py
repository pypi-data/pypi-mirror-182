...
class ConicalGearMeshCompoundMultibodyDynamicsAnalysis(_5525.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConicalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5349.ConicalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5349.ConicalGearMeshMultibodyDynamicsAnalysis]':
