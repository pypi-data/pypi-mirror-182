...
class HypoidGearCompoundMultibodyDynamicsAnalysis(_5470.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """HypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5381.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5381.HypoidGearMultibodyDynamicsAnalysis]':
