...
class BevelDifferentialGearCompoundMultibodyDynamicsAnalysis(_5482.BevelGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5328.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5328.BevelDifferentialGearMultibodyDynamicsAnalysis]':
