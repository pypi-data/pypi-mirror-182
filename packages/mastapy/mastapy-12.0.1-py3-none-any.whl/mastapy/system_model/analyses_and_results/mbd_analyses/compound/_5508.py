...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5554.PulleyCompoundMultibodyDynamicsAnalysis):
    """CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5359.CVTPulleyMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5359.CVTPulleyMultibodyDynamicsAnalysis]':
