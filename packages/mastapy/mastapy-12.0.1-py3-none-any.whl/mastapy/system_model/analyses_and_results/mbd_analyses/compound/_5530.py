...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5528, _5529, _5472
...
class HypoidGearSetCompoundMultibodyDynamicsAnalysis(_5472.AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """HypoidGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5382.HypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5528.HypoidGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5529.HypoidGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5382.HypoidGearSetMultibodyDynamicsAnalysis]':
