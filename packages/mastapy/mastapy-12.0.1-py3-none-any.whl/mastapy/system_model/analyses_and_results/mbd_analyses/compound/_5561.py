...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5467
...
class ShaftCompoundMultibodyDynamicsAnalysis(_5467.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """ShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5423.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5423.ShaftMultibodyDynamicsAnalysis]':
