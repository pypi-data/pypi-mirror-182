...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5504.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5430.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5430.SpringDamperConnectionMultibodyDynamicsAnalysis]':
