...
class StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis(_5482.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5434.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5434.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
