...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5498.ConicalGearCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5319.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5319.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
