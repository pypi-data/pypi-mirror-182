...
class StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5483.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5436.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5436.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
