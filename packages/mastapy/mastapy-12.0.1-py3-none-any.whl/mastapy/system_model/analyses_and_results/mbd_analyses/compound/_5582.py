...
class SynchroniserSleeveCompoundMultibodyDynamicsAnalysis(_5581.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserSleeveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5444.SynchroniserSleeveMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5444.SynchroniserSleeveMultibodyDynamicsAnalysis]':
