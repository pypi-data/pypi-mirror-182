...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5574, _5575, _5484
...
class StraightBevelGearSetCompoundMultibodyDynamicsAnalysis(_5484.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5438.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5574.StraightBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5575.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5438.StraightBevelGearSetMultibodyDynamicsAnalysis]':
