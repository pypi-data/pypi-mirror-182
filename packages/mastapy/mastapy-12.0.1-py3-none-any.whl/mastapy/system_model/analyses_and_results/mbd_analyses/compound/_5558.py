...
class RollingRingCompoundMultibodyDynamicsAnalysis(_5505.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """RollingRingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5418.RollingRingMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5418.RollingRingMultibodyDynamicsAnalysis]':
