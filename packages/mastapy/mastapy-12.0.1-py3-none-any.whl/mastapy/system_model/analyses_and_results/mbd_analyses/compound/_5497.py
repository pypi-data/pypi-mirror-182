...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5495, _5496, _5526
...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(_5526.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConceptGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5348.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5495.ConceptGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5496.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5348.ConceptGearSetMultibodyDynamicsAnalysis]':
