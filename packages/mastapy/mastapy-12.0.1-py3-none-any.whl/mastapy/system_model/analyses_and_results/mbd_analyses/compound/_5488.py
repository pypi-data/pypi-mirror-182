...
class ClutchConnectionCompoundMultibodyDynamicsAnalysis(_5504.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """ClutchConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5337.ClutchConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5337.ClutchConnectionMultibodyDynamicsAnalysis]':
