...
class CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis(_5513.CylindricalGearCompoundMultibodyDynamicsAnalysis):
    """CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5367.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5367.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
