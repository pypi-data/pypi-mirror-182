...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5347, _5346, _5378
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5378.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5347.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_multibody_dynamics_analysis(self) -> 'List[_5347.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_multibody_dynamics_analysis(self) -> 'List[_5346.ConceptGearMeshMultibodyDynamicsAnalysis]':
