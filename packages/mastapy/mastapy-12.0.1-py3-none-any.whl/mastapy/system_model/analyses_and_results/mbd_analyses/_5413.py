...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5463
...
class PulleyMultibodyDynamicsAnalysis(_5355.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5463.DynamicTorqueResultAtTime]':
