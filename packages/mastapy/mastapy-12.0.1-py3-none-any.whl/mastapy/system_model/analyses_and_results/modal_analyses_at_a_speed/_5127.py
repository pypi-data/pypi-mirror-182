...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5126, _5125, _5124
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed(_5124.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5126.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5125.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
