...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5119, _5118, _5062
...
class HypoidGearSetModalAnalysisAtASpeed(_5062.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5119.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5118.HypoidGearMeshModalAnalysisAtASpeed]':
