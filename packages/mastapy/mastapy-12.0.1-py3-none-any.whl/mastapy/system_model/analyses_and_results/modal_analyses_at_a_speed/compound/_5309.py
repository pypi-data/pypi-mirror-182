...
class WormGearMeshCompoundModalAnalysisAtASpeed(_5244.GearMeshCompoundModalAnalysisAtASpeed):
    """WormGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5179.WormGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5179.WormGearMeshModalAnalysisAtASpeed]':
