...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_5300.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5169.SynchroniserHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5169.SynchroniserHalfModalAnalysisAtASpeed]':
