...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(_5209.CoaxialConnectionCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5100.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5100.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
