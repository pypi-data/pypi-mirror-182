...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5186
...
class ShaftCompoundModalAnalysisAtASpeed(_5186.AbstractShaftCompoundModalAnalysisAtASpeed):
    """ShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5152.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5152.ShaftModalAnalysisAtASpeed]':
