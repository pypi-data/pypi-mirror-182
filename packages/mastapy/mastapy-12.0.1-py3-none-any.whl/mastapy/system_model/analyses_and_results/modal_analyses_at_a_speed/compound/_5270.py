...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_5262.MountableComponentCompoundModalAnalysisAtASpeed):
    """PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5141.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5141.PlanetCarrierModalAnalysisAtASpeed]':
