...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5290, _5291, _5203
...
class StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed(_5203.BevelGearSetCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5163.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5290.StraightBevelDiffGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5291.StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5163.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
