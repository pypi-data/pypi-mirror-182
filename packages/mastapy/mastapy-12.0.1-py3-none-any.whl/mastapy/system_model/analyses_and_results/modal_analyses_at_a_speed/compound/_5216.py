...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5214, _5215, _5245
...
class ConceptGearSetCompoundModalAnalysisAtASpeed(_5245.GearSetCompoundModalAnalysisAtASpeed):
    """ConceptGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5087.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5214.ConceptGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5215.ConceptGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5087.ConceptGearSetModalAnalysisAtASpeed]':
