...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed(_5251.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5126.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5126.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
