...
class ConnectorCompoundModalAnalysisAtASpeed(_5262.MountableComponentCompoundModalAnalysisAtASpeed):
    """ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5092.ConnectorModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5092.ConnectorModalAnalysisAtASpeed]':
