...
class AbstractShaftCompoundModalAnalysisAtASpeed(_5187.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5057.AbstractShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5057.AbstractShaftModalAnalysisAtASpeed]':
