...
class HypoidGearCompoundModalAnalysisAtASpeed(_5189.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    """HypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5119.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5119.HypoidGearModalAnalysisAtASpeed]':
