...
class BeltConnectionCompoundModalAnalysisAtASpeed(_5250.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """BeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5065.BeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5065.BeltConnectionModalAnalysisAtASpeed]':
