...
class ClutchCompoundModalAnalysisAtASpeed(_5222.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5079.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5079.ClutchModalAnalysisAtASpeed]':
