...
class BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed(_5202.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5067.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5067.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
