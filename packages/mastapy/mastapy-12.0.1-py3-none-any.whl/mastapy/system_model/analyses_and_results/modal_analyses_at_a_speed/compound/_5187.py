...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_5210.ComponentCompoundModalAnalysisAtASpeed):
    """AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5058.AbstractShaftOrHousingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5058.AbstractShaftOrHousingModalAnalysisAtASpeed]':
