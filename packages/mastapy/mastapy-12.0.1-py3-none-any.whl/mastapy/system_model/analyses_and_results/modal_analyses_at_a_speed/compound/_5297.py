...
class StraightBevelSunGearCompoundModalAnalysisAtASpeed(_5290.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5168.StraightBevelSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5168.StraightBevelSunGearModalAnalysisAtASpeed]':
