...
class SynchroniserPartCompoundModalAnalysisAtASpeed(_5224.CouplingHalfCompoundModalAnalysisAtASpeed):
    """SynchroniserPartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5171.SynchroniserPartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5171.SynchroniserPartModalAnalysisAtASpeed]':
