...
class OilSealCompoundModalAnalysisAtASpeed(_5221.ConnectorCompoundModalAnalysisAtASpeed):
    """OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5134.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5134.OilSealModalAnalysisAtASpeed]':
