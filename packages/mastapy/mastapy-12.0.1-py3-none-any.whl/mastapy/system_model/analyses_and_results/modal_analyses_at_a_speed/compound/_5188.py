...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5220.ConnectionCompoundModalAnalysisAtASpeed):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5059.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5059.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
