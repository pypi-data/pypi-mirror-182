...
class FaceGearCompoundModalAnalysisAtASpeed(_5243.GearCompoundModalAnalysisAtASpeed):
    """FaceGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5110.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5110.FaceGearModalAnalysisAtASpeed]':
