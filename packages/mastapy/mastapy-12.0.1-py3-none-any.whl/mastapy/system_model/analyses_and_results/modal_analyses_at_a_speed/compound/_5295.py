...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5293, _5294, _5203
...
class StraightBevelGearSetCompoundModalAnalysisAtASpeed(_5203.BevelGearSetCompoundModalAnalysisAtASpeed):
    """StraightBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5166.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5293.StraightBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5294.StraightBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5166.StraightBevelGearSetModalAnalysisAtASpeed]':
