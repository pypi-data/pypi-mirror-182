...
class ConceptGearCompoundModalAnalysisAtASpeed(_5243.GearCompoundModalAnalysisAtASpeed):
    """ConceptGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5086.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5086.ConceptGearModalAnalysisAtASpeed]':
