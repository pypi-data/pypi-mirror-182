...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5201.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5162.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5162.StraightBevelDiffGearModalAnalysisAtASpeed]':
