...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(_5194.BeltConnectionCompoundModalAnalysisAtASpeed):
    """CVTBeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5096.CVTBeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5096.CVTBeltConnectionModalAnalysisAtASpeed]':
