...
class BevelGearCompoundModalAnalysisAtASpeed(_5189.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    """BevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5073.BevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5073.BevelGearModalAnalysisAtASpeed]':
