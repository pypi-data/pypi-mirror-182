...
class ClutchHalfCompoundModalAnalysisAtASpeed(_5224.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5078.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5078.ClutchHalfModalAnalysisAtASpeed]':
