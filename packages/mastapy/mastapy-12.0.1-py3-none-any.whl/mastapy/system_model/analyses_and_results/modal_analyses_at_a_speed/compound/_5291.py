...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5202
...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed(_5202.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5161.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5161.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
