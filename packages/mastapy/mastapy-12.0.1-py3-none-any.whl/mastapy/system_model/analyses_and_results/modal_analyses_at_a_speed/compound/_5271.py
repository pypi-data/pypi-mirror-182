...
class PointLoadCompoundModalAnalysisAtASpeed(_5307.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PointLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5142.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5142.PointLoadModalAnalysisAtASpeed]':
