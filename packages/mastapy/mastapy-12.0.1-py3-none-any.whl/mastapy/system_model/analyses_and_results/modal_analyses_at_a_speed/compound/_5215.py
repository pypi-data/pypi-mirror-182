...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5244.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5085.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5085.ConceptGearMeshModalAnalysisAtASpeed]':
