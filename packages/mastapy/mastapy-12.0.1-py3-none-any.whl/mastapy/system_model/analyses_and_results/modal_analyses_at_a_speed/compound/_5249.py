...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5247, _5248, _5191
...
class HypoidGearSetCompoundModalAnalysisAtASpeed(_5191.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """HypoidGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5120.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5247.HypoidGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5248.HypoidGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5120.HypoidGearSetModalAnalysisAtASpeed]':
