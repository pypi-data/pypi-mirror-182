...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(_5223.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5136.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5136.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
