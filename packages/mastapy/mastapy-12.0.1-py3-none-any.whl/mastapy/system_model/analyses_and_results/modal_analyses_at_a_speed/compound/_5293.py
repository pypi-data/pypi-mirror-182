...
class StraightBevelGearCompoundModalAnalysisAtASpeed(_5201.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5165.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5165.StraightBevelGearModalAnalysisAtASpeed]':
