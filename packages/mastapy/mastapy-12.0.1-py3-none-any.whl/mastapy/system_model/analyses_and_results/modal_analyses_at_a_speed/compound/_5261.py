...
class MeasurementComponentCompoundModalAnalysisAtASpeed(_5307.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MeasurementComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5132.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5132.MeasurementComponentModalAnalysisAtASpeed]':
