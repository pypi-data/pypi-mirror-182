...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed(_5188.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5102.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5102.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed]':
