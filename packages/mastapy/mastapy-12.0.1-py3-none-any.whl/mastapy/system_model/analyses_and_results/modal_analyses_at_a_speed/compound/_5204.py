...
class BoltCompoundModalAnalysisAtASpeed(_5210.ComponentCompoundModalAnalysisAtASpeed):
    """BoltCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5076.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5076.BoltModalAnalysisAtASpeed]':
