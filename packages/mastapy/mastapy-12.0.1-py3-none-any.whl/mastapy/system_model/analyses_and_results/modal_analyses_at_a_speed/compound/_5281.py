...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(_5221.ConnectorCompoundModalAnalysisAtASpeed):
    """ShaftHubConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5151.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5151.ShaftHubConnectionModalAnalysisAtASpeed]':
