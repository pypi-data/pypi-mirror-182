...
class WormGearCompoundModalAnalysisAtASpeed(_5243.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5180.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5180.WormGearModalAnalysisAtASpeed]':
