...
class SpringDamperCompoundModalAnalysisAtASpeed(_5222.CouplingCompoundModalAnalysisAtASpeed):
    """SpringDamperCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5160.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5160.SpringDamperModalAnalysisAtASpeed]':
