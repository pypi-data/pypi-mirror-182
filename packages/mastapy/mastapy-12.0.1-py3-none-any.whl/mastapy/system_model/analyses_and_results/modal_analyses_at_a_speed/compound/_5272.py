...
class PowerLoadCompoundModalAnalysisAtASpeed(_5307.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PowerLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5143.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5143.PowerLoadModalAnalysisAtASpeed]':
