...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import (
    _5064, _5066, _5069, _5075,
    _5076, _5097, _5079, _5084,
    _5087, _5099, _5101, _5105,
    _5112, _5111, _5113, _5120,
    _5127, _5130, _5131, _5132,
    _5134, _5138, _5141, _5142,
    _5143, _5145, _5147, _5151,
    _5152, _5157, _5160, _5163,
    _5166, _5170, _5174, _5177,
    _5181, _5184, _5056
)
...
class AssemblyModalAnalysisAtASpeed(_5056.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_5064.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5066.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5069.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5075.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5076.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5097.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5079.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5084.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5087.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5099.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5101.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5105.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5112.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5111.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5113.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5120.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5127.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5130.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5131.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5132.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5134.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5138.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5141.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5142.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5143.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5145.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5147.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5151.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5152.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5157.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5160.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5163.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5166.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5170.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5174.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5177.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5181.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5184.ZerolBevelGearSetModalAnalysisAtASpeed]':
