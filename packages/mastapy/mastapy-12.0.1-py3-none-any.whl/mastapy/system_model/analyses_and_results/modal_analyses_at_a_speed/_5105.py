...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5104, _5103, _5116
...
class CylindricalGearSetModalAnalysisAtASpeed(_5116.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_5104.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_5103.CylindricalGearMeshModalAnalysisAtASpeed]':
