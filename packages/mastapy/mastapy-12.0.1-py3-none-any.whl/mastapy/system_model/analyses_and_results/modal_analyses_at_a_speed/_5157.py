...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5156, _5155, _5074
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_5074.BevelGearSetModalAnalysisAtASpeed):
    """SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5156.SpiralBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5155.SpiralBevelGearMeshModalAnalysisAtASpeed]':
