...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5068, _5067, _5074
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5074.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5068.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5067.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
