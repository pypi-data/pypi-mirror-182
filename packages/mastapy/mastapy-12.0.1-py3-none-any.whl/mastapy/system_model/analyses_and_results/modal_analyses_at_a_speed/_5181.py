...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5180, _5179, _5116
...
class WormGearSetModalAnalysisAtASpeed(_5116.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_5180.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_5179.WormGearMeshModalAnalysisAtASpeed]':
