...
from mastapy.system_model.analyses_and_results.modal_analyses import _4545, _4544, _4579
...
class ConceptGearSetModalAnalysis(_4579.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4545.ConceptGearModalAnalysis]':
    ...
    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4544.ConceptGearMeshModalAnalysis]':
