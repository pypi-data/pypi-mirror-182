...
class PerModeResultsReport(_1722.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1784.TableAndChartOptions':
    ...
    def display_option(self, value: '_1784.TableAndChartOptions'):
