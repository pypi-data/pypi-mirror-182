...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4663, _4659
...
class SingleModeResults(_4659.DesignEntityModalAnalysisGroupResults):
    """SingleModeResults
    ...
    @property
    def all_rigidly_connected_groups(self) -> 'List[_4663.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_energy(self) -> 'List[_4663.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_kinetic_energy(self) -> 'List[_4663.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_strain_energy(self) -> 'List[_4663.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]':
