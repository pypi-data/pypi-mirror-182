...
from mastapy.system_model.analyses_and_results.modal_analyses import _2587, _4522
...
class RootAssemblyModalAnalysis(_4522.AssemblyModalAnalysis):
    """RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2587.ModalAnalysis':
