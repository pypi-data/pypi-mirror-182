...
from mastapy.system_model.analyses_and_results.modal_analyses import _2587
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2590
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4666, _4664, _4667
...
class PartModalAnalysis(_7473.PartStaticLoadAnalysisCase):
    """PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_2587.ModalAnalysis':
        ...
        if _2587.ModalAnalysis.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def excited_modes_summary(self) -> 'List[_4666.SingleExcitationResultsModalAnalysis]':
    ...
    @property
    def gear_mesh_excitation_details(self) -> 'List[_4664.RigidlyConnectedDesignEntityGroupModalAnalysis]':
    ...
    @property
    def results_for_modes(self) -> 'List[_4667.SingleModeResults]':
    ...
    @property
    def shaft_excitation_details(self) -> 'List[_4664.RigidlyConnectedDesignEntityGroupModalAnalysis]':
    ...
    def create_viewable(self) -> '_2203.ModalAnalysisViewable':
