...
from mastapy.system_model.analyses_and_results.modal_analyses import _4654, _4653, _4533
...
class ZerolBevelGearSetModalAnalysis(_4533.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4654.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4653.ZerolBevelGearMeshModalAnalysis]':
