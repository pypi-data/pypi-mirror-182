...
class FlexiblePinAssemblyCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4575.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4575.FlexiblePinAssemblyModalAnalysis]':
