...
class FaceGearMeshCompoundModalAnalysis(_4727.GearMeshCompoundModalAnalysis):
    """FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4571.FaceGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4571.FaceGearMeshModalAnalysis]':
