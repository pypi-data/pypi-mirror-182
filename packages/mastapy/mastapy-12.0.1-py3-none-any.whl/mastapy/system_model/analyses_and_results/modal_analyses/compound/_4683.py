...
class BevelDifferentialSunGearCompoundModalAnalysis(_4679.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4530.BevelDifferentialSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4530.BevelDifferentialSunGearModalAnalysis]':
