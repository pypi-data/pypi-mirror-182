...
class ConceptCouplingHalfCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4542.ConceptCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4542.ConceptCouplingHalfModalAnalysis]':
