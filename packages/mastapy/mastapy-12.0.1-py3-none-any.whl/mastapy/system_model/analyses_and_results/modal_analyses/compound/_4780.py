...
class StraightBevelSunGearCompoundModalAnalysis(_4773.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4636.StraightBevelSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4636.StraightBevelSunGearModalAnalysis]':
