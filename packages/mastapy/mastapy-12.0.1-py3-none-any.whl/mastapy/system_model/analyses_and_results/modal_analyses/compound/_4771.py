...
class SpringDamperConnectionCompoundModalAnalysis(_4706.CouplingConnectionCompoundModalAnalysis):
    """SpringDamperConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4626.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4626.SpringDamperConnectionModalAnalysis]':
