...
class AbstractShaftCompoundModalAnalysis(_4670.AbstractShaftOrHousingCompoundModalAnalysis):
    """AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4516.AbstractShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4516.AbstractShaftModalAnalysis]':
