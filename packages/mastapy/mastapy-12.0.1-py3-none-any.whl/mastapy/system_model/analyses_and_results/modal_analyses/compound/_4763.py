...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4669
...
class ShaftCompoundModalAnalysis(_4669.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4619.ShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4619.ShaftModalAnalysis]':
