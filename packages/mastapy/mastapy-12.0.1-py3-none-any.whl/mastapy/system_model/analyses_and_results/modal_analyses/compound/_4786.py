...
class TorqueConverterConnectionCompoundModalAnalysis(_4706.CouplingConnectionCompoundModalAnalysis):
    """TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4641.TorqueConverterConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4641.TorqueConverterConnectionModalAnalysis]':
