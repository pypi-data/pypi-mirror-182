...
class StraightBevelGearCompoundModalAnalysis(_4684.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4633.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4633.StraightBevelGearModalAnalysis]':
