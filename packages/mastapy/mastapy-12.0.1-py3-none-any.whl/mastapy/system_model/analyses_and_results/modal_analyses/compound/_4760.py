...
class RollingRingCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4616.RollingRingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4616.RollingRingModalAnalysis]':
