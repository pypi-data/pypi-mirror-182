...
class CouplingCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4555.CouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4555.CouplingModalAnalysis]':
