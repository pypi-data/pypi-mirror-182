...
class ClutchConnectionCompoundModalAnalysis(_4706.CouplingConnectionCompoundModalAnalysis):
    """ClutchConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4536.ClutchConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4536.ClutchConnectionModalAnalysis]':
