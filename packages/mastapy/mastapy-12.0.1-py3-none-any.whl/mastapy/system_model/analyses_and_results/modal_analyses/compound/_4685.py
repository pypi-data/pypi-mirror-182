...
class BevelGearMeshCompoundModalAnalysis(_4673.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """BevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4531.BevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4531.BevelGearMeshModalAnalysis]':
