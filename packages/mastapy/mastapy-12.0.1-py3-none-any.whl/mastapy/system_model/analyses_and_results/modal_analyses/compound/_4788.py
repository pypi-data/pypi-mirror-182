...
class TorqueConverterTurbineCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4644.TorqueConverterTurbineModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4644.TorqueConverterTurbineModalAnalysis]':
