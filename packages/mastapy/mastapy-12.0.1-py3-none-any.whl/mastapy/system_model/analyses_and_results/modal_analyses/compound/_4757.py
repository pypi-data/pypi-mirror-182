...
class RingPinsCompoundModalAnalysis(_4745.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4612.RingPinsModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4612.RingPinsModalAnalysis]':
