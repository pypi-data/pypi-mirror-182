...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4697, _4698, _4728
...
class ConceptGearSetCompoundModalAnalysis(_4728.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4546.ConceptGearSetModalAnalysis]':
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4697.ConceptGearCompoundModalAnalysis]':
    ...
    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4698.ConceptGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4546.ConceptGearSetModalAnalysis]':
