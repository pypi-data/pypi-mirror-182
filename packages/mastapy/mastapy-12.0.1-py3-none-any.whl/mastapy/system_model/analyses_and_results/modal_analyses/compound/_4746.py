...
class OilSealCompoundModalAnalysis(_4704.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4600.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4600.OilSealModalAnalysis]':
