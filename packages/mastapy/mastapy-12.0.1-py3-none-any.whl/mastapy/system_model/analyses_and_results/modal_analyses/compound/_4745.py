...
class MountableComponentCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4599.MountableComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4599.MountableComponentModalAnalysis]':
