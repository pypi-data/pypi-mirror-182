...
class VirtualComponentCompoundModalAnalysis(_4745.MountableComponentCompoundModalAnalysis):
    """VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4646.VirtualComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4646.VirtualComponentModalAnalysis]':
