...
class PlanetaryConnectionCompoundModalAnalysis(_4765.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4606.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4606.PlanetaryConnectionModalAnalysis]':
