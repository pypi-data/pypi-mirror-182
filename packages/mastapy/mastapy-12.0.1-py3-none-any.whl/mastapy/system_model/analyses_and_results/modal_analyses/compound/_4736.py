...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_4702.ConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4587.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4587.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
