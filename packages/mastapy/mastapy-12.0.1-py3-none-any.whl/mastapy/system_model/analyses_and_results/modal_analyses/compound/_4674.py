...
class AGMAGleasonConicalGearSetCompoundModalAnalysis(_4702.ConicalGearSetCompoundModalAnalysis):
    """AGMAGleasonConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4521.AGMAGleasonConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4521.AGMAGleasonConicalGearSetModalAnalysis]':
