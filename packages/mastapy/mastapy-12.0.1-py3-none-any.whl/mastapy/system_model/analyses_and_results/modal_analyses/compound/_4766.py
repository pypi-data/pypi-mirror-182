...
class SpecialisedAssemblyCompoundModalAnalysis(_4668.AbstractAssemblyCompoundModalAnalysis):
    """SpecialisedAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4622.SpecialisedAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4622.SpecialisedAssemblyModalAnalysis]':
