...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4737, _4738, _4736
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4736.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4590.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4737.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4738.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4590.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
