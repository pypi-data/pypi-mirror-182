...
class SpringDamperHalfCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4627.SpringDamperHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4627.SpringDamperHalfModalAnalysis]':
