...
class ZerolBevelGearCompoundModalAnalysis(_4684.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4654.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4654.ZerolBevelGearModalAnalysis]':
