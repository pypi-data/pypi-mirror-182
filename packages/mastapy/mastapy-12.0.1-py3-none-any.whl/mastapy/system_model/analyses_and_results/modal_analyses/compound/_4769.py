...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4767, _4768, _4686
...
class SpiralBevelGearSetCompoundModalAnalysis(_4686.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4625.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4767.SpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4768.SpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4625.SpiralBevelGearSetModalAnalysis]':
