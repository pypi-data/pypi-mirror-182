...
class PlanetCarrierCompoundModalAnalysis(_4745.MountableComponentCompoundModalAnalysis):
    """PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4608.PlanetCarrierModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4608.PlanetCarrierModalAnalysis]':
