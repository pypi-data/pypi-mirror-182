...
class CVTBeltConnectionCompoundModalAnalysis(_4677.BeltConnectionCompoundModalAnalysis):
    """CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4556.CVTBeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4556.CVTBeltConnectionModalAnalysis]':
