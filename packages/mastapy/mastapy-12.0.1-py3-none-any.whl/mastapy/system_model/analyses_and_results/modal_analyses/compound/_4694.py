...
class ConceptCouplingCompoundModalAnalysis(_4705.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4543.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4543.ConceptCouplingModalAnalysis]':
