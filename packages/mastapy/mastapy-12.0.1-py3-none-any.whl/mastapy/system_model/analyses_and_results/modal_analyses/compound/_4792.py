...
class WormGearMeshCompoundModalAnalysis(_4727.GearMeshCompoundModalAnalysis):
    """WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4650.WormGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4650.WormGearMeshModalAnalysis]':
