...
class WormGearCompoundModalAnalysis(_4726.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4651.WormGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4651.WormGearModalAnalysis]':
