...
class CylindricalPlanetGearCompoundModalAnalysis(_4715.CylindricalGearCompoundModalAnalysis):
    """CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4566.CylindricalPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4566.CylindricalPlanetGearModalAnalysis]':
