...
class BeltConnectionCompoundModalAnalysis(_4733.InterMountableComponentConnectionCompoundModalAnalysis):
    """BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4524.BeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4524.BeltConnectionModalAnalysis]':
