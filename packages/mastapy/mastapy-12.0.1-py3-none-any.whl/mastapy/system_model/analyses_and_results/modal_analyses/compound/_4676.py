...
class BearingCompoundModalAnalysis(_4704.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4523.BearingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4523.BearingModalAnalysis]':
