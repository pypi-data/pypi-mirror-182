...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import (
    _4676, _4678, _4681, _4688,
    _4687, _4709, _4689, _4694,
    _4699, _4711, _4713, _4717,
    _4724, _4723, _4725, _4732,
    _4739, _4742, _4743, _4744,
    _4746, _4748, _4753, _4754,
    _4755, _4757, _4759, _4764,
    _4763, _4769, _4770, _4775,
    _4778, _4781, _4785, _4789,
    _4793, _4796, _4668
)
...
class AssemblyCompoundModalAnalysis(_4668.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4522.AssemblyModalAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_4676.BearingCompoundModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4678.BeltDriveCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4681.BevelDifferentialGearSetCompoundModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4688.BoltedJointCompoundModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4687.BoltCompoundModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4709.CVTCompoundModalAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_4689.ClutchCompoundModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4694.ConceptCouplingCompoundModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4699.ConceptGearSetCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4711.CycloidalAssemblyCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4713.CycloidalDiscCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4717.CylindricalGearSetCompoundModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4724.FEPartCompoundModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4723.FaceGearSetCompoundModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4725.FlexiblePinAssemblyCompoundModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4732.HypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4739.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4742.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4743.MassDiscCompoundModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4744.MeasurementComponentCompoundModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4746.OilSealCompoundModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4748.PartToPartShearCouplingCompoundModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4753.PlanetCarrierCompoundModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4754.PointLoadCompoundModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4755.PowerLoadCompoundModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4757.RingPinsCompoundModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4759.RollingRingAssemblyCompoundModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4764.ShaftHubConnectionCompoundModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4763.ShaftCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4769.SpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4770.SpringDamperCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4775.StraightBevelDiffGearSetCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4778.StraightBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4781.SynchroniserCompoundModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4785.TorqueConverterCompoundModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4789.UnbalancedMassCompoundModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4793.WormGearSetCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4796.ZerolBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4522.AssemblyModalAnalysis]':
