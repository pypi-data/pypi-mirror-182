...
class RingPinsToDiscConnectionCompoundModalAnalysis(_4733.InterMountableComponentConnectionCompoundModalAnalysis):
    """RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4613.RingPinsToDiscConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4613.RingPinsToDiscConnectionModalAnalysis]':
