...
class StraightBevelDiffGearMeshCompoundModalAnalysis(_4685.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelDiffGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4629.StraightBevelDiffGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4629.StraightBevelDiffGearMeshModalAnalysis]':
