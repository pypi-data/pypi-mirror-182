...
class SynchroniserSleeveCompoundModalAnalysis(_4783.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4640.SynchroniserSleeveModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4640.SynchroniserSleeveModalAnalysis]':
