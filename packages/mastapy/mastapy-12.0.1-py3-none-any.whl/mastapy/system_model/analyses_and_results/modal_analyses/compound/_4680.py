...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4685
...
class BevelDifferentialGearMeshCompoundModalAnalysis(_4685.BevelGearMeshCompoundModalAnalysis):
    """BevelDifferentialGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4526.BevelDifferentialGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4526.BevelDifferentialGearMeshModalAnalysis]':
