...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_4701.ConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4585.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4585.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
