...
class PulleyCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4611.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4611.PulleyModalAnalysis]':
