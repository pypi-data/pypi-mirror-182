...
class SynchroniserCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4638.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4638.SynchroniserModalAnalysis]':
