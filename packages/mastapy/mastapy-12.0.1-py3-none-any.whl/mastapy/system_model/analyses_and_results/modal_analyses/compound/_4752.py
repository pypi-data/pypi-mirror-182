...
class PlanetaryGearSetCompoundModalAnalysis(_4717.CylindricalGearSetCompoundModalAnalysis):
    """PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4607.PlanetaryGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4607.PlanetaryGearSetModalAnalysis]':
