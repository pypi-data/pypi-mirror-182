...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis(_4735.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4591.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4591.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
