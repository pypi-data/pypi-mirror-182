...
class StraightBevelPlanetGearCompoundModalAnalysis(_4773.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4635.StraightBevelPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4635.StraightBevelPlanetGearModalAnalysis]':
