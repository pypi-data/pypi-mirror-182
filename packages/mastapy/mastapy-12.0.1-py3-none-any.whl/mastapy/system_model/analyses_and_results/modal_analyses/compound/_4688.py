...
class BoltedJointCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4534.BoltedJointModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4534.BoltedJointModalAnalysis]':
