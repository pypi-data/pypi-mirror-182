...
class GearMeshCompoundModalAnalysis(_4733.InterMountableComponentConnectionCompoundModalAnalysis):
    """GearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4577.GearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4577.GearMeshModalAnalysis]':
