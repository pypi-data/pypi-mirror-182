...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4700
...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis(_4700.ConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4586.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4586.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
