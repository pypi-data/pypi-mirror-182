...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4679, _4680, _4686
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4686.BevelGearSetCompoundModalAnalysis):
    """BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4528.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4679.BevelDifferentialGearCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4680.BevelDifferentialGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4528.BevelDifferentialGearSetModalAnalysis]':
