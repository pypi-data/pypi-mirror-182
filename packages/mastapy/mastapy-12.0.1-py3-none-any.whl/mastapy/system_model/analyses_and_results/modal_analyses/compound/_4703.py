...
class ConnectionCompoundModalAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4550.ConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4550.ConnectionModalAnalysis]':
