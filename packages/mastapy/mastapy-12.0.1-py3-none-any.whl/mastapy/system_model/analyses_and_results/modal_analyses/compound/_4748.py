...
class PartToPartShearCouplingCompoundModalAnalysis(_4705.CouplingCompoundModalAnalysis):
    """PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4605.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4605.PartToPartShearCouplingModalAnalysis]':
