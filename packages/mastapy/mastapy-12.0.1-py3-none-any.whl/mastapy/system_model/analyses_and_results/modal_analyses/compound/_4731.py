...
class HypoidGearMeshCompoundModalAnalysis(_4673.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """HypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4581.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4581.HypoidGearMeshModalAnalysis]':
