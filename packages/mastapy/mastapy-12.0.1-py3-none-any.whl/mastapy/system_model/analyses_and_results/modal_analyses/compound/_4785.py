...
class TorqueConverterCompoundModalAnalysis(_4705.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4642.TorqueConverterModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4642.TorqueConverterModalAnalysis]':
