...
class AGMAGleasonConicalGearCompoundModalAnalysis(_4700.ConicalGearCompoundModalAnalysis):
    """AGMAGleasonConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4520.AGMAGleasonConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4520.AGMAGleasonConicalGearModalAnalysis]':
