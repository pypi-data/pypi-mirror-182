...
class PartToPartShearCouplingHalfCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """PartToPartShearCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4604.PartToPartShearCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4604.PartToPartShearCouplingHalfModalAnalysis]':
