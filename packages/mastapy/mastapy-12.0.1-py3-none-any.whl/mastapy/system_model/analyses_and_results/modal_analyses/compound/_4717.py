...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4715, _4716, _4728
...
class CylindricalGearSetCompoundModalAnalysis(_4728.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4565.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_4715.CylindricalGearCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_4716.CylindricalGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4565.CylindricalGearSetModalAnalysis]':
