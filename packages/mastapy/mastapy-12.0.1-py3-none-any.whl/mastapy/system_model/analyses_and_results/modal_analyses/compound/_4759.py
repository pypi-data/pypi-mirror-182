...
class RollingRingAssemblyCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4614.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4614.RollingRingAssemblyModalAnalysis]':
