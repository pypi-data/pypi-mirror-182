...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4670
...
class FEPartCompoundModalAnalysis(_4670.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4574.FEPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4574.FEPartModalAnalysis]':
