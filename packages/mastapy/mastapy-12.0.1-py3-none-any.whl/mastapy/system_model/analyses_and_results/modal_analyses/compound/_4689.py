...
class ClutchCompoundModalAnalysis(_4705.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4538.ClutchModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4538.ClutchModalAnalysis]':
