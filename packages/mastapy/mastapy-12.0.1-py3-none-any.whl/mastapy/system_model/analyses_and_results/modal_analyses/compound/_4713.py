...
class CycloidalDiscCompoundModalAnalysis(_4669.AbstractShaftCompoundModalAnalysis):
    """CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4561.CycloidalDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4561.CycloidalDiscModalAnalysis]':
