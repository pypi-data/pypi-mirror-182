...
class AbstractAssemblyCompoundModalAnalysis(_4747.PartCompoundModalAnalysis):
    """AbstractAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4515.AbstractAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4515.AbstractAssemblyModalAnalysis]':
