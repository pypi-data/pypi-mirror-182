...
class AbstractShaftOrHousingCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """AbstractShaftOrHousingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4517.AbstractShaftOrHousingModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4517.AbstractShaftOrHousingModalAnalysis]':
