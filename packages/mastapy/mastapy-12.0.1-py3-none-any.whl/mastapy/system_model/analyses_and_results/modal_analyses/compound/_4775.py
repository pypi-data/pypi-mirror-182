...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4773, _4774, _4686
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_4686.BevelGearSetCompoundModalAnalysis):
    """StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4631.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_4773.StraightBevelDiffGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_4774.StraightBevelDiffGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4631.StraightBevelDiffGearSetModalAnalysis]':
