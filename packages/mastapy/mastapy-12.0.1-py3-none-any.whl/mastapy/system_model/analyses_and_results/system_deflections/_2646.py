...
class BeltConnectionSystemDeflection(_2714.InterMountableComponentConnectionSystemDeflection):
    """BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3986.BeltConnectionPowerFlow':
        ...
        if _3986.BeltConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
