...
from mastapy.system_model.analyses_and_results.system_deflections import _2743, _2714
...
class RingPinsToDiscConnectionSystemDeflection(_2714.InterMountableComponentConnectionSystemDeflection):
    """RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6871.RingPinsToDiscConnectionLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4070.RingPinsToDiscConnectionPowerFlow':
    ...
    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2743.RingPinToDiscContactReporting]':
