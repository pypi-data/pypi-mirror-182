...
from mastapy.system_model.analyses_and_results.system_deflections import _2762, _2760, _2654
...
class StraightBevelDiffGearSetSystemDeflection(_2654.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4087.StraightBevelDiffGearSetPowerFlow':
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2762.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2760.StraightBevelDiffGearMeshSystemDeflection]':
