...
from mastapy.system_model.analyses_and_results.system_deflections import _2756, _2754, _2654
...
class SpiralBevelGearSetSystemDeflection(_2654.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4081.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2756.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2754.SpiralBevelGearMeshSystemDeflection]':
