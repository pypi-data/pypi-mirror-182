...
from mastapy.system_model.analyses_and_results.system_deflections import _2658, _2678
...
class ClutchSystemDeflection(_2678.CouplingSystemDeflection):
    """ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4000.ClutchPowerFlow':
