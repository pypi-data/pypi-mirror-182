...
class VirtualComponentSystemDeflection(_2729.MountableComponentSystemDeflection):
    """VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4103.VirtualComponentPowerFlow':
