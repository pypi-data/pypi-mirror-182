...
from mastapy.system_model.analyses_and_results.system_deflections import _2650, _2648, _2654
...
class BevelDifferentialGearSetSystemDeflection(_2654.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3990.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2650.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2648.BevelDifferentialGearMeshSystemDeflection]':
