...
class ConceptCouplingConnectionSystemDeflection(_2676.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4003.ConceptCouplingConnectionPowerFlow':
