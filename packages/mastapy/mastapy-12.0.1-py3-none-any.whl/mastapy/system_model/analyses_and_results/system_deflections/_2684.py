...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2640.AbstractShaftToMountableComponentConnectionSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4022.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
