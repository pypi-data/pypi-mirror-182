...
class ConnectorCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2675.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2675.ConnectorSystemDeflection]':
