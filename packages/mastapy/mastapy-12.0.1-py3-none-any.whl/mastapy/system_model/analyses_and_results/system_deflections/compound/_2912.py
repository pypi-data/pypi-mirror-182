...
class StraightBevelSunGearCompoundSystemDeflection(_2905.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2767.StraightBevelSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2767.StraightBevelSunGearSystemDeflection]':
