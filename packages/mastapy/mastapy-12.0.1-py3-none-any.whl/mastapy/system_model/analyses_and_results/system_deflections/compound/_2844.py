...
class CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection(_2801.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2684.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2684.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
