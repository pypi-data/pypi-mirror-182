...
class BevelGearCompoundSystemDeflection(_2802.AGMAGleasonConicalGearCompoundSystemDeflection):
    """BevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2655.BevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2655.BevelGearSystemDeflection]':
