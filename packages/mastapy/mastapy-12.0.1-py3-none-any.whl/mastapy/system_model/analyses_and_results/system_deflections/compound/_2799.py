...
class AbstractShaftCompoundSystemDeflection(_2800.AbstractShaftOrHousingCompoundSystemDeflection):
    """AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2639.AbstractShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2639.AbstractShaftSystemDeflection]':
