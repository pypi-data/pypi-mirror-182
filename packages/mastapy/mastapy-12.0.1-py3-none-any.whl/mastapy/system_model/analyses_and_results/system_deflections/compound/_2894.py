...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2895, _2799
...
class ShaftCompoundSystemDeflection(_2799.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2895.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2751.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2751.ShaftSystemDeflection]':
