...
class AbstractShaftOrHousingCompoundSystemDeflection(_2823.ComponentCompoundSystemDeflection):
    """AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2638.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2638.AbstractShaftOrHousingSystemDeflection]':
