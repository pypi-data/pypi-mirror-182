...
class RollingRingAssemblyCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """RollingRingAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2744.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2744.RollingRingAssemblySystemDeflection]':
