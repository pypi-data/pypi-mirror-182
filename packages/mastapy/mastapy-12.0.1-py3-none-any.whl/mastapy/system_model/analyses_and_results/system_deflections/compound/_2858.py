...
class GearMeshCompoundSystemDeflection(_2864.InterMountableComponentConnectionCompoundSystemDeflection):
    """GearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2706.GearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2706.GearMeshSystemDeflection]':
