...
class BoltCompoundSystemDeflection(_2823.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2657.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2657.BoltSystemDeflection]':
