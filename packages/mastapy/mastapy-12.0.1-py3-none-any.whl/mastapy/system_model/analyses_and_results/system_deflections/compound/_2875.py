...
class MeasurementComponentCompoundSystemDeflection(_2922.VirtualComponentCompoundSystemDeflection):
    """MeasurementComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2727.MeasurementComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2727.MeasurementComponentSystemDeflection]':
