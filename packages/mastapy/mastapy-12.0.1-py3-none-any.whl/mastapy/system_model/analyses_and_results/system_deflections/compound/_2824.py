...
class ConceptCouplingCompoundSystemDeflection(_2835.CouplingCompoundSystemDeflection):
    """ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2666.ConceptCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2666.ConceptCouplingSystemDeflection]':
