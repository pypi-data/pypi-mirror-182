...
class ConceptGearCompoundSystemDeflection(_2857.GearCompoundSystemDeflection):
    """ConceptGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2669.ConceptGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2669.ConceptGearSystemDeflection]':
