...
class TorqueConverterTurbineCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2778.TorqueConverterTurbineSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2778.TorqueConverterTurbineSystemDeflection]':
