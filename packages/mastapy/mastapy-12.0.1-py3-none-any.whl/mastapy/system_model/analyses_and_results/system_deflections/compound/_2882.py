...
class PlanetaryConnectionCompoundSystemDeflection(_2897.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2736.PlanetaryConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2736.PlanetaryConnectionSystemDeflection]':
