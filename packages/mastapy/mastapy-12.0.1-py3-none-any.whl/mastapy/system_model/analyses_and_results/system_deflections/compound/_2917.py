...
class TorqueConverterCompoundSystemDeflection(_2835.CouplingCompoundSystemDeflection):
    """TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2777.TorqueConverterSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2777.TorqueConverterSystemDeflection]':
