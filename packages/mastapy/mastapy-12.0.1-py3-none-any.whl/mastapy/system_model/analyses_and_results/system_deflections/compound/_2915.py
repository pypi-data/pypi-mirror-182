...
class SynchroniserPartCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.SynchroniserPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.SynchroniserPartSystemDeflection]':
