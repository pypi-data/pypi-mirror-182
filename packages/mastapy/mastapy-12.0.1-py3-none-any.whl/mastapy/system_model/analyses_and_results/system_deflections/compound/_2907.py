...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2905, _2906, _2816
...
class StraightBevelDiffGearSetCompoundSystemDeflection(_2816.BevelGearSetCompoundSystemDeflection):
    """StraightBevelDiffGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2761.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_system_deflection(self) -> 'List[_2905.StraightBevelDiffGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_system_deflection(self) -> 'List[_2906.StraightBevelDiffGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2761.StraightBevelDiffGearSetSystemDeflection]':
