...
class ConceptCouplingHalfCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """ConceptCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2665.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2665.ConceptCouplingHalfSystemDeflection]':
