...
from mastapy.system_model.analyses_and_results.system_deflections.compound import (
    _2806, _2808, _2811, _2818,
    _2817, _2839, _2819, _2824,
    _2829, _2841, _2843, _2847,
    _2855, _2854, _2856, _2863,
    _2870, _2873, _2874, _2875,
    _2877, _2879, _2884, _2885,
    _2886, _2888, _2890, _2896,
    _2894, _2901, _2902, _2907,
    _2910, _2913, _2917, _2921,
    _2925, _2928, _2798
)
...
class AssemblyCompoundSystemDeflection(_2798.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2644.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_2806.BearingCompoundSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_2808.BeltDriveCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2811.BevelDifferentialGearSetCompoundSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2818.BoltedJointCompoundSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_2817.BoltCompoundSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_2839.CVTCompoundSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_2819.ClutchCompoundSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2824.ConceptCouplingCompoundSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2829.ConceptGearSetCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2841.CycloidalAssemblyCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2843.CycloidalDiscCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2847.CylindricalGearSetCompoundSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_2855.FEPartCompoundSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2854.FaceGearSetCompoundSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2856.FlexiblePinAssemblyCompoundSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2863.HypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2870.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2873.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_2874.MassDiscCompoundSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_2875.MeasurementComponentCompoundSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_2877.OilSealCompoundSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_2879.PartToPartShearCouplingCompoundSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_2884.PlanetCarrierCompoundSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_2885.PointLoadCompoundSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_2886.PowerLoadCompoundSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_2888.RingPinsCompoundSystemDeflection]':
    ...
    @property
    def rolling_bearings(self) -> 'List[_2806.BearingCompoundSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_2890.RollingRingAssemblyCompoundSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_2896.ShaftHubConnectionCompoundSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_2894.ShaftCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2901.SpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_2902.SpringDamperCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_2907.StraightBevelDiffGearSetCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_2910.StraightBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_2913.SynchroniserCompoundSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_2917.TorqueConverterCompoundSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_2921.UnbalancedMassCompoundSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_2925.WormGearSetCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_2928.ZerolBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2644.AssemblySystemDeflection]':
