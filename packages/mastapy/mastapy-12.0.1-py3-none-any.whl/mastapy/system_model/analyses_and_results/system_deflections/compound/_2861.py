...
class HypoidGearCompoundSystemDeflection(_2802.AGMAGleasonConicalGearCompoundSystemDeflection):
    """HypoidGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2712.HypoidGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2712.HypoidGearSystemDeflection]':
