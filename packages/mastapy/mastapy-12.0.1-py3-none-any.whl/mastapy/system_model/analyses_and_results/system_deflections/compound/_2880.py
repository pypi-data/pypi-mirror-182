...
class PartToPartShearCouplingConnectionCompoundSystemDeflection(_2836.CouplingConnectionCompoundSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2733.PartToPartShearCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2733.PartToPartShearCouplingConnectionSystemDeflection]':
