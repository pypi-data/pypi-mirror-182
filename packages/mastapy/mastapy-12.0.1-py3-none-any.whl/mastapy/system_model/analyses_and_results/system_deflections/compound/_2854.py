...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2852, _2853, _2859
...
class FaceGearSetCompoundSystemDeflection(_2859.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2702.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2852.FaceGearCompoundSystemDeflection]':
    ...
    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2853.FaceGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2702.FaceGearSetSystemDeflection]':
