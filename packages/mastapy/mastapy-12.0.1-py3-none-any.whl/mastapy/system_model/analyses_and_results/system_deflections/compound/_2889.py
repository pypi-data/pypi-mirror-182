...
class RingPinsToDiscConnectionCompoundSystemDeflection(_2864.InterMountableComponentConnectionCompoundSystemDeflection):
    """RingPinsToDiscConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2742.RingPinsToDiscConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2742.RingPinsToDiscConnectionSystemDeflection]':
