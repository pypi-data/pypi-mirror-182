...
class OilSealCompoundSystemDeflection(_2834.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2731.OilSealSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2731.OilSealSystemDeflection]':
