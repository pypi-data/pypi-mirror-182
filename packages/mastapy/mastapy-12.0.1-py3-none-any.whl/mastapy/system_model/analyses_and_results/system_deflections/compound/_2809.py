...
class BevelDifferentialGearCompoundSystemDeflection(_2814.BevelGearCompoundSystemDeflection):
    """BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2650.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2650.BevelDifferentialGearSystemDeflection]':
