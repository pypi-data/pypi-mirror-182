...
class ZerolBevelGearMeshCompoundSystemDeflection(_2815.BevelGearMeshCompoundSystemDeflection):
    """ZerolBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2786.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2786.ZerolBevelGearMeshSystemDeflection]':
