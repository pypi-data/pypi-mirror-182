...
class ComponentCompoundSystemDeflection(_2878.PartCompoundSystemDeflection):
    """ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2662.ComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2662.ComponentSystemDeflection]':
