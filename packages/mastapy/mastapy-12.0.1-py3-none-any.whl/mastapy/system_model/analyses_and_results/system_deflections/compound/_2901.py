...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2899, _2900, _2816
...
class SpiralBevelGearSetCompoundSystemDeflection(_2816.BevelGearSetCompoundSystemDeflection):
    """SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2755.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2899.SpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2900.SpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2755.SpiralBevelGearSetSystemDeflection]':
