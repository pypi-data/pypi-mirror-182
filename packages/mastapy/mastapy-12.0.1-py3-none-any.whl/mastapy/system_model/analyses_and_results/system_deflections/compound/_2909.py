...
class StraightBevelGearMeshCompoundSystemDeflection(_2815.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2763.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2763.StraightBevelGearMeshSystemDeflection]':
