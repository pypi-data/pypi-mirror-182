...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2845, _2846, _2859
...
class CylindricalGearSetCompoundSystemDeflection(_2859.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2691.CylindricalGearSetSystemDeflectionWithLTCAResults]':
    ...
    @property
    def cylindrical_gears_compound_system_deflection(self) -> 'List[_2845.CylindricalGearCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_system_deflection(self) -> 'List[_2846.CylindricalGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2691.CylindricalGearSetSystemDeflectionWithLTCAResults]':
