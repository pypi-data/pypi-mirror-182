...
class MountableComponentCompoundSystemDeflection(_2823.ComponentCompoundSystemDeflection):
    """MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2729.MountableComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2729.MountableComponentSystemDeflection]':
