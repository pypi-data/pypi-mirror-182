...
class KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection(_2830.ConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2717.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2717.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
