...
class StraightBevelDiffGearCompoundSystemDeflection(_2814.BevelGearCompoundSystemDeflection):
    """StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2762.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2762.StraightBevelDiffGearSystemDeflection]':
