...
class BeltConnectionCompoundSystemDeflection(_2864.InterMountableComponentConnectionCompoundSystemDeflection):
    """BeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2646.BeltConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2646.BeltConnectionSystemDeflection]':
