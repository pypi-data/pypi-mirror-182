...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2830.ConicalGearCompoundSystemDeflection):
    """AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2643.AGMAGleasonConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2643.AGMAGleasonConicalGearSystemDeflection]':
