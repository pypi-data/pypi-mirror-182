...
class WormGearCompoundSystemDeflection(_2857.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2785.WormGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2785.WormGearSystemDeflection]':
