...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2809, _2810, _2816
...
class BevelDifferentialGearSetCompoundSystemDeflection(_2816.BevelGearSetCompoundSystemDeflection):
    """BevelDifferentialGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2649.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_system_deflection(self) -> 'List[_2809.BevelDifferentialGearCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_system_deflection(self) -> 'List[_2810.BevelDifferentialGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2649.BevelDifferentialGearSetSystemDeflection]':
