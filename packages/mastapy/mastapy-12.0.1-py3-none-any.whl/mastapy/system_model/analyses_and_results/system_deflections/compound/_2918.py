...
class TorqueConverterConnectionCompoundSystemDeflection(_2836.CouplingConnectionCompoundSystemDeflection):
    """TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2775.TorqueConverterConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2775.TorqueConverterConnectionSystemDeflection]':
