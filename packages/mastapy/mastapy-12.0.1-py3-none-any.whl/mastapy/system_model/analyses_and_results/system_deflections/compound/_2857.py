...
class GearCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2708.GearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2708.GearSystemDeflection]':
