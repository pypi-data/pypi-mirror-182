...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2799
...
class CycloidalDiscCompoundSystemDeflection(_2799.AbstractShaftCompoundSystemDeflection):
    """CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2685.CycloidalDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2685.CycloidalDiscSystemDeflection]':
