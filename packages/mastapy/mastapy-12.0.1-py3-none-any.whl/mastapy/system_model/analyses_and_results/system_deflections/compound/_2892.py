...
class RollingRingConnectionCompoundSystemDeflection(_2864.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2745.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2745.RollingRingConnectionSystemDeflection]':
