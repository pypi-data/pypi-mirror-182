...
class VirtualComponentCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """VirtualComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2782.VirtualComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2782.VirtualComponentSystemDeflection]':
