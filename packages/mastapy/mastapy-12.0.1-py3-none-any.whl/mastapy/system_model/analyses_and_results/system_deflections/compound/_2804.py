...
class AGMAGleasonConicalGearSetCompoundSystemDeflection(_2832.ConicalGearSetCompoundSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2642.AGMAGleasonConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2642.AGMAGleasonConicalGearSetSystemDeflection]':
