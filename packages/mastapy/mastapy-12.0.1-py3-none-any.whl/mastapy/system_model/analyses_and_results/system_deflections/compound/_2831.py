...
class ConicalGearMeshCompoundSystemDeflection(_2858.GearMeshCompoundSystemDeflection):
    """ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2671.ConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2671.ConicalGearMeshSystemDeflection]':
