...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2923, _2924, _2859
...
class WormGearSetCompoundSystemDeflection(_2859.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2784.WormGearSetSystemDeflection]':
    ...
    @property
    def worm_gears_compound_system_deflection(self) -> 'List[_2923.WormGearCompoundSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_system_deflection(self) -> 'List[_2924.WormGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2784.WormGearSetSystemDeflection]':
