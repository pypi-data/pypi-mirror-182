...
class BearingCompoundSystemDeflection(_2834.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1909.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2645.BearingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2645.BearingSystemDeflection]':
