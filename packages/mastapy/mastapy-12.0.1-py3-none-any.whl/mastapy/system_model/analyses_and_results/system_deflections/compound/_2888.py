...
class RingPinsCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2741.RingPinsSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2741.RingPinsSystemDeflection]':
