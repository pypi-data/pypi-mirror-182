...
class BoltedJointCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """BoltedJointCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2656.BoltedJointSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2656.BoltedJointSystemDeflection]':
