...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2926, _2927, _2816
...
class ZerolBevelGearSetCompoundSystemDeflection(_2816.BevelGearSetCompoundSystemDeflection):
    """ZerolBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2787.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_system_deflection(self) -> 'List[_2926.ZerolBevelGearCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_system_deflection(self) -> 'List[_2927.ZerolBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2787.ZerolBevelGearSetSystemDeflection]':
