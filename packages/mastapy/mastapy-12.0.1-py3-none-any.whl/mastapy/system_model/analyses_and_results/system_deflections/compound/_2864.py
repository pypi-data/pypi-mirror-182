...
class InterMountableComponentConnectionCompoundSystemDeflection(_2833.ConnectionCompoundSystemDeflection):
    """InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2714.InterMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2714.InterMountableComponentConnectionSystemDeflection]':
