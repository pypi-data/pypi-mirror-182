...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2800
...
class FEPartCompoundSystemDeflection(_2800.AbstractShaftOrHousingCompoundSystemDeflection):
    """FEPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2704.FEPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2704.FEPartSystemDeflection]':
