...
class SpringDamperCompoundSystemDeflection(_2835.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2759.SpringDamperSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2759.SpringDamperSystemDeflection]':
