...
class ConceptCouplingConnectionCompoundSystemDeflection(_2836.CouplingConnectionCompoundSystemDeflection):
    """ConceptCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2664.ConceptCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2664.ConceptCouplingConnectionSystemDeflection]':
