...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2734.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2734.PartToPartShearCouplingHalfSystemDeflection]':
