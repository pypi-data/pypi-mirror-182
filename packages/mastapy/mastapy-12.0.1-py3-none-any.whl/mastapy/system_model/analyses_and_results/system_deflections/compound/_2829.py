...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2827, _2828, _2859
...
class ConceptGearSetCompoundSystemDeflection(_2859.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2668.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_compound_system_deflection(self) -> 'List[_2827.ConceptGearCompoundSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_system_deflection(self) -> 'List[_2828.ConceptGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2668.ConceptGearSetSystemDeflection]':
