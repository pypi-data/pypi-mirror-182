...
class SpiralBevelGearMeshCompoundSystemDeflection(_2815.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2754.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2754.SpiralBevelGearMeshSystemDeflection]':
