...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2809.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2651.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2651.BevelDifferentialPlanetGearSystemDeflection]':
