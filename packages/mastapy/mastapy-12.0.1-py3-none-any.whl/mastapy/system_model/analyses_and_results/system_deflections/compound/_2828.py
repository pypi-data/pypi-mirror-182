...
class ConceptGearMeshCompoundSystemDeflection(_2858.GearMeshCompoundSystemDeflection):
    """ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2667.ConceptGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2667.ConceptGearMeshSystemDeflection]':
