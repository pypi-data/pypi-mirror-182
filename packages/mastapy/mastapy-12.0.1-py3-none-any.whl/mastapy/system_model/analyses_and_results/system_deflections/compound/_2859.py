...
class GearSetCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2707.GearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2707.GearSetSystemDeflection]':
