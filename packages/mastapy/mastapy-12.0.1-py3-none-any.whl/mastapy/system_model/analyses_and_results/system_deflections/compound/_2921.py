...
class UnbalancedMassCompoundSystemDeflection(_2922.VirtualComponentCompoundSystemDeflection):
    """UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2781.UnbalancedMassSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2781.UnbalancedMassSystemDeflection]':
