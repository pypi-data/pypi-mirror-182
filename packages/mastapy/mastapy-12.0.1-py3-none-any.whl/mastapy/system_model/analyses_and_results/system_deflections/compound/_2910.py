...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2908, _2909, _2816
...
class StraightBevelGearSetCompoundSystemDeflection(_2816.BevelGearSetCompoundSystemDeflection):
    """StraightBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2764.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2908.StraightBevelGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2909.StraightBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2764.StraightBevelGearSetSystemDeflection]':
