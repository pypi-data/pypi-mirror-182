...
class CycloidalAssemblyCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """CycloidalAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2682.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2682.CycloidalAssemblySystemDeflection]':
