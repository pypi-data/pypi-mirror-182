...
class PlanetCarrierCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2737.PlanetCarrierSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2737.PlanetCarrierSystemDeflection]':
