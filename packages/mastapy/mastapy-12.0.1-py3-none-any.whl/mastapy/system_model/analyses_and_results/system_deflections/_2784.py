...
from mastapy.system_model.analyses_and_results.system_deflections import _2785, _2783, _2707
...
class WormGearSetSystemDeflection(_2707.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4106.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2785.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2783.WormGearMeshSystemDeflection]':
