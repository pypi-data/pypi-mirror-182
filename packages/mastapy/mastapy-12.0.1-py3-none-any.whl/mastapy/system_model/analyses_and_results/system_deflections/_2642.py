...
class AGMAGleasonConicalGearSetSystemDeflection(_2672.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3983.AGMAGleasonConicalGearSetPowerFlow':
