...
class SplineFlankContactReporting(_0.APIBase):
    ...
    @property
    def force_on_inner_contact_coordinate_system(self) -> '_1528.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_on_inner_wcs(self) -> '_1528.VectorWithLinearAndAngularComponents':
    ...
    @property
    def relative_deflection_lcs(self) -> '_1528.VectorWithLinearAndAngularComponents':
    ...
    @property
    def relative_deflection_wcs(self) -> '_1528.VectorWithLinearAndAngularComponents':
