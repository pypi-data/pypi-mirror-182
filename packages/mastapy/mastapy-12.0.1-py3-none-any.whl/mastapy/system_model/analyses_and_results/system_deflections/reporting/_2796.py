...
from mastapy.utility.enums import _1784
...
class ShaftSystemDeflectionSectionsReport(_1722.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1784.TableAndChartOptions':
        ...
        return constructor.new_from_mastapy_type(_1784.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1784.TableAndChartOptions'):
