...
from mastapy.system_model.analyses_and_results.power_flows import _4027, _4062
from mastapy.system_model.analyses_and_results.system_deflections import _2692, _2686, _2707
...
class CylindricalGearSetSystemDeflection(_2707.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4027.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2692.CylindricalGearSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2686.CylindricalGearMeshSystemDeflection]':
