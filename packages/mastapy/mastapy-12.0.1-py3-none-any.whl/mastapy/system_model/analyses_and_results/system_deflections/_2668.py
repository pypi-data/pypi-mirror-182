...
from mastapy.system_model.analyses_and_results.system_deflections import _2669, _2667, _2707
...
class ConceptGearSetSystemDeflection(_2707.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4008.ConceptGearSetPowerFlow':
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2669.ConceptGearSystemDeflection]':
    ...
    @property
    def concept_meshes_system_deflection(self) -> 'List[_2667.ConceptGearMeshSystemDeflection]':
