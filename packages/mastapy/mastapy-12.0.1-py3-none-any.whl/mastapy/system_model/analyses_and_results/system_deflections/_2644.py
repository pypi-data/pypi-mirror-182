...
from mastapy.system_model.analyses_and_results.power_flows import _3984, _4074
from mastapy.gears.analysis import _1217
from mastapy.shafts import _40
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2645, _2647, _2649, _2656,
    _2657, _2681, _2660, _2662,
    _2666, _2668, _2674, _2682,
    _2685, _2689, _2704, _2702,
    _2705, _2711, _2719, _2722,
    _2726, _2727, _2729, _2731,
    _2735, _2737, _2738, _2739,
    _2741, _2744, _2748, _2751,
    _2638, _2755, _2759, _2761,
    _2764, _2771, _2777, _2781,
    _2706, _2784, _2787, _2637
)
...
class AssemblySystemDeflection(_2637.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3984.AssemblyPowerFlow':
        ...
        if _3984.AssemblyPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bearings(self) -> 'List[_2645.BearingSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_2647.BeltDriveSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2649.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2656.BoltedJointSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_2657.BoltSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_2681.CVTSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_2660.ClutchSystemDeflection]':
    ...
    @property
    def component_details(self) -> 'List[_2662.ComponentSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2666.ConceptCouplingSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2668.ConceptGearSetSystemDeflection]':
    ...
    @property
    def connection_details(self) -> 'List[_2674.ConnectionSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2682.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2685.CycloidalDiscSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2689.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_2704.FEPartSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2702.FaceGearSetSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2705.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2711.HypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2722.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_2726.MassDiscSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_2727.MeasurementComponentSystemDeflection]':
    ...
    @property
    def mountable_component_details(self) -> 'List[_2729.MountableComponentSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_2731.OilSealSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_2735.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_2737.PlanetCarrierSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_2738.PointLoadSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_2739.PowerLoadSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_2741.RingPinsSystemDeflection]':
    ...
    @property
    def rolling_bearings(self) -> 'List[_2645.BearingSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_2744.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_2748.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_2751.ShaftSystemDeflection]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_2638.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def sorted_converged_component_details(self) -> 'List[_2662.ComponentSystemDeflection]':
    ...
    @property
    def sorted_converged_connection_details(self) -> 'List[_2674.ConnectionSystemDeflection]':
    ...
    @property
    def sorted_unconverged_component_details(self) -> 'List[_2662.ComponentSystemDeflection]':
    ...
    @property
    def sorted_unconverged_connection_details(self) -> 'List[_2674.ConnectionSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2755.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_2759.SpringDamperSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_2761.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_2764.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_2689.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_2771.SynchroniserSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_2777.TorqueConverterSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_2781.UnbalancedMassSystemDeflection]':
    ...
    @property
    def unconverged_bearings_sorted_by_load(self) -> 'List[_2645.BearingSystemDeflection]':
    ...
    @property
    def unconverged_gear_meshes_sorted_by_power(self) -> 'List[_2706.GearMeshSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_2784.WormGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_2787.ZerolBevelGearSetSystemDeflection]':
