...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2717.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4051.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
