...
from mastapy.system_model.analyses_and_results.power_flows import _3979, _4023, _4076
...
class AbstractShaftSystemDeflection(_2638.AbstractShaftOrHousingSystemDeflection):
    """AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3979.AbstractShaftPowerFlow':
