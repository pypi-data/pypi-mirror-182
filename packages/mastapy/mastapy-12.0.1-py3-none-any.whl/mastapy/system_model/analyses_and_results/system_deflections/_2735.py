...
from mastapy.system_model.analyses_and_results.system_deflections import _2733, _2678
...
class PartToPartShearCouplingSystemDeflection(_2678.CouplingSystemDeflection):
    """PartToPartShearCouplingSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6858.PartToPartShearCouplingLoadCase':
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2733.PartToPartShearCouplingConnectionSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4060.PartToPartShearCouplingPowerFlow':
