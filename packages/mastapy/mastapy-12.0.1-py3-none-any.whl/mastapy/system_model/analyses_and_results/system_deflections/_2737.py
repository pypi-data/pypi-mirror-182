...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2793
...
class PlanetCarrierSystemDeflection(_2729.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6862.PlanetCarrierLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4063.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2793.PlanetCarrierWindup]':
