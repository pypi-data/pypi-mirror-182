...
from mastapy.system_model.analyses_and_results.system_deflections import _2742, _2753
...
class CycloidalAssemblySystemDeflection(_2753.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6784.CycloidalAssemblyLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4020.CycloidalAssemblyPowerFlow':
    ...
    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2742.RingPinsToDiscConnectionSystemDeflection]':
