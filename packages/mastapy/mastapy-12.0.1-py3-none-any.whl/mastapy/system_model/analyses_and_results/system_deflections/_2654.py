...
class BevelGearSetSystemDeflection(_2642.AGMAGleasonConicalGearSetSystemDeflection):
    """BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3995.BevelGearSetPowerFlow':
