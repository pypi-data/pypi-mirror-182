...
class CylindricalPlanetGearSystemDeflection(_2694.CylindricalGearSystemDeflectionWithLTCAResults):
    """CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4028.CylindricalPlanetGearPowerFlow':
