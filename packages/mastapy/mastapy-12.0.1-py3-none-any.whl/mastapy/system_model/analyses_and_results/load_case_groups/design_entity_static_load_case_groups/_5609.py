...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5614
...
TAssembly = TypeVar('TAssembly', bound='_2388.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6734.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5614.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    """AbstractAssemblyStaticLoadCaseGroup
