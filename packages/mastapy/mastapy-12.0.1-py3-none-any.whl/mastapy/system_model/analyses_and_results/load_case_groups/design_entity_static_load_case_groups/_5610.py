...
TReal = TypeVar('TReal', bound='_2397.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6764.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5614.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
