...
from mastapy.system_model.analyses_and_results.load_case_groups import _5604, _5597
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6928
...
class DutyCycle(_5597.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5604.SubGroupInSingleDesignState]':
    ...
    @property
    def time_series_importer(self) -> '_6928.TimeSeriesImporter':
    ...
    def add_static_load(self, static_load: '_6732.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5604.SubGroupInSingleDesignState'):
    ...
    def remove_static_load(self, static_load: '_6732.StaticLoadCase'):
