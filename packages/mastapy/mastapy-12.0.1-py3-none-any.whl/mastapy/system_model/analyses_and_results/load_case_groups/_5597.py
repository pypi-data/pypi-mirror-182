...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5606, _5607, _5595, _5605,
    _5596
)
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5610, _5613, _5614
from mastapy.system_model.part_model import (
    _2393, _2406, _2424, _2425
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _6747, _6788, _6790, _6792,
    _6814, _6865, _6866, _6732,
    _6745
)
from mastapy.system_model.part_model.gears import _2478, _2477
...
from mastapy.system_model.analyses_and_results import (
    _2633, _2628, _2610, _2620,
    _2630, _2623, _2613, _2629,
    _2612, _2617, _2571
)
...
class AbstractStaticLoadCaseGroup(_5596.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    @property
    def gear_set_optimisation(self) -> '_5606.SystemOptimiserGearSetOptimisation':
        ...
        return constructor.new_from_mastapy_type(_5606.SystemOptimiserGearSetOptimisation)(value) if value is not None else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_5606.SystemOptimiserGearSetOptimisation'):
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_5607.SystemOptimiserTargets':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5607.SystemOptimiserTargets)(value) if value is not None else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_5607.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearings(self) -> 'List[_5610.ComponentStaticLoadCaseGroup[_2393.Bearing, _6747.BearingLoadCase]]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5613.GearSetStaticLoadCaseGroup[_2478.CylindricalGearSet, _2477.CylindricalGear, _6788.CylindricalGearLoadCase, _2262.CylindricalGearMesh, _6790.CylindricalGearMeshLoadCase, _6792.CylindricalGearSetLoadCase]]':
    ...
    @property
    def design_states(self) -> 'List[_5595.AbstractDesignStateLoadCaseGroup]':
    ...
    @property
    def fe_parts(self) -> 'List[_5610.ComponentStaticLoadCaseGroup[_2406.FEPart, _6814.FEPartLoadCase]]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4159.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def parts_with_excitations(self) -> 'List[_5614.PartStaticLoadCaseGroup]':
    ...
    @property
    def point_loads(self) -> 'List[_5610.ComponentStaticLoadCaseGroup[_2424.PointLoad, _6865.PointLoadLoadCase]]':
    ...
    @property
    def power_loads(self) -> 'List[_5610.ComponentStaticLoadCaseGroup[_2425.PowerLoad, _6866.PowerLoadLoadCase]]':
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_6732.StaticLoadCase]':
    ...
    @property
    def system_optimisation_gear_sets(self) -> 'List[_5605.SystemOptimisationGearSet]':
    ...
    @property
    def compound_system_deflection(self) -> '_2633.CompoundSystemDeflectionAnalysis':
    ...
    @property
    def compound_power_flow(self) -> '_2628.CompoundPowerFlowAnalysis':
    ...
    @property
    def compound_advanced_system_deflection(self) -> '_2610.CompoundAdvancedSystemDeflectionAnalysis':
    ...
    @property
    def compound_harmonic_analysis(self) -> '_2620.CompoundHarmonicAnalysis':
    ...
    @property
    def compound_steady_state_synchronous_response(self) -> '_2630.CompoundSteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def compound_modal_analysis(self) -> '_2623.CompoundModalAnalysis':
    ...
    @property
    def compound_critical_speed_analysis(self) -> '_2613.CompoundCriticalSpeedAnalysis':
    ...
    @property
    def compound_stability_analysis(self) -> '_2629.CompoundStabilityAnalysis':
    ...
    @property
    def compound_advanced_time_stepping_analysis_for_modulation(self) -> '_2612.CompoundAdvancedTimeSteppingAnalysisForModulation':
    ...
    @property
    def compound_dynamic_model_for_modal_analysis(self) -> '_2617.CompoundDynamicModelForModalAnalysis':
    ...
    def analysis_of(self, analysis_type: '_6745.AnalysisType') -> '_2571.CompoundAnalysis':
