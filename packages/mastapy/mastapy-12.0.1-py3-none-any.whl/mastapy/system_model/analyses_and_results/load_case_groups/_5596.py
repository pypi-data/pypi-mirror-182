...
from mastapy.system_model import _2156
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4332
from mastapy.system_model.analyses_and_results.static_loads import _6875, _6731
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6875.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7484.TaskProgress') -> 'List[_6731.LoadCase]':
    ...
    def perform_pst_with_progress(self, progress: '_7484.TaskProgress'):
