...
class GearCompoundSteadyStateSynchronousResponseAtASpeed(_3658.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3511.GearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3511.GearSteadyStateSynchronousResponseAtASpeed]':
