...
class ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(_3639.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3482.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3482.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
