...
class CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3582.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3497.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3497.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
