...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3703.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3537.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3537.PointLoadSteadyStateSynchronousResponseAtASpeed]':
