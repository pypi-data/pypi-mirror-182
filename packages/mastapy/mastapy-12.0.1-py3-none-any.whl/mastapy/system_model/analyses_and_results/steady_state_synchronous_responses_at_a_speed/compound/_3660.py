...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_7471.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3530.PartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3530.PartSteadyStateSynchronousResponseAtASpeed]':
