...
class StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3597.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3562.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3562.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
