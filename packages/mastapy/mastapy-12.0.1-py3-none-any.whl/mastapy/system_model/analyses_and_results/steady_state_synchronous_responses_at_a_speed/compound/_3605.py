...
class CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3678.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3475.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3475.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
