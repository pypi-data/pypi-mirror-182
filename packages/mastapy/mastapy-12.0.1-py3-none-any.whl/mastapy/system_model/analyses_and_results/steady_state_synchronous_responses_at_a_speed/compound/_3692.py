...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(_3686.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3563.StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3563.StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed]':
