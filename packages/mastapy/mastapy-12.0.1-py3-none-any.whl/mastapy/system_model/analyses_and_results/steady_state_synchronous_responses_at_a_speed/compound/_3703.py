...
class VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3658.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3574.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3574.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
