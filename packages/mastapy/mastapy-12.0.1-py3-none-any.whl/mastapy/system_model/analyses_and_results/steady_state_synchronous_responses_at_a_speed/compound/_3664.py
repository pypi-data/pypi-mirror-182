...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3678.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3534.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3534.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
