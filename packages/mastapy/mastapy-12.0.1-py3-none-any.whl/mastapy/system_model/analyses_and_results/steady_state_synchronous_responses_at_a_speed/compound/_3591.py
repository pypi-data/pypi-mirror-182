...
class BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed(_3679.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3461.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3461.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
