...
class ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed(_3606.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3503.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3503.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
