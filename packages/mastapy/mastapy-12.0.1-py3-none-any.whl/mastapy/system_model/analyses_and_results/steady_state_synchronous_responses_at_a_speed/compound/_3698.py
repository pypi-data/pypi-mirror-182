...
class TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3571.TorqueConverterSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3571.TorqueConverterSteadyStateSynchronousResponseAtASpeed]':
