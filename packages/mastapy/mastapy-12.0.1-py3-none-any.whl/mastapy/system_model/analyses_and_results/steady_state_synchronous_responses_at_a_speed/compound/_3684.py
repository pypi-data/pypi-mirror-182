...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3619.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3553.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3553.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
