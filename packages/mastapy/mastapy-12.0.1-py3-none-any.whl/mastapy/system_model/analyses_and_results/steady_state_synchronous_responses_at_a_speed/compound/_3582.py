...
class AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3583.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3453.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3453.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
