...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3606.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3471.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3471.BoltSteadyStateSynchronousResponseAtASpeed]':
