...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_3679.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3470.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3470.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
