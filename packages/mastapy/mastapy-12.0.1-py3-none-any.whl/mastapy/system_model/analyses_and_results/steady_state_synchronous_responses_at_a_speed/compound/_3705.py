...
class WormGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3640.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3575.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3575.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
