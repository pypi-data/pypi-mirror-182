...
class SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3555.SpringDamperSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3555.SpringDamperSteadyStateSynchronousResponseAtASpeed]':
