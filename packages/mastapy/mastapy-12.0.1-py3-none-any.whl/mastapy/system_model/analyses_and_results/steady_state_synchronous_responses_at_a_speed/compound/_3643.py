...
class HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed(_3585.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3515.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3515.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
