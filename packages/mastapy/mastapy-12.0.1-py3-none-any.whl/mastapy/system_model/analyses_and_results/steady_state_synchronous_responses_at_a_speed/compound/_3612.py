...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3610, _3611, _3641
...
class ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3641.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3481.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3610.ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3611.ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3481.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]':
