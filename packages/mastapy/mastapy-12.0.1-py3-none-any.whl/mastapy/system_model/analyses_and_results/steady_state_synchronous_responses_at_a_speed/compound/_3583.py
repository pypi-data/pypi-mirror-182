...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed(_3606.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3452.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3452.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
