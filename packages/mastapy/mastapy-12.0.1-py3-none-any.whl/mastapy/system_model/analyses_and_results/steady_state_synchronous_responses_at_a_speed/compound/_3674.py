...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3646.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3543.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3543.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
