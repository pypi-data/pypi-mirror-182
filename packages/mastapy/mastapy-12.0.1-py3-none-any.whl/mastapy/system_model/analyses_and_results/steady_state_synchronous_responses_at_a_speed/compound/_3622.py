...
class CVTCompoundSteadyStateSynchronousResponseAtASpeed(_3591.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3493.CVTSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3493.CVTSteadyStateSynchronousResponseAtASpeed]':
