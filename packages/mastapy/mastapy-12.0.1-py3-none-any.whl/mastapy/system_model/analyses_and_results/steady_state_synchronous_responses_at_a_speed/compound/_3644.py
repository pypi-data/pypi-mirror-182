...
class HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3586.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3513.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3513.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
