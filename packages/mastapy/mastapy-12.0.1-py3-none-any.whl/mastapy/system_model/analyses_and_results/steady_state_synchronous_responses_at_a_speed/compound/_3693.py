...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3686.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3564.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3564.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
