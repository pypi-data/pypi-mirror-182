...
class ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3619.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3472.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3472.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
