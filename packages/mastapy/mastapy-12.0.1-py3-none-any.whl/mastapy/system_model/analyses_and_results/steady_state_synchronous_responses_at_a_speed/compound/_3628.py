...
class CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3639.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3500.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3500.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
