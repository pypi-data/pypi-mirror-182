...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed(_3620.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3570.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3570.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
