...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3643, _3644, _3587
...
class HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3587.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3514.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3643.HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3644.HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3514.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
