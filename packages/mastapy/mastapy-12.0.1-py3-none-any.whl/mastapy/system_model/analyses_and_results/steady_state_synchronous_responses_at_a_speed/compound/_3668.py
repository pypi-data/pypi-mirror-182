...
class PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3703.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3538.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3538.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
