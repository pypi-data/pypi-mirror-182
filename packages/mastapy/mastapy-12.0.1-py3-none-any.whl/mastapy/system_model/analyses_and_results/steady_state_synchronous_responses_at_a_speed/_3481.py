...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3482, _3480, _3510
...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(_3510.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def concept_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3482.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3480.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
