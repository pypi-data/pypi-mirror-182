...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3464, _3462, _3468
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed(_3468.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3464.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3462.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
