...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3577, _3575, _3510
...
class WormGearSetSteadyStateSynchronousResponseAtASpeed(_3510.GearSetSteadyStateSynchronousResponseAtASpeed):
    """WormGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def worm_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3577.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3575.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
