...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3559, _3557, _3468
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed(_3468.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3559.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3557.StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed]':
