...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3580, _3578, _3468
...
class ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3468.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3580.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3578.ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
