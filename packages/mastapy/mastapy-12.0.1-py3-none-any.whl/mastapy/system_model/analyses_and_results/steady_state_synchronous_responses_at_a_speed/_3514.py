...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3515, _3513, _3456
...
class HypoidGearSetSteadyStateSynchronousResponseAtASpeed(_3456.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3515.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3513.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
