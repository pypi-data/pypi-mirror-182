...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3562, _3560, _3468
...
class StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3468.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3562.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3560.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
