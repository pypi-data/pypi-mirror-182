...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3552, _3550, _3468
...
class SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3468.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3552.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3550.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
