...
T = TypeVar('T', bound='_2397.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1455.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1455.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_2177.RelativeOffsetOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2177.RelativeOffsetOption)(value) if value is not None else None

    @axial_offset.setter
    def axial_offset(self, value: '_2177.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
