...
from mastapy.system_model.optimization import _2192, _2190
...
TStep = TypeVar('TStep', bound='_2190.OptimizationStep')


class OptimizationStrategy(_2192.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
