...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_2189.MicroGeometryOptimisationTarget':
        ...
        return constructor.new_from_mastapy_type(_2189.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_2189.MicroGeometryOptimisationTarget'):
