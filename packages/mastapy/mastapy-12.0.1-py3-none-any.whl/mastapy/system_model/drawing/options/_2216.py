...
from mastapy.math_utility.measured_ranges import _1529
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5780, _5779
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self) -> '_1453.Range':
        ...
        if _1453.Range.TYPE not in temp.__class__.__mro__:
    ...
    def filtering_frequency_range(self, value: '_1453.Range'):
        value = value.wrapped if value else None
        self.wrapped.FilteringFrequencyRange = value

    @property
    def filtering_method(self) -> '_5780.ModalContributionFilteringMethod':
        ...
        return constructor.new_from_mastapy_type(_5780.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5780.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilteringMethod = value

    @property
    def frequency_range(self) -> '_1453.Range':
    ...
    def frequency_range(self, value: '_1453.Range'):
        value = value.wrapped if value else None
    ...
    @property
    def index_range(self) -> '_1554.IntegerRange':
    ...
    @index_range.setter
    def index_range(self, value: '_1554.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def modes_to_display(self) -> '_5779.ModalContributionDisplayMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5779.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5779.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
