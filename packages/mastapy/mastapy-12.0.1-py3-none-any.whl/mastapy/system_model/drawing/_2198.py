...
from mastapy.system_model.drawing import _2208, _2204
...
class ContourDrawStyle(_302.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1785.ThreeDViewContourOption':
        ...
        return constructor.new_from_mastapy_type(_1785.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1785.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_2208.ScalingDrawStyle':
    ...
    @property
    def model_view_options(self) -> '_2204.ModelViewOptionsDrawStyle':
