...
from mastapy.cycloidal import _1426, _1427
...
class RingPins(_2417.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1426.RingPinsDesign':
    ...
    @property
    def ring_pins_material(self) -> '_1427.RingPinsMaterial':
