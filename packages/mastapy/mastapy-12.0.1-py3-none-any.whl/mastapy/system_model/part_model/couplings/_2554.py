...
from mastapy.system_model.part_model.couplings import _2558, _2556
...
class Synchroniser(_2429.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self) -> '_2295.ClutchConnection':
    ...
    @property
    def clutch_connection_right(self) -> '_2295.ClutchConnection':
    ...
    @property
    def hub_and_sleeve(self) -> '_2558.SynchroniserSleeve':
    ...
    @property
    def left_cone(self) -> '_2556.SynchroniserHalf':
    ...
    @property
    def right_cone(self) -> '_2556.SynchroniserHalf':
