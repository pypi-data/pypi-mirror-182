...
from mastapy.math_utility.stiffness_calculators import _1500
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1500.IndividualContactPosition':
        ...
        return constructor.new_from_mastapy_type(_1500.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1828.TwoDChartDefinition':
    ...
    @property
    def crowning(self) -> '_2537.CrowningSpecification':
