...
class ConceptCoupling(_2535.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1498.Vector2DListAccessor':
    ...
    def efficiency_vs_speed_ratio(self, value: '_1498.Vector2DListAccessor'):
