...
from mastapy.system_model.part_model.gears import _2473, _2484
...
class ConceptGearSet(_2484.GearSet):
    """ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2473.ConceptGear]':
    ...
    @property
    def concept_meshes(self) -> 'List[_2258.ConceptGearMesh]':
