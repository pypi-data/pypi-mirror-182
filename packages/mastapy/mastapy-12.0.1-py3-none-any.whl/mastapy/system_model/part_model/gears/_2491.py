...
from mastapy.system_model.part_model.gears import _2490, _2489
...
class KlingelnbergCycloPalloidHypoidGearSet(_2489.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2490.KlingelnbergCycloPalloidHypoidGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2272.KlingelnbergCycloPalloidHypoidGearMesh]':
