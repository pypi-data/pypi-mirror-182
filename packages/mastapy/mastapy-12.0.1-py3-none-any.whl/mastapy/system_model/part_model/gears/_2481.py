...
from mastapy.system_model.part_model.gears import _2480, _2484
...
class FaceGearSet(_2484.GearSet):
    """FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2480.FaceGear]':
    ...
    @property
    def face_meshes(self) -> 'List[_2264.FaceGearMesh]':
