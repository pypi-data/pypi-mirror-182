...
from mastapy.system_model.part_model.gears import _2499, _2472
...
class StraightBevelGearSet(_2472.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2499.StraightBevelGear]':
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_2280.StraightBevelGearMesh]':
