...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2515
from mastapy.system_model.part_model.gears import _2477, _2484
...
class CylindricalGearSet(_2484.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2515.SuperchargerRotorSet':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2477.CylindricalGear]':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2262.CylindricalGearMesh]':
