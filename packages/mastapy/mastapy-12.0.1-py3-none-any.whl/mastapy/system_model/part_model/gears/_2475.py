...
from mastapy.system_model.part_model.gears import _2483, _2482
...
class ConicalGear(_2482.Gear):
    ...
    @property
    def orientation(self) -> '_2483.GearOrientations':
        ...
        return constructor.new_from_mastapy_type(_2483.GearOrientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_2483.GearOrientations'):
