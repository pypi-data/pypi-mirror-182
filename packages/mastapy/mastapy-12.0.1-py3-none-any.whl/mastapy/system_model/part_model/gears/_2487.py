...
from mastapy.system_model.part_model.gears import _2486, _2466
...
class HypoidGearSet(_2466.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self) -> 'List[_2486.HypoidGear]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_2268.HypoidGearMesh]':
