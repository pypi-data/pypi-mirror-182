...
from mastapy.system_model.part_model.part_groups import _2439, _2440, _2443
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2439.ConcentricOrParallelPartGroup':
        ...
        if _2439.ConcentricOrParallelPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2440.ConcentricPartGroup':
        ...
        if _2440.ConcentricPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2443.ParallelPartGroup':
        ...
        if _2443.ParallelPartGroup.TYPE not in temp.__class__.__mro__:
