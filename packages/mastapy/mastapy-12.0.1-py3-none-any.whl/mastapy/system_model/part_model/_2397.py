...
from mastapy.math_utility import _1463, _1464
from mastapy.system_model.connections_and_sockets import (
    _2223, _2225, _2249, _2244
)
from mastapy.system_model.part_model import _2398, _2421
...
class Component(_2421.Part):
    ...
    @property
    def local_coordinate_system(self) -> '_1463.CoordinateSystem3D':
    ...
    @property
    def component_connections(self) -> 'List[_2223.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2225.Connection') -> 'bool':
    ...
    def connect_to_socket(self, socket: '_2249.Socket') -> '_2398.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2398.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def create_coordinate_system_editor(self) -> '_1464.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2225.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2225.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2249.Socket') -> 'List[_2249.Socket]':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2249.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2244.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1463.CoordinateSystem3D') -> '_2244.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2244.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2249.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2398.ComponentsConnectedResult':
