...
from mastapy.bearings.bearing_results.fluid_film import _2079, _2075
...
class LoadedPlainJournalBearingResults(_2075.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_2079.LoadedPlainJournalBearingRow]':
