...
from mastapy.bearings.bearing_results.rolling import _1933, _2032, _1990
...
class LoadedBallBearingResults(_1990.LoadedRollingBearingResults):
    """LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1933.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new_from_mastapy_type(_1933.FrictionModelForGyroscopicMoment)(value) if value is not None else None
    ...
    @property
    def track_truncation(self) -> '_2032.TrackTruncationSafetyFactorResults':
