...
from mastapy.bearings.bearing_results.rolling import _2029, _1986
...
class LoadedNonBarrelRollerBearingResults(_1986.LoadedRollerBearingResults):
    """LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_2029.SMTRibStressResults':
