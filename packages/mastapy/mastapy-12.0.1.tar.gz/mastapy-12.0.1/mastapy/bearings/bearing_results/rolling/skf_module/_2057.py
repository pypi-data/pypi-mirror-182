...
from mastapy.bearings.bearing_results.rolling.skf_module import _2049, _2053
...
class Viscosities(_2053.SKFCalculationResult):
    """Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_2049.OperatingViscosity':
