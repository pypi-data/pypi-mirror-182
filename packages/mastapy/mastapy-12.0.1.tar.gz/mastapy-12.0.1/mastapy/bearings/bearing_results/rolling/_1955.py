...
from mastapy.bearings.bearing_results.rolling import _1954, _1952
...
class LoadedAxialThrustNeedleRollerBearingRow(_1952.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1954.LoadedAxialThrustNeedleRollerBearingResults':
