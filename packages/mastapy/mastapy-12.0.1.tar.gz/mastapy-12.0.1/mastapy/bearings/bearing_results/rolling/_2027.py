...
class RollingBearingFrictionCoefficients(_1552.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    """RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1906.EquivalentLoadFactors':
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1906.EquivalentLoadFactors':
