...
from mastapy.bearings.bearing_results.rolling import _1993, _1960
...
class LoadedSelfAligningBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1993.LoadedSelfAligningBallBearingResults':
