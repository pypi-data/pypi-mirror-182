...
from mastapy.bearings.bearing_results.rolling import _1934, _2031, _2030
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1934.InternalClearance':
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_2030.StressAtPosition]':
    ...
    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_2030.StressAtPosition]':
