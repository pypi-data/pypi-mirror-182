...
from mastapy.bearings.bearing_results.rolling import _1943, _1941
...
class LoadedAngularContactThrustBallBearingRow(_1941.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1943.LoadedAngularContactThrustBallBearingResults':
