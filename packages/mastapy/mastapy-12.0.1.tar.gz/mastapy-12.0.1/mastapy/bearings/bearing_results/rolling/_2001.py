...
from mastapy.bearings.bearing_results.rolling import _2000, _1987
...
class LoadedSphericalRollerThrustBearingRow(_1987.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2000.LoadedSphericalRollerThrustBearingResults':
