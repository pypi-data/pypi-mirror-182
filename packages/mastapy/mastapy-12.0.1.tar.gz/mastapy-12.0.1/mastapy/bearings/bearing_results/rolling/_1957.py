...
from mastapy.bearings.bearing_results.rolling import _1929, _1971
...
class LoadedBallBearingElement(_1971.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1929.BallBearingRaceContactGeometry]':
    ...
    @property
    def outer_race_contact_geometries(self) -> 'List[_1929.BallBearingRaceContactGeometry]':
