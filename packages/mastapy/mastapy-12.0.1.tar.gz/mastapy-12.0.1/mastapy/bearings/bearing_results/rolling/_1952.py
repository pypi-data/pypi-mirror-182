...
from mastapy.bearings.bearing_results.rolling import _1951, _1954, _1982
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1982.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1951.LoadedAxialThrustCylindricalRollerBearingResults':
