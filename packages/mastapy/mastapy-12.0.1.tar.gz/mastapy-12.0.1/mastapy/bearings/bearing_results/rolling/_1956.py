...
class LoadedBallBearingDutyCycle(_1920.LoadedRollingBearingDutyCycle):
    """LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1803.DutyCyclePropertySummaryPercentage[_1959.LoadedBallBearingResults]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1959.LoadedBallBearingResults](temp) if temp is not None else None

    @property
    def track_truncation_outer_summary(self) -> '_1803.DutyCyclePropertySummaryPercentage[_1959.LoadedBallBearingResults]':
