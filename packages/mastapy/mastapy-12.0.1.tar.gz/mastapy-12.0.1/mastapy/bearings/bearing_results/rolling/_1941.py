...
from mastapy.bearings.bearing_results.rolling import _1940, _1943, _1960
...
class LoadedAngularContactBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1940.LoadedAngularContactBallBearingResults':
