...
from mastapy.bearings.bearing_results.rolling import _2021, _1981
...
class LoadedCylindricalRollerBearingResults(_1981.LoadedNonBarrelRollerBearingResults):
    """LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_2021.PermissibleContinuousAxialLoadResults':
