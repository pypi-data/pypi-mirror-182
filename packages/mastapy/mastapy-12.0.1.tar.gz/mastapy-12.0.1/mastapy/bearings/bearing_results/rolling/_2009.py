...
from mastapy.bearings.bearing_results.rolling import _2008, _1960
...
class LoadedThreePointContactBallBearingRow(_1960.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2008.LoadedThreePointContactBallBearingResults':
