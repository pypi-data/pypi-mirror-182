...
from mastapy.bearings import _1858
...
class ISO14179SettingsPerBearingType(_1552.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    """ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1858.RollingBearingType':
        ...
        return constructor.new_from_mastapy_type(_1858.RollingBearingType)(value) if value is not None else None

    @property
    def iso14179_settings(self) -> '_1935.ISO14179Settings':
