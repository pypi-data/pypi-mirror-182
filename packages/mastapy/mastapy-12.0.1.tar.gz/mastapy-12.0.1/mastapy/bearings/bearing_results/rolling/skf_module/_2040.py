...
from mastapy.bearings.bearing_results.rolling.skf_module import _2042, _2041, _2053
...
class Friction(_2053.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self) -> '_2042.FrictionSources':
    ...
    @property
    def frictional_moment(self) -> '_2041.FrictionalMoment':
