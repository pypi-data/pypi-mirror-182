...
from mastapy.bearings.bearing_results.rolling import _1962, _1987
...
class LoadedCrossedRollerBearingRow(_1987.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1962.LoadedCrossedRollerBearingResults':
