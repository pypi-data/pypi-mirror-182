...
from mastapy.bearings.bearing_results.rolling import _2024, _1971
...
class LoadedRollerBearingElement(_1971.LoadedElement):
    """LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_2024.ResultsAtRollerOffset]':
