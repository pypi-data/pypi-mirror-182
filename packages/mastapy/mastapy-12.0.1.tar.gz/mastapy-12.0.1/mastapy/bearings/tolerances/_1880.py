...
from mastapy.bearings.tolerances import _1881, _1887, _1877
...
class RoundnessSpecification(_1552.IndependentReportablePropertiesBase['RoundnessSpecification']):
    """RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1881.RoundnessSpecificationType':
        ...
        return constructor.new_from_mastapy_type(_1881.RoundnessSpecificationType)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1881.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def type_of_fit(self) -> '_1887.TypeOfFit':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1887.TypeOfFit)(value) if value is not None else None

    @type_of_fit.setter
    def type_of_fit(self, value: '_1887.TypeOfFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfFit = value

    @property
    def user_specified_deviation(self) -> '_1498.Vector2DListAccessor':
    ...
    def user_specified_deviation(self, value: '_1498.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.UserSpecifiedDeviation = value

    @property
    def roundness_distribution(self) -> 'List[_1877.RaceRoundnessAtAngle]':
