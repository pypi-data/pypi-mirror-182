...
from mastapy.bearings.bearing_designs.rolling import _2112, _2113
...
class GeometricConstants(_0.APIBase):
    ...
    @property
    def geometric_constants_for_rolling_frictional_moments(self) -> '_2112.GeometricConstantsForRollingFrictionalMoments':
    ...
    @property
    def geometric_constants_for_sliding_frictional_moments(self) -> '_2113.GeometricConstantsForSlidingFrictionalMoments':
