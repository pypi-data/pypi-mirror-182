...
from mastapy.bearings.bearing_designs.rolling import _2096
...
class ThrustBallBearing(_2096.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1851.OuterRingMounting':
        ...
        return constructor.new_from_mastapy_type(_1851.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1851.OuterRingMounting'):
