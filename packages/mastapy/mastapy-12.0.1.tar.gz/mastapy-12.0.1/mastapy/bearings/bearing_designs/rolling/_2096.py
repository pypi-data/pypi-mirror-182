...
from mastapy.bearings.bearing_designs.rolling import _2097, _2121
...
class BallBearing(_2121.RollingBearing):
    """BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_2097.BallBearingShoulderDefinition]':
