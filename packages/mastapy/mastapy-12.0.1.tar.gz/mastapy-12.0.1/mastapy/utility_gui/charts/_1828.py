...
from mastapy.utility_gui.charts import _1815, _1824, _1820
...
class TwoDChartDefinition(_1820.NDChartDefinition):
    """TwoDChartDefinition
    ...
    @property
    def const_lines(self) -> 'List[_1815.ConstantLine]':
    ...
    @property
    def series_list(self) -> 'List[_1824.Series2D]':
