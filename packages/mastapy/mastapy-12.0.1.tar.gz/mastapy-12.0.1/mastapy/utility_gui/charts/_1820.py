...
from mastapy.utility.report import _1709, _1714
...
class NDChartDefinition(_1714.ChartDefinition):
    """NDChartDefinition
    ...
    @property
    def x_axis(self) -> '_1709.AxisSettings':
    ...
    @property
    def y_axis(self) -> '_1709.AxisSettings':
