...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse(_3088.ComponentCompoundSteadyStateSynchronousResponse):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2931.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2931.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
