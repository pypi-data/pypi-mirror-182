...
class ClutchCompoundSteadyStateSynchronousResponse(_3100.CouplingCompoundSteadyStateSynchronousResponse):
    """ClutchCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2953.ClutchSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2953.ClutchSteadyStateSynchronousResponse]':
