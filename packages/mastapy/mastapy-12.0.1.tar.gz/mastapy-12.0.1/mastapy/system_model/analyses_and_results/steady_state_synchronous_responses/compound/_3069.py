...
class AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse(_3097.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2935.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2935.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
