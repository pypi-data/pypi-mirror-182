...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponse(_3102.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3052.TorqueConverterPumpSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3052.TorqueConverterPumpSteadyStateSynchronousResponse]':
