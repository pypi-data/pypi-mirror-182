...
class ExternalCADModelCompoundSteadyStateSynchronousResponse(_3088.ComponentCompoundSteadyStateSynchronousResponse):
    """ExternalCADModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2983.ExternalCADModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2983.ExternalCADModelSteadyStateSynchronousResponse]':
