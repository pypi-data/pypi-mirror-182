...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3079.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3032.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3032.SpiralBevelGearSteadyStateSynchronousResponse]':
