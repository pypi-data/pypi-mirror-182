...
class FaceGearSetCompoundSteadyStateSynchronousResponse(_3123.GearSetCompoundSteadyStateSynchronousResponse):
    """FaceGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2985.FaceGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response(self) -> 'List[_3116.FaceGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3117.FaceGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2985.FaceGearSetSteadyStateSynchronousResponse]':
