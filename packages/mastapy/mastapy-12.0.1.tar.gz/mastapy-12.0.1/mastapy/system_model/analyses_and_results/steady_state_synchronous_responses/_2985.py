...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2986, _2984, _2990
...
class FaceGearSetSteadyStateSynchronousResponse(_2990.GearSetSteadyStateSynchronousResponse):
    """FaceGearSetSteadyStateSynchronousResponse
    ...
    @property
    def face_gears_steady_state_synchronous_response(self) -> 'List[_2986.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response(self) -> 'List[_2984.FaceGearMeshSteadyStateSynchronousResponse]':
