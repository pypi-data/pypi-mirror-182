...
class BeltConnectionCompoundSteadyStateSynchronousResponse(_3128.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """BeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2939.BeltConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2939.BeltConnectionSteadyStateSynchronousResponse]':
