...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3189, _3190, _3081
...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponse(_3081.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3061.ZerolBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3189.ZerolBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3190.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3061.ZerolBevelGearSetSteadyStateSynchronousResponse]':
