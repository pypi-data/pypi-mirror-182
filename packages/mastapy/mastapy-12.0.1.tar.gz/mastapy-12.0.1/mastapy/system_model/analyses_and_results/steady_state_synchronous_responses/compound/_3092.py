...
class ConceptGearCompoundSteadyStateSynchronousResponse(_3121.GearCompoundSteadyStateSynchronousResponse):
    """ConceptGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2961.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2961.ConceptGearSteadyStateSynchronousResponse]':
