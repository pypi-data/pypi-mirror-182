...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3186, _3187, _3123
...
class WormGearSetCompoundSteadyStateSynchronousResponse(_3123.GearSetCompoundSteadyStateSynchronousResponse):
    """WormGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3058.WormGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response(self) -> 'List[_3186.WormGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3187.WormGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3058.WormGearSetSteadyStateSynchronousResponse]':
