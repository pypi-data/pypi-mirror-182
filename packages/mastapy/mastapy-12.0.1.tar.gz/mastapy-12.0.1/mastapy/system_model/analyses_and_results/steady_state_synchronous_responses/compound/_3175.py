...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponse(_3168.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3046.StraightBevelSunGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3046.StraightBevelSunGearSteadyStateSynchronousResponse]':
