...
class PulleyCompoundSteadyStateSynchronousResponse(_3102.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """PulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.PulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.PulleySteadyStateSynchronousResponse]':
