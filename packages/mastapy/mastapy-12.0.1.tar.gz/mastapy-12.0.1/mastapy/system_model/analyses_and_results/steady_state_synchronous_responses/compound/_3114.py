...
class DatumCompoundSteadyStateSynchronousResponse(_3088.ComponentCompoundSteadyStateSynchronousResponse):
    """DatumCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2981.DatumSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2981.DatumSteadyStateSynchronousResponse]':
