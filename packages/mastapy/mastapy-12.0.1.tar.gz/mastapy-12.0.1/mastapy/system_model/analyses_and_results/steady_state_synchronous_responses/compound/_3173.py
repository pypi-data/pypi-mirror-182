...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3171, _3172, _3081
...
class StraightBevelGearSetCompoundSteadyStateSynchronousResponse(_3081.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3043.StraightBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3171.StraightBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3172.StraightBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3043.StraightBevelGearSetSteadyStateSynchronousResponse]':
