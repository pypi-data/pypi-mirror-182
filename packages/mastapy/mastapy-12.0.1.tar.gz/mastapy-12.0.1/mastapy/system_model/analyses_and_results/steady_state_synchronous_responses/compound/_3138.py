...
class MassDiscCompoundSteadyStateSynchronousResponse(_3185.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MassDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3006.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3006.MassDiscSteadyStateSynchronousResponse]':
