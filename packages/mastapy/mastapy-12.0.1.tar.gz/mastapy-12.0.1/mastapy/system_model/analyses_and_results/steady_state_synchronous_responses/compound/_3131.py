...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse(_3097.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2998.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2998.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
