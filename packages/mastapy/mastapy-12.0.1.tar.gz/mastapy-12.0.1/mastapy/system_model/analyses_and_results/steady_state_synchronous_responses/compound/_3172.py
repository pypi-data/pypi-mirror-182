...
class StraightBevelGearMeshCompoundSteadyStateSynchronousResponse(_3080.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3042.StraightBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3042.StraightBevelGearMeshSteadyStateSynchronousResponse]':
