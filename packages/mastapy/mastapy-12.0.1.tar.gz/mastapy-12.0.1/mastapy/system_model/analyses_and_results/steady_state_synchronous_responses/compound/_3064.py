...
class AbstractShaftCompoundSteadyStateSynchronousResponse(_3065.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    """AbstractShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2932.AbstractShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2932.AbstractShaftSteadyStateSynchronousResponse]':
