...
class SynchroniserCompoundSteadyStateSynchronousResponse(_3161.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """SynchroniserCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3050.SynchroniserSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3050.SynchroniserSteadyStateSynchronousResponse]':
