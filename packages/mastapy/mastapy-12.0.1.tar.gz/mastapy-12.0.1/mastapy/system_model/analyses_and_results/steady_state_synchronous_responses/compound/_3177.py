...
class SynchroniserHalfCompoundSteadyStateSynchronousResponse(_3178.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3047.SynchroniserHalfSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3047.SynchroniserHalfSteadyStateSynchronousResponse]':
