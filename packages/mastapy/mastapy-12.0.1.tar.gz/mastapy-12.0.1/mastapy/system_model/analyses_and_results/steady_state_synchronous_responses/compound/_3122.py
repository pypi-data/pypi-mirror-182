...
class GearMeshCompoundSteadyStateSynchronousResponse(_3128.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """GearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2989.GearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2989.GearMeshSteadyStateSynchronousResponse]':
