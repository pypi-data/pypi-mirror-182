...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3005, _3003, _2998
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse(_2998.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3005.KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3003.KlingelnbergCycloPalloidSpiralBevelGearMeshSteadyStateSynchronousResponse]':
