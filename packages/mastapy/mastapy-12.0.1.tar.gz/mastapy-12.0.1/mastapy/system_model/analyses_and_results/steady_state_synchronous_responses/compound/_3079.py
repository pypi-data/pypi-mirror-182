...
class BevelGearCompoundSteadyStateSynchronousResponse(_3067.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2948.BevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2948.BevelGearSteadyStateSynchronousResponse]':
