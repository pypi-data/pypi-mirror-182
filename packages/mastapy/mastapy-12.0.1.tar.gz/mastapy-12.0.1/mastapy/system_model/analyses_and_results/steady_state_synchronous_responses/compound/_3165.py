...
class SpringDamperCompoundSteadyStateSynchronousResponse(_3100.CouplingCompoundSteadyStateSynchronousResponse):
    """SpringDamperCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3035.SpringDamperSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3035.SpringDamperSteadyStateSynchronousResponse]':
