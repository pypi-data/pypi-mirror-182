...
class ConnectorCompoundSteadyStateSynchronousResponse(_3140.MountableComponentCompoundSteadyStateSynchronousResponse):
    """ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2966.ConnectorSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2966.ConnectorSteadyStateSynchronousResponse]':
