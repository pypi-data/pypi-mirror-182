...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponse(_3178.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3049.SynchroniserSleeveSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3049.SynchroniserSleeveSteadyStateSynchronousResponse]':
