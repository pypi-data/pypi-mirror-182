...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse(_3168.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3045.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3045.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
