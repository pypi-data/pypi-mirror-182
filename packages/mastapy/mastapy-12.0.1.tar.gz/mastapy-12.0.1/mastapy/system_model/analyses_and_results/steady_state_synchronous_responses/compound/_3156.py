...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3128.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3023.RollingRingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3023.RollingRingConnectionSteadyStateSynchronousResponse]':
