...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponse(_3100.CouplingCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3013.PartToPartShearCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3013.PartToPartShearCouplingSteadyStateSynchronousResponse]':
