...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3002, _3000, _2998
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_2998.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3002.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_3000.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
