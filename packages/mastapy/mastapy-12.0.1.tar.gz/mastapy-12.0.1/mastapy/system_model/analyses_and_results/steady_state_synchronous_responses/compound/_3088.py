...
class ComponentCompoundSteadyStateSynchronousResponse(_3142.PartCompoundSteadyStateSynchronousResponse):
    """ComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2955.ComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2955.ComponentSteadyStateSynchronousResponse]':
