...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3162, _3163, _3081
...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponse(_3081.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3031.SpiralBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3162.SpiralBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3163.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3031.SpiralBevelGearSetSteadyStateSynchronousResponse]':
