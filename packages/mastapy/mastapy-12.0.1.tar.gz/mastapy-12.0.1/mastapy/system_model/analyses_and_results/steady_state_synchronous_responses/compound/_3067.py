...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse(_3095.ConicalGearCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2936.AGMAGleasonConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2936.AGMAGleasonConicalGearSteadyStateSynchronousResponse]':
