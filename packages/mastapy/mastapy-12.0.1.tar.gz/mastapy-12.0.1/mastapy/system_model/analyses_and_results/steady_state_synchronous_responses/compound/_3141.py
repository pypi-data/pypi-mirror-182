...
class OilSealCompoundSteadyStateSynchronousResponse(_3099.ConnectorCompoundSteadyStateSynchronousResponse):
    """OilSealCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3009.OilSealSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3009.OilSealSteadyStateSynchronousResponse]':
