...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3080
...
class StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse(_3080.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3039.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3039.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
