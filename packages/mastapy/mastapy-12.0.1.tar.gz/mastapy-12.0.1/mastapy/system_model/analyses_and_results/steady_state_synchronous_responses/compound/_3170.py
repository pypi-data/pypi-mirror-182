...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3168, _3169, _3081
...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(_3081.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3040.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(self) -> 'List[_3168.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3169.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3040.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
