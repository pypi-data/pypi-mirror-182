...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponse(_3122.GearMeshCompoundSteadyStateSynchronousResponse):
    """CylindricalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2977.CylindricalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2977.CylindricalGearMeshSteadyStateSynchronousResponse]':
