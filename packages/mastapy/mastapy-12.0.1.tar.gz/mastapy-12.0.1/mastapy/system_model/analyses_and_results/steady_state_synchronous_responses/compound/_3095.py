...
class ConicalGearCompoundSteadyStateSynchronousResponse(_3121.GearCompoundSteadyStateSynchronousResponse):
    """ConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2964.ConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2964.ConicalGearSteadyStateSynchronousResponse]':
