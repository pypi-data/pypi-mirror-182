...
class BevelGearMeshCompoundSteadyStateSynchronousResponse(_3068.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """BevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2946.BevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2946.BevelGearMeshSteadyStateSynchronousResponse]':
