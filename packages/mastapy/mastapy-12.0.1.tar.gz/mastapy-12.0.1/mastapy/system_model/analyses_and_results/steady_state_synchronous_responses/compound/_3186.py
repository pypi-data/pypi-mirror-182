...
class WormGearCompoundSteadyStateSynchronousResponse(_3121.GearCompoundSteadyStateSynchronousResponse):
    """WormGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3059.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3059.WormGearSteadyStateSynchronousResponse]':
