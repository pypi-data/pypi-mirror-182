...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3101.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3051.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3051.TorqueConverterConnectionSteadyStateSynchronousResponse]':
