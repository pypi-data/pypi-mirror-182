...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3125, _3126, _3069
...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(_3069.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """HypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2994.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_3125.HypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3126.HypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2994.HypoidGearSetSteadyStateSynchronousResponse]':
