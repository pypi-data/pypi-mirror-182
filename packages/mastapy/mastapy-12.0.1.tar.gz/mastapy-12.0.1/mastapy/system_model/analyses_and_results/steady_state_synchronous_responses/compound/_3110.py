...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3121.GearCompoundSteadyStateSynchronousResponse):
    """CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2979.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2979.CylindricalGearSteadyStateSynchronousResponse]':
