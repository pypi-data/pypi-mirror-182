...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3079
...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3079.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3062.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3062.ZerolBevelGearSteadyStateSynchronousResponse]':
