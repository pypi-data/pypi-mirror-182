...
class ConceptGearMeshCompoundSteadyStateSynchronousResponse(_3122.GearMeshCompoundSteadyStateSynchronousResponse):
    """ConceptGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2959.ConceptGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2959.ConceptGearMeshSteadyStateSynchronousResponse]':
