...
class ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse(_3080.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3060.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3060.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
