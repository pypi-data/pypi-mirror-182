...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2943, _2941, _2947
...
class BevelDifferentialGearSetSteadyStateSynchronousResponse(_2947.BevelGearSetSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetSteadyStateSynchronousResponse
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response(self) -> 'List[_2943.BevelDifferentialGearSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response(self) -> 'List[_2941.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
