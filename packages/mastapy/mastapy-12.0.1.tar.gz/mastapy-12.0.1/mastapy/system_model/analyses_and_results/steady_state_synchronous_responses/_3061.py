...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3062, _3060, _2947
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2947.BevelGearSetSteadyStateSynchronousResponse):
    """ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3062.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3060.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
