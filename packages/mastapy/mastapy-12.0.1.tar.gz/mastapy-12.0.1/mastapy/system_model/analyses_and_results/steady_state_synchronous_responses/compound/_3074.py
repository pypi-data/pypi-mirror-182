...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponse(_3079.BevelGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2943.BevelDifferentialGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2943.BevelDifferentialGearSteadyStateSynchronousResponse]':
