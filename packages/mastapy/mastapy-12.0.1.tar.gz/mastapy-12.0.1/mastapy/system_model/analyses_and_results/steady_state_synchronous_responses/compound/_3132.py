...
class KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse(_3129.KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3002.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3002.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
