...
class HypoidGearMeshCompoundSteadyStateSynchronousResponse(_3068.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """HypoidGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2993.HypoidGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2993.HypoidGearMeshSteadyStateSynchronousResponse]':
