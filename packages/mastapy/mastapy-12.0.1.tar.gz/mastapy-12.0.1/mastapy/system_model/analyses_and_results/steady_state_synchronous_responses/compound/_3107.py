...
class CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse(_3087.CoaxialConnectionCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2974.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2974.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
