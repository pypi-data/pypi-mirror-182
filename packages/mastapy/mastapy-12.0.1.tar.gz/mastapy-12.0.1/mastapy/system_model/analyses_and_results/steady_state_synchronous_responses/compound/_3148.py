...
class PlanetCarrierCompoundSteadyStateSynchronousResponse(_3140.MountableComponentCompoundSteadyStateSynchronousResponse):
    """PlanetCarrierCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3016.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3016.PlanetCarrierSteadyStateSynchronousResponse]':
