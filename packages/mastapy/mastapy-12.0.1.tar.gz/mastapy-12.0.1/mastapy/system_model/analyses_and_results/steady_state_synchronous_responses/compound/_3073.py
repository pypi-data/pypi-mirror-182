...
class BeltDriveCompoundSteadyStateSynchronousResponse(_3161.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BeltDriveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2940.BeltDriveSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2940.BeltDriveSteadyStateSynchronousResponse]':
