...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3032, _3030, _2947
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2947.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3032.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3030.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
