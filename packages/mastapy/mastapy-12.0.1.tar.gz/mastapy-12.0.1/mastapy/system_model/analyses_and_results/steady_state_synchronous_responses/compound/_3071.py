...
class BearingCompoundSteadyStateSynchronousResponse(_3099.ConnectorCompoundSteadyStateSynchronousResponse):
    """BearingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2938.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2938.BearingSteadyStateSynchronousResponse]':
