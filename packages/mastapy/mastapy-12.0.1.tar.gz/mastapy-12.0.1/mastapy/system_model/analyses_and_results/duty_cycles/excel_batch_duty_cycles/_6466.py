...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6467, _6470, _6469
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6467.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6470.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1565.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6469.ExcelSheetDesignStateSelector]':
