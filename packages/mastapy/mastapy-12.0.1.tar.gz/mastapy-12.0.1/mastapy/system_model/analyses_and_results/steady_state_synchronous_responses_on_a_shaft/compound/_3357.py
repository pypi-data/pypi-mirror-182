...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3227.ConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3227.ConnectionSteadyStateSynchronousResponseOnAShaft]':
