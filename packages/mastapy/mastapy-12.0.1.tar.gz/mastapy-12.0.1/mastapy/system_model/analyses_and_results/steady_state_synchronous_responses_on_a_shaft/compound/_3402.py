...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3359.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3274.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3274.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
