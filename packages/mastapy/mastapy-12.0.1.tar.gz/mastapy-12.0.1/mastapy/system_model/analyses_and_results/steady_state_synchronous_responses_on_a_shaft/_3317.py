...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3318, _3316, _3251
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3251.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3318.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3316.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
