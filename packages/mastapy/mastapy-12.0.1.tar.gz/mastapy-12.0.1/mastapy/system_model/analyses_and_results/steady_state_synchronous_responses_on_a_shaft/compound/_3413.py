...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3420.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3283.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3283.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
