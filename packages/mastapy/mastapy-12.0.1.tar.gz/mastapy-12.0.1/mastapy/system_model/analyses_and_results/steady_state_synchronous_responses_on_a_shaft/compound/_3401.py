...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_7471.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3271.PartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3271.PartSteadyStateSynchronousResponseOnAShaft]':
