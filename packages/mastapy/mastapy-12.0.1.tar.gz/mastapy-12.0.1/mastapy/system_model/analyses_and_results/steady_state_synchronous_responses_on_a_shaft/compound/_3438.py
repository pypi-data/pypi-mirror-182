...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft(_3437.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3308.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3308.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
