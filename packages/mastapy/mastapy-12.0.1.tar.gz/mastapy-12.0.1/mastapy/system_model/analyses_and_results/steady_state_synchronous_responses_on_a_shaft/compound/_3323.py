...
class AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3324.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3194.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3194.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
