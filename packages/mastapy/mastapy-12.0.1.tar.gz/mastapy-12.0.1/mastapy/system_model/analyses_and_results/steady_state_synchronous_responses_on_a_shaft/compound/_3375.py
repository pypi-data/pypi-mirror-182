...
class FaceGearCompoundSteadyStateSynchronousResponseOnAShaft(_3380.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """FaceGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3247.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3247.FaceGearSteadyStateSynchronousResponseOnAShaft]':
