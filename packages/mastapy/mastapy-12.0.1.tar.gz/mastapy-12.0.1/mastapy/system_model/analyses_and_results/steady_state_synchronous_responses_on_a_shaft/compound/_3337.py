...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseOnAShaft(_3333.BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3207.BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3207.BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft]':
