...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft(_3338.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3205.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3205.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
