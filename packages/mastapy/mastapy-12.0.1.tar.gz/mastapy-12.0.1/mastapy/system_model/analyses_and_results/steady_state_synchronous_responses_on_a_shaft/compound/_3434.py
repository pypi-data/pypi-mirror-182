...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft(_3427.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3305.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3305.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]':
