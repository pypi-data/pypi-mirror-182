...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_3427.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3304.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3304.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
