...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3437.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3306.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3306.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
