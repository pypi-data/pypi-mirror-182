...
class CoaxialConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3419.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3216.CoaxialConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3216.CoaxialConnectionSteadyStateSynchronousResponseOnAShaft]':
