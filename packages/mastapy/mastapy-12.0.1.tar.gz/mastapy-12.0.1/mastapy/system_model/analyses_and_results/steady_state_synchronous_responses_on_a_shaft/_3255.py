...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3256, _3254, _3197
...
class HypoidGearSetSteadyStateSynchronousResponseOnAShaft(_3197.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3256.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3254.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
