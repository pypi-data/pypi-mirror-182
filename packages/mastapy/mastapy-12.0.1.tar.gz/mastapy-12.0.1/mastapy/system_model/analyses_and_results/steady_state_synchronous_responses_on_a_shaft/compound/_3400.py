...
class OilSealCompoundSteadyStateSynchronousResponseOnAShaft(_3358.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """OilSealCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3270.OilSealSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3270.OilSealSteadyStateSynchronousResponseOnAShaft]':
