...
class ConceptGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_3381.GearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3221.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3221.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
