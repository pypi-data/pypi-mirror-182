...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3241, _3239, _3251
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3251.GearSetSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3241.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3239.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
