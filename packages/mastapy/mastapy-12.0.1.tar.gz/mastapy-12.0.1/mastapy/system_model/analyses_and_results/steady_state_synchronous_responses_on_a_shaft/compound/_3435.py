...
class SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft(_3420.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3309.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3309.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
