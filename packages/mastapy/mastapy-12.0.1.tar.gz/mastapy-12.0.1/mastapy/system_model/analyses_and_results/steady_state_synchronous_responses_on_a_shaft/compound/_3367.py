...
class CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft(_3323.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3238.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3238.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
