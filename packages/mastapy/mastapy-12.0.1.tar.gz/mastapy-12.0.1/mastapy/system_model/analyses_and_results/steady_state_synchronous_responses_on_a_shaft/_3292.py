...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3293, _3291, _3209
...
class SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3209.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3293.SpiralBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3291.SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
