...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3358.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3287.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3287.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
