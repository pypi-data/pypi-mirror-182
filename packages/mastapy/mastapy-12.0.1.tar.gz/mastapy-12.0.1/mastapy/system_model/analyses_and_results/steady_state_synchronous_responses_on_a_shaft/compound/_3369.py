...
class CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3380.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3241.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3241.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
