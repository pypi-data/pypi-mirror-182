...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3380.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3318.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3318.WormGearSteadyStateSynchronousResponseOnAShaft]':
