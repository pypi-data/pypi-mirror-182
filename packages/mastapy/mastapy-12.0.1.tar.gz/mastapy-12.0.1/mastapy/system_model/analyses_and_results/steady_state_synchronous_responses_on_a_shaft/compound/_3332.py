...
class BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft(_3420.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3202.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3202.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
