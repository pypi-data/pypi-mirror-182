...
class SpiralBevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3338.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3293.SpiralBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3293.SpiralBevelGearSteadyStateSynchronousResponseOnAShaft]':
