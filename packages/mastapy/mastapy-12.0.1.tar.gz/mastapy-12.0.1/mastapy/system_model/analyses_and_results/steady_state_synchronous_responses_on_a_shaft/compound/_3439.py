...
class TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft(_3359.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3312.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3312.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
