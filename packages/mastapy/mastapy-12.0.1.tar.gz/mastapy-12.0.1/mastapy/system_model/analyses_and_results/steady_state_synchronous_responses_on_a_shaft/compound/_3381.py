...
class GearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_3387.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3250.GearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3250.GearMeshSteadyStateSynchronousResponseOnAShaft]':
