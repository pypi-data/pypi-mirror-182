...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3321, _3319, _3209
...
class ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3209.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3321.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3319.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
