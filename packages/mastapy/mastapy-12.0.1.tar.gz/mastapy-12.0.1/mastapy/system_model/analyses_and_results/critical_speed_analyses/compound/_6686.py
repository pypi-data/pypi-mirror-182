...
class PlanetaryGearSetCompoundCriticalSpeedAnalysis(_6651.CylindricalGearSetCompoundCriticalSpeedAnalysis):
    """PlanetaryGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6557.PlanetaryGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6557.PlanetaryGearSetCriticalSpeedAnalysis]':
