...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6667.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6565.RollingRingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6565.RollingRingConnectionCriticalSpeedAnalysis]':
