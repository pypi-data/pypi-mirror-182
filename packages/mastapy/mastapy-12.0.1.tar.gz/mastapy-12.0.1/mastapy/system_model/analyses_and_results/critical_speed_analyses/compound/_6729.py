...
class ZerolBevelGearMeshCompoundCriticalSpeedAnalysis(_6619.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6600.ZerolBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6600.ZerolBevelGearMeshCriticalSpeedAnalysis]':
