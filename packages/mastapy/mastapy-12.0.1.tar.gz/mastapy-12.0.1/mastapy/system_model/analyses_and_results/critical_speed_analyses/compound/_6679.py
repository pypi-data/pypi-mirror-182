...
class MountableComponentCompoundCriticalSpeedAnalysis(_6627.ComponentCompoundCriticalSpeedAnalysis):
    """MountableComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6550.MountableComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6550.MountableComponentCriticalSpeedAnalysis]':
