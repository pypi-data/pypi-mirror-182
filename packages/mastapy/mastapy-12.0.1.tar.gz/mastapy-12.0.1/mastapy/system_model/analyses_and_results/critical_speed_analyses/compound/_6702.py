...
class SpiralBevelGearMeshCompoundCriticalSpeedAnalysis(_6619.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6573.SpiralBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6573.SpiralBevelGearMeshCriticalSpeedAnalysis]':
