...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6707.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6585.StraightBevelSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6585.StraightBevelSunGearCriticalSpeedAnalysis]':
