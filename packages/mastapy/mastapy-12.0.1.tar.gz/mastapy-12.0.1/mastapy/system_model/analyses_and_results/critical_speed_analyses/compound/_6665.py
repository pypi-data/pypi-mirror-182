...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6607.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6536.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6536.HypoidGearMeshCriticalSpeedAnalysis]':
