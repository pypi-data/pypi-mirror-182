...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6604
...
class FEPartCompoundCriticalSpeedAnalysis(_6604.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """FEPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6529.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6529.FEPartCriticalSpeedAnalysis]':
