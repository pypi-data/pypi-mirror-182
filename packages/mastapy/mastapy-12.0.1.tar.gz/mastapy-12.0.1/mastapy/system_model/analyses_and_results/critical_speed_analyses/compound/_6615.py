...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6613, _6614, _6620
...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(_6620.BevelGearSetCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6484.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_critical_speed_analysis(self) -> 'List[_6613.BevelDifferentialGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_critical_speed_analysis(self) -> 'List[_6614.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6484.BevelDifferentialGearSetCriticalSpeedAnalysis]':
