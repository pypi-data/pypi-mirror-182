...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6690.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6515.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6515.CVTPulleyCriticalSpeedAnalysis]':
