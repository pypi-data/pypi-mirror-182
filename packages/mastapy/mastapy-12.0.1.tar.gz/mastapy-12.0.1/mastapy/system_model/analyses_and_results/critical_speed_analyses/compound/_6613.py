...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6618.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6482.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6482.BevelDifferentialGearCriticalSpeedAnalysis]':
