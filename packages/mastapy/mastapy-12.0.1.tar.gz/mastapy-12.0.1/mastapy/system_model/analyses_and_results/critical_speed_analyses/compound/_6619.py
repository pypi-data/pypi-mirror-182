...
class BevelGearMeshCompoundCriticalSpeedAnalysis(_6607.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """BevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6488.BevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6488.BevelGearMeshCriticalSpeedAnalysis]':
