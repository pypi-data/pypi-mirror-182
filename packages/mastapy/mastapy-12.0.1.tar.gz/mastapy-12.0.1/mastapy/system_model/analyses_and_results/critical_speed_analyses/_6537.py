...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6535, _6536, _6477
...
class HypoidGearSetCriticalSpeedAnalysis(_6477.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    """HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6535.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6536.HypoidGearMeshCriticalSpeedAnalysis]':
