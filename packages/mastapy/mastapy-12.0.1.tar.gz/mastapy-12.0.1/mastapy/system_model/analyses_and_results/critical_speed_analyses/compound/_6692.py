...
class RingPinsToDiscConnectionCompoundCriticalSpeedAnalysis(_6667.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """RingPinsToDiscConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6563.RingPinsToDiscConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6563.RingPinsToDiscConnectionCriticalSpeedAnalysis]':
