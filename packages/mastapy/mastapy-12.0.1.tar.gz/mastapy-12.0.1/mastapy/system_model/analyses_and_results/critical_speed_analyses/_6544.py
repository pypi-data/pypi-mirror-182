...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6542, _6543, _6541
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6541.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6542.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6543.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
