...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6660.GearCompoundCriticalSpeedAnalysis):
    """CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6520.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6520.CylindricalGearCriticalSpeedAnalysis]':
