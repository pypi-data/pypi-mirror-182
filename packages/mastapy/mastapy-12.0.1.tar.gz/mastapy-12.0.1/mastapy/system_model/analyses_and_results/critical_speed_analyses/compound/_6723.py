...
class UnbalancedMassCompoundCriticalSpeedAnalysis(_6724.VirtualComponentCompoundCriticalSpeedAnalysis):
    """UnbalancedMassCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6594.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6594.UnbalancedMassCriticalSpeedAnalysis]':
