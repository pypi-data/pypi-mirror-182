...
class PointLoadCompoundCriticalSpeedAnalysis(_6724.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PointLoadCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6559.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6559.PointLoadCriticalSpeedAnalysis]':
