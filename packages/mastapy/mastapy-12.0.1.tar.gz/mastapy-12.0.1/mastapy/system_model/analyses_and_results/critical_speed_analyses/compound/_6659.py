...
class FlexiblePinAssemblyCompoundCriticalSpeedAnalysis(_6700.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """FlexiblePinAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6530.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6530.FlexiblePinAssemblyCriticalSpeedAnalysis]':
