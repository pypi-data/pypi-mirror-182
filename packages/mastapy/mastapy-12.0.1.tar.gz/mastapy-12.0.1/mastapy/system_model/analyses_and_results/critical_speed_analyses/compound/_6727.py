...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6725, _6726, _6662
...
class WormGearSetCompoundCriticalSpeedAnalysis(_6662.GearSetCompoundCriticalSpeedAnalysis):
    """WormGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6598.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gears_compound_critical_speed_analysis(self) -> 'List[_6725.WormGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_compound_critical_speed_analysis(self) -> 'List[_6726.WormGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6598.WormGearSetCriticalSpeedAnalysis]':
