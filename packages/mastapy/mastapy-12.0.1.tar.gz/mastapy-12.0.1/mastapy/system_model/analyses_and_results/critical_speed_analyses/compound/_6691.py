...
class RingPinsCompoundCriticalSpeedAnalysis(_6679.MountableComponentCompoundCriticalSpeedAnalysis):
    """RingPinsCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6562.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6562.RingPinsCriticalSpeedAnalysis]':
