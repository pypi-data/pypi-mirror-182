...
class CoaxialConnectionCompoundCriticalSpeedAnalysis(_6699.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CoaxialConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6495.CoaxialConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6495.CoaxialConnectionCriticalSpeedAnalysis]':
