...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6661.GearMeshCompoundCriticalSpeedAnalysis):
    """ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6504.ConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6504.ConicalGearMeshCriticalSpeedAnalysis]':
