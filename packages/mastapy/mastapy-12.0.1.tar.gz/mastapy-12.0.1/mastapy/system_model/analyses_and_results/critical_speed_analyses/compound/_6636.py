...
class ConicalGearSetCompoundCriticalSpeedAnalysis(_6662.GearSetCompoundCriticalSpeedAnalysis):
    """ConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6505.ConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6505.ConicalGearSetCriticalSpeedAnalysis]':
