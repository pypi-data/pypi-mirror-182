...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6681.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6471.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6471.AbstractAssemblyCriticalSpeedAnalysis]':
