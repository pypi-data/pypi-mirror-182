...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6728, _6729, _6620
...
class ZerolBevelGearSetCompoundCriticalSpeedAnalysis(_6620.BevelGearSetCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6601.ZerolBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6728.ZerolBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6729.ZerolBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6601.ZerolBevelGearSetCriticalSpeedAnalysis]':
