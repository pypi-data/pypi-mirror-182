...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6500, _6501, _6533
...
class ConceptGearSetCriticalSpeedAnalysis(_6533.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6500.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6501.ConceptGearMeshCriticalSpeedAnalysis]':
