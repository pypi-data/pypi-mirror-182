...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6655, _6656, _6662
...
class FaceGearSetCompoundCriticalSpeedAnalysis(_6662.GearSetCompoundCriticalSpeedAnalysis):
    """FaceGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6528.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def face_gears_compound_critical_speed_analysis(self) -> 'List[_6655.FaceGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_compound_critical_speed_analysis(self) -> 'List[_6656.FaceGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6528.FaceGearSetCriticalSpeedAnalysis]':
