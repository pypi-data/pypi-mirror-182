...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import (
    _6610, _6612, _6615, _6622,
    _6621, _6643, _6623, _6628,
    _6633, _6645, _6647, _6651,
    _6658, _6657, _6659, _6666,
    _6673, _6676, _6677, _6678,
    _6680, _6682, _6687, _6688,
    _6689, _6691, _6693, _6698,
    _6697, _6703, _6704, _6709,
    _6712, _6715, _6719, _6723,
    _6727, _6730, _6602
)
...
class AssemblyCompoundCriticalSpeedAnalysis(_6602.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """AssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6478.AssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6610.BearingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6612.BeltDriveCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6615.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6622.BoltedJointCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6621.BoltCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6643.CVTCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6623.ClutchCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6628.ConceptCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6633.ConceptGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6645.CycloidalAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6647.CycloidalDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6651.CylindricalGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6658.FEPartCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6657.FaceGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6659.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6666.HypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6673.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6676.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6677.MassDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6678.MeasurementComponentCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6680.OilSealCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6682.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6687.PlanetCarrierCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6688.PointLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6689.PowerLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6691.RingPinsCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6693.RollingRingAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6698.ShaftHubConnectionCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6697.ShaftCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6703.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6704.SpringDamperCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6709.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6712.StraightBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6715.SynchroniserCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6719.TorqueConverterCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6723.UnbalancedMassCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6727.WormGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6730.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6478.AssemblyCriticalSpeedAnalysis]':
