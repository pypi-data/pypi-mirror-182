...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6482, _6483, _6489
...
class BevelDifferentialGearSetCriticalSpeedAnalysis(_6489.BevelGearSetCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCriticalSpeedAnalysis
    ...
    @property
    def bevel_differential_gears_critical_speed_analysis(self) -> 'List[_6482.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_critical_speed_analysis(self) -> 'List[_6483.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
