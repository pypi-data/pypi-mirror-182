...
class TorqueConverterTurbineCompoundCriticalSpeedAnalysis(_6641.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterTurbineCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6593.TorqueConverterTurbineCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6593.TorqueConverterTurbineCriticalSpeedAnalysis]':
