...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6671, _6672, _6670
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis(_6670.KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6544.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6671.KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6672.KlingelnbergCycloPalloidHypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6544.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
