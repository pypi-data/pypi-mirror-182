...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(_6638.ConnectorCompoundCriticalSpeedAnalysis):
    """ShaftHubConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6569.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6569.ShaftHubConnectionCriticalSpeedAnalysis]':
