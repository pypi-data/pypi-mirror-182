...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6545, _6546, _6541
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis(_6541.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6545.KlingelnbergCycloPalloidSpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6546.KlingelnbergCycloPalloidSpiralBevelGearMeshCriticalSpeedAnalysis]':
