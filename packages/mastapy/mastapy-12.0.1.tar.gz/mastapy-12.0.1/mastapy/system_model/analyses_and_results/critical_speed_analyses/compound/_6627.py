...
class ComponentCompoundCriticalSpeedAnalysis(_6681.PartCompoundCriticalSpeedAnalysis):
    """ComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6496.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6496.ComponentCriticalSpeedAnalysis]':
