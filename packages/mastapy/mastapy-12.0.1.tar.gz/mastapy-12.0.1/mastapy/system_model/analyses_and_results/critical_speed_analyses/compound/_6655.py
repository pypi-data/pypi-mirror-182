...
class FaceGearCompoundCriticalSpeedAnalysis(_6660.GearCompoundCriticalSpeedAnalysis):
    """FaceGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6526.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6526.FaceGearCriticalSpeedAnalysis]':
