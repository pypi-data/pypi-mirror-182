...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6572, _6573, _6489
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6489.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6572.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6573.SpiralBevelGearMeshCriticalSpeedAnalysis]':
