...
class PartCompoundCriticalSpeedAnalysis(_7471.PartCompoundAnalysis):
    """PartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6552.PartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6552.PartCriticalSpeedAnalysis]':
