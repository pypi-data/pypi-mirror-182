...
class BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis(_6619.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6483.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6483.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
