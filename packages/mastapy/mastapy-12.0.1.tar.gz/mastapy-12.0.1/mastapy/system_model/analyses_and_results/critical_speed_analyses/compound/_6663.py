...
class GuideDxfModelCompoundCriticalSpeedAnalysis(_6627.ComponentCompoundCriticalSpeedAnalysis):
    """GuideDxfModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6534.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6534.GuideDxfModelCriticalSpeedAnalysis]':
