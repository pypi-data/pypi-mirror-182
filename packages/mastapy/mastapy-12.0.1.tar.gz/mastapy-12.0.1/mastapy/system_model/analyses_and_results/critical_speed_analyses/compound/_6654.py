...
class ExternalCADModelCompoundCriticalSpeedAnalysis(_6627.ComponentCompoundCriticalSpeedAnalysis):
    """ExternalCADModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6525.ExternalCADModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6525.ExternalCADModelCriticalSpeedAnalysis]':
