...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6604.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6472.AbstractShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6472.AbstractShaftCriticalSpeedAnalysis]':
