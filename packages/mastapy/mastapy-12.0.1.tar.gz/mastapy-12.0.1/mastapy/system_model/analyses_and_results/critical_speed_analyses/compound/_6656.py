...
class FaceGearMeshCompoundCriticalSpeedAnalysis(_6661.GearMeshCompoundCriticalSpeedAnalysis):
    """FaceGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6527.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6527.FaceGearMeshCriticalSpeedAnalysis]':
