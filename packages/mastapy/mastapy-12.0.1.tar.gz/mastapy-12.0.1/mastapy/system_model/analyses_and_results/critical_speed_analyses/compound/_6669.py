...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6635
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6635.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6540.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6540.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
