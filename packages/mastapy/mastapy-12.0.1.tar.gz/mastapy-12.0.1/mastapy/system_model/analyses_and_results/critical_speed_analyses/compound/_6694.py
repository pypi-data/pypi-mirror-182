...
class RollingRingCompoundCriticalSpeedAnalysis(_6641.CouplingHalfCompoundCriticalSpeedAnalysis):
    """RollingRingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6566.RollingRingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6566.RollingRingCriticalSpeedAnalysis]':
