...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6710, _6711, _6620
...
class StraightBevelGearSetCompoundCriticalSpeedAnalysis(_6620.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6583.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6710.StraightBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6711.StraightBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6583.StraightBevelGearSetCriticalSpeedAnalysis]':
