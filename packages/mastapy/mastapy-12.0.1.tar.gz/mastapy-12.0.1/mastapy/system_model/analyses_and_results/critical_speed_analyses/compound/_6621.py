...
class BoltCompoundCriticalSpeedAnalysis(_6627.ComponentCompoundCriticalSpeedAnalysis):
    """BoltCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6490.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6490.BoltCriticalSpeedAnalysis]':
