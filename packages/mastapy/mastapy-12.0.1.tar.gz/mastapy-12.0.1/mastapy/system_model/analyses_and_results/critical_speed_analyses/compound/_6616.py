...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6613.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6485.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6485.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
