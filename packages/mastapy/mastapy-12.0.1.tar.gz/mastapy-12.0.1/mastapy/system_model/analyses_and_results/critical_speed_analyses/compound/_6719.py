...
class TorqueConverterCompoundCriticalSpeedAnalysis(_6639.CouplingCompoundCriticalSpeedAnalysis):
    """TorqueConverterCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6591.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6591.TorqueConverterCriticalSpeedAnalysis]':
