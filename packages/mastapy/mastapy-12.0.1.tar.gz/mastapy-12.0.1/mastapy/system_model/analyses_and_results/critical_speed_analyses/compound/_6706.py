...
class SpringDamperHalfCompoundCriticalSpeedAnalysis(_6641.CouplingHalfCompoundCriticalSpeedAnalysis):
    """SpringDamperHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6577.SpringDamperHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6577.SpringDamperHalfCriticalSpeedAnalysis]':
