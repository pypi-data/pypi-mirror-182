...
class CouplingConnectionCompoundCriticalSpeedAnalysis(_6667.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6508.CouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6508.CouplingConnectionCriticalSpeedAnalysis]':
