...
class AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis(_6636.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6477.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6477.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
