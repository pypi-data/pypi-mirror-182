...
class StraightBevelDiffGearCompoundCriticalSpeedAnalysis(_6618.BevelGearCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6578.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6578.StraightBevelDiffGearCriticalSpeedAnalysis]':
