...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(_6611.BeltConnectionCompoundCriticalSpeedAnalysis):
    """CVTBeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6513.CVTBeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6513.CVTBeltConnectionCriticalSpeedAnalysis]':
