...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6619
...
class StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis(_6619.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6579.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6579.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
