...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6664, _6665, _6608
...
class HypoidGearSetCompoundCriticalSpeedAnalysis(_6608.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """HypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6537.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6664.HypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6665.HypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6537.HypoidGearSetCriticalSpeedAnalysis]':
