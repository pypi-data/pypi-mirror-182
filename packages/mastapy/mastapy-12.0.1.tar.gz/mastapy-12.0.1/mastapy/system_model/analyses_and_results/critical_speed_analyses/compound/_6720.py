...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6640.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6590.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6590.TorqueConverterConnectionCriticalSpeedAnalysis]':
