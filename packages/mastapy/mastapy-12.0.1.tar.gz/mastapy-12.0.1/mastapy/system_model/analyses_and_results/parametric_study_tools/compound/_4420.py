...
class ConicalGearSetCompoundParametricStudyTool(_4446.GearSetCompoundParametricStudyTool):
    """ConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4273.ConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4273.ConicalGearSetParametricStudyTool]':
