...
class StraightBevelSunGearCompoundParametricStudyTool(_4491.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4369.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4369.StraightBevelSunGearParametricStudyTool]':
