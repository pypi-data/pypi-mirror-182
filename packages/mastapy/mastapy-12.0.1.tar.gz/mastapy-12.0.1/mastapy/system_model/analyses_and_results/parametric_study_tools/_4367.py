...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4366, _4365, _4257
...
class StraightBevelGearSetParametricStudyTool(_4257.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4366.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4365.StraightBevelGearMeshParametricStudyTool]':
