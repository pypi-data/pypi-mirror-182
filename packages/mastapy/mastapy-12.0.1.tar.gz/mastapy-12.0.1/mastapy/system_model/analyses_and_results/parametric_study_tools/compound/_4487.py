...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4485, _4486, _4404
...
class SpiralBevelGearSetCompoundParametricStudyTool(_4404.BevelGearSetCompoundParametricStudyTool):
    """SpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4358.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4485.SpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4486.SpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4358.SpiralBevelGearSetParametricStudyTool]':
