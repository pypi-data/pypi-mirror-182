...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5596, _5595, _5597, _5600,
    _5601, _5604, _5608
)
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4332, _4333, _4351
...
class RootAssemblyCompoundParametricStudyTool(_4393.AssemblyCompoundParametricStudyTool):
    """RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def compound_load_case(self) -> '_5596.AbstractLoadCaseGroup':
        ...
        if _5596.AbstractLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_design_state_load_case_group(self) -> '_5595.AbstractDesignStateLoadCaseGroup':
        ...
        if _5595.AbstractDesignStateLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_static_load_case_group(self) -> '_5597.AbstractStaticLoadCaseGroup':
        ...
        if _5597.AbstractStaticLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_design_state(self) -> '_5600.DesignState':
        ...
        if _5600.DesignState.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_duty_cycle(self) -> '_5601.DutyCycle':
        ...
        if _5601.DutyCycle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_sub_group_in_single_design_state(self) -> '_5604.SubGroupInSingleDesignState':
        ...
        if _5604.SubGroupInSingleDesignState.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_time_series_load_case_group(self) -> '_5608.TimeSeriesLoadCaseGroup':
        ...
        if _5608.TimeSeriesLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parametric_analysis_options(self) -> '_4332.ParametricStudyToolOptions':
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2850.DutyCycleEfficiencyResults':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4351.RootAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4351.RootAssemblyParametricStudyTool]':
