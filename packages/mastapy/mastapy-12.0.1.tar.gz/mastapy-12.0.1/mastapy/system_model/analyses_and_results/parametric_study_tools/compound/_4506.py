...
class TorqueConverterTurbineCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterTurbineCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4377.TorqueConverterTurbineParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4377.TorqueConverterTurbineParametricStudyTool]':
