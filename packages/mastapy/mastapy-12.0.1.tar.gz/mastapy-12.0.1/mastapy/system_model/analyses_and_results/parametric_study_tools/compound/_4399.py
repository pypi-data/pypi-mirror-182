...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4397, _4398, _4404
...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4404.BevelGearSetCompoundParametricStudyTool):
    """BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4252.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4397.BevelDifferentialGearCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4398.BevelDifferentialGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4252.BevelDifferentialGearSetParametricStudyTool]':
