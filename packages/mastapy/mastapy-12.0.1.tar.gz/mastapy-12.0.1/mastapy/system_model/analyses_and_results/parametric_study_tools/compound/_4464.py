...
class OilSealCompoundParametricStudyTool(_4422.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4325.OilSealParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4325.OilSealParametricStudyTool]':
