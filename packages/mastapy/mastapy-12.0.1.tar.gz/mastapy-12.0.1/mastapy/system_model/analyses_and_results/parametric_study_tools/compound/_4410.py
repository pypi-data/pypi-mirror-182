...
class CoaxialConnectionCompoundParametricStudyTool(_4483.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CoaxialConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4263.CoaxialConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4263.CoaxialConnectionParametricStudyTool]':
