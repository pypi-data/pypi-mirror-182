...
class CylindricalPlanetGearCompoundParametricStudyTool(_4433.CylindricalGearCompoundParametricStudyTool):
    """CylindricalPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4289.CylindricalPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4289.CylindricalPlanetGearParametricStudyTool]':
