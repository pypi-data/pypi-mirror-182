...
class SpringDamperConnectionCompoundParametricStudyTool(_4424.CouplingConnectionCompoundParametricStudyTool):
    """SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4359.SpringDamperConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4359.SpringDamperConnectionParametricStudyTool]':
