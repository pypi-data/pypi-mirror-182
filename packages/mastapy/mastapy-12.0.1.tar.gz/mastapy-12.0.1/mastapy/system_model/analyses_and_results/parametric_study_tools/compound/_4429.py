...
class CycloidalAssemblyCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """CycloidalAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4282.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4282.CycloidalAssemblyParametricStudyTool]':
