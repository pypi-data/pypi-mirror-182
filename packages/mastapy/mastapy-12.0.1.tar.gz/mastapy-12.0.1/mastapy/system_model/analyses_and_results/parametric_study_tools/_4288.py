...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4287, _4286, _4306
...
class CylindricalGearSetParametricStudyTool(_4306.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2689.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4287.CylindricalGearParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4286.CylindricalGearMeshParametricStudyTool]':
