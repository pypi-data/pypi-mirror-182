...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4421.ConnectionCompoundParametricStudyTool):
    """AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4242.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4242.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
