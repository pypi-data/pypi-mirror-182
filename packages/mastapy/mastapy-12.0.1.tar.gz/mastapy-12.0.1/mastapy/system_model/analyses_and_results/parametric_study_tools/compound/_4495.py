...
class StraightBevelGearMeshCompoundParametricStudyTool(_4403.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4365.StraightBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4365.StraightBevelGearMeshParametricStudyTool]':
