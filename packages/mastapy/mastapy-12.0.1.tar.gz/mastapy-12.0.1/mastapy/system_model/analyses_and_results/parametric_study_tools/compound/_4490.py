...
class SpringDamperHalfCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """SpringDamperHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4360.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4360.SpringDamperHalfParametricStudyTool]':
