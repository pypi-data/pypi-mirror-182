...
class CylindricalGearMeshParametricStudyTool(_4304.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2686.CylindricalGearMeshSystemDeflection]':
