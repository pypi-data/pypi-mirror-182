...
class CouplingHalfCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """CouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4277.CouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4277.CouplingHalfParametricStudyTool]':
