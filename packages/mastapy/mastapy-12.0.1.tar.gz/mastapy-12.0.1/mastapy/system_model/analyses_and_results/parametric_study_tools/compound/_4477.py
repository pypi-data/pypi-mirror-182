...
class RollingRingAssemblyCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4348.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4348.RollingRingAssemblyParametricStudyTool]':
