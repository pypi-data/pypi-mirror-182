...
class ClutchCompoundParametricStudyTool(_4423.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4262.ClutchParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4262.ClutchParametricStudyTool]':
