...
class ShaftToMountableComponentConnectionCompoundParametricStudyTool(_4389.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """ShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4354.ShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4354.ShaftToMountableComponentConnectionParametricStudyTool]':
