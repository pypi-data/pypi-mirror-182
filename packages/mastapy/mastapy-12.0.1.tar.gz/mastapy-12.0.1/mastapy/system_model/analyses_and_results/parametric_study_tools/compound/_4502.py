...
class SynchroniserSleeveCompoundParametricStudyTool(_4501.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4373.SynchroniserSleeveParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4373.SynchroniserSleeveParametricStudyTool]':
