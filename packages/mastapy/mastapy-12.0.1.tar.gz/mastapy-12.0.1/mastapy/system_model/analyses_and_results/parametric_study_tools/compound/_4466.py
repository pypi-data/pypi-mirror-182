...
class PartToPartShearCouplingCompoundParametricStudyTool(_4423.CouplingCompoundParametricStudyTool):
    """PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4339.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4339.PartToPartShearCouplingParametricStudyTool]':
