...
class BearingCompoundParametricStudyTool(_4422.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1909.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4247.BearingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4247.BearingParametricStudyTool]':
