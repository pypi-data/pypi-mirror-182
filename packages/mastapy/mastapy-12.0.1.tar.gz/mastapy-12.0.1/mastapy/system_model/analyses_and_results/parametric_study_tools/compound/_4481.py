...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4387
...
class ShaftCompoundParametricStudyTool(_4387.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4353.ShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4353.ShaftParametricStudyTool]':
