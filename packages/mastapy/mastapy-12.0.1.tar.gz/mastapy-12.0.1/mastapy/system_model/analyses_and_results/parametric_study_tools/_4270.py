...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4269, _4268, _4306
...
class ConceptGearSetParametricStudyTool(_4306.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4269.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4268.ConceptGearMeshParametricStudyTool]':
