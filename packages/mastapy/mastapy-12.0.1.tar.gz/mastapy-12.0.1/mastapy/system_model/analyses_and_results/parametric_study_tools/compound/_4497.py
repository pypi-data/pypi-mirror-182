...
class StraightBevelPlanetGearCompoundParametricStudyTool(_4491.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4368.StraightBevelPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4368.StraightBevelPlanetGearParametricStudyTool]':
