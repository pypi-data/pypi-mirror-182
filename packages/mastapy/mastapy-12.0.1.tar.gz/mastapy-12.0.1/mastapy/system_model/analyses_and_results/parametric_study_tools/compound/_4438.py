...
class ExternalCADModelCompoundParametricStudyTool(_4411.ComponentCompoundParametricStudyTool):
    """ExternalCADModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4298.ExternalCADModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4298.ExternalCADModelParametricStudyTool]':
