...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4326, _4323, _4291
...
class ParametricStudyVariable(_2600.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4326.ParametricStudyDimension':
        ...
        return constructor.new_from_mastapy_type(_4326.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4326.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4323.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4323.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4323.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4291.DesignOfExperimentsVariableSetter':
