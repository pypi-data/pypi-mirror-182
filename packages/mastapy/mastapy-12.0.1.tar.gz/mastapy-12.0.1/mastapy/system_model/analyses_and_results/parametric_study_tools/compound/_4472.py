...
class PointLoadCompoundParametricStudyTool(_4508.VirtualComponentCompoundParametricStudyTool):
    """PointLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4343.PointLoadParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4343.PointLoadParametricStudyTool]':
