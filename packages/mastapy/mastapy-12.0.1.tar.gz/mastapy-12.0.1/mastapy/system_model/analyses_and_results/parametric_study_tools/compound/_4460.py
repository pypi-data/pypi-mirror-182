...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4458, _4459, _4454
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool(_4454.KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4320.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4458.KlingelnbergCycloPalloidSpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4459.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4320.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
