...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4381, _4380, _4306
...
class WormGearSetParametricStudyTool(_4306.GearSetParametricStudyTool):
    """WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4381.WormGearParametricStudyTool]':
    ...
    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4380.WormGearMeshParametricStudyTool]':
