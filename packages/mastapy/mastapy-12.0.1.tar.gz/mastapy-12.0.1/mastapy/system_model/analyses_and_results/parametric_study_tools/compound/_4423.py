...
class CouplingCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """CouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4278.CouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4278.CouplingParametricStudyTool]':
