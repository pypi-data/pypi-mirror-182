...
class RollingRingCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4350.RollingRingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4350.RollingRingParametricStudyTool]':
