...
class VirtualComponentCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """VirtualComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4379.VirtualComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4379.VirtualComponentParametricStudyTool]':
