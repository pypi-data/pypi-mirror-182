...
class SynchroniserPartCompoundParametricStudyTool(_4425.CouplingHalfCompoundParametricStudyTool):
    """SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4372.SynchroniserPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4372.SynchroniserPartParametricStudyTool]':
