...
class ConnectorCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4275.ConnectorParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4275.ConnectorParametricStudyTool]':
