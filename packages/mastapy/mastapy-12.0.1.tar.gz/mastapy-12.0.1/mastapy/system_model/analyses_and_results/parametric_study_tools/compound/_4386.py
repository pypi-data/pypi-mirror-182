...
class AbstractAssemblyCompoundParametricStudyTool(_4465.PartCompoundParametricStudyTool):
    """AbstractAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4239.AbstractAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4239.AbstractAssemblyParametricStudyTool]':
