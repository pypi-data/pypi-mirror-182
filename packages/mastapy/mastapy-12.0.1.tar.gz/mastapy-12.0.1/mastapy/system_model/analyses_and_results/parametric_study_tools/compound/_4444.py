...
class GearCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """GearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4305.GearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4305.GearParametricStudyTool]':
