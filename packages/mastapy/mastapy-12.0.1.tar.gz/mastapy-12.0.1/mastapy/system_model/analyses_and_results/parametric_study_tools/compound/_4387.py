...
class AbstractShaftCompoundParametricStudyTool(_4388.AbstractShaftOrHousingCompoundParametricStudyTool):
    """AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4241.AbstractShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4241.AbstractShaftParametricStudyTool]':
