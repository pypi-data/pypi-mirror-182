...
class RollingRingConnectionCompoundParametricStudyTool(_4451.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4349.RollingRingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4349.RollingRingConnectionParametricStudyTool]':
