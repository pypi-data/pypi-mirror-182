...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4451.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4347.RingPinsToDiscConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4347.RingPinsToDiscConnectionParametricStudyTool]':
