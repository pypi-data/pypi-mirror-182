...
class PlanetCarrierCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4342.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4342.PlanetCarrierParametricStudyTool]':
