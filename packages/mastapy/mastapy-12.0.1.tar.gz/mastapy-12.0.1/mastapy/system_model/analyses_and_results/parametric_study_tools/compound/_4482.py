...
class ShaftHubConnectionCompoundParametricStudyTool(_4422.ConnectorCompoundParametricStudyTool):
    """ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4352.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4352.ShaftHubConnectionParametricStudyTool]':
