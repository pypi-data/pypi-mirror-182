...
class BevelGearCompoundParametricStudyTool(_4390.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4256.BevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4256.BevelGearParametricStudyTool]':
