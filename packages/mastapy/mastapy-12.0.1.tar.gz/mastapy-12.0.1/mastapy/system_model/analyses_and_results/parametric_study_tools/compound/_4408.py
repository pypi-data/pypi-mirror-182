...
class ClutchConnectionCompoundParametricStudyTool(_4424.CouplingConnectionCompoundParametricStudyTool):
    """ClutchConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4260.ClutchConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4260.ClutchConnectionParametricStudyTool]':
