...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4357, _4356, _4257
...
class SpiralBevelGearSetParametricStudyTool(_4257.BevelGearSetParametricStudyTool):
    """SpiralBevelGearSetParametricStudyTool
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4357.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4356.SpiralBevelGearMeshParametricStudyTool]':
