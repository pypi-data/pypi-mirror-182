...
class RingPinsCompoundParametricStudyTool(_4463.MountableComponentCompoundParametricStudyTool):
    """RingPinsCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4346.RingPinsParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4346.RingPinsParametricStudyTool]':
