...
class WormGearMeshCompoundParametricStudyTool(_4445.GearMeshCompoundParametricStudyTool):
    """WormGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4380.WormGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4380.WormGearMeshParametricStudyTool]':
