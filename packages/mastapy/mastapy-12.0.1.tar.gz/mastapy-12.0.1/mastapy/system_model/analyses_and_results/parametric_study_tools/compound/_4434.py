...
class CylindricalGearMeshCompoundParametricStudyTool(_4445.GearMeshCompoundParametricStudyTool):
    """CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4286.CylindricalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4286.CylindricalGearMeshParametricStudyTool]':
