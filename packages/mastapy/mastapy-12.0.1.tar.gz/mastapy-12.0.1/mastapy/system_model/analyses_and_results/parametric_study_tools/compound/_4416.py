...
class ConceptGearMeshCompoundParametricStudyTool(_4445.GearMeshCompoundParametricStudyTool):
    """ConceptGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4268.ConceptGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4268.ConceptGearMeshParametricStudyTool]':
