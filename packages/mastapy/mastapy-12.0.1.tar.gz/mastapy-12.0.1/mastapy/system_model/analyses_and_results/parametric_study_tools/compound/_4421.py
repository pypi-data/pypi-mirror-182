...
class ConnectionCompoundParametricStudyTool(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4274.ConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4274.ConnectionParametricStudyTool]':
