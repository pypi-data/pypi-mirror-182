...
class TorqueConverterCompoundParametricStudyTool(_4423.CouplingCompoundParametricStudyTool):
    """TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4375.TorqueConverterParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4375.TorqueConverterParametricStudyTool]':
