...
class BearingParametricStudyTool(_4275.ConnectorParametricStudyTool):
    """BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1909.LoadedBearingDutyCycle]':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2645.BearingSystemDeflection]':
