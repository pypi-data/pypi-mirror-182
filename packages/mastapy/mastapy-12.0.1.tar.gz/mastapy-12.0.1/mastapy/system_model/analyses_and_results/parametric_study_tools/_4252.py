...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4251, _4250, _4257
...
class BevelDifferentialGearSetParametricStudyTool(_4257.BevelGearSetParametricStudyTool):
    """BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4251.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4250.BevelDifferentialGearMeshParametricStudyTool]':
