...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4421.ConnectionCompoundParametricStudyTool):
    """InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4311.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4311.InterMountableComponentConnectionParametricStudyTool]':
