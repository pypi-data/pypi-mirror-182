...
class GearSetCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """GearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4306.GearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4306.GearSetParametricStudyTool]':
