...
class SpiralBevelGearCompoundParametricStudyTool(_4402.BevelGearCompoundParametricStudyTool):
    """SpiralBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4357.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4357.SpiralBevelGearParametricStudyTool]':
