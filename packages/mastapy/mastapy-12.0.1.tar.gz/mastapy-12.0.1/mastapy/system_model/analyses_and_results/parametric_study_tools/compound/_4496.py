...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4494, _4495, _4404
...
class StraightBevelGearSetCompoundParametricStudyTool(_4404.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4367.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4494.StraightBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4495.StraightBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4367.StraightBevelGearSetParametricStudyTool]':
