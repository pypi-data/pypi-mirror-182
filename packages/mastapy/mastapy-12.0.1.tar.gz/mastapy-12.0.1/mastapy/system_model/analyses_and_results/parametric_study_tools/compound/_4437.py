...
class DatumCompoundParametricStudyTool(_4411.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4290.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4290.DatumParametricStudyTool]':
