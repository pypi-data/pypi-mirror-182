...
class BeltDriveCompoundParametricStudyTool(_4484.SpecialisedAssemblyCompoundParametricStudyTool):
    """BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4249.BeltDriveParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4249.BeltDriveParametricStudyTool]':
