...
from mastapy.system_model.analyses_and_results.static_loads import _6864, _6908
...
class PointLoadLoadCase(_6908.VirtualComponentLoadCase):
    """PointLoadLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6864.PointLoadHarmonicLoadData':
