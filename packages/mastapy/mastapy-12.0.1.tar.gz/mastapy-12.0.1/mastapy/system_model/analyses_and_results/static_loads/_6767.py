...
class ConceptCouplingLoadCase(_6780.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_2159.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2159.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value is not None else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_2159.ConceptCouplingSpeedRatioSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedRatioSpecificationMethod = value

    @property
    def speed_ratio_vs_time(self) -> '_1498.Vector2DListAccessor':
    ...
    @property
    def assembly_design(self) -> '_2533.ConceptCoupling':
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1541.PIDControlSettings':
