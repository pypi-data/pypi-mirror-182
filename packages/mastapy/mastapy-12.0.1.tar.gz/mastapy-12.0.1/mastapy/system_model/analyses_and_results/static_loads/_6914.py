...
from mastapy.system_model.analyses_and_results.static_loads import _6912, _6913, _6757
...
class ZerolBevelGearSetLoadCase(_6757.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6912.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6912.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6913.ZerolBevelGearMeshLoadCase]':
