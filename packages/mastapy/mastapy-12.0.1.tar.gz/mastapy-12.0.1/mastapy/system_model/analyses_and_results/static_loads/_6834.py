...
from mastapy.system_model.analyses_and_results.static_loads import _6832, _6833, _6743
...
class HypoidGearSetLoadCase(_6743.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6832.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6832.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_meshes_load_case(self) -> 'List[_6833.HypoidGearMeshLoadCase]':
