...
from mastapy.system_model.analyses_and_results.static_loads import _6861, _6851
...
class PlanetCarrierLoadCase(_6851.MountableComponentLoadCase):
    """PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6861.PlanetarySocketManufactureError]':
