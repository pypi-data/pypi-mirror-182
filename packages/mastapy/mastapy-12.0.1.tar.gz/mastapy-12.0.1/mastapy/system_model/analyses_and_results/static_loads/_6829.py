...
from mastapy.system_model.analyses_and_results.static_loads import _6828, _6807
...
class HarmonicLoadDataImportFromMotorPackages(_6828.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
