...
from mastapy.system_model.analyses_and_results.static_loads import _6909, _6910, _6822
...
class WormGearSetLoadCase(_6822.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6909.WormGearLoadCase]':
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6909.WormGearLoadCase]':
    ...
    @property
    def worm_meshes_load_case(self) -> 'List[_6910.WormGearMeshLoadCase]':
