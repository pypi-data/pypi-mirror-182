...
from mastapy.system_model.analyses_and_results import (
    _2598, _2593, _2573, _2584,
    _2592, _2576, _2595, _2587,
    _2577, _2594, _2575, _2581,
    _2635, _2572
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5598, _5599, _5600
from mastapy.system_model.analyses_and_results.static_loads import _6745, _6731
...
class StaticLoadCase(_6731.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2598.SystemDeflectionAnalysis':
    ...
    @property
    def power_flow(self) -> '_2593.PowerFlowAnalysis':
    ...
    @property
    def advanced_system_deflection(self) -> '_2573.AdvancedSystemDeflectionAnalysis':
    ...
    @property
    def parametric_study_tool(self) -> '_2592.ParametricStudyToolAnalysis':
    ...
    @property
    def compound_parametric_study_tool(self) -> '_2576.CompoundParametricStudyToolAnalysis':
    ...
    @property
    def steady_state_synchronous_response(self) -> '_2595.SteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def dynamic_model_for_modal_analysis(self) -> '_2581.DynamicModelForModalAnalysis':
    ...
    @property
    def advanced_system_deflection_options(self) -> '_7200.AdvancedSystemDeflectionOptions':
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5699.HarmonicAnalysisOptions':
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2635.TESetUpForDynamicAnalysisOptions':
    ...
    @property
    def clutch_engagements(self) -> 'List[_5598.ClutchEngagementStatus]':
    ...
    @property
    def concept_clutch_engagements(self) -> 'List[_5599.ConceptSynchroGearEngagementStatus]':
    ...
    @property
    def design_state_load_case_group(self) -> '_5600.DesignState':
    ...
    def analysis_of(self, analysis_type: '_6745.AnalysisType') -> '_2572.SingleAnalysis':
    ...
    def duplicate(self, new_design_state_group: '_5600.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
