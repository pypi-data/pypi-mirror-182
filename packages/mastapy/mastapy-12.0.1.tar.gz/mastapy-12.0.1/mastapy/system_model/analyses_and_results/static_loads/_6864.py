...
from mastapy.math_utility import _1468, _1476
...
class PointLoadHarmonicLoadData(_1351.SpeedDependentHarmonicLoadData):
    ...
    @property
    def degree_of_freedom(self) -> '_1468.DegreesOfFreedom':
        ...
        return constructor.new_from_mastapy_type(_1468.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1468.DegreesOfFreedom'):
