...
from mastapy.system_model.analyses_and_results.static_loads import _6845, _6846, _6841
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6841.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6845.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6845.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6846.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
