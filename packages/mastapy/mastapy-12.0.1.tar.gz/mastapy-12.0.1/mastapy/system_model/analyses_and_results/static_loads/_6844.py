...
from mastapy.system_model.analyses_and_results.static_loads import _6842, _6843, _6841
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6841.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6842.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6842.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6843.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
