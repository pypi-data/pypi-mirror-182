...
from mastapy.system_model.analyses_and_results.static_loads import _6768, _6769, _6822
...
class ConceptGearSetLoadCase(_6822.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6768.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6768.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6769.ConceptGearMeshLoadCase]':
