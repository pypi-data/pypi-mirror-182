...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6106.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6019.PartToPartShearCouplingConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6019.PartToPartShearCouplingConnectionHarmonicAnalysisOfSingleExcitation]':
