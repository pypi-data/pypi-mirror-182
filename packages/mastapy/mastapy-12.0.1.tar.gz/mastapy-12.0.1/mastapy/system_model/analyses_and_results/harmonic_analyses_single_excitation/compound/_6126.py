...
class GearCompoundHarmonicAnalysisOfSingleExcitation(_6145.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """GearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5996.GearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5996.GearHarmonicAnalysisOfSingleExcitation]':
