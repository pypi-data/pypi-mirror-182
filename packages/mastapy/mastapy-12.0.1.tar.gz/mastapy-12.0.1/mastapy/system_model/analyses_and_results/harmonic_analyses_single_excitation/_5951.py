...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5949, _5950, _5956
...
class BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation(_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def bevel_differential_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5949.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5950.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
