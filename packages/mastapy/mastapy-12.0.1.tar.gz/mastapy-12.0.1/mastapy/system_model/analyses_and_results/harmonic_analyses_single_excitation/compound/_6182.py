...
class SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation(_6183.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6052.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6052.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
