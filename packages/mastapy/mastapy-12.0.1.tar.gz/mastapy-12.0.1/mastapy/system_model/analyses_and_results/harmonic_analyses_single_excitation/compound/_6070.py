...
class AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation(_6093.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5940.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5940.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
