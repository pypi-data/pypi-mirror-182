...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6079, _6080, _6086
...
class BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6086.BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5951.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6079.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6080.BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5951.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
