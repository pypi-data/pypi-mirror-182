...
class UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation(_6190.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6060.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6060.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
