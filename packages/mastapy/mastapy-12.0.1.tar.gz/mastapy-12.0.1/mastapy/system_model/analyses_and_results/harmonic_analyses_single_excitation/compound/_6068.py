...
class AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6147.PartCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5938.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5938.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
