...
class PowerLoadCompoundHarmonicAnalysisOfSingleExcitation(_6190.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PowerLoadCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6026.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6026.PowerLoadHarmonicAnalysisOfSingleExcitation]':
