...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6044, _6045, _5956
...
class StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation(_5956.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6044.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6045.StraightBevelDiffGearMeshHarmonicAnalysisOfSingleExcitation]':
