...
class SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(_6183.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6055.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6055.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
