...
class CVTCompoundHarmonicAnalysisOfSingleExcitation(_6078.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5979.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5979.CVTHarmonicAnalysisOfSingleExcitation]':
