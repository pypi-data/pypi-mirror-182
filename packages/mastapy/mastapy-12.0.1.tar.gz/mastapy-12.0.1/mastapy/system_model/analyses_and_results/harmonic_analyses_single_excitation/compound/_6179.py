...
class StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6173.StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6050.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6050.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
