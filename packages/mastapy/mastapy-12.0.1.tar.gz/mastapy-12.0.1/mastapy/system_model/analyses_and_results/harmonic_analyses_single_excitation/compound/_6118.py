...
class CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6115.CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation):
    """CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5988.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5988.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
