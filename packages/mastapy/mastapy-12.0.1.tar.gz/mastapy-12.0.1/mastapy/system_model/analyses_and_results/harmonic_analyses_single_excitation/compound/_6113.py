...
class CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation(_6069.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5983.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5983.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
