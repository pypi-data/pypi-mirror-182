...
class TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6106.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6056.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6056.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
