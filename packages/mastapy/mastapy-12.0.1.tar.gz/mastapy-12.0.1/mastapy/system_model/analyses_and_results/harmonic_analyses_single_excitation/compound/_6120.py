...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_6093.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5990.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5990.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
