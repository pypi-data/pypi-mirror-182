...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import (
    _5946, _5948, _5951, _5957,
    _5958, _5979, _5961, _5966,
    _5969, _5981, _5983, _5987,
    _5994, _5993, _5995, _6003,
    _6010, _6013, _6014, _6015,
    _6017, _6021, _6024, _6025,
    _6026, _6028, _6030, _6035,
    _6034, _6040, _6043, _6046,
    _6049, _6053, _6057, _6060,
    _6064, _6067, _5938
)
...
class AssemblyHarmonicAnalysisOfSingleExcitation(_5938.AbstractAssemblyHarmonicAnalysisOfSingleExcitation):
    """AssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def bearings(self) -> 'List[_5946.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def belt_drives(self) -> 'List[_5948.BeltDriveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5951.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5957.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolts(self) -> 'List[_5958.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cv_ts(self) -> 'List[_5979.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def clutches(self) -> 'List[_5961.ClutchHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5966.ConceptCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5969.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5981.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5983.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5987.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def fe_parts(self) -> 'List[_5994.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5993.FaceGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5995.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6003.HypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6010.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6013.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def mass_discs(self) -> 'List[_6014.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def measurement_components(self) -> 'List[_6015.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def oil_seals(self) -> 'List[_6017.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6021.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6024.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def point_loads(self) -> 'List[_6025.PointLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def power_loads(self) -> 'List[_6026.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def ring_pins(self) -> 'List[_6028.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6030.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6035.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shafts(self) -> 'List[_6034.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6040.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6043.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6046.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6049.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def synchronisers(self) -> 'List[_6053.SynchroniserHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def torque_converters(self) -> 'List[_6057.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6060.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6064.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6067.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]':
