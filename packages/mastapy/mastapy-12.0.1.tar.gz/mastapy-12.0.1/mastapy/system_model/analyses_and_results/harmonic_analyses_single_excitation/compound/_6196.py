...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6194, _6195, _6086
...
class ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6086.BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6067.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6194.ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6195.ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6067.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]':
