...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5991, _5992, _5998
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_5998.GearSetHarmonicAnalysisOfSingleExcitation):
    """FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5991.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5992.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
