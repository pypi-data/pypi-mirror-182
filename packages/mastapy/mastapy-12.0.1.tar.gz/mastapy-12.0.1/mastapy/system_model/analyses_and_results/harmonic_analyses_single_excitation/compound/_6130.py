...
class HypoidGearCompoundHarmonicAnalysisOfSingleExcitation(_6072.AGMAGleasonConicalGearCompoundHarmonicAnalysisOfSingleExcitation):
    """HypoidGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6001.HypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6001.HypoidGearHarmonicAnalysisOfSingleExcitation]':
