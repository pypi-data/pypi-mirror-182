...
class RollingRingCompoundHarmonicAnalysisOfSingleExcitation(_6107.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6032.RollingRingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6032.RollingRingHarmonicAnalysisOfSingleExcitation]':
