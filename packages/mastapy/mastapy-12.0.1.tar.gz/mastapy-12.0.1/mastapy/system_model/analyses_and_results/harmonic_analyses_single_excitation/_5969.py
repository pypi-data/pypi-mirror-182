...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5967, _5968, _5998
...
class ConceptGearSetHarmonicAnalysisOfSingleExcitation(_5998.GearSetHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def concept_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5967.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5968.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
