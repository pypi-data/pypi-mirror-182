...
class DatumCompoundHarmonicAnalysisOfSingleExcitation(_6093.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """DatumCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5989.DatumHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5989.DatumHarmonicAnalysisOfSingleExcitation]':
