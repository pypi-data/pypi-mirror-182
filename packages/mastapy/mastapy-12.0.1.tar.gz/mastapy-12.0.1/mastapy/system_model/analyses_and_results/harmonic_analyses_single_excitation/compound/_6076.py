...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_6104.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5946.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5946.BearingHarmonicAnalysisOfSingleExcitation]':
