...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6085
...
class BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6085.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5950.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5950.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
