...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6121, _6122, _6128
...
class FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6128.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5993.FaceGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6121.FaceGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6122.FaceGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5993.FaceGearSetHarmonicAnalysisOfSingleExcitation]':
