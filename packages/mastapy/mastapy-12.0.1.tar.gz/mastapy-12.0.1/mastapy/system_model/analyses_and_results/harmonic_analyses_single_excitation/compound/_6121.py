...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(_6126.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5991.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5991.FaceGearHarmonicAnalysisOfSingleExcitation]':
