...
from mastapy import _7484, _7478
...
class SingleAnalysis(_7478.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    def perform_analysis_with_progress(self, task_progress: '_7484.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2160.DesignEntity') -> '_2603.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2603.DesignEntityAnalysis') -> '_2603.DesignEntityAnalysis':
        """ 'ResultsFor' is the original name of this method.
