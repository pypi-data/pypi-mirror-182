...
class CVTCompoundModalAnalysis(_4678.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4557.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4557.CVTModalAnalysis]':
