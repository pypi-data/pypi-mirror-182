...
class DatumCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4567.DatumModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4567.DatumModalAnalysis]':
