...
class RollingRingConnectionCompoundModalAnalysis(_4733.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4615.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4615.RollingRingConnectionModalAnalysis]':
