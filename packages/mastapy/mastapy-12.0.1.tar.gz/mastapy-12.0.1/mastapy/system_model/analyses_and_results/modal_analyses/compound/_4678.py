...
class BeltDriveCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4525.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4525.BeltDriveModalAnalysis]':
