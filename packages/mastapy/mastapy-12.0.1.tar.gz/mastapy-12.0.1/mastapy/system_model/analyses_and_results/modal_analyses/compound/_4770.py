...
class SpringDamperCompoundModalAnalysis(_4705.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4628.SpringDamperModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4628.SpringDamperModalAnalysis]':
