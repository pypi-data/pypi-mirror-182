...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4740, _4741, _4736
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis(_4736.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4593.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4740.KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4741.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4593.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
