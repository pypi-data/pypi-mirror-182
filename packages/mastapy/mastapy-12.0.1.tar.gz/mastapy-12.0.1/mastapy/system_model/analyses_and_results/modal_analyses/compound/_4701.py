...
class ConicalGearMeshCompoundModalAnalysis(_4727.GearMeshCompoundModalAnalysis):
    """ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4547.ConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4547.ConicalGearMeshModalAnalysis]':
