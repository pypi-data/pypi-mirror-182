...
class ConicalGearSetCompoundModalAnalysis(_4728.GearSetCompoundModalAnalysis):
    """ConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4549.ConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4549.ConicalGearSetModalAnalysis]':
