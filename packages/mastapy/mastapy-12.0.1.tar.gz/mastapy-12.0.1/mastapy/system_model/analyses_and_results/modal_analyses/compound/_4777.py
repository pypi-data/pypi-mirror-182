...
class StraightBevelGearMeshCompoundModalAnalysis(_4685.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4632.StraightBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4632.StraightBevelGearMeshModalAnalysis]':
