...
from mastapy.system_model.analyses_and_results.modal_analyses import _4651, _4650, _4579
...
class WormGearSetModalAnalysis(_4579.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4651.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4650.WormGearMeshModalAnalysis]':
