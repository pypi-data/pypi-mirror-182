...
class ShaftHubConnectionCompoundModalAnalysis(_4704.ConnectorCompoundModalAnalysis):
    """ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4618.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4618.ShaftHubConnectionModalAnalysis]':
