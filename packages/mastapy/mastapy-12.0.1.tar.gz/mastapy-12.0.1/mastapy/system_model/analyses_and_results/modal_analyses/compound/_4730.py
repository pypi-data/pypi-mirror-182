...
class HypoidGearCompoundModalAnalysis(_4672.AGMAGleasonConicalGearCompoundModalAnalysis):
    """HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4582.HypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4582.HypoidGearModalAnalysis]':
