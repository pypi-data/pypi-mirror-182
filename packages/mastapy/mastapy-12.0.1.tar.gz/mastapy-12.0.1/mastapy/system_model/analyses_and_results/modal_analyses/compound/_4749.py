...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_4706.CouplingConnectionCompoundModalAnalysis):
    """PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4603.PartToPartShearCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4603.PartToPartShearCouplingConnectionModalAnalysis]':
