...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis(_4734.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
