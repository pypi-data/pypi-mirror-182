...
class SpiralBevelGearCompoundModalAnalysis(_4684.BevelGearCompoundModalAnalysis):
    """SpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4624.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4624.SpiralBevelGearModalAnalysis]':
