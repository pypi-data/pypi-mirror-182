...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4679.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4529.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4529.BevelDifferentialPlanetGearModalAnalysis]':
