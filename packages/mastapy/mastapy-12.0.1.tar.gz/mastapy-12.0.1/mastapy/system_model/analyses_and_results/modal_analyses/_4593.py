...
from mastapy.system_model.analyses_and_results.modal_analyses import _4592, _4591, _4587
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(_4587.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis(self) -> 'List[_4592.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis(self) -> 'List[_4591.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
