...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4721, _4722, _4728
...
class FaceGearSetCompoundModalAnalysis(_4728.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4573.FaceGearSetModalAnalysis]':
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_4721.FaceGearCompoundModalAnalysis]':
    ...
    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_4722.FaceGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4573.FaceGearSetModalAnalysis]':
