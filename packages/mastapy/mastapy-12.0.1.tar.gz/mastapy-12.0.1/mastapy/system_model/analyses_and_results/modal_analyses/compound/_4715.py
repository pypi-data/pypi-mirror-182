...
class CylindricalGearCompoundModalAnalysis(_4726.GearCompoundModalAnalysis):
    """CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4564.CylindricalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4564.CylindricalGearModalAnalysis]':
