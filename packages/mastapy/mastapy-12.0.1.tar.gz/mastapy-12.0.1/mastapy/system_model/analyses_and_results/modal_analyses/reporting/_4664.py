...
from mastapy.utility.modal_analysis import _1762
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2604.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1762.DesignEntityExcitationDescription]':
