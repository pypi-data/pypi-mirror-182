...
from mastapy.system_model.analyses_and_results.modal_analyses import _4630, _4629, _4533
...
class StraightBevelDiffGearSetModalAnalysis(_4533.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4630.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4629.StraightBevelDiffGearMeshModalAnalysis]':
