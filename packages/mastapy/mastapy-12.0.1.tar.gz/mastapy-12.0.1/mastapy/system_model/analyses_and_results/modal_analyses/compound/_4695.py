...
class ConceptCouplingConnectionCompoundModalAnalysis(_4706.CouplingConnectionCompoundModalAnalysis):
    """ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4541.ConceptCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4541.ConceptCouplingConnectionModalAnalysis]':
