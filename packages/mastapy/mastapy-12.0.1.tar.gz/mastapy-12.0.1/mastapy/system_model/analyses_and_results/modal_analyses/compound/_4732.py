...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4730, _4731, _4674
...
class HypoidGearSetCompoundModalAnalysis(_4674.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4583.HypoidGearSetModalAnalysis]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4730.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4731.HypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4583.HypoidGearSetModalAnalysis]':
