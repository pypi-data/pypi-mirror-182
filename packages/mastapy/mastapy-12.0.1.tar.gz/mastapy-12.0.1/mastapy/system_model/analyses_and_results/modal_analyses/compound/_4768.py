...
class SpiralBevelGearMeshCompoundModalAnalysis(_4685.BevelGearMeshCompoundModalAnalysis):
    """SpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4623.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4623.SpiralBevelGearMeshModalAnalysis]':
