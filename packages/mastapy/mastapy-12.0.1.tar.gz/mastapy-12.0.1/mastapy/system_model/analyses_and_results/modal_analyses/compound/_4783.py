...
class SynchroniserPartCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """SynchroniserPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4639.SynchroniserPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4639.SynchroniserPartModalAnalysis]':
