...
class ConnectorCompoundModalAnalysis(_4745.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4551.ConnectorModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4551.ConnectorModalAnalysis]':
