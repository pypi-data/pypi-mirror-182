...
class ExternalCADModelCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4570.ExternalCADModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4570.ExternalCADModelModalAnalysis]':
