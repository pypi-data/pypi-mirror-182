...
class CouplingHalfCompoundModalAnalysis(_4745.MountableComponentCompoundModalAnalysis):
    """CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4554.CouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4554.CouplingHalfModalAnalysis]':
