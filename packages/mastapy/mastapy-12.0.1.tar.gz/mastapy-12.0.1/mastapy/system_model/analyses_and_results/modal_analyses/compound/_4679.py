...
class BevelDifferentialGearCompoundModalAnalysis(_4684.BevelGearCompoundModalAnalysis):
    """BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4527.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4527.BevelDifferentialGearModalAnalysis]':
