...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4776, _4777, _4686
...
class StraightBevelGearSetCompoundModalAnalysis(_4686.BevelGearSetCompoundModalAnalysis):
    """StraightBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4634.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis(self) -> 'List[_4776.StraightBevelGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis(self) -> 'List[_4777.StraightBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4634.StraightBevelGearSetModalAnalysis]':
