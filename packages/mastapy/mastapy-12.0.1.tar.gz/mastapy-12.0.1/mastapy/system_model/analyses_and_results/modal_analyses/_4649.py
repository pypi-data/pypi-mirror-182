...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4568, _4552, _4569, _4648,
    _4601, _4647
)
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import enum_with_selected_value, overridable
from mastapy.math_utility import (
    _1459, _1497, _1483, _1490
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5774, _5782, _5777, _5783
)
from mastapy.math_utility.measured_data_scaling import _1534
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5687, _5699, _5742
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6998
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.drawing.options import _2216, _2214
from mastapy.utility.property import _1806
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def chart_type(self) -> '_4568.DynamicsResponse3DChartType':
        ...
        return constructor.new_from_mastapy_type(_4568.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_4568.DynamicsResponse3DChartType'):
    ...
    @property
    def connected_component_type(self) -> '_5774.ConnectedComponentType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5774.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5774.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def coordinate_system(self) -> '_4552.CoordinateSystemForWhine':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4552.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4552.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def translation_or_rotation(self) -> '_1497.TranslationRotation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1497.TranslationRotation)(value) if value is not None else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1497.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def vector_magnitude_method(self) -> '_1483.ComplexMagnitudeMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1483.ComplexMagnitudeMethod)(value) if value is not None else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1483.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VectorMagnitudeMethod = value

    @property
    def whine_waterfall_export_option(self) -> '_4648.WhineWaterfallExportOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4648.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4648.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.WhineWaterfallExportOption = value

    @property
    def data_scaling(self) -> '_1534.DataScalingOptions':
    ...
    @property
    def frequency_options(self) -> '_5687.FrequencyOptionsForHarmonicAnalysisResults':
    ...
    @property
    def modal_contribution_view_options(self) -> '_2216.ModalContributionViewOptions':
    ...
    @property
    def mode_view_options(self) -> '_2214.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
    ...
    @property
    def order_cuts_chart_settings(self) -> '_4601.OrderCutsChartSettings':
    ...
    @property
    def reference_speed_options(self) -> '_5742.SpeedOptionsForHarmonicAnalysisResults':
    ...
    @property
    def result_location_selection_groups(self) -> '_5782.ResultLocationSelectionGroups':
    ...
    @property
    def selected_excitations(self) -> '_5777.ExcitationSourceSelectionGroup':
    ...
    @property
    def waterfall_chart_settings(self) -> '_4647.WaterfallChartSettings':
    ...
    @property
    def active_result_locations(self) -> 'List[_5783.ResultNodeSelection]':
    ...
    @property
    def degrees_of_freedom(self) -> 'List[_1806.EnumWithBool[_1490.ResultOptionsFor3DVector]]':
