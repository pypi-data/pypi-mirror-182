...
from mastapy.system_model.analyses_and_results.modal_analyses import _4624, _4623, _4533
...
class SpiralBevelGearSetModalAnalysis(_4533.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4624.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4623.SpiralBevelGearMeshModalAnalysis]':
