...
from mastapy.system_model.analyses_and_results.modal_analyses import _4564, _4563, _4579
...
class CylindricalGearSetModalAnalysis(_4579.GearSetModalAnalysis):
    """CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4564.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4563.CylindricalGearMeshModalAnalysis]':
