...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_4703.ConnectionCompoundModalAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4518.AbstractShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4518.AbstractShaftToMountableComponentConnectionModalAnalysis]':
