...
class UnbalancedMassCompoundModalAnalysis(_4790.VirtualComponentCompoundModalAnalysis):
    """UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4645.UnbalancedMassModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4645.UnbalancedMassModalAnalysis]':
