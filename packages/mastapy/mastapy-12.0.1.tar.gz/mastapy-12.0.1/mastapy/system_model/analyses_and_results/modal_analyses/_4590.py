...
from mastapy.system_model.analyses_and_results.modal_analyses import _4589, _4588, _4587
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(_4587.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(self) -> 'List[_4589.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(self) -> 'List[_4588.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
