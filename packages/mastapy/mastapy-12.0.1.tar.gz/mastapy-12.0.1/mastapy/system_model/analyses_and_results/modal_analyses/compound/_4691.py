...
class ClutchHalfCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4537.ClutchHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4537.ClutchHalfModalAnalysis]':
