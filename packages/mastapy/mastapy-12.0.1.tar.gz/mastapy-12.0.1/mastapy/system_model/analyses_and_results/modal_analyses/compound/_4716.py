...
class CylindricalGearMeshCompoundModalAnalysis(_4727.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4563.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4563.CylindricalGearMeshModalAnalysis]':
