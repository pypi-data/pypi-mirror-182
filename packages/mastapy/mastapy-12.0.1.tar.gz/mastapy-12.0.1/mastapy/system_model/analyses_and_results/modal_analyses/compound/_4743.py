...
class MassDiscCompoundModalAnalysis(_4790.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4594.MassDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4594.MassDiscModalAnalysis]':
