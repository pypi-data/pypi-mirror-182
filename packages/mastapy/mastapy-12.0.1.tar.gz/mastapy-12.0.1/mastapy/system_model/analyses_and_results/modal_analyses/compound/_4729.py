...
class GuideDxfModelCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4580.GuideDxfModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4580.GuideDxfModelModalAnalysis]':
