...
class PartCompoundModalAnalysis(_7471.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4602.PartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4602.PartModalAnalysis]':
