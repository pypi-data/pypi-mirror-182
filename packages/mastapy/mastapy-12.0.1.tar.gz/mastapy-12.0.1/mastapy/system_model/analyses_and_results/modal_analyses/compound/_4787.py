...
class TorqueConverterPumpCompoundModalAnalysis(_4707.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4643.TorqueConverterPumpModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4643.TorqueConverterPumpModalAnalysis]':
