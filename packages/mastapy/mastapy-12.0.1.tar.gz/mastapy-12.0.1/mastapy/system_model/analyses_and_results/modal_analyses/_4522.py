...
from mastapy.system_model.analyses_and_results.system_deflections import _2644, _2747
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4523, _4525, _4528, _4534,
    _4535, _4557, _4538, _4543,
    _4546, _4559, _4561, _4565,
    _4574, _4573, _4575, _4583,
    _4590, _4593, _4594, _4595,
    _4600, _4605, _4608, _4609,
    _4610, _4612, _4614, _4618,
    _4619, _4625, _4628, _4631,
    _4634, _4638, _4642, _4645,
    _4652, _4655, _4515
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4656
...
class AssemblyModalAnalysis(_4515.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2644.AssemblySystemDeflection':
    ...
    @property
    def bearings(self) -> 'List[_4523.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4525.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4528.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4534.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4535.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4557.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4656.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4538.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4543.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4546.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4559.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4561.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4565.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4574.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4573.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4575.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4574.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4583.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4590.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4593.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4594.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4595.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4600.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4605.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4608.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4609.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4610.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4612.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4614.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4618.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4619.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4625.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4628.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4631.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4634.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4638.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4642.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4645.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4652.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4655.ZerolBevelGearSetModalAnalysis]':
