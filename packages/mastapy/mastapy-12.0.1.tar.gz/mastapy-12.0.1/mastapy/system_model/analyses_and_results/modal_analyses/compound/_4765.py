...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4671.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4621.ShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4621.ShaftToMountableComponentConnectionModalAnalysis]':
