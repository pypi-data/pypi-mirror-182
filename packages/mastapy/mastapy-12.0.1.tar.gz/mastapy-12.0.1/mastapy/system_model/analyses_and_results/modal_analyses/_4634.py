...
from mastapy.system_model.analyses_and_results.modal_analyses import _4633, _4632, _4533
...
class StraightBevelGearSetModalAnalysis(_4533.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4633.StraightBevelGearModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4632.StraightBevelGearMeshModalAnalysis]':
