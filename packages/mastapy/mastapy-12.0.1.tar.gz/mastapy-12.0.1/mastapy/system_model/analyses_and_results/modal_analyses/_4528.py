...
from mastapy.system_model.analyses_and_results.modal_analyses import _4527, _4526, _4533
...
class BevelDifferentialGearSetModalAnalysis(_4533.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4527.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4526.BevelDifferentialGearMeshModalAnalysis]':
