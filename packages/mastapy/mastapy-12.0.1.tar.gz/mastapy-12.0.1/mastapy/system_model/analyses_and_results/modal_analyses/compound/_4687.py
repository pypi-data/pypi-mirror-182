...
class BoltCompoundModalAnalysis(_4693.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4535.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4535.BoltModalAnalysis]':
