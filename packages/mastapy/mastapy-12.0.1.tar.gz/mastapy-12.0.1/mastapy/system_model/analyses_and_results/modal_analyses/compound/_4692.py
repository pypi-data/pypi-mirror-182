...
class CoaxialConnectionCompoundModalAnalysis(_4765.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4539.CoaxialConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4539.CoaxialConnectionModalAnalysis]':
