...
class SynchroniserHalfCompoundModalAnalysis(_4783.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4637.SynchroniserHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4637.SynchroniserHalfModalAnalysis]':
