...
class ConceptGearCompoundModalAnalysis(_4726.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4545.ConceptGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4545.ConceptGearModalAnalysis]':
