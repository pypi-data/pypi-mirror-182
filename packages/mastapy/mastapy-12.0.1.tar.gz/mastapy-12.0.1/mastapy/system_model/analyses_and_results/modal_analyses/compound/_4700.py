...
class ConicalGearCompoundModalAnalysis(_4726.GearCompoundModalAnalysis):
    """ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4548.ConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4548.ConicalGearModalAnalysis]':
