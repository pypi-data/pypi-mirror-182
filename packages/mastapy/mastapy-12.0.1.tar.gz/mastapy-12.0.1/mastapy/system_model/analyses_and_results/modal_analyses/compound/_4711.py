...
class CycloidalAssemblyCompoundModalAnalysis(_4766.SpecialisedAssemblyCompoundModalAnalysis):
    """CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4559.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4559.CycloidalAssemblyModalAnalysis]':
