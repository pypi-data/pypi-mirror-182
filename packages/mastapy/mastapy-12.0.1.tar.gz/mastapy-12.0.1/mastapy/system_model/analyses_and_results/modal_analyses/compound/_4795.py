...
class ZerolBevelGearMeshCompoundModalAnalysis(_4685.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4653.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4653.ZerolBevelGearMeshModalAnalysis]':
