...
class FaceGearCompoundModalAnalysis(_4726.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4572.FaceGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4572.FaceGearModalAnalysis]':
