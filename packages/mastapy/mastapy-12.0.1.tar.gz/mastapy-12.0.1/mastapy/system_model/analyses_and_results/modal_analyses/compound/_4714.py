...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_4671.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4562.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4562.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
