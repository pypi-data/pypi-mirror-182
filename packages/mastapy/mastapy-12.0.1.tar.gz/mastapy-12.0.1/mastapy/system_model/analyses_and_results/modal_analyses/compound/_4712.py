...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysis(_4692.CoaxialConnectionCompoundModalAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4560.CycloidalDiscCentralBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4560.CycloidalDiscCentralBearingConnectionModalAnalysis]':
