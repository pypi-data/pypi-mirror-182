...
class ConceptGearMeshCompoundPowerFlow(_4169.GearMeshCompoundPowerFlow):
    """ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4006.ConceptGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4006.ConceptGearMeshPowerFlow]':
