...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4233, _4234, _4170
...
class WormGearSetCompoundPowerFlow(_4170.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4106.WormGearSetPowerFlow]':
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_4233.WormGearCompoundPowerFlow]':
    ...
    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_4234.WormGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4106.WormGearSetPowerFlow]':
