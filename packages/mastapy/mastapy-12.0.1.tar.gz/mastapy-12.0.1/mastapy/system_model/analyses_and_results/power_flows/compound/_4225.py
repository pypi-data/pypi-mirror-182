...
class SynchroniserPartCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4094.SynchroniserPartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4094.SynchroniserPartPowerFlow]':
