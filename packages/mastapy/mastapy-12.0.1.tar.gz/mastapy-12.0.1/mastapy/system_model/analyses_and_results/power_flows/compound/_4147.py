...
class CouplingCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4016.CouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4016.CouplingPowerFlow]':
