...
from mastapy.system_model.analyses_and_results.power_flows import _4051, _4050, _4046
...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(_4046.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_power_flow(self) -> 'List[_4051.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
