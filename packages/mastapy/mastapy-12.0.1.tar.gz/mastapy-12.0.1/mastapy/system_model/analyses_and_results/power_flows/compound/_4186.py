...
class MeasurementComponentCompoundPowerFlow(_4232.VirtualComponentCompoundPowerFlow):
    """MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4054.MeasurementComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4054.MeasurementComponentPowerFlow]':
