...
class MountableComponentCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4055.MountableComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.MountableComponentPowerFlow]':
