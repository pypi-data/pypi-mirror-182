...
class ClutchHalfCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3999.ClutchHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3999.ClutchHalfPowerFlow]':
