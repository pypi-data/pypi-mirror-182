...
class ConceptCouplingCompoundPowerFlow(_4147.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4005.ConceptCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4005.ConceptCouplingPowerFlow]':
