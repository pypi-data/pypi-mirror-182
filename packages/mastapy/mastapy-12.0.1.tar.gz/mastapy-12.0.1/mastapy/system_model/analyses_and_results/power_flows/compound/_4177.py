...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_4143.ConicalGearMeshCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4044.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4044.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
