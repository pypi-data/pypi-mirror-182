...
class ShaftHubConnectionCompoundPowerFlow(_4146.ConnectorCompoundPowerFlow):
    """ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4075.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4075.ShaftHubConnectionPowerFlow]':
