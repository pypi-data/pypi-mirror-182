...
class AGMAGleasonConicalGearCompoundPowerFlow(_4142.ConicalGearCompoundPowerFlow):
    """AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3982.AGMAGleasonConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3982.AGMAGleasonConicalGearPowerFlow]':
