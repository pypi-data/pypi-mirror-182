...
class ConicalGearMeshCompoundPowerFlow(_4169.GearMeshCompoundPowerFlow):
    """ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4009.ConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4009.ConicalGearMeshPowerFlow]':
