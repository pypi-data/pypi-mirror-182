...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4163, _4164, _4170
...
class FaceGearSetCompoundPowerFlow(_4170.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4033.FaceGearSetPowerFlow]':
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_4163.FaceGearCompoundPowerFlow]':
    ...
    @property
    def face_meshes_compound_power_flow(self) -> 'List[_4164.FaceGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4033.FaceGearSetPowerFlow]':
