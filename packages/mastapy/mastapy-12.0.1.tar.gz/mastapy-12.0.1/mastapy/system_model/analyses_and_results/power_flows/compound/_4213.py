...
class SpringDamperConnectionCompoundPowerFlow(_4148.CouplingConnectionCompoundPowerFlow):
    """SpringDamperConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4082.SpringDamperConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4082.SpringDamperConnectionPowerFlow]':
