...
class UnbalancedMassCompoundPowerFlow(_4232.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4102.UnbalancedMassPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4102.UnbalancedMassPowerFlow]':
