...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4139, _4140, _4170
...
class ConceptGearSetCompoundPowerFlow(_4170.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4008.ConceptGearSetPowerFlow]':
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_4139.ConceptGearCompoundPowerFlow]':
    ...
    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_4140.ConceptGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4008.ConceptGearSetPowerFlow]':
