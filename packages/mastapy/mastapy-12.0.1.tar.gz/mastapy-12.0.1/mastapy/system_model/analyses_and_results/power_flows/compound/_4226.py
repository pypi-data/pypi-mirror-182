...
class SynchroniserSleeveCompoundPowerFlow(_4225.SynchroniserPartCompoundPowerFlow):
    """SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4096.SynchroniserSleevePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4096.SynchroniserSleevePowerFlow]':
