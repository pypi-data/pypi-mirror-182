...
class OilSealCompoundPowerFlow(_4146.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4056.OilSealPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4056.OilSealPowerFlow]':
