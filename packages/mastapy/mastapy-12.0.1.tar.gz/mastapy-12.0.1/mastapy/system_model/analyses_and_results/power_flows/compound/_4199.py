...
class RingPinsCompoundPowerFlow(_4187.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4069.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4069.RingPinsPowerFlow]':
