...
class PartToPartShearCouplingCompoundPowerFlow(_4147.CouplingCompoundPowerFlow):
    """PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4060.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4060.PartToPartShearCouplingPowerFlow]':
