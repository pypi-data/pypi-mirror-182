...
from mastapy.system_model.analyses_and_results.power_flows import _4032, _4031, _4038
...
class FaceGearSetPowerFlow(_4038.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4032.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4032.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4031.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4031.FaceGearMeshPowerFlow]':
