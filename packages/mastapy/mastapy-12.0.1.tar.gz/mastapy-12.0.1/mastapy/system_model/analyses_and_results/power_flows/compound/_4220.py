...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4218, _4219, _4128
...
class StraightBevelGearSetCompoundPowerFlow(_4128.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4090.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_4218.StraightBevelGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_4219.StraightBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4090.StraightBevelGearSetPowerFlow]':
