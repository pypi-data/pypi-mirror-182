...
from mastapy.system_model.analyses_and_results.power_flows import _4093, _4078
...
class SynchroniserPowerFlow(_4078.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4093.SynchroniserHalfPowerFlow]':
