...
class ComponentCompoundPowerFlow(_4189.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4002.ComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4002.ComponentPowerFlow]':
