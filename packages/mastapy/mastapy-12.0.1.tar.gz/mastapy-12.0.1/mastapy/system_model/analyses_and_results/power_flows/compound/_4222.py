...
class StraightBevelSunGearCompoundPowerFlow(_4215.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4092.StraightBevelSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4092.StraightBevelSunGearPowerFlow]':
