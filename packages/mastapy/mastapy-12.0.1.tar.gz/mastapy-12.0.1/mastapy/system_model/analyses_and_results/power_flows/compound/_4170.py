...
class GearSetCompoundPowerFlow(_4208.SpecialisedAssemblyCompoundPowerFlow):
    """GearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4038.GearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4038.GearSetPowerFlow]':
