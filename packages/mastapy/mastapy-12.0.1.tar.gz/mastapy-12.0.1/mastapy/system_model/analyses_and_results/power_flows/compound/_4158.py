...
class CylindricalGearMeshCompoundPowerFlow(_4169.GearMeshCompoundPowerFlow):
    """CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4025.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4025.CylindricalGearMeshPowerFlow]':
