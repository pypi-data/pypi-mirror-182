...
class PointLoadCompoundPowerFlow(_4232.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4064.PointLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4064.PointLoadPowerFlow]':
