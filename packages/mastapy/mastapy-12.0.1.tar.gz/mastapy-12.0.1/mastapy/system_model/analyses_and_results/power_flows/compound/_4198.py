...
class PulleyCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4068.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4068.PulleyPowerFlow]':
