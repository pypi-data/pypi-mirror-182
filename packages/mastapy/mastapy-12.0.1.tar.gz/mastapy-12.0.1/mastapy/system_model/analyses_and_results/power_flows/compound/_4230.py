...
class TorqueConverterTurbineCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """TorqueConverterTurbineCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4101.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4101.TorqueConverterTurbinePowerFlow]':
