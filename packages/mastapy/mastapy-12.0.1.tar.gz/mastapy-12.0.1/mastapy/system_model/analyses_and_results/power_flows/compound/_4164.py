...
class FaceGearMeshCompoundPowerFlow(_4169.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4031.FaceGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4031.FaceGearMeshPowerFlow]':
