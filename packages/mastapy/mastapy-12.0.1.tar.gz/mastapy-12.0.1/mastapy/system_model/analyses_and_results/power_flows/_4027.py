...
from mastapy.system_model.analyses_and_results.power_flows import _4026, _4025, _4038
...
class CylindricalGearSetPowerFlow(_4038.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4026.CylindricalGearPowerFlow]':
    ...
    @property
    def cylindrical_gears_power_flow(self) -> 'List[_4026.CylindricalGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4025.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def cylindrical_meshes_power_flow(self) -> 'List[_4025.CylindricalGearMeshPowerFlow]':
