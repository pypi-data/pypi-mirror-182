...
class FEPartCompoundPowerFlow(_4112.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4034.FEPartPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4034.FEPartPowerFlow]':
