...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4144.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3983.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3983.AGMAGleasonConicalGearSetPowerFlow]':
