...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4157, _4158, _4170
...
class CylindricalGearSetCompoundPowerFlow(_4170.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4027.CylindricalGearSetPowerFlow]':
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_4157.CylindricalGearCompoundPowerFlow]':
    ...
    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_4158.CylindricalGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4027.CylindricalGearSetPowerFlow]':
