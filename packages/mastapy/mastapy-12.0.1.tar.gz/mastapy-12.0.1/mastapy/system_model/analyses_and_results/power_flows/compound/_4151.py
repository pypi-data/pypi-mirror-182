...
class CVTCompoundPowerFlow(_4120.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4018.CVTPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4018.CVTPowerFlow]':
