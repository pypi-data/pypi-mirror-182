...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_4144.ConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4046.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4046.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
