...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4127
...
class BevelDifferentialGearMeshCompoundPowerFlow(_4127.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3988.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3988.BevelDifferentialGearMeshPowerFlow]':
