...
class BearingCompoundPowerFlow(_4146.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3985.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3985.BearingPowerFlow]':
