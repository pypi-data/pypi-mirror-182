...
class TorqueConverterPumpCompoundPowerFlow(_4149.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4100.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4100.TorqueConverterPumpPowerFlow]':
