...
class BevelDifferentialSunGearCompoundPowerFlow(_4121.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3992.BevelDifferentialSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3992.BevelDifferentialSunGearPowerFlow]':
