...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4215, _4216, _4128
...
class StraightBevelDiffGearSetCompoundPowerFlow(_4128.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4087.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_4215.StraightBevelDiffGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_4216.StraightBevelDiffGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4087.StraightBevelDiffGearSetPowerFlow]':
