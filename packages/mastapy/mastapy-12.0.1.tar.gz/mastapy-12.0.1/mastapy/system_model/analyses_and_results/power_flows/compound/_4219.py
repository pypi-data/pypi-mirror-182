...
class StraightBevelGearMeshCompoundPowerFlow(_4127.BevelGearMeshCompoundPowerFlow):
    """StraightBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4088.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4088.StraightBevelGearMeshPowerFlow]':
