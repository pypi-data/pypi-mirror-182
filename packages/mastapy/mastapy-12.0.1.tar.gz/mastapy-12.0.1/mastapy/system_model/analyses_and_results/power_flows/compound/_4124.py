...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4121.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3991.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3991.BevelDifferentialPlanetGearPowerFlow]':
