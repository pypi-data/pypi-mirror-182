...
class StraightBevelPlanetGearCompoundPowerFlow(_4215.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4091.StraightBevelPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4091.StraightBevelPlanetGearPowerFlow]':
