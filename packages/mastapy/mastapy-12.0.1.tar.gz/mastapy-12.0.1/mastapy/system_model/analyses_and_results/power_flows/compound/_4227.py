...
class TorqueConverterCompoundPowerFlow(_4147.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4099.TorqueConverterPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4099.TorqueConverterPowerFlow]':
