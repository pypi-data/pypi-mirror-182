...
class StraightBevelGearCompoundPowerFlow(_4126.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4089.StraightBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4089.StraightBevelGearPowerFlow]':
