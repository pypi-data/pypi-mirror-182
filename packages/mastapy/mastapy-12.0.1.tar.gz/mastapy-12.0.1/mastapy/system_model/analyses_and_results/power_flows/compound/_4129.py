...
class BoltCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3997.BoltPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3997.BoltPowerFlow]':
