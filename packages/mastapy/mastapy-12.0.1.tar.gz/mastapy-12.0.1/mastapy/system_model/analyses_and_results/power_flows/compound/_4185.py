...
class MassDiscCompoundPowerFlow(_4232.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4053.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4053.MassDiscPowerFlow]':
