...
class WormGearMeshCompoundPowerFlow(_4169.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4104.WormGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4104.WormGearMeshPowerFlow]':
