...
class CycloidalDiscCompoundPowerFlow(_4111.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4023.CycloidalDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4023.CycloidalDiscPowerFlow]':
