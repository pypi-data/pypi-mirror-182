...
class GearMeshCompoundPowerFlow(_4175.InterMountableComponentConnectionCompoundPowerFlow):
    """GearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4036.GearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4036.GearMeshPowerFlow]':
