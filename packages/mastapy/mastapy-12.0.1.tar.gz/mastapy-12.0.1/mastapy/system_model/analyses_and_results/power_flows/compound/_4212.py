...
class SpringDamperCompoundPowerFlow(_4147.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4084.SpringDamperPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4084.SpringDamperPowerFlow]':
