...
class AbstractShaftOrHousingCompoundPowerFlow(_4135.ComponentCompoundPowerFlow):
    """AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3978.AbstractShaftOrHousingPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3978.AbstractShaftOrHousingPowerFlow]':
