...
class AbstractAssemblyCompoundPowerFlow(_4189.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3977.AbstractAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3977.AbstractAssemblyPowerFlow]':
