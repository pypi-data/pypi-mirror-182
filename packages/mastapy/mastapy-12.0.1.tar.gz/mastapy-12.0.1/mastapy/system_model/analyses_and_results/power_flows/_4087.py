...
from mastapy.system_model.analyses_and_results.power_flows import _4086, _4085, _3995
...
class StraightBevelDiffGearSetPowerFlow(_3995.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4086.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_4086.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4085.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_4085.StraightBevelDiffGearMeshPowerFlow]':
