...
class AbstractShaftCompoundPowerFlow(_4112.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3979.AbstractShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3979.AbstractShaftPowerFlow]':
