...
class RingPinsToDiscConnectionCompoundPowerFlow(_4175.InterMountableComponentConnectionCompoundPowerFlow):
    """RingPinsToDiscConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4070.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4070.RingPinsToDiscConnectionPowerFlow]':
