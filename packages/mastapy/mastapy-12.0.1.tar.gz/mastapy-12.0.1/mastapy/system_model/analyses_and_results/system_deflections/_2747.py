...
class RootAssemblySystemDeflection(_2644.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4074.RootAssemblyPowerFlow':
    ...
    @property
    def system_deflection_inputs(self) -> '_2772.SystemDeflection':
        ...
        if _2772.SystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2663.ConcentricPartGroupCombinationSystemDeflectionResults]':
