...
class StraightBevelGearCompoundSystemDeflection(_2814.BevelGearCompoundSystemDeflection):
    """StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2765.StraightBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2765.StraightBevelGearSystemDeflection]':
