...
class SynchroniserSleeveCompoundSystemDeflection(_2915.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2770.SynchroniserSleeveSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2770.SynchroniserSleeveSystemDeflection]':
