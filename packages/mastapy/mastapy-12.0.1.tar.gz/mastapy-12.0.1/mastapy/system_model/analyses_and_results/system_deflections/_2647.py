...
from mastapy.system_model.analyses_and_results.power_flows import _3987, _4018
from mastapy.system_model.analyses_and_results.system_deflections import _2646, _2753
...
class BeltDriveSystemDeflection(_2753.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3987.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2646.BeltConnectionSystemDeflection]':
