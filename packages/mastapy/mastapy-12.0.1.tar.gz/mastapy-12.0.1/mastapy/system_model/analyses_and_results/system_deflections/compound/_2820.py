...
class ClutchConnectionCompoundSystemDeflection(_2836.CouplingConnectionCompoundSystemDeflection):
    """ClutchConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2658.ClutchConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2658.ClutchConnectionSystemDeflection]':
