...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2822.CoaxialConnectionCompoundSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2683.CycloidalDiscCentralBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2683.CycloidalDiscCentralBearingConnectionSystemDeflection]':
