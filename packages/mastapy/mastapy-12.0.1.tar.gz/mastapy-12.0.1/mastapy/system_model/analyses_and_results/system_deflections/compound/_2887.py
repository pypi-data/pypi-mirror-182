...
class PulleyCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2740.PulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2740.PulleySystemDeflection]':
