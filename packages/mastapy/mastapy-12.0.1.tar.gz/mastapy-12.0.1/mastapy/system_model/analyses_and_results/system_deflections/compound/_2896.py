...
class ShaftHubConnectionCompoundSystemDeflection(_2834.ConnectorCompoundSystemDeflection):
    """ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2748.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2748.ShaftHubConnectionSystemDeflection]':
