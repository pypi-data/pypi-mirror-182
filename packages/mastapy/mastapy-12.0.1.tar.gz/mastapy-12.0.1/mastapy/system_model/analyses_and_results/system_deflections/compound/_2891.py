...
class RollingRingCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2746.RollingRingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2746.RollingRingSystemDeflection]':
