...
from mastapy.system_model.analyses_and_results.system_deflections import _2712, _2710, _2642
...
class HypoidGearSetSystemDeflection(_2642.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4042.HypoidGearSetPowerFlow':
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2712.HypoidGearSystemDeflection]':
    ...
    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2710.HypoidGearMeshSystemDeflection]':
