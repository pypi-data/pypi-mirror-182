...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2868, _2869, _2867
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection(_2867.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_system_deflection(self) -> 'List[_2868.KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_system_deflection(self) -> 'List[_2869.KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2719.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
