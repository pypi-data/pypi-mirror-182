...
class KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection(_2831.ConicalGearMeshCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2715.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2715.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
