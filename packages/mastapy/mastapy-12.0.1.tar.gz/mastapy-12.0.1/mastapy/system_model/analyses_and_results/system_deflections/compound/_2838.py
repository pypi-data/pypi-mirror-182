...
class CVTBeltConnectionCompoundSystemDeflection(_2807.BeltConnectionCompoundSystemDeflection):
    """CVTBeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2679.CVTBeltConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2679.CVTBeltConnectionSystemDeflection]':
