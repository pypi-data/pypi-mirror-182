...
from mastapy.system_model.analyses_and_results.system_deflections import _2780, _2782
...
class PowerLoadSystemDeflection(_2782.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4067.PowerLoadPowerFlow':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2780.TransmissionErrorResult]':
