...
class CylindricalGearCompoundSystemDeflection(_2857.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2694.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2694.CylindricalGearSystemDeflectionWithLTCAResults]':
