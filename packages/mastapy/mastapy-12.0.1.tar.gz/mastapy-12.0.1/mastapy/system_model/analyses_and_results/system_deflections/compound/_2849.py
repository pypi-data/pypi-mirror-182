...
class DatumCompoundSystemDeflection(_2823.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2698.DatumSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2698.DatumSystemDeflection]':
