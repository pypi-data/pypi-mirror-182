...
class CouplingCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2678.CouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2678.CouplingSystemDeflection]':
