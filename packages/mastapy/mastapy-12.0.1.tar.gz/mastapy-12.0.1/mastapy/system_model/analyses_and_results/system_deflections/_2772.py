...
from mastapy.system_model.analyses_and_results.system_deflections import _2774, _2724
...
class SystemDeflection(_7469.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2774.SystemDeflectionOptions':
    ...
    @property
    def overall_efficiency_results(self) -> '_2724.LoadCaseOverallEfficiencyResult':
