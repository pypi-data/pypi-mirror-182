...
class BevelGearSetCompoundSystemDeflection(_2804.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """BevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2654.BevelGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2654.BevelGearSetSystemDeflection]':
