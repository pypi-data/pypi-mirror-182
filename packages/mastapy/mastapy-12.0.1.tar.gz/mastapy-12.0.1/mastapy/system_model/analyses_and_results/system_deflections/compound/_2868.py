...
class KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection(_2865.KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2720.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2720.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
