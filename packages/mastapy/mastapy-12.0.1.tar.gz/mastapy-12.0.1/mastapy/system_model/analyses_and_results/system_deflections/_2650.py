...
from mastapy.system_model.analyses_and_results.power_flows import _3989, _3991, _3992
...
class BevelDifferentialGearSystemDeflection(_2655.BevelGearSystemDeflection):
    """BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3989.BevelDifferentialGearPowerFlow':
