...
class SpecialisedAssemblyCompoundSystemDeflection(_2798.AbstractAssemblyCompoundSystemDeflection):
    """SpecialisedAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2753.SpecialisedAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2753.SpecialisedAssemblySystemDeflection]':
