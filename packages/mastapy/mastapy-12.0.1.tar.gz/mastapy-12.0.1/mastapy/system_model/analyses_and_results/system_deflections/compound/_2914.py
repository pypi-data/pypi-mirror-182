...
class SynchroniserHalfCompoundSystemDeflection(_2915.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2768.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2768.SynchroniserHalfSystemDeflection]':
