...
class SpiralBevelGearCompoundSystemDeflection(_2814.BevelGearCompoundSystemDeflection):
    """SpiralBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2756.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2756.SpiralBevelGearSystemDeflection]':
