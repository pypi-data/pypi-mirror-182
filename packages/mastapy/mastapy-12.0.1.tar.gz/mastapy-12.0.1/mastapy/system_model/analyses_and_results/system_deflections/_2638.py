...
class AbstractShaftOrHousingSystemDeflection(_2662.ComponentSystemDeflection):
    """AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3978.AbstractShaftOrHousingPowerFlow':
