...
from mastapy.system_model.analyses_and_results.system_deflections import _2703, _2701, _2707
...
class FaceGearSetSystemDeflection(_2707.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4033.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2703.FaceGearSystemDeflection]':
    ...
    @property
    def face_meshes_system_deflection(self) -> 'List[_2701.FaceGearMeshSystemDeflection]':
