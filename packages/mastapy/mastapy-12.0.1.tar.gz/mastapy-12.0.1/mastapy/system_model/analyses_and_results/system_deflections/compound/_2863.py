...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2861, _2862, _2804
...
class HypoidGearSetCompoundSystemDeflection(_2804.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """HypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2711.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2861.HypoidGearCompoundSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2862.HypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2711.HypoidGearSetSystemDeflection]':
