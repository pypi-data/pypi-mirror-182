...
class ShaftHubConnectionSystemDeflection(_2675.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_design(self) -> '_2550.ShaftHubConnection':
    ...
    @property
    def component_load_case(self) -> '_6876.ShaftHubConnectionLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4075.ShaftHubConnectionPowerFlow':
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1903.BearingStiffnessMatrixReporter':
    ...
    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1903.BearingStiffnessMatrixReporter':
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2797.SplineFlankContactReporting]':
    ...
    @property
    def right_flank_contacts(self) -> 'List[_2797.SplineFlankContactReporting]':
    ...
    @property
    def tip_contacts(self) -> 'List[_2797.SplineFlankContactReporting]':
