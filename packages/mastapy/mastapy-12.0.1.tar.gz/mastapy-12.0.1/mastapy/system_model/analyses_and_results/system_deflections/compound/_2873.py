...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2871, _2872, _2867
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection(_2867.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2722.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2871.KlingelnbergCycloPalloidSpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2872.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2722.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
