...
class ConicalGearCompoundSystemDeflection(_2857.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2673.ConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2673.ConicalGearSystemDeflection]':
