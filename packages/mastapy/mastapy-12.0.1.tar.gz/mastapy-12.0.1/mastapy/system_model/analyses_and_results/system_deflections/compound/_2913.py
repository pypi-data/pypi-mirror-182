...
class SynchroniserCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2771.SynchroniserSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2771.SynchroniserSystemDeflection]':
