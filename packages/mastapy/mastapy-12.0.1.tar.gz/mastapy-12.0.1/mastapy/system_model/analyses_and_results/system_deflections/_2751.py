...
from mastapy.system_model.analyses_and_results.system_deflections import _2749, _2750, _2639
...
class ShaftSystemDeflection(_2639.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def component_design(self) -> '_2435.Shaft':
    ...
    @property
    def component_load_case(self) -> '_6877.ShaftLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4076.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2749.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2749.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2749.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def mounted_components_applying_torque(self) -> 'List[_1525.ForceResults]':
    ...
    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2749.ShaftSectionEndResultsSystemDeflection]':
    ...
    @property
    def shaft_section_results(self) -> 'List[_2750.ShaftSectionSystemDeflection]':
