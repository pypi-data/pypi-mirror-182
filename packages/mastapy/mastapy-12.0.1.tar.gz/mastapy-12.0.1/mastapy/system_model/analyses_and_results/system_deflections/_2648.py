...
class BevelDifferentialGearMeshSystemDeflection(_2653.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3988.BevelDifferentialGearMeshPowerFlow':
