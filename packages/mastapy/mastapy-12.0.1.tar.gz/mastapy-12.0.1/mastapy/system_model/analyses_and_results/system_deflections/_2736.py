...
class PlanetaryConnectionSystemDeflection(_2752.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4061.PlanetaryConnectionPowerFlow':
