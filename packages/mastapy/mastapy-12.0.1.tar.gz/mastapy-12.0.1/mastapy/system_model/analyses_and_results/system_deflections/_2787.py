...
from mastapy.system_model.analyses_and_results.system_deflections import _2788, _2786, _2654
...
class ZerolBevelGearSetSystemDeflection(_2654.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4109.ZerolBevelGearSetPowerFlow':
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2788.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2786.ZerolBevelGearMeshSystemDeflection]':
