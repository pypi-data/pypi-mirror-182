...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2661.CoaxialConnectionSystemDeflection):
    """CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4021.CycloidalDiscCentralBearingConnectionPowerFlow':
