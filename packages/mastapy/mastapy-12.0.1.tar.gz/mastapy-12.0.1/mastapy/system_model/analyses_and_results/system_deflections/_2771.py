...
from mastapy.system_model.analyses_and_results.system_deflections import _2768, _2753
...
class SynchroniserSystemDeflection(_2753.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6895.SynchroniserLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4095.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2768.SynchroniserHalfSystemDeflection]':
