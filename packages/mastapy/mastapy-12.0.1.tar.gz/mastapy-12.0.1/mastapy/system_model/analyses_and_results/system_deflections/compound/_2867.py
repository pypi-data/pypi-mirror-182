...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2832.ConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2716.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2716.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
