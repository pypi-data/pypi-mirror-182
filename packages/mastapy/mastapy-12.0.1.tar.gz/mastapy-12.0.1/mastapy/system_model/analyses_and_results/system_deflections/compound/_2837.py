...
class CouplingHalfCompoundSystemDeflection(_2876.MountableComponentCompoundSystemDeflection):
    """CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2677.CouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2677.CouplingHalfSystemDeflection]':
