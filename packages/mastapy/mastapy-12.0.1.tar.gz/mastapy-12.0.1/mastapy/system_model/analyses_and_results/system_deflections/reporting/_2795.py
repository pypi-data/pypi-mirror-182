...
class RigidlyConnectedComponentGroupSystemDeflection(_2604.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1481.MassProperties':
    ...
    @property
    def components(self) -> 'List[_2662.ComponentSystemDeflection]':
