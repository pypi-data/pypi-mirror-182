...
class StraightBevelPlanetGearCompoundSystemDeflection(_2905.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2766.StraightBevelPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2766.StraightBevelPlanetGearSystemDeflection]':
