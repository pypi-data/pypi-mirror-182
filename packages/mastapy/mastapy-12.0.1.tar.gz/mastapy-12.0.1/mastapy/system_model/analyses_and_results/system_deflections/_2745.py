...
class RollingRingConnectionSystemDeflection(_2714.InterMountableComponentConnectionSystemDeflection):
    """RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4072.RollingRingConnectionPowerFlow':
