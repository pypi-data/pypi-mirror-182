...
class ConnectionCompoundSystemDeflection(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2674.ConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2674.ConnectionSystemDeflection]':
