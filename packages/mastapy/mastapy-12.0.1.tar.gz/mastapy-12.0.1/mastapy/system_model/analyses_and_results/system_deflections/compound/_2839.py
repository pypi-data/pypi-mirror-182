...
class CVTCompoundSystemDeflection(_2808.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2681.CVTSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2681.CVTSystemDeflection]':
