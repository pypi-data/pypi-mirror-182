...
class CVTPulleyCompoundSystemDeflection(_2887.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2680.CVTPulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2680.CVTPulleySystemDeflection]':
