...
class BevelDifferentialGearMeshCompoundSystemDeflection(_2815.BevelGearMeshCompoundSystemDeflection):
    """BevelDifferentialGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2648.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2648.BevelDifferentialGearMeshSystemDeflection]':
