...
class FaceGearMeshCompoundSystemDeflection(_2858.GearMeshCompoundSystemDeflection):
    """FaceGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2701.FaceGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2701.FaceGearMeshSystemDeflection]':
