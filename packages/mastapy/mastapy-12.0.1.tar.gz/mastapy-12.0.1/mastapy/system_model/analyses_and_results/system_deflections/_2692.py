...
from mastapy.system_model.analyses_and_results.power_flows import _4026, _4028
from mastapy.system_model.analyses_and_results.system_deflections import _2696, _2708
...
class CylindricalGearSystemDeflection(_2708.GearSystemDeflection):
    """CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4026.CylindricalGearPowerFlow':
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2696.CylindricalMeshedGearSystemDeflection]':
