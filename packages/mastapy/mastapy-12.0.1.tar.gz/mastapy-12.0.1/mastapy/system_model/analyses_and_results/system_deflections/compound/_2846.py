...
class CylindricalGearMeshCompoundSystemDeflection(_2858.GearMeshCompoundSystemDeflection):
    """CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2688.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2688.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
