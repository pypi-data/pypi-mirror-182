...
class ClutchCompoundSystemDeflection(_2835.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2660.ClutchSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2660.ClutchSystemDeflection]':
