...
class BevelGearMeshSystemDeflection(_2641.AGMAGleasonConicalGearMeshSystemDeflection):
    """BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3993.BevelGearMeshPowerFlow':
