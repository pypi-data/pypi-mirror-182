...
class PartToPartShearCouplingCompoundSystemDeflection(_2835.CouplingCompoundSystemDeflection):
    """PartToPartShearCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2735.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2735.PartToPartShearCouplingSystemDeflection]':
