...
class PointLoadCompoundSystemDeflection(_2922.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2738.PointLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2738.PointLoadSystemDeflection]':
