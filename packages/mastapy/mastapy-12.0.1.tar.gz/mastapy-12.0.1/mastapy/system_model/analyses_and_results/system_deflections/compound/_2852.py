...
class FaceGearCompoundSystemDeflection(_2857.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2703.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2703.FaceGearSystemDeflection]':
