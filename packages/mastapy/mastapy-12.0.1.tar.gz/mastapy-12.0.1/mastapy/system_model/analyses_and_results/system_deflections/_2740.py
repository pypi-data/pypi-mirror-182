...
from mastapy.system_model.analyses_and_results.power_flows import _4068, _4019
...
class PulleySystemDeflection(_2677.CouplingHalfSystemDeflection):
    """PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4068.PulleyPowerFlow':
