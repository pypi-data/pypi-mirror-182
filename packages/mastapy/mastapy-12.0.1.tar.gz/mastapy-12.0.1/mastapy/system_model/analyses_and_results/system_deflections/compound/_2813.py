...
class BevelDifferentialSunGearCompoundSystemDeflection(_2809.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2652.BevelDifferentialSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2652.BevelDifferentialSunGearSystemDeflection]':
