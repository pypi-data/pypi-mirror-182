...
class PowerLoadCompoundSystemDeflection(_2922.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2739.PowerLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2739.PowerLoadSystemDeflection]':
