...
class StraightBevelPlanetGearSystemDeflection(_2762.StraightBevelDiffGearSystemDeflection):
    """StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4091.StraightBevelPlanetGearPowerFlow':
