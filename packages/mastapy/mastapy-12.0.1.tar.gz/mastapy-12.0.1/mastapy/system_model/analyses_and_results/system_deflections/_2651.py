...
class BevelDifferentialPlanetGearSystemDeflection(_2650.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3991.BevelDifferentialPlanetGearPowerFlow':
