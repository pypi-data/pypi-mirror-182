...
class FlexiblePinAssemblyCompoundSystemDeflection(_2898.SpecialisedAssemblyCompoundSystemDeflection):
    """FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2705.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2705.FlexiblePinAssemblySystemDeflection]':
