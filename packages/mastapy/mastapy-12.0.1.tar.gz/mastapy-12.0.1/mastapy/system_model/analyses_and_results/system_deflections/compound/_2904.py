...
class SpringDamperHalfCompoundSystemDeflection(_2837.CouplingHalfCompoundSystemDeflection):
    """SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2758.SpringDamperHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2758.SpringDamperHalfSystemDeflection]':
