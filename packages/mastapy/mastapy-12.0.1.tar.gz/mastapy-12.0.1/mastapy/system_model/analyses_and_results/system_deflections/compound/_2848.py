...
class CylindricalPlanetGearCompoundSystemDeflection(_2845.CylindricalGearCompoundSystemDeflection):
    """CylindricalPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2697.CylindricalPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2697.CylindricalPlanetGearSystemDeflection]':
