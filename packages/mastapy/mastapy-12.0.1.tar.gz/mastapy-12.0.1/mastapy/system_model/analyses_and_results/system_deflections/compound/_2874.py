...
class MassDiscCompoundSystemDeflection(_2922.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2726.MassDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2726.MassDiscSystemDeflection]':
