...
class PartToPartShearCouplingHalfSystemDeflection(_2677.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4059.PartToPartShearCouplingHalfPowerFlow':
