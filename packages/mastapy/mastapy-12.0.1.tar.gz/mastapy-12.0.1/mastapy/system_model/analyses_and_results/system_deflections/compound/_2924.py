...
class WormGearMeshCompoundSystemDeflection(_2858.GearMeshCompoundSystemDeflection):
    """WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2783.WormGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2783.WormGearMeshSystemDeflection]':
