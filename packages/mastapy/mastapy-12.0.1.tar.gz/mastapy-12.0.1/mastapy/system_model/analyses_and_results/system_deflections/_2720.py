...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2717.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4048.KlingelnbergCycloPalloidHypoidGearPowerFlow':
