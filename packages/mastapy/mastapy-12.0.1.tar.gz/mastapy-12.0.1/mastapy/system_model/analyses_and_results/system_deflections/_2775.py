...
class TorqueConverterConnectionSystemDeflection(_2676.CouplingConnectionSystemDeflection):
    """TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4098.TorqueConverterConnectionPowerFlow':
