...
class ZerolBevelGearCompoundSystemDeflection(_2814.BevelGearCompoundSystemDeflection):
    """ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2788.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2788.ZerolBevelGearSystemDeflection]':
