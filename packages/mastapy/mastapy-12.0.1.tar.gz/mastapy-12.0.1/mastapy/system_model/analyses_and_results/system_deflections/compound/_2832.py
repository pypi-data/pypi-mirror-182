...
class ConicalGearSetCompoundSystemDeflection(_2859.GearSetCompoundSystemDeflection):
    """ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2672.ConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2672.ConicalGearSetSystemDeflection]':
