...
class StraightBevelDiffGearMeshCompoundSystemDeflection(_2815.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelDiffGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2760.StraightBevelDiffGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2760.StraightBevelDiffGearMeshSystemDeflection]':
