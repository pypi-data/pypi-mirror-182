...
class KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection(_2715.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4047.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
