...
class ShaftToMountableComponentConnectionSystemDeflection(_2640.AbstractShaftToMountableComponentConnectionSystemDeflection):
    """ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4077.ShaftToMountableComponentConnectionPowerFlow':
