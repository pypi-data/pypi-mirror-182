...
class ExternalCADModelCompoundSystemDeflection(_2823.ComponentCompoundSystemDeflection):
    """ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2699.ExternalCADModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2699.ExternalCADModelSystemDeflection]':
