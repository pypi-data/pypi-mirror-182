...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2833.ConnectionCompoundSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2640.AbstractShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2640.AbstractShaftToMountableComponentConnectionSystemDeflection]':
