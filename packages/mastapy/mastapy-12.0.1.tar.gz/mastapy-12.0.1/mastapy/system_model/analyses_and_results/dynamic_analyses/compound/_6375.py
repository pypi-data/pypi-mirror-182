...
class CouplingHalfCompoundDynamicAnalysis(_6413.MountableComponentCompoundDynamicAnalysis):
    """CouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6245.CouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6245.CouplingHalfDynamicAnalysis]':
