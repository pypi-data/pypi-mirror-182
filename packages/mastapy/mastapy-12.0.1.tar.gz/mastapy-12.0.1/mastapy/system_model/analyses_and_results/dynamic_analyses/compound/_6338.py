...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6208.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6208.AbstractShaftOrHousingDynamicAnalysis]':
