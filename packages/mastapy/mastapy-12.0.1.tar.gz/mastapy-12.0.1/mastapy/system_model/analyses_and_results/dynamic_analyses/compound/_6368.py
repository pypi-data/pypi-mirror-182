...
class ConicalGearCompoundDynamicAnalysis(_6394.GearCompoundDynamicAnalysis):
    """ConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6238.ConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6238.ConicalGearDynamicAnalysis]':
