...
class DatumCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6257.DatumDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6257.DatumDynamicAnalysis]':
