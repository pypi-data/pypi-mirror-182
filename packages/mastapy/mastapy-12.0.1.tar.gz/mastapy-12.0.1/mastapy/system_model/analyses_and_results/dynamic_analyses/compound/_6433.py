...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6339.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6304.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6304.ShaftToMountableComponentConnectionDynamicAnalysis]':
