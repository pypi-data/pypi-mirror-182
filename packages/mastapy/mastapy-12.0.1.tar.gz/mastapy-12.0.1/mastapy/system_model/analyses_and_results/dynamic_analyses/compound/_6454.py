...
class TorqueConverterConnectionCompoundDynamicAnalysis(_6374.CouplingConnectionCompoundDynamicAnalysis):
    """TorqueConverterConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6324.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6324.TorqueConverterConnectionDynamicAnalysis]':
