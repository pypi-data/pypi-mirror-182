...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6360.CoaxialConnectionCompoundDynamicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6250.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6250.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
