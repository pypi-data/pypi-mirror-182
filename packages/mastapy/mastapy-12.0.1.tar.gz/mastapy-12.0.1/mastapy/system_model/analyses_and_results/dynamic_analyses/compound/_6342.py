...
class AGMAGleasonConicalGearSetCompoundDynamicAnalysis(_6370.ConicalGearSetCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6212.AGMAGleasonConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6212.AGMAGleasonConicalGearSetDynamicAnalysis]':
