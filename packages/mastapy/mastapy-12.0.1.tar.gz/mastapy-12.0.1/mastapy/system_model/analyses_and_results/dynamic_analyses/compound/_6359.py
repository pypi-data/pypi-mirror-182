...
class ClutchHalfCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """ClutchHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6229.ClutchHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6229.ClutchHalfDynamicAnalysis]':
