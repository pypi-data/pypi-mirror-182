...
class StraightBevelPlanetGearCompoundDynamicAnalysis(_6441.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6318.StraightBevelPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6318.StraightBevelPlanetGearDynamicAnalysis]':
