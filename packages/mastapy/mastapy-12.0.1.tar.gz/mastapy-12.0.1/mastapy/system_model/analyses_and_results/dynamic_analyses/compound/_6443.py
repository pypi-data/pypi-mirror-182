...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6441, _6442, _6354
...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(_6354.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelDiffGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6314.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_dynamic_analysis(self) -> 'List[_6441.StraightBevelDiffGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_dynamic_analysis(self) -> 'List[_6442.StraightBevelDiffGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6314.StraightBevelDiffGearSetDynamicAnalysis]':
