...
class ConceptCouplingCompoundDynamicAnalysis(_6373.CouplingCompoundDynamicAnalysis):
    """ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6233.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6233.ConceptCouplingDynamicAnalysis]':
