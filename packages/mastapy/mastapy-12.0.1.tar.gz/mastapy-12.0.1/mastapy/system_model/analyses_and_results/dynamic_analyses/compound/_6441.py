...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6352.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6312.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6312.StraightBevelDiffGearDynamicAnalysis]':
