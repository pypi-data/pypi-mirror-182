...
class RollingRingConnectionCompoundDynamicAnalysis(_6401.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6299.RollingRingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6299.RollingRingConnectionDynamicAnalysis]':
