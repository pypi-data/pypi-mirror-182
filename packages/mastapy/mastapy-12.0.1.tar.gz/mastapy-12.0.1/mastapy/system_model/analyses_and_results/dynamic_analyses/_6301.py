...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2578, _6213
...
from mastapy.system_model.analyses_and_results.modal_analyses import _2581
...
class RootAssemblyDynamicAnalysis(_6213.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2578.DynamicAnalysis':
