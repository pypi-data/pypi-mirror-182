...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6279, _6280, _6275
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis(_6275.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6279.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6280.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
