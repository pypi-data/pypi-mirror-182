...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6353
...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_6353.BevelGearMeshCompoundDynamicAnalysis):
    """BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6218.BevelDifferentialGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6218.BevelDifferentialGearMeshDynamicAnalysis]':
