...
class AbstractShaftCompoundDynamicAnalysis(_6338.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6207.AbstractShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6207.AbstractShaftDynamicAnalysis]':
