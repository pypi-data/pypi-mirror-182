...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6347.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6221.BevelDifferentialSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6221.BevelDifferentialSunGearDynamicAnalysis]':
