...
class ExternalCADModelCompoundDynamicAnalysis(_6361.ComponentCompoundDynamicAnalysis):
    """ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6259.ExternalCADModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6259.ExternalCADModelDynamicAnalysis]':
