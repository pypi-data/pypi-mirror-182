...
class SpiralBevelGearMeshCompoundDynamicAnalysis(_6353.BevelGearMeshCompoundDynamicAnalysis):
    """SpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6307.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6307.SpiralBevelGearMeshDynamicAnalysis]':
