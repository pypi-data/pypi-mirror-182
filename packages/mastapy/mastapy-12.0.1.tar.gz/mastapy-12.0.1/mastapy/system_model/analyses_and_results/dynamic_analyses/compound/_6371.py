...
class ConnectionCompoundDynamicAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6241.ConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6241.ConnectionDynamicAnalysis]':
