...
class CylindricalGearCompoundDynamicAnalysis(_6394.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6253.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6253.CylindricalGearDynamicAnalysis]':
