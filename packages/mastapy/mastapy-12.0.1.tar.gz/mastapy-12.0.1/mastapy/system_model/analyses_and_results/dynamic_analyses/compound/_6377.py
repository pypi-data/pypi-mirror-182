...
class CVTCompoundDynamicAnalysis(_6346.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6247.CVTDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6247.CVTDynamicAnalysis]':
