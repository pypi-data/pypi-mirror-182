...
class PartToPartShearCouplingConnectionCompoundDynamicAnalysis(_6374.CouplingConnectionCompoundDynamicAnalysis):
    """PartToPartShearCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6287.PartToPartShearCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6287.PartToPartShearCouplingConnectionDynamicAnalysis]':
