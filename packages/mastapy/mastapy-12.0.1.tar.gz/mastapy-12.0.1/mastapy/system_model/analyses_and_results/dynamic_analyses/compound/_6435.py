...
class SpiralBevelGearCompoundDynamicAnalysis(_6352.BevelGearCompoundDynamicAnalysis):
    """SpiralBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6306.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6306.SpiralBevelGearDynamicAnalysis]':
