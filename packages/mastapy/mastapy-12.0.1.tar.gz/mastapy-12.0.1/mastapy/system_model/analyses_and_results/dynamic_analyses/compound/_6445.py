...
class StraightBevelGearMeshCompoundDynamicAnalysis(_6353.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6316.StraightBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6316.StraightBevelGearMeshDynamicAnalysis]':
