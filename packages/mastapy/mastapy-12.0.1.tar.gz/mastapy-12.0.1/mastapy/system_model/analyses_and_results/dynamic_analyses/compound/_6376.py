...
class CVTBeltConnectionCompoundDynamicAnalysis(_6345.BeltConnectionCompoundDynamicAnalysis):
    """CVTBeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6246.CVTBeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6246.CVTBeltConnectionDynamicAnalysis]':
