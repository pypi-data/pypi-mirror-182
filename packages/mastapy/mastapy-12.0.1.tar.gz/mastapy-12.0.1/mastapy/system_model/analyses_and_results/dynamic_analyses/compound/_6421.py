...
class PlanetCarrierCompoundDynamicAnalysis(_6413.MountableComponentCompoundDynamicAnalysis):
    """PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6292.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6292.PlanetCarrierDynamicAnalysis]':
