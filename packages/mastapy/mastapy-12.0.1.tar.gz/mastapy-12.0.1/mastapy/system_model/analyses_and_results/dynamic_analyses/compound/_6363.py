...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6374.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6232.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6232.ConceptCouplingConnectionDynamicAnalysis]':
