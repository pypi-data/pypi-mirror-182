...
from mastapy.system_model.analyses_and_results.dynamic_analyses import (
    _6214, _6216, _6219, _6226,
    _6225, _6247, _6228, _6233,
    _6237, _6249, _6251, _6255,
    _6263, _6262, _6264, _6271,
    _6278, _6281, _6282, _6283,
    _6285, _6288, _6292, _6293,
    _6294, _6296, _6298, _6303,
    _6302, _6308, _6310, _6314,
    _6317, _6320, _6325, _6328,
    _6332, _6335, _6206
)
...
class AssemblyDynamicAnalysis(_6206.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6214.BearingDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6216.BeltDriveDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6219.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6226.BoltedJointDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6225.BoltDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6247.CVTDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6228.ClutchDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6233.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6237.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6249.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6251.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6255.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6263.FEPartDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6262.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6264.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6271.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6278.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6281.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6282.MassDiscDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6283.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6285.OilSealDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6288.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6292.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6293.PointLoadDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6294.PowerLoadDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6296.RingPinsDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6298.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6303.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6302.ShaftDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6308.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6310.SpringDamperDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6314.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6317.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6320.SynchroniserDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6325.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6328.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6332.WormGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6335.ZerolBevelGearSetDynamicAnalysis]':
