...
class StraightBevelDiffGearMeshCompoundDynamicAnalysis(_6353.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelDiffGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6313.StraightBevelDiffGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6313.StraightBevelDiffGearMeshDynamicAnalysis]':
