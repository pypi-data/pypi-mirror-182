...
class BeltDriveCompoundDynamicAnalysis(_6434.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6216.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6216.BeltDriveDynamicAnalysis]':
