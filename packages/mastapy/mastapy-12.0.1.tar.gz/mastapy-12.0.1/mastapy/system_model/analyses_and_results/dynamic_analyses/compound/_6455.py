...
class TorqueConverterPumpCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6326.TorqueConverterPumpDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6326.TorqueConverterPumpDynamicAnalysis]':
