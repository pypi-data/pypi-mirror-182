...
class TorqueConverterCompoundDynamicAnalysis(_6373.CouplingCompoundDynamicAnalysis):
    """TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6325.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6325.TorqueConverterDynamicAnalysis]':
