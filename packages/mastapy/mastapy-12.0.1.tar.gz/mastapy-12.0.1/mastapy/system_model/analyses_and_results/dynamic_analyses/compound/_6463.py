...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_6353.BevelGearMeshCompoundDynamicAnalysis):
    """ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6334.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6334.ZerolBevelGearMeshDynamicAnalysis]':
