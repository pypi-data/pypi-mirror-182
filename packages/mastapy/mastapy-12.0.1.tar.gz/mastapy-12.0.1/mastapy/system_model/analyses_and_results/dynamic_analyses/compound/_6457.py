...
class UnbalancedMassCompoundDynamicAnalysis(_6458.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6328.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6328.UnbalancedMassDynamicAnalysis]':
