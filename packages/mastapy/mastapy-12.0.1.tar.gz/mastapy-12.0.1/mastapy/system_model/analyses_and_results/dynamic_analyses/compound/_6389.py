...
class FaceGearCompoundDynamicAnalysis(_6394.GearCompoundDynamicAnalysis):
    """FaceGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6260.FaceGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6260.FaceGearDynamicAnalysis]':
