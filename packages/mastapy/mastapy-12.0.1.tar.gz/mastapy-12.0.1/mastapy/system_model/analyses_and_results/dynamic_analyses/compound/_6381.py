...
class CycloidalDiscCompoundDynamicAnalysis(_6337.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6251.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6251.CycloidalDiscDynamicAnalysis]':
