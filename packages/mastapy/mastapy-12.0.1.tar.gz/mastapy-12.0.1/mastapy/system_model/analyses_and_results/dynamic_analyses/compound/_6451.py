...
class SynchroniserPartCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6322.SynchroniserPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6322.SynchroniserPartDynamicAnalysis]':
