...
class ConceptGearCompoundDynamicAnalysis(_6394.GearCompoundDynamicAnalysis):
    """ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6235.ConceptGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6235.ConceptGearDynamicAnalysis]':
