...
class ConceptGearMeshCompoundDynamicAnalysis(_6395.GearMeshCompoundDynamicAnalysis):
    """ConceptGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6236.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6236.ConceptGearMeshDynamicAnalysis]':
