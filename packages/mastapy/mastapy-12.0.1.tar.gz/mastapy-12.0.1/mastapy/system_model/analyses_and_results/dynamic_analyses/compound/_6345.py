...
class BeltConnectionCompoundDynamicAnalysis(_6401.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """BeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6215.BeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6215.BeltConnectionDynamicAnalysis]':
