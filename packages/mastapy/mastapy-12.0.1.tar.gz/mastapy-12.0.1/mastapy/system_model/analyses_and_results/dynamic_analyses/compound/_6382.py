...
class CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis(_6339.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6252.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6252.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
