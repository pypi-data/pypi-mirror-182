...
class CylindricalPlanetGearCompoundDynamicAnalysis(_6383.CylindricalGearCompoundDynamicAnalysis):
    """CylindricalPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6256.CylindricalPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6256.CylindricalPlanetGearDynamicAnalysis]':
