...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6365, _6366, _6396
...
class ConceptGearSetCompoundDynamicAnalysis(_6396.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6237.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6365.ConceptGearCompoundDynamicAnalysis]':
    ...
    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6366.ConceptGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6237.ConceptGearSetDynamicAnalysis]':
