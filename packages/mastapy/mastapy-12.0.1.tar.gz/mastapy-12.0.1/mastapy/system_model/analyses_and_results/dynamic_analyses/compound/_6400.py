...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6398, _6399, _6342
...
class HypoidGearSetCompoundDynamicAnalysis(_6342.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """HypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6271.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6398.HypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6399.HypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6271.HypoidGearSetDynamicAnalysis]':
