...
class TorqueConverterTurbineCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterTurbineCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6327.TorqueConverterTurbineDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6327.TorqueConverterTurbineDynamicAnalysis]':
