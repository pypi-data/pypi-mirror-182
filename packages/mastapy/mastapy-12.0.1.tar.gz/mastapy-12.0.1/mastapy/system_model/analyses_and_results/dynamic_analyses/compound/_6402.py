...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6368
...
class KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis(_6368.ConicalGearCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6273.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6273.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
