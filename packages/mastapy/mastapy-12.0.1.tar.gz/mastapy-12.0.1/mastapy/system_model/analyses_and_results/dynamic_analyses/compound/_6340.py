...
class AGMAGleasonConicalGearCompoundDynamicAnalysis(_6368.ConicalGearCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6210.AGMAGleasonConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6210.AGMAGleasonConicalGearDynamicAnalysis]':
