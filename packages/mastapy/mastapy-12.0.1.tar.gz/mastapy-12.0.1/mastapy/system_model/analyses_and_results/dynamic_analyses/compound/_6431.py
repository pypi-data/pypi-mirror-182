...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6337
...
class ShaftCompoundDynamicAnalysis(_6337.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6302.ShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6302.ShaftDynamicAnalysis]':
