...
class PulleyCompoundDynamicAnalysis(_6375.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6295.PulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6295.PulleyDynamicAnalysis]':
