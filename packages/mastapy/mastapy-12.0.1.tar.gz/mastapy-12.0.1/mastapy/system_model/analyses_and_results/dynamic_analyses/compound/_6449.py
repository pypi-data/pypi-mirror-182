...
class SynchroniserCompoundDynamicAnalysis(_6434.SpecialisedAssemblyCompoundDynamicAnalysis):
    """SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6320.SynchroniserDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6320.SynchroniserDynamicAnalysis]':
