...
class FaceGearMeshCompoundDynamicAnalysis(_6395.GearMeshCompoundDynamicAnalysis):
    """FaceGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6261.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6261.FaceGearMeshDynamicAnalysis]':
