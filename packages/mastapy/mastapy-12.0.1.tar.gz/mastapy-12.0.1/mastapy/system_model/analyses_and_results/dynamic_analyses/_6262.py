...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6260, _6261, _6267
...
class FaceGearSetDynamicAnalysis(_6267.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6260.FaceGearDynamicAnalysis]':
    ...
    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6261.FaceGearMeshDynamicAnalysis]':
