...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_5196.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5071.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5071.BevelDifferentialSunGearModalAnalysisAtASpeed]':
