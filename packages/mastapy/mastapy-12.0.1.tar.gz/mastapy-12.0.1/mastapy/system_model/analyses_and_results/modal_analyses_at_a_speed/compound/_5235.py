...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_5232.CylindricalGearCompoundModalAnalysisAtASpeed):
    """CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5106.CylindricalPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5106.CylindricalPlanetGearModalAnalysisAtASpeed]':
