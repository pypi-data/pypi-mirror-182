...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed(_5224.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5137.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5137.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
