...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5220.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5121.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5121.InterMountableComponentConnectionModalAnalysisAtASpeed]':
