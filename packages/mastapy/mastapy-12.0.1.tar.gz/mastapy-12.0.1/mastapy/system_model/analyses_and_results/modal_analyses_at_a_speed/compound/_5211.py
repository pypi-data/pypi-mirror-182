...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_5222.CouplingCompoundModalAnalysisAtASpeed):
    """ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5084.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5084.ConceptCouplingModalAnalysisAtASpeed]':
