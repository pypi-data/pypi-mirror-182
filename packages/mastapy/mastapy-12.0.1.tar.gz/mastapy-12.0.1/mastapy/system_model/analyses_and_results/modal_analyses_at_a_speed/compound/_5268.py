...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5282.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5139.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5139.PlanetaryConnectionModalAnalysisAtASpeed]':
