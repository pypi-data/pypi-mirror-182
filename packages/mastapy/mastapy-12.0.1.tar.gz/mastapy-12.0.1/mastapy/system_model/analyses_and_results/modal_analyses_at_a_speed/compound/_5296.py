...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5290.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5167.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5167.StraightBevelPlanetGearModalAnalysisAtASpeed]':
