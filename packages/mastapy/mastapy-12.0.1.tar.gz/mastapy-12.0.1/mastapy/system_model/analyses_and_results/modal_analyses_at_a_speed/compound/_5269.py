...
class PlanetaryGearSetCompoundModalAnalysisAtASpeed(_5234.CylindricalGearSetCompoundModalAnalysisAtASpeed):
    """PlanetaryGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5140.PlanetaryGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5140.PlanetaryGearSetModalAnalysisAtASpeed]':
