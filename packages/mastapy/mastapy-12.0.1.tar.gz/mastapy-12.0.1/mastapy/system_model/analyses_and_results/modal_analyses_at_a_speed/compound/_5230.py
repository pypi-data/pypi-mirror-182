...
class CycloidalDiscCompoundModalAnalysisAtASpeed(_5186.AbstractShaftCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5101.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5101.CycloidalDiscModalAnalysisAtASpeed]':
