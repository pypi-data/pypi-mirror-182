...
class ClutchConnectionCompoundModalAnalysisAtASpeed(_5223.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """ClutchConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5077.ClutchConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5077.ClutchConnectionModalAnalysisAtASpeed]':
