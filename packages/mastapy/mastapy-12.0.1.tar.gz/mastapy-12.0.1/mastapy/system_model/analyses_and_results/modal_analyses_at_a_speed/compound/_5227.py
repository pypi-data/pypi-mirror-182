...
class CVTPulleyCompoundModalAnalysisAtASpeed(_5273.PulleyCompoundModalAnalysisAtASpeed):
    """CVTPulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5098.CVTPulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5098.CVTPulleyModalAnalysisAtASpeed]':
