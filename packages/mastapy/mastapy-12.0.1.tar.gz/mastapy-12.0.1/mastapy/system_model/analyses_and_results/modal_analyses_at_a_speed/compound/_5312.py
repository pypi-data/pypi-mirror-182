...
class ZerolBevelGearMeshCompoundModalAnalysisAtASpeed(_5202.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5182.ZerolBevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5182.ZerolBevelGearMeshModalAnalysisAtASpeed]':
