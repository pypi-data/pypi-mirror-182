...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5307.VirtualComponentCompoundModalAnalysisAtASpeed):
    """UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5177.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5177.UnbalancedMassModalAnalysisAtASpeed]':
