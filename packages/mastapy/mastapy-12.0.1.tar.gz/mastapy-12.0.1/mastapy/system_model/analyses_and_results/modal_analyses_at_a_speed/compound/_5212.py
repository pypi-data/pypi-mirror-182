...
class ConceptCouplingConnectionCompoundModalAnalysisAtASpeed(_5223.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """ConceptCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5082.ConceptCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5082.ConceptCouplingConnectionModalAnalysisAtASpeed]':
