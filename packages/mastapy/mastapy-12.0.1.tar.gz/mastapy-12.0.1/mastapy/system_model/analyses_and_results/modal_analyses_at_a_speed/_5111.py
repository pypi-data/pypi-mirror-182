...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5110, _5109, _5116
...
class FaceGearSetModalAnalysisAtASpeed(_5116.GearSetModalAnalysisAtASpeed):
    """FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_5110.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_5109.FaceGearMeshModalAnalysisAtASpeed]':
