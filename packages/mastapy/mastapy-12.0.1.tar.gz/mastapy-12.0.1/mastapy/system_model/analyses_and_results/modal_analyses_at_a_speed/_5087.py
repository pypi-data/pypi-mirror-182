...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5086, _5085, _5116
...
class ConceptGearSetModalAnalysisAtASpeed(_5116.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5086.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5085.ConceptGearMeshModalAnalysisAtASpeed]':
