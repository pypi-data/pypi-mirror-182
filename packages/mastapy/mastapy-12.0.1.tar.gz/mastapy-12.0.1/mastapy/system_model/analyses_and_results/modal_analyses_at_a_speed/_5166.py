...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5165, _5164, _5074
...
class StraightBevelGearSetModalAnalysisAtASpeed(_5074.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5165.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5164.StraightBevelGearMeshModalAnalysisAtASpeed]':
