...
class FlexiblePinAssemblyCompoundModalAnalysisAtASpeed(_5283.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """FlexiblePinAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5113.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5113.FlexiblePinAssemblyModalAnalysisAtASpeed]':
