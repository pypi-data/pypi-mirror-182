...
class HypoidGearMeshCompoundModalAnalysisAtASpeed(_5190.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """HypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5118.HypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5118.HypoidGearMeshModalAnalysisAtASpeed]':
