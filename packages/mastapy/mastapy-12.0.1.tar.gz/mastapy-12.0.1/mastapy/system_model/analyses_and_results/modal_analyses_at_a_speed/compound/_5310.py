...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5308, _5309, _5245
...
class WormGearSetCompoundModalAnalysisAtASpeed(_5245.GearSetCompoundModalAnalysisAtASpeed):
    """WormGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5181.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5308.WormGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5309.WormGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5181.WormGearSetModalAnalysisAtASpeed]':
