...
class SynchroniserCompoundModalAnalysisAtASpeed(_5283.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """SynchroniserCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5170.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5170.SynchroniserModalAnalysisAtASpeed]':
