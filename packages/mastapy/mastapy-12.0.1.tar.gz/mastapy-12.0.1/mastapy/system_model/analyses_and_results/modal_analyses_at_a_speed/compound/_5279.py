...
class RootAssemblyCompoundModalAnalysisAtASpeed(_5192.AssemblyCompoundModalAnalysisAtASpeed):
    """RootAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5150.RootAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5150.RootAssemblyModalAnalysisAtASpeed]':
