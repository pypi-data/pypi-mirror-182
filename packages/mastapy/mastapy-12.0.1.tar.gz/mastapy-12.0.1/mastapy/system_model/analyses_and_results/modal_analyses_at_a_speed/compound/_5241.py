...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5187
...
class FEPartCompoundModalAnalysisAtASpeed(_5187.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """FEPartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5112.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5112.FEPartModalAnalysisAtASpeed]':
