...
class ComponentCompoundModalAnalysisAtASpeed(_5264.PartCompoundModalAnalysisAtASpeed):
    """ComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5081.ComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5081.ComponentModalAnalysisAtASpeed]':
