...
class BevelGearMeshCompoundModalAnalysisAtASpeed(_5190.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """BevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5072.BevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5072.BevelGearMeshModalAnalysisAtASpeed]':
