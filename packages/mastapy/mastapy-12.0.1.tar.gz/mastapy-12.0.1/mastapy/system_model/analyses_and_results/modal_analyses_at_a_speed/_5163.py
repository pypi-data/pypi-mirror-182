...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5162, _5161, _5074
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_5074.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_5162.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_5161.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
