...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5284, _5285, _5203
...
class SpiralBevelGearSetCompoundModalAnalysisAtASpeed(_5203.BevelGearSetCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5157.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5284.SpiralBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5285.SpiralBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5157.SpiralBevelGearSetModalAnalysisAtASpeed]':
