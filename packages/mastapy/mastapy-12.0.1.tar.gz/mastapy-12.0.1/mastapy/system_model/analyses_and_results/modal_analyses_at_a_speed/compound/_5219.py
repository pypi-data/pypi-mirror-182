...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5245.GearSetCompoundModalAnalysisAtASpeed):
    """ConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5090.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5090.ConicalGearSetModalAnalysisAtASpeed]':
