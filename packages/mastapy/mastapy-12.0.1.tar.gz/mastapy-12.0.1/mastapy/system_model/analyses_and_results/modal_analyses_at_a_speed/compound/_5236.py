...
class DatumCompoundModalAnalysisAtASpeed(_5210.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5107.DatumModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5107.DatumModalAnalysisAtASpeed]':
