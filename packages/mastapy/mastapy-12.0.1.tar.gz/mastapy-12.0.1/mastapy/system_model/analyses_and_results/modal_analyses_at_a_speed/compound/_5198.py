...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5196, _5197, _5203
...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(_5203.BevelGearSetCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5069.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5196.BevelDifferentialGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5197.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5069.BevelDifferentialGearSetModalAnalysisAtASpeed]':
