...
class SpiralBevelGearCompoundModalAnalysisAtASpeed(_5201.BevelGearCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5156.SpiralBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5156.SpiralBevelGearModalAnalysisAtASpeed]':
