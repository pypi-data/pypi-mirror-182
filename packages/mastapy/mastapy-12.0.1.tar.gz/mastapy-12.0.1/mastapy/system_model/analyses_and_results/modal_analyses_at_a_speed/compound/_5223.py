...
class CouplingConnectionCompoundModalAnalysisAtASpeed(_5250.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5093.CouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5093.CouplingConnectionModalAnalysisAtASpeed]':
