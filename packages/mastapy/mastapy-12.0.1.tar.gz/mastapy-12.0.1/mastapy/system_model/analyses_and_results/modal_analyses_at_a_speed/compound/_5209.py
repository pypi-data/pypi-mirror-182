...
class CoaxialConnectionCompoundModalAnalysisAtASpeed(_5282.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CoaxialConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5080.CoaxialConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5080.CoaxialConnectionModalAnalysisAtASpeed]':
