...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5311, _5312, _5203
...
class ZerolBevelGearSetCompoundModalAnalysisAtASpeed(_5203.BevelGearSetCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5184.ZerolBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5311.ZerolBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5312.ZerolBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5184.ZerolBevelGearSetModalAnalysisAtASpeed]':
