...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed(_5196.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5070.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5070.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
