...
class RollingRingCompoundModalAnalysisAtASpeed(_5224.CouplingHalfCompoundModalAnalysisAtASpeed):
    """RollingRingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5149.RollingRingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5149.RollingRingModalAnalysisAtASpeed]':
