...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5238, _5239, _5245
...
class FaceGearSetCompoundModalAnalysisAtASpeed(_5245.GearSetCompoundModalAnalysisAtASpeed):
    """FaceGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5111.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5238.FaceGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5239.FaceGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5111.FaceGearSetModalAnalysisAtASpeed]':
