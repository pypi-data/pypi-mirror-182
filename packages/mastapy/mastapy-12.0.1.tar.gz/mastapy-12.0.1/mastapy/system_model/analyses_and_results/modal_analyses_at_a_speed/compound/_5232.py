...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5243.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5104.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5104.CylindricalGearModalAnalysisAtASpeed]':
