...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
    _5193, _5195, _5198, _5205,
    _5204, _5226, _5206, _5211,
    _5216, _5228, _5230, _5234,
    _5241, _5240, _5242, _5249,
    _5256, _5259, _5260, _5261,
    _5263, _5265, _5270, _5271,
    _5272, _5274, _5276, _5281,
...
class AssemblyCompoundModalAnalysisAtASpeed(_5185.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """AssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5063.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_5193.BearingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5195.BeltDriveCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5198.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5205.BoltedJointCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5204.BoltCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5226.CVTCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5206.ClutchCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5211.ConceptCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5216.ConceptGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5228.CycloidalAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5230.CycloidalDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5234.CylindricalGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5241.FEPartCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5240.FaceGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5242.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5249.HypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5256.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5259.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5260.MassDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5261.MeasurementComponentCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5263.OilSealCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5265.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5270.PlanetCarrierCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5271.PointLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5272.PowerLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5274.RingPinsCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5276.RollingRingAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5281.ShaftHubConnectionCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5280.ShaftCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5286.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5287.SpringDamperCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5292.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5295.StraightBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5298.SynchroniserCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5302.TorqueConverterCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5306.UnbalancedMassCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5310.WormGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5313.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5063.AssemblyModalAnalysisAtASpeed]':
