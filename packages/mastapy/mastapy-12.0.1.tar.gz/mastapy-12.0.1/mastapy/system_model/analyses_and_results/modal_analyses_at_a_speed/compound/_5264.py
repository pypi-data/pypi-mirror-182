...
class PartCompoundModalAnalysisAtASpeed(_7471.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5135.PartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5135.PartModalAnalysisAtASpeed]':
