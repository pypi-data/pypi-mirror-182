...
class MountableComponentCompoundModalAnalysisAtASpeed(_5210.ComponentCompoundModalAnalysisAtASpeed):
    """MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5133.MountableComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5133.MountableComponentModalAnalysisAtASpeed]':
