...
class ConicalGearMeshCompoundModalAnalysisAtASpeed(_5244.GearMeshCompoundModalAnalysisAtASpeed):
    """ConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5088.ConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5088.ConicalGearMeshModalAnalysisAtASpeed]':
