...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_5250.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5148.RollingRingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5148.RollingRingConnectionModalAnalysisAtASpeed]':
