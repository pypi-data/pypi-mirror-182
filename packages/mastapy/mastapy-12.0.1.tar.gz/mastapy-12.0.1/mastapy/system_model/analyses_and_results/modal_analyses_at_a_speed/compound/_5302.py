...
class TorqueConverterCompoundModalAnalysisAtASpeed(_5222.CouplingCompoundModalAnalysisAtASpeed):
    """TorqueConverterCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5174.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5174.TorqueConverterModalAnalysisAtASpeed]':
