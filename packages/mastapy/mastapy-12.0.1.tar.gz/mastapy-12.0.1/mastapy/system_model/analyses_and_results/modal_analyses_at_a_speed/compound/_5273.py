...
class PulleyCompoundModalAnalysisAtASpeed(_5224.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5144.PulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5144.PulleyModalAnalysisAtASpeed]':
