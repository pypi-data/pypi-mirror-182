...
class FaceGearMeshCompoundModalAnalysisAtASpeed(_5244.GearMeshCompoundModalAnalysisAtASpeed):
    """FaceGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5109.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5109.FaceGearMeshModalAnalysisAtASpeed]':
