...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5210.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5108.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5108.ExternalCADModelModalAnalysisAtASpeed]':
