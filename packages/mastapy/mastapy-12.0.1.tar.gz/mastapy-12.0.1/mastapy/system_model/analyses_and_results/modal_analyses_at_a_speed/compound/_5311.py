...
class ZerolBevelGearCompoundModalAnalysisAtASpeed(_5201.BevelGearCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5183.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5183.ZerolBevelGearModalAnalysisAtASpeed]':
