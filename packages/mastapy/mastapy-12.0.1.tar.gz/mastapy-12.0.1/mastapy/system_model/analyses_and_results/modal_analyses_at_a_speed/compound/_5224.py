...
class CouplingHalfCompoundModalAnalysisAtASpeed(_5262.MountableComponentCompoundModalAnalysisAtASpeed):
    """CouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5094.CouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5094.CouplingHalfModalAnalysisAtASpeed]':
