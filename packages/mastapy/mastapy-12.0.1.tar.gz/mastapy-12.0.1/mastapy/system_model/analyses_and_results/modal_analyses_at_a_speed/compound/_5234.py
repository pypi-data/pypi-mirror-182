...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5232, _5233, _5245
...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(_5245.GearSetCompoundModalAnalysisAtASpeed):
    """CylindricalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5105.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5232.CylindricalGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5233.CylindricalGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5105.CylindricalGearSetModalAnalysisAtASpeed]':
