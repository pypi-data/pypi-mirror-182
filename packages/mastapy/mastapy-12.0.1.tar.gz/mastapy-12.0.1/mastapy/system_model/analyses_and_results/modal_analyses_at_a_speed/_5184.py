...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5183, _5182, _5074
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5074.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5183.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5182.ZerolBevelGearMeshModalAnalysisAtASpeed]':
