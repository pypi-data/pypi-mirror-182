...
class SynchroniserSleeveCompoundModalAnalysisAtASpeed(_5300.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserSleeveCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5172.SynchroniserSleeveModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5172.SynchroniserSleeveModalAnalysisAtASpeed]':
