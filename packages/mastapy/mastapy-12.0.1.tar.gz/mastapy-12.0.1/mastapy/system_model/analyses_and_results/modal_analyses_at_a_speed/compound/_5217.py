...
class ConicalGearCompoundModalAnalysisAtASpeed(_5243.GearCompoundModalAnalysisAtASpeed):
    """ConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5089.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5089.ConicalGearModalAnalysisAtASpeed]':
