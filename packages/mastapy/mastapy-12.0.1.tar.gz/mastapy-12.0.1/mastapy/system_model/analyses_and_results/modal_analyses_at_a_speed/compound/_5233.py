...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_5244.GearMeshCompoundModalAnalysisAtASpeed):
    """CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5103.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5103.CylindricalGearMeshModalAnalysisAtASpeed]':
