...
class AbstractAssemblyCompoundModalAnalysisAtASpeed(_5264.PartCompoundModalAnalysisAtASpeed):
    """AbstractAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5056.AbstractAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5056.AbstractAssemblyModalAnalysisAtASpeed]':
