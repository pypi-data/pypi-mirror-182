...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_5222.CouplingCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5138.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5138.PartToPartShearCouplingModalAnalysisAtASpeed]':
