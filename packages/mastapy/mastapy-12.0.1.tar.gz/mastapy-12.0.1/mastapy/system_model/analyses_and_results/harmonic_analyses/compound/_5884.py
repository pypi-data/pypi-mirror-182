...
class MassDiscCompoundHarmonicAnalysis(_5931.VirtualComponentCompoundHarmonicAnalysis):
    """MassDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5715.MassDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5715.MassDiscHarmonicAnalysis]':
