...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5763.TorqueConverterPumpHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5763.TorqueConverterPumpHarmonicAnalysis]':
