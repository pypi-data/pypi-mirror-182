...
class ExternalCADModelCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5681.ExternalCADModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5681.ExternalCADModelHarmonicAnalysis]':
