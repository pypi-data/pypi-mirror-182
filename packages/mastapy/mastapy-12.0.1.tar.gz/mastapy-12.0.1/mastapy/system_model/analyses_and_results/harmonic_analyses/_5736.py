...
class RootAssemblyHarmonicAnalysis(_5623.AssemblyHarmonicAnalysis):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5700.HarmonicAnalysisRootAssemblyExportOptions':
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2584.HarmonicAnalysis':
