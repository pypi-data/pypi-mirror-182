...
class ConnectorCompoundHarmonicAnalysis(_5886.MountableComponentCompoundHarmonicAnalysis):
    """ConnectorCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5653.ConnectorHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5653.ConnectorHarmonicAnalysis]':
