...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5844.ConnectionCompoundHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5619.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5619.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
