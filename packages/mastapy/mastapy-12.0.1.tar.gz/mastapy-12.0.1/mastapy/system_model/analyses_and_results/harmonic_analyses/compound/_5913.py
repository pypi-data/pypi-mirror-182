...
class SpringDamperHalfCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5747.SpringDamperHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5747.SpringDamperHalfHarmonicAnalysis]':
