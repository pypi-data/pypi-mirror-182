...
class CVTPulleyCompoundHarmonicAnalysis(_5897.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5659.CVTPulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5659.CVTPulleyHarmonicAnalysis]':
