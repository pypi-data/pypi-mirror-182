...
class FaceGearMeshCompoundHarmonicAnalysis(_5868.GearMeshCompoundHarmonicAnalysis):
    """FaceGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5683.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5683.FaceGearMeshHarmonicAnalysis]':
