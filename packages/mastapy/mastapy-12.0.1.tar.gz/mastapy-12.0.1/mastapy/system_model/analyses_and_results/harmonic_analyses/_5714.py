...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5712, _5713, _5708
...
class KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis(_5708.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6847.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2722.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5712.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5712.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5713.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5713.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
