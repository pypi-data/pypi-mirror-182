...
class PowerLoadCompoundHarmonicAnalysis(_5931.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5728.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5728.PowerLoadHarmonicAnalysis]':
