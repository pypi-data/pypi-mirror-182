...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import (
    _5817, _5819, _5822, _5829,
    _5828, _5850, _5830, _5835,
    _5840, _5852, _5854, _5858,
    _5865, _5864, _5866, _5873,
    _5880, _5883, _5884, _5885,
    _5887, _5889, _5894, _5895,
    _5896, _5898, _5900, _5905,
    _5904, _5910, _5911, _5916,
    _5919, _5922, _5926, _5930,
    _5934, _5937, _5809
)
...
class AssemblyCompoundHarmonicAnalysis(_5809.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5623.AssemblyHarmonicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5817.BearingCompoundHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5819.BeltDriveCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5822.BevelDifferentialGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5829.BoltedJointCompoundHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5828.BoltCompoundHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5850.CVTCompoundHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5830.ClutchCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5835.ConceptCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5840.ConceptGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5852.CycloidalAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5854.CycloidalDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5858.CylindricalGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5865.FEPartCompoundHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5864.FaceGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5866.FlexiblePinAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5873.HypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5880.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5883.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5884.MassDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5885.MeasurementComponentCompoundHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5887.OilSealCompoundHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5889.PartToPartShearCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5894.PlanetCarrierCompoundHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5895.PointLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5896.PowerLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5898.RingPinsCompoundHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5900.RollingRingAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5905.ShaftHubConnectionCompoundHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5904.ShaftCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5910.SpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5911.SpringDamperCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5916.StraightBevelDiffGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5919.StraightBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5922.SynchroniserCompoundHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5926.TorqueConverterCompoundHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5930.UnbalancedMassCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5934.WormGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5937.ZerolBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5623.AssemblyHarmonicAnalysis]':
