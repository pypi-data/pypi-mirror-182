...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5820, _5821, _5827
...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(_5827.BevelGearSetCompoundHarmonicAnalysis):
    """BevelDifferentialGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5629.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis(self) -> 'List[_5820.BevelDifferentialGearCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis(self) -> 'List[_5821.BevelDifferentialGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5629.BevelDifferentialGearSetHarmonicAnalysis]':
