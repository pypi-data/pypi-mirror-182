...
class ComponentCompoundHarmonicAnalysis(_5888.PartCompoundHarmonicAnalysis):
    """ComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5642.ComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5642.ComponentHarmonicAnalysis]':
