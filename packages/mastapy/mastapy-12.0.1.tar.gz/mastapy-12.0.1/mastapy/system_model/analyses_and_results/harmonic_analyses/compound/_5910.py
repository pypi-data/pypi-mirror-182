...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5908, _5909, _5827
...
class SpiralBevelGearSetCompoundHarmonicAnalysis(_5827.BevelGearSetCompoundHarmonicAnalysis):
    """SpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5745.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5908.SpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5909.SpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5745.SpiralBevelGearSetHarmonicAnalysis]':
