...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5721.PartToPartShearCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5721.PartToPartShearCouplingHalfHarmonicAnalysis]':
