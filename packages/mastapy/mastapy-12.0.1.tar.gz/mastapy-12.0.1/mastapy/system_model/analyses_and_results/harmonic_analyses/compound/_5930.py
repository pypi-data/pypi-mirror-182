...
class UnbalancedMassCompoundHarmonicAnalysis(_5931.VirtualComponentCompoundHarmonicAnalysis):
    """UnbalancedMassCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5766.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5766.UnbalancedMassHarmonicAnalysis]':
