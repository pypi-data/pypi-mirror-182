...
class GearMeshHarmonicAnalysis(_5705.InterMountableComponentConnectionHarmonicAnalysis):
    """GearMeshHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_2266.GearMesh':
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_4097.ToothPassingHarmonic]':
    ...
    @property
    def system_deflection_results(self) -> '_2706.GearMeshSystemDeflection':
