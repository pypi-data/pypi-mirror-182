...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5752, _5753, _5634
...
class StraightBevelGearSetHarmonicAnalysis(_5634.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5752.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_harmonic_analysis(self) -> 'List[_5752.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5753.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis(self) -> 'List[_5753.StraightBevelGearMeshHarmonicAnalysis]':
