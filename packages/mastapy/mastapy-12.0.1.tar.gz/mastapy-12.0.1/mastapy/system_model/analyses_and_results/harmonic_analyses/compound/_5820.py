...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5825.BevelGearCompoundHarmonicAnalysis):
    """BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5627.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5627.BevelDifferentialGearHarmonicAnalysis]':
