...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5914, _5915, _5827
...
class StraightBevelDiffGearSetCompoundHarmonicAnalysis(_5827.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelDiffGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5751.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_harmonic_analysis(self) -> 'List[_5914.StraightBevelDiffGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_harmonic_analysis(self) -> 'List[_5915.StraightBevelDiffGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5751.StraightBevelDiffGearSetHarmonicAnalysis]':
