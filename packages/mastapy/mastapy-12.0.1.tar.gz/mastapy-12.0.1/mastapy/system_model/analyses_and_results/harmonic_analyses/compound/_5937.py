...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5935, _5936, _5827
...
class ZerolBevelGearSetCompoundHarmonicAnalysis(_5827.BevelGearSetCompoundHarmonicAnalysis):
    """ZerolBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5773.ZerolBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5935.ZerolBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5936.ZerolBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5773.ZerolBevelGearSetHarmonicAnalysis]':
