...
class KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis(_5842.ConicalGearMeshCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5707.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5707.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
