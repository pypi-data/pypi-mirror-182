...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5833.CoaxialConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5661.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5661.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
