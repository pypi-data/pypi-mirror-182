...
class StraightBevelPlanetGearCompoundHarmonicAnalysis(_5914.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5755.StraightBevelPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5755.StraightBevelPlanetGearHarmonicAnalysis]':
