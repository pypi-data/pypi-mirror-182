...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5843.ConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5708.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5708.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
