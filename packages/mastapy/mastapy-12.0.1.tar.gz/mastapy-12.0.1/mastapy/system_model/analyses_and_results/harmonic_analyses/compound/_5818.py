...
class BeltConnectionCompoundHarmonicAnalysis(_5874.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """BeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5625.BeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5625.BeltConnectionHarmonicAnalysis]':
