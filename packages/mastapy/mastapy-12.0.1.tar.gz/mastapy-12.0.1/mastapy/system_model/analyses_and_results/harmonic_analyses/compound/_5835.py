...
class ConceptCouplingCompoundHarmonicAnalysis(_5846.CouplingCompoundHarmonicAnalysis):
    """ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5645.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5645.ConceptCouplingHarmonicAnalysis]':
