...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5862, _5863, _5869
...
class FaceGearSetCompoundHarmonicAnalysis(_5869.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5684.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def face_gears_compound_harmonic_analysis(self) -> 'List[_5862.FaceGearCompoundHarmonicAnalysis]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis(self) -> 'List[_5863.FaceGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5684.FaceGearSetHarmonicAnalysis]':
