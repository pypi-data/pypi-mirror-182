...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5768, _5769, _5693
...
class WormGearSetHarmonicAnalysis(_5693.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5768.WormGearHarmonicAnalysis]':
    ...
    @property
    def worm_gears_harmonic_analysis(self) -> 'List[_5768.WormGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5769.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_harmonic_analysis(self) -> 'List[_5769.WormGearMeshHarmonicAnalysis]':
