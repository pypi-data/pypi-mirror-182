...
class PlanetCarrierCompoundHarmonicAnalysis(_5886.MountableComponentCompoundHarmonicAnalysis):
    """PlanetCarrierCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5726.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5726.PlanetCarrierHarmonicAnalysis]':
