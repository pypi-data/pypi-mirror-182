...
class BevelGearMeshCompoundHarmonicAnalysis(_5814.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis):
    """BevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5633.BevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5633.BevelGearMeshHarmonicAnalysis]':
