...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5776
...
class ExcitationSourceSelectionGroup(_5776.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5776.ExcitationSourceSelectionBase]':
