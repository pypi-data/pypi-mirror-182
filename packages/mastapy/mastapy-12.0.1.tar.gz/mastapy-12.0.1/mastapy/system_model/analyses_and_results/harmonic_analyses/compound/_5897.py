...
class PulleyCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """PulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5729.PulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5729.PulleyHarmonicAnalysis]':
