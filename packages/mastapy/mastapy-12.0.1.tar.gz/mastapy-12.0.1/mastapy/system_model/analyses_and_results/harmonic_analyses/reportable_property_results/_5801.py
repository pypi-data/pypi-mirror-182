...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5793, _5799
...
class ResultsForOrderIncludingNodes(_5799.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    @property
    def node_results_global_coordinate_system(self) -> 'List[_5793.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
    ...
    @property
    def node_results_local_coordinate_system(self) -> 'List[_5793.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
