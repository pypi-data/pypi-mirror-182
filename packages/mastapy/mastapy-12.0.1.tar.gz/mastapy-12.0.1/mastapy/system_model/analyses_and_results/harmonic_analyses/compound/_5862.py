...
class FaceGearCompoundHarmonicAnalysis(_5867.GearCompoundHarmonicAnalysis):
    """FaceGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5682.FaceGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5682.FaceGearHarmonicAnalysis]':
