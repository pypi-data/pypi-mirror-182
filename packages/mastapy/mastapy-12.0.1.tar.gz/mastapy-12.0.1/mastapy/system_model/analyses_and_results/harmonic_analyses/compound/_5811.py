...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5618.AbstractShaftOrHousingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5618.AbstractShaftOrHousingHarmonicAnalysis]':
