...
class PlanetaryGearSetCompoundHarmonicAnalysis(_5858.CylindricalGearSetCompoundHarmonicAnalysis):
    """PlanetaryGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5725.PlanetaryGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5725.PlanetaryGearSetHarmonicAnalysis]':
