...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5749, _5750, _5634
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5634.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5749.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis(self) -> 'List[_5749.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5750.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis(self) -> 'List[_5750.StraightBevelDiffGearMeshHarmonicAnalysis]':
