...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5791, _5796
...
class ResultsForMultipleOrdersForGroups(_5796.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5791.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
