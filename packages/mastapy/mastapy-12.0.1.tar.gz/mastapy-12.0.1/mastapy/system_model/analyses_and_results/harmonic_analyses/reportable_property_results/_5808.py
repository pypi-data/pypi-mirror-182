...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5801, _5784
...
class SingleWhineAnalysisResultsPropertyAccessor(_5784.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5801.ResultsForOrderIncludingNodes]':
