...
class BearingHarmonicAnalysis(_5653.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_2028.RollingBearingSpeedResults':
    ...
    @property
    def system_deflection_results(self) -> '_2645.BearingSystemDeflection':
