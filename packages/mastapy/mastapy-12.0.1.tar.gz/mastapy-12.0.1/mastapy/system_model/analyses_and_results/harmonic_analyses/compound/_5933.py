...
class WormGearMeshCompoundHarmonicAnalysis(_5868.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5769.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5769.WormGearMeshHarmonicAnalysis]':
