...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysis(_5843.ConicalGearSetCompoundHarmonicAnalysis):
    """AGMAGleasonConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5622.AGMAGleasonConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5622.AGMAGleasonConicalGearSetHarmonicAnalysis]':
