...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5818.BeltConnectionCompoundHarmonicAnalysis):
    """CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5657.CVTBeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5657.CVTBeltConnectionHarmonicAnalysis]':
