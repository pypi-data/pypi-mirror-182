...
class HypoidGearCompoundHarmonicAnalysis(_5813.AGMAGleasonConicalGearCompoundHarmonicAnalysis):
    """HypoidGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5702.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5702.HypoidGearHarmonicAnalysis]':
