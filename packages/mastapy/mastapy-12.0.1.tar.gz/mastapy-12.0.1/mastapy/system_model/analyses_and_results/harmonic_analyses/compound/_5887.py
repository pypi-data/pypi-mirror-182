...
class OilSealCompoundHarmonicAnalysis(_5845.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5718.OilSealHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5718.OilSealHarmonicAnalysis]':
