...
class StraightBevelGearCompoundHarmonicAnalysis(_5825.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5752.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5752.StraightBevelGearHarmonicAnalysis]':
