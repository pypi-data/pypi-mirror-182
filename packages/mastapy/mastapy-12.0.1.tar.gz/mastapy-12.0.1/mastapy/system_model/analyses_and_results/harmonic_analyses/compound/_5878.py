...
class KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis(_5875.KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
