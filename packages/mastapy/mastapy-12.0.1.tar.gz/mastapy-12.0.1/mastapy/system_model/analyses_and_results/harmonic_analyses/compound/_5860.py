...
class DatumCompoundHarmonicAnalysis(_5834.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5668.DatumHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5668.DatumHarmonicAnalysis]':
