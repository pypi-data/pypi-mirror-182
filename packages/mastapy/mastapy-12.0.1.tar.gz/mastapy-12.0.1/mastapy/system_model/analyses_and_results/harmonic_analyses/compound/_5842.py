...
class ConicalGearMeshCompoundHarmonicAnalysis(_5868.GearMeshCompoundHarmonicAnalysis):
    """ConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5650.ConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5650.ConicalGearMeshHarmonicAnalysis]':
