...
class WormGearCompoundHarmonicAnalysis(_5867.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5768.WormGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5768.WormGearHarmonicAnalysis]':
