...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5802, _5808
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5808.SingleWhineAnalysisResultsPropertyAccessor):
    """FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5802.ResultsForOrderIncludingSurfaces]':
