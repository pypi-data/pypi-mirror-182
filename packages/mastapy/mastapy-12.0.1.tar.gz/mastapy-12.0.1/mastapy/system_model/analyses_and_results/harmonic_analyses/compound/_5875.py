...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_5841.ConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5706.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5706.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
