...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5826.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5772.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5772.ZerolBevelGearMeshHarmonicAnalysis]':
