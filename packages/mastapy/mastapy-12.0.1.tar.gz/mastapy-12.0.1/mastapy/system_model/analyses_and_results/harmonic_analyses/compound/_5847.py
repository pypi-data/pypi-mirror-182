...
class CouplingConnectionCompoundHarmonicAnalysis(_5874.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """CouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5654.CouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5654.CouplingConnectionHarmonicAnalysis]':
