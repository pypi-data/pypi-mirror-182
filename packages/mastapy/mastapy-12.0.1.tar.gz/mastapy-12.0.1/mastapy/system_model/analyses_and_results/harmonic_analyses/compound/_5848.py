...
class CouplingHalfCompoundHarmonicAnalysis(_5886.MountableComponentCompoundHarmonicAnalysis):
    """CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5655.CouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5655.CouplingHalfHarmonicAnalysis]':
