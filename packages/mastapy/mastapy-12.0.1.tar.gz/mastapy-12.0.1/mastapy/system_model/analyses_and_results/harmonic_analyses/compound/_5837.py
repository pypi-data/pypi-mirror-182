...
class ConceptCouplingHalfCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """ConceptCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5644.ConceptCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5644.ConceptCouplingHalfHarmonicAnalysis]':
