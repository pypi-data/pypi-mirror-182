...
class RollingRingConnectionCompoundHarmonicAnalysis(_5874.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5734.RollingRingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5734.RollingRingConnectionHarmonicAnalysis]':
