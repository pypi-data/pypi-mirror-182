...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5682, _5683, _5693
...
class FaceGearSetHarmonicAnalysis(_5693.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5682.FaceGearHarmonicAnalysis]':
    ...
    @property
    def face_gears_harmonic_analysis(self) -> 'List[_5682.FaceGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5683.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def face_meshes_harmonic_analysis(self) -> 'List[_5683.FaceGearMeshHarmonicAnalysis]':
