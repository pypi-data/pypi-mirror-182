...
class SynchroniserCompoundHarmonicAnalysis(_5907.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5758.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5758.SynchroniserHarmonicAnalysis]':
