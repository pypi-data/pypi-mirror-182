...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5847.CouplingConnectionCompoundHarmonicAnalysis):
    """TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5761.TorqueConverterConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5761.TorqueConverterConnectionHarmonicAnalysis]':
