...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5709, _5710, _5708
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5708.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6844.KlingelnbergCycloPalloidHypoidGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2719.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5709.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5710.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5710.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
