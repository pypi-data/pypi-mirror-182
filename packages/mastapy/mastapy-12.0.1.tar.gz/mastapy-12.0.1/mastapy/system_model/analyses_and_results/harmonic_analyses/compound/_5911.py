...
class SpringDamperCompoundHarmonicAnalysis(_5846.CouplingCompoundHarmonicAnalysis):
    """SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5748.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5748.SpringDamperHarmonicAnalysis]':
