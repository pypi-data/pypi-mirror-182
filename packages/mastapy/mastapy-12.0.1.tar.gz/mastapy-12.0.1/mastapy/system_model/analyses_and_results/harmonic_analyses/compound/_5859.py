...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5856.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5667.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5667.CylindricalPlanetGearHarmonicAnalysis]':
