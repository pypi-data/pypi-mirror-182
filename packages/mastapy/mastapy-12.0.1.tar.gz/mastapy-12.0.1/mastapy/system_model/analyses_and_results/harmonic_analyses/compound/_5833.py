...
class CoaxialConnectionCompoundHarmonicAnalysis(_5906.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5640.CoaxialConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5640.CoaxialConnectionHarmonicAnalysis]':
