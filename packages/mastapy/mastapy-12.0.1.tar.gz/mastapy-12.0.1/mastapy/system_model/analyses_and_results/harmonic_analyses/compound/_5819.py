...
class BeltDriveCompoundHarmonicAnalysis(_5907.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5626.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5626.BeltDriveHarmonicAnalysis]':
