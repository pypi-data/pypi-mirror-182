...
class SynchroniserPartCompoundHarmonicAnalysis(_5848.CouplingHalfCompoundHarmonicAnalysis):
    """SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5759.SynchroniserPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5759.SynchroniserPartHarmonicAnalysis]':
