...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5624, _5626, _5629, _5635,
    _5636, _5658, _5639, _5645,
    _5648, _5660, _5662, _5666,
    _5685, _5684, _5686, _5704,
    _5711, _5714, _5693, _5715,
    _5716, _5718, _5722, _5726,
    _5727, _5728, _5731, _5733,
    _5738, _5737, _5745, _5748,
    _5751, _5754, _5758, _5762,
    _5766, _5770, _5773, _5615
)
...
class AssemblyHarmonicAnalysis(_5615.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5624.BearingHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5626.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5629.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5635.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5636.BoltHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5658.CVTHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5639.ClutchHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5645.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5648.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5660.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5662.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5666.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5685.FEPartHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5684.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5686.FlexiblePinAssemblyHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5704.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5711.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5714.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_5693.GearSetHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5715.MassDiscHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5716.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5718.OilSealHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5722.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5726.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5727.PointLoadHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5728.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5731.RingPinsHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5733.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5738.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5737.ShaftHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5745.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5748.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5751.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5754.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5758.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5762.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5766.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5770.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5773.ZerolBevelGearSetHarmonicAnalysis]':
