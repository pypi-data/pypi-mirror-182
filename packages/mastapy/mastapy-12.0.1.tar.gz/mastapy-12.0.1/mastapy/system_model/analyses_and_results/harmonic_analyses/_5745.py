...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5743, _5744, _5634
...
class SpiralBevelGearSetHarmonicAnalysis(_5634.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5743.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5743.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5744.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5744.SpiralBevelGearMeshHarmonicAnalysis]':
