...
class CylindricalGearCompoundHarmonicAnalysis(_5867.GearCompoundHarmonicAnalysis):
    """CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5664.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5664.CylindricalGearHarmonicAnalysis]':
