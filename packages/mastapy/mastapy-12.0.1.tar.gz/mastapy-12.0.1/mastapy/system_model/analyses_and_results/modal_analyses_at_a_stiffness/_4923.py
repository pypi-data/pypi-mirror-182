...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4922, _4921, _4858
...
class WormGearSetModalAnalysisAtAStiffness(_4858.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4922.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4921.WormGearMeshModalAnalysisAtAStiffness]':
