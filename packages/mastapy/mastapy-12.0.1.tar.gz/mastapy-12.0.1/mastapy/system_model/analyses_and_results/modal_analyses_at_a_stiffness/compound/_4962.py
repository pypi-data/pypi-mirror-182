...
class ConnectionCompoundModalAnalysisAtAStiffness(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4832.ConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4832.ConnectionModalAnalysisAtAStiffness]':
