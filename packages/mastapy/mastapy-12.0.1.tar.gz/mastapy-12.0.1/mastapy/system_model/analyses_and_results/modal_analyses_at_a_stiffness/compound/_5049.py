...
class VirtualComponentCompoundModalAnalysisAtAStiffness(_5004.MountableComponentCompoundModalAnalysisAtAStiffness):
    """VirtualComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4920.VirtualComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4920.VirtualComponentModalAnalysisAtAStiffness]':
