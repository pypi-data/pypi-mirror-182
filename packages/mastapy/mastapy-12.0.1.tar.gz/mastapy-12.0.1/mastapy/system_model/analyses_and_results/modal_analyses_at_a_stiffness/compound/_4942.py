...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4938.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4812.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4812.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
