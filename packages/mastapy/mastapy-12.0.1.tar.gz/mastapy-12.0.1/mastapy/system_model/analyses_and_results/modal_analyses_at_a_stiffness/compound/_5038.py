...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5032.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4909.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4909.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
