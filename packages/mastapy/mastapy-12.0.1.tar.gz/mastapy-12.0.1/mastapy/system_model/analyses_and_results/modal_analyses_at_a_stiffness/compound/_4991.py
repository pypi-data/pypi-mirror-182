...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4989, _4990, _4933
...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(_4933.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """HypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4862.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4989.HypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4990.HypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4862.HypoidGearSetModalAnalysisAtAStiffness]':
