...
class StraightBevelSunGearCompoundModalAnalysisAtAStiffness(_5032.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4910.StraightBevelSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4910.StraightBevelSunGearModalAnalysisAtAStiffness]':
