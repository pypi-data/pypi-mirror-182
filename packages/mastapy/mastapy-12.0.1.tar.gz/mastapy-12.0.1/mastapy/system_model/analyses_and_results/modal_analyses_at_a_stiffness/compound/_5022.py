...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4928
...
class ShaftCompoundModalAnalysisAtAStiffness(_4928.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4894.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4894.ShaftModalAnalysisAtAStiffness]':
