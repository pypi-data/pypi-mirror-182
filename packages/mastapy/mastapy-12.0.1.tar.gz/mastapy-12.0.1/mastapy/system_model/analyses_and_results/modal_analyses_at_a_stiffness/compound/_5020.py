...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4992.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4890.RollingRingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4890.RollingRingConnectionModalAnalysisAtAStiffness]':
