...
class PointLoadCompoundModalAnalysisAtAStiffness(_5049.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4884.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4884.PointLoadModalAnalysisAtAStiffness]':
