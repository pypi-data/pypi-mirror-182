...
class AbstractShaftCompoundModalAnalysisAtAStiffness(_4929.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """AbstractShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4798.AbstractShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4798.AbstractShaftModalAnalysisAtAStiffness]':
