...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4904, _4903, _4815
...
class StraightBevelDiffGearSetModalAnalysisAtAStiffness(_4815.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelDiffGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4904.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4903.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
