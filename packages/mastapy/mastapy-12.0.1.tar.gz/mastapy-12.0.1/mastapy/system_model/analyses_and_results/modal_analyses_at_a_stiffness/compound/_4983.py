...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4929
...
class FEPartCompoundModalAnalysisAtAStiffness(_4929.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4854.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4854.FEPartModalAnalysisAtAStiffness]':
