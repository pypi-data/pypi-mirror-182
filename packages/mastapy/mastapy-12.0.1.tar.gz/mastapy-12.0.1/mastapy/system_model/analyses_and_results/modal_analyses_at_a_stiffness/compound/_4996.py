...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtAStiffness(_4993.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4868.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4868.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]':
