...
class GuideDxfModelCompoundModalAnalysisAtAStiffness(_4952.ComponentCompoundModalAnalysisAtAStiffness):
    """GuideDxfModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4859.GuideDxfModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4859.GuideDxfModelModalAnalysisAtAStiffness]':
