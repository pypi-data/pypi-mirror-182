...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4827, _4826, _4858
...
class ConceptGearSetModalAnalysisAtAStiffness(_4858.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4827.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4826.ConceptGearMeshModalAnalysisAtAStiffness]':
