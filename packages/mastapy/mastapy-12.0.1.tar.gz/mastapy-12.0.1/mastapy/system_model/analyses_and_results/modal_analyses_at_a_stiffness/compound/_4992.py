...
class InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4962.ConnectionCompoundModalAnalysisAtAStiffness):
    """InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4863.InterMountableComponentConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4863.InterMountableComponentConnectionModalAnalysisAtAStiffness]':
