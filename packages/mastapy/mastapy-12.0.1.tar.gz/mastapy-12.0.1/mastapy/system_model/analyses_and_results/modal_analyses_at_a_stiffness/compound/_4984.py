...
class FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness(_5025.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4855.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4855.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
