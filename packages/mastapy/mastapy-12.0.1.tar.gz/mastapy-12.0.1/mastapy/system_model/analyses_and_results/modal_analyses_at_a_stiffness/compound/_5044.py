...
class TorqueConverterCompoundModalAnalysisAtAStiffness(_4964.CouplingCompoundModalAnalysisAtAStiffness):
    """TorqueConverterCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4916.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4916.TorqueConverterModalAnalysisAtAStiffness]':
