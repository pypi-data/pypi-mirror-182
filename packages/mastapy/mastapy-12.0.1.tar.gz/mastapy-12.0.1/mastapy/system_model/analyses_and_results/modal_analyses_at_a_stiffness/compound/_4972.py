...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4928.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4842.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4842.CycloidalDiscModalAnalysisAtAStiffness]':
