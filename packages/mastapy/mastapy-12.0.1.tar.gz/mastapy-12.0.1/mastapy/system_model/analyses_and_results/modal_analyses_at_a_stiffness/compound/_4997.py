...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness(_4994.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4867.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4867.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
