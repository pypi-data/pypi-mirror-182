...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness(_4930.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4843.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4843.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
