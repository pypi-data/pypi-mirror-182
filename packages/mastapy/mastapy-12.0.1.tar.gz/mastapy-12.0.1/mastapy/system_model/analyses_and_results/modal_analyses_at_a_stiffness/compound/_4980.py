...
class FaceGearCompoundModalAnalysisAtAStiffness(_4985.GearCompoundModalAnalysisAtAStiffness):
    """FaceGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4852.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4852.FaceGearModalAnalysisAtAStiffness]':
