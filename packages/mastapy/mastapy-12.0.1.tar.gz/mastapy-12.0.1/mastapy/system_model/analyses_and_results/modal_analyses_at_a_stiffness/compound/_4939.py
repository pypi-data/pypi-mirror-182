...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4944
...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4944.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4808.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4808.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
