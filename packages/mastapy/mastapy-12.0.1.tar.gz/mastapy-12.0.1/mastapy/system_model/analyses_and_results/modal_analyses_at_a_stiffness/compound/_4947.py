...
class BoltedJointCompoundModalAnalysisAtAStiffness(_5025.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BoltedJointCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4816.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4816.BoltedJointModalAnalysisAtAStiffness]':
