...
class GearCompoundModalAnalysisAtAStiffness(_5004.MountableComponentCompoundModalAnalysisAtAStiffness):
    """GearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4857.GearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4857.GearModalAnalysisAtAStiffness]':
