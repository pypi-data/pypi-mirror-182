...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4925, _4924, _4815
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4815.BevelGearSetModalAnalysisAtAStiffness):
    """ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4925.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4924.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
