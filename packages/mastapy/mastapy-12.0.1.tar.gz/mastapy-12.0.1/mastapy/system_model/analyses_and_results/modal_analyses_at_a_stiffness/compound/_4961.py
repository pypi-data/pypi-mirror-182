...
class ConicalGearSetCompoundModalAnalysisAtAStiffness(_4987.GearSetCompoundModalAnalysisAtAStiffness):
    """ConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4831.ConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4831.ConicalGearSetModalAnalysisAtAStiffness]':
