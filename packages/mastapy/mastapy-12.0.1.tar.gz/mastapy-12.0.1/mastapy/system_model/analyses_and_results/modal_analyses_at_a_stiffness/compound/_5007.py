...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4964.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4880.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4880.PartToPartShearCouplingModalAnalysisAtAStiffness]':
