...
class WormGearCompoundModalAnalysisAtAStiffness(_4985.GearCompoundModalAnalysisAtAStiffness):
    """WormGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4922.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4922.WormGearModalAnalysisAtAStiffness]':
