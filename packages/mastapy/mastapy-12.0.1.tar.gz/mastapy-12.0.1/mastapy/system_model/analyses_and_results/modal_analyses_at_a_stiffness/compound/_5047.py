...
class TorqueConverterTurbineCompoundModalAnalysisAtAStiffness(_4966.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterTurbineCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4918.TorqueConverterTurbineModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4918.TorqueConverterTurbineModalAnalysisAtAStiffness]':
