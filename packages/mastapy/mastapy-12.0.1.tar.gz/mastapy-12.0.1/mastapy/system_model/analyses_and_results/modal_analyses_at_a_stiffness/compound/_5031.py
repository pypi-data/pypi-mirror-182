...
class SpringDamperHalfCompoundModalAnalysisAtAStiffness(_4966.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """SpringDamperHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4901.SpringDamperHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4901.SpringDamperHalfModalAnalysisAtAStiffness]':
