...
class StraightBevelGearCompoundModalAnalysisAtAStiffness(_4943.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4907.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4907.StraightBevelGearModalAnalysisAtAStiffness]':
