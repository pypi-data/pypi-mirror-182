...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4974.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4847.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4847.CylindricalPlanetGearModalAnalysisAtAStiffness]':
