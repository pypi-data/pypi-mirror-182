...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4938, _4939, _4945
...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(_4945.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4810.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4938.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4939.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4810.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
