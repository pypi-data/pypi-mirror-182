...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(_4943.BevelGearCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4898.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4898.SpiralBevelGearModalAnalysisAtAStiffness]':
