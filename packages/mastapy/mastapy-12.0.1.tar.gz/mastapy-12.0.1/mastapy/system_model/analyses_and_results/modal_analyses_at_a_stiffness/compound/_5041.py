...
class SynchroniserHalfCompoundModalAnalysisAtAStiffness(_5042.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    """SynchroniserHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4911.SynchroniserHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4911.SynchroniserHalfModalAnalysisAtAStiffness]':
