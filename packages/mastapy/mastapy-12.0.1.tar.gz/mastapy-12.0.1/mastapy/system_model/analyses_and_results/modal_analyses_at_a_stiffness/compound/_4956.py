...
class ConceptGearCompoundModalAnalysisAtAStiffness(_4985.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4827.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4827.ConceptGearModalAnalysisAtAStiffness]':
