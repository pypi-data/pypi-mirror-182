...
class AbstractAssemblyCompoundModalAnalysisAtAStiffness(_5006.PartCompoundModalAnalysisAtAStiffness):
    """AbstractAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4797.AbstractAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4797.AbstractAssemblyModalAnalysisAtAStiffness]':
