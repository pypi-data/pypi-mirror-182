...
class RollingRingAssemblyCompoundModalAnalysisAtAStiffness(_5025.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """RollingRingAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4889.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4889.RollingRingAssemblyModalAnalysisAtAStiffness]':
