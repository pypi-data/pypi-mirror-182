...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4898, _4897, _4815
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4815.BevelGearSetModalAnalysisAtAStiffness):
    """SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4898.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4897.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
