...
class BoltCompoundModalAnalysisAtAStiffness(_4952.ComponentCompoundModalAnalysisAtAStiffness):
    """BoltCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4817.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4817.BoltModalAnalysisAtAStiffness]':
