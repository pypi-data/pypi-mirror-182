...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4980, _4981, _4987
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_4987.GearSetCompoundModalAnalysisAtAStiffness):
    """FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4853.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4980.FaceGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4981.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4853.FaceGearSetModalAnalysisAtAStiffness]':
