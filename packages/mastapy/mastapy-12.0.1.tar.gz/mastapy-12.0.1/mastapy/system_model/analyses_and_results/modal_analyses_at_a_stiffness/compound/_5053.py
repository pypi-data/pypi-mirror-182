...
class ZerolBevelGearCompoundModalAnalysisAtAStiffness(_4943.BevelGearCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4925.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4925.ZerolBevelGearModalAnalysisAtAStiffness]':
