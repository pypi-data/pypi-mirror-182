...
class RingPinsCompoundModalAnalysisAtAStiffness(_5004.MountableComponentCompoundModalAnalysisAtAStiffness):
    """RingPinsCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4887.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4887.RingPinsModalAnalysisAtAStiffness]':
