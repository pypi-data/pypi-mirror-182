...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5050, _5051, _4987
...
class WormGearSetCompoundModalAnalysisAtAStiffness(_4987.GearSetCompoundModalAnalysisAtAStiffness):
    """WormGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4923.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5050.WormGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5051.WormGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4923.WormGearSetModalAnalysisAtAStiffness]':
