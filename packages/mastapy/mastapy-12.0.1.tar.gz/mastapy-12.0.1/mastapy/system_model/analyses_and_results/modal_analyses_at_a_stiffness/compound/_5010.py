...
class PlanetaryConnectionCompoundModalAnalysisAtAStiffness(_5024.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """PlanetaryConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4881.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4881.PlanetaryConnectionModalAnalysisAtAStiffness]':
