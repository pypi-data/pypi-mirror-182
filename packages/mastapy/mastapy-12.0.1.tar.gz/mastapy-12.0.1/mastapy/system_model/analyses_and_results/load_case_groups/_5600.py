...
from mastapy.system_model.analyses_and_results.load_case_groups import _5598, _5599, _5595
...
class DesignState(_5595.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self) -> 'List[_5598.ClutchEngagementStatus]':
    ...
    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5599.ConceptSynchroGearEngagementStatus]':
    ...
    def clutch_engagement_status_for(self, clutch_connection: '_2295.ClutchConnection') -> '_5598.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_2477.CylindricalGear') -> '_5599.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6732.StaticLoadCase':
