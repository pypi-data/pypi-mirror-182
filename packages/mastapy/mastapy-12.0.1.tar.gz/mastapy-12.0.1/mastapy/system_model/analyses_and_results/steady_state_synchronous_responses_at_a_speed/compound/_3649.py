...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3615.ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3518.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3518.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
