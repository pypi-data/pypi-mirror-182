...
class ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3479.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3479.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]':
