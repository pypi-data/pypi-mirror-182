...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3639.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3577.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3577.WormGearSteadyStateSynchronousResponseAtASpeed]':
