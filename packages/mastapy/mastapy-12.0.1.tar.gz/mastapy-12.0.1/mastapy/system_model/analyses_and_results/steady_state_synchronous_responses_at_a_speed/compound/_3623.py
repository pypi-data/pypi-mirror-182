...
class CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3669.PulleyCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3492.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3492.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
