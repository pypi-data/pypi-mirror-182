...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3696.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3565.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3565.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
