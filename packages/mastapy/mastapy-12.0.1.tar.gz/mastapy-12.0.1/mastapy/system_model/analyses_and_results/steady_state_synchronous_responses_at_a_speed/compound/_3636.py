...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3634, _3635, _3641
...
class FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3641.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3505.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3634.FaceGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3635.FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3505.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
