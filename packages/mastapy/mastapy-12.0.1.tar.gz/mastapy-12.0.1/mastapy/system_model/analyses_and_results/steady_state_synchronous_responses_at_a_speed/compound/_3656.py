...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3703.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3526.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3526.MassDiscSteadyStateSynchronousResponseAtASpeed]':
