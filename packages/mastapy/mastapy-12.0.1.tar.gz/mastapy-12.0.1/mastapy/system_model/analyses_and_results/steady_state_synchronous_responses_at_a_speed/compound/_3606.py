...
class ComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3660.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """ComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3476.ComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3476.ComponentSteadyStateSynchronousResponseAtASpeed]':
