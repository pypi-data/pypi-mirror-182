...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3506, _3504, _3510
...
class FaceGearSetSteadyStateSynchronousResponseAtASpeed(_3510.GearSetSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def face_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3506.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3504.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
