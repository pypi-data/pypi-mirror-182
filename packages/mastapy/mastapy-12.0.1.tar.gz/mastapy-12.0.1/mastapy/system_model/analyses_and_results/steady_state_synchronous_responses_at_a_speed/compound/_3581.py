...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3660.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3451.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3451.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
