...
class RootAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3588.AssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """RootAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3545.RootAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3545.RootAssemblySteadyStateSynchronousResponseAtASpeed]':
