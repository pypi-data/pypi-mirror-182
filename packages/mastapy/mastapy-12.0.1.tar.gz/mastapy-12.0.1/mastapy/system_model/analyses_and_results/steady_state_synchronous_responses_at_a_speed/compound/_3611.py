...
class ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3640.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3480.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3480.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
