...
class ClutchCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3474.ClutchSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3474.ClutchSteadyStateSynchronousResponseAtASpeed]':
