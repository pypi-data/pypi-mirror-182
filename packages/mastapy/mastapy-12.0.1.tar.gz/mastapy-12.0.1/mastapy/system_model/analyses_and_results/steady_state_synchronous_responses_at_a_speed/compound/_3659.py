...
class OilSealCompoundSteadyStateSynchronousResponseAtASpeed(_3617.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """OilSealCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3529.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3529.OilSealSteadyStateSynchronousResponseAtASpeed]':
