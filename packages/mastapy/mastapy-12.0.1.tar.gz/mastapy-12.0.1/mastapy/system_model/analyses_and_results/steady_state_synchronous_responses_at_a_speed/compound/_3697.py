...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3696.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3567.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3567.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
