...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3619.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3477.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3477.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
