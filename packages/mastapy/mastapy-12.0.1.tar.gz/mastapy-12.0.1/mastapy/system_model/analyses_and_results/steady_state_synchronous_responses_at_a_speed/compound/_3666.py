...
class PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed(_3658.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3536.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3536.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]':
