...
class RingPinsCompoundSteadyStateSynchronousResponseAtASpeed(_3658.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3540.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3540.RingPinsSteadyStateSynchronousResponseAtASpeed]':
