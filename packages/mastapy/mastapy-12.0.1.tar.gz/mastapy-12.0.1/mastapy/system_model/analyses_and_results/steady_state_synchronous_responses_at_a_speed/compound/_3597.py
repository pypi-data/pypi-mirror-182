...
class BevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3585.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3469.BevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3469.BevelGearSteadyStateSynchronousResponseAtASpeed]':
