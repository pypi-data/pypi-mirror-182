...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3592.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3466.BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3466.BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed]':
