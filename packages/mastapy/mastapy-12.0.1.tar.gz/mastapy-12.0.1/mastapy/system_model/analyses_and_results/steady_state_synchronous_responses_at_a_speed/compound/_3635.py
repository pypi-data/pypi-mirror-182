...
class FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3640.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3504.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3504.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
