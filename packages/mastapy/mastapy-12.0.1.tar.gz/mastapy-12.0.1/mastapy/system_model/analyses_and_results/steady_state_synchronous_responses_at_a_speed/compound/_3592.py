...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed(_3597.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3464.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3464.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
