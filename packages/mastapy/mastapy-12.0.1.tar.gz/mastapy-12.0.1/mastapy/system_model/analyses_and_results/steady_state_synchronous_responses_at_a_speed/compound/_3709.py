...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3707, _3708, _3599
...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3599.BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3579.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3707.ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3708.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3579.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
