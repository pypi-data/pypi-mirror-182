...
class RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3646.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3541.RingPinsToDiscConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3541.RingPinsToDiscConnectionSteadyStateSynchronousResponseAtASpeed]':
