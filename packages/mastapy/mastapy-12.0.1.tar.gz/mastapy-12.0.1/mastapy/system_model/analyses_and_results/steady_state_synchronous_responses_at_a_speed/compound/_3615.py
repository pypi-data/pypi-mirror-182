...
class ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3641.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3484.ConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3484.ConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
