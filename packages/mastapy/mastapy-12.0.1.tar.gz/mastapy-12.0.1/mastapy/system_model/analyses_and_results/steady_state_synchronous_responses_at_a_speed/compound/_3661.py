...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed(_3618.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3533.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3533.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]':
