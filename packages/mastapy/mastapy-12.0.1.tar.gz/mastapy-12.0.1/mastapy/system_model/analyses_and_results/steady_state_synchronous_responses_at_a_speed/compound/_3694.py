...
class SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed(_3679.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3568.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3568.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
