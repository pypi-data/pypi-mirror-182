...
class AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3615.ConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3456.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3456.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed]':
