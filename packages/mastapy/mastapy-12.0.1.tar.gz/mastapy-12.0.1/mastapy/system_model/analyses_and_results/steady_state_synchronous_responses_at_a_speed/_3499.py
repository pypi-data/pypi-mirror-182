...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3500, _3498, _3510
...
class CylindricalGearSetSteadyStateSynchronousResponseAtASpeed(_3510.GearSetSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3500.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3498.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
