...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3617.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3459.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3459.BearingSteadyStateSynchronousResponseAtASpeed]':
