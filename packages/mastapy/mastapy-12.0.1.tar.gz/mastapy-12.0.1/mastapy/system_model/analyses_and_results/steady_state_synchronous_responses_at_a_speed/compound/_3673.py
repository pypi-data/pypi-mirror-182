...
class RollingRingCompoundSteadyStateSynchronousResponseAtASpeed(_3620.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3544.RollingRingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3544.RollingRingSteadyStateSynchronousResponseAtASpeed]':
