...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3617.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3546.ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3546.ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed]':
