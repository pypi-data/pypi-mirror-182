...
class SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3597.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3552.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3552.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
