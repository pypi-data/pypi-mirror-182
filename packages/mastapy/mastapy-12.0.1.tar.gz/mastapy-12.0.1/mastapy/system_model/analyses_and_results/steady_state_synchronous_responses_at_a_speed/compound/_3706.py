...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3704, _3705, _3641
...
class WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3641.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3576.WormGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3704.WormGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3705.WormGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3576.WormGearSetSteadyStateSynchronousResponseAtASpeed]':
