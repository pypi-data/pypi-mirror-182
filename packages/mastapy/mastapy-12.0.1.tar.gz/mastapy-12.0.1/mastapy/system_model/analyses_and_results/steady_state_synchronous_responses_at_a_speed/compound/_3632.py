...
class DatumCompoundSteadyStateSynchronousResponseAtASpeed(_3606.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """DatumCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3502.DatumSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3502.DatumSteadyStateSynchronousResponseAtASpeed]':
