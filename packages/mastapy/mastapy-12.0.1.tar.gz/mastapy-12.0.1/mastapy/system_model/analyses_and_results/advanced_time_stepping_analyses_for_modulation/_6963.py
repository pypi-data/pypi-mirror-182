...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6765.ConceptCouplingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2664.ConceptCouplingConnectionSystemDeflection':
