...
class TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2559.TorqueConverter':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7054.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7054.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
