...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2757.SpringDamperConnectionSystemDeflection':
