...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7077, _7078, _7084
...
class BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7084.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6949.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7077.BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7078.BevelDifferentialGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6949.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
