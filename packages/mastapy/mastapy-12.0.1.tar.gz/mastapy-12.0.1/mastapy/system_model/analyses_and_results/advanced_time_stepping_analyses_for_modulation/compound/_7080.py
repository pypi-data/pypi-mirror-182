...
class BevelDifferentialPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7077.BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6950.BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6950.BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
