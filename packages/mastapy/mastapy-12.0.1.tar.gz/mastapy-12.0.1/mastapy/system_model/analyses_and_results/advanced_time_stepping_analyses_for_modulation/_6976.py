...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6946.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    """CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2681.CVTSystemDeflection':
