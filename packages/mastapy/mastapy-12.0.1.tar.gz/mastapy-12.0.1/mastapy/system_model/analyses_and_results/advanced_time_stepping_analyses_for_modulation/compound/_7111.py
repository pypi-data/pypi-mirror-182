...
class CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7067.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6980.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6980.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
