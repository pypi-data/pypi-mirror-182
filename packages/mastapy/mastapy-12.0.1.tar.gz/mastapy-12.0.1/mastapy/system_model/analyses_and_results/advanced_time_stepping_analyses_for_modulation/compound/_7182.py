...
class SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation(_7181.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7053.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7053.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
