...
class HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6999.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6999.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
