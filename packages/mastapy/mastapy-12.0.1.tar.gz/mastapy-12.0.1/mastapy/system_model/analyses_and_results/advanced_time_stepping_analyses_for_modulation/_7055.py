...
class TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2775.TorqueConverterConnectionSystemDeflection':
