...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6947.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2469.BevelDifferentialPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2651.BevelDifferentialPlanetGearSystemDeflection':
