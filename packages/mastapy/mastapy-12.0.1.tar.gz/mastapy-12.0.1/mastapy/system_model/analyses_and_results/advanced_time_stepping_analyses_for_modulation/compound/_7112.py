...
from mastapy.system_model.connections_and_sockets.cycloidal import _2291
...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7069.AbstractShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2291.CycloidalDiscPlanetaryBearingConnection':
    ...
    @property
    def connection_design(self) -> '_2291.CycloidalDiscPlanetaryBearingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6982.CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6982.CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation]':
