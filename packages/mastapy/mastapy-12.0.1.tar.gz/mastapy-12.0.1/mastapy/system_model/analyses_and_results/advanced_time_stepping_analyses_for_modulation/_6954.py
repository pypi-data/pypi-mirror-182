...
class BevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6941.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2654.BevelGearSetSystemDeflection':
