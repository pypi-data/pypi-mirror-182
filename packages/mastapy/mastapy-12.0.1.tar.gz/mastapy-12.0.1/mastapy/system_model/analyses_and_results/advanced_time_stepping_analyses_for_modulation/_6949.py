...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6947, _6948, _6954
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6954.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6752.BevelDifferentialGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2649.BevelDifferentialGearSetSystemDeflection':
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6947.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6948.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
