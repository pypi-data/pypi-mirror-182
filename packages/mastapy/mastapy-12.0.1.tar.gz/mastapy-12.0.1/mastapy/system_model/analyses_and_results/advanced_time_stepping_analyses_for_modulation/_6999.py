...
class HypoidGearAdvancedTimeSteppingAnalysisForModulation(_6939.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6832.HypoidGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2712.HypoidGearSystemDeflection':
