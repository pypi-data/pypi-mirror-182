...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6767.ConceptCouplingLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2666.ConceptCouplingSystemDeflection':
