...
from mastapy.system_model.analyses_and_results.system_deflections import _2639, _2685, _2751
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6934.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2639.AbstractShaftSystemDeflection':
