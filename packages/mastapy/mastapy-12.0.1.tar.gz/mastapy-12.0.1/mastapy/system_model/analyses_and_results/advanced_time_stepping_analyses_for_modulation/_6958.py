...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6974.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6760.ClutchConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2658.ClutchConnectionSystemDeflection':
