...
class CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
