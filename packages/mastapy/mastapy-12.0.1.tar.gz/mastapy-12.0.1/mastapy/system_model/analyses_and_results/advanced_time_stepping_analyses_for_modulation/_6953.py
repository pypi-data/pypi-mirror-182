...
class BevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6940.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2653.BevelGearMeshSystemDeflection':
