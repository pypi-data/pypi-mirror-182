...
class KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation(_7003.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6842.KlingelnbergCycloPalloidHypoidGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2720.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
