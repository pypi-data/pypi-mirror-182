...
class PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7115.CylindricalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7021.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7021.PlanetaryGearSetAdvancedTimeSteppingAnalysisForModulation]':
