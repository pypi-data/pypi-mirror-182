...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7145.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6961.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6961.ComponentAdvancedTimeSteppingAnalysisForModulation]':
