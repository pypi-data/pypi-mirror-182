...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_7003.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """KlingelnbergCycloPalloidSpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6845.KlingelnbergCycloPalloidSpiralBevelGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2723.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
