...
class UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation(_7188.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2430.UnbalancedMass':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7058.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7058.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
