...
class PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2301.PartToPartShearCouplingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7018.PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7018.PartToPartShearCouplingConnectionAdvancedTimeSteppingAnalysisForModulation]':
