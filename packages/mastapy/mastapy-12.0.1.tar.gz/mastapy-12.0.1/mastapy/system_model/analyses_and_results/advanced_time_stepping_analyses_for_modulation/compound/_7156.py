...
class RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7131.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2294.RingPinsToDiscConnection':
    ...
    @property
    def connection_design(self) -> '_2294.RingPinsToDiscConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7027.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7027.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
