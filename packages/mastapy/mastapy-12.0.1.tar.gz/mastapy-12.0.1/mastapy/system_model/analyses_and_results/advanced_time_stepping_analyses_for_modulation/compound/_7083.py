...
class BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7071.AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6953.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6953.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
