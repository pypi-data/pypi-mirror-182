...
class CVTPulleyAdvancedTimeSteppingAnalysisForModulation(_7025.PulleyAdvancedTimeSteppingAnalysisForModulation):
    """CVTPulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2539.CVTPulley':
    ...
    @property
    def system_deflection_results(self) -> '_2680.CVTPulleySystemDeflection':
