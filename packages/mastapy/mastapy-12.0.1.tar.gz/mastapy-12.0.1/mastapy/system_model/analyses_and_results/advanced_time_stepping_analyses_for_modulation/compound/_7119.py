...
class FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7124.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6989.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6989.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
