...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7042.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2501.StraightBevelPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2766.StraightBevelPlanetGearSystemDeflection':
