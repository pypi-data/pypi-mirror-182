...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6999, _7000, _6941
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6941.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6999.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7000.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
