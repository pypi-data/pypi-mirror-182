...
class SpiralBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7082.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7036.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7036.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
