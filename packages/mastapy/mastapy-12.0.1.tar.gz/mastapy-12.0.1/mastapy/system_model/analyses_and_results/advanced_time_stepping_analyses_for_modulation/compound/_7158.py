...
class RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2548.RollingRing':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7028.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7028.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
