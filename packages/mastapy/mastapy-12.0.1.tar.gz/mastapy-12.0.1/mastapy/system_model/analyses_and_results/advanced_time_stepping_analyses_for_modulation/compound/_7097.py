...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7095, _7096, _7126
...
class ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7126.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2474.ConceptGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6967.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7095.ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7096.ConceptGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6967.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
