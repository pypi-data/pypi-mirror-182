...
class AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7145.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6932.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6932.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
