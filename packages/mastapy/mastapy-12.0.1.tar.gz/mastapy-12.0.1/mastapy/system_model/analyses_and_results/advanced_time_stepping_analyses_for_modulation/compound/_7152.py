...
class PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7188.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2424.PointLoad':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7023.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7023.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
