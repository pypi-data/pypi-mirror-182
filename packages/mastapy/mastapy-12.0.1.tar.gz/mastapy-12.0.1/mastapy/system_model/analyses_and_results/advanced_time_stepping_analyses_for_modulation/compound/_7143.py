...
class MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7014.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7014.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
