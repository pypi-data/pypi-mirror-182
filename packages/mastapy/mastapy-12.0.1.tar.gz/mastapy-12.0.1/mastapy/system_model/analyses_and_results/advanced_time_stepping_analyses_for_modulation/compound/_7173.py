...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7171, _7172, _7084
...
class StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7084.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2498.StraightBevelDiffGearSet':
    ...
    @property
    def assembly_design(self) -> '_2498.StraightBevelDiffGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7044.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7171.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7172.StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7044.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
