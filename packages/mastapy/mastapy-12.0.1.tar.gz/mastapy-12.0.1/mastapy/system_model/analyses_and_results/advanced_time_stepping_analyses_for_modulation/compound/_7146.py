...
class PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7103.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2540.PartToPartShearCoupling':
    ...
    @property
    def assembly_design(self) -> '_2540.PartToPartShearCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7017.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7017.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
