...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_7014.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2737.PlanetCarrierSystemDeflection':
