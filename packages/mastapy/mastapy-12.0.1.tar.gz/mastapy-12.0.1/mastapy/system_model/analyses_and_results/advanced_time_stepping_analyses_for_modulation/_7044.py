...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7042, _7043, _6954
...
class StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation(_6954.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6888.StraightBevelDiffGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2761.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_diff_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7042.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7043.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
