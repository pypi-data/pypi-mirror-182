...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6953.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6751.BevelDifferentialGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2648.BevelDifferentialGearMeshSystemDeflection':
