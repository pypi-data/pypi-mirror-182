...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7091.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6955.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6955.BoltAdvancedTimeSteppingAnalysisForModulation]':
