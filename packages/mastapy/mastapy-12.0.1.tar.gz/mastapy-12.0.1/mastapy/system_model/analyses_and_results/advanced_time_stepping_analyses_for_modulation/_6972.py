...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_7014.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2400.Connector':
    ...
    @property
    def system_deflection_results(self) -> '_2675.ConnectorSystemDeflection':
