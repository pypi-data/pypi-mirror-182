...
class SynchroniserAdvancedTimeSteppingAnalysisForModulation(_7035.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2771.SynchroniserSystemDeflection':
