...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_7052.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2768.SynchroniserHalfSystemDeflection':
