...
class ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation(_6995.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6769.ConceptGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2667.ConceptGearMeshSystemDeflection':
