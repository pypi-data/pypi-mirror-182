...
class ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7126.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6970.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6970.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
