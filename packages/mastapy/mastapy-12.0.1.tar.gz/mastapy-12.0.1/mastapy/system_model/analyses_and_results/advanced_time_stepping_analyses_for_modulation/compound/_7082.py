...
class BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6952.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6952.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
