...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_7042.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2502.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2767.StraightBevelSunGearSystemDeflection':
