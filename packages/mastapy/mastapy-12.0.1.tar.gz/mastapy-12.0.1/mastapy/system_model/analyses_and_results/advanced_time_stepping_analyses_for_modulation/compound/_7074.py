...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_7102.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6944.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6944.BearingAdvancedTimeSteppingAnalysisForModulation]':
