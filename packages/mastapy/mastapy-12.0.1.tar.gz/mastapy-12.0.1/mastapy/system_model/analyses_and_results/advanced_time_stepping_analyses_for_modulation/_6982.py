...
class CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6935.AbstractShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6787.CycloidalDiscPlanetaryBearingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2684.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
