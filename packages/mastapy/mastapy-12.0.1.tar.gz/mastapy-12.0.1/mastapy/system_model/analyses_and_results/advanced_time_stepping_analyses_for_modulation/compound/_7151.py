...
class PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2422.PlanetCarrier':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7022.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7022.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
