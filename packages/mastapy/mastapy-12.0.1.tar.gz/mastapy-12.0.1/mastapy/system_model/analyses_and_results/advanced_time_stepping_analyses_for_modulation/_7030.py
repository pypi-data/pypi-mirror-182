...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_7002.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6873.RollingRingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2745.RollingRingConnectionSystemDeflection':
