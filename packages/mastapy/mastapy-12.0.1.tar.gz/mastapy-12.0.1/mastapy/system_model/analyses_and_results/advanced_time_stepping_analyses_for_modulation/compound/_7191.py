...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7189, _7190, _7126
...
class WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7126.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7062.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7189.WormGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7190.WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7062.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
