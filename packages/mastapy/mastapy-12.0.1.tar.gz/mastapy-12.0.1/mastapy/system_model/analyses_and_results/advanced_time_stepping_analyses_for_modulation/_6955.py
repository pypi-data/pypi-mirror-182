...
class BoltAdvancedTimeSteppingAnalysisForModulation(_6961.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """BoltAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2657.BoltSystemDeflection':
