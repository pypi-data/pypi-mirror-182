...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7063, _7064, _6954
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6954.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6914.ZerolBevelGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2787.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7063.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7064.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
