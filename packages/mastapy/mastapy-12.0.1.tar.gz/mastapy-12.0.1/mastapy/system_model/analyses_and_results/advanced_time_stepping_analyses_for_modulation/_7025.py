...
from mastapy.system_model.part_model.couplings import _2542, _2539
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.static_loads import _6867, _6783
...
class PulleyAdvancedTimeSteppingAnalysisForModulation(_6975.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """PulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2542.Pulley':
    ...
    @property
    def component_load_case(self) -> '_6867.PulleyLoadCase':
        ...
        if _6867.PulleyLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2740.PulleySystemDeflection':
