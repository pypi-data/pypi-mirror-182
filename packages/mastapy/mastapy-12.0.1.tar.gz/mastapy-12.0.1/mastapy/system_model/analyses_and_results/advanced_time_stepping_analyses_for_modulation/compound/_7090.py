...
class CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2222.CoaxialConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6960.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6960.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
