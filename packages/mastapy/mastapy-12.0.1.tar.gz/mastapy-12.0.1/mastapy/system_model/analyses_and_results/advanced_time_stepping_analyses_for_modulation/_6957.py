...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_6973.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2660.ClutchSystemDeflection':
