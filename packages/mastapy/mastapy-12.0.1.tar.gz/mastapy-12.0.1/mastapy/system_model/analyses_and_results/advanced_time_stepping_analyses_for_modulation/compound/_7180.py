...
class SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7181.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7051.SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7051.SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation]':
