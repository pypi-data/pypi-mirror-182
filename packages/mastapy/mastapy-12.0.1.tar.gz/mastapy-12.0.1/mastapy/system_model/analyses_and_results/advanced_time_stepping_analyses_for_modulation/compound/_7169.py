...
class SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7104.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2303.SpringDamperConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7040.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7040.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation]':
