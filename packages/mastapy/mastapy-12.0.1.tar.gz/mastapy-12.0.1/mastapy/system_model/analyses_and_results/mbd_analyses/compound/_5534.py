...
class KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis(_5500.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5390.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5390.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
