...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5503.CouplingCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5447.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5447.TorqueConverterMultibodyDynamicsAnalysis]':
