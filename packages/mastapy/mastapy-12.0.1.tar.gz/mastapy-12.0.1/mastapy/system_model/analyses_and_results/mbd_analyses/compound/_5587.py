...
class UnbalancedMassCompoundMultibodyDynamicsAnalysis(_5588.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """UnbalancedMassCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5451.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5451.UnbalancedMassMultibodyDynamicsAnalysis]':
