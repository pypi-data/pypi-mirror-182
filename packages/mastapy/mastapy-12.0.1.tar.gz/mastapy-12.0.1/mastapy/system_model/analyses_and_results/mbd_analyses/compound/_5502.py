...
class ConnectorCompoundMultibodyDynamicsAnalysis(_5543.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """ConnectorCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5353.ConnectorMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5353.ConnectorMultibodyDynamicsAnalysis]':
