...
class KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis(_5532.KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5392.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5392.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
