...
class ExternalCADModelCompoundMultibodyDynamicsAnalysis(_5491.ComponentCompoundMultibodyDynamicsAnalysis):
    """ExternalCADModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5369.ExternalCADModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5369.ExternalCADModelMultibodyDynamicsAnalysis]':
