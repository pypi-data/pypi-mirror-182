...
class FaceGearCompoundMultibodyDynamicsAnalysis(_5524.GearCompoundMultibodyDynamicsAnalysis):
    """FaceGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5371.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5371.FaceGearMultibodyDynamicsAnalysis]':
