...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5477, _5478, _5484
...
class BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis(_5484.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5329.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5477.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5478.BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5329.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
