...
class CouplingConnectionCompoundMultibodyDynamicsAnalysis(_5531.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5354.CouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5354.CouplingConnectionMultibodyDynamicsAnalysis]':
