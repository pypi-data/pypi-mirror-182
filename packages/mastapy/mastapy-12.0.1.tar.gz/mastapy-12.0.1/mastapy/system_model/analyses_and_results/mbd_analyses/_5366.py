...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5365, _5364, _5378
...
class CylindricalGearSetMultibodyDynamicsAnalysis(_5378.GearSetMultibodyDynamicsAnalysis):
    """CylindricalGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5365.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_multibody_dynamics_analysis(self) -> 'List[_5365.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_multibody_dynamics_analysis(self) -> 'List[_5364.CylindricalGearMeshMultibodyDynamicsAnalysis]':
