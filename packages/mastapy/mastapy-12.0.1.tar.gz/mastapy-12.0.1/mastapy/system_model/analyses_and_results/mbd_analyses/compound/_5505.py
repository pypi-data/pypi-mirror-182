...
class CouplingHalfCompoundMultibodyDynamicsAnalysis(_5543.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """CouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5355.CouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5355.CouplingHalfMultibodyDynamicsAnalysis]':
