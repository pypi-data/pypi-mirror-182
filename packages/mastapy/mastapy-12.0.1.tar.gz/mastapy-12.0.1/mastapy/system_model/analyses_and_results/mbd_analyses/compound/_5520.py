...
class FaceGearMeshCompoundMultibodyDynamicsAnalysis(_5525.GearMeshCompoundMultibodyDynamicsAnalysis):
    """FaceGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5370.FaceGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5370.FaceGearMeshMultibodyDynamicsAnalysis]':
