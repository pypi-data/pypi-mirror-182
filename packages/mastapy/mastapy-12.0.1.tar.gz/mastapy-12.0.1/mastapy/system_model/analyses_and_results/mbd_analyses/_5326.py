...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5413, _5426
...
class BeltDriveMultibodyDynamicsAnalysis(_5426.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5413.PulleyMultibodyDynamicsAnalysis]':
