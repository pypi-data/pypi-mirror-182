...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5589, _5590, _5526
...
class WormGearSetCompoundMultibodyDynamicsAnalysis(_5526.GearSetCompoundMultibodyDynamicsAnalysis):
    """WormGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5456.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5589.WormGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5590.WormGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5456.WormGearSetMultibodyDynamicsAnalysis]':
