...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5491.ComponentCompoundMultibodyDynamicsAnalysis):
    """GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5379.GuideDxfModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5379.GuideDxfModelMultibodyDynamicsAnalysis]':
