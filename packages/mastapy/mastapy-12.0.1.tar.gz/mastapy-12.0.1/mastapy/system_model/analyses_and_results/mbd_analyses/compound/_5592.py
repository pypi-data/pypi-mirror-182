...
class ZerolBevelGearCompoundMultibodyDynamicsAnalysis(_5482.BevelGearCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5458.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5458.ZerolBevelGearMultibodyDynamicsAnalysis]':
