...
class ConnectionCompoundMultibodyDynamicsAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5352.ConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5352.ConnectionMultibodyDynamicsAnalysis]':
