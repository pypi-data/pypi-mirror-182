...
class CycloidalDiscCompoundMultibodyDynamicsAnalysis(_5467.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5362.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5362.CycloidalDiscMultibodyDynamicsAnalysis]':
