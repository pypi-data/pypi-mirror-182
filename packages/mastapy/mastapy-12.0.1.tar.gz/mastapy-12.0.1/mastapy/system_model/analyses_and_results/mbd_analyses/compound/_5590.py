...
class WormGearMeshCompoundMultibodyDynamicsAnalysis(_5525.GearMeshCompoundMultibodyDynamicsAnalysis):
    """WormGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5454.WormGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5454.WormGearMeshMultibodyDynamicsAnalysis]':
