...
class CoaxialConnectionCompoundMultibodyDynamicsAnalysis(_5563.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CoaxialConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5341.CoaxialConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5341.CoaxialConnectionMultibodyDynamicsAnalysis]':
