...
class AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5501.ConnectionCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5317.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5317.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
