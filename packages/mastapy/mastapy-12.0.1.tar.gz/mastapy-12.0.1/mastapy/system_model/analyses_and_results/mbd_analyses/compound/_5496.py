...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5525.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5346.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5346.ConceptGearMeshMultibodyDynamicsAnalysis]':
