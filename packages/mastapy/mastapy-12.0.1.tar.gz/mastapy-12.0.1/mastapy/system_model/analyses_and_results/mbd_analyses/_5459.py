...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5458, _5457, _5334
...
class ZerolBevelGearSetMultibodyDynamicsAnalysis(_5334.BevelGearSetMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5458.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5458.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5457.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
