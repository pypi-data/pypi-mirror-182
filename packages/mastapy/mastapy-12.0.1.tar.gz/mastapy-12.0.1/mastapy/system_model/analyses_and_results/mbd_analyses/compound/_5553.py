...
class PowerLoadCompoundMultibodyDynamicsAnalysis(_5588.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PowerLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5412.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5412.PowerLoadMultibodyDynamicsAnalysis]':
