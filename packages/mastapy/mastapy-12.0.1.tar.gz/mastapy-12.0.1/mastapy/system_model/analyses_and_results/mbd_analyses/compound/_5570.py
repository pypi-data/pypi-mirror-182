...
class SpringDamperHalfCompoundMultibodyDynamicsAnalysis(_5505.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """SpringDamperHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5431.SpringDamperHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5431.SpringDamperHalfMultibodyDynamicsAnalysis]':
