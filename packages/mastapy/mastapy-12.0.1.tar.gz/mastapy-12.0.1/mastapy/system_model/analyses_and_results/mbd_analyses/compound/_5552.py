...
class PointLoadCompoundMultibodyDynamicsAnalysis(_5588.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PointLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5411.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5411.PointLoadMultibodyDynamicsAnalysis]':
