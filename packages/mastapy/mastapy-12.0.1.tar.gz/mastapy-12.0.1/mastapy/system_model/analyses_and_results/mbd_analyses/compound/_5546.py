...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5503.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5407.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5407.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
