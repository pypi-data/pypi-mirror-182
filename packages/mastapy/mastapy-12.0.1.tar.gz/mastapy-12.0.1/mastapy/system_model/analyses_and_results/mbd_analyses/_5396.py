...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5395, _5394, _5390
...
class KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis(_5390.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5395.KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5395.KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5394.KlingelnbergCycloPalloidSpiralBevelGearMeshMultibodyDynamicsAnalysis]':
