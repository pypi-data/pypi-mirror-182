...
class BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(_5483.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5327.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5327.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
