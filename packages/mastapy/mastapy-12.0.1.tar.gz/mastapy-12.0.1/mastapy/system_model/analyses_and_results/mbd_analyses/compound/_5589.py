...
class WormGearCompoundMultibodyDynamicsAnalysis(_5524.GearCompoundMultibodyDynamicsAnalysis):
    """WormGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5455.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5455.WormGearMultibodyDynamicsAnalysis]':
