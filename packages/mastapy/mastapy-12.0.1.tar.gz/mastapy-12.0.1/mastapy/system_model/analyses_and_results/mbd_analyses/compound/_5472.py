...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5500.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5320.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5320.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
