...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5437, _5436, _5334
...
class StraightBevelGearSetMultibodyDynamicsAnalysis(_5334.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5437.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5437.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5436.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
