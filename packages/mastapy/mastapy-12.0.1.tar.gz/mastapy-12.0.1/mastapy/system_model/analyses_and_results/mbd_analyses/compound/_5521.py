...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5519, _5520, _5526
...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(_5526.GearSetCompoundMultibodyDynamicsAnalysis):
    """FaceGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5372.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5519.FaceGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5520.FaceGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5372.FaceGearSetMultibodyDynamicsAnalysis]':
