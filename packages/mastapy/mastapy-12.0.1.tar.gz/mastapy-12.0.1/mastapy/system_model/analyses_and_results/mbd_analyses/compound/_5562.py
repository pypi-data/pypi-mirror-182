...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5502.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5422.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5422.ShaftHubConnectionMultibodyDynamicsAnalysis]':
