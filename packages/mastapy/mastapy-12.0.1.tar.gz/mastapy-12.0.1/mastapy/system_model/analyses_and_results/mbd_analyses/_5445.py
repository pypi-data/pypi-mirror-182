...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5449, _5354
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5354.CouplingConnectionMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5449.TorqueConverterStatus':
        ...
        return constructor.new_from_mastapy_type(_5449.TorqueConverterStatus)(value) if value is not None else None
