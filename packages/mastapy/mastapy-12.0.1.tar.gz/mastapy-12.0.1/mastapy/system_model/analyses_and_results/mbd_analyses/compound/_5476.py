...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5564.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5326.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5326.BeltDriveMultibodyDynamicsAnalysis]':
