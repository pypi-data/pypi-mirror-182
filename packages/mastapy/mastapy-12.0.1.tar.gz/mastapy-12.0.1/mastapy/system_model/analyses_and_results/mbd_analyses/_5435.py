...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5434, _5433, _5334
...
class StraightBevelDiffGearSetMultibodyDynamicsAnalysis(_5334.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5434.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_multibody_dynamics_analysis(self) -> 'List[_5434.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_multibody_dynamics_analysis(self) -> 'List[_5433.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
