...
class RootAssemblyCompoundMultibodyDynamicsAnalysis(_5473.AssemblyCompoundMultibodyDynamicsAnalysis):
    """RootAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5419.RootAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5419.RootAssemblyMultibodyDynamicsAnalysis]':
