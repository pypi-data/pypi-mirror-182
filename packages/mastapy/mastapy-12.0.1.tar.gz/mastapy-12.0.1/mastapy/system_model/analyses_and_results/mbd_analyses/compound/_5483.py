...
class BevelGearMeshCompoundMultibodyDynamicsAnalysis(_5471.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5332.BevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5332.BevelGearMeshMultibodyDynamicsAnalysis]':
