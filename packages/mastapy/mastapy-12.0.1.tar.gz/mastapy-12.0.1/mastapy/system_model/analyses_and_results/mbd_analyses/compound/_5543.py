...
class MountableComponentCompoundMultibodyDynamicsAnalysis(_5491.ComponentCompoundMultibodyDynamicsAnalysis):
    """MountableComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5402.MountableComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5402.MountableComponentMultibodyDynamicsAnalysis]':
