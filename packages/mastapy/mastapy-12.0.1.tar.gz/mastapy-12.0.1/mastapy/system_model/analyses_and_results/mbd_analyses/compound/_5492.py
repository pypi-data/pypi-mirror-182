...
class ConceptCouplingCompoundMultibodyDynamicsAnalysis(_5503.CouplingCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5345.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5345.ConceptCouplingMultibodyDynamicsAnalysis]':
