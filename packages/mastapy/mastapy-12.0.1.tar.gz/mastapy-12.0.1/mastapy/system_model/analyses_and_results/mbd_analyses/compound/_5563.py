...
class ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5469.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5424.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5424.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
