...
class SynchroniserHalfCompoundMultibodyDynamicsAnalysis(_5581.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5441.SynchroniserHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5441.SynchroniserHalfMultibodyDynamicsAnalysis]':
