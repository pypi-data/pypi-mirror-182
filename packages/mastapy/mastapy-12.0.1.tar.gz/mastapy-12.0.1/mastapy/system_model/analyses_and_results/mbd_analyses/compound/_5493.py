...
class ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5504.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5343.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5343.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
