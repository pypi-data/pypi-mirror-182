...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5392, _5391, _5390
...
class KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis(_5390.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5392.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5392.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5391.KlingelnbergCycloPalloidHypoidGearMeshMultibodyDynamicsAnalysis]':
