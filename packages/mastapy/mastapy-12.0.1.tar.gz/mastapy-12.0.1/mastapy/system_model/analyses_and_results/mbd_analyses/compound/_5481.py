...
class BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis(_5477.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5331.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5331.BevelDifferentialSunGearMultibodyDynamicsAnalysis]':
