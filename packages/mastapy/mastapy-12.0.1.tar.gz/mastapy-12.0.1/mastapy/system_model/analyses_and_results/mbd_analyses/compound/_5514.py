...
class CylindricalGearMeshCompoundMultibodyDynamicsAnalysis(_5525.GearMeshCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5364.CylindricalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5364.CylindricalGearMeshMultibodyDynamicsAnalysis]':
