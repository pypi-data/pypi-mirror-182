...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5455, _5454, _5378
...
class WormGearSetMultibodyDynamicsAnalysis(_5378.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5455.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_multibody_dynamics_analysis(self) -> 'List[_5455.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_multibody_dynamics_analysis(self) -> 'List[_5454.WormGearMeshMultibodyDynamicsAnalysis]':
