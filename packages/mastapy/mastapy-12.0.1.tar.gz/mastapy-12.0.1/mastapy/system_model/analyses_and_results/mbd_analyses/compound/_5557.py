...
class RollingRingAssemblyCompoundMultibodyDynamicsAnalysis(_5564.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """RollingRingAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5416.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5416.RollingRingAssemblyMultibodyDynamicsAnalysis]':
