...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5371, _5370, _5378
...
class FaceGearSetMultibodyDynamicsAnalysis(_5378.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5371.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5371.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5370.FaceGearMeshMultibodyDynamicsAnalysis]':
