...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5381, _5380, _5320
...
class HypoidGearSetMultibodyDynamicsAnalysis(_5320.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis):
    """HypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5381.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5381.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5380.HypoidGearMeshMultibodyDynamicsAnalysis]':
