...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5513, _5514, _5526
...
class CylindricalGearSetCompoundMultibodyDynamicsAnalysis(_5526.GearSetCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5366.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5513.CylindricalGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5514.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5366.CylindricalGearSetMultibodyDynamicsAnalysis]':
