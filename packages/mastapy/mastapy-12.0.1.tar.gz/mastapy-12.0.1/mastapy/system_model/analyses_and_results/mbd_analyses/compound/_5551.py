...
class PlanetCarrierCompoundMultibodyDynamicsAnalysis(_5543.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """PlanetCarrierCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5410.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5410.PlanetCarrierMultibodyDynamicsAnalysis]':
