...
class BoltedJointCompoundMultibodyDynamicsAnalysis(_5564.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BoltedJointCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5335.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5335.BoltedJointMultibodyDynamicsAnalysis]':
