...
class SpringDamperCompoundMultibodyDynamicsAnalysis(_5503.CouplingCompoundMultibodyDynamicsAnalysis):
    """SpringDamperCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5432.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5432.SpringDamperMultibodyDynamicsAnalysis]':
