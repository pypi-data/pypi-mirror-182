...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5524.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5350.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5350.ConicalGearMultibodyDynamicsAnalysis]':
