...
class ComponentCompoundMultibodyDynamicsAnalysis(_5545.PartCompoundMultibodyDynamicsAnalysis):
    """ComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5342.ComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5342.ComponentMultibodyDynamicsAnalysis]':
