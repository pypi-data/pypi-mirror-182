...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5386, _5420, _5425
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7461
from mastapy.system_model.analyses_and_results.static_loads import _6733
...
class MBDRunUpAnalysisOptions(_7461.AbstractAnalysisOptions['_6733.TimeSeriesLoadCase']):
    """MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5386.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new_from_mastapy_type(_5386.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5386.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def run_up_driving_mode(self) -> '_5420.RunUpDrivingMode':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5420.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5420.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5425.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5425.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5425.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
