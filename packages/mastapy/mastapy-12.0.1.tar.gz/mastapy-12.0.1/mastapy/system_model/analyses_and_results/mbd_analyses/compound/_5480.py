...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5477.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5330.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5330.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
