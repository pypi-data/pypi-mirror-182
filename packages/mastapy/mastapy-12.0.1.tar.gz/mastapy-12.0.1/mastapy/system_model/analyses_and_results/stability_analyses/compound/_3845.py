...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3877.ConnectionCompoundStabilityAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3713.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3713.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
