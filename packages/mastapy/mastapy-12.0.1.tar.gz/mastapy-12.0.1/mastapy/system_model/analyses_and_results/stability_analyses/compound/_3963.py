...
class UnbalancedMassCompoundStabilityAnalysis(_3964.VirtualComponentCompoundStabilityAnalysis):
    """UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3834.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3834.UnbalancedMassStabilityAnalysis]':
