...
class ExternalCADModelCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3763.ExternalCADModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3763.ExternalCADModelStabilityAnalysis]':
