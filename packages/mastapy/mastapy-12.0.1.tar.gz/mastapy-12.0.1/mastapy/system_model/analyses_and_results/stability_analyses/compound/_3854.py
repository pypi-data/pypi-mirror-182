...
class BevelDifferentialGearMeshCompoundStabilityAnalysis(_3859.BevelGearMeshCompoundStabilityAnalysis):
    """BevelDifferentialGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3721.BevelDifferentialGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3721.BevelDifferentialGearMeshStabilityAnalysis]':
