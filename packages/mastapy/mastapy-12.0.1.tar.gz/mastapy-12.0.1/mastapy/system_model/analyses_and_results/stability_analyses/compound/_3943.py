...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3941, _3942, _3860
...
class SpiralBevelGearSetCompoundStabilityAnalysis(_3860.BevelGearSetCompoundStabilityAnalysis):
    """SpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3811.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3941.SpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3942.SpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3811.SpiralBevelGearSetStabilityAnalysis]':
