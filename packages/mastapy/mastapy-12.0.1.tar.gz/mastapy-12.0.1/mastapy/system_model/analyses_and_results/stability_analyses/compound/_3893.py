...
class DatumCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3762.DatumStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3762.DatumStabilityAnalysis]':
