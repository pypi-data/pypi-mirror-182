...
from mastapy.system_model.analyses_and_results.stability_analyses import _3823, _3821, _3727
...
class StraightBevelGearSetStabilityAnalysis(_3727.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3823.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3821.StraightBevelGearMeshStabilityAnalysis]':
