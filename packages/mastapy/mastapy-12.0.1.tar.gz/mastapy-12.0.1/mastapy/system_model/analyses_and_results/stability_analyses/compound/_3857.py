...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3853.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3725.BevelDifferentialSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3725.BevelDifferentialSunGearStabilityAnalysis]':
