...
class RollingRingCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """RollingRingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3804.RollingRingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3804.RollingRingStabilityAnalysis]':
