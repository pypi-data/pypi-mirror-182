...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3911, _3912, _3910
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(_3910.KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3781.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_stability_analysis(self) -> 'List[_3911.KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_stability_analysis(self) -> 'List[_3912.KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3781.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
