...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3874.ConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3779.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3779.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
