...
class BevelGearMeshCompoundStabilityAnalysis(_3847.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """BevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3726.BevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3726.BevelGearMeshStabilityAnalysis]':
