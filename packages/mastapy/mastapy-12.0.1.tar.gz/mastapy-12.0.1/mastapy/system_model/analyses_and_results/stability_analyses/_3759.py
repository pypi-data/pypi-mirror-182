...
from mastapy.system_model.analyses_and_results.stability_analyses import _3760, _3758, _3770
...
class CylindricalGearSetStabilityAnalysis(_3770.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3760.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3758.CylindricalGearMeshStabilityAnalysis]':
