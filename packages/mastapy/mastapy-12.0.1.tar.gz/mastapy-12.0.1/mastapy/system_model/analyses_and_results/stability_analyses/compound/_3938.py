...
class ShaftHubConnectionCompoundStabilityAnalysis(_3878.ConnectorCompoundStabilityAnalysis):
    """ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3806.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3806.ShaftHubConnectionStabilityAnalysis]':
