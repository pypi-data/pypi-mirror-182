...
class KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis(_3908.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3782.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3782.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
