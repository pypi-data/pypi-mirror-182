...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3871, _3872, _3902
...
class ConceptGearSetCompoundStabilityAnalysis(_3902.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3740.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3871.ConceptGearCompoundStabilityAnalysis]':
    ...
    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3872.ConceptGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3740.ConceptGearSetStabilityAnalysis]':
