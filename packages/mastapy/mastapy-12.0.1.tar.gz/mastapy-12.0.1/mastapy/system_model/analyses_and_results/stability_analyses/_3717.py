...
from mastapy.system_model.analyses_and_results.stability_analyses import (
    _3718, _3720, _3722, _3729,
    _3730, _3753, _3733, _3738,
    _3740, _3754, _3757, _3759,
    _3767, _3765, _3768, _3774,
    _3781, _3784, _3786, _3787,
    _3789, _3793, _3796, _3797,
    _3798, _3800, _3802, _3806,
    _3807, _3811, _3815, _3819,
    _3822, _3829, _3832, _3834,
    _3837, _3840, _3710
)
...
class AssemblyStabilityAnalysis(_3710.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self) -> 'List[_3718.BearingStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3720.BeltDriveStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3722.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3729.BoltedJointStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3730.BoltStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3753.CVTStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3733.ClutchStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3738.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3740.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3754.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3757.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3759.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3767.FEPartStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3765.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3768.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3774.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3781.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3784.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3786.MassDiscStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3787.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3789.OilSealStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3793.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3796.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3797.PointLoadStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3798.PowerLoadStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3800.RingPinsStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3802.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3806.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3807.ShaftStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3811.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3815.SpringDamperStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3819.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3822.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3829.SynchroniserStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3832.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3834.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3837.WormGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3840.ZerolBevelGearSetStabilityAnalysis]':
