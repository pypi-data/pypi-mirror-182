...
class CVTCompoundStabilityAnalysis(_3852.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3753.CVTStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3753.CVTStabilityAnalysis]':
