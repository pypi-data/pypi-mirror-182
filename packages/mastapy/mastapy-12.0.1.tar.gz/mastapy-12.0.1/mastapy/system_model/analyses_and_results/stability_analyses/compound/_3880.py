...
class CouplingConnectionCompoundStabilityAnalysis(_3907.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """CouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3747.CouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3747.CouplingConnectionStabilityAnalysis]':
