...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3853, _3854, _3860
...
class BevelDifferentialGearSetCompoundStabilityAnalysis(_3860.BevelGearSetCompoundStabilityAnalysis):
    """BevelDifferentialGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3722.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_stability_analysis(self) -> 'List[_3853.BevelDifferentialGearCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_stability_analysis(self) -> 'List[_3854.BevelDifferentialGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3722.BevelDifferentialGearSetStabilityAnalysis]':
