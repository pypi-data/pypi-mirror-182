...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3965, _3966, _3902
...
class WormGearSetCompoundStabilityAnalysis(_3902.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3837.WormGearSetStabilityAnalysis]':
    ...
    @property
    def worm_gears_compound_stability_analysis(self) -> 'List[_3965.WormGearCompoundStabilityAnalysis]':
    ...
    @property
    def worm_meshes_compound_stability_analysis(self) -> 'List[_3966.WormGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3837.WormGearSetStabilityAnalysis]':
