...
class ConceptCouplingHalfCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """ConceptCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3737.ConceptCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3737.ConceptCouplingHalfStabilityAnalysis]':
