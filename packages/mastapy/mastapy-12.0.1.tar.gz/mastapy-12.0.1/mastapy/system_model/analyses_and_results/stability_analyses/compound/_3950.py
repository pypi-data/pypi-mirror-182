...
class StraightBevelGearCompoundStabilityAnalysis(_3858.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3823.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3823.StraightBevelGearStabilityAnalysis]':
