...
class AbstractAssemblyCompoundStabilityAnalysis(_3921.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3710.AbstractAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3710.AbstractAssemblyStabilityAnalysis]':
