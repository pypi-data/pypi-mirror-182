...
class SpiralBevelGearCompoundStabilityAnalysis(_3858.BevelGearCompoundStabilityAnalysis):
    """SpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3812.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3812.SpiralBevelGearStabilityAnalysis]':
