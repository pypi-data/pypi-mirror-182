...
class AGMAGleasonConicalGearSetCompoundStabilityAnalysis(_3876.ConicalGearSetCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3715.AGMAGleasonConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3715.AGMAGleasonConicalGearSetStabilityAnalysis]':
