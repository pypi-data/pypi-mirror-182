...
class SynchroniserCompoundStabilityAnalysis(_3940.SpecialisedAssemblyCompoundStabilityAnalysis):
    """SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3829.SynchroniserStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3829.SynchroniserStabilityAnalysis]':
