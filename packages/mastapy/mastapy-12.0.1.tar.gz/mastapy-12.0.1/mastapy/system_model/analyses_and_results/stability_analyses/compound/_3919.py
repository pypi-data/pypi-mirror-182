...
class MountableComponentCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """MountableComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3788.MountableComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3788.MountableComponentStabilityAnalysis]':
