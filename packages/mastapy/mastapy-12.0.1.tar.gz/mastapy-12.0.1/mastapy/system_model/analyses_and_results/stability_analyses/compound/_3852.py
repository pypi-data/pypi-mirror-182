...
class BeltDriveCompoundStabilityAnalysis(_3940.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3720.BeltDriveStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3720.BeltDriveStabilityAnalysis]':
