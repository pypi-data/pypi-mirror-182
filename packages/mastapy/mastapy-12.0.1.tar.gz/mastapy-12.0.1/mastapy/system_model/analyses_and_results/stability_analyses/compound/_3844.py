...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3711.AbstractShaftOrHousingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3711.AbstractShaftOrHousingStabilityAnalysis]':
