...
class KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis(_3876.ConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3778.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3778.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
