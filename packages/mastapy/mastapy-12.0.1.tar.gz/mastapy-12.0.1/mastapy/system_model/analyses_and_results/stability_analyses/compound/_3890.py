...
class CylindricalGearMeshCompoundStabilityAnalysis(_3901.GearMeshCompoundStabilityAnalysis):
    """CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3758.CylindricalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3758.CylindricalGearMeshStabilityAnalysis]':
