...
class TorqueConverterPumpCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3831.TorqueConverterPumpStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3831.TorqueConverterPumpStabilityAnalysis]':
