...
class VirtualComponentCompoundStabilityAnalysis(_3919.MountableComponentCompoundStabilityAnalysis):
    """VirtualComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3835.VirtualComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3835.VirtualComponentStabilityAnalysis]':
