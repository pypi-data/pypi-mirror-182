...
class CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis(_3845.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3756.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3756.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
