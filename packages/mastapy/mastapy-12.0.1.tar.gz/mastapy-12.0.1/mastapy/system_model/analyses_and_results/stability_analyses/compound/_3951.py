...
class StraightBevelGearMeshCompoundStabilityAnalysis(_3859.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3821.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3821.StraightBevelGearMeshStabilityAnalysis]':
