...
class CVTBeltConnectionCompoundStabilityAnalysis(_3851.BeltConnectionCompoundStabilityAnalysis):
    """CVTBeltConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3751.CVTBeltConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3751.CVTBeltConnectionStabilityAnalysis]':
