...
class ClutchHalfCompoundStabilityAnalysis(_3881.CouplingHalfCompoundStabilityAnalysis):
    """ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3732.ClutchHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3732.ClutchHalfStabilityAnalysis]':
