...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3950, _3951, _3860
...
class StraightBevelGearSetCompoundStabilityAnalysis(_3860.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3822.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_stability_analysis(self) -> 'List[_3950.StraightBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_stability_analysis(self) -> 'List[_3951.StraightBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3822.StraightBevelGearSetStabilityAnalysis]':
