...
class BevelDifferentialGearCompoundStabilityAnalysis(_3858.BevelGearCompoundStabilityAnalysis):
    """BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3723.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3723.BevelDifferentialGearStabilityAnalysis]':
