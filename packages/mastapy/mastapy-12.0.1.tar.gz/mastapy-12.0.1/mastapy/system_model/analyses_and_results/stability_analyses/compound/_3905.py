...
class HypoidGearMeshCompoundStabilityAnalysis(_3847.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """HypoidGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3773.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3773.HypoidGearMeshStabilityAnalysis]':
