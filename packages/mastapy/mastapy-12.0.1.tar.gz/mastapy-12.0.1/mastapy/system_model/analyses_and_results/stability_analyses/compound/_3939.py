...
class ShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3845.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """ShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3808.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3808.ShaftToMountableComponentConnectionStabilityAnalysis]':
