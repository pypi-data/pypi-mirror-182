...
class PlanetCarrierCompoundStabilityAnalysis(_3919.MountableComponentCompoundStabilityAnalysis):
    """PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3796.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3796.PlanetCarrierStabilityAnalysis]':
