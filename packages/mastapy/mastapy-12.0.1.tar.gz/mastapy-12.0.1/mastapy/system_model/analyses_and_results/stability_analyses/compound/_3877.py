...
class ConnectionCompoundStabilityAnalysis(_7464.ConnectionCompoundAnalysis):
    """ConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3745.ConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3745.ConnectionStabilityAnalysis]':
