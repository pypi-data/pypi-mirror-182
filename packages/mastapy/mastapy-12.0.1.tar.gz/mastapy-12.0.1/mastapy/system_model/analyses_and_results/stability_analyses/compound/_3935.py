...
class RollingRingConnectionCompoundStabilityAnalysis(_3907.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RollingRingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3803.RollingRingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3803.RollingRingConnectionStabilityAnalysis]':
