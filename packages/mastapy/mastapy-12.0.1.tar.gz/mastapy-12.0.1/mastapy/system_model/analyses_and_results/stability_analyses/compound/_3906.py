...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3904, _3905, _3848
...
class HypoidGearSetCompoundStabilityAnalysis(_3848.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """HypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3774.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def hypoid_gears_compound_stability_analysis(self) -> 'List[_3904.HypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_stability_analysis(self) -> 'List[_3905.HypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3774.HypoidGearSetStabilityAnalysis]':
