...
class TorqueConverterConnectionCompoundStabilityAnalysis(_3880.CouplingConnectionCompoundStabilityAnalysis):
    """TorqueConverterConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3830.TorqueConverterConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3830.TorqueConverterConnectionStabilityAnalysis]':
