...
class SpringDamperConnectionCompoundStabilityAnalysis(_3880.CouplingConnectionCompoundStabilityAnalysis):
    """SpringDamperConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3813.SpringDamperConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3813.SpringDamperConnectionStabilityAnalysis]':
