...
class RingPinsCompoundStabilityAnalysis(_3919.MountableComponentCompoundStabilityAnalysis):
    """RingPinsCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3800.RingPinsStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3800.RingPinsStabilityAnalysis]':
