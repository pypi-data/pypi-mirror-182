...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3858
...
class ZerolBevelGearCompoundStabilityAnalysis(_3858.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3841.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3841.ZerolBevelGearStabilityAnalysis]':
