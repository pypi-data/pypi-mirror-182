...
class CVTPulleyCompoundStabilityAnalysis(_3930.PulleyCompoundStabilityAnalysis):
    """CVTPulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3752.CVTPulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3752.CVTPulleyStabilityAnalysis]':
