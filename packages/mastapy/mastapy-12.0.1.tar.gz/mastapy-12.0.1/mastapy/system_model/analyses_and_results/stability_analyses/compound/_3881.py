...
class CouplingHalfCompoundStabilityAnalysis(_3919.MountableComponentCompoundStabilityAnalysis):
    """CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3748.CouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3748.CouplingHalfStabilityAnalysis]':
