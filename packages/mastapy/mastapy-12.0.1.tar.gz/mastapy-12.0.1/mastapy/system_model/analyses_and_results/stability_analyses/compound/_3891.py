...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3889, _3890, _3902
...
class CylindricalGearSetCompoundStabilityAnalysis(_3902.GearSetCompoundStabilityAnalysis):
    """CylindricalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3759.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_stability_analysis(self) -> 'List[_3889.CylindricalGearCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_stability_analysis(self) -> 'List[_3890.CylindricalGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3759.CylindricalGearSetStabilityAnalysis]':
