...
class BoltCompoundStabilityAnalysis(_3867.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3730.BoltStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3730.BoltStabilityAnalysis]':
