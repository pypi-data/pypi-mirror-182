...
class CompoundAnalysis(_7478.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    def perform_analysis_with_progress(self, progress: '_7484.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2160.DesignEntity') -> 'Iterable[_7468.DesignEntityCompoundAnalysis]':
