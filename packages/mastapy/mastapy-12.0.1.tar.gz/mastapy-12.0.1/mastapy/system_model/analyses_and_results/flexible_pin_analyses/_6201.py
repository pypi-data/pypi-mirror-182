...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2847, _2883, _2806
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6198
...
class FlexiblePinAnalysisGearAndBearingRating(_6198.FlexiblePinAnalysis):
    """FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2847.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2847.CylindricalGearSetCompoundSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2806.BearingCompoundSystemDeflection]':
