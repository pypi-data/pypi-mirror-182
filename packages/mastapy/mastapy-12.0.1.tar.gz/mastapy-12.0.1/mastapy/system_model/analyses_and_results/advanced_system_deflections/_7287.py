...
class PointLoadAdvancedSystemDeflection(_7324.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2738.PointLoadSystemDeflection]':
