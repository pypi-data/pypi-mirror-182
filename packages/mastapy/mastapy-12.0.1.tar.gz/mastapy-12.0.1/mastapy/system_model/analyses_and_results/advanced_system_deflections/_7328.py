...
class ZerolBevelGearAdvancedSystemDeflection(_7214.BevelGearAdvancedSystemDeflection):
    """ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2788.ZerolBevelGearSystemDeflection]':
