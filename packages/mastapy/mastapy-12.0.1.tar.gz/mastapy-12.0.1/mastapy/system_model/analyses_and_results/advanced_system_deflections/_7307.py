...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7215.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2760.StraightBevelDiffGearMeshSystemDeflection]':
