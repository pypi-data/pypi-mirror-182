...
class PlanetCarrierAdvancedSystemDeflection(_7278.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2737.PlanetCarrierSystemDeflection]':
