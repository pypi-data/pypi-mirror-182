...
class PlanetCarrierCompoundAdvancedSystemDeflection(_7408.MountableComponentCompoundAdvancedSystemDeflection):
    """PlanetCarrierCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7286.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7286.PlanetCarrierAdvancedSystemDeflection]':
