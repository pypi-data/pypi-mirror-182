...
class StraightBevelGearAdvancedSystemDeflection(_7214.BevelGearAdvancedSystemDeflection):
    """StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2765.StraightBevelGearSystemDeflection]':
