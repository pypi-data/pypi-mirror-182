...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7348.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7301.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7301.SpiralBevelGearMeshAdvancedSystemDeflection]':
