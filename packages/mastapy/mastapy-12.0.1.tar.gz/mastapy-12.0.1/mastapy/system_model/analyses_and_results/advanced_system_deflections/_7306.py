...
class StraightBevelDiffGearAdvancedSystemDeflection(_7214.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2762.StraightBevelDiffGearSystemDeflection]':
