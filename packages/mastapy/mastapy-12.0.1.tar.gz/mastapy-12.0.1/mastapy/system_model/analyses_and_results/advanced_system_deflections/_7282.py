...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_7237.CouplingConnectionAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2733.PartToPartShearCouplingConnectionSystemDeflection]':
