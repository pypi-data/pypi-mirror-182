...
class CycloidalAssemblyAdvancedSystemDeflection(_7299.SpecialisedAssemblyAdvancedSystemDeflection):
    """CycloidalAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2682.CycloidalAssemblySystemDeflection]':
