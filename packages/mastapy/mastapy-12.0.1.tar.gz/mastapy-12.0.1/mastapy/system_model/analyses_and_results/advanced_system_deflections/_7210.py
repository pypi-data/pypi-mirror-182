...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_7215.BevelGearMeshAdvancedSystemDeflection):
    """BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2648.BevelDifferentialGearMeshSystemDeflection]':
