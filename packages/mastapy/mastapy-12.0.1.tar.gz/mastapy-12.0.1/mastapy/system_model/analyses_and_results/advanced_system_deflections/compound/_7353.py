...
class ClutchConnectionCompoundAdvancedSystemDeflection(_7369.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ClutchConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7220.ClutchConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7220.ClutchConnectionAdvancedSystemDeflection]':
