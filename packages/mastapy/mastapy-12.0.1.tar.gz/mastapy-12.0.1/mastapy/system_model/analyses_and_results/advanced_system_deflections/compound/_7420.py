...
class RingPinsCompoundAdvancedSystemDeflection(_7408.MountableComponentCompoundAdvancedSystemDeflection):
    """RingPinsCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7290.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7290.RingPinsAdvancedSystemDeflection]':
