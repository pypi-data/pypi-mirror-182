...
class WormGearAdvancedSystemDeflection(_7258.GearAdvancedSystemDeflection):
    """WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2785.WormGearSystemDeflection]':
