...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7306, _7307, _7216
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_7216.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2761.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_7306.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_7307.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
