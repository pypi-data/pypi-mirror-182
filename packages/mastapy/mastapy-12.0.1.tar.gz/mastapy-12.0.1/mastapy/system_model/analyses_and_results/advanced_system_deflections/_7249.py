...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7246, _7250, _7247
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7246.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7246.CylindricalGearAdvancedSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7247.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7246.CylindricalGearAdvancedSystemDeflection':
