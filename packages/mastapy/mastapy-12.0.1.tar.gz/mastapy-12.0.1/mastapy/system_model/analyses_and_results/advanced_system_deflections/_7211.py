...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7209, _7210, _7216
...
class BevelDifferentialGearSetAdvancedSystemDeflection(_7216.BevelGearSetAdvancedSystemDeflection):
    """BevelDifferentialGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2649.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_advanced_system_deflection(self) -> 'List[_7209.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_advanced_system_deflection(self) -> 'List[_7210.BevelDifferentialGearMeshAdvancedSystemDeflection]':
