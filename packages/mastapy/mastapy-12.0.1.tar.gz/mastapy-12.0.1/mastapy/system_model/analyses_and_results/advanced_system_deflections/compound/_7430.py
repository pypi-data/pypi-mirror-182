...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7347.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7300.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7300.SpiralBevelGearAdvancedSystemDeflection]':
