...
class RollingRingAssemblyCompoundAdvancedSystemDeflection(_7429.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """RollingRingAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7293.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7293.RollingRingAssemblyAdvancedSystemDeflection]':
