...
class ConceptCouplingAdvancedSystemDeflection(_7236.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2666.ConceptCouplingSystemDeflection]':
