...
class ConicalGearMeshCompoundAdvancedSystemDeflection(_7390.GearMeshCompoundAdvancedSystemDeflection):
    """ConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7231.ConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7231.ConicalGearMeshAdvancedSystemDeflection]':
