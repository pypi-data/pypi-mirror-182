...
class BevelDifferentialGearCompoundAdvancedSystemDeflection(_7347.BevelGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7209.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7209.BevelDifferentialGearAdvancedSystemDeflection]':
