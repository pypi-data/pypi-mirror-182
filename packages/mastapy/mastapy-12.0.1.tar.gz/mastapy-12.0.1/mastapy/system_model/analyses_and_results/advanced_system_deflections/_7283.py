...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2734.PartToPartShearCouplingHalfSystemDeflection]':
