...
class ConicalGearCompoundAdvancedSystemDeflection(_7389.GearCompoundAdvancedSystemDeflection):
    """ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7230.ConicalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7230.ConicalGearAdvancedSystemDeflection]':
