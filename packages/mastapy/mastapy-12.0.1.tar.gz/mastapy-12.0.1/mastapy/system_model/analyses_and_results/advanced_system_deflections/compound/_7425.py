...
class RootAssemblyCompoundAdvancedSystemDeflection(_7338.AssemblyCompoundAdvancedSystemDeflection):
    """RootAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7295.RootAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7295.RootAssemblyAdvancedSystemDeflection]':
