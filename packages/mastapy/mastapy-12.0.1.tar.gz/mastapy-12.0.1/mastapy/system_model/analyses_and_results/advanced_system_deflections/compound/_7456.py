...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7454, _7455, _7391
...
class WormGearSetCompoundAdvancedSystemDeflection(_7391.GearSetCompoundAdvancedSystemDeflection):
    """WormGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7327.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def worm_gears_compound_advanced_system_deflection(self) -> 'List[_7454.WormGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_advanced_system_deflection(self) -> 'List[_7455.WormGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7327.WormGearSetAdvancedSystemDeflection]':
