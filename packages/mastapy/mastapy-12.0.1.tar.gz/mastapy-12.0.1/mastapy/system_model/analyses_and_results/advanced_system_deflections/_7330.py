...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7328, _7329, _7216
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7216.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2787.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7328.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7329.ZerolBevelGearMeshAdvancedSystemDeflection]':
