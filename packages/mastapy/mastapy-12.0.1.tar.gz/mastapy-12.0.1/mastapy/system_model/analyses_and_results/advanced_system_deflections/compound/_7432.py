...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7430, _7431, _7349
...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(_7349.BevelGearSetCompoundAdvancedSystemDeflection):
    """SpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7302.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7430.SpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7431.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7302.SpiralBevelGearSetAdvancedSystemDeflection]':
