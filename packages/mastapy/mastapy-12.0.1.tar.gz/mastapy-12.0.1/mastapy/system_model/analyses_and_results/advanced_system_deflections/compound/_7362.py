...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7360, _7361, _7391
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_7391.GearSetCompoundAdvancedSystemDeflection):
    """ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7229.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_7360.ConceptGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_7361.ConceptGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7229.ConceptGearSetAdvancedSystemDeflection]':
