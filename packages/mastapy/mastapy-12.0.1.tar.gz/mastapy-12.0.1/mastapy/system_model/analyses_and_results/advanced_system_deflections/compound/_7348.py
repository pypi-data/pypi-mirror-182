...
class BevelGearMeshCompoundAdvancedSystemDeflection(_7336.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """BevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7215.BevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7215.BevelGearMeshAdvancedSystemDeflection]':
