...
class ConceptCouplingCompoundAdvancedSystemDeflection(_7368.CouplingCompoundAdvancedSystemDeflection):
    """ConceptCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7224.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7224.ConceptCouplingAdvancedSystemDeflection]':
