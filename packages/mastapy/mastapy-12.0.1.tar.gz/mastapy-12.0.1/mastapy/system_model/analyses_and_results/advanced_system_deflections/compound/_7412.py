...
class PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection(_7369.CouplingConnectionCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7282.PartToPartShearCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7282.PartToPartShearCouplingConnectionAdvancedSystemDeflection]':
