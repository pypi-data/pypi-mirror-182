...
class MassDiscAdvancedSystemDeflection(_7324.VirtualComponentAdvancedSystemDeflection):
    """MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2726.MassDiscSystemDeflection]':
