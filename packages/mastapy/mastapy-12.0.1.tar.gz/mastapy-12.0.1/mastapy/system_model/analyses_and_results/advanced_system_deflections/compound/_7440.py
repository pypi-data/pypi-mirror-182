...
class StraightBevelGearMeshCompoundAdvancedSystemDeflection(_7348.BevelGearMeshCompoundAdvancedSystemDeflection):
    """StraightBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7310.StraightBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7310.StraightBevelGearMeshAdvancedSystemDeflection]':
