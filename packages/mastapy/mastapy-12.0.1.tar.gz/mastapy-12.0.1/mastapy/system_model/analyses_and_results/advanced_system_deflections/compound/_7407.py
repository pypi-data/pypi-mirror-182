...
class MeasurementComponentCompoundAdvancedSystemDeflection(_7453.VirtualComponentCompoundAdvancedSystemDeflection):
    """MeasurementComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7277.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7277.MeasurementComponentAdvancedSystemDeflection]':
