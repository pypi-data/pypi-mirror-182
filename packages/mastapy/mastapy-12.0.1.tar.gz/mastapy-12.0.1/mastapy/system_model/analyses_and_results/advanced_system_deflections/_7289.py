...
class PulleyAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2740.PulleySystemDeflection]':
