...
class StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection(_7348.BevelGearMeshCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7307.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7307.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
