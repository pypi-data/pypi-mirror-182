...
class ConceptGearAdvancedSystemDeflection(_7258.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2669.ConceptGearSystemDeflection]':
