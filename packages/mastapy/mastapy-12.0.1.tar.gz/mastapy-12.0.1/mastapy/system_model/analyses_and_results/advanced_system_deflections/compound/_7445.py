...
class SynchroniserHalfCompoundAdvancedSystemDeflection(_7446.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7315.SynchroniserHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7315.SynchroniserHalfAdvancedSystemDeflection]':
