...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7340.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7240.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7240.CVTBeltConnectionAdvancedSystemDeflection]':
