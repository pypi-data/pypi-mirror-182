...
class FEPartAdvancedSystemDeflection(_7197.AbstractShaftOrHousingAdvancedSystemDeflection):
    """FEPartAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2704.FEPartSystemDeflection]':
