...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7272, _7273, _7268
...
class KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection(_7268.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2722.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7272.KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7273.KlingelnbergCycloPalloidSpiralBevelGearMeshAdvancedSystemDeflection]':
