...
class BevelDifferentialGearAdvancedSystemDeflection(_7214.BevelGearAdvancedSystemDeflection):
    """BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2650.BevelDifferentialGearSystemDeflection]':
