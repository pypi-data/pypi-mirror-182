...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7366.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7265.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7265.InterMountableComponentConnectionAdvancedSystemDeflection]':
