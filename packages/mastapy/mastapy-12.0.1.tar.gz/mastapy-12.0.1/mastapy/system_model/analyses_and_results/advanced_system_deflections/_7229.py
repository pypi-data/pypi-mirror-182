...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7227, _7228, _7260
...
class ConceptGearSetAdvancedSystemDeflection(_7260.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2668.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_7227.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_7228.ConceptGearMeshAdvancedSystemDeflection]':
