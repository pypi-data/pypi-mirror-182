...
class PartCompoundAdvancedSystemDeflection(_7471.PartCompoundAnalysis):
    """PartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7280.PartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7280.PartAdvancedSystemDeflection]':
