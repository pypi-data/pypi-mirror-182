...
class ClutchHalfAdvancedSystemDeflection(_7238.CouplingHalfAdvancedSystemDeflection):
    """ClutchHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2659.ClutchHalfSystemDeflection]':
