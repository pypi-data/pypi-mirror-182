...
class ZerolBevelGearMeshAdvancedSystemDeflection(_7215.BevelGearMeshAdvancedSystemDeflection):
    """ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2786.ZerolBevelGearMeshSystemDeflection]':
