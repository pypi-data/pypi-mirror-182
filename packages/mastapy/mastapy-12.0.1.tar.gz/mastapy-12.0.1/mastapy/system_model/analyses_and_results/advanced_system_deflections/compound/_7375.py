...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7355.CoaxialConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7244.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7244.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
