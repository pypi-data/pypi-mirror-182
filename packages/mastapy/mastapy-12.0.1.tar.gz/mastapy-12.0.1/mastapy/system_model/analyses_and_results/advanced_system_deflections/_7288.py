...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7322, _7324
...
class PowerLoadAdvancedSystemDeflection(_7324.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2739.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7322.TransmissionErrorToOtherPowerLoad]':
