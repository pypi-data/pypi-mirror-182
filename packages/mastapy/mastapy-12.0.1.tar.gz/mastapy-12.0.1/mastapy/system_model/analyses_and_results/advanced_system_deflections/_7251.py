...
class DatumAdvancedSystemDeflection(_7223.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2698.DatumSystemDeflection]':
