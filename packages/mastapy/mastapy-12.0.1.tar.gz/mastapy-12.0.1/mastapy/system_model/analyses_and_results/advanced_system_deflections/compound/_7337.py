...
class AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection(_7365.ConicalGearSetCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7204.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7204.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
