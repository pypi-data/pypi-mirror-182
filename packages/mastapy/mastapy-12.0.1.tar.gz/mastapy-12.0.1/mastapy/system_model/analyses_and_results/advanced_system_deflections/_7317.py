...
class SynchroniserSleeveAdvancedSystemDeflection(_7316.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2770.SynchroniserSleeveSystemDeflection]':
