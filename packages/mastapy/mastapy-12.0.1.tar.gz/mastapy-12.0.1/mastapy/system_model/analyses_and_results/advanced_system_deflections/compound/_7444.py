...
class SynchroniserCompoundAdvancedSystemDeflection(_7429.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """SynchroniserCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7314.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7314.SynchroniserAdvancedSystemDeflection]':
