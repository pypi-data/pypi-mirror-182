...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7369.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7319.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7319.TorqueConverterConnectionAdvancedSystemDeflection]':
