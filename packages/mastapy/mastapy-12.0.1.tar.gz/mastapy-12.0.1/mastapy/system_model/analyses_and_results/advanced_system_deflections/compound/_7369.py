...
class CouplingConnectionCompoundAdvancedSystemDeflection(_7396.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7237.CouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7237.CouplingConnectionAdvancedSystemDeflection]':
