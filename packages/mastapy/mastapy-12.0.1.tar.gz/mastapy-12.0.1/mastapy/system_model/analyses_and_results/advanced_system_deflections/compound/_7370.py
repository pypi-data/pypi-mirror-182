...
class CouplingHalfCompoundAdvancedSystemDeflection(_7408.MountableComponentCompoundAdvancedSystemDeflection):
    """CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7238.CouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7238.CouplingHalfAdvancedSystemDeflection]':
