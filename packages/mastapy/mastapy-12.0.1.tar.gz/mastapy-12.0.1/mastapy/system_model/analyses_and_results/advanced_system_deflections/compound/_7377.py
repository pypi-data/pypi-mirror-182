...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection(_7334.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7245.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7245.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
