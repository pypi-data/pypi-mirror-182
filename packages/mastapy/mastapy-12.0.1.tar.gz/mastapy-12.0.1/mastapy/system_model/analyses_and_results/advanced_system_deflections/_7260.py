...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7275, _7299
...
class GearSetAdvancedSystemDeflection(_7299.SpecialisedAssemblyAdvancedSystemDeflection):
    """GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_7275.UseLtcaInAsdOption':
        ...
        return constructor.new_from_mastapy_type(_7275.UseLtcaInAsdOption)(value) if value is not None else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_7275.UseLtcaInAsdOption'):
