...
class ClutchAdvancedSystemDeflection(_7236.CouplingAdvancedSystemDeflection):
    """ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2660.ClutchSystemDeflection]':
