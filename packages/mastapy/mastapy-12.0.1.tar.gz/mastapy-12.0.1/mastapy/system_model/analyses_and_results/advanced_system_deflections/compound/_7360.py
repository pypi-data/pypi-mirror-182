...
class ConceptGearCompoundAdvancedSystemDeflection(_7389.GearCompoundAdvancedSystemDeflection):
    """ConceptGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7227.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7227.ConceptGearAdvancedSystemDeflection]':
