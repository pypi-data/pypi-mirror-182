...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7300, _7301, _7216
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7216.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2755.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7300.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7301.SpiralBevelGearMeshAdvancedSystemDeflection]':
