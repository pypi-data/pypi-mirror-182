...
class SpiralBevelGearAdvancedSystemDeflection(_7214.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2756.SpiralBevelGearSystemDeflection]':
