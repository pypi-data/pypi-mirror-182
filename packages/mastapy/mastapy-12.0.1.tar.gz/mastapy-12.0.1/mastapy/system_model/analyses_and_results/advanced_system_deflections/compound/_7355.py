...
class CoaxialConnectionCompoundAdvancedSystemDeflection(_7428.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CoaxialConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7222.CoaxialConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7222.CoaxialConnectionAdvancedSystemDeflection]':
