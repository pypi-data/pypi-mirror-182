...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7367.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7297.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7297.ShaftHubConnectionAdvancedSystemDeflection]':
