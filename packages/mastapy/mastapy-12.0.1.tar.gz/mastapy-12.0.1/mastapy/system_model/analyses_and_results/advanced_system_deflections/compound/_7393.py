...
class HypoidGearCompoundAdvancedSystemDeflection(_7335.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    """HypoidGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7262.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7262.HypoidGearAdvancedSystemDeflection]':
