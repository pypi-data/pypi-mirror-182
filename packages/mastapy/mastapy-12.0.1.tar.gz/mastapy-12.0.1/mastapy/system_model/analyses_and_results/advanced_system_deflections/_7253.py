...
class FaceGearAdvancedSystemDeflection(_7258.GearAdvancedSystemDeflection):
    """FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2703.FaceGearSystemDeflection]':
