...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7410.PartCompoundAdvancedSystemDeflection):
    """AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7195.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7195.AbstractAssemblyAdvancedSystemDeflection]':
