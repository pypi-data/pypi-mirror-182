...
class ShaftHubConnectionAdvancedSystemDeflection(_7234.ConnectorAdvancedSystemDeflection):
    """ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2748.ShaftHubConnectionSystemDeflection]':
