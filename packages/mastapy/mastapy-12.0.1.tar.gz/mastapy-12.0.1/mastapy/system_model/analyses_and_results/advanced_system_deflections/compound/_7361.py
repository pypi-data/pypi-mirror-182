...
class ConceptGearMeshCompoundAdvancedSystemDeflection(_7390.GearMeshCompoundAdvancedSystemDeflection):
    """ConceptGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7228.ConceptGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7228.ConceptGearMeshAdvancedSystemDeflection]':
