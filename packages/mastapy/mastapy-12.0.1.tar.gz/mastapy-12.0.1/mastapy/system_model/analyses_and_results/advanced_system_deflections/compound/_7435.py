...
class SpringDamperHalfCompoundAdvancedSystemDeflection(_7370.CouplingHalfCompoundAdvancedSystemDeflection):
    """SpringDamperHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7305.SpringDamperHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7305.SpringDamperHalfAdvancedSystemDeflection]':
