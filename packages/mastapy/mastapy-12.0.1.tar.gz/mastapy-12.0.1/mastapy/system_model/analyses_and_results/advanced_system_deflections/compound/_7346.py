...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7342.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7213.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7213.BevelDifferentialSunGearAdvancedSystemDeflection]':
