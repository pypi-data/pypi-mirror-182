...
class PlanetaryConnectionAdvancedSystemDeflection(_7298.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2736.PlanetaryConnectionSystemDeflection]':
