...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7364
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection(_7364.ConicalGearMeshCompoundAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7267.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7267.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
