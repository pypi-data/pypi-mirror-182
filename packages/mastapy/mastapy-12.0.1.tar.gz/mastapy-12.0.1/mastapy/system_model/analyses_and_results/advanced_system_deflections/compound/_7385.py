...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7390.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7254.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7254.FaceGearMeshAdvancedSystemDeflection]':
