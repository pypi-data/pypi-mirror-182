...
class MeasurementComponentAdvancedSystemDeflection(_7324.VirtualComponentAdvancedSystemDeflection):
    """MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2727.MeasurementComponentSystemDeflection]':
