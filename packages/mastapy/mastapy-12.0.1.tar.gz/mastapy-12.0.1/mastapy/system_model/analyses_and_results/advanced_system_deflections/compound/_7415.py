...
class PlanetaryGearSetCompoundAdvancedSystemDeflection(_7380.CylindricalGearSetCompoundAdvancedSystemDeflection):
    """PlanetaryGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7285.PlanetaryGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7285.PlanetaryGearSetAdvancedSystemDeflection]':
