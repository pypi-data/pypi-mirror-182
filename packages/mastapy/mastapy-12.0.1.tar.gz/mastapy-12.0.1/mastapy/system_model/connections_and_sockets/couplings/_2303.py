...
from mastapy.system_model.connections_and_sockets.couplings import _2299
...
class SpringDamperConnection(_2299.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_2158.ComponentDampingOption':
        ...
        return constructor.new_from_mastapy_type(_2158.ComponentDampingOption)(value) if value is not None else None

    @damping_option.setter
    def damping_option(self, value: '_2158.ComponentDampingOption'):
