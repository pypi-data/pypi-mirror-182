...
from mastapy.system_model.part_model import _2414, _2417
...
class PlanetCarrier(_2417.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def load_sharing_settings(self) -> '_2414.LoadSharingSettings':
    ...
    @property
    def planetary_sockets(self) -> 'List[_2241.PlanetarySocket]':
    ...
    def attach_carrier_shaft(self, shaft: '_2435.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2435.Shaft', offset: Optional['float'] = float('nan')):
