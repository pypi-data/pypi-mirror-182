...
from mastapy.system_model.part_model.gears import _2477, _2479, _2478
...
class PlanetaryGearSet(_2478.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    def annuluses(self) -> 'List[_2477.CylindricalGear]':
    ...
    @property
    def planets(self) -> 'List[_2479.CylindricalPlanetGear]':
    ...
    @property
    def suns(self) -> 'List[_2477.CylindricalGear]':
    ...
    def add_annulus(self) -> '_2477.CylindricalGear':
    ...
    def add_planet(self) -> '_2477.CylindricalGear':
    ...
    def add_sun(self) -> '_2477.CylindricalGear':
