...
from mastapy.system_model.part_model.gears import _2492, _2489
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2489.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2492.KlingelnbergCycloPalloidSpiralBevelGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_2273.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
