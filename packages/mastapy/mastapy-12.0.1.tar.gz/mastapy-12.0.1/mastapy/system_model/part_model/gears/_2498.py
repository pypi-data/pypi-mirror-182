...
from mastapy.system_model.part_model.gears import _2497, _2472
...
class StraightBevelDiffGearSet(_2472.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2497.StraightBevelDiffGear]':
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_2278.StraightBevelDiffGearMesh]':
