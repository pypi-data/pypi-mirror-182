...
from mastapy.system_model.part_model.gears import _2505, _2472
...
class ZerolBevelGearSet(_2472.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self) -> 'List[_2505.ZerolBevelGear]':
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_2284.ZerolBevelGearMesh]':
