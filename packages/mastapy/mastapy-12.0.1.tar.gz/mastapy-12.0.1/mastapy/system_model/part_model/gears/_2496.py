...
from mastapy.system_model.part_model.gears import _2495, _2472
...
class SpiralBevelGearSet(_2472.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2495.SpiralBevelGear]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_2276.SpiralBevelGearMesh]':
