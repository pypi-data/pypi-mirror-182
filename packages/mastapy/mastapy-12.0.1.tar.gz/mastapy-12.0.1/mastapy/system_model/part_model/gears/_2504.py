...
from mastapy.system_model.part_model.gears import _2503, _2484
...
class WormGearSet(_2484.GearSet):
    """WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2503.WormGear]':
    ...
    @property
    def worm_meshes(self) -> 'List[_2282.WormGearMesh]':
