...
from mastapy.system_model.part_model.gears import _2471, _2472
...
class BevelDifferentialGearSet(_2472.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2471.BevelGear]':
    ...
    @property
    def bevel_meshes(self) -> 'List[_2256.BevelGearMesh]':
