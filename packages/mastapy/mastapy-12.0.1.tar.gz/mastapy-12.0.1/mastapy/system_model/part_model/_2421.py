...
from mastapy.system_model.import_export import _2194
...
class Part(_2160.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1481.MassProperties':
    ...
    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1481.MassProperties':
    ...
    @property
    def local_connections(self) -> 'List[_2225.Connection]':
    ...
    def connections_to(self, part: 'Part') -> 'List[_2225.Connection]':
    ...
    def copy_to(self, container: '_2387.Assembly') -> 'Part':
    ...
    def create_geometry_export_options(self) -> '_2194.GeometryExportOptions':
