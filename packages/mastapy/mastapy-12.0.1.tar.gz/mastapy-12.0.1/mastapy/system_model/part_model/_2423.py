...
from mastapy.system_model import _2171
...
class PlanetCarrierSettings(_1560.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_2171.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new_from_mastapy_type(_2171.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_2171.PlanetPinManufacturingErrorsCoordinateSystem'):
