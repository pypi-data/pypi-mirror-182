...
from mastapy.system_model.part_model import _2397, _2421
...
class AbstractAssembly(_2421.Part):
    """AbstractAssembly
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2397.Component]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2397.Component]':
