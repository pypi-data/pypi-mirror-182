...
from mastapy.system_model.part_model.couplings import _2529, _2542
...
class BeltDrive(_2429.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2529.BeltDriveType':
        ...
        return constructor.new_from_mastapy_type(_2529.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2529.BeltDriveType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBelt = value

    @property
    def belt_connections(self) -> 'List[_2221.BeltConnection]':
    ...
    @property
    def pulleys(self) -> 'List[_2542.Pulley]':
