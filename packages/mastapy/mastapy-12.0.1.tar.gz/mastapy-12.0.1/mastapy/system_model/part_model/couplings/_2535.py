...
class Coupling(_2429.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self) -> 'List[_2536.CouplingHalf]':
    ...
    @property
    def half_a(self) -> '_2536.CouplingHalf':
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2531.ClutchHalf':
    ...
    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2534.ConceptCouplingHalf':
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2539.CVTPulley':
    ...
    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2541.PartToPartShearCouplingHalf':
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2542.Pulley':
    ...
    @property
    def half_a_of_type_rolling_ring(self) -> '_2548.RollingRing':
    ...
    @property
    def half_a_of_type_spring_damper_half(self) -> '_2553.SpringDamperHalf':
    ...
    @property
    def half_a_of_type_synchroniser_half(self) -> '_2556.SynchroniserHalf':
    ...
    @property
    def half_a_of_type_synchroniser_part(self) -> '_2557.SynchroniserPart':
    ...
    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2558.SynchroniserSleeve':
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2560.TorqueConverterPump':
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2562.TorqueConverterTurbine':
    ...
    @property
    def half_b(self) -> '_2536.CouplingHalf':
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2531.ClutchHalf':
    ...
    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2534.ConceptCouplingHalf':
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2539.CVTPulley':
    ...
    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2541.PartToPartShearCouplingHalf':
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2542.Pulley':
    ...
    @property
    def half_b_of_type_rolling_ring(self) -> '_2548.RollingRing':
    ...
    @property
    def half_b_of_type_spring_damper_half(self) -> '_2553.SpringDamperHalf':
    ...
    @property
    def half_b_of_type_synchroniser_half(self) -> '_2556.SynchroniserHalf':
    ...
    @property
    def half_b_of_type_synchroniser_part(self) -> '_2557.SynchroniserPart':
    ...
    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2558.SynchroniserSleeve':
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2560.TorqueConverterPump':
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2562.TorqueConverterTurbine':
