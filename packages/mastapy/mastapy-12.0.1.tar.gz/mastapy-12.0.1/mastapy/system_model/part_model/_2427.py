...
from mastapy.system_model.part_model.projections import _2438
...
class RootAssembly(_2387.Assembly):
    """RootAssembly
    ...
    @property
    def parallel_part_groups(self) -> 'List[_2443.ParallelPartGroup]':
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2438.SpecifiedParallelPartGroupDrawingOrder]':
