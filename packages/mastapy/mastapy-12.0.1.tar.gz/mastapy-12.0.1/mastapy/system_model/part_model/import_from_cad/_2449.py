...
from mastapy.system_model.part_model.import_from_cad import _2455, _2456
...
class ConnectorFromCAD(_2456.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2455.HousedOrMounted':
        ...
        return constructor.new_from_mastapy_type(_2455.HousedOrMounted)(value) if value is not None else None

    @mounting.setter
    def mounting(self, value: '_2455.HousedOrMounted'):
