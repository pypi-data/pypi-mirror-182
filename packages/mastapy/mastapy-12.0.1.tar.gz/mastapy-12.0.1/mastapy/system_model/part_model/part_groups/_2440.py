...
from mastapy.system_model.part_model.part_groups import _2441, _2439
...
class ConcentricPartGroup(_2439.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2441.ConcentricPartGroupParallelToThis]':
