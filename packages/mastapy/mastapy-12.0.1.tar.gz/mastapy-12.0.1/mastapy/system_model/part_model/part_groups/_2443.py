...
from mastapy.system_model.part_model.part_groups import _2440, _2442, _2439
...
class ParallelPartGroup(_2439.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2440.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2442.DesignMeasurements]':
