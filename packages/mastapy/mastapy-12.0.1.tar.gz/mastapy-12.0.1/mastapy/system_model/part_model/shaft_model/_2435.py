...
class Shaft(_2389.AbstractShaft):
    """Shaft
    ...
    @property
    def guide_image(self) -> '_2409.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2335.FESubstructure':
    ...
    def mount_component(self, component: '_2417.MountableComponent', offset: 'float'):
