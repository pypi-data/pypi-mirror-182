...
from mastapy.system_model.fe import _2339, _2342
...
class FESubstructureWithSelectionForModalAnalysis(_2342.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2339.FESubstructureNodeModeShapes]':
