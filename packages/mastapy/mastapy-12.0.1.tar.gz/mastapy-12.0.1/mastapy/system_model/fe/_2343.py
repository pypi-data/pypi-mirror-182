...
from mastapy.math_utility import _1464
from mastapy.system_model.fe import (
    _2329, _2320, _2321, _2351,
    _2342
)
...
from mastapy.system_model.fe.links import _2372
...
class FESubstructureWithSelectionComponents(_2342.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    def manual_alignment(self) -> '_1464.CoordinateSystemEditor':
    ...
    @property
    def beam_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_204.ElementPropertiesBeam]]':
    ...
    @property
    def component_links(self) -> 'List[_2372.FELinkWithSelection]':
    ...
    @property
    def contact_pairs(self) -> 'List[_2320.ContactPairWithSelection]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_2321.CoordinateSystemWithSelection]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_205.ElementPropertiesInterface]]':
    ...
    @property
    def links_for_electric_machine(self) -> 'List[_2372.FELinkWithSelection]':
    ...
    @property
    def links_for_selected_component(self) -> 'List[_2372.FELinkWithSelection]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_206.ElementPropertiesMass]]':
    ...
    @property
    def materials(self) -> 'List[_2351.MaterialPropertiesWithSelection]':
    ...
    @property
    def other_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_203.ElementPropertiesBase]]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_207.ElementPropertiesRigid]]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_208.ElementPropertiesShell]]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_209.ElementPropertiesSolid]]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_2329.ElementPropertiesWithSelection[_210.ElementPropertiesSpringDashpot]]':
