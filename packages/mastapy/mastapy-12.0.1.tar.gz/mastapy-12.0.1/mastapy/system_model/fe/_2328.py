...
from mastapy.system_model.fe import _2330
...
class ElementFaceGroupWithSelection(_2330.FEEntityGroupWithSelection['_219.CMSElementFaceGroup', '_1223.ElementFace']):
    """ElementFaceGroupWithSelection
