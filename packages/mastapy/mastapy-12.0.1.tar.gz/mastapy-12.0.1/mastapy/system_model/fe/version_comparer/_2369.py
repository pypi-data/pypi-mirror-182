...
from mastapy.math_utility.measured_vectors import _1528, _1526
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1528.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1526.NodeResults':
    ...
    @property
    def original_result(self) -> '_1526.NodeResults':
