...
from mastapy.system_model.fe import _2337
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6903.TorqueRippleInputType':
        ...
        return constructor.new_from_mastapy_type(_6903.TorqueRippleInputType)(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6903.TorqueRippleInputType'):
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7485.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7485.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', node: '_2337.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7485.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', node: '_2337.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7485.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType') -> '_1484.MultipleFourierSeriesInterpolator':
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', node: '_2337.FESubstructureNode') -> '_1484.MultipleFourierSeriesInterpolator':
        """ 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
