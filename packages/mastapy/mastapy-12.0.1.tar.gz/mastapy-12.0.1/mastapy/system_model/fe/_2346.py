...
from mastapy.system_model.fe import _2352, _2342
...
class FESubstructureWithSelectionForStaticAnalysis(_2342.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2352.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2352.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1528.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1528.VectorWithLinearAndAngularComponents]':
