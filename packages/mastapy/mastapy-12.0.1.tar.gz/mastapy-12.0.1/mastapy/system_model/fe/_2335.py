...
from mastapy.system_model.fe import (
    _2309, _2315, _2363, _2340,
    _2311, _2336, _2347, _2333,
    _2348, _2337, _2361, _2343,
    _2344, _2345, _2346
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2397, _2401, _2406
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1576
from mastapy._internal.python_net import python_net_import
from mastapy.nodal_analysis import (
    _70, _84, _60, _66
)
from mastapy.materials import _231, _277
from mastapy.system_model import _2176
...
from mastapy.system_model.fe.links import _2370
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2309.AlignmentMethod':
        ...
        return constructor.new_from_mastapy_type(_2309.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2309.AlignmentMethod'):
    ...
    @property
    def bearing_node_alignment(self) -> '_2315.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2315.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2315.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2311.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2176.RelativeComponentAlignment[_2397.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2397.Component](temp) if temp is not None else None
    ...
    @property
    def coordinate_system(self) -> '_1463.CoordinateSystem3D':
    ...
    @property
    def export(self) -> '_2336.FESubstructureExportOptions':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2347.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2333.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2348.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2370.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2435.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2361.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1528.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1528.VectorWithLinearAndAngularComponents]':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2343.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2344.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2345.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2346.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7484.TaskProgress'] = None):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1576.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1576.Unit', force_unit: '_1576.Unit'):
    ...
    def links_for(self, node: '_2337.FESubstructureNode') -> 'List[_2370.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7484.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1576.Unit', file_name: 'str'):
