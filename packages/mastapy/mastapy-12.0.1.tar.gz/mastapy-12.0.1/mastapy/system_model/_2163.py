...
from mastapy.system_model import _2164, _2168
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def design_state_destinations(self) -> 'List[_2164.DutyCycleImporterDesignEntityMatch[_5600.DesignState]]':
    ...
    @property
    def duty_cycles_to_import(self) -> 'List[_2168.IncludeDutyCycleOption]':
    ...
    @property
    def point_load_destinations(self) -> 'List[_2164.DutyCycleImporterDesignEntityMatch[_2424.PointLoad]]':
    ...
    @property
    def power_load_destinations(self) -> 'List[_2164.DutyCycleImporterDesignEntityMatch[_2425.PowerLoad]]':
