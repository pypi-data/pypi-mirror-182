...
from mastapy.utility.model_validation import _1760, _1759
...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_2156.Design':
    ...
    @property
    def all_status_errors(self) -> 'List[_1760.StatusItem]':
    ...
    @property
    def user_specified_data(self) -> '_1707.UserSpecifiedData':
