...
class LubricationDetail(_1793.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def density_vs_temperature(self) -> '_1498.Vector2DListAccessor':
    ...
    def density_vs_temperature(self, value: '_1498.Vector2DListAccessor'):
