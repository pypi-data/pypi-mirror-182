...
from mastapy.math_utility.optimisation import _1522, _1521
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self) -> '_1554.IntegerRange':
    ...
    def integer_range(self, value: '_1554.IntegerRange'):
    ...
    @range.setter
    def range(self, value: '_1453.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def specification_type(self) -> '_1522.TargetingPropertyTo':
        ...
        return constructor.new_from_mastapy_type(_1522.TargetingPropertyTo)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1522.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1521.SpecifyOptimisationInputAs':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1521.SpecifyOptimisationInputAs)(value) if value is not None else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1521.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
