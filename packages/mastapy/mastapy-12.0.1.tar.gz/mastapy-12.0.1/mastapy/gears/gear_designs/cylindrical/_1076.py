...
class ToothFlankFractureAnalysisSettings(_1552.IndependentReportablePropertiesBase['ToothFlankFractureAnalysisSettings']):
    """ToothFlankFractureAnalysisSettings
    ...
    @property
    def measured_residual_stress_profile_property(self) -> '_1498.Vector2DListAccessor':
    ...
    def measured_residual_stress_profile_property(self, value: '_1498.Vector2DListAccessor'):
