...
class PocketingPowerLossCoefficients(_1793.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1530.GriddedSurfaceAccessor':
    ...
    def raw_pocketing_power_loss_lookup_table(self, value: '_1530.GriddedSurfaceAccessor'):
