...
from mastapy.utility.report import _1715, _1739
...
class CustomReportChartItem(_1739.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self) -> '_1715.SMTChartPointShape':
        ...
        return constructor.new_from_mastapy_type(_1715.SMTChartPointShape)(value) if value is not None else None

    @point_shape.setter
    def point_shape(self, value: '_1715.SMTChartPointShape'):
