...
from mastapy.utility.report import _1751, _1744
...
class UserTextRow(_1744.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self) -> '_1751.HeadingSize':
        ...
        return constructor.new_from_mastapy_type(_1751.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1751.HeadingSize'):
