...
from mastapy.utility import _1564
...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1564.RoundingMethods':
        ...
        return constructor.new_from_mastapy_type(_1564.RoundingMethods)(value) if value is not None else None

    @rounding_method.setter
    def rounding_method(self, value: '_1564.RoundingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RoundingMethod = value

    @property
    def current_unit(self) -> '_1576.Unit':
    ...
    @property
    def available_units(self) -> 'List[_1576.Unit]':
