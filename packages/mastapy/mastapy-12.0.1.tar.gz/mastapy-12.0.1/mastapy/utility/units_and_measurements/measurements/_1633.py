...
class LengthShort(_1571.MeasurementBase):
    """LengthShort
    ...
    @property
    def micrometres(self) -> '_1576.Unit':
    ...
    @property
    def millimetres(self) -> '_1576.Unit':
    ...
    @property
    def thousandths_of_an_inch(self) -> '_1576.Unit':
