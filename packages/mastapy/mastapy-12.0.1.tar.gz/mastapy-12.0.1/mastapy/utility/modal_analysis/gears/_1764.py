...
from mastapy.utility.modal_analysis.gears import _1765, _1768, _1770
...
class GearOrderForTE(_1770.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self) -> '_1765.GearPositions':
        ...
        return constructor.new_from_mastapy_type(_1765.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1768.OrderForTE]':
