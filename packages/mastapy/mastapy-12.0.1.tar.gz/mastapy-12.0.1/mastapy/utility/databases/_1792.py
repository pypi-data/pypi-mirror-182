...
from mastapy.utility.databases import _1793, _1795, _1794
...
TValue = TypeVar('TValue', bound='_1793.NamedDatabaseItem')


class NamedDatabase(_1795.SQLDatabase['_1794.NamedKey', 'TValue'], Generic[TValue]):
    """NamedDatabase
    ...
    def duplicate(self, new_name: 'str', item: '_1793.NamedDatabaseItem') -> '_1793.NamedDatabaseItem':
    ...
    def rename(self, item: '_1793.NamedDatabaseItem', new_name: 'str') -> 'bool':
