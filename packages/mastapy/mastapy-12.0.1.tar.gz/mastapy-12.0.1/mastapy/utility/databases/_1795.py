...
from mastapy.utility.databases import _1788, _1790
...
TKey = TypeVar('TKey', bound='_1790.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1788.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    """SQLDatabase
