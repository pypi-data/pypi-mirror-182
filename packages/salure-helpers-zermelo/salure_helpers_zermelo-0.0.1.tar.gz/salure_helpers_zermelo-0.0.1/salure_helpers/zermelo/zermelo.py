...
class Zermelo:
    def __init__(self, salureconnect_connection: SalureConnect, label: Union[str, List], storage_location, initial_zermelo_extract=False, extract_cancelled_appointments=True):
        """
        ...
        credentials = self.salureconnect_connection.get_system_credential(system='zermelo', label=label)
