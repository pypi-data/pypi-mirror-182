        ...
        cfn_access_point = s3objectlambda.CfnAccessPoint(self, "MyCfnAccessPoint",
            object_lambda_configuration=s3objectlambda.CfnAccessPoint.ObjectLambdaConfigurationProperty(
                ...
                transformation_configurations=[s3objectlambda.CfnAccessPoint.TransformationConfigurationProperty(
                    actions=["actions"],
                    content_transformation=s3objectlambda.CfnAccessPoint.ContentTransformationProperty(
    ...
    class TransformationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            content_transformation: typing.Union[_aws_cdk_core_f4b25747.IResolvable, typing.Union["CfnAccessPoint.ContentTransformationProperty", typing.Dict[builtins.str, typing.Any]]],
        ) -> None:
        ...
        def content_transformation(
            self,
        ) -> typing.Union[_aws_cdk_core_f4b25747.IResolvable, "CfnAccessPoint.ContentTransformationProperty"]:
            ...
            return typing.cast(typing.Union[_aws_cdk_core_f4b25747.IResolvable, "CfnAccessPoint.ContentTransformationProperty"], result)
