...
async def search_players(position: str, age_min: int = 18, age_max: int = 35, mv_min: int = 0,
                         mv_max: int = 5000000, countries: str = None,
                         place_of_birth: str = None, contract_expires_year: int = None):
    return {Keys.DATA_TYPE: Keys.PLAYERS,
            Keys.DATA:
                PlayersModel.Meta.database.get_data(
                    query=Players.search_players(position=position, age_min=age_min, age_max=age_max,
                                                 ...
                                                 contract_expires_year=contract_expires_year))[0],
            Keys.STATUS_CODE: 200}
