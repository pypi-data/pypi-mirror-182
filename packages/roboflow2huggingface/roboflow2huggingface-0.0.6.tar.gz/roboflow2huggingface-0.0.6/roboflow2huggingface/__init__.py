...
from .other_utils import extract_random_test_images_from_zip
...
def roboflow_to_huggingface_pipeline(
    ...
    random_test_image_sample_num: int = 3,
    random_test_image_export_dir: str = None,
):
    """
    ...
    if random_test_image_export_dir is not None:
        extract_random_test_images_from_zip(
            local_data_dir=local_data_dir, 
            export_dir=random_test_image_export_dir,
            num_samples=random_test_image_sample_num,
        )
