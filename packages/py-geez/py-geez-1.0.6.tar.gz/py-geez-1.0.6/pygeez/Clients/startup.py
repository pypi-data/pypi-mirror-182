...
#
# This file is a part of < https://github.com/vckyou/Ayiin-Userbot >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/vckyou/Ayiin-Userbot/blob/main/LICENSE/>.
#
# FROM Ayiin-Userbot <https://github.com/vckyou/Ayiin-Userbot>
...
from pygeez.config import Var as Variable
...
async def geez_client(client):
    try:
        ...
        await client.join_chat("GeezProject")
        await client.join_chat("RamSupport")
    except Exception:
        pass
