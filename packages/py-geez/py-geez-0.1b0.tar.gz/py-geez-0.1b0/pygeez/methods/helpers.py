...
class Helpers(object):
    ...
    def gen_chlog(self, repo, diff):
        ...
        ch_log = tldr_log = ""
        ch = f"<b>Ayiin Ubot {geez_ver} updates for <a href={UPSTREAM_REPO_URL}/tree/{ac_br}>[{ac_br}]</a>:</b>"
        ch_tl = f"Ayiin Ubot {geez_ver} updates for {ac_br}:"
        d_form = "%d/%m/%y || %H:%M"
