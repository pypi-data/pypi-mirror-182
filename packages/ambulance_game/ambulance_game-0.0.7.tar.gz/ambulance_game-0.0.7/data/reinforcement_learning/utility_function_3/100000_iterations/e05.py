"""Reinforcement learning algorithm with e = 0.5"""
import copy
...
for _ in range(num_of_iterations):
    ...
    output_to_file(str(server_utilities), "e05/utilities.csv")
    str_rates = str([list(rates[server].values()) for server in rates])
    output_to_file(str_rates, "e05/rates.csv")
