...
class CapacitiesApi(object):
    ...
    def get_capacities(self, delivery_area, delivery_from, delivery_to, **kwargs):  # noqa: E501
        ...
        :param delivery_area: The EIC codes of the outgoing delivery area(s). Filter is applied to \"from_delivery_area\". (required)
        ...
        :param delivery_area_to: The EIC codes of the incoming delivery area(s). Filter is applied to \"to_delivery_area\".
