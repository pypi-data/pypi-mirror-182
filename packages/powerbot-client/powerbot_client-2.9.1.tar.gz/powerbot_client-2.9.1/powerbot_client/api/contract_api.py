...
class ContractApi(object):
    ...
    def get_contract_history_with_http_info(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_contract_history`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_order_books_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 500:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_order_books`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
    ...
    def get_public_trades_with_http_info(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_public_trades`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
