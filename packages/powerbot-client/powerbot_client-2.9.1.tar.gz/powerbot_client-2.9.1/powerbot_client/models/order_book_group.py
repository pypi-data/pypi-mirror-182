...
class OrderBookGroup(object):
    ...
    def __init__(self, message_class=None, emitted_at=None, best_price_changed=None, changed_contract=None, related_contracts=None, local_vars_configuration=None):  # noqa: E501
