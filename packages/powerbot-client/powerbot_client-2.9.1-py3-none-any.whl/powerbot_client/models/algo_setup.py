...
class AlgoSetup(object):
    ...
    def __init__(self, id=None, name=None, description=None, require_heartbeat_every_seconds=None, on_missing_heartbeat=None, image=None, parameter_schema_name=None, parameter_schema_version=None, local_vars_configuration=None):  # noqa: E501
