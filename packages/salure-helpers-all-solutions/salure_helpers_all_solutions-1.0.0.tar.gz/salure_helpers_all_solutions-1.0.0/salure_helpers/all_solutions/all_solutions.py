...
class AllSolutions:
    def __init__(self, salureconnect_connection: SalureConnect, label: Union[str, List]):
        self.salureconnect_connection = salureconnect_connection
        self.token = None
        self.refresh_token = None
        self.debug = False
        credentials = self.salureconnect_connection.get_system_credential(system='all-solutions', label=label)
