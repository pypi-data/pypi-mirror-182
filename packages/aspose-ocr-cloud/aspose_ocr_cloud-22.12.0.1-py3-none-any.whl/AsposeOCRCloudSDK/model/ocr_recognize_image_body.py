...
class OCRRecognizeImageBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsRecognizeImage']:
                return OCRSettingsRecognizeImage
            __annotations__ = {
                "image": image,
                "settings": settings,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeImage': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeImage': ...
