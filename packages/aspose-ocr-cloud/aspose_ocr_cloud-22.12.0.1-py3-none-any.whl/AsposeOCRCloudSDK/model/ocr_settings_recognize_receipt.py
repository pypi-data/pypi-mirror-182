...
from AsposeOCRCloudSDK import schemas  # noqa: F401


class OCRSettingsRecognizeReceipt(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class regions(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OCRRegion'], typing.List['OCRRegion']],
                ...
                def __getitem__(self, i: int) -> 'OCRRegion':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["language"], typing_extensions.Literal["makeSkewCorrect"], typing_extensions.Literal["makeSpellCheck"], typing_extensions.Literal["makeContrastCorrection"], typing_extensions.Literal["makeBinarization"], typing_extensions.Literal["makeUpsampling"], typing_extensions.Literal["dsrMode"], typing_extensions.Literal["dsrConfidence"], typing_extensions.Literal["resultType"], typing_extensions.Literal["resultTypeTable"], typing_extensions.Literal["regions"], ]):
