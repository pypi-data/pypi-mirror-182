...
class OCRRecognizeReceiptBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsRecognizeReceipt']:
                return OCRSettingsRecognizeReceipt
            __annotations__ = {
                "image": image,
                "settings": settings,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeReceipt': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeReceipt': ...
