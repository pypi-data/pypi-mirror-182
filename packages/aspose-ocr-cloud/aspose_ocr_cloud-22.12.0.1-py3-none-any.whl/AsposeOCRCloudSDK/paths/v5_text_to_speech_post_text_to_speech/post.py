...
# body param
SchemaForRequestBodyApplicationJson = TTSBody
...
class BaseApi(api_client.Api):
    ...
    def _post_text_to_speech_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tts_body.serialize(body, content_type)
...
class PostTextToSpeech(BaseApi):
    ...
    def post_text_to_speech(
        ...
        return self._post_text_to_speech_oapg(
            body=body,
