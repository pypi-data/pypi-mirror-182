...
from sarus_data_spec.scalar import PrivacyProfile, privacy_budget
...
def attach_variant(
    ...
    attach_properties(
        ...
        properties={
            ...
            sp.ConstraintKind.Name(sp_kind): variant.uuid(),
            VARIANT_UUID: variant.uuid(),
        },
        name=sp.ConstraintKind.Name(sp_kind),
    )
