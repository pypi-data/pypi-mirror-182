...
from benchling_sdk.services.v2.beta.v2_beta_user_service import V2BetaUserService
...
class V2BetaService(BaseService):
    ...
    _user_service: V2BetaUserService
    ...
    def __init__(self, client: Client, retry_strategy: RetryStrategy = RetryStrategy()):
        ...
        self._user_service = V2BetaUserService(beta_client, retry_strategy)
    ...
    @property
    def users(self) -> V2BetaUserService:
        """
        V2-Beta Benchling Users.
