...
from benchling_api_client.webhooks.v0.alpha.models.webhook_envelope import (  # type: ignore
    WebhookEnvelope as WebhookEnvelopeAlpha,
)
from benchling_api_client.webhooks.v0.beta.models.webhook_envelope import (  # type: ignore
...
class App(Generic[ConfigType]):
    ...
    def create_session_context(
        ...
        return new_session_context(self, label, timeout_seconds, context_enter_handler, context_exit_handler)
