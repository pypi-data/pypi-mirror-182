...
this module needs user to be introduced to the bot by using the ``met`` 
command::

|
| op met ~bart@127.0.0.1 
|

if userhost checking is not wanted one can disable it with the ``cfg``
command::
...
from op.obj import locked, register
