...
/* harmony import */ var _icons_vm_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../icons/vm.svg */ "./icons/vm.svg");
/* harmony import */ var _icons_book_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icons/book.svg */ "./icons/book.svg");
/* harmony import */ var _icons_watch_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../icons/watch.svg */ "./icons/watch.svg");
/* harmony import */ var _icons_repo_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../icons/repo.svg */ "./icons/repo.svg");
/* harmony import */ var _icons_tag_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../icons/tag.svg */ "./icons/tag.svg");
/* harmony import */ var _icons_history_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../icons/history.svg */ "./icons/history.svg");
/* harmony import */ var _icons_source_control_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../icons/source-control.svg */ "./icons/source-control.svg");
...
const createdIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'created',
    svgstr: _icons_book_svg__WEBPACK_IMPORTED_MODULE_3__["default"]
});
const timeoutIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'timeout',
    svgstr: _icons_watch_svg__WEBPACK_IMPORTED_MODULE_4__["default"]
});
const repoIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'repo',
    svgstr: _icons_repo_svg__WEBPACK_IMPORTED_MODULE_5__["default"]
});
const sourceControlIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'source-control',
    svgstr: _icons_source_control_svg__WEBPACK_IMPORTED_MODULE_6__["default"]
});
const codespaceNameIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'codespaceName',
    svgstr: _icons_tag_svg__WEBPACK_IMPORTED_MODULE_7__["default"]
});
const machineIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'machine-details',
    svgstr: _icons_vm_svg__WEBPACK_IMPORTED_MODULE_8__["default"]
});
const retentionIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.LabIcon({
    name: 'retention-period',
    svgstr: _icons_history_svg__WEBPACK_IMPORTED_MODULE_9__["default"]
});
class CodespaceMenu extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { className: "info-title" }, "GITHUB CODESPACES"),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(repoIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null, this.data.repo_name)),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(codespaceNameIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null, this.data.codespace_name)),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(sourceControlIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    ...
                    "\u2191")),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(machineIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null, this.data.machine)),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(timeoutIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    "Idle timeout ",
                    this.data.idle_timeout_minutes,
                    " minutes")),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(createdIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    "Created ",
                    this.data.created_days_ago,
                    " days ago")),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "info-line" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(retentionIcon.react, { className: "info-icon" }),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    "Retention period ",
...
const plugin = {
    ...
    activate: (app, shell) => {
        console.log('JupyterLab extension codespaces-jupyterlab is activated! ', app);
...
//# sourceMappingURL=lib_index_js.6808e34d5141cf723f10.js.map