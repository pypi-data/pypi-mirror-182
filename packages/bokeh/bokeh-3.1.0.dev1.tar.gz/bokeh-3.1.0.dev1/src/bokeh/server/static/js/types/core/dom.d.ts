...
declare type WhitespaceKeys = "Tab" | "Enter" | " ";
declare type UIKeys = "Escape";
declare type NavigationKeys = "Home" | "End" | "PageUp" | "PageDown" | "ArrowLeft" | "ArrowRight" | "ArrowUp" | "ArrowDown";
declare type EditingKeys = "Backspace" | "Delete";
export declare type Keys = WhitespaceKeys | UIKeys | NavigationKeys | EditingKeys;
...
export declare type StyleSheetLike = StyleSheet | string;
