...
export declare type ImageScalar = {
...
export declare type ImageVector = {
...
export declare type AboveFill = Prefixed<"above", Fill>;
export declare type AboveHatch = Prefixed<"above", Hatch>;
export declare type BelowFill = Prefixed<"below", Fill>;
export declare type BelowHatch = Prefixed<"below", Hatch>;
...
declare type Mixins = Text | Line | Fill | Hatch | Image;
