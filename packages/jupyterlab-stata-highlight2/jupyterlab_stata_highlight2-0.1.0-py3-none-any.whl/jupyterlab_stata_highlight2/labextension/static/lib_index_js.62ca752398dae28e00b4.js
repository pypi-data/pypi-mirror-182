"use strict";
(self["webpackChunkjupyterlab_stata_highlight2"] = self["webpackChunkjupyterlab_stata_highlight2"] || []).push([["lib_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _stata_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stata.js */ "./lib/stata.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([
  {
    ...
    activate: function (app, codeMirror) {
      ...
      codeMirror.CodeMirror.defineSimpleMode("stata", _stata_js__WEBPACK_IMPORTED_MODULE_1__.stata_mode);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "stata_mode": () => (/* binding */ stata_mode)
/* harmony export */ });
...
const stata_mode = {
  ...
  start: [
    ...
    {regex: /\/\*/, token: color_translator['comment'], push: 'comments_block'},
    ...
    {regex: /\$/, token: color_translator['variable-2'], push: 'macro_global'},
    ...
    {regex: new RegExp('\\s' + builtins_str + '(?![\\(\\w])'), token: color_translator['keyword']},
    {regex: new RegExp(builtins_str + '\\b'), token: color_translator['keyword'], sol: true},

    {regex: new RegExp('(\\W)' + builtins_fun_str), token: [null, color_translator['def']]},
  ...
  comments_block: [
    ...
    {regex: /(\*\/\s+\*(?!\/)[^\n]*)|(\*\/)/, token: color_translator['comment'], pop: true},
  ...
  macro_global: [
    {regex: /\}/, token: color_translator['variable-2'], pop: true},
    {regex: /.(?=[^\w\{\}])/, token: color_translator['variable-2'], pop: true},
    {regex: /./, token: color_translator['variable-2']},
  ],
  meta: {
    closeBrackets: {pairs: "()[]{}`'\"\""},
...
//# sourceMappingURL=lib_index_js.62ca752398dae28e00b4.js.map