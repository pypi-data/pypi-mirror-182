...
class REmail(object):
    ...
    def __init__(
        ...
        check_parm(to_email, str, "_iterable", None)
        check_parm(cc_email, str, "_iterable", None)
        check_parm(display_from_email, str, None)
        check_parm(display_to_email, str, "_iterable", None)
        check_parm(display_cc_email, str, "_iterable", None)
