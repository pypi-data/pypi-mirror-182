...
class RConn(object):
    ...
    def fetch_table(self, data: "LegacyCursorResult | iter", fields: "iter"=None) -> "list[dict,]":
        ...
        check_parm(data, LegacyCursorResult, "_iterable")
        check_parm(fields, "_iterable", None)
    ...
    def execute_select(
        ...
        check_parm(database, str, None)
        check_parm(fields, str, "_iterable", None)
        check_parm(where, str, None)
        check_parm(order, str, None)
        check_parm(limit, int, str, "_iterable", None)
        check_parm(print_sql, bool)
