...
print(crayons.cyan(f'Encore quelques secondes mon ptit charo...'))
...
class SekkayBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.blacklist_invite = 'SekkayBot','COUSINFN',"Zeeih","Samsodierr"
    ...
    async def add_list(self) -> None:
        try:
            await self.add_friend('7b7217923de9400da54e1349b4d8e629')
        except: pass    
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def update_settings(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://samutpc.teampnglol.repl.co/default.json"
            ) as r:
                data = await r.json()
