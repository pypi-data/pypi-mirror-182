...
Repo = collections.namedtuple(
    'Repo', 'nickname package_name git_repo settings_module front_end internal_deps')
REPOS_DICT = {}
KNOWN_REPOS = []

def add(nickname, package_name, git_repo='', settings_module='', front_end='', internal_deps=[]):
    if isinstance(internal_deps, str):
        internal_deps = internal_deps.split()
    t = Repo(nickname, package_name, git_repo, settings_module, front_end, internal_deps)
