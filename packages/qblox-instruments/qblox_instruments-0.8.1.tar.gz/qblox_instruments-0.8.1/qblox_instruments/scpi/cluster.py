...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.3.0 fwBuild=08/12/2022-11:14:46 fwHash=0x2CC18B28 fwDirty=0 kmodVersion=0.3.0 kmodBuild=08/12/2022-11:14:46 kmodHash=0x2CC18B28 kmodDirty=0 swVersion=0.3.0 swBuild=08/12/2022-11:14:46 swHash=0x2CC18B28 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=08/12/2022-11:14:46 cfgManHash=0x2CC18B28 cfgManDirty=0"
            if build != build_ref:
