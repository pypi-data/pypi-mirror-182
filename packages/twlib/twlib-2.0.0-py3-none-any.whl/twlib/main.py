...
def epoch2dt(
    ...
    """Convert epoch in ms (UTC) to datetime"""
    if to_local:
...
def dt2epoch(
    ...
    """Convert naive local datetime string to epoch in ms (UTC)"""
    if is_local:
...
def revert_lks(
    ...
    """Replace symlinks in given directory with assocarted files/directories."""
