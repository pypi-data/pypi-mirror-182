...
setup(
    ...
    name="samcarswell-test",  # Required
    ...
    description="A CLI to interact with samcarswell-test",  # Optional
    ...
    url="https://github.com/samcarswell-test/samcarswell-test-cli",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="samcarswell-test Dev Team",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="dev@samcarswell-test.net.au",  # Optional
    ...
    # TODO: update this
    entry_points={
        "console_scripts": ["samcarswell-test=src.main:main"]
    },  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/samcarswell-test/samcarswell-test2-cli/issues",
        "Source": "https://github.com/samcarswell-test/samcarswell-test2-cli/",
    },
)
