...
OSPRay can render scenes with ambient occlusion lighting, semi-transparent objects, and depth-of-field focal blur. For technical details of the supported rendering algorithms and parameters, see the `www.ospray.org <https://www.ospray.org>`__ website. See also the corresponding user manual page for more information on this rendering engine."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        self.ambient_brightness: float
        'Controls the radiance of the ambient light. \n\n:Default: ``0.8``'
        self.ambient_light_enabled: bool
        ...
        self.direct_light_angular_diameter: float
        ...
        self.direct_light_enabled: bool
...
See the documentation of the :py:attr:`property` parameter for more information."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.legend_size: float
        'Controls the overall size of the color bar relative to the output image size. \n\n:Default: ``0.3``'
        self.modifier: Optional[ovito.modifiers.ColorCodingModifier]
        ...
        self.orientation: PySide6.QtCore.Orientation
        ...
        self.color_mapping_source: DataVis
...
Members:
  ...
  Solid"""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.axis4_enabled: bool
        'Enables the display of the fourth axis.\n\n:Default: ``False``'
        self.axis4_label: str
        ...
        self.style: CoordinateTripodOverlay.Style
...
:return: The computed screen-space size measured in pixels."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        self.function: Callable[[PythonViewportOverlay.Arguments], Optional[Generator[str | float, None, None]]]
...
Text labels can display dynamically computed values. See the :py:attr:`text` property for an example."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.outline_enabled: bool
        'Enables the painting of a font outline to make the text easier to read.\n\n:Default: ``False``'
        self.source_pipeline: Optional[ovito.pipeline.Pipeline]
...
Members:
  ...
  ByParticle"""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.coloring_mode: BondsVis.ColoringMode
...
Members:
  ...
  Region"""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.cap_transparency: float
        'The level of transparency of the displayed cap polygons. The valid range is 0.0 -- 1.0  (fully opaque to fully transparent).\n\n:Default: ``0.0``'
        self.clip_at_domain_boundaries: bool
        'Controls whether the mesh gets clipped at *non-periodic* cell boundaries during visualization. This option plays a role only if the mesh extends beyond the boundaries of the finite :py:class:`SimulationCell` representing the :py:attr:`domain` of the :py:class:`SurfaceMesh`; it does *not* apply to intersections of the surface with periodic boundaries of the simulation cell (see :py:attr:`pbc`), at which the surface mesh always gets wrapped around back into primary cell image for visualization. \n\nIf the mesh extends beyond the (non-periodic) domain boundaries, you can use this option to restrict the display of the mesh to those parts that are located inside the domain. \n\n:Default: ``False``'
        self.color_mapping_gradient: ovito.modifiers.ColorCodingModifier.Gradient
        ...
        self.color_mapping_interval: Tuple[float, float]
        ...
        self.color_mapping_mode: SurfaceMeshVis.ColorMappingMode
        ...
        self.color_mapping_property: str
        ...
        self.surface_transparency: float
...
Members:
  ...
  Head"""
    ...
    def __init__(self, **kwargs: Any) -> None:
        self.alignment: VectorVis.Alignment
