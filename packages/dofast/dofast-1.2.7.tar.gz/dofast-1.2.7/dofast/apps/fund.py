...
class Fund(object):
    ...
    def get_share_detail(self):
        ...
        s = requests.Session()
        res = s.post(
            'http://tradeapilvs.1234567.com.cn/User/home/GetMyAssetDetails',
            data=params,
            headers=headers)
...
class FundMonitor(CliCommand):
    HELP_DOC = """fund"""
    
    def __init__(self, *args):
        self.name = 'fund monitor'
        self.args = args
...
class FundFactory(object):
    def inspect_command(self):
        return FundMonitor.HELP_DOC
    
    def create_command(self, *args):
        return FundMonitor(*args)
