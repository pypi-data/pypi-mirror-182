# -*- coding: utf-8 -*-
"""
Supports loading data from files generated using Naval Research Laboratory
 SAMI (SAMI is Another Model of the Ionosphere) model.
The SAMI file is a netCDF file with multiple dimensions for some variables.
...
def load(fnames, tag=None, sat_id=None, **kwargs):
    ...
    **kwargs : extra keywords
    ...
    --------
    ::
        inst = pysat.Instrument('NRL', 'SAMI')
        inst.load(2019,1)
    ...
    # these attributes will be transferred to the Instrument object
...
def list_files(tag=None, sat_id=None, data_path=None, format_str=None):
    """Produce a list of files corresponding to NRL SAMI.
    ...
    if format_str is None:
        # default file naming
        format_str = 'u1p_{year:4d}{day:03d}.nc'
...
def download(date_array, tag, sat_id, data_path=None, user=None, password=None,
             **kwargs):
    """Placeholder for NRL SAMI downloads. Doesn't do anything.
