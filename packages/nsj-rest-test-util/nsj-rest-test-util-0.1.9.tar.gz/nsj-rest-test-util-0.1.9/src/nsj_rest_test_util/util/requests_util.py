...
class RequestsUtil():
    ...
    @staticmethod
    def get(url, data=None, params: dict = None, headers: dict = {},
            param_mode: ParamMode = ParamMode.QUERY, has_authorization:bool = False) -> requests.Response:
    ...
    @staticmethod
    def delete(url, data=None, params: dict = None, headers: dict = {},
            param_mode: ParamMode = ParamMode.QUERY, has_authorization:bool = False) -> requests.Response:
    ...
    @staticmethod
    def post(url, data: dict = None, params: dict = None, headers: dict = {}, has_authorization:bool = False) -> requests.Response:
    ...
    @staticmethod
    def put(url, data: dict = None, params: dict = None, headers: dict = {}, has_authorization:bool = False) -> requests.Response:
