...
install_requires = \
['click>=8.0.1', 'httpx>=0.23.1,<0.24.0', 'pydantic>=1.10.2,<2.0.0']

entry_points = \
{'console_scripts': ['checkedid-python-client = checkedid.__main__:main']}
...
setup_kwargs = {
    ...
    'url': 'https://github.com/foarsitter/checkedid-python-client',
