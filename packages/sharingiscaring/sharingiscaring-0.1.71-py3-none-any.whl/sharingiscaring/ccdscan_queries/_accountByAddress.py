...
class Mixin:
    ...
    def ql_request_delegators_for_lookup_using_edges(self, baker_id: str, before_cursor: str = None, after: str = None):
        query = "query {"
        ...
        try:
            r = requests.post(self.graphql_url, json={'query': query})
            if r.status_code == 200:
                return r.json()['data']['bakerByBakerId']['state']['pool']['delegators']['edges'], \
