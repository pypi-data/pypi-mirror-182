...
import aws_cdk.aws_synthetics_alpha as _aws_cdk_aws_synthetics_alpha_f2a55805
import constructs as _constructs_77d1e7e8


class ApiCanary(
    _aws_cdk_aws_synthetics_alpha_f2a55805.Canary,
    ...
    def __init__(
        ...
        *,
        ...
        artifacts_bucket_location: typing.Optional[typing.Union[_aws_cdk_aws_synthetics_alpha_f2a55805.ArtifactsBucketLocation, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        schedule: typing.Optional[_aws_cdk_aws_synthetics_alpha_f2a55805.Schedule] = None,
...
class ApiCanaryProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(artifacts_bucket_location, dict):
            artifacts_bucket_location = _aws_cdk_aws_synthetics_alpha_f2a55805.ArtifactsBucketLocation(**artifacts_bucket_location)
    ...
    def artifacts_bucket_location(
        self,
    ) -> typing.Optional[_aws_cdk_aws_synthetics_alpha_f2a55805.ArtifactsBucketLocation]:
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_synthetics_alpha_f2a55805.ArtifactsBucketLocation], result)
    ...
    def schedule(
        self,
    ) -> typing.Optional[_aws_cdk_aws_synthetics_alpha_f2a55805.Schedule]:
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_synthetics_alpha_f2a55805.Schedule], result)
...
class ApplicationLoadBalancedCodeDeployedFargateService(
    ...
    def health_alarm(self) -> _aws_cdk_aws_cloudwatch_ceddda9d.IAlarm:
        '''(experimental) Composite alarm for monitoring health of service.

        :stability: experimental
        '''
        return typing.cast(_aws_cdk_aws_cloudwatch_ceddda9d.IAlarm, jsii.get(self, "healthAlarm"))

    @health_alarm.setter
    def health_alarm(self, value: _aws_cdk_aws_cloudwatch_ceddda9d.IAlarm) -> None:
        if __debug__:
