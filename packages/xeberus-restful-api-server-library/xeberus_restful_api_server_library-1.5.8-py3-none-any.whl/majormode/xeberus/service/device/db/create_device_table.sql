...
CREATE TABLE device (
  ...
  /**
   * Current status of this mobile device:
   *
...
CREATE TABLE device_battery_event (
  ...
  */
  ...
  /**
   * The reference of this event as given by the client application running
   * on the mobile device that reported this event.
   *
