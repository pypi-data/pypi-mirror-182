...
def is_datetimelike(dt):
    return dt in dolphindb_temporal_types
...
def to_dolphindb_type_string(dtype, to_lower=False):
    ...
    if np_dtype is np.dtype('bool'):
        typestr = "BOOL"
    elif np_dtype is np.dtype('int8'):
        typestr = "CHAR"
    elif np_dtype is np.dtype('int16'):
        typestr = "SHORT"
    elif np_dtype is np.dtype('int32'):
        typestr = "INT"
    elif np_dtype is np.dtype('int64'):
        typestr = "LONG"
    elif np_dtype is np.dtype('float32'):
        typestr = "FLOAT"
    elif np_dtype is np.dtype('float64'):
        typestr = "DOUBLE"
    elif np_dtype is np.dtype(str):
        typestr = "STRING"
    elif dtype == "category":
        typestr = "SYMBOL"
    ...
    return typestr.lower() if to_lower else typestr
