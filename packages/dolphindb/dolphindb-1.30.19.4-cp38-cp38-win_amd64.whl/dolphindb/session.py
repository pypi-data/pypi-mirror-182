...
import warnings
from dolphindb.table import Table, _generate_tablename, _generate_dbname
...
class DBConnectionPool(object):
    ...
    """
    def __init__(self, host:str, port:int, threadNum:int=10, userid:str=None, password:str=None, loadBalance:bool=False, highAvailability:bool=False, compress:bool=False,
                 reConnect:bool=False, python:bool=False):
    ...
    def addTask(self, script:str, taskId:int, clearMemory:bool = True):
...
class session(object):
    ...
    """
    def __init__(self, host:Optional[str]=None, port:Optional[int]=None, userid:Optional[str]="", password:Optional[str]="",
                 enableSSL:bool=False, enableASYNC:bool=False,
                 keepAliveTime:int=30, enableChunkGranularityConfig:bool=False, compress:bool=False, enablePickle:bool=True,
                 python:bool=False, **kwargs):
    ...
    def connect(self, host:str, port:int, userid:str=None, password:str=None, startup:str=None, 
    ...
    def enableStreaming(self, port:int, threadCount:int = 1) -> None:
        """Enable streaming.
    ...
    def subscribe(self, host:str, port:str, handler:Callable, tableName:str, actionName:str=None, offset:int=-1, resub:bool=False, 
        ...
        Args:
            resub : whether to resubscribe after network disconnection. True means automatic resubscription. Defaults to False.
    ...
    def database(self,dbName:str=None, partitionType:int=None, partitions=None, dbPath:str=None, engine:str=None, atomic:str=None, chunkGranularity:str=None) -> Type["Database"]:
        """Create database.
        ...
        if atomic is not None:
            dbstr += ",atomic='"+atomic+"'"
        if self.enableChunkGranularityConfig == True and chunkGranularity is not None:
    ...
    def loadTextEx(self, dbPath:str, tableName:str,  partitionColumns:Optional[List[str]]=None, remoteFilePath:str=None, delimiter:str=",") -> Type["Table"]:
    ...
    def table(self, data, dbPath:str=None) -> Type["Table"]:
        """Create a DolphinDB table object and upload it to the server.

        Args:
            data : data of the table, can be a dictionary, DataFrame or a DolphinDB table name.
            dbPath : database path. Defaults to None.
    ...
    def table(self, dbPath:str=None, data=None,  tableAliasName:str=None,
              inMem:bool=False, partitions:Optional[List[str]]=None) -> Type["Table"]:
        """Create a DolphinDB table object and upload it to the server.
...
class PartitionedTableAppender(object):
    ...
    """
    def __init__(self, dbPath:str=None, tableName:str=None, partitionColName:str=None, dbConnectionPool:DBConnectionPool=None):
...
class tableUpsert(object) :
    ...
    """
    def __init__(self, dbPath:str=None, tableName:str=None, ddbSession:session=None, ignoreNull:bool = False, keyColNames:List[str] = [], sortColumns:List[str]=[]):
    ...
    def upsert(self, table:DataFrame) -> int:
        """upsert data.
...
class BatchTableWriter(object):
    ...
    """
    def __init__(self, host:str, port:int, userid:str=None, password:str=None, acquireLock:bool=True):
    ...
    def addTable(self, dbPath:str=None, tableName:str=None, partitioned:bool=True) -> None:
...
class MultithreadedTableWriter(object):
    ...
    """
    def __init__(self, host:str, port:int, userId:str, password:str, dbPath:str, tableName:str, useSSL:bool=False, enableHighAvailability:bool = False,
                            highAvailabilitySites:List[str] = [], batchSize:int = 1, throttle:float = 1,threadCount:int = 1,
                            partitionCol:str ="", compressMethods:List[str] = [], mode:str = "", modeOption:List[str]=[]):
