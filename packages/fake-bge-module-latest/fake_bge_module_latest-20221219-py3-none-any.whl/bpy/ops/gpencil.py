...
def stroke_outline(view_mode: typing.Union[str, int] = 'VIEW',
                   material_mode: typing.Union[str, int] = 'ACTIVE',
                   thickness: int = 1,
                   keep: bool = True,
                   subdivisions: int = 3,
                   length: float = 0.0):
    ...
    :type view_mode: typing.Union[str, int]
    ...
    :type material_mode: typing.Union[str, int]
...
def time_segment_move(modifier: str = "", type: typing.Union[str, int] = 'UP'):
