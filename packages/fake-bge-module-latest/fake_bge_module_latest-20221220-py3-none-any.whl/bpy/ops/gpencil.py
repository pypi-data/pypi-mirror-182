...
def stroke_outline(view_mode: typing.Union[int, str] = 'VIEW',
                   material_mode: typing.Union[int, str] = 'ACTIVE',
                   thickness: int = 1,
                   keep: bool = True,
                   subdivisions: int = 3,
                   length: float = 0.0):
    ...
    :type view_mode: typing.Union[int, str]
    ...
    :type material_mode: typing.Union[int, str]
...
def stroke_sample(length: float = 0.1, sharp_threshold: float = 0.1):
...
def time_segment_add(modifier: str = ""):
...
def time_segment_move(modifier: str = "", type: typing.Union[int, str] = 'UP'):
...
def time_segment_remove(modifier: str = "", index: int = 0):
...
def tint_flip():
    ''' Switch tint colors :file: startup/bl_ui/properties_grease_pencil_common.py\:871 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$871> _
