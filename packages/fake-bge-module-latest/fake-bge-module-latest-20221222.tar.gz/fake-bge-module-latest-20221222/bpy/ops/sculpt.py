...
def color_filter(area_normal_radius: float = 0.25,
                 ...
                 fill_color: 'mathutils.Color' = (0.0, 0.0, 0.0)):
    ...
    :type fill_color: 'mathutils.Color'
    '''
...
def mask_from_cavity(mix_mode: typing.Union[int, str] = 'MIX',
                     ...
                     settings_source: typing.Union[int, str] = 'OPERATOR',
                     factor: float = 0.5,
                     blur_steps: int = 2,
    ...
    :type settings_source: typing.Union[int, str]
