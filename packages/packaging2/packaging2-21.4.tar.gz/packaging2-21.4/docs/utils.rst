...
.. currentmodule:: packaging2.utils
...
.. function:: canonicalize_name(name)
    ...
    .. doctest::
        ...
        >>> from packaging2.utils import canonicalize_name
...
.. function:: canonicalize_version(version)
    ...
    :class:`~packaging2.version.Version` instance), and returns the
    ...
    .. doctest::
        ...
        >>> from packaging2.utils import canonicalize_version
...
.. function:: parse_wheel_filename(filename)
    ...
    instance of :class:`~packaging2.version.Version`. The build number
    ...
    .. doctest::
        ...
        >>> from packaging2.utils import parse_wheel_filename
...
.. function:: parse_sdist_filename(filename)
    ...
    represented by an instance of :class:`~packaging2.version.Version`.

    :param str filename: The name of the sdist file.

    .. doctest::

        >>> from packaging2.utils import parse_sdist_filename
        >>> from packaging2.version import Version
