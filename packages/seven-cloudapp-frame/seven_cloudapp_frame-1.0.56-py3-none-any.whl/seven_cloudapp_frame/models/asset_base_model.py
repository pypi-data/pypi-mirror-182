...
@LastEditTime: 2022-12-13 10:37:35
...
class AssetBaseModel():
    ...
    def update_user_asset(self, app_id, act_id, module_id, user_id, open_id, user_nick, asset_type, asset_value, asset_object_id, source_type, source_object_id, source_object_name, log_title, only_id="",handler_name="",request_code="", info_json={}):
        ...
        redis_init = SevenHelper.redis_init()
        is_asset_warn = config.get_value("is_asset_warn",False) #是否开启资产预警，跟控制台配套使用
        only_cache_key = ""
        if only_id:
    ...
    def get_asset_log_list(self, app_id, act_id, asset_type=0, page_size=20, page_index=0, user_id=0, asset_object_id="", start_date="", end_date="", user_nick="", open_id="", source_type=0, source_object_id=None, field="*", is_cache=True, operate_type=-1):
        """
        ...
        asset_log_model = AssetLogModel(context=self.context)
        if is_cache:
