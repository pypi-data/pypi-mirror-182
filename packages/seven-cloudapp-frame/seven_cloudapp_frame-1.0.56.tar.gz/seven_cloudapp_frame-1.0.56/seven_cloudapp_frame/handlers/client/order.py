...
@LastEditTime: 2022-12-19 11:08:39
...
class PrizeRosterListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if not invoke_result_data.data:
            invoke_result_data.data = {}
        page_count_mode = invoke_result_data.data["page_count_mode"] if invoke_result_data.data.__contains__("page_count_mode") else "total"
