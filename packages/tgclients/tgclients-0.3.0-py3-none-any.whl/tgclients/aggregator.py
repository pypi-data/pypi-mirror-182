...
class Aggregator:
    ...
    @overload
    def zip(self, textgrid_uris: str, sid: Optional[str] = '') -> Response:
        ...

    @overload
    def zip(self, textgrid_uris: List[str], sid: Optional[str] = '') -> Response:
        ...

    def zip(self, textgrid_uris: Union[str, List[str]], sid: Optional[str] = '') -> Response:
        ...
        url = self._url + '/zip/'
        response = requests.get(url + textgrid_uris + '?sid=' + sid,
                                timeout=self._config.http_timeout)
        return response

    @overload
    def text(self, textgrid_uris: str, sid: Optional[str] = '') -> Response:
        ...

    @overload
    def text(self, textgrid_uris: List[str], sid: Optional[str] = '') -> Response:
        ...
    ...
    def text(self, textgrid_uris: Union[str, List[str]], sid: Optional[str] = '') -> Response:
