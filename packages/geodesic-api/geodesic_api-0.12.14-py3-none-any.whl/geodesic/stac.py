...
from geodesic.descriptors import _BBoxDescr, _BaseDescr, _DatetimeDescr, _DictDescr, _GeometryDescr, _ListDescr, _StringDescr
...
feature_collection_widget = DeferredImport(
    'geodesic.widgets.geodesic_widgets.feature_collection_widget')
...
class FeatureCollection(_APIObject):
    ...
    def _ipython_display_(self, **kwargs):
        return feature_collection_widget.FeatureCollectionWidget(self)._ipython_display_(**kwargs)
...
class Item(Feature):
    ...
    """
    id = _StringDescr(doc="the string id for this item")
