...
.. code-block:: python
    ...
    instr = RsCMPX_NrFr2Meas('TCPIP::192.168.56.101::5025::SOCKET', reset=True)
    idn = instr.query('*IDN?')
...
----------------
	...
	Latest release notes summary: Update of RsCMPX_NrFr2Meas to FW 4.0.140 from the complete FW package 7.10.0
