...
class DftPrecodingCls:
	...
	def set(self, bwp: enums.BandwidthPart, enable: bool, carrierComponent=repcap.CarrierComponent.Default) -> None:
		...
		Specifies whether the <BWP> on carrier <no> uses a transform precoding function. For Signal Path = Network,
		use[CONFigure:]SIGNaling:NRADio:CELL:PUSCh:TPRecoding. \n
