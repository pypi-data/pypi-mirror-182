...
from ..exceptions import ClientError, Forbidden, ServerError, TransientServerError, Unauthorized
...
class Client(metaclass=Singleton):
    ...
    def request(self, method, path, content_type='application/json', data=None,
        ...
        api_call = partial(self._request, method=method, path=path, content_type=content_type,
                           data=data, endpoint=endpoint, headers=headers)
