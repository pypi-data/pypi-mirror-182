...
class ReportingClient(Client):
    ...
    def get_report(self, breakdowns, metrics=None, custom_metrics=None, campaign=None,
                   anomalies=None, filters=None, date_range=None, start_date=None, end_date=None,
                   format=None, step=None, start=None, order_by=None, time_series=None,
                   timezone=None):
