...
def selectMysqlMetadata(mysqlConnect=None,#数据库连接对象
    ...
    sql="select '%s' \n\
     ...
     , ifnull(t3.SEQ_IN_INDEX,0) as IsIndex \n\
     , if(t1.COLUMN_KEY = '', 0, 1) as IsNotNull \n\
    ...
    left join information_schema.STATISTICS t3 on t1.TABLE_SCHEMA=t3.TABLE_SCHEMA and t1.TABLE_NAME=t3.TABLE_NAME and t1.COLUMN_NAME=t3.COLUMN_NAME \n\
