...
class List(google.protobuf.message.Message):
    ...
    def metadata(self) -> global___ListMeta:
        ...
        """
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[k8s.io.apimachinery.pkg.runtime.generated_pb2.RawExtension]:
        """List of objects"""
    def __init__(
        self,
        *,
        metadata: global___ListMeta | None = ...,
        items: collections.abc.Iterable[k8s.io.apimachinery.pkg.runtime.generated_pb2.RawExtension] | None = ...,
    ) -> None: ...
...
class WatchEvent(google.protobuf.message.Message):
    ...
    type: builtins.str
    @property
    def object(self) -> k8s.io.apimachinery.pkg.runtime.generated_pb2.RawExtension:
        """Object is:
    ...
    def __init__(
        ...
        *,
        type: builtins.str | None = ...,
        object: k8s.io.apimachinery.pkg.runtime.generated_pb2.RawExtension | None = ...,
    ) -> None: ...
