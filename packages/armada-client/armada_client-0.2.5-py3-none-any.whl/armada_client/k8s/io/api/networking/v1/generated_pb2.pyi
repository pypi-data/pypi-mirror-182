...
class Ingress(google.protobuf.message.Message):
    ...
    @property
    def metadata(self) -> k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.ObjectMeta:
    ...
    def __init__(
        self,
        *,
        metadata: k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.ObjectMeta | None = ...,
...
class IngressBackend(google.protobuf.message.Message):
    ...
    def service(self) -> global___IngressServiceBackend:
        ...
        """
    @property
    def resource(self) -> k8s.io.api.core.v1.generated_pb2.TypedLocalObjectReference:
    ...
    def __init__(
        ...
        *,
        ...
        resource: k8s.io.api.core.v1.generated_pb2.TypedLocalObjectReference | None = ...,
    ) -> None: ...
...
class IngressClassList(google.protobuf.message.Message):
    ...
    @property
    def metadata(self) -> k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.ListMeta:
    ...
    def __init__(
        self,
        *,
        metadata: k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.ListMeta | None = ...,
...
class IngressStatus(google.protobuf.message.Message):
    ...
    @property
    def loadBalancer(self) -> k8s.io.api.core.v1.generated_pb2.LoadBalancerStatus:
    ...
    def __init__(
        self,
        *,
        loadBalancer: k8s.io.api.core.v1.generated_pb2.LoadBalancerStatus | None = ...,
    ) -> None: ...
...
class NetworkPolicyPeer(google.protobuf.message.Message):
    ...
    @property
    def podSelector(self) -> k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.LabelSelector:
        ...
        """
    @property
    def namespaceSelector(self) -> k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.LabelSelector:
    ...
    def __init__(
        self,
        *,
        podSelector: k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.LabelSelector | None = ...,
        namespaceSelector: k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2.LabelSelector | None = ...,
...
class NetworkPolicyPort(google.protobuf.message.Message):
    ...
    """
    @property
    def port(self) -> k8s.io.apimachinery.pkg.util.intstr.generated_pb2.IntOrString:
    ...
    def __init__(
        ...
        *,
        ...
        port: k8s.io.apimachinery.pkg.util.intstr.generated_pb2.IntOrString | None = ...,
