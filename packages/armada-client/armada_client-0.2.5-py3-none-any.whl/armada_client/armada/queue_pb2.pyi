...
class Job(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created", b"created", "pod_spec", b"pod_spec"]) -> builtins.bool: ...
...
class NodeInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allocatable_resources", b"allocatable_resources", "allocated_resources", b"allocated_resources", "available_resources", b"available_resources", "labels", b"labels", "name", b"name", "taints", b"taints", "total_resources", b"total_resources"]) -> None: ...
...
class ReturnLeaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["avoid_node_labels", b"avoid_node_labels", "cluster_id", b"cluster_id", "job_id", b"job_id", "kubernetes_id", b"kubernetes_id", "reason", b"reason"]) -> None: ...
