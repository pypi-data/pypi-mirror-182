...
def add(override_context: typing.Union[typing.
        ...
        *,
        ...
        rotation: typing.
        Union[typing.List[float], typing.
              Tuple[float, float, float], 'mathutils.Euler'] = (0.0, 0.0, 0.0),
    ...
    :type rotation: typing.Union[typing.List[float], typing.Tuple[float, float, float], 'mathutils.Euler']
...
def randomize_transform(
        ...
        *,
        ...
        rot: typing.Union[typing.List[float], typing.
                          Tuple[float, float, float], 'mathutils.Euler'] = (
                              0.0, 0.0, 0.0),
        use_scale: bool = True,
    ...
    :type rot: typing.Union[typing.List[float], typing.Tuple[float, float, float], 'mathutils.Euler']
