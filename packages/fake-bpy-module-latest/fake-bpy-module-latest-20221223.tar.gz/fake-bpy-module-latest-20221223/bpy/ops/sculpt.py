...
def color_filter(override_context: typing.
                 ...
                 *,
                 ...
                 Union[typing.List[float], typing.
                       Tuple[float, float, float], 'mathutils.Color'] = (0.0,
                                                                         0.0,
                                                                         0.0)):
    ...
    :type fill_color: typing.Union[typing.List[float], typing.Tuple[float, float, float], 'mathutils.Color']
    '''
...
def mask_from_cavity(override_context: typing.
                     ...
                     *,
                     ...
                     settings_source: typing.Union[str, int] = 'OPERATOR',
                     factor: float = 0.5,
                     blur_steps: int = 2,
    ...
    :type settings_source: typing.Union[str, int]
