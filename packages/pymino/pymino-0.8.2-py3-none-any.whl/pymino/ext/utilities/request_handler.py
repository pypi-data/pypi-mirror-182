...
class RequestHandler:
    ...
    def parse_signature(self, data: str) -> dict:
        try:
            ...
            print(f"{Fore.RED}{Style.BRIGHT}ERROR:{Style.RESET_ALL} Failed to generate signature from server.")
    ...
    def ping_server(self) -> HTTPResponse:
        try:
            ...
            raise Exception(
                f"{Fore.RED}{Style.BRIGHT}ERROR:{Style.RESET_ALL} Failed to ping server, server is most likely down."
            ) from e
