...
class RequestHandler:
    ...
    def ping_server(self) -> HTTPResponse:
        try:
            ...
            raise Exception("ERROR: Failed to ping server, server is most likely down.")
    ...
    def run_abc(self, data: str) -> dict:
        return self.xyz if all([self.abc(data), self.run_gg()]) else self.run_xyz(data)

    def abc(self, data: str) -> bool:
