...
set(ARB_VECTORIZE False)
set(ARB_WITH_GPU )
set(ARB_ARCH none)
set(ARB_MODCC_FLAGS )
set(ARB_CXX /Applications/Xcode_13.2.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++)
set(ARB_CXX_FLAGS )
set(ARB_CXX_FLAGS_TARGET $<$<BUILD_INTERFACE:$<COMPILE_LANGUAGE:CXX>>:-fvisibility=hidden>;$<$<BUILD_INTERFACE:$<COMPILE_LANGUAGE:CUDA>>:-Xcompiler=-fvisibility=hidden>)
