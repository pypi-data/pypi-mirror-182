...
class AutoResNet(AutoModel):
    ...
    def fine_tune(self,
        ...
        if not self.is_debug_script:  # TODO platform depended, remove later
    ...
    def _save_fine_tuned(self):
        ...
        self.result_dir = os.path.join(self._save_root, 'result')
...
class ResNetFedAvgScheduler(AutoFedAvgScheduler):
    ...
    def test(self):
        ...
        self.tb_writer.add_scalar('test_results/avg_loss', avg_loss, self._round)
