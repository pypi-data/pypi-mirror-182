...
class SimpleTaskScheduler(SimpleFedAvgScheduler):
    ...
    def build_train_dataloader(self) -> DataLoader:
        return DataLoader(
            datasets.MNIST(
                os.path.join(self._save_root, 'data'),
                train=True,
                download=True,
    ...
    def test(self):
        ...
        self.tb_writer.add_scalar('timer/run_time', end - start, self._round)
        self.tb_writer.add_scalar('test_results/average_loss', test_loss, self._round)
        self.tb_writer.add_scalar('test_results/accuracy', accuracy, self._round)
        self.tb_writer.add_scalar('test_results/correct_rate', correct_rate, self._round)
