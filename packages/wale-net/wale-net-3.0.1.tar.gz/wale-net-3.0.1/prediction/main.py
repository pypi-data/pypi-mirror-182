...
if __name__ == "__main__":
    ...
    try:
        ...
        scenario, _ = CommonRoadFileReader("/home/max/Repositories/MotionPlanning/custom-scenarios/scenarios/rainer/DEU_LocationALower-11_103_T-1.xml").open() # CommonRoadFileReader(os.path.join(scenario_list[2300])).open()
