...
class CncMachineCommunicationSettingsDto(_serialization.Model):
    ...
    :ivar from_cloud_to_machine_path: Required.
    :vartype from_cloud_to_machine_path: str
    :ivar from_machine_to_cloud_path: Required.
    :vartype from_machine_to_cloud_path: str
    """

    _validation = {
        "from_cloud_to_machine_path": {"required": True, "min_length": 1},
        "from_machine_to_cloud_path": {"required": True, "min_length": 1},
    }
    ...
    def __init__(self, *, from_cloud_to_machine_path: str, from_machine_to_cloud_path: str, **kwargs: Any) -> None:
        """
        :keyword from_cloud_to_machine_path: Required.
        :paramtype from_cloud_to_machine_path: str
        :keyword from_machine_to_cloud_path: Required.
...
class CncMachineDto(_serialization.Model):
    ...
    :ivar description:
    :vartype description: str
    :ivar communication_settings:
    :vartype communication_settings: ~ignos.api.client.models.CncMachineCommunicationSettingsDto
    """
    ...
    _attribute_map = {
        ...
        "name": {"key": "name", "type": "str"},
        "description": {"key": "description", "type": "str"},
        "communication_settings": {"key": "communicationSettings", "type": "CncMachineCommunicationSettingsDto"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        name: str,
        description: Optional[str] = None,
        communication_settings: Optional["_models.CncMachineCommunicationSettingsDto"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Required.
        ...
        :keyword description:
        :paramtype description: str
        :keyword communication_settings:
        :paramtype communication_settings: ~ignos.api.client.models.CncMachineCommunicationSettingsDto
        """
        super().__init__(**kwargs)
        self.id = id
        self.name = name
...
class CncMachineOperationDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar chuck_pressure:
    :vartype chuck_pressure: float
    :ivar tailstock:
    :vartype tailstock: str
    :ivar tailstock_pressure:
    :vartype tailstock_pressure: float
    :ivar fixture:
    :vartype fixture: str
    :ivar status: Required. Known values are: "Draft", "Released", and "Deprecated".
    ...
    _attribute_map = {
        ...
        "chuck_pressure": {"key": "chuckPressure", "type": "float"},
        "tailstock": {"key": "tailstock", "type": "str"},
        "tailstock_pressure": {"key": "tailstockPressure", "type": "float"},
    ...
    def __init__(
        ...
        *,
        ...
        chuck_pressure: Optional[float] = None,
        tailstock: Optional[str] = None,
        tailstock_pressure: Optional[float] = None,
        ...
        **kwargs: Any
        ...
        :paramtype chuck_pressure: float
        :keyword tailstock:
        :paramtype tailstock: str
        :keyword tailstock_pressure:
        :paramtype tailstock_pressure: float
        :keyword fixture:
        :paramtype fixture: str
        :keyword status: Required. Known values are: "Draft", "Released", and "Deprecated".
...
class CncMachineOperationTransferDto(_serialization.Model):
    """CncMachineOperationTransferDto.
    ...
    :ivar id: Required.
    :vartype id: str
    :ivar cnc_machine_operation_id: Required.
    ...
    _validation = {
        "id": {"required": True, "min_length": 1},
        "cnc_machine_operation_id": {"required": True, "min_length": 1},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword id: Required.
        :paramtype id: str
        :keyword cnc_machine_operation_id: Required.
...
class CncPartDto(_serialization.Model):
    """CncPartDto.
...
class CncPartDtoPagedResult(_serialization.Model):
    """CncPartDtoPagedResult.

    All required parameters must be populated in order to send to Azure.

    :ivar results: Required.
    :vartype results: list[~ignos.api.client.models.CncPartDto]
    :ivar continuation_token:
    :vartype continuation_token: str
    """
    ...
    _attribute_map = {
        "results": {"key": "results", "type": "[CncPartDto]"},
        "continuation_token": {"key": "continuationToken", "type": "str"},
    }

    def __init__(
        self, *, results: List["_models.CncPartDto"], continuation_token: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword results: Required.
        :paramtype results: list[~ignos.api.client.models.CncPartDto]
        :keyword continuation_token:
        :paramtype continuation_token: str
        """
        super().__init__(**kwargs)
...
class FileDto(_serialization.Model):
    ...
    def __init__(self, *, url: Optional[str] = None, name: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword url:
        :paramtype url: str
        :keyword name:
...
class SetTransferStatusRequest(_serialization.Model):
    ...
    def __init__(self, *, status: Union[str, "_models.FileTransferStatus"], files: List[str], **kwargs: Any) -> None:
        """
        :keyword status: Required. Known values are: "InProgress", "Success", and "Failed".
        :paramtype status: str or ~ignos.api.client.models.FileTransferStatus
        :keyword files: Required.
...
class UpdateCncMachineOperationRequest(_serialization.Model):
    ...
    :ivar fixture:
    :vartype fixture: str
    :ivar status: Known values are: "Draft", "Released", and "Deprecated".
    :vartype status: str or ~ignos.api.client.models.CncOperationStatus
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword fixture:
        :paramtype fixture: str
        :keyword status: Known values are: "Draft", "Released", and "Deprecated".
        :paramtype status: str or ~ignos.api.client.models.CncOperationStatus
        """
        super().__init__(**kwargs)
        self.operation = operation
...
class UserAppDto(_serialization.Model):
    ...
    def __init__(self, *, key: str, name: str, description: Optional[str] = None, **kwargs: Any) -> None:
        """
