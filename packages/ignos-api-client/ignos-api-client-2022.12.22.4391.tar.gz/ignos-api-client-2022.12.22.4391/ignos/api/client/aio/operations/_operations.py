...
from ...operations._operations import (
    ...
    build_cnc_file_transfer_get_cnc_agent_config_request,
    build_cnc_file_transfer_get_transfer_status_request,
    build_cnc_file_transfer_set_transfer_status_request,
...
class CncFileTransferOperations:
    ...
    @distributed_trace_async
    async def get_cnc_agent_config(self, *, agent_id: Optional[str] = None, **kwargs: Any) -> _models.AgentConfigDto:
    ...
    @distributed_trace_async
    async def start_cnc_machine_operation_transfer_to_cloud(
    ...
    @distributed_trace_async
    async def start_cnc_machine_operation_transfer_to_machine(
        self, id: str, **kwargs: Any
    ) -> _models.CncMachineOperationTransferDto:
    ...
    @distributed_trace_async
    async def get_transfer_status(self, id: str, **kwargs: Any) -> _models.CncMachineOperationTransferDto:
        """get_transfer_status.
...
class CncSetupOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def list_cnc_machine_operations_programs(self, id: str, **kwargs: Any) -> List[_models.FileDto]:
...
class MeasurementFormSchemasOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace_async
    async def set_measurement_form_mapping_balloons(self, id: str, **kwargs: Any) -> _models.MeasurementFormMappingDto:
...
class WorkspaceTemplatesAdminOperations:
    ...
    @overload
    async def update_workspace_template_widget_settings(
        self,
        id: str,
        widget_id: str,
        body: Optional[_models.UpdateWorkspaceWidgetSettingsRequest] = None,
