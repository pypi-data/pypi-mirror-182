...
def build_cnc_setup_create_cnc_machine_operation_tool_request(
...
class CncSetupOperations:
    ...
    @distributed_trace
    def create_cnc_machine_operation_tool(self, id: str, body: Optional[JSON] = None, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def list_cnc_tool_by_operation(self, id: str, **kwargs: Any) -> List[JSON]:
