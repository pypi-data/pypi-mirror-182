...
class CncSetupOperations:
    ...
    @distributed_trace_async
    async def create_cnc_machine_operation_tool(self, id: str, body: Optional[JSON] = None, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def list_cnc_tool_by_operation(self, id: str, **kwargs: Any) -> List[JSON]:
