...
class SidelinkCls:
	...
	def set(self, auto: bool, no_rb_pssch: int, offset_pssch: int, offset_pscch: int, segment=repcap.Segment.Default) -> None:
		...
		No command help available \n
			...
			:param no_rb_pssch: No help available
			:param offset_pssch: No help available
			:param offset_pscch: No help available
	...
	class SidelinkStruct(StructBase):
		"""Response structure. Fields: \n
			- Auto: bool: No parameter help available
			- No_Rb_Pssch: int: No parameter help available
			- Offset_Pssch: int: No parameter help available
			- Offset_Pscch: int: No parameter help available"""
		__meta_args_list = [
