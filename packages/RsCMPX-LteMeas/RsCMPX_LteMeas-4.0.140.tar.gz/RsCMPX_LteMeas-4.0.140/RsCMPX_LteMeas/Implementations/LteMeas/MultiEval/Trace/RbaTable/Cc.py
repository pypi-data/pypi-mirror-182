...
class CcCls:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Channel_Type: List[enums.RbTableChannelType]: PUSCh / PUCCH: for UL slot with RB allocation NONE: UL slot contains no allocated RBs. DL: DL slot (only for TDD UL measurements) SSUB: part of special SF (only for TDD UL measurements)
