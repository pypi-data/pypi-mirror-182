...
class MultiEvalCls:
	"""MultiEval commands group definition. 138 total commands, 17 Subgroups, 19 group commands"""
	...
	@property
	def listPy(self):
		"""listPy commands group. 3 Sub-classes, 3 commands."""
	...
	def set_sch_type(self, channel_type: enums.SidelinkChannelType) -> None:
		"""SCPI: CONFigure:LTE:MEASurement<Instance>:MEValuation:SCTYpe \n
		Snippet: driver.configure.lteMeas.multiEval.set_sch_type(channel_type = enums.SidelinkChannelType.PSCCh) \n
		No command help available \n
