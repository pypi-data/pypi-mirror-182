# perllib module for pythonizer, generated by makelib.py on Tue Dec 20 14:15:57 2022
#
...
TRACE_RUN = 0
_PYTHONIZER_KEYWORDS = {'fileinput','delattr','while','as','raise','True','bool','yield','from','dir','atexit','nonlocal','bytes','complex','async','False','tm_py','Array','global','str','types','assert','finally','all','pdb','oct','os','dataclasses','random','globals','object','warnings','open','del','or','locals','compile','builtins','elif','property','struct','perllib','traceback','print','wantarray','try','hasattr','hash','getopt','if','re','except','itertools','$PERLLIB','Hash','for','close','pow','int','chr','return','dict','staticmethod','getattr','inspect','continue','ord','signal','sorted','issubclass','lambda','import','bin','None','eval','float','super','zip','reversed','slice','await','frozenset','type','math','range','sys','calendar','is','input','map','min','else','def','classmethod','functools','setattr','copy','iter','tempfile','anext','abs','ascii','list','memoryview','subprocess','sum','divmod','codecs','breakpoint','stat','ArrayHash','in','format','any','enumerate','isinstance','repr','break','io','callable','filter','not','with','vars','max','and','id','tuple','bytearray','round','collections.abc','pass','hex','exec','class','glob','help','next','fcntl','set','len','aiter','argparse'}
INPUT_LINE_NUMBER = 0
...
def bless(obj, classname, isa=(), is_tie_package=False):
...
def store_perl_global(perlname, value, infer_suffix=False):
