...
class _dict(type(_d)):
    ...
    def has_key(self, key):
        ...
        DEPRECATED: use the implicit __contains__ via the 'key in dict' syntax
        """
        return key in self
...
class Block(object):
    ...
    def has_key(self, key):
        ...
        DEPRECATED: use the implicit __contains__ via the 'key in block' syntax
        """
        return key in self
