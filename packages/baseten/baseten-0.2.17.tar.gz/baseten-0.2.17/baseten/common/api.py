...
def _format_inputs_for_v1(auth_token: AuthToken, inputs: Union[List, Dict], metadata: List[Dict]):
    """
...
def _post_rest_query(auth_token: AuthToken, url: str, post_body_dict: dict):
    headers = auth_token.headers()
