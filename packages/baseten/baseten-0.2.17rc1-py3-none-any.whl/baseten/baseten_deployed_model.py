...
class BasetenDeployedModel:
    ...
    def __init__(self, model_id: str = None,
                 ...
                 model_name: str = None,
                 model_zoo_name: str = None,
                 truss_handle: TrussHandle = None,
                 truss_spec_version: str = None):
    ...
    def get_truss_spec_version(self) -> dict:
        if self._model_id:
            ...
            return api.external_version_truss_spec_version(self._external_model_version_id)
