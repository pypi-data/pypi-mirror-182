...
class Datastore(object):
    ...
    def allocateIds(
        ...
        url = '{}/projects/{}:allocateIds'.format((self._api_root), (project))
    ...
    def beginTransaction(
        ...
        project = self.project()
        url = '{}/projects/{}:beginTransaction'.format((self._api_root), (project))
        headers = self.headers()
        headers.update({
            'Content-Length': '0',
            'Content-Type': 'application/json',
    ...
    def commit(
        ...
        project = self.project()
        url = '{}/projects/{}:commit'.format((self._api_root), (project))
    ...
    def export(
        ...
        project = self.project()
        url = '{}/projects/{}:export'.format((self._api_root), (project))
    ...
    def get_datastore_operation(
        ...
        url = '{}/{}'.format((self._api_root), (name))
    ...
    def lookup(
        ...
        project = self.project()
        url = '{}/projects/{}:lookup'.format((self._api_root), (project))
    ...
    def reserveIds(
        self, keys           , database_id      = '',
        session                    = None,
        timeout      = 10,
    )        :
        project = self.project()
        url = '{}/projects/{}:reserveIds'.format((self._api_root), (project))
    ...
    def rollback(
        ...
        project = self.project()
        url = '{}/projects/{}:rollback'.format((self._api_root), (project))
    ...
    def runQuery(
        ...
        project = self.project()
        url = '{}/projects/{}:runQuery'.format((self._api_root), (project))
