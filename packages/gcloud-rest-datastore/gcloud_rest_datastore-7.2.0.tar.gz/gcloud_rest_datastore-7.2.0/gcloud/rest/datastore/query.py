...
class GQLQuery(BaseQuery):
    ...
    def __init__(
        self, query_string     , allow_literals       = True,
        named_bindings                           = None,
    ...
    @classmethod
    def _param_from_repr(cls, param_repr                )       :
...
class QueryResultBatch(object):
    ...
    def __init__(
        self, end_cursor     ,
        entity_result_type             = ResultType.UNSPECIFIED,
        entity_results                               = None,
        more_results                  = MoreResultsType.UNSPECIFIED,
        skipped_cursor      = '', skipped_results      = 0,
        snapshot_version      = '',
    )        :
        self.end_cursor = end_cursor
