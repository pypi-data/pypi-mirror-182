...
from kilroy_face_discord import resource_text
from kilroy_face_discord.face import Params
...
class BaseConfig(BaseSettings):
    class Config:
        env_prefix = "kilroy_face_discord_"
...
class Config(BaseConfig):
    ...
    state_directory: Path = CACHE_DIR / "kilroy-face-discord" / "state"
