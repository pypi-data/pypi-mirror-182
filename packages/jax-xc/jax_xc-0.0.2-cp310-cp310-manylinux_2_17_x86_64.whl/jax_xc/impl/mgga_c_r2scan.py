...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t140 = jnp.where(t44, t138, t98 * t43)
  t142 = jnp.where(t51, t138, t100 * t50)
  t148 = jnp.sqrt(0.4e1)
  t149 = t148 * t14
  ...
  t181 = t175 ** 2
  t185 = t11 ** 0.5e0
  t192 = 0.1e1 * t13 / t181 * (0.379785e1 * t168 + 0.35876e1 + 0.122865e1 * t185 + 0.24647e0 * t11) / t178
  ...
  t218 = t212 ** 2
  t219 = 0.1e1 / t218
  t224 = 0.51785e1 * t168 + 0.36231e1 + 0.660195e0 * t185 + 0.248355e0 * t11
  t225 = 0.1e1 / t215
  t245 = 0.1e1 / (0.1e1 + 0.4445e-1 * t14 + t151)
  t255 = 6 ** (0.1e1 / 0.3e1)
  t256 = t94 ** (0.1e1 / 0.3e1)
  t257 = t256 ** 2
  t259 = t255 / t257
  t260 = t56 ** 2
  t263 = 0.1e1 / t22 / t37
  ...
  t265 = t255 ** 2
  t269 = t121 ** 2
  t277 = jnp.exp(-0.20444604078896369094e0 * t265 / t256 / t94 * t56 * t269 / t8 / t38 / t7)
  t283 = (0.1e1 + 0.27801896084645508333e-2 * (0.1e1 + 0.25e-1 * t11) / (0.1e1 + 0.4445e-1 * t11) * t121 / t8 / t37 * t56 / t104 * t19 / t3 * t5 * t132 * t133 + 0.43913724338827160496e-2 * t132 / (t140 / 0.2e1 + t142 / 0.2e1) * t109 * t133 * (0.5e1 * t4 * t10 * (0.285764e-1 / t153 * t158 * t166 * (0.4445e-1 * t168 + 0.125541e0) + t180 - t192 - t40 * t60 * (-0.6388517036e-2 * t198 + 0.1e1 * t62 / t200 * (0.705945e1 * t168 + 0.61977e1 + 0.252465e1 * t185 + 0.312585e0 * t11) / t197 + t180 - t192 - 0.21973736767207854065e-2 * t216 + 0.5848223622634646207e0 * t75 * t219 * t224 * t225) - 0.21973736767207854065e-2 * t60 * t216 + 0.5848223622634646207e0 * t60 * t75 * t219 * t224 * t225) - 0.45e2 * params.eta * (-0.285764e-1 * t245 * t158 * t166 + t33 - t89 - t91)) * t259 * t260 * t264 * t277) ** (0.1e1 / 0.4e1)
  ...
  t302 = t301 ** 2
  t306 = t50 / 0.2e1
  t307 = t306 ** (0.1e1 / 0.3e1)
  t308 = t307 ** 2
  t309 = t308 * t306
  t322 = (tau0 / t292 / r0 * t299 + tau1 / t302 / r1 * t309 - t264 / 0.8e1) / (0.3e1 / 0.1e2 * t265 * t257 * (t299 + t309) + params.eta * t121 * t263 / 0.8e1)
  t325 = jnp.where(0.e0 < t322, 0, t322)
  t330 = jnp.exp(-0.64e0 * t325 / (0.1e1 - t325))
  t332 = 0.25e1 < t322
  t333 = jnp.where(t332, 0.25e1, t322)
  t335 = t333 ** 2
  t337 = t335 * t333
  t339 = t335 ** 2
  t348 = jnp.where(t332, t322, 0.25e1)
  t352 = jnp.exp(0.15e1 / (0.1e1 - t348))
  t354 = jnp.where(t322 <= 0.25e1, 0.1e1 - 0.64e0 * t333 - 0.4352e0 * t335 - 0.1535685604549e1 * t337 + 0.3061560252175e1 * t339 - 0.1915710236206e1 * t339 * t333 + 0.516884468372e0 * t339 * t335 - 0.51848879792e-1 * t339 * t337, -0.7e0 * t352)
  t355 = jnp.where(t322 <= 0.e0, t330, t354)
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t92 = t68 * t60
  t93 = 0.1e1 / t74
  t99 = jnp.where(t33, t63 * p.zeta_threshold, 1)
  t103 = jnp.sqrt(0.4e1)
  t104 = t103 * t13
  ...
  t189 = s0 ** 2
  t191 = t82 ** 2
  t198 = jnp.exp(-0.20444604078896369094e0 * t185 / t176 / t60 * t39 * t189 / t7 / t191 / r0)
  t204 = (0.1e1 + 0.27801896084645508333e-2 * (0.1e1 + 0.25e-1 * t10) / (0.1e1 + 0.4445e-1 * t10) * s0 / t7 / t82 * t39 / t65 * t18 / t3 * t5 * t92 * t93 + 0.43913724338827160496e-2 * t92 / t99 * t70 * t93 * (0.5e1 * t4 * t9 * (0.285764e-1 / t108 * t113 * (0.4445e-1 * t116 + 0.125541e0) + 0.1328816518e-1 * t126 - 0.1e1 * t12 / t128 * (0.379785e1 * t116 + 0.35876e1 + 0.122865e1 * t132 + 0.24647e0 * t10) / t125 - 0.21973736767207854065e-2 * t43 * t145 + 0.5848223622634646207e0 * t43 * t45 / t149 * (0.51785e1 * t116 + 0.36231e1 + 0.660195e0 * t132 + 0.248355e0 * t10) / t144) - 0.45e2 * params.eta * (-0.285764e-1 * t166 * t113 + t32 - t57)) * t179 * t180 * t184 * t198) ** (0.1e1 / 0.4e1)
  ...
  t228 = jnp.where(0.e0 < t225, 0, t225)
  t233 = jnp.exp(-0.64e0 * t228 / (0.1e1 - t228))
  t235 = 0.25e1 < t225
  t236 = jnp.where(t235, 0.25e1, t225)
  t238 = t236 ** 2
  t240 = t238 * t236
  t242 = t238 ** 2
  t251 = jnp.where(t235, t225, 0.25e1)
  t255 = jnp.exp(0.15e1 / (0.1e1 - t251))
  t257 = jnp.where(t225 <= 0.25e1, 0.1e1 - 0.64e0 * t236 - 0.4352e0 * t238 - 0.1535685604549e1 * t240 + 0.3061560252175e1 * t242 - 0.1915710236206e1 * t242 * t236 + 0.516884468372e0 * t242 * t238 - 0.51848879792e-1 * t242 * t240, -0.7e0 * t255)
  t258 = jnp.where(t225 <= 0.e0, t233, t257)
