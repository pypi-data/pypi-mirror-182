...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t62 = 0.1e1 / t60 / t39
  t63 = t58 * s0 * t62
  t70 = params.k1 * (0.1e1 - params.k1 / (params.k1 + (-0.162742215233874e0 * t30 * t52 + 0.1e2 / 0.81e2) * t31 * t63 / 0.24e2))
  t74 = s0 * t62
  ...
  t124 = 0.1e1 - t84
  t125 = t124 ** 2
  t130 = (0.40570770199022687793e-1 - 0.30235468026081006357e0 * params.eta) * t31 * t58
  t136 = (0.3e1 / 0.4e1 * params.eta + 0.2e1 / 0.3e1) ** 2
  t141 = (0.290700106132790123e-2 - 0.27123702538979e0 * params.eta) ** 2
  ...
  t195 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * (0.1e1 + t70 + t117 * (0.174e0 - t70) + 0.2e1 * (-0.162742215233874e0 + 0.162742215233874e0 * t84 + 0.678092563474475e-2 * t121 * t63 - 0.59353125082804e-1 * t125 + t130 * t74 * t124 / 0.24e2 + t145 * t36 * t38 * t44 / 0.576e3) * t151 / t153 / (0.1e1 + t155 / t156) * t172) * (0.1e1 - t190))
  t197 = jnp.where(t10, t15, -t17)
  t198 = jnp.where(t14, t11, t197)
  t199 = 0.1e1 + t198
  t201 = t199 ** (0.1e1 / 0.3e1)
  t203 = jnp.where(t199 <= p.zeta_threshold, t23, t201 * t199)
  t205 = s2 ** 2
  t206 = r1 ** 2
  t207 = t206 ** 2
  t209 = r1 ** (0.1e1 / 0.3e1)
  ...
  t225 = t58 * s2 * t224
  t232 = params.k1 * (0.1e1 - params.k1 / (params.k1 + (-0.162742215233874e0 * t30 * t216 + 0.1e2 / 0.81e2) * t31 * t225 / 0.24e2))
  t236 = s2 * t224
  t238 = tau1 / t222 / r1 - t236 / 0.8e1
  t242 = t78 + params.eta * s2 * t224 / 0.8e1
  t244 = t238 / t242
  t247 = jnp.where(0.e0 < t244, 0, t244)
  t252 = jnp.exp(-params.c1 * t247 / (0.1e1 - t247))
  t254 = 0.25e1 < t244
  t255 = jnp.where(t254, 0.25e1, t244)
  t257 = t255 ** 2
  t259 = t257 * t255
  t261 = t257 ** 2
  t270 = jnp.where(t254, t244, 0.25e1)
  t274 = jnp.exp(params.c2 / (0.1e1 - t270))
  t276 = jnp.where(t244 <= 0.25e1, 0.1e1 - 0.667e0 * t255 - 0.4445555e0 * t257 - 0.663086601049e0 * t259 + 0.145129704449e1 * t261 - 0.887998041597e0 * t261 * t255 + 0.234528941479e0 * t261 * t257 - 0.23185843322e-1 * t261 * t259, -params.d * t274)
  t277 = jnp.where(t244 <= 0.e0, t252, t276)
  t283 = 0.1e1 - t244
  t284 = t283 ** 2
  t294 = t238 ** 2
  t296 = t242 ** 2
  ...
  t330 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t203 * t28 * (0.1e1 + t232 + t277 * (0.174e0 - t232) + 0.2e1 * (-0.162742215233874e0 + 0.162742215233874e0 * t244 + 0.678092563474475e-2 * t121 * t225 - 0.59353125082804e-1 * t284 + t130 * t236 * t283 / 0.24e2 + t145 * t36 * t205 * t211 / 0.576e3) * t294 / t296 / (0.1e1 + t298 / t299) * t310) * (0.1e1 - t325))
  res = t195 + t330
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t57 = 0.1e1 / t55 / t33
  t58 = t54 * t57
  t65 = params.k1 * (0.1e1 - params.k1 / (params.k1 + (-0.162742215233874e0 * t22 * t45 + 0.1e2 / 0.81e2) * t23 * t51 * t58 / 0.24e2))
  ...
  t139 = (0.290700106132790123e-2 - 0.27123702538979e0 * params.eta) ** 2
  t150 = t71 ** 2
  t152 = t78 ** 2
  t154 = t150 ** 2
  t155 = t152 ** 2
  ...
  t195 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t20 * (0.1e1 + t65 + t113 * (0.174e0 - t65) + 0.2e1 * (-0.162742215233874e0 + 0.162742215233874e0 * t80 + 0.678092563474475e-2 * t22 * t23 * t51 * t58 - 0.59353125082804e-1 * t122 + (0.40570770199022687793e-1 - 0.30235468026081006357e0 * params.eta) * t23 * t51 * t54 * t57 * t121 / 0.24e2 + (0.146e3 / 0.2025e4 * t134 - 0.73e2 / 0.54e3 * params.eta - 0.146e3 / 0.1215e4 + t139 / params.k1) * t24 * t28 * t30 * t32 * t37 / 0.288e3) * t150 / t152 / (0.1e1 + t154 / t155) * t171) * (0.1e1 - t190))
  res = 0.2e1 * t195
  return res