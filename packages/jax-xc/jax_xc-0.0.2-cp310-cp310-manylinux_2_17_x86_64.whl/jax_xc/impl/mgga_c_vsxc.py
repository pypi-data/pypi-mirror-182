...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t164 = jnp.where(t162, p.zeta_threshold, t161)
  t165 = t161 ** (0.1e1 / 0.3e1)
  t167 = jnp.where(t162, t22, 0.1e1 / t165)
  t169 = t16 * t20 * t167
  t172 = jnp.sqrt(t169)
  t175 = t169 ** 0.15e1
  t177 = t167 ** 2
  t179 = t38 * t42 * t177
  t185 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t172 + 0.8969e0 * t169 + 0.204775e0 * t175 + 0.123235e0 * t179))
  t187 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t169) * t185
  t198 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t172 + 0.1549425e1 * t169 + 0.420775e0 * t175 + 0.1562925e0 * t179))
  t211 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t172 + 0.905775e0 * t169 + 0.1100325e0 * t175 + 0.1241775e0 * t179))
  t212 = (0.1e1 + 0.278125e-1 * t169) * t211
  t221 = jnp.where(t163, 0, t164 * (-t187 + t64 * (-0.310907e-1 * (0.1e1 + 0.5137e-1 * t169) * t198 + t187 - 0.19751673498613801407e-1 * t212) + 0.19751673498613801407e-1 * t64 * t212) / 0.2e1)
  t222 = r1 ** 2
  t223 = r1 ** (0.1e1 / 0.3e1)
  t224 = t223 ** 2
  ...
  t277 = t271 ** 0.15e1
  t280 = t37 * t14 * t40
  t286 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t274 + 0.8969e0 * t271 + 0.204775e0 * t277 + 0.123235e0 * t280))
  t288 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t271) * t286
  t289 = t2 ** 2
  t290 = t289 ** 2
  t291 = t3 ** 2
  t292 = t291 ** 2
  t296 = jnp.where(t7, t55, t23 * t6)
  t298 = jnp.where(t162, t55, t165 * t161)
  t300 = (t296 + t298 - 0.2e1) * t63
  t311 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t274 + 0.1549425e1 * t271 + 0.420775e0 * t277 + 0.1562925e0 * t280))
  t324 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t274 + 0.905775e0 * t271 + 0.1100325e0 * t277 + 0.1241775e0 * t280))
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t165 = t159 ** 0.15e1
  t168 = t31 * t10 * t34
  t174 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t162 + 0.8969e0 * t159 + 0.204775e0 * t165 + 0.123235e0 * t168))
  t177 = jnp.where(t3, t49, 1)
  t191 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t162 + 0.905775e0 * t159 + 0.1100325e0 * t165 + 0.1241775e0 * t168))
  t199 = 0.4e1 * t102
