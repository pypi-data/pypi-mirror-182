...
def pol(r0, r1, params, p):
  ...
  t233 = t212 ** t231
  t234 = jnp.where(t212 <= p.zeta_threshold, t232, t233)
  t235 = 0.1e1 - t211
  t237 = t235 ** t231
  t238 = jnp.where(t235 <= p.zeta_threshold, t232, t237)
  t240 = 2 ** t231
  ...
  res = -(t1 * t3 * t5 * t8 * t31 * (0.75e0 + 0.45090814814814814815e0 * t45 - 0.82017777777777777776e-1 * t55 + 0.33649382716049382717e0 * t69) / (0.1e1 + 0.12311866666666666667e1 * t45 + 0.10094814814814814815e1 * t69) / 0.4e1 + t91 * (params.b[0][0] + 0.4e1 / 0.27e2 * params.b[0][1] * t9 * t36 * t98 + 0.16e2 / 0.81e2 * params.b[0][2] * t5 * t59 * t106) / (0.1e1 + 0.4e1 / 0.27e2 * params.b[0][3] * t9 * t36 * t98 + 0.16e2 / 0.81e2 * params.b[0][4] * t5 * t59 * t106) * t127 / 0.2e1 + (params.c[0][1] * t141 + params.c[0][0]) * t31 * t156 * t168 * t126 / 0.4e1) * t63 * t8 * t2 * t17 / (0.1e1 + t91 * (params.d[0][0] + 0.4e1 / 0.27e2 * params.d[0][1] * t9 * t36 * t98 + 0.16e2 / 0.81e2 * params.d[0][2] * t5 * t59 * t106) / (0.1e1 + 0.4e1 / 0.27e2 * params.d[0][3] * t9 * t36 * t98 + 0.16e2 / 0.81e2 * params.d[0][4] * t5 * t59 * t106) * t127 / 0.2e1 + t31 * t156 * t168 * t126 / 0.4e1) * (0.1e1 - t243) / 0.3e1 - (t248 * t1 * t3 * t5 * t8 * t257 * (0.75e0 + 0.11272703703703703704e0 * t261 - 0.20504444444444444444e-1 * t55 + 0.42061728395061728396e-1 * t266) / (0.1e1 + 0.30779666666666666667e0 * t261 + 0.12618518518518518519e0 * t266) / 0.4e1 + t283 * (params.b[1][0] + params.b[1][1] * t9 * t287 * t260 / 0.27e2 + 0.2e1 / 0.81e2 * params.b[1][2] * t5 * t293 * t265) / (0.1e1 + params.b[1][3] * t9 * t287 * t260 / 0.27e2 + 0.2e1 / 0.81e2 * params.b[1][4] * t5 * t293 * t265) * t127 / 0.2e1 + (params.c[1][1] * t322 + params.c[1][0]) * t257 * t337 * t349 * t126 / 0.4e1) * t63 * t8 * t2 * t17 / (0.1e1 + t283 * (params.d[1][0] + params.d[1][1] * t9 * t287 * t260 / 0.27e2 + 0.2e1 / 0.81e2 * params.d[1][2] * t5 * t293 * t265) / (0.1e1 + params.d[1][3] * t9 * t287 * t260 / 0.27e2 + 0.2e1 / 0.81e2 * params.d[1][4] * t5 * t293 * t265) * t127 / 0.2e1 + t257 * t337 * t349 * t126 / 0.4e1) * t243 / 0.3e1
  return res
...
def unpol(r0, params, p):
  ...
  t205 = jnp.where(0.1e1 <= p.zeta_threshold, t204, 1)
  t208 = 2 ** t203
  ...
  res = -(t1 * t3 * t5 * t8 * t21 * (0.75e0 + 0.45090814814814814815e0 * t33 - 0.82017777777777777776e-1 * t41 + 0.33649382716049382717e0 * t53) / (0.1e1 + 0.12311866666666666667e1 * t33 + 0.10094814814814814815e1 * t53) / 0.4e1 + t74 * (params.b[0][0] + 0.4e1 / 0.27e2 * params.b[0][1] * t9 * t26 * t32 + 0.16e2 / 0.81e2 * params.b[0][2] * t5 * t45 * t52) / (0.1e1 + 0.4e1 / 0.27e2 * params.b[0][3] * t9 * t26 * t32 + 0.16e2 / 0.81e2 * params.b[0][4] * t5 * t45 * t52) * t104 / 0.2e1 + (params.c[0][1] * t115 + params.c[0][0]) * t21 * t130 * t142 * t103 / 0.4e1) * t48 * t8 * t2 * t16 / (0.1e1 + t74 * (params.d[0][0] + 0.4e1 / 0.27e2 * params.d[0][1] * t9 * t26 * t32 + 0.16e2 / 0.81e2 * params.d[0][2] * t5 * t45 * t52) / (0.1e1 + 0.4e1 / 0.27e2 * params.d[0][3] * t9 * t26 * t32 + 0.16e2 / 0.81e2 * params.d[0][4] * t5 * t45 * t52) * t104 / 0.2e1 + t21 * t130 * t142 * t103 / 0.4e1) * (0.1e1 - t211) / 0.3e1 - (t216 * t1 * t3 * t5 * t8 * t226 * (0.75e0 + 0.11272703703703703704e0 * t231 - 0.20504444444444444444e-1 * t41 + 0.42061728395061728396e-1 * t237) / (0.1e1 + 0.30779666666666666667e0 * t231 + 0.12618518518518518519e0 * t237) / 0.4e1 + t253 * (params.b[1][0] + params.b[1][1] * t9 * t26 * t259 / 0.27e2 + 0.2e1 / 0.81e2 * params.b[1][2] * t5 * t45 * t266) / (0.1e1 + params.b[1][3] * t9 * t26 * t259 / 0.27e2 + 0.2e1 / 0.81e2 * params.b[1][4] * t5 * t45 * t266) * t104 / 0.2e1 + (params.c[1][1] * t295 + params.c[1][0]) * t226 * t310 * t322 * t103 / 0.4e1) * t48 * t8 * t2 * t16 / (0.1e1 + t253 * (params.d[1][0] + params.d[1][1] * t9 * t26 * t259 / 0.27e2 + 0.2e1 / 0.81e2 * params.d[1][2] * t5 * t45 * t266) / (0.1e1 + params.d[1][3] * t9 * t26 * t259 / 0.27e2 + 0.2e1 / 0.81e2 * params.d[1][4] * t5 * t45 * t266) * t104 / 0.2e1 + t226 * t310 * t322 * t103 / 0.4e1) * t211 / 0.3e1
  return res