...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t139 = 0.1e1 / t66
  t141 = t138 * t124 * t139
  t147 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t131 + 0.8969e0 * t128 + 0.204775e0 * t134 + 0.123235e0 * t141))
  t149 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t128) * t147
  t150 = t37 ** 2
  t151 = t45 <= p.zeta_threshold
  t152 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  ...
  t173 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t131 + 0.1549425e1 * t128 + 0.420775e0 * t134 + 0.1562925e0 * t141))
  t186 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t131 + 0.905775e0 * t128 + 0.1100325e0 * t134 + 0.1241775e0 * t141))
  ...
  t285 = t273 ** 2
  t287 = t283 * t284 * t285
  t293 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t278 + 0.8969e0 * t275 + 0.204775e0 * t281 + 0.123235e0 * t287))
  t295 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t275) * t293
  t296 = 0.2e1 <= p.zeta_threshold
  t298 = jnp.where(t296, t153, 0.2e1 * t159)
  t299 = 0.e0 <= p.zeta_threshold
  t300 = jnp.where(t299, t153, 0)
  t302 = (t298 + t300 - 0.2e1) * t162
  t313 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t278 + 0.1549425e1 * t275 + 0.420775e0 * t281 + 0.1562925e0 * t287))
  t326 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t278 + 0.905775e0 * t275 + 0.1100325e0 * t281 + 0.1241775e0 * t287))
  ...
  t333 = jnp.where(t296, t199, t241)
  t334 = jnp.where(t299, t199, 0)
  ...
  t397 = jnp.where(t267 < t395, t395, t267)
  t400 = jnp.where(t120, t267 * t29 / 0.2e1, t397 * t45 / 0.2e1)
  t402 = jnp.logical_or(r1 <= p.dens_threshold, t33)
  t406 = (0.1e1 / t57) ** (0.1e1 / 0.3e1)
  t408 = t270 * t271 * t406
  t411 = jnp.sqrt(t408)
  t414 = t408 ** 0.15e1
  t416 = t406 ** 2
  t418 = t283 * t284 * t416
  t424 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t411 + 0.8969e0 * t408 + 0.204775e0 * t414 + 0.123235e0 * t418))
  t426 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t408) * t424
  t437 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t411 + 0.1549425e1 * t408 + 0.420775e0 * t414 + 0.1562925e0 * t418))
  t450 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t411 + 0.905775e0 * t408 + 0.1100325e0 * t414 + 0.1241775e0 * t418))
  ...
  t508 = jnp.where(t267 < t506, t506, t267)
  t511 = jnp.where(t402, t267 * t32 / 0.2e1, t508 * t57 / 0.2e1)
  t517 = t29 ** (0.1e1 / 0.3e1)
  t519 = jnp.where(t30, t153, t517 * t29)
  t520 = t32 ** (0.1e1 / 0.3e1)
  t522 = jnp.where(t33, t153, t520 * t32)
  t524 = (t519 + t522 - 0.2e1) * t162
  t526 = t18 * t21 * t524 * t189
  t528 = 0.19751673498613801407e-1 * t524 * t187
  t529 = t517 ** 2
  t530 = jnp.where(t30, t199, t529)
  t531 = t520 ** 2
  t532 = jnp.where(t33, t199, t531)
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t59 = t58 ** 2
  t62 = jnp.where(-t2 <= -0.999999999999e0, t4 + params.C0_c[1] + params.C0_c[2] + params.C0_c[3], t4 / t59)
  t68 = s0 / r0 / tau0 / 0.8e1
  t70 = jnp.where(0.1e1 < t68, 1, t68)
  t71 = t70 ** 2
  ...
  t94 = 0.1e1 / t21
  t96 = t93 * t79 * t94
  t102 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t86 + 0.8969e0 * t83 + 0.204775e0 * t89 + 0.123235e0 * t96))
  t103 = (0.1e1 + 0.53425e-1 * t83) * t102
  t105 = t14 ** 2
  t106 = t24 <= p.zeta_threshold
  t107 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t108 = t107 * p.zeta_threshold
  t109 = jnp.where(t106, t108, t48)
  t110 = t31 <= p.zeta_threshold
  t111 = jnp.where(t110, t108, t51)
  t112 = t109 + t111 - 0.2e1
  t116 = 0.1e1 / (0.2e1 * t16 - 0.2e1)
  t127 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t86 + 0.1549425e1 * t83 + 0.420775e0 * t89 + 0.1562925e0 * t96))
  t130 = 0.621814e-1 * t103
  t141 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t86 + 0.905775e0 * t83 + 0.1100325e0 * t89 + 0.1241775e0 * t96))
  ...
  t155 = t107 ** 2
  t156 = t47 ** 2
  t157 = jnp.where(t106, t155, t156)
  t158 = t50 ** 2
  t159 = jnp.where(t110, t155, t158)
  ...
  t242 = t230 ** 2
  t244 = t240 * t241 * t242
  t250 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t235 + 0.8969e0 * t232 + 0.204775e0 * t238 + 0.123235e0 * t244))
  t252 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t232) * t250
  t253 = 0.2e1 <= p.zeta_threshold
  t255 = jnp.where(t253, t108, 0.2e1 * t16)
  t256 = 0.e0 <= p.zeta_threshold
  t257 = jnp.where(t256, t108, 0)
  t259 = (t255 + t257 - 0.2e1) * t116
  t270 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t235 + 0.1549425e1 * t232 + 0.420775e0 * t238 + 0.1562925e0 * t244))
  t283 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t235 + 0.905775e0 * t232 + 0.1100325e0 * t238 + 0.1241775e0 * t244))
  ...
  t290 = jnp.where(t253, t155, t17)
  t291 = jnp.where(t256, t155, 0)
  ...
  t349 = jnp.where(t226 < t347, t347, t226)
  t352 = jnp.where(t75, t225, t349 * t24 / 0.2e1)
  ...
  t364 = t354 ** 2
  t366 = t240 * t241 * t364
  t372 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t359 + 0.8969e0 * t356 + 0.204775e0 * t362 + 0.123235e0 * t366))
  t374 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t356) * t372
  t385 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t359 + 0.1549425e1 * t356 + 0.420775e0 * t362 + 0.1562925e0 * t366))
  t398 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t359 + 0.905775e0 * t356 + 0.1100325e0 * t362 + 0.1241775e0 * t366))
  ...
  t448 = jnp.where(t226 < t446, t446, t226)
  t451 = jnp.where(t75, t225, t448 * t31 / 0.2e1)
  t456 = jnp.where(t9, t108, 1)
  t461 = 0.19751673498613801407e-1 * (0.2e1 * t456 - 0.2e1) * t116 * t142
  t462 = jnp.where(t9, t155, 1)
  t463 = t462 ** 2
  t464 = t463 * t462
