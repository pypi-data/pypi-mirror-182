...
def pol(r0, r1, params, p):
  ...
  t20 = t6 ** 0.15e1
  t27 = jnp.log(0.1e1 + 0.1e1 / (0.10022e1 * t6 - 0.2069e-1 * t20 + 0.33997e0 * t10 + 0.1747e-1 * t16))
  t39 = jnp.log(0.1e1 + 0.1e1 / (0.4133e0 * t6 + 0.668467e-1 * t10 + 0.7799e-3 * t16))
  t42 = r0 - r1
  t43 = t42 ** 2
  t45 = t3 ** 2
  t46 = 0.1e1 / t45
  ...
  t76 = jnp.sqrt(t72)
  t78 = jnp.where(t72 <= p.zeta_threshold, t75, t76 * t72)
  t80 = 0.1e1 - t71
  t82 = jnp.sqrt(t80)
  t84 = jnp.where(t80 <= p.zeta_threshold, t75, t82 * t80)
...
def unpol(r0, params, p):
  ...
  t19 = t5 ** 0.15e1
  t26 = jnp.log(0.1e1 + 0.1e1 / (0.10022e1 * t5 - 0.2069e-1 * t19 + 0.33997e0 * t9 + 0.1747e-1 * t15))
  t29 = jnp.exp(-0.13386e1 * t5)
  t31 = jnp.sqrt(0.2e1)
  t35 = jnp.sqrt(p.zeta_threshold)
  t37 = jnp.where(0.1e1 <= p.zeta_threshold, t35 * p.zeta_threshold, 1)
