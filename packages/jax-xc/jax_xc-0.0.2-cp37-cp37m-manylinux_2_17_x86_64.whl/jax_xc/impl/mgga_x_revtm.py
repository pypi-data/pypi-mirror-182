...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t110 = jnp.sqrt(0.1e1 + 0.22222222222222222222e0 * t102 * t48 * t105)
  ...
  t129 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (t43 * (0.1e1 / t71 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t56 - 0.5e1 / 0.9e1 * (0.14554132e0 * t76 + t79 + 0.11867481666666666667e-1 * t55) * t44 * t48) / t86) + (0.1e1 - t43) * t123))
  ...
  t145 = jnp.where(t143 < 0.1e1, t143, 0.1e1)
  t146 = t145 ** 2
  t147 = t146 * t145
  t151 = (0.1e1 + t147) ** 2
  ...
  t162 = s2 ** 2
  t163 = t154 ** 2
  t171 = (0.1e1 + 0.15045488888888888889e0 * t160 + 0.26899490462262948e-2 * t61 * t162 / t155 / t163 / r1) ** (0.1e1 / 0.5e1)
  t176 = tau1 / t156 / r1
  t184 = t171 ** 2
  t200 = (t176 - t159 / 0.8e1) * t44
  t203 = 0.5e1 / 0.9e1 * t200 * t48 - 0.1e1
  t208 = jnp.sqrt(0.1e1 + 0.22222222222222222222e0 * t200 * t48 * t203)
  ...
  t227 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t137 * t27 * (t153 * (0.1e1 / t171 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t160 - 0.5e1 / 0.9e1 * (0.14554132e0 * t176 + t79 + 0.11867481666666666667e-1 * t159) * t44 * t48) / t184) + (0.1e1 - t153) * t221))
  res = t129 + t227
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t105 = jnp.sqrt(0.1e1 + 0.22222222222222222222e0 * t97 * t40 * t100)
  ...
  t124 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (t35 * (0.1e1 / t66 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t50 - 0.5e1 / 0.9e1 * (0.14554132e0 * t72 + 0.256337604e0 * t52 * t39 + 0.11867481666666666667e-1 * t49) * t36 * t40) / t82) + (0.1e1 - t35) * t118))
  res = 0.2e1 * t124
  return res