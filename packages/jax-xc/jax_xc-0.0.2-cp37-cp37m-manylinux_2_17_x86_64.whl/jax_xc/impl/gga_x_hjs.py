...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t194 = 0.60965e0 + t183 + t192 / 0.3e1
  t195 = jnp.sqrt(t194)
  t198 = t34 * t47 / t195
  t201 = 0.60965e0 + t183
  t205 = s0 * t57
  ...
  t240 = jnp.sqrt(t183)
  t245 = jnp.where(0.e0 < 0.7572109999e0 + t183, 0.757211e0 + t183, 0.1e-9)
  t246 = jnp.sqrt(t245)
  t253 = t184 ** 2
  ...
  t308 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t198 / 0.3e1) / t201 + 0.26366444444444444444e-1 * t214 * (0.2e1 - t198 + t223 / 0.3e1) / t227 - (0.474596e-1 * t214 * t201 + 0.28363733333333333333e-1 * t227 - 0.9086532e0 * t234 - t236 * t234 * (t239 + 0.12e2 / 0.5e1 * t240 - 0.12e2 / 0.5e1 * t246)) * (0.8e1 - 0.5e1 * t198 + 0.1e2 / 0.3e1 * t223 - t256 / t257 / t44 * t261 / t195 / t263 / 0.3e1) / t234 / 0.9e1 + 0.2e1 / 0.3e1 * t34 * t47 * (t277 / 0.3e1 - t280 / 0.3e1) + 0.2e1 * t183 * t295 - 0.2e1 * t245 * t301))
  t310 = jnp.where(t10, t15, -t17)
  t311 = jnp.where(t14, t11, t310)
  t312 = 0.1e1 + t311
  t314 = t312 ** (0.1e1 / 0.3e1)
  t316 = jnp.where(t312 <= p.zeta_threshold, t23, t314 * t312)
  t318 = jnp.where(t36, t15, -t17)
  t319 = jnp.where(t38, t11, t318)
  t320 = 0.1e1 + t319
  t322 = t320 ** (0.1e1 / 0.3e1)
  t323 = jnp.where(t320 <= p.zeta_threshold, t22, t322)
  t324 = 0.1e1 / t323
  t325 = t324 * t46
  t327 = r1 ** 2
  t328 = r1 ** (0.1e1 / 0.3e1)
  ...
  t420 = 0.60965e0 + t413 + t418 / 0.3e1
  t421 = jnp.sqrt(t420)
  t424 = t34 * t325 / t421
  t427 = 0.60965e0 + t413
  t431 = s2 * t331
  ...
  t460 = jnp.sqrt(t427)
  t462 = jnp.sqrt(t413)
  t467 = jnp.where(0.e0 < 0.7572109999e0 + t413, 0.757211e0 + t413, 0.1e-9)
  t468 = jnp.sqrt(t467)
  t475 = t414 ** 2
  t479 = t420 ** 2
  t491 = 0.3e1 * t418
  ...
  t524 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t316 * t27 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t424 / 0.3e1) / t427 + 0.26366444444444444444e-1 * t440 * (0.2e1 - t424 + t447 / 0.3e1) / t451 - (0.474596e-1 * t440 * t427 + 0.28363733333333333333e-1 * t451 - 0.9086532e0 * t458 - t460 * t458 * (t239 + 0.12e2 / 0.5e1 * t462 - 0.12e2 / 0.5e1 * t468)) * (0.8e1 - 0.5e1 * t424 + 0.1e2 / 0.3e1 * t447 - t256 / t475 / t323 * t261 / t421 / t479 / 0.3e1) / t458 / 0.9e1 + 0.2e1 / 0.3e1 * t34 * t325 * (t493 / 0.3e1 - t496 / 0.3e1) + 0.2e1 * t413 * t511 - 0.2e1 * t467 * t517))
  res = t308 + t524
  return res
...
def unpol(r0, s0, params, p):
  ...
  t188 = 0.60965e0 + t178 + t186 / 0.3e1
  t189 = jnp.sqrt(t188)
  t192 = t26 * t30 / t189
  t195 = 0.60965e0 + t178
  ...
  t234 = jnp.sqrt(t178)
  t239 = jnp.where(0.e0 < 0.7572109999e0 + t178, 0.757211e0 + t178, 0.1e-9)
  t240 = jnp.sqrt(t239)
  t247 = t179 ** 2
  t251 = t181 ** 2
  t257 = t188 ** 2
  ...
  t302 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t192 / 0.3e1) / t195 + 0.26366444444444444444e-1 * t207 * (0.2e1 - t192 + t217 / 0.3e1) / t221 - (0.474596e-1 * t207 * t195 + 0.28363733333333333333e-1 * t221 - 0.9086532e0 * t228 - t230 * t228 * (0.4e1 / 0.5e1 * t232 + 0.12e2 / 0.5e1 * t234 - 0.12e2 / 0.5e1 * t240)) * (0.8e1 - 0.5e1 * t192 + 0.1e2 / 0.3e1 * t217 - t247 * p.cam_omega * t3 * t77 / t251 / t27 / t39 / r0 / t189 / t257 / 0.3e1) / t228 / 0.9e1 + 0.2e1 / 0.3e1 * t26 * t30 * (t271 / 0.3e1 - t274 / 0.3e1) + 0.2e1 * t178 * t289 - 0.2e1 * t239 * t295))
  res = 0.2e1 * t302
  return res