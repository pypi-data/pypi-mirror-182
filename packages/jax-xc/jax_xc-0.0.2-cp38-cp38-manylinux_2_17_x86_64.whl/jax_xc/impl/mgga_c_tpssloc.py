...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t85 = t84 ** 2
  t88 = jnp.where(-t6 <= -0.999999999999e0, 0.398e1, (0.35e0 + 0.87e0 * t8 / t9 + 0.5e0 * t16 + 0.226e1 * t13 * t8 / t14 / t9) / t85)
  t93 = t24 / 0.2e1
  t94 = t93 ** (0.1e1 / 0.3e1)
  t95 = t94 ** 2
  t101 = t27 / 0.2e1
  ...
  t147 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  ...
  t168 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t126 + 0.1549425e1 * t123 + 0.420775e0 * t129 + 0.1562925e0 * t136))
  t181 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t126 + 0.905775e0 * t123 + 0.1100325e0 * t129 + 0.1241775e0 * t136))
  ...
  t283 = t271 ** 2
  t285 = t281 * t282 * t283
  t291 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t276 + 0.8969e0 * t273 + 0.204775e0 * t279 + 0.123235e0 * t285))
  t293 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t273) * t291
  t294 = 0.2e1 <= p.zeta_threshold
  t296 = jnp.where(t294, t148, 0.2e1 * t154)
  t297 = 0.e0 <= p.zeta_threshold
  t298 = jnp.where(t297, t148, 0)
  t300 = (t296 + t298 - 0.2e1) * t157
  t311 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t276 + 0.1549425e1 * t273 + 0.420775e0 * t279 + 0.1562925e0 * t285))
  t324 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t276 + 0.905775e0 * t273 + 0.1100325e0 * t279 + 0.1241775e0 * t285))
  ...
  t415 = t405 ** 2
  t417 = t281 * t282 * t415
  t423 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t410 + 0.8969e0 * t407 + 0.204775e0 * t413 + 0.123235e0 * t417))
  t425 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t407) * t423
  t436 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t410 + 0.1549425e1 * t407 + 0.420775e0 * t413 + 0.1562925e0 * t417))
  t449 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t410 + 0.905775e0 * t407 + 0.1100325e0 * t413 + 0.1241775e0 * t417))
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t89 = 0.1e1 / t16
  t91 = t88 * t74 * t89
  t97 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t81 + 0.8969e0 * t78 + 0.204775e0 * t84 + 0.123235e0 * t91))
  t98 = (0.1e1 + 0.53425e-1 * t78) * t97
  t100 = t9 ** 2
  t101 = t19 <= p.zeta_threshold
  t102 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  ...
  t122 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t81 + 0.1549425e1 * t78 + 0.420775e0 * t84 + 0.1562925e0 * t91))
  t125 = 0.621814e-1 * t98
  t136 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t81 + 0.905775e0 * t78 + 0.1100325e0 * t84 + 0.1241775e0 * t91))
  ...
  t240 = t228 ** 2
  t242 = t238 * t239 * t240
  t248 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t233 + 0.8969e0 * t230 + 0.204775e0 * t236 + 0.123235e0 * t242))
  t250 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t230) * t248
  t251 = 0.2e1 <= p.zeta_threshold
  t253 = jnp.where(t251, t103, 0.2e1 * t11)
  t254 = 0.e0 <= p.zeta_threshold
  t255 = jnp.where(t254, t103, 0)
  t257 = (t253 + t255 - 0.2e1) * t111
  t268 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t233 + 0.1549425e1 * t230 + 0.420775e0 * t236 + 0.1562925e0 * t242))
  t281 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t233 + 0.905775e0 * t230 + 0.1100325e0 * t236 + 0.1241775e0 * t242))
  ...
  t363 = t353 ** 2
  t365 = t238 * t239 * t363
  t371 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t358 + 0.8969e0 * t355 + 0.204775e0 * t361 + 0.123235e0 * t365))
  t373 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t355) * t371
  t384 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t358 + 0.1549425e1 * t355 + 0.420775e0 * t361 + 0.1562925e0 * t365))
  t397 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t358 + 0.905775e0 * t355 + 0.1100325e0 * t361 + 0.1241775e0 * t365))
