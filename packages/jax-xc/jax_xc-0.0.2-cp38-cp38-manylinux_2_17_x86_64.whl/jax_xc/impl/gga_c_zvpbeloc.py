...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t27 = jnp.exp(-0.99999999999999999999e0 * t3 * t1 * t5 * t9 * t12 * t15 * t23)
  t28 = 3 ** (0.1e1 / 0.3e1)
  t30 = 4 ** (0.1e1 / 0.3e1)
  t31 = t30 ** 2
  t33 = t28 * t12 * t31 * t15
  ...
  t44 = t14 ** 2
  t47 = t41 * t42 * t30 / t44
  t53 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t36 + 0.8969e0 * t33 + 0.204775e0 * t39 + 0.123235e0 * t47))
  ...
  t64 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  ...
  t90 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t36 + 0.1549425e1 * t33 + 0.420775e0 * t39 + 0.1562925e0 * t47))
  t103 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t36 + 0.905775e0 * t33 + 0.1100325e0 * t39 + 0.1241775e0 * t47))
...
def unpol(r0, s0, params, p):
  ...
  t13 = r0 ** (0.1e1 / 0.3e1)
  t14 = 0.1e1 / t13
  t17 = jnp.where(0.1e-19 < 0.e0, 0, 0.1e-19)
  t21 = jnp.exp(-0.99999999999999999999e0 * t3 * t1 * t5 * t9 * t12 * t14 * t17)
  t22 = 3 ** (0.1e1 / 0.3e1)
  t24 = 4 ** (0.1e1 / 0.3e1)
  t25 = t24 ** 2
  t27 = t22 * t12 * t25 * t14
  ...
  t38 = t13 ** 2
  t41 = t35 * t36 * t24 / t38
  t47 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t30 + 0.8969e0 * t27 + 0.204775e0 * t33 + 0.123235e0 * t41))
  t49 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t27) * t47
  t50 = 0.1e1 <= p.zeta_threshold
  t51 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t53 = jnp.where(t50, t51 * p.zeta_threshold, 1)
  t56 = 2 ** (0.1e1 / 0.3e1)
  t71 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t30 + 0.905775e0 * t27 + 0.1100325e0 * t33 + 0.1241775e0 * t41))
