...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t104 = t103 ** 2
  t105 = t104 * t103
  t119 = (0.1e1 + 0.125e0 * t4 * t10 * (0.1e1 + 0.416675e-1 * t11)) / (0.1e1 + 0.125e0 * t4 * t10 * (0.1e1 + 0.740825e-1 * t11))
  t121 = s0 + 0.2e1 * s1 + s2
  t130 = jnp.sqrt(t121)
  t134 = t56 ** 2
  t139 = t130 / t8 / t7 * t134 / t103 / t14
  t141 = 0.45e1 + t139 / 0.4e1
  t144 = 0.45e1 + 0.36675e0 * t139
  t150 = 0.1e1 / t93
  t151 = t119 * t150
...
def unpol(r0, s0, params, p):
  ...
  t65 = t64 ** 2
  t66 = t65 * t64
  t80 = (0.1e1 + 0.125e0 * t4 * t9 * (0.1e1 + 0.416675e-1 * t10)) / (0.1e1 + 0.125e0 * t4 * t9 * (0.1e1 + 0.740825e-1 * t10))
  t81 = r0 ** 2
  t90 = jnp.sqrt(s0)
  t94 = t39 ** 2
  t99 = t90 / t7 / r0 * t94 / t64 / t13
  t101 = 0.45e1 + t99 / 0.4e1
  t104 = 0.45e1 + 0.36675e0 * t99
  t110 = 0.1e1 / t59
  t111 = t80 * t110
