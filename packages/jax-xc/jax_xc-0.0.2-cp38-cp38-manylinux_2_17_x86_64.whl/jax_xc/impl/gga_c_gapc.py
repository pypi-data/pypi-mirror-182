...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t220 = jnp.where(t216 <= p.zeta_threshold, t36, t218 * t216)
  t221 = 0.1e1 - t215
  t223 = t221 ** (0.1e1 / 0.3e1)
  t225 = jnp.where(t221 <= p.zeta_threshold, t36, t223 * t221)
  t228 = 0.2e1 <= p.zeta_threshold
  t230 = jnp.where(t228, t36, 0.2e1 * t40)
  t231 = 0.e0 <= p.zeta_threshold
  t232 = jnp.where(t231, t36, 0)
  t234 = (t230 + t232 - 0.2e1) * t43
  t245 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t14 + 0.1549425e1 * t11 + 0.420775e0 * t17 + 0.1562925e0 * t25))
  ...
  t280 = t271 * t279
  t281 = t40 ** 2
  t282 = jnp.where(t228, t120, t281)
  t283 = jnp.where(t231, t120, 0)
...
def unpol(r0, s0, params, p):
  ...
  t213 = jnp.where(t211, t35, 0.2e1 * t39)
  t214 = 0.e0 <= p.zeta_threshold
  t215 = jnp.where(t214, t35, 0)
  t217 = (t213 + t215 - 0.2e1) * t42
  t228 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t13 + 0.1549425e1 * t10 + 0.420775e0 * t16 + 0.1562925e0 * t24))
  ...
  t263 = t254 * t262
  t264 = t39 ** 2
  t265 = jnp.where(t211, t119, t264)
  t266 = jnp.where(t214, t119, 0)
