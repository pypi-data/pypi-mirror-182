...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t78 = t77 ** 2
  t79 = 0.1e1 / t78
  t86 = 0.3e1 / 0.8e1 / t33 * (t41 + 0.317708004743941464e0 * t45 + 0.41403379428206274608e-3 * t50) * t69 * t74 * (-t76 * t79 + 0.1e1) * t72
  ...
  t110 = t59 ** 2
  t111 = t61 ** 2
  t112 = jnp.where(t58, t110, t111)
  t113 = t66 ** 2
  t114 = jnp.where(t65, t110, t113)
...
def unpol(r0, s0, params, p):
  ...
  t59 = 2 ** (0.1e1 / 0.3e1)
  t60 = t59 - 0.1e1
  t67 = 0.1e1 / t32 * (t40 + 0.317708004743941464e0 * t44 + 0.41403379428206274608e-3 * t49) * (0.9e1 * t56 - 0.9e1) / 0.24e2
  t68 = t54 ** 2
