...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t66 = 0.1e1 / t65
  t68 = t64 * t49 * t66
  t74 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t57 + 0.8969e0 * t54 + 0.204775e0 * t60 + 0.123235e0 * t68))
  ...
  t84 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t85 = t84 * p.zeta_threshold
  t86 = t11 ** (0.1e1 / 0.3e1)
  t88 = jnp.where(t83, t85, t86 * t11)
  t89 = t23 <= p.zeta_threshold
  t90 = t23 ** (0.1e1 / 0.3e1)
  t92 = jnp.where(t89, t85, t90 * t23)
  t94 = 2 ** (0.1e1 / 0.3e1)
  t97 = 0.1e1 / (0.2e1 * t94 - 0.2e1)
  t98 = (t88 + t92 - 0.2e1) * t97
  t109 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t57 + 0.1549425e1 * t54 + 0.420775e0 * t60 + 0.1562925e0 * t68))
  t122 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t57 + 0.905775e0 * t54 + 0.1100325e0 * t60 + 0.1241775e0 * t68))
  ...
  t135 = t84 ** 2
  t136 = t86 ** 2
  t137 = jnp.where(t83, t135, t136)
  t138 = t90 ** 2
  t139 = jnp.where(t89, t135, t138)
  ...
  t207 = t52 * t94
  t208 = 0.1e1 / t84
  t210 = jnp.where(t83, t208, 0.1e1 / t86)
  t212 = t206 * t207 * t210
  t215 = jnp.sqrt(t212)
  t218 = t212 ** 0.15e1
  t220 = t64 * t49
  ...
  t222 = t210 ** 2
  t224 = t220 * t221 * t222
  t230 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t215 + 0.8969e0 * t212 + 0.204775e0 * t218 + 0.123235e0 * t224))
  t232 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t212) * t230
  t233 = 0.2e1 <= p.zeta_threshold
  t235 = jnp.where(t233, t85, 0.2e1 * t94)
  t236 = 0.e0 <= p.zeta_threshold
  t237 = jnp.where(t236, t85, 0)
  t239 = (t235 + t237 - 0.2e1) * t97
  t250 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t215 + 0.1549425e1 * t212 + 0.420775e0 * t218 + 0.1562925e0 * t224))
  t263 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t215 + 0.905775e0 * t212 + 0.1100325e0 * t218 + 0.1241775e0 * t224))
  ...
  t270 = jnp.where(t233, t135, t173)
  t271 = jnp.where(t236, t135, 0)
  ...
  t324 = jnp.where(t83, p.zeta_threshold, t11)
  t327 = jnp.where(t205, 0, (t134 * t275 * t320 - t232 + t267 + t269) * t324 / 0.2e1)
  t331 = s2 ** 2
  t334 = tau1 ** 2
  t337 = jnp.logical_or(r1 <= p.dens_threshold, t89)
  t339 = jnp.where(t89, t208, 0.1e1 / t90)
  t341 = t206 * t207 * t339
  t344 = jnp.sqrt(t341)
  t347 = t341 ** 0.15e1
  t349 = t339 ** 2
  t351 = t220 * t221 * t349
  t357 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t344 + 0.8969e0 * t341 + 0.204775e0 * t347 + 0.123235e0 * t351))
  t359 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t341) * t357
  t370 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t344 + 0.1549425e1 * t341 + 0.420775e0 * t347 + 0.1562925e0 * t351))
  t383 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t344 + 0.905775e0 * t341 + 0.1100325e0 * t347 + 0.1241775e0 * t351))
  ...
  t429 = jnp.where(t89, p.zeta_threshold, t23)
  t432 = jnp.where(t337, 0, (t134 * t275 * t425 - t359 + t387 + t389) * t429 / 0.2e1)
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t31 = 0.1e1 / t30
  t33 = t29 * t14 * t31
  t39 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t22 + 0.8969e0 * t19 + 0.204775e0 * t25 + 0.123235e0 * t33))
  ...
  t45 = jnp.where(t42, t44, 1)
  t48 = 2 ** (0.1e1 / 0.3e1)
  t51 = 0.1e1 / (0.2e1 * t48 - 0.2e1)
  t63 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t22 + 0.905775e0 * t19 + 0.1100325e0 * t25 + 0.1241775e0 * t33))
  ...
  t135 = jnp.where(t42, 0.1e1 / t43, 1)
  t137 = t13 * t15 * t17 * t48 * t135
  t140 = jnp.sqrt(t137)
  t143 = t137 ** 0.15e1
  t147 = t135 ** 2
  t149 = t29 * t14 * t31 * t103 * t147
  t155 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t140 + 0.8969e0 * t137 + 0.204775e0 * t143 + 0.123235e0 * t149))
  t157 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t137) * t155
  t158 = 0.2e1 <= p.zeta_threshold
  t160 = jnp.where(t158, t44, 0.2e1 * t48)
  t161 = 0.e0 <= p.zeta_threshold
  t162 = jnp.where(t161, t44, 0)
  t164 = (t160 + t162 - 0.2e1) * t51
  t175 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t140 + 0.1549425e1 * t137 + 0.420775e0 * t143 + 0.1562925e0 * t149))
  t188 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t140 + 0.905775e0 * t137 + 0.1100325e0 * t143 + 0.1241775e0 * t149))
  ...
  t195 = jnp.where(t158, t72, t103)
  t196 = jnp.where(t161, t72, 0)
  ...
  t245 = jnp.where(t42, p.zeta_threshold, 1)
  t248 = jnp.where(t131, 0, (t71 * t200 * t241 - t157 + t192 + t194) * t245 / 0.2e1)
