...
def pol(r0, r1, params, p):
  ...
  t82 = jnp.log(0.1e1 + (t13 - 0.2e1 * t29 * ((-0.9e0 + 0.3e1 / 0.16e2 * t34 * t35) * t9 * t3 + t41)) * t15 * t49 / 0.3e1 - 0.12e2 * t63 + (t13 - 0.2e1 * t29 * (-0.3e1 / 0.4e2 * t66 * t67 * t9 + t41)) * t14 * t78 / 0.3e1)
  t84 = t5 * t82 / 0.2e1
  t86 = t56 * t28
  t87 = 4 ** (0.1e1 / 0.4e1)
  t88 = t87 ** 2
  ...
  t130 = t121 / 0.2e1
  t139 = t122 ** 2
  t152 = jnp.log(0.1e1 + (t121 - 0.2e1 * t29 * (0.2e1 * (-0.9e0 + 0.3e1 / 0.16e2 * t34 * t35 * t122) * t9 * t3 + t130)) * t15 * t49 / 0.3e1 - 0.24e2 * t63 + (t121 - 0.2e1 * t29 * (-0.3e1 / 0.2e2 * t66 * t67 * t139 * t9 + t130)) * t14 * t78 / 0.3e1)
  t168 = (r0 - r1) / t21
  t169 = 0.1e1 + t168
  t171 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t172 = t171 * p.zeta_threshold
  t173 = t169 ** (0.1e1 / 0.3e1)
  t175 = jnp.where(t169 <= p.zeta_threshold, t172, t173 * t169)
  t176 = 0.1e1 - t168
  t178 = t176 ** (0.1e1 / 0.3e1)
  t180 = jnp.where(t176 <= p.zeta_threshold, t172, t178 * t176)
...
def unpol(r0, params, p):
  ...
  t81 = jnp.log(0.1e1 + (t13 - 0.2e1 * t28 * ((-0.9e0 + 0.3e1 / 0.16e2 * t33 * t34) * t9 * t3 + t40)) * t15 * t48 / 0.3e1 - 0.12e2 * t62 + (t13 - 0.2e1 * t28 * (-0.3e1 / 0.4e2 * t65 * t66 * t9 + t40)) * t14 * t77 / 0.3e1)
  t83 = t5 * t81 / 0.2e1
  t85 = t55 * t27
  t86 = 4 ** (0.1e1 / 0.4e1)
  t87 = t86 ** 2
  ...
  t129 = t120 / 0.2e1
  t138 = t121 ** 2
  t151 = jnp.log(0.1e1 + (t120 - 0.2e1 * t28 * (0.2e1 * (-0.9e0 + 0.3e1 / 0.16e2 * t33 * t34 * t121) * t9 * t3 + t129)) * t15 * t48 / 0.3e1 - 0.24e2 * t62 + (t120 - 0.2e1 * t28 * (-0.3e1 / 0.2e2 * t65 * t66 * t138 * t9 + t129)) * t14 * t77 / 0.3e1)
  t166 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t168 = jnp.where(0.1e1 <= p.zeta_threshold, t166 * p.zeta_threshold, 1)
