...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t153 = params.d[5]
  t154 = t135 ** 2
  t164 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.91464571985215458336e-2 * t34 * t40)) * t120 + t122 / t126 + (t129 * s0 * t39 + t132 * t135) / t138 + (t141 * t142 / t36 / t144 / r0 + t149 * s0 * t39 * t135 + t153 * t154) / t138 / t126))
  t166 = jnp.where(t10, t15, -t17)
  t167 = jnp.where(t14, t11, t166)
  t168 = 0.1e1 + t167
  t170 = t168 ** (0.1e1 / 0.3e1)
  t172 = jnp.where(t168 <= p.zeta_threshold, t23, t170 * t168)
  t174 = r1 ** 2
  t175 = r1 ** (0.1e1 / 0.3e1)
  t176 = t175 ** 2
  ...
  t262 = t174 ** 2
  t270 = t254 ** 2
  t280 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t172 * t27 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.91464571985215458336e-2 * t34 * t179)) * t244 + t122 / t248 + (t129 * s2 * t178 + t132 * t254) / t257 + (t141 * t260 / t175 / t262 / r1 + t149 * s2 * t178 * t254 + t153 * t270) / t257 / t248))
  res = t164 + t280
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t140 = t30 ** 2
  t152 = t131 ** 2
  t162 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.91464571985215458336e-2 * t21 / t24 * t34)) * t115 + params.d[0] / t121 + (params.d[1] * s0 * t126 + params.d[2] * t131) / t134 + (0.2e1 * params.d[3] * t138 * t27 / t19 / t140 / r0 + params.d[4] * s0 * t126 * t131 + params.d[5] * t152) / t134 / t121))
  res = 0.2e1 * t162
  return res