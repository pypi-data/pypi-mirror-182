...
def pol(r0, r1, params, p):
  ...
  t222 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t206 + 0.8969e0 * t203 + 0.204775e0 * t209 + 0.123235e0 * t216))
  ...
  t246 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t206 + 0.1549425e1 * t203 + 0.420775e0 * t209 + 0.1562925e0 * t216))
  t259 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t206 + 0.905775e0 * t203 + 0.1100325e0 * t209 + 0.1241775e0 * t216))
  t260 = (0.1e1 + 0.278125e-1 * t203) * t259
  res = -0.3e1 / 0.32e2 * t7 * t9 * t20 * t22 * t108 - 0.3e1 / 0.32e2 * t7 * t9 * t117 * t22 * t197 + 0.34602e1 * (-t224 + t226 / t228 * t235 * (-0.310907e-1 * (0.1e1 + 0.5137e-1 * t203) * t246 + t224 - 0.19751673498613801407e-1 * t260) + 0.19751673498613801407e-1 * t235 * t260) / (0.32e1 - 0.225e0 * t203 + t216 / 0.4e1)
  return res
...
def unpol(r0, params, p):
  ...
  t126 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t110 + 0.8969e0 * t107 + 0.204775e0 * t113 + 0.123235e0 * t120))
  t145 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t110 + 0.905775e0 * t107 + 0.1100325e0 * t113 + 0.1241775e0 * t120))
  res = -0.3e1 / 0.16e2 * t4 * t6 * t9 * t13 * t15 * t101 + 0.34602e1 * (-0.621814e-1 * (0.1e1 + 0.53425e-1 * t107) * t126 + 0.19751673498613801407e-1 * (0.2e1 * t13 - 0.2e1) / (0.2e1 * t8 - 0.2e1) * (0.1e1 + 0.278125e-1 * t107) * t145) / (0.32e1 - 0.225e0 * t107 + t120 / 0.4e1)
  return res