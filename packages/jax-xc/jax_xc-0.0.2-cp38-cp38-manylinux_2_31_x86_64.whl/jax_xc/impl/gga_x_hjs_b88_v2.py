...
def pol(r0, r1, s0, s1, s2, params, p):
  ...
  t41 = 0.1e1 + t40
  t43 = t41 ** (0.1e1 / 0.3e1)
  t44 = jnp.where(t41 <= p.zeta_threshold, t22, t43)
  t45 = 0.1e1 / t44
  t46 = 0.1e1 / t27
  t47 = t45 * t46
  t48 = 6 ** (0.1e1 / 0.3e1)
  ...
  t124 = 0.60965e0 + t111 + t122 / 0.3e1
  t125 = jnp.sqrt(t124)
  t128 = t34 * t47 / t125
  t131 = 0.60965e0 + t111
  ...
  t168 = jnp.sqrt(t111)
  t173 = jnp.where(0.e0 < 0.7572109999e0 + t111, 0.757211e0 + t111, 0.1e-9)
  t174 = jnp.sqrt(t173)
  t181 = t112 ** 2
  ...
  t238 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t128 / 0.3e1) / t131 + 0.26366444444444444444e-1 * t141 * (0.2e1 - t128 + t151 / 0.3e1) / t155 - (0.474596e-1 * t141 * t131 + 0.28363733333333333333e-1 * t155 - 0.9086532e0 * t162 - t164 * t162 * (t167 + 0.12e2 / 0.5e1 * t168 - 0.12e2 / 0.5e1 * t174)) * (0.8e1 - 0.5e1 * t128 + 0.1e2 / 0.3e1 * t151 - t186 / t187 / t44 * t191 / t125 / t193 / 0.3e1) / t162 / 0.9e1 + 0.2e1 / 0.3e1 * t34 * t47 * (t207 / 0.3e1 - t210 / 0.3e1) + 0.2e1 * t111 * t225 - 0.2e1 * t173 * t231))
  t240 = jnp.where(t10, t15, -t17)
  t241 = jnp.where(t14, t11, t240)
  t242 = 0.1e1 + t241
  t244 = t242 ** (0.1e1 / 0.3e1)
  t246 = jnp.where(t242 <= p.zeta_threshold, t23, t244 * t242)
  t248 = jnp.where(t36, t15, -t17)
  t249 = jnp.where(t38, t11, t248)
  t250 = 0.1e1 + t249
  t252 = t250 ** (0.1e1 / 0.3e1)
  t253 = jnp.where(t250 <= p.zeta_threshold, t22, t252)
  t254 = 0.1e1 / t253
  t255 = t254 * t46
  t256 = jnp.sqrt(s2)
  t257 = r1 ** (0.1e1 / 0.3e1)
  ...
  t303 = 0.60965e0 + t296 + t301 / 0.3e1
  t304 = jnp.sqrt(t303)
  t307 = t34 * t255 / t304
  t310 = 0.60965e0 + t296
  ...
  t340 = jnp.sqrt(t310)
  t342 = jnp.sqrt(t296)
  t347 = jnp.where(0.e0 < 0.7572109999e0 + t296, 0.757211e0 + t296, 0.1e-9)
  t348 = jnp.sqrt(t347)
  t355 = t297 ** 2
  t359 = t303 ** 2
  t371 = 0.3e1 * t301
  ...
  t404 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t246 * t27 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t307 / 0.3e1) / t310 + 0.26366444444444444444e-1 * t320 * (0.2e1 - t307 + t327 / 0.3e1) / t331 - (0.474596e-1 * t320 * t310 + 0.28363733333333333333e-1 * t331 - 0.9086532e0 * t338 - t340 * t338 * (t167 + 0.12e2 / 0.5e1 * t342 - 0.12e2 / 0.5e1 * t348)) * (0.8e1 - 0.5e1 * t307 + 0.1e2 / 0.3e1 * t327 - t186 / t355 / t253 * t191 / t304 / t359 / 0.3e1) / t338 / 0.9e1 + 0.2e1 / 0.3e1 * t34 * t255 * (t373 / 0.3e1 - t376 / 0.3e1) + 0.2e1 * t296 * t391 - 0.2e1 * t347 * t397))
  res = t238 + t404
  return res
...
def unpol(r0, s0, params, p):
  ...
  t95 = jnp.where(0.1e-9 < t93, t93, 0.1e-9)
  t96 = p.cam_omega ** 2
  t98 = t24 ** 2
  t100 = t27 ** 2
  t103 = t19 ** 2
  t106 = t96 * t3 / t98 / t100 / t103
  t108 = 0.60965e0 + t95 + t106 / 0.3e1
  t109 = jnp.sqrt(t108)
  t112 = t26 * t30 / t109
  t115 = 0.60965e0 + t95
  ...
  t153 = jnp.sqrt(t95)
  t158 = jnp.where(0.e0 < 0.7572109999e0 + t95, 0.757211e0 + t95, 0.1e-9)
  t159 = jnp.sqrt(t158)
  t166 = t96 ** 2
  t172 = t100 ** 2
  t178 = t108 ** 2
  ...
  t223 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (0.757211e0 + 0.47272888888888888889e-1 * (0.1e1 - t112 / 0.3e1) / t115 + 0.26366444444444444444e-1 * t125 * (0.2e1 - t112 + t136 / 0.3e1) / t140 - (0.474596e-1 * t125 * t115 + 0.28363733333333333333e-1 * t140 - 0.9086532e0 * t147 - t149 * t147 * (0.4e1 / 0.5e1 * t151 + 0.12e2 / 0.5e1 * t153 - 0.12e2 / 0.5e1 * t159)) * (0.8e1 - 0.5e1 * t112 + 0.1e2 / 0.3e1 * t136 - t166 * p.cam_omega * t3 / t98 / t23 / t172 / t27 / t103 / r0 / t109 / t178 / 0.3e1) / t147 / 0.9e1 + 0.2e1 / 0.3e1 * t26 * t30 * (t192 / 0.3e1 - t195 / 0.3e1) + 0.2e1 * t95 * t210 - 0.2e1 * t158 * t216))
  res = 0.2e1 * t223
  return res