...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t87 = s0 ** 2
  t88 = t34 ** 2
  t96 = (0.1e1 + 0.15045488888888888889e0 * t47 + 0.26899490462262948e-2 * t86 * t87 / t29 / t88 / r0) ** (0.1e1 / 0.5e1)
  t101 = 0.256337604e0 * t55 * t44
  t108 = t96 ** 2
  t124 = t49 / 0.4e1 - 0.9e1 / 0.2e2 + t47 / 0.36e2
  t125 = t124 ** 2
  t131 = s0 / r0 / tau0 / 0.8e1
  t133 = jnp.where(t131 < 0.1e1, t131, 0.1e1)
  ...
  t145 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (t84 * (0.1e1 / t96 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t47 - 0.5e1 / 0.9e1 * (0.14554132e0 * t33 + t101 + 0.11867481666666666667e-1 * t37) * t40 * t45) / t108) + (0.1e1 - t84) * t139))
  ...
  t203 = s2 ** 2
  t204 = t160 ** 2
  t212 = (0.1e1 + 0.15045488888888888889e0 * t167 + 0.26899490462262948e-2 * t86 * t203 / t155 / t204 / r1) ** (0.1e1 / 0.5e1)
  t222 = t212 ** 2
  t238 = t169 / 0.4e1 - 0.9e1 / 0.2e2 + t167 / 0.36e2
  t239 = t238 ** 2
  t245 = s2 / r1 / tau1 / 0.8e1
  t247 = jnp.where(t245 < 0.1e1, t245, 0.1e1)
  ...
  t259 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t153 * t27 * (t201 * (0.1e1 / t212 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t167 - 0.5e1 / 0.9e1 * (0.14554132e0 * t159 + t101 + 0.11867481666666666667e-1 * t163) * t40 * t45) / t222) + (0.1e1 - t201) * t253))
  res = t145 + t259
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t82 = s0 ** 2
  t84 = t29 ** 2
  t92 = (0.1e1 + 0.15045488888888888889e0 * t42 + 0.53798980924525896e-2 * t50 * t53 * t82 * t21 / t19 / t84 / r0) ** (0.1e1 / 0.5e1)
  t104 = t92 ** 2
  t119 = t44 / 0.4e1 - 0.9e1 / 0.2e2 + t42 / 0.36e2
  t120 = t119 ** 2
  t126 = s0 / r0 / tau0 / 0.8e1
  t128 = jnp.where(t126 < 0.1e1, t126, 0.1e1)
  ...
  t140 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (t79 * (0.1e1 / t92 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t42 - 0.5e1 / 0.9e1 * (0.14554132e0 * t27 + 0.256337604e0 * t50 * t39 + 0.11867481666666666667e-1 * t32) * t35 * t40) / t104) + (0.1e1 - t79) * t134))
  res = 0.2e1 * t140
  return res