...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t130 = 0.25e1 < t128
  t131 = jnp.where(t130, 0.25e1, t128)
  t133 = t131 ** 2
  t135 = t133 * t131
  t137 = t133 ** 2
  t146 = jnp.where(t130, t128, 0.25e1)
  t150 = jnp.exp(0.15e1 / (0.1e1 - t146))
  t152 = jnp.where(t128 <= 0.25e1, 0.1e1 - 0.64e0 * t131 - 0.4352e0 * t133 - 0.1535685604549e1 * t135 + 0.3061560252175e1 * t137 - 0.1915710236206e1 * t137 * t131 + 0.516884468372e0 * t137 * t133 - 0.51848879792e-1 * t137 * t135, -0.7e0 * t150)
