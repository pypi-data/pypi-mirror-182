...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t133 = jnp.where(t131, p.zeta_threshold, t130)
  t134 = t130 ** (0.1e1 / 0.3e1)
  t136 = jnp.where(t131, t22, 0.1e1 / t134)
  t138 = t16 * t20 * t136
  t141 = jnp.sqrt(t138)
  t144 = t138 ** 0.15e1
  t146 = t136 ** 2
  t148 = t38 * t42 * t146
  t154 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t141 + 0.8969e0 * t138 + 0.204775e0 * t144 + 0.123235e0 * t148))
  t156 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t138) * t154
  t167 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t141 + 0.1549425e1 * t138 + 0.420775e0 * t144 + 0.1562925e0 * t148))
  t180 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t141 + 0.905775e0 * t138 + 0.1100325e0 * t144 + 0.1241775e0 * t148))
  t181 = (0.1e1 + 0.278125e-1 * t138) * t180
  t190 = jnp.where(t132, 0, t133 * (-t156 + t64 * (-0.310907e-1 * (0.1e1 + 0.5137e-1 * t138) * t167 + t156 - 0.19751673498613801407e-1 * t181) + 0.19751673498613801407e-1 * t64 * t181) / 0.2e1)
  t192 = r1 ** (0.1e1 / 0.3e1)
  t193 = t192 ** 2
  t205 = r1 ** 2
  ...
  t223 = t217 ** 0.15e1
  t226 = t37 * t14 * t40
  t232 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t220 + 0.8969e0 * t217 + 0.204775e0 * t223 + 0.123235e0 * t226))
  t234 = 0.621814e-1 * (0.1e1 + 0.53425e-1 * t217) * t232
  t235 = t2 ** 2
  t236 = t235 ** 2
  t237 = t3 ** 2
  t238 = t237 ** 2
  t242 = jnp.where(t7, t55, t23 * t6)
  t244 = jnp.where(t131, t55, t134 * t130)
  t246 = (t242 + t244 - 0.2e1) * t63
  t257 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t220 + 0.1549425e1 * t217 + 0.420775e0 * t223 + 0.1562925e0 * t226))
  t270 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t220 + 0.905775e0 * t217 + 0.1100325e0 * t223 + 0.1241775e0 * t226))
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t130 = t124 ** 0.15e1
  t133 = t31 * t10 * t34
  t139 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t127 + 0.8969e0 * t124 + 0.204775e0 * t130 + 0.123235e0 * t133))
  t142 = jnp.where(t3, t49, 1)
  t156 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t127 + 0.905775e0 * t124 + 0.1100325e0 * t130 + 0.1241775e0 * t133))
