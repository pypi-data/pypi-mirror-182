...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t166 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t41)) * t120 + (0.1552e1 - 0.552e0 * t123) * t160))
  t168 = jnp.where(t10, t15, -t17)
  t169 = jnp.where(t14, t11, t168)
  t170 = 0.1e1 + t169
  t172 = t170 ** (0.1e1 / 0.3e1)
  t174 = jnp.where(t170 <= p.zeta_threshold, t23, t172 * t170)
  t176 = r1 ** 2
  t177 = r1 ** (0.1e1 / 0.3e1)
  t178 = t177 ** 2
  ...
  t280 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t174 * t27 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t182)) * t246 + (0.1552e1 - 0.552e0 * t249) * t274))
  res = t166 + t280
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t161 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t35)) * t115 + (0.1552e1 - 0.552e0 * t118) * t155))
  res = 0.2e1 * t161
  return res