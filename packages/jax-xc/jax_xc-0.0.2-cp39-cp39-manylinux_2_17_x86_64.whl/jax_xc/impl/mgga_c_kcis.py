...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t67 = 0.1e1 / t3
  t68 = t19 * t67
  t71 = jnp.where(0.e0 < t59, t59, -t59)
  ...
  t174 = jnp.where(t171, t36, t172 * t170)
  t175 = 0.1e1 - t169
  t176 = t175 <= p.zeta_threshold
  t177 = t175 ** (0.1e1 / 0.3e1)
  t179 = jnp.where(t176, t36, t177 * t175)
  t184 = jnp.where(0.2e1 <= p.zeta_threshold, t36, 0.2e1 * t40)
  t186 = jnp.where(0.e0 <= p.zeta_threshold, t36, 0)
  t188 = (t184 + t186 - 0.2e1) * t43
  t199 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t14 + 0.1549425e1 * t11 + 0.420775e0 * t17 + 0.1562925e0 * t25))
  t207 = -t33 + t188 * (-0.3109e-1 * (0.1e1 + 0.5137e-1 * t11) * t199 + t33 - 0.19751789702565206229e-1 * t56) + 0.19751789702565206229e-1 * t188 * t56
  t210 = t67 * t5
  t213 = jnp.where(0.e0 < t207, t207, -t207)
  t219 = jnp.log(0.1e1 + t61 * t65 * t19 * t210 / t213 / 0.96e2)
  t236 = jnp.where(t171, p.zeta_threshold, t170)
  t238 = t4 * t6
  t239 = t9 * t40
  t240 = 0.1e1 / t170
  ...
  t254 = t241 ** 2
  t256 = t251 * t253 * t254
  t262 = jnp.log(0.1e1 + 0.16081824322151104822e2 / (0.379785e1 * t246 + 0.8969e0 * t243 + 0.204775e0 * t249 + 0.123235e0 * t256))
  t264 = 0.62182e-1 * (0.1e1 + 0.53425e-1 * t243) * t262
  t275 = jnp.log(0.1e1 + 0.29608574643216675549e2 / (0.51785e1 * t246 + 0.905775e0 * t243 + 0.1100325e0 * t249 + 0.1241775e0 * t256))
  ...
  t287 = t5 * t8
  t288 = 0.1e1 / t241
  t291 = jnp.where(0.e0 < t279, t279, -t279)
  ...
  t407 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t246 + 0.1549425e1 * t243 + 0.420775e0 * t249 + 0.1562925e0 * t256))
  ...
  t422 = jnp.where(0.e0 < t415, t415, -t415)
  t429 = jnp.log(0.1e1 + t252 * s0 * t284 * t19 * t210 * t8 * t288 / t422 / 0.192e3)
  t450 = jnp.where(t176, p.zeta_threshold, t175)
  t452 = 0.1e1 / t175
  ...
  t463 = t453 ** 2
  t465 = t251 * t253 * t463
  t471 = jnp.log(0.1e1 + 0.16081824322151104822e2 / (0.379785e1 * t458 + 0.8969e0 * t455 + 0.204775e0 * t461 + 0.123235e0 * t465))
  t473 = 0.62182e-1 * (0.1e1 + 0.53425e-1 * t455) * t471
  t484 = jnp.log(0.1e1 + 0.29608574643216675549e2 / (0.51785e1 * t458 + 0.905775e0 * t455 + 0.1100325e0 * t461 + 0.1241775e0 * t465))
  ...
  t494 = s2 * t493
  t496 = 0.1e1 / t453
  t499 = jnp.where(0.e0 < t488, t488, -t488)
  ...
  t604 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t458 + 0.1549425e1 * t455 + 0.420775e0 * t461 + 0.1562925e0 * t465))
  ...
  t619 = jnp.where(0.e0 < t612, t612, -t612)
  t626 = jnp.log(0.1e1 + t252 * s2 * t493 * t19 * t210 * t8 * t496 / t619 / 0.192e3)
  res = t167 + (t174 + t179 - 0.2e1) * t43 * ((t207 / (0.1e1 + 0.66725e-1 * t219) + 0.69644166666666666665e-2 * t141) / (0.1e1 + 0.1875e0 * t156 - 0.4046875e-1 * t163) - t167) - s0 / r0 / tau0 * t236 * (t396 + t188 * ((t415 / (0.1e1 + 0.66725e-1 * t429) + 0.17411041666666666666e-2 * t364) / (0.1e1 + 0.9375e-1 * t380 - 0.101171875e-1 * t392) - t396)) / 0.16e2 - s2 / r1 / tau1 * t450 * (t593 + t188 * ((t612 / (0.1e1 + 0.66725e-1 * t626) + 0.17411041666666666666e-2 * t562) / (0.1e1 + 0.9375e-1 * t577 - 0.101171875e-1 * t589) - t593)) / 0.16e2
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t64 = 0.1e1 / t3
  t65 = t18 * t64
  t68 = jnp.where(0.e0 < t58, t58, -t58)
  ...
  t167 = jnp.where(0.2e1 <= p.zeta_threshold, t35, 0.2e1 * t39)
  t169 = jnp.where(0.e0 <= p.zeta_threshold, t35, 0)
  t171 = (t167 + t169 - 0.2e1) * t42
  t182 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t13 + 0.1549425e1 * t10 + 0.420775e0 * t16 + 0.1562925e0 * t24))
  t190 = -t32 + t171 * (-0.3109e-1 * (0.1e1 + 0.5137e-1 * t10) * t182 + t32 - 0.19751789702565206229e-1 * t55) + 0.19751789702565206229e-1 * t171 * t55
  t192 = s0 * t62 * t18
  t193 = t64 * t5
  t196 = jnp.where(0.e0 < t190, t190, -t190)
  t202 = jnp.log(0.1e1 + t192 * t193 / t196 / 0.96e2)
  t218 = jnp.where(t33, p.zeta_threshold, 1)
  t221 = t4 * t9 * t39
  t224 = jnp.sqrt(t221)
  t227 = t221 ** 0.15e1
  t229 = t39 ** 2
  t231 = t20 * t23 * t229
  t237 = jnp.log(0.1e1 + 0.16081824322151104822e2 / (0.379785e1 * t224 + 0.8969e0 * t221 + 0.204775e0 * t227 + 0.123235e0 * t231))
  t239 = 0.62182e-1 * (0.1e1 + 0.53425e-1 * t221) * t237
  t250 = jnp.log(0.1e1 + 0.29608574643216675549e2 / (0.51785e1 * t224 + 0.905775e0 * t221 + 0.1100325e0 * t227 + 0.1241775e0 * t231))
  t251 = (0.1e1 + 0.278125e-1 * t221) * t250
  t254 = -t239 + 0.19751789702565206229e-1 * t43 * t251
  t257 = jnp.where(0.e0 < t254, t254, -t254)
  ...
  t337 = jnp.log(0.1e1 + 0.32164683177870697974e2 / (0.705945e1 * t224 + 0.1549425e1 * t221 + 0.420775e0 * t227 + 0.1562925e0 * t231))
  ...
  t348 = jnp.where(0.e0 < t345, t345, -t345)
  t355 = jnp.log(0.1e1 + t63 * t65 * t5 / t348 / 0.96e2)
  res = t164 + t43 * ((t190 / (0.1e1 + 0.66725e-1 * t202) + 0.69644166666666666665e-2 * t138) / (0.1e1 + 0.1875e0 * t153 - 0.4046875e-1 * t160) - t164) - s0 * t85 / tau0 * t218 * (t326 + t171 * ((t345 / (0.1e1 + 0.66725e-1 * t355) + 0.34822083333333333332e-2 * t308) / (0.1e1 + 0.1875e0 * t319 - 0.4046875e-1 * t322) - t326)) / 0.8e1
  return res