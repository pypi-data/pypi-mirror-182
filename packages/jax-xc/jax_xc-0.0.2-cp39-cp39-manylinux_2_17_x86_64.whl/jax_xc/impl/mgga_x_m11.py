...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t239 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t28 * t100 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t114)) * t193 + (0.1552e1 - 0.552e0 * t196) * t233))
  t241 = jnp.where(t10, t15, -t17)
  t242 = jnp.where(t14, t11, t241)
  t243 = 0.1e1 + t242
  t245 = t243 ** (0.1e1 / 0.3e1)
  t247 = jnp.where(t243 <= p.zeta_threshold, t23, t245 * t243)
  t249 = jnp.where(t39, t15, -t17)
  t250 = jnp.where(t41, t11, t249)
  t251 = 0.1e1 + t250
  t253 = t251 ** (0.1e1 / 0.3e1)
  t254 = jnp.where(t251 <= p.zeta_threshold, t22, t253)
  ...
  t412 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t247 * t28 * t306 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t314)) * t378 + (0.1552e1 - 0.552e0 * t381) * t406))
  res = t239 + t412
  return res
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t225 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t20 * t83 * ((0.1804e1 - 0.646416e0 / (0.804e0 + 0.914625e-2 * t99)) * t179 + (0.1552e1 - 0.552e0 * t182) * t219))
  res = 0.2e1 * t225
  return res