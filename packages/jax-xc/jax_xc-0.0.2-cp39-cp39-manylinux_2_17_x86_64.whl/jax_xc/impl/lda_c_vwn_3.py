...
def pol(r0, r1, params, p):
  ...
  t86 = jnp.log(t84 * t72)
  t91 = jnp.pi ** 2
  t95 = 0.1e1 / (t12 + 0.534175e0 * t13 + 0.114813e2)
  ...
  t115 = t113 / t7
  t116 = 0.1e1 + t115
  t118 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t119 = t118 * p.zeta_threshold
  t120 = t116 ** (0.1e1 / 0.3e1)
  t122 = jnp.where(t116 <= p.zeta_threshold, t119, t120 * t116)
  t123 = 0.1e1 - t115
  t125 = t123 ** (0.1e1 / 0.3e1)
  t127 = jnp.where(t123 <= p.zeta_threshold, t119, t125 * t123)
...
def unpol(r0, params, p):
  ...
  t85 = jnp.log(t83 * t71)
  t90 = jnp.pi ** 2
  t95 = 0.1e1 / (t11 + 0.534175e0 * t12 + 0.114813e2)
  t99 = jnp.log(t4 * t9 * t95 / 0.4e1)
  t103 = jnp.arctan(0.6692072046645941483e1 / (t12 + 0.106835e1))
  t106 = (t26 + 0.228344e0) ** 2
  t108 = jnp.log(t106 * t95)
  t112 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t114 = jnp.where(0.1e1 <= p.zeta_threshold, t112 * p.zeta_threshold, 1)
  t118 = 2 ** (0.1e1 / 0.3e1)
  t119 = t118 - 0.1e1
