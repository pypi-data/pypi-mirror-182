...
def pol(r0, r1, s0, s1, s2, l0, l1, tau0, tau1, params, p):
  ...
  t135 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t118 + 0.8969e0 * t115 + 0.204775e0 * t121 + 0.123235e0 * t129))
  ...
  t145 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  ...
  t169 = jnp.log(0.1e1 + 0.32163958997385070134e2 / (0.705945e1 * t118 + 0.1549425e1 * t115 + 0.420775e0 * t121 + 0.1562925e0 * t129))
  t182 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t118 + 0.905775e0 * t115 + 0.1100325e0 * t121 + 0.1241775e0 * t129))
...
def unpol(r0, s0, l0, tau0, params, p):
  ...
  t111 = jnp.log(0.1e1 + 0.16081979498692535067e2 / (0.379785e1 * t95 + 0.8969e0 * t92 + 0.204775e0 * t98 + 0.123235e0 * t105))
  t114 = 0.1e1 <= p.zeta_threshold
  t115 = p.zeta_threshold ** (0.1e1 / 0.3e1)
  t117 = jnp.where(t114, t115 * p.zeta_threshold, 1)
  t134 = jnp.log(0.1e1 + 0.29608749977793437516e2 / (0.51785e1 * t95 + 0.905775e0 * t92 + 0.1100325e0 * t98 + 0.1241775e0 * t105))
