...
# remove dagster dependencies
# * remove dagster resource functions
# * remove `public` annotatinos entirely
# * remove merge_dicts and add own to utils
...
from dbtp.cli.utils import execute_cli, parse_manifest, parse_run_results, remove_run_results, merge_dicts
...
class DbtCliResource(DbtResource):
    ...
    def cli(self, command: str, **kwargs) -> DbtCliOutput:
        ...
        """
        command = rcheck.asset_str(command, "command")
