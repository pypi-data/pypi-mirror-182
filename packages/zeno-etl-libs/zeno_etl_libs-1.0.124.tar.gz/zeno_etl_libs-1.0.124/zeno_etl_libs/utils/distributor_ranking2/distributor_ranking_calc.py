"""
all calculations for ranking (DC & Franchisee) happens here
"""
...
def ranking_calc_dc(reset_date, time_interval_dc, as_ms_weights_dc_drug_lvl,
    ...
    df_features = preprocess_features_dc(df_features, df_dc_distributors_mapping,
                                         df_distributor_drugs, db, schema)
    ...
    rank_drug_lvl, rank_drug_type_lvl = calc_ranks_dc(
        features, as_ms_weights_dc_drug_lvl, as_ms_weights_dc_type_lvl, logger)

    final_ranks = get_final_ranks_dc(
        rank_drug_lvl, rank_drug_type_lvl, features, df_distributor_drugs,
        df_distributors, df_dc_distributors_mapping, as_ms_weights_dc_drug_lvl,
        logger)
    ...
    final_ranks_as_ms["order_type"] = "AS/MS"
    ranked_features_as_ms["order_type"] = "AS/MS"
    ...
    final_ranks = get_final_ranks_dc(
        rank_drug_lvl, rank_drug_type_lvl, features, df_distributor_drugs,
        df_distributors, df_dc_distributors_mapping, pr_weights_dc_drug_lvl,
        logger)
    ...
    final_ranks_pr["order_type"] = "PR"
    ranked_features_pr["order_type"] = "PR"
...
def ranking_calc_franchisee(reset_date, time_interval_franchisee,
    ...
    final_ranks["order_type"] = "ALL"
    ranked_features["order_type"] = "ALL"
