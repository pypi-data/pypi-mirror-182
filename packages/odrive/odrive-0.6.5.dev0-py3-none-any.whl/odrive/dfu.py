...
class ODriveInDfuMode(DfuDevice):
    ...
    def init(self, logger, ask):
        ...
        if is_odrive3:
            ...
            if ask:
                guess = 'ODrive Pro v4.4-58V' if 'OTP Memory' in self.memories else 'ODrive S1 X4'
        ...
        if path:
            ...
            async with aiohttp.ClientSession() as session:
                if channel:
                    ...
                    logger.info(f"Checking online for {product} firmware version {format_version(version)}...")
                ...
                try:
                    if channel:
                        ...
                        manifest = firmware_index.get_version(version, app='default', product=product)
