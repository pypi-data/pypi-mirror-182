...
MLFLOW_ECHO_QUERIES = "MLFLOW_ECHO_QUERIES"
...
def create_sqlalchemy_engine(db_uri):
    echo = (os.environ.get(MLFLOW_ECHO_QUERIES) or "").lower() == "true"
    ...
    return sqlalchemy.create_engine(db_uri, pool_pre_ping=True, echo=echo, **pool_kwargs)
