...
from kilroy_face_debug import resource_text
from kilroy_face_debug.face import Params
...
class Config(BaseConfig):
    ...
    state_directory: Path = CACHE_DIR / "kilroy-face-debug" / "state"
