...
class KdpConn(object):
    ...
    # WRITE
    def batch_write_v2(self, dataframe, dataset_id: str, jwt: str, security_label_info_params: SecurityLabelInfoParams = None, batch_size: int = 100, is_async: bool = True):
        """This method will be used to write batches of data to KDP
