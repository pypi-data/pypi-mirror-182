...
def doc_to_json(text:str='The quick fox jumped over the lazy dog.', add_gov:bool=False): 
	...
	doc = spacy.nlp(text)
	res = doc.to_json()
	if add_gov: [ res['tokens'][t.i].update({"glem": t.head.lemma_, "gpos":t.head.pos_}) for t in doc]
	return res 
