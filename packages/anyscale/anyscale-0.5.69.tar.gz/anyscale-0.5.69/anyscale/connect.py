...
class ClientBuilder:
    ...
    def __init__(
        ...
        if anyscale_sdk:
            ...
            self._log.debug("Using credentials {}".format(redacted_token))
    ...
    def _pin_protobuf_in_runtime_env_if_needed(
        ...
        if version.parse(self._ray.__version__) < version.parse("1.13.0"):
            ...
            if "conda" in runtime_env and isinstance(runtime_env["conda"], dict):
                if "dependencies" in runtime_env["conda"]:
    ...
    def _exec_self_in_head_node(self) -> None:
        ...
        try:
            ...
            os.chdir(cur_dir)
        self._os._exit(0)  # pylint:disable=private-use
