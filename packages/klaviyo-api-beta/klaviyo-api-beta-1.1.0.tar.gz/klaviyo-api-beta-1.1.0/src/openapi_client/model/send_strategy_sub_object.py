...
def lazy_import():
    ...
    globals()['StaticScheduleOptions'] = StaticScheduleOptions
    globals()['ThrottledScheduleOptions'] = ThrottledScheduleOptions


class SendStrategySubObject(ModelNormal):
    ...
    def _from_openapi_data(cls, method, *args, **kwargs):  # noqa: E501
        """SendStrategySubObject - a model defined in OpenAPI

        Args:
            method (str): Describes the shape of the options object
