...
class Elasticgraph:
    ...
    References
    ----------
    * Github : https://gitlab.com/rwsdatalab/public/codebase/tools/elasticgraphh
    * Fork Ger Hobbelts (Block 3104394): https://bl.ocks.org/GerHobbelt/3104394
    ...
    def write_html(self, json_data, overwrite: bool = True) -> None:
        ...
        try:
            ...
            jinja_env = Environment(loader=PackageLoader(package_name='elasticgraph', package_path='d3js'))
        index_template = jinja_env.get_template('index.html.j2')
        index_file = Path(self.D3graph.config['filepath'])
