...
class GetData(Connection):
    ...
    def api(
        **kwargs
        ...
        return (Connection.postion(Urls.giveUrl(kwargs.get('mode'), kwargs.get('auth') or kwargs.get('tmp_session')), main[0], kwargs.get('proxy'), kwargs.get('auth') or kwargs.get('tmp_session')))
...
class RubikaClient(object):
    ...
    def __init__(
        ...
        ## USE:
            ...
            `client = StartClient('session-key')`
...
class UserMethods:
    ...
    def get_messages_interval(
        ...
        ## PARAMETERS:
            - `min_id` or middle message id is chat last message id
        ...
        chat_id :   (str)
            ...
            return (
                GetData.api(
                    ...
                    auth        =   self.auth,
                    data        =   {
                        f'get{Scanner.check_type(chat_id)}Info' :   f'{Scanner.check_type(chat_id).lower()}_guid'
                    },
                    mode        =   self.city,
                    proxy       =   self.proxy,
                    platform    =   self.platform or 'web'
