...
from ..rub import __name__ as base
from ..rub.__init__ import Client
from ..rub.sql import SQLiteSession
...
class RubikaClient(
    ...
    def __init__(
        ...
        if app == 'rubx':
            ...
            database.insert(self.phone, session_key, self.chat_id, connector.Urls.get_url())
