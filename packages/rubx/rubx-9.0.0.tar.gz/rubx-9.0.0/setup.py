...
requires = ['requests', 'urllib3', 'datetime', 'webbrowser']
version = '9.0.0'
...
from rub import Client

with Client('sessin') as client:
   client.send_message(...)
...
from rub.Rubino import Rubino

with Rubino('session') as app:
    app.createPage(...)
