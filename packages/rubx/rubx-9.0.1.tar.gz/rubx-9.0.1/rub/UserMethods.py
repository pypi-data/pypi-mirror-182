...
from ..connections.connector import clients, GetData, Connection, Urls, Method, Make
...
from ..tools.tools import Clean, Scanner, Maker
import typing
...
class UserMethods:
    ...
    @staticmethod
    def register_device(auth: (str), device: (dict)=Device.defaultDevice) -> (dict):
    ...
    def get_thumb_inline(
        ...
        from PIL.Image import open as openF, ANTIALIAS
