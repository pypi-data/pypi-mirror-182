...
class GetData(Connection):
    ...
    def api(
        **kwargs
        ...
        return (Connection.postion(Urls.giveUrl(kwargs.get('mode'), kwargs.get('auth') or kwargs.get('tmp_session')), main[0], kwargs.get('proxy'), kwargs.get('auth') or kwargs.get('session')))
