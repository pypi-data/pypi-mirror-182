"""本模块包含许多用于 Rainfer.SendMessage 的 action 函数"""
from typing import Optional, TypeVar, Union, overload

from .. import get_running
from ..model import BotMessage  # typeLignore
from ..typing import SendMessageAction, SendMessageException  # type: ignore
...
class Safe(SendMessageAction):
    ...
    @overload
    async def exception(s, i):  # type:ignore
        ...
