"""本模块提供 Rainfer 内部使用的小工具, 以及方便的 `async_exec` 模块.
"""
...
from ..typing import DictStrAny, P, R, T  # type:ignore
...
def app_ctx_manager(func: Callable[P, R]) -> Callable[P, R]:
    """包装声明需要在 Rainfer Context 中执行的函数
    ...
    def wrapper(*args: P.args, **kwargs: P.kwargs):
        ...
        sys.audit("CallRainferAPI", func.__name__, args, kwargs)
