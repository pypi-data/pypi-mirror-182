...
class MessageEvent(MiraiEvent):
    ...
    class Dispatcher(BaseDispatcher):
        mixin = [MessageChainDispatcher, ChainSawDispatcher, SourceDispatcher, SenderDispatcher]
...
class ActiveFriendMessage(ActiveMessage):
    ...
    class Dispatcher(BaseDispatcher):
        mixin = [MessageChainDispatcher, ChainSawDispatcher, SourceDispatcher, SubjectDispatcher]
