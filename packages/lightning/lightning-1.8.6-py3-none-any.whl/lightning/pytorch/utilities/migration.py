...
import lightning.pytorch.utilities.argparse
...
class pl_legacy_patch:
    ...
    def __enter__(self) -> None:
        ...
        lightning.pytorch.utilities.argparse._gpus_arg_default = lambda x: x

    def __exit__(
        self, exc_type: type[BaseException] | None, exc_value: BaseException | None, exc_traceback: TracebackType | None
    ) -> None:
        if hasattr(lightning.pytorch.utilities.argparse, "_gpus_arg_default"):
            delattr(lightning.pytorch.utilities.argparse, "_gpus_arg_default")
