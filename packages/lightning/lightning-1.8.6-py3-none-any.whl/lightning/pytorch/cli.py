    ...
    def __init__(
        ...
        **kwargs: Any,  # Remove with deprecations of v1.10
        ...
        Args:
            ...
            seed_everything_default: Number for the :func:`~lightning.lite.utilities.seed.seed_everything`
        ...
        from lightning.pytorch.utilities.cli import _populate_registries
