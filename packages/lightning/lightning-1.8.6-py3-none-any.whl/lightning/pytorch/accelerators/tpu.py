...
from lightning.lite.accelerators.tpu import _parse_tpu_cores, _XLA_AVAILABLE
from lightning.lite.accelerators.tpu import TPUAccelerator as LiteTPUAccelerator
