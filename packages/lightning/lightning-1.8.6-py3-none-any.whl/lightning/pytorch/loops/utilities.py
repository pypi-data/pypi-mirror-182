...
from lightning.pytorch.trainer.progress import BaseProgress
...
def _extract_hiddens(training_step_output: STEP_OUTPUT, truncated_bptt_steps: int) -> Optional[Any]:
    ...
    Raises:
        MisconfigurationException: If :attr:`~lightning.pytorch.core.Lightning.LightningModule.truncated_bptt_steps` is
