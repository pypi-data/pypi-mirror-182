...
from lightning.lite.utilities.rank_zero import _get_rank, rank_zero_only, rank_zero_warn
...
def seed_everything(seed: Optional[int] = None, workers: bool = False) -> int:
    ...
    Args:
        ...
        workers: if set to ``True``, will properly configure all dataloaders passed to the
            ...
            :func:`~lightning.lite.utilities.seed.pl_worker_init_function`.
    """
    if seed is None:
...
def reset_seed() -> None:
    """Reset the seed to the value that :func:`lightning.lite.utilities.seed.seed_everything` previously set.

    If :func:`lightning.lite.utilities.seed.seed_everything` is unused, this function will do nothing.
    """
