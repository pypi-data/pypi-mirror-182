...
_PACKAGE_ROOT = os.path.join(_SOURCE_ROOT, "lightning.lite")
...
def _adjust_manifest(**__: Any) -> None:
    ...
    lines += ["recursive-include src/lightning.app/ui *" + os.linesep]
...
def _setup_args(**__: Any) -> Dict[str, Any]:
    ...
    return dict(
        ...
        packages=find_packages(where="src", include=["lightning.lite", "lightning.lite.*"]),
        package_dir={"": "src"},
