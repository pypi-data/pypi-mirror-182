...
from lightning.lite.plugins import Precision
from lightning.lite.plugins.precision.utils import _convert_fp_tensor
from lightning.lite.strategies import Strategy
...
from lightning.lite.utilities.types import Optimizable
    ...
    def __init__(
        ...
        Args:
            ...
            original_module: The original, unmodified module as passed into the
                :meth:`lightning.pytorch.lite.lite.LightningLite.setup` method. This is needed when attribute lookup
