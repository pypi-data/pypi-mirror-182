...
from lightning.lite.utilities.data import _auto_add_worker_init_fn, _replace_dunder_methods, has_iterable_dataset
...
from lightning.pytorch.utilities.auto_restart import _validate_fault_tolerant_automatic
