...
from lightning.lite.utilities.types import _LRScheduler, ReduceLROnPlateau
...
from lightning.pytorch.utilities.imports import _HIVEMIND_AVAILABLE
        ...
        **optimizer_kwargs: Any,
        ...
        Arguments:
            ...
            delay_optimizer_step: Run optimizer in background, apply results in future .step. requires
                :paramref:`~lightning.pytorch.strategies.hivemind.HivemindStrategy.offload_optimizer`.

            delay_grad_averaging: Average gradients in background; requires
                :paramref:`~lightning.pytorch.strategies.hivemind.HivemindStrategy.offload_optimizer` and
                :paramref:`~lightning.pytorch.strategies.hivemind.HivemindStrategy.delay_optimizer_step`.
