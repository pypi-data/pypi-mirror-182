...
from lightning.lite.strategies.fairscale import _FAIRSCALE_AVAILABLE
...
from lightning.lite.utilities.optimizer import _optimizers_to_device
from lightning.lite.utilities.seed import reset_seed
from lightning.lite.utilities.types import ReduceOp
...
from lightning.pytorch.utilities.imports import _IS_WINDOWS, _TORCH_GREATER_EQUAL_1_10, _TORCH_GREATER_EQUAL_1_11
