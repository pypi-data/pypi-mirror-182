...
from lightning.lite.utilities.device_dtype_mixin import _DeviceDtypeModuleMixin
from lightning.lite.utilities.distributed import _distributed_available, _sync_ddp
from lightning.lite.utilities.types import Steppable
...
from lightning.pytorch.utilities import _IS_WINDOWS, _TORCH_GREATER_EQUAL_1_10, GradClipAlgorithmType
from lightning.pytorch.utilities.exceptions import MisconfigurationException
from lightning.pytorch.utilities.imports import _TORCH_GREATER_EQUAL_1_11, _TORCH_GREATER_EQUAL_1_13
...
class LightningModule(
    ...
    def training_step(self, *args: Any, **kwargs: Any) -> STEP_OUTPUT:  # type: ignore[return-value]
        ...
        Args:
            ...
            hiddens (``Any``): Passed in if
                :paramref:`~lightning.pytorch.core.module.LightningModule.truncated_bptt_steps` > 0.
    ...
    def tbptt_split_batch(self, batch: Any, split_size: int) -> List[Any]:
        ...
        Note:
            ...
            :meth:`~lightning.pytorch.callbacks.base.Callback.on_train_batch_start`
            if :paramref:`~lightning.pytorch.core.module.LightningModule.truncated_bptt_steps` > 0.
