...
from lightning.lite.connector import _PLUGIN_INPUT as _LITE_PLUGIN_INPUT
from lightning.lite.connector import _PRECISION_INPUT
from lightning.lite.lite import LightningLite as _NewLightningLite
from lightning.lite.plugins import CheckpointIO, ClusterEnvironment
from lightning.lite.plugins import DeepSpeedPrecision as LiteDeepSpeedPrecision
from lightning.lite.plugins import DoublePrecision as LiteDoublePrecision
from lightning.lite.plugins import NativeMixedPrecision as LiteNativeMixedPrecision
from lightning.lite.plugins import Precision as LitePrecision
from lightning.lite.plugins import TPUBf16Precision as LiteTPUBf16Precision
from lightning.lite.plugins import TPUPrecision as LiteTPUPrecision
from lightning.lite.strategies import DataParallelStrategy as LiteDataParallelStrategy
from lightning.lite.strategies import DDPShardedStrategy as LiteDDPShardedStrategy
from lightning.lite.strategies import DDPSpawnShardedStrategy as LiteDDPSpawnShardedStrategy
from lightning.lite.strategies import DDPSpawnStrategy as LiteDDPSpawnStrategy
from lightning.lite.strategies import DDPStrategy as LiteDDPStrategy
from lightning.lite.strategies import DeepSpeedStrategy as LiteDeepSpeedStrategy
from lightning.lite.strategies import SingleDeviceStrategy as LiteSingleDeviceStrategy
from lightning.lite.strategies import SingleTPUStrategy as LiteSingleTPUStrategy
from lightning.lite.strategies import Strategy as LiteStrategy
from lightning.lite.strategies import XLAStrategy
...
from lightning.pytorch.plugins import NativeMixedPrecisionPlugin as PLNativeMixedPrecisionPlugin
...
def _to_lite_precision(plugin: Optional[PLPrecisionPlugin]) -> LitePrecision:
    ...
    raise TypeError(
        ...
        " please change it to subclass the `lightning.lite.plugins.precision.Precision` class. Otherwise, please open"
