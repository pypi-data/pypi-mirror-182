...
def is_meta_init() -> bool:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.is_meta_init` is deprecated in v1.8 and will be removed in v1.9."
...
def init_meta(module_fn: Callable[..., Module], *args: Any, **kwargs: Any) -> None:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.init_meta` is deprecated in v1.8 and will be removed in v1.9."
        " The function has become a no-op."
        " Please check out the `torchdistx` project instead: https://github.com/pytorch/torchdistx"
    )
...
def get_all_subclasses(cls: Type) -> Set[Type]:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.get_all_subclasses` is deprecated in v1.8 and will be removed in v1.9."
...
def recursively_setattr(root_module: Any, prefix: str, materialized_module: Module) -> None:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.recursively_setattr` is deprecated in v1.8 and will be removed in v1.9."
        " Please copy its implementation if you have a use for it."
    )
...
def materialize_module(root_module: Module) -> None:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.materialize_module` is deprecated in v1.8 and will be removed in v1.9."
        " The function has become a no-op."
        " Please check out the `torchdistx` project instead: https://github.com/pytorch/torchdistx"
    )
...
def init_meta_context() -> Generator:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.init_meta_context` is deprecated in v1.8 and will be removed in v1.9."
        " The function has become a no-op."
        " Please check out the `torchdistx` project instead: https://github.com/pytorch/torchdistx"
    )
    yield
...
def is_on_meta_device(module: Module) -> bool:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.meta.is_on_meta_device` is deprecated in v1.8 and will be removed in v1.9."
        " Please copy its implementation if you have a use for it."
    )
    try:
