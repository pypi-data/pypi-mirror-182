...
def inner_f(queue: Queue, func: Callable, *args: Any, **kwargs: Any) -> None:  # pragma: no cover
    ...
    from lightning.lite.accelerators.tpu import _inner_f
...
def pl_multi_process(func: Callable) -> Callable:
    ...
    from lightning.lite.accelerators.tpu import _multi_process
...
class XLADeviceUtils:
    ...
    def tpu_device_exists() -> bool:
        rank_zero_deprecation(
            ...
            " and will be removed in v1.10.0. Please use `lightning.pytorch.accelerators.TPUAccelerator.is_available()`"
            " instead."
        )
