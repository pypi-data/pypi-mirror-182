...
from lightning.lite.utilities.distributed import _all_gather_ddp_if_available as new_all_gather_ddp_if_available
from lightning.lite.utilities.distributed import _distributed_available as new_distributed_available
from lightning.lite.utilities.distributed import _gather_all_tensors as new_gather_all_tensors
...
from lightning.lite.utilities.distributed import _init_dist_connection as new_init_dist_connection
from lightning.lite.utilities.distributed import _sync_ddp as new_sync_ddp
from lightning.lite.utilities.distributed import _sync_ddp_if_available as new_sync_ddp_if_available
from lightning.pytorch.utilities.rank_zero import rank_zero_debug, rank_zero_deprecation, rank_zero_info
...
def all_gather_ddp_if_available(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.all_gather_ddp_if_available` has been deprecated in v1.8.0 and will"
...
def distributed_available() -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.distributed_available` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
...
def gather_all_tensors(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.gather_all_tensors` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
...
def get_default_process_group_backend_for_device(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.get_default_process_group_backend_for_device` has been deprecated"
        " in v1.8.0 and will be removed in v1.10.0. This function is internal but you can copy over its implementation."
        " `lightning.lite.utilities.distributed.get_default_process_group_backend_for_device` instead."
    )
...
def init_dist_connection(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.init_dist_connection` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
...
def sync_ddp(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.sync_ddp` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
...
def sync_ddp_if_available(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.sync_ddp_if_available` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
...
def tpu_distributed() -> bool:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.tpu_distributed` has been deprecated in v1.8.0 and will"
        " be removed in v1.10.0. This function is internal but you can copy over its implementation."
    )
    from lightning.lite.accelerators.tpu import _tpu_distributed
...
def rank_zero_only(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "`lightning.pytorch.utilities.distributed.rank_zero_only` has been deprecated in v1.8.1 and will"
        " be removed in v1.10.0. You can import it from `lightning.pytorch.utilities` instead."
    )
    from lightning.pytorch.utilities.rank_zero import rank_zero_only as new_rank_zero_only
