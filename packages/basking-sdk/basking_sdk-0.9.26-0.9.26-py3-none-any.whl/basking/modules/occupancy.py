...
class Occupancy:
    ...
    def get_building_occupancy_stats_daily(
        ...
        try:
            ...
            for start_date, end_date in date_slices:
                result = self.basking._graphql_query.graphql_executor(
                    *self.basking._graphql_query.get_building_occupancy_stats_daily_graphql_query(
                        building_id,
                        start_date,
                        end_date
                    )
    ...
    def _get_building_occupancy_hourly_pagination(
        ...
        query, variables = self.basking._graphql_query.get_building_occupancy_hourly_pagination_graphql_query(
            building_id,
            start_date,
            end_date
        )
        ...
        result = self.basking._graphql_query.graphql_executor(query=query, variables=variables)
    ...
    def get_floor_heatmap_kpi(
        ...
        query, variables = self.basking._graphql_query.get_floor_heatmap_kpi_graphql_query(
            basking_floor_id,
            start_date,
            end_date
        )
    ...
    def get_location_duration_of_visits(
        ...
        start_date = self.basking.utils.convert_timestamp_to_building_timezone(building_id, start_date)
        end_date = self.basking.utils.convert_timestamp_to_building_timezone(building_id, end_date)
        query, variables = self.basking._graphql_query.get_location_duration_of_visits_graphql_query(
            building_id,
            start_date,
            end_date,
        )
    ...
    def get_location_frequency_of_visits(
        ...
        query, variables = self.basking._graphql_query.get_location_frequency_of_visits_graphql_query(
            building_id,
            start_date,
            end_date,
        )
    ...
    def get_location_popular_days_of_visits(
        ...
        try:
            ...
            query, variables = self.basking._graphql_query.get_location_popular_days_of_visits_graphql_query(
                building_id,
                start_date,
                end_date,
            )
    ...
    def get_organization_duration_of_visits(
        ...
        try:
            query, variables = self.basking._graphql_query.get_organization_duration_of_visits_graphql_query(
    ...
    def get_organization_frequency_of_visits(
        ...
        try:
            query, variables = self.basking._graphql_query.get_organization_frequency_of_visits_graphql_query(
                organization_id=organization_id,
                start_date=datetime.combine(start_date, time()),
                end_date=datetime.combine(end_date, time()),
            )
    ...
    def get_organization_popular_days_of_visits(
        ...
        """
        query, variables = self.basking._graphql_query.get_organization_popular_days_of_visits_graphql_query(
            organization_id=organization_id,
            start_date=datetime.combine(start_date, time()),
            end_date=datetime.combine(end_date, time()),
        )
