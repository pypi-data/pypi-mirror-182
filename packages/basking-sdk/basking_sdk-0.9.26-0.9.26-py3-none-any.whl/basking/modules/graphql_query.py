...
class GraphqlQuery:
    ...
    def __init__(self, basking_obj):
        ...
        self.basking_api_url = os.getenv('BASKING_API_URL', 'https://api.basking.io/api/')
    ...
    @staticmethod
    def get_building_occupancy_stats_daily_graphql_query(building_id, start_date, end_date) -> (str, dict):
        ...
        return GET_LOCATION_STATS_DAILY, variables
    ...
    def get_building_occupancy_hourly_pagination_graphql_query(
        ...
        return GET_LOCATION_OCCUPANCY_HOURLY, variables
    ...
    @staticmethod
    def get_location_duration_of_visits_graphql_query(building_id, start_date, end_date) -> (str, dict):
        ...
        return GET_LOCATION_VISIT_DURATION, variables

    @staticmethod
    def get_location_frequency_of_visits_graphql_query(building_id, start_date, end_date) -> (str, dict):
        ...
        return GET_LOCATION_VISIT_FREQ, variables
    ...
    def get_location_popular_days_of_visits_graphql_query(
        ...
        return GET_LOCATION_POPULAR_VISIT_DAYS, variables
    ...
    @staticmethod
    def get_invite_list(location_id: str):
        return LOCATION_GET_INVITE_LIST, {'buildingid': location_id}

    @staticmethod
    def set_role(email: str, location_id: str, auth_group_id: int):
        return USER_SET_ROLE, {'email': email, 'locationId': location_id, 'authGroupId': auth_group_id}

    @staticmethod
    def grant_access(email: str, location_id: str, auth_group_id: int):
        """
        WARNING: calling this will implicitly create an invitation or a user if such does not exist
        """
        return USER_ADD_TO_LOCATION, {'email': email, 'locationId': location_id, 'authGroupId': auth_group_id}

    @staticmethod
    def revoke_access(user_id:str, location_id: str):
        return USER_REMOVE_FROM_LOCATION, {'userId': user_id, 'locationId': location_id}
