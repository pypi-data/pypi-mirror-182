...
class Organization:
    ...
    def get_user_organizations(self, pandify=False):
        ...
        query = self.basking._graphql_query.get_user_organizations_graphql_query()
    ...
    def get_organization_details(
        ...
        query, variables = self.basking._graphql_query.get_organization_details_graphql_query(
            organization_id
        )
...
"""
        query, variables = self.basking._graphql_query.get_hoteling_by_org_graphql_query(
            organization_id,
            start_date,
            end_date
        )
    ...
    def get_org_locations(
        ...
        """
        try:
            query, variables = self.basking._graphql_query.get_org_locations_graphql_query(organization_id)
            result = self.basking._graphql_query.graphql_executor(query=query, variables=variables)
            data = json.loads(result)
