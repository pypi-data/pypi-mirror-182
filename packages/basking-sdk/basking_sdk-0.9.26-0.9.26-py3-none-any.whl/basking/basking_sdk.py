...
from .modules.graphql_query import GraphqlQuery
from .modules.insight import Insight
from .modules.location import Location
from .modules.occupancy import Occupancy
...
class Basking:
    def __init__(self, *args, log_level='WARNING', **kwargs):
        ...
        self._graphql_query: GraphqlQuery = GraphqlQuery(basking_obj=self)
        self.insight: Insight = Insight(basking_obj=self)
        self.user: User = User(basking_obj=self)
        self.utils: Utils = Utils(basking_obj=self)
        self.admin: Admin = Admin(basking_obj=self)
    ...
    def api_timeout_handler(self, api_data):
        """
        for handle api timeout error coming from _graphql_query
