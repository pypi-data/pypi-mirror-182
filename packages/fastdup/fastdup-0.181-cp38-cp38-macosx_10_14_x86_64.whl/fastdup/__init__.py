...
def run(input_dir='',             
    ...
    Args:
        ...
        bounding_box (str): Optional bounding box to crop images, given as bounding_box='row_y=xx,col_x=xx,height=xx,width=xx'.
                            In addition, it is possible to set bounding_box='face' to crop the face from the image (in case present).
...
def create_components_gallery(work_dir, save_path, num_images=20, lazy_load=False, get_label_func=None,
    ...
    try:
        ...
        if isinstance(work_dir, str):
            ...
            assert '__id' in work_dir.columns, "Connected components dataframe should contain '__id' column"
        else:
