...
class Env():
    ...
    def make(self, scenario: dict, output_dir: str, visilize=False) -> Observation:
        observation = self.controller.init(scenario)
        self.recorder.init(observation, output_dir)
        self.visualizer.init(observation, visilize)
        return observation
