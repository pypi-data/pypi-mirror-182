...
class License(Video):
    ...
    car_path = "/home/pi/AiCar/file/license"
    model_pb_path = "/home/pi/AiCar/mylib/car.onnx"
    ...
    def red_light(self):
        ...
        while True:
            ...
            if success:
                ...
                cv2.line(img0,self.posion_A1,self.posion_A2,(255,255,255),3)
                cv2.line(img0,self.posion_B1,self.posion_B2,(255,255,255),3)
                cv2.rectangle(img0,(450,5),(610,60),(5,5,5),-1)
                cv2.circle(img0,(483,31),22,(0,10,250),-1)
                cv2.circle(img0,(528,31),22,(128,128,128),-1)
                cv2.circle(img0,(573,31),22,(128,128,128),-1)
                ...
                if (len(det_boxes)!=0) and (scores[0] > 0.8):
                    ...
                    if det_boxes[0][1]> 310 and det_boxes[0][3] < 460:
                        ...
                        self.result = HyperLPR_plate_recognition(img0)
