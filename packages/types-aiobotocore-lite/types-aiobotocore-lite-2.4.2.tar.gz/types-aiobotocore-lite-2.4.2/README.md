...
[aiobotocore 2.4.2](https://github.com/aio-libs/aiobotocore) compatible with
...
- `types-aiobotocore-lite[all]` - Type annotations for all 314 services.
...
- `types-aiobotocore-lite[gamelift]` - Type annotations for
  ...
  service.
- `types-aiobotocore-lite[gamesparks]` - Type annotations for
  [GameSparks](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_gamesparks/)
  service.
