...
class Font:
    ...
    @classmethod
    def render(cls, txt: strint, color: color_liked, size: int_f, ifBold: bool = ..., ifItalic: bool = ..., background_color: Optional[color_liked] = ...) -> ImageSurface: ...

class ArtisticFont:
    @staticmethod
    def render_description_box(txt: strint, color: color_liked, size: int, padding: int, background_color: color_liked, ifBold: bool = ..., ifItalic: bool = ..., outline_color: Optional[color_liked] = ..., thickness: int = ...) -> ImageSurface: ...
    @staticmethod
...
class PersistentVariables(TypeSafeGetter, TypeSafeSetter):
    ...
    @classmethod
    def save(cls) -> None: ...
PersistentData = PersistentVariables
