...
class GetConnectorAsync:
    def __init__(self, salureconnect_connection: SalureConnect, label: Union[str, List], test_environment: bool = False, debug: bool = False):
...
class ProfitExtractAsync:
    def __init__(self, salureconnect_connection: SalureConnect, label: Union[str, List], test_environment: bool = False, debug=False):
