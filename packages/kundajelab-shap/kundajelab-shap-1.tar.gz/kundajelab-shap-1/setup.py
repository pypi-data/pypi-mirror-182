...
def run_setup(with_binary=True, test_xgboost=True, test_lightgbm=True):
    ...
    setup(
        ...
        description='Kundaje lab edits to Scott Lundberg\'s unified approach to explain the output of any machine learning model.',
        long_description_content_type="text/markdown",
        url='http://github.com/kundajelab/shap',
        author='Avanti Shrikumar\'s modifications to Scott Lundberg original package',
