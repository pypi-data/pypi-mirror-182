...
setup(
    ...
    install_requires=['reahl-component>=6.1,<6.2', 'reahl-mailutil>=6.1,<6.2', 'ply>=3.8,<3.11.999', 'rjsmin>=1.2.0,<1.2.999', 'rcssmin>=1.1.0,<1.1.999', 'beautifulsoup4>=4.6,<4.11.999', 'WebOb>=1.8,<1.8.999', 'Babel>=2.1,<2.11.999', 'setuptools>=51.0.0', 'lxml>=4.2,<4.9.999'],
