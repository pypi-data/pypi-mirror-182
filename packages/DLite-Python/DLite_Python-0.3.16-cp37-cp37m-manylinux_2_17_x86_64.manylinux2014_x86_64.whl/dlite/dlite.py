...
class Instance(object):
    ...
    def __init__(self, metaid=None, dims=None, id=None, url=None, storage=None, driver=None, location=None, options=None, uri=None, jsoninput=None, dimensions=None, properties=None, description=None):
        r"""
    ...
    def tojson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False):
        r"""tojson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False) -> char *"""
