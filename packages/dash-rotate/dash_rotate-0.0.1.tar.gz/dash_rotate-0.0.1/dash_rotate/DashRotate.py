...
- reload (boolean; default True)"""
    ...
    _type = 'DashRotate'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, orientation=Component.REQUIRED, message=Component.UNDEFINED, reload=Component.UNDEFINED, delay=Component.UNDEFINED, **kwargs):
