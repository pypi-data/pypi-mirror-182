...
class ControlPage(EmbeddedPage):
    ...
    def change_style(self):
        ...
        self.sections_panel.item(0).setIcon(QIcon('./ui/custom/svg/settings.svg'))
        self.sections_panel.item(1).setIcon(QIcon('./ui/custom/svg/history.svg'))
        self.sections_panel.item(2).setIcon(QIcon('./ui/custom/svg/bookmark_empty.svg'))
        self.sections_panel.item(3).setIcon(QIcon('./ui/custom/svg/downloads.svg'))
