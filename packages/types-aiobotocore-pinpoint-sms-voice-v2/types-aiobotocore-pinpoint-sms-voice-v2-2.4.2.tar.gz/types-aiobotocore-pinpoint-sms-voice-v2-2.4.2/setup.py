...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.PinpointSMSVoiceV2 2.4.2 service generated with"
    ...
    keywords=(
        "aiobotocore pinpoint-sms-voice-v2 type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
