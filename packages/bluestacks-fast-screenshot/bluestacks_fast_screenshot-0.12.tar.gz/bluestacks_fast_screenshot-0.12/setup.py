...
setup(
    ...
    #packages=['a_cv2_easy_resize', 'ctypes_screenshots', 'ctypes_window_info', 'opencv_python', 'pandas'],
    ...
    install_requires=['a_cv2_easy_resize', 'ctypes_screenshots', 'ctypes_window_info', 'opencv_python', 'pandas'],
