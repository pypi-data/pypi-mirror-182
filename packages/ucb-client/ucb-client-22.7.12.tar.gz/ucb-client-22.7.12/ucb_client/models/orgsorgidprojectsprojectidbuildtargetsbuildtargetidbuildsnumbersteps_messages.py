...
class OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages(object):
    ...
    def __init__(self, content=None, type_code=None, _configuration=None):  # noqa: E501
        """OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def content(self):
        """Gets the content of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501


        :return: The content of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501
        :rtype: str
        """
    ...
    def content(self, content):
        """Sets the content of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.


        :param content: The content of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type_code(self):
        """Gets the type_code of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501


        :return: The type_code of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501
        :rtype: int
        """
    ...
    def type_code(self, type_code):
        """Sets the type_code of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.


        :param type_code: The type_code of this OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages):
            return False
