...
class OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRef(object):
    ...
    def __init__(self, platform=None, label=None, credentialid=None, created=None, last_mod=None, certificate=None, provisioning_profile=None, keystore=None, links=None, _configuration=None):  # noqa: E501
