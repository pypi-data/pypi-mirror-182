...
class InlineResponse20010(object):
    ...
    def __init__(self, platform=None, label=None, credentialid=None, created=None, last_mod=None, certificate=None, provider_name=None, apple_id_username=None, links=None, _configuration=None):  # noqa: E501
