...
class OrgsorgidprojectsprojectidartifactsdeleteBuilds(object):
    ...
    def __init__(self, buildtargetid=None, build=None, _configuration=None):  # noqa: E501
    ...
    def buildtargetid(self, buildtargetid):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and buildtargetid is None:
    ...
    def build(self, build):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and build is None:
