...
class OrgsorgidprojectsprojectidbuildtargetsSettingsScm(object):
    ...
    def __init__(self, type=None, repo=None, branch=None, subdirectory=None, client=None, _configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["git", "svn", "p4", "hg", "oauth", "plastic"]  # noqa: E501
    ...
    @property
    def repo(self):
        """Gets the repo of this OrgsorgidprojectsprojectidbuildtargetsSettingsScm.  # noqa: E501

        Which repo to use. Only applies to Plastic SCM, other SCM types configure repo on the project level.  # noqa: E501

        :return: The repo of this OrgsorgidprojectsprojectidbuildtargetsSettingsScm.  # noqa: E501
        :rtype: str
        """
        return self._repo
    ...
    @repo.setter
    def repo(self, repo):
        """Sets the repo of this OrgsorgidprojectsprojectidbuildtargetsSettingsScm.

        Which repo to use. Only applies to Plastic SCM, other SCM types configure repo on the project level.  # noqa: E501

        :param repo: The repo of this OrgsorgidprojectsprojectidbuildtargetsSettingsScm.  # noqa: E501
        :type: str
        """
