...
class OrgsorgidcredentialssigningiosProvisioningProfile(object):
    ...
    def __init__(self, team_id=None, bundle_id=None, expiration=None, is_enterprise_profile=None, type=None, num_devices=None, uploaded=None, provisioned_devices=None, _configuration=None):  # noqa: E501
