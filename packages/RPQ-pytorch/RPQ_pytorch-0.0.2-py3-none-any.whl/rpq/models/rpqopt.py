...
""" PyTorch OPT model from huggingface repo modified w/ RPQ modules."""
import random
...
class RPQOPTDecoder(OPTPreTrainedModel):
    """
...
class RPQOPTForCausalLM(OPTPreTrainedModel):
...
class RPQOPTForSequenceClassification(OPTPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"lm_head.weight"]
...
class RPQOPTForQuestionAnswering(OPTPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"lm_head.weight"]
