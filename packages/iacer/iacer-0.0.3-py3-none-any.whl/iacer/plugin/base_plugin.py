...
from iacer.plugin import error_code
from iacer.util import pascal_to_snake
...
class TeaSDKPlugin(metaclass=abc.ABCMeta):
    ...
    async def send_request(self, request_name: str, **kwargs) -> dict:
        ...
        try:
            ...
            LOG.exception(f'plugin exception: {self.product} {self.endpoint} {api_name} {request.to_map()} {ex.data}')
            raise ex
