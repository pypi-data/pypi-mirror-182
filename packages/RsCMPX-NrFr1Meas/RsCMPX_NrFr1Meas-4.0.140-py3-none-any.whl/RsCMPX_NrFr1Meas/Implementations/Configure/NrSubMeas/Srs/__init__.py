...
class SrsCls:
	"""Srs commands group definition. 12 total commands, 3 Subgroups, 5 group commands"""
	...
	def get_sposition(self) -> int:
		...
		Defines the start position of the SRS resource. \n
			:return: start_position: The allowed range depends on the SCS.
		"""
	...
	def set_sposition(self, start_position: int) -> None:
		...
		Defines the start position of the SRS resource. \n
			:param start_position: The allowed range depends on the SCS.
		"""
