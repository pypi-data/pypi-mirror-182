...
class NrSubMeasCls:
	"""NrSubMeas commands group definition. 281 total commands, 12 Subgroups, 4 group commands"""
	...
	@property
	def network(self):
		"""network commands group. 4 Sub-classes, 5 commands."""
	...
	@property
	def rfSettings(self):
		"""rfSettings commands group. 1 Sub-classes, 5 commands."""
	...
	@property
	def srs(self):
		"""srs commands group. 3 Sub-classes, 5 commands."""
	...
	def get_nantenna(self) -> int:
		...
		Selects the number of UE TX antennas to be measured. With RF path sharing, this command is not applicable. \n
	...
	def get_band(self) -> enums.Band:
		...
		Network, use[CONFigure:]SIGNaling:NRADio:CELL:RFSettings:FBINdicator. \n
			:return: band: TDD: OB34 | OB38 | ... | OB41 | OB46 | OB47 | OB48 | OB50 | OB51 | OB53 | OB77 | ... | OB84 | OB86 | OB89 | OB90 | OB95 | OB97 | OB98 | OB99
		"""
	...
	def set_band(self, band: enums.Band) -> None:
		...
		Selects the operating band (OB) . The allowed input range depends on the duplex mode (FDD or TDD) . For Signal Path =
		Network, use[CONFigure:]SIGNaling:NRADio:CELL:RFSettings:FBINdicator. \n
			:param band: TDD: OB34 | OB38 | ... | OB41 | OB46 | OB47 | OB48 | OB50 | OB51 | OB53 | OB77 | ... | OB84 | OB86 | OB89 | OB90 | OB95 | OB97 | OB98 | OB99
		"""
	...
	def get_ncarrier(self) -> int:
		...
		Configures the number of contiguously aggregated UL carriers in the measured signal. With RF path sharing, this command
		is not applicable. \n
			:return: number: No help available
		"""
