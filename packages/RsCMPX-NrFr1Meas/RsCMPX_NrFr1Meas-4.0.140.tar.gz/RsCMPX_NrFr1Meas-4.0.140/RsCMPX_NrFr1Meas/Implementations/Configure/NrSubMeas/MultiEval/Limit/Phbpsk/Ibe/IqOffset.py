...
class IqOffsetCls:
	...
	def set(self, offset_0: float, offset_1: float, offset_2: float, offset_3: float) -> None:
		...
		self._core.io.write(f'CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:PHBPsk:IBE:IQOFfset {param}'.rstrip())
	...
	def get(self) -> IqOffsetStruct:
		...
		return self._core.io.query_struct(f'CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:PHBPsk:IBE:IQOFfset?', self.__class__.IqOffsetStruct())
