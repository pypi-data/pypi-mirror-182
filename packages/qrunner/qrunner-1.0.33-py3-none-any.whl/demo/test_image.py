...
class HomePage(qrunner.Page):
    ...
    patent_entry = {'text': '查专利', 'desc': '查专利入口'}
...
class PatentSearch(qrunner.Page):
    """查专利"""
    report_entry = {"image": "patent_report_entry.png", "desc": "分析报告"}
    tech_report = {"image": "patent_tech_entry.png", "desc": "技术全景报告入口"}
    create_tech = {'image': 'patent_create_tech_title.png', 'desc': '创建技术报告标题'}
