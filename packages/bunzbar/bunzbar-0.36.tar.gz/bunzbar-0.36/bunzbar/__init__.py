...
def main():                                  
    ...
    parser.add_argument("-t", "--toggle", metavar="<info>", type=str, nargs='+') #For info toggles
    parser.add_argument("-s", "--set") #For config options
    parser.add_argument("-l", "--list", action="store_true") #For info toggles or options
