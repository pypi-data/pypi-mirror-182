...
class WPCUserInputs(QDialog):
    ...
    def add_ptmc_code_input(self):
        ...
        self.ptmc_code.setValidator(
            QRegExpValidator(QRegExp("[0-9A-Fa-f]{4}")))
    ...
    def add_qi_id_input(self):
        ...
        self.qi_id.setValidator(QRegExpValidator(QRegExp("[0-9]{6}")))
    ...
    def add_ca_seqid_input(self):
        ...
        self.ca_seqid.setValidator(QRegExpValidator(QRegExp("[0-9A-Fa-f]{2}")))
