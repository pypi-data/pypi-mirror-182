...
class MessageGroupsQueueSearchRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["end_timestamp",b"end_timestamp","external_queue",b"external_queue","keep_alive",b"keep_alive","message_group",b"message_group","send_raw_directly",b"send_raw_directly","start_timestamp",b"start_timestamp","sync_interval",b"sync_interval"]) -> None: ...
