...
def main():
    ...
    if args.version:
        ...
        import pythonav
        import pythonav._core

        print("PyAV v" + pythonav.__version__)

        by_config = {}
        for libname, config in sorted(pythonav._core.library_meta.items()):
    ...
    if args.codecs:
        from pythonav.codec.codec import dump_codecs
