...
#
about = {}
with open('../pythonav/about.py') as fp:
    exec(fp.read(), about)
...
import pythonav
from pythonav.datasets import fate, fate as fate_suite, curated
...
extlinks = {
    ...
    'issue': ('https://github.com/dot-six/python-av/issues/%s', '#'),
    'pr': ('https://github.com/dot-six/python-av/pull/%s', '#'),
