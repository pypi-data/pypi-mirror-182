...
class TestPythonIO(TestCase):
    def test_basic_errors(self):
        self.assertRaises(Exception, pythonav.open, None)
        self.assertRaises(Exception, pythonav.open, None, "w")
    ...
    def test_writing_to_buffer(self):
        ...
        buf.seek(0)
        with pythonav.open(buf) as container:
    ...
    def test_writing_to_buffer_broken(self):
        ...
        with self.assertRaises(OSError):
            with pythonav.open(buf, "w", "mp4") as container:
    ...
    def test_writing_to_custom_io_dash(self):
        ...
        with pythonav.open(output_filename, "r") as container:
    ...
    def test_writing_to_custom_io_image2(self):
        ...
        input_frame = pythonav.VideoFrame.from_image(image)
        ...
        # Check contents.
        with pythonav.open(sequence_filename, "r", "image2") as container:
            self.assertEqual(len(container.streams), 1)
            stream = container.streams[0]
            self.assertIsInstance(stream, pythonav.video.stream.VideoStream)
    ...
    def test_writing_to_file(self):
        ...
        # Check contents.
        with pythonav.open(path) as container:
            assert_rgb_rotate(self, container)
    ...
    def read(self, fh, seekable=True):
        ...
        with pythonav.open(wrapped) as container:
    ...
    def write(self, fh):
        ...
        with pythonav.open(wrapped, "w", "mp4") as container:
            write_rgb_rotate(container)
