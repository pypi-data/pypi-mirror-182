...
def fix_doctests(suite):
    ...
    for case in suite._tests:
        ...
        case._dt_test.globs["pythonav"] = pythonav
        case._dt_test.globs["video_path"] = pythonav.datasets.curated(
...
for importer, mod_name, ispkg in pkgutil.walk_packages(
    path=pythonav.__path__, prefix=pythonav.__name__ + ".", onerror=lambda x: None
):
