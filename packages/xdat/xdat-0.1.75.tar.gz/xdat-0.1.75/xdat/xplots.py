...
def post_plot(title='', legend=True, xlim=None, ylim=None, xlabel=None, ylabel=None, tight_layout=True, show=True, y_auc=False):
    """
...
def plot_multi(df, kind='scatter', plot_func=None, x=None, y=None, plot_on=None, group_on=None, color_on=None, cmap=None, label_on=None, style_on=None, size_on=None, figsize=(10,6), alpha=1.0, hdi_probs=(0.1, 0.25, 0.5, 0.8, 0.999), color_dict=None, title='', x_axis_type=None, y_axis_type=None, legend_loc='best', xlim=None, ylim=None, save_to=None, clear_folder=False, add_date=True, show=True, **kwargs):
    """
