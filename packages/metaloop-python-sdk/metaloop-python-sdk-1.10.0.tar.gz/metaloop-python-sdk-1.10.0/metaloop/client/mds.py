...
class MDS:
    ...
    def call_model_convert_path_status(self, data: Dict[str, Any]) -> None:
    ...
    def call_model_test_status(self, data: Dict[str, Any]) -> None:
    ...
    def call_model_test_result_content(self, data: Dict[str, Any]) -> None:
    ...
    def send_notice(self,
        ...
        Arguments:
            ...
            usernames: the users you want to notice, if usernamse is nil , then notice will send to yourself.
