    ...
    def NatGatway(self):
        ...
        with open('NatGatewaydata.csv','w', newline = '') as csvfile:
            ...
            for i in gateways:
                ...
                data=[natgatewayid['NatGatewayId'],state['State'],Allocation_id['Allocation_Id'],NetworkInterfaceId['Network_Interface_Id'],Private_Ip['Private_IP'],Public_Ip['Public_IP']]
                writer.writerow(data)
