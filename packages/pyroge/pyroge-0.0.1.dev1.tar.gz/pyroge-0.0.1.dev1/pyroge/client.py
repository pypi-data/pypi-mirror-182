...
import pyroge
from pyroge import __version__, __license__
from pyroge import enums
from pyroge import raw
from pyroge import utils
from pyroge.crypto import aes
from pyroge.errors import CDNFileHashMismatch
from pyroge.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from pyroge.handlers.handler import Handler
from pyroge.methods import Methods
from pyroge.session import Auth, Session
from pyroge.storage import FileStorage, MemoryStorage
from pyroge.types import User, TermsOfService
from pyroge.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyroge.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyroge.enums.ParseMode`):
        ...
        try:
            ...
            if isinstance(r, raw.types.upload.File):
                ...
                try:
                    ...
                    raise e
        except pyroge.StopTransmission:
            raise
        except Exception as e:
            log.error(e, exc_info=True)
