...
from pyroge.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyroge.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyroge.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyroge.handlers.MessageHandler` the *update* argument will be a :obj:`~pyroge.types.Message`; in a :obj:`~pyroge.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyroge.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyroge.filters.command` or :meth:`~pyroge.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyroge.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyroge.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyroge.types.Message`.
    ...
    async def func(flt, client: pyroge.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroge.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyroge.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyroge.types.InlineQuery`: The filter will match ``query``.
