...
import pyroge
from pyroge import StopTransmission, enums
from pyroge import raw
from pyroge import types
from pyroge import utils
from pyroge.errors import FilePartMissing
from pyroge.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyroge.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyroge.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroge.Client.stop_transmission`, None is returned.
