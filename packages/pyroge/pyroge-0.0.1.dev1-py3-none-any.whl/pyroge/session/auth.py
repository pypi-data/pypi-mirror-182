...
from pyroge.crypto import aes, rsa, prime
from pyroge.errors import SecurityCheckMismatch
from pyroge.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyroge.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
