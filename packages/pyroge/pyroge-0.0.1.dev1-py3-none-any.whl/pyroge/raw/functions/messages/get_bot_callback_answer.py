...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        password (:obj:`InputCheckPasswordSRP <pyroge.raw.base.InputCheckPasswordSRP>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotCallbackAnswer <pyroge.raw.base.messages.BotCallbackAnswer>`
    """
