...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat <pyroge.raw.base.InputEncryptedChat>`):
            N/A
        ...
        file (:obj:`InputEncryptedFile <pyroge.raw.base.InputEncryptedFile>`):
            N/A
    ...
    Returns:
        :obj:`messages.SentEncryptedMessage <pyroge.raw.base.messages.SentEncryptedMessage>`
    """
