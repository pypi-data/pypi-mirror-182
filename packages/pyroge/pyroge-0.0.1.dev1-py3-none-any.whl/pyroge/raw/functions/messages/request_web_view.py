...
class RequestWebView(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyroge.raw.base.InputUser>`):
            N/A
        ...
        theme_params (:obj:`DataJSON <pyroge.raw.base.DataJSON>`, *optional*):
            N/A
        ...
        send_as (:obj:`InputPeer <pyroge.raw.base.InputPeer>`, *optional*):
            N/A

    Returns:
        :obj:`WebViewResult <pyroge.raw.base.WebViewResult>`
    """
