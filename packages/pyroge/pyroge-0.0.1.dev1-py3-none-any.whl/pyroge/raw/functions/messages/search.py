...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <pyroge.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <pyroge.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <pyroge.raw.base.messages.Messages>`
    """
