...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        user_id (:obj:`InputUser <pyroge.raw.base.InputUser>`):
            N/A
        ...
        stickers (List of :obj:`InputStickerSetItem <pyroge.raw.base.InputStickerSetItem>`):
            N/A
        ...
        thumb (:obj:`InputDocument <pyroge.raw.base.InputDocument>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.StickerSet <pyroge.raw.base.messages.StickerSet>`
    """
