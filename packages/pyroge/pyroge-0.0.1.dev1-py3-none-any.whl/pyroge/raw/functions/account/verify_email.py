...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pyroge.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pyroge.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pyroge.raw.base.account.EmailVerified>`
    """
