...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        value_hashes (List of :obj:`SecureValueHash <pyroge.raw.base.SecureValueHash>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <pyroge.raw.base.SecureCredentialsEncrypted>`):
            N/A
