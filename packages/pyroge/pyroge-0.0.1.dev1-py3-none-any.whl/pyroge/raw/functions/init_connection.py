...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pyroge.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pyroge.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pyroge.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pyroge.raw.types`
    """
