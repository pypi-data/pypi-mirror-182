...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pyroge.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <pyroge.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <pyroge.raw.base.phone.GroupParticipants>`
    """
