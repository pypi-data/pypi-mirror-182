...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pyroge.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pyroge.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pyroge.raw.base.payments.ValidatedRequestedInfo>`
    """
