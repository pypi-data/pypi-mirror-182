...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyroge.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyroge.raw.base.Message>`):
            N/A
