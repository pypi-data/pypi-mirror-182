...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <pyroge.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pyroge.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A
