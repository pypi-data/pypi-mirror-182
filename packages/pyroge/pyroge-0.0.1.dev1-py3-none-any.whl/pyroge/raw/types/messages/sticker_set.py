...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <pyroge.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <pyroge.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <pyroge.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <pyroge.raw.base.Document>`):
            N/A
