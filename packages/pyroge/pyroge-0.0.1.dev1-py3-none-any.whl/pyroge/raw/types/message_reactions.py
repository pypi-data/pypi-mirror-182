...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyroge.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyroge.raw.base.MessagePeerReaction>`, *optional*):
            N/A
