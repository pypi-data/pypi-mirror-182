...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <pyroge.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyroge.raw.base.InputFile>`, *optional*):
            N/A
