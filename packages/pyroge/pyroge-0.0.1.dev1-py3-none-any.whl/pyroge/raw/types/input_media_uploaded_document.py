...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyroge.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyroge.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyroge.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyroge.raw.base.InputDocument>`, *optional*):
            N/A
