...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyroge.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyroge.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyroge.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyroge.raw.base.updates.State>`):
            N/A
