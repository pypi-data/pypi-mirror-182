...
class WallPaper(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        document (:obj:`Document <pyroge.raw.base.Document>`):
            N/A
        ...
        settings (:obj:`WallPaperSettings <pyroge.raw.base.WallPaperSettings>`, *optional*):
            N/A
