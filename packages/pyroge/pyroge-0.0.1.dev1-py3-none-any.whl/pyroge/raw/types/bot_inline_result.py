...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pyroge.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pyroge.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pyroge.raw.base.WebDocument>`, *optional*):
            N/A
