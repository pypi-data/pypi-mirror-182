...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyroge.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyroge.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyroge.raw.base.PremiumSubscriptionOption>`):
            N/A
