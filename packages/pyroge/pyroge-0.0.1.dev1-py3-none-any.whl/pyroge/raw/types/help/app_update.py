...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <pyroge.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <pyroge.raw.base.Document>`, *optional*):
            N/A
