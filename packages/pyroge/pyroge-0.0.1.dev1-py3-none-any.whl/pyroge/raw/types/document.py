...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyroge.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyroge.raw.base.VideoSize>`, *optional*):
            N/A
