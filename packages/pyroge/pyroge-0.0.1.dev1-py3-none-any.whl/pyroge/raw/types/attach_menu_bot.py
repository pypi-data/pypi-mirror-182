...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pyroge.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <pyroge.raw.base.AttachMenuBotIcon>`):
            N/A
