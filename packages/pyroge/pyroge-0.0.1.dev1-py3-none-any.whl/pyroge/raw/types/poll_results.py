...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyroge.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyroge.raw.base.MessageEntity>`, *optional*):
            N/A
