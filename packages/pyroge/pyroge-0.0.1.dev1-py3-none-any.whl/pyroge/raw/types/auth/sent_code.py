...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyroge.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyroge.raw.base.auth.CodeType>`, *optional*):
            N/A
