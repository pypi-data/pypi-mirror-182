...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <pyroge.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <pyroge.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
