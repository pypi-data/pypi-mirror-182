...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyroge.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyroge.raw.base.VideoSize>`, *optional*):
            N/A
