...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyroge.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyroge.raw.base.Reaction>`, *optional*):
            N/A
