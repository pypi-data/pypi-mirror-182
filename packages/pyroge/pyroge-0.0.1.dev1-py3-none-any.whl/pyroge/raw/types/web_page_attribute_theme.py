...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pyroge.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pyroge.raw.base.ThemeSettings>`, *optional*):
            N/A
