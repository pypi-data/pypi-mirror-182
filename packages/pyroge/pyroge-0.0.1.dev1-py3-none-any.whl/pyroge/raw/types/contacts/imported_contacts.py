...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyroge.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyroge.raw.base.PopularContact>`):
            N/A
