...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <pyroge.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <pyroge.raw.base.SecureSecretSettings>`, *optional*):
            N/A
