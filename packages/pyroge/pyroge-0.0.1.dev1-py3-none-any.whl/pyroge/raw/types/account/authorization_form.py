...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyroge.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyroge.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyroge.raw.base.SecureValueError>`):
            N/A
