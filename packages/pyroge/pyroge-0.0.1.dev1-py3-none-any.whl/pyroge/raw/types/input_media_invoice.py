...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <pyroge.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <pyroge.raw.base.InputWebDocument>`, *optional*):
            N/A

        start_param (``str``, *optional*):
            N/A

        extended_media (:obj:`InputMedia <pyroge.raw.base.InputMedia>`, *optional*):
            N/A
