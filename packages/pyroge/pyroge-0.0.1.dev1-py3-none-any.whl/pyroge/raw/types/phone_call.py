...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyroge.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyroge.raw.base.PhoneConnection>`):
            N/A
