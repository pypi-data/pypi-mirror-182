...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroge.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pyroge.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pyroge.raw.base.GroupCallParticipant>`):
            N/A
