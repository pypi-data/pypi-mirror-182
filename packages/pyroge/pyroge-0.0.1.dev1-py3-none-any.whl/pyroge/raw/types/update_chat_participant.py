...
class UpdateChatParticipant(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        prev_participant (:obj:`ChatParticipant <pyroge.raw.base.ChatParticipant>`, *optional*):
            N/A

        new_participant (:obj:`ChatParticipant <pyroge.raw.base.ChatParticipant>`, *optional*):
            N/A
