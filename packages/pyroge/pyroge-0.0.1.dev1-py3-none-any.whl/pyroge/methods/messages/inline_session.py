...
from pyroge.errors import AuthBytesInvalid
from pyroge.session import Session
from pyroge.session.auth import Auth


async def get_session(client: "pyroge.Client", dc_id: int):
