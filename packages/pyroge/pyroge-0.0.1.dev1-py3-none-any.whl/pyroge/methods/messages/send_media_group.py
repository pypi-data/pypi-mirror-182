...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroge.types.InputMediaPhoto`, :obj:`~pyroge.types.InputMediaVideo`, :obj:`~pyroge.types.InputMediaAudio` and :obj:`~pyroge.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyroge.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroge.types import InputMediaPhoto, InputMediaVideo
