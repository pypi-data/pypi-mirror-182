...
import pyroge
from pyroge.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyroge.Client.start`, :meth:`~pyroge.idle` and :meth:`~pyroge.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyroge.compose`.
