...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~pyroge.Client.run`.

    Parameters:
        clients (List of :obj:`~pyroge.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from pyroge import Client, compose
