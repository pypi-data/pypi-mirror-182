...
class Robot(object):
    ...
    def get_robot_mode(self) -> "int":
        ...
        Notes: See state here ("https://help.lebai.ltd/guide/basic.html#%E6%9C%BA%E5%99%A8%E4%BA%BA%E7%8A%B6%E6%80%81").
        """
    ...
    def scene(self, *args) -> "unsigned int":
        r"""
        *Overload 1:*
        ...
        *Overload 3:*
        ...
        :param name:: 调用场景的名字
        """
        return _l_master.Robot_scene(self, *args)
