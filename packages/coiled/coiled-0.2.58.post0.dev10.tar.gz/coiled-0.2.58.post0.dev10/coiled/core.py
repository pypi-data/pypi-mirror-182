...
class Cloud(Generic[IsAsynchronous]):
    ...
    @track_context
    async def _list_clusters(self, account: Optional[str] = None):
    ...
    @overload
    def list_clusters(self: Cloud[Sync], account: Optional[str] = None) -> dict:
        ...
    ...
    def create_cluster(
        ...
        *,
        ...
        worker_memory: Optional[Union[str, int]] = None,
        worker_class: Optional[str] = None,
        worker_options: Optional[dict] = None,
        scheduler_cpu: Optional[int] = None,
        scheduler_memory: Optional[Union[str, int]] = None,
...
def cluster_logs(name: str, account: Optional[str] = None) -> Logs:
