...
def train_gridsearch_classifier(umap_df,test_size=0.3,num_CV=5,verbosity=0):
    ...
    UMAP_model = xgb.XGBClassifier(objective='multi:softmax',verbosity=verbosity)
...
def plot_shap_summary(explainer,umap_df):
