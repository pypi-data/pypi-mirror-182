...
class EventPolling(Base):
    ...
    def subscribe_contract(self, contract_name, contract_address, contract_version, network_name, abi, collection_name):
    ...
    def get_contracts_events_info(self, collection_name, contract_addresses, user_web3_addresses, event_names):
