...
impl Array {
    #[apply(new_rc_unwrap)]
    pub fn try_new(value: Tensor, name: Option<String>) -> Result<Self> {
...
impl Array {
    #[new]
    #[args(name = "None")]
    fn py_new(value: Tensor, name: Option<String>) -> Result<PyClassInitializer<Self>> {
...
impl Symbol {
    ...
    pub fn ident(&self) -> (Uuid, Option<&str>) {
        (self.uuid, self.name())
    }
}
