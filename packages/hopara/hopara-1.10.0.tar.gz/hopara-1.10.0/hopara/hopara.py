...
class Hopara:
    ...
    """
    def __init__(self, organization: str = 'hopara.io'):
    ...
    def __upload_file(self, file_path, endpoint_name):
        url = urljoin(self.config.get_assets_url(), f'w/{self.__tenant}/{endpoint_name}')
    ...
    def upload_image(self, file_path):
        return self.__upload_file(file_path, 'image')

    def upload_model(self, file_path):
        return self.__upload_file(file_path, 'model')
