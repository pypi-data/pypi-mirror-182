...
def procesamiento_aseguradoras(date_port, port_name, ruta, ruta_precia, portfolioName, subGroup, portfolio_fields, mkt_value_prorrateo=None, add_rows=None):
    ...
    coupFreq['idCoupFreq'] = coupFreq['idCoupFreq'].astype('str')
    Portafolio['coupFreq'] = Portafolio['coupFreq'].astype('str')
    ...
    Portafolio['dateConv'] = Portafolio['dateConv'].astype('str')
    dateConv['idDateConv'] = dateConv['idDateConv'].astype('str')
